...
public final class ConnectionSpec {
    ...
    static {
        ...
        ConnectionSpec connectionSpecBuild = builderCipherSuites.tlsVersions(tlsVersion, tlsVersion2).supportsTlsExtensions(true).build();
        MODERN_TLS = connectionSpecBuild;
        new Builder(connectionSpecBuild).tlsVersions(tlsVersion, tlsVersion2, TlsVersion.TLS_1_1, TlsVersion.TLS_1_0).supportsTlsExtensions(true).build();
