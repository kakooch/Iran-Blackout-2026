...
public class Platform {
    ...
    private static Platform findPlatform() throws IllegalAccessException, NoSuchMethodException, NoSuchAlgorithmException, ClassNotFoundException, SecurityException, KeyManagementException, IllegalArgumentException, InvocationTargetException {
        Method method;
        Method method2;
        ...
        if (androidSecurityProvider != null) {
            ...
            try {
                ...
                try {
                    ...
                    method2 = null;
                    tlsExtensionType = !androidSecurityProvider.getName().equals("GmsCore_OpenSSL") ? TlsExtensionType.ALPN_AND_NPN : TlsExtensionType.ALPN_AND_NPN;
    ...
    private static boolean isAtLeastAndroid5() throws ClassNotFoundException {
        try {
    ...
    private static boolean isAtLeastAndroid41() throws ClassNotFoundException {
        try {
