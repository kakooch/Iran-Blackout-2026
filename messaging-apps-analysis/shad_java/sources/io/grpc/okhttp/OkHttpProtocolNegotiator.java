...
class OkHttpProtocolNegotiator {
    ...
    static OkHttpProtocolNegotiator createNegotiator(ClassLoader classLoader) throws ClassNotFoundException {
        boolean z;
        try {
    ...
    static final class AndroidNegotiator extends OkHttpProtocolNegotiator {
        ...
        static {
            ...
            SET_USE_SESSION_TICKETS = new OptionalMethod<>(null, "setUseSessionTickets", cls2);
        ...
        @Override // io.grpc.okhttp.OkHttpProtocolNegotiator
        protected void configureTlsExtensions(SSLSocket sSLSocket, String str, List<Protocol> list) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
