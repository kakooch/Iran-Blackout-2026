...
final class InternalSubchannel implements InternalInstrumented<Object>, TransportProvider {
    ...
    public void scheduleBackoff(Status status) {
        ...
        long jNextBackoffNanos = this.reconnectPolicy.nextBackoffNanos();
        Stopwatch stopwatch = this.connectingTimer;
        TimeUnit timeUnit = TimeUnit.NANOSECONDS;
        long jElapsed = jNextBackoffNanos - stopwatch.elapsed(timeUnit);
        this.channelLogger.log(ChannelLogger.ChannelLogLevel.INFO, "TRANSIENT_FAILURE ({0}). Will reconnect after {1} ns", printShortStatus(status), Long.valueOf(jElapsed));
        ...
        }, jElapsed, timeUnit, this.scheduledExecutor);
    }
    ...
    public void updateAddresses(List<EquivalentAddressGroup> list) {
        ...
        this.syncContext.execute(new Runnable() { // from class: io.grpc.internal.InternalSubchannel.4
            ...
            public void run() {
                ...
                } else if (InternalSubchannel.this.state.getState() == connectivityState) {
