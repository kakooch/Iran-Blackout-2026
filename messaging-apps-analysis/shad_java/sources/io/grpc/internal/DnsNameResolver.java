...
public class DnsNameResolver extends NameResolver {
    ...
    protected DnsNameResolver(String str, String str2, NameResolver.Args args, SharedResourceHolder.Resource<Executor> resource, Stopwatch stopwatch, boolean z) {
    ...
    private NameResolver.ConfigOrError resolveServiceConfig() {
        ...
        if (resourceResolver != null) {
            try {
                listEmptyList = resourceResolver.resolveTxt("_grpc_config." + this.host);
            } catch (Exception e) {
