...
public final class DiskLruCache implements Closeable {
    ...
    private void readJournal() throws IOException {
        ...
        try {
            ...
            if (!"libcore.io.DiskLruCache".equals(line) || !"1".equals(line2) || !Integer.toString(this.appVersion).equals(line3) || !Integer.toString(this.valueCount).equals(line4) || !BuildConfig.FLAVOR.equals(line5)) {
