...
final class SingletonConnectivityReceiver {
    ...
    private SingletonConnectivityReceiver(final Context context) {
        ...
        GlideSuppliers.GlideSupplier glideSupplierMemorize = GlideSuppliers.memorize(new GlideSuppliers.GlideSupplier<ConnectivityManager>(this) { // from class: com.bumptech.glide.manager.SingletonConnectivityReceiver.1
