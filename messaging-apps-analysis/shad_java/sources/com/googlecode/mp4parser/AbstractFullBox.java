...
public abstract class AbstractFullBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_0 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setVersion", "com.googlecode.mp4parser.AbstractFullBox", "int", "version", BuildConfig.FLAVOR, "void"), 51);
        ajc$tjp_1 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setFlags", "com.googlecode.mp4parser.AbstractFullBox", "int", "flags", BuildConfig.FLAVOR, "void"), 64);
    }
