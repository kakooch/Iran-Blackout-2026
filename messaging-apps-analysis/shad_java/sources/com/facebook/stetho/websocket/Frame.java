...
class Frame {
    ...
    private static byte[] encodeLength(long j) {
        return j <= 125 ? new byte[]{(byte) j} : j <= 65535 ? new byte[]{126, (byte) ((j >> 8) & 255), (byte) (j & 255)} : new byte[]{127, (byte) ((j >> 56) & 255), (byte) ((j >> 48) & 255), (byte) ((j >> 40) & 255), (byte) ((j >> 32) & 255), (byte) ((j >> 24) & 255), (byte) ((j >> 16) & 255), (byte) ((j >> 8) & 255), (byte) (j & 255)};
    }
    ...
    private long decodeLength(byte b, InputStream inputStream) throws IOException {
        ...
        long byteOrThrow = 0;
        for (int i = 0; i < 8; i++) {
            byteOrThrow = (byteOrThrow << 8) | (readByteOrThrow(inputStream) & 255);
        }
        return byteOrThrow;
    }
