...
public class FilesDumperPlugin implements DumperPlugin {
    ...
    public void dump(DumperContext dumperContext) throws DumpException, IOException {
        ...
        String strNextOptionalArg = ArgsHelper.nextOptionalArg(it, BuildConfig.FLAVOR);
        ...
        if (BuildConfig.FLAVOR.equals(strNextOptionalArg)) {
            return;
        }
    ...
    private void doLs(PrintStream printStream) throws DumpUsageException {
        ...
        if (baseDir.isDirectory()) {
            printDirectoryText(baseDir, BuildConfig.FLAVOR, printStream);
        }
    }
