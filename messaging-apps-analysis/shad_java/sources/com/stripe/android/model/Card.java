...
public class Card {
    ...
    public boolean validateNumber() {
        ...
        String strReplaceAll = this.number.trim().replaceAll("\\s+|-", BuildConfig.FLAVOR);
        ...
        return "American Express".equals(brand) ? strReplaceAll.length() == 15 : "Diners Club".equals(brand) ? strReplaceAll.length() == 14 : strReplaceAll.length() == 16;
    }
    ...
    private boolean isValidLuhnNumber(String str) throws NumberFormatException {
        ...
        for (int length = str.length() - 1; length >= 0; length--) {
            ...
            int i2 = Integer.parseInt(BuildConfig.FLAVOR + cCharAt);
            z ^= true;
            if (z) {
                i2 *= 2;
            }
