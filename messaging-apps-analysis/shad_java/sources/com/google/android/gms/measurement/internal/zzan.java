...
public final class zzan {
    ...
    zzan(zzfl zzflVar, String str, String str2, String str3, long j, long j2, Bundle bundle) {
        zzaq zzaqVar;
        ...
        if (bundle == null || bundle.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (next == null) {
                    ...
                    Object objZzE = zzflVar.zzl().zzE(next, bundle2.get(next));
                    if (objZzE == null) {
                        zzflVar.zzat().zze().zzb("Param value can't be null", zzflVar.zzm().zzd(next));
                        it.remove();
                    } else {
                        zzflVar.zzl().zzL(bundle2, next, objZzE);
                    }
                }
            }
    ...
    final zzan zza(zzfl zzflVar, long j) {
