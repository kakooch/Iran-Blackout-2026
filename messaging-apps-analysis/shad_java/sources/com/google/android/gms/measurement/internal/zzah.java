...
final class zzah extends SQLiteOpenHelper {
    ...
    zzah(zzai zzaiVar, Context context, String str) {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        try {
            ...
            try {
                ...
                this.zza.zzx.zzat().zzb().zzb("Failed to open freshly created database", e);
                throw e;
            }
        }
    }
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) throws Throwable {
        ...
        zzaj.zza(this.zza.zzx.zzat(), sQLiteDatabase, "user_attributes", "CREATE TABLE IF NOT EXISTS user_attributes ( app_id TEXT NOT NULL, name TEXT NOT NULL, set_timestamp INTEGER NOT NULL, value BLOB NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,set_timestamp,value", zzai.zzc);
        zzaj.zza(this.zza.zzx.zzat(), sQLiteDatabase, "apps", "CREATE TABLE IF NOT EXISTS apps ( app_id TEXT NOT NULL, app_instance_id TEXT, gmp_app_id TEXT, resettable_device_id_hash TEXT, last_bundle_index INTEGER NOT NULL, last_bundle_end_timestamp INTEGER NOT NULL, PRIMARY KEY (app_id)) ;", "app_id,app_instance_id,gmp_app_id,resettable_device_id_hash,last_bundle_index,last_bundle_end_timestamp", zzai.zzd);
        zzaj.zza(this.zza.zzx.zzat(), sQLiteDatabase, "queue", "CREATE TABLE IF NOT EXISTS queue ( app_id TEXT NOT NULL, bundle_end_timestamp INTEGER NOT NULL, data BLOB NOT NULL);", "app_id,bundle_end_timestamp,data", zzai.zzf);
        ...
        zzaj.zza(this.zza.zzx.zzat(), sQLiteDatabase, "raw_events", "CREATE TABLE IF NOT EXISTS raw_events ( app_id TEXT NOT NULL, name TEXT NOT NULL, timestamp INTEGER NOT NULL, metadata_fingerprint INTEGER NOT NULL, data BLOB NOT NULL);", "app_id,name,timestamp,metadata_fingerprint,data", zzai.zze);
        ...
        zzaj.zza(this.zza.zzx.zzat(), sQLiteDatabase, "app2", "CREATE TABLE IF NOT EXISTS app2 ( app_id TEXT NOT NULL, first_open_count INTEGER NOT NULL, PRIMARY KEY (app_id));", "app_id,first_open_count", zzai.zzi);
