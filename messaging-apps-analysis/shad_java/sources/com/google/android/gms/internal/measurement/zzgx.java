...
final class zzgx extends zzgz {
        ...
        if (zzgz.zzc && !zzgd.zza()) {
            ...
            if (i2 - i3 >= 5) {
                if ((i & (-128)) == 0) {
                    byte[] bArr = this.zzb;
                    this.zzd = i3 + 1;
                    zzkh.zzq(bArr, i3, (byte) i);
                    return;
                }
                byte[] bArr2 = this.zzb;
                this.zzd = i3 + 1;
                zzkh.zzq(bArr2, i3, (byte) (i | 128));
                int i4 = i >>> 7;
                if ((i4 & (-128)) == 0) {
                    byte[] bArr3 = this.zzb;
                    int i5 = this.zzd;
                    this.zzd = i5 + 1;
                    zzkh.zzq(bArr3, i5, (byte) i4);
                    return;
                }
                byte[] bArr4 = this.zzb;
                int i6 = this.zzd;
                this.zzd = i6 + 1;
                zzkh.zzq(bArr4, i6, (byte) (i4 | 128));
                int i7 = i4 >>> 7;
                if ((i7 & (-128)) == 0) {
                    byte[] bArr5 = this.zzb;
                    int i8 = this.zzd;
                    this.zzd = i8 + 1;
                    zzkh.zzq(bArr5, i8, (byte) i7);
                    return;
                }
                byte[] bArr6 = this.zzb;
                int i9 = this.zzd;
                this.zzd = i9 + 1;
                zzkh.zzq(bArr6, i9, (byte) (i7 | 128));
                int i10 = i7 >>> 7;
                if ((i10 & (-128)) == 0) {
                    byte[] bArr7 = this.zzb;
                    int i11 = this.zzd;
                    this.zzd = i11 + 1;
                    zzkh.zzq(bArr7, i11, (byte) i10);
                    return;
                }
                byte[] bArr8 = this.zzb;
                int i12 = this.zzd;
                this.zzd = i12 + 1;
                zzkh.zzq(bArr8, i12, (byte) (i10 | 128));
                byte[] bArr9 = this.zzb;
                int i13 = this.zzd;
                this.zzd = i13 + 1;
                zzkh.zzq(bArr9, i13, (byte) (i10 >>> 7));
                return;
            }
        }
        while ((i & (-128)) != 0) {
    ...
    public final void zzr(String str) throws IOException {
        int i = this.zzd;
        try {
            int iZzw = zzgz.zzw(str.length() * 3);
            int iZzw2 = zzgz.zzw(str.length());
            if (iZzw2 != iZzw) {
                zzl(zzkn.zzc(str));
                byte[] bArr = this.zzb;
                int i2 = this.zzd;
            ...
            int i3 = i + iZzw2;
            this.zzd = i3;
            int iZzd = zzkn.zzd(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzl((iZzd - i) - iZzw2);
            this.zzd = iZzd;
        } catch (zzkl e) {
    ...
    public final void zzn(long j) throws IOException {
        if (zzgz.zzc && this.zzc - this.zzd >= 10) {
            while ((j & (-128)) != 0) {
                ...
                int i = this.zzd;
                this.zzd = i + 1;
                zzkh.zzq(bArr, i, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zzb;
            int i2 = this.zzd;
            this.zzd = i2 + 1;
            zzkh.zzq(bArr2, i2, (byte) j);
            return;
        }
        while ((j & (-128)) != 0) {
            try {
