...
public final class zzlb implements zzla {
    ...
    static {
        ...
        zza = zzfeVar.zza("measurement.ad_id_cache_time", 10000L);
        zzb = zzfeVar.zza("measurement.max_bundles_per_iteration", 100L);
        zzc = zzfeVar.zza("measurement.config.cache_time", 86400000L);
        zzfeVar.zzd("measurement.log_tag", "FA");
        zze = zzfeVar.zzd("measurement.config.url_authority", "app-measurement.com");
        zzf = zzfeVar.zzd("measurement.config.url_scheme", "https");
        ...
        zzn = zzfeVar.zza("measurement.monitoring.sample_period_millis", 86400000L);
        zzo = zzfeVar.zza("measurement.upload.realtime_upload_interval", 10000L);
        zzp = zzfeVar.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L);
        zzfeVar.zza("measurement.config.cache_time.service", 3600000L);
        zzr = zzfeVar.zza("measurement.service_client.idle_disconnect_millis", 5000L);
        zzfeVar.zzd("measurement.log_tag.service", "FA-SVC");
        zzt = zzfeVar.zza("measurement.upload.stale_data_deletion_interval", 86400000L);
        ...
        zzy = zzfeVar.zza("measurement.upload.max_bundle_size", 65536L);
        ...
        zzH = zzfeVar.zza("measurement.upload.max_batch_size", 65536L);
