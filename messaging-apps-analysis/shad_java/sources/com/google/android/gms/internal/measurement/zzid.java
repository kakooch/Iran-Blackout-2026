...
public final class zzid {
    ...
    static {
        ...
        zzd = zzidVar4;
        zzid zzidVar5 = new zzid("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(0.0d));
        zze = zzidVar5;
        zzid zzidVar6 = new zzid("BOOLEAN", 5, Boolean.TYPE, Boolean.class, Boolean.FALSE);
        zzf = zzidVar6;
        zzid zzidVar7 = new zzid("STRING", 6, String.class, String.class, BuildConfig.FLAVOR);
        zzg = zzidVar7;
    ...
    private zzid(String str, int i, Class cls, Class cls2, Object obj) {
        this.zzl = cls2;
        this.zzm = obj;
    }
