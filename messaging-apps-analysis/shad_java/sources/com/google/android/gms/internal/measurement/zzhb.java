...
/* JADX WARN: Unexpected interfaces in signature: [com.google.android.gms.internal.measurement.zzje] */
/* compiled from: com.google.android.gms:play-services-measurement-base@@18.0.2 */
/* loaded from: classes3.dex */
final class zzhb extends zzgc<Double> implements RandomAccess, zzhz {
    ...
    public final int hashCode() {
        int iZze = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZze = (iZze * 31) + zzia.zze(Double.doubleToLongBits(this.zzb[i]));
        }
        return iZze;
    }
