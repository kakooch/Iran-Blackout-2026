...
public final class zzdq extends zzhs<zzdq, zzdp> implements zziy {
    ...
    static /* synthetic */ void zzo(zzdq zzdqVar, Iterable iterable) {
    ...
    static /* synthetic */ void zzq(zzdq zzdqVar, Iterable iterable) {
    ...
    static /* synthetic */ void zzs(zzdq zzdqVar, Iterable iterable) {
        zzdqVar.zzw();
        zzgb.zzbs(iterable, zzdqVar.zzf);
    }

    static /* synthetic */ void zzt(zzdq zzdqVar, int i) {
        zzdqVar.zzw();
        zzdqVar.zzf.remove(i);
    }

    static /* synthetic */ void zzu(zzdq zzdqVar, Iterable iterable) {
        zzdqVar.zzx();
        zzgb.zzbs(iterable, zzdqVar.zzg);
    }

    static /* synthetic */ void zzv(zzdq zzdqVar, int i) {
        zzdqVar.zzx();
