...
final class zzip implements zzjj {
    ...
    public final <T> zzji<T> zza(Class<T> cls) {
        zzjk.zza(cls);
        zziu zziuVarZzc = this.zza.zzc(cls);
        return zziuVarZzc.zza() ? zzhs.class.isAssignableFrom(cls) ? zzjb.zzf(zzjk.zzC(), zzhh.zza(), zziuVarZzc.zzb()) : zzjb.zzf(zzjk.zzA(), zzhh.zzb(), zziuVarZzc.zzb()) : zzhs.class.isAssignableFrom(cls) ? zzb(zziuVarZzc) ? zzja.zzk(cls, zziuVarZzc, zzjd.zzb(), zzil.zzd(), zzjk.zzC(), zzhh.zza(), zzit.zzb()) : zzja.zzk(cls, zziuVarZzc, zzjd.zzb(), zzil.zzd(), zzjk.zzC(), null, zzit.zzb()) : zzb(zziuVarZzc) ? zzja.zzk(cls, zziuVarZzc, zzjd.zza(), zzil.zzc(), zzjk.zzA(), zzhh.zzb(), zzit.zza()) : zzja.zzk(cls, zziuVarZzc, zzjd.zza(), zzil.zzc(), zzjk.zzB(), null, zzit.zza());
    }
}
