...
public final class zzha extends zzfu<zzha> implements Cloneable {
    ...
    public int zzbji = 0;
    private String zzbjj = BuildConfig.FLAVOR;
    ...
    public zzha() {
        ...
        this.zzbjo = null;
        this.zzbjp = bArr;
        this.zzbjq = BuildConfig.FLAVOR;
        this.zzbjr = BuildConfig.FLAVOR;
        this.zzbjs = null;
        this.zzbjt = BuildConfig.FLAVOR;
        this.zzbju = 180000L;
        this.zzbjv = null;
        this.zzbjw = bArr;
        this.zzbjx = BuildConfig.FLAVOR;
    ...
    public final int hashCode() {
        ...
        zzge$zzd zzge_zzd = this.zzbjo;
        int iHashCode5 = ((((iHashCode4 * 31) + (zzge_zzd == null ? 0 : zzge_zzd.hashCode())) * 31) + Arrays.hashCode(this.zzbjp)) * 31;
        String str3 = this.zzbjq;
        ...
        zzge$zzs zzge_zzs = this.zzbkb;
        int iHashCode12 = ((((iHashCode11 * 31) + (zzge_zzs == null ? 0 : zzge_zzs.hashCode())) * 31) + (this.zzbkc ? 1231 : 1237)) * 31;
        zzfw zzfwVar = this.zzrj;
        if (zzfwVar != null && !zzfwVar.isEmpty()) {
    ...
    protected final int zzen() {
        ...
        String str6 = this.zzbjj;
        return (str6 == null || str6.equals(BuildConfig.FLAVOR)) ? iZzen : iZzen + zzfs.zzb(26, this.zzbjj);
    }
