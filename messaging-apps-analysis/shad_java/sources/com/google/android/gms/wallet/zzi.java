...
public final class zzi implements Parcelable.Creator<FullWallet> {
    ...
    public final /* synthetic */ FullWallet createFromParcel(Parcel parcel) {
        ...
        return new FullWallet(strCreateString, strCreateString2, zzaeVar, strCreateString3, zzaVar, zzaVar2, strArrCreateStringArray, userAddress, userAddress2, instrumentInfoArr, paymentMethodToken);
    }
}
