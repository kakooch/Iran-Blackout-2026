...
public class zzhp {
    ...
    public final boolean zze(String str) {
        PackageInfo packageInfoZzf = zzf(str);
        if (packageInfoZzf == null) {
            return false;
        }
        if (GooglePlayServicesUtilLight.honorsDebugCertificates(this.zzft)) {
            return zza(packageInfoZzf, true);
        }
        boolean zZza = zza(packageInfoZzf, false);
        if (!zZza && zza(packageInfoZzf, true)) {
    ...
    private static boolean zza(PackageInfo packageInfo, boolean z) {
        ...
        return z ? zza(packageInfo, zzfu, zzfv) : zza(packageInfo, zzfu);
    }
