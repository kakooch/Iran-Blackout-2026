...
final class SpannedToHtmlConverter {
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f) {
        if (charSequence == null) {
            return new HtmlAndCss(BuildConfig.FLAVOR, ImmutableMap.of());
        }
    ...
    private static String getClosingTag(Object obj) {
        if ((obj instanceof StrikethroughSpan) || (obj instanceof ForegroundColorSpan) || (obj instanceof BackgroundColorSpan) || (obj instanceof HorizontalTextInVerticalContextSpan) || (obj instanceof AbsoluteSizeSpan) || (obj instanceof RelativeSizeSpan)) {
            return "</span>";
        }
        if (obj instanceof TypefaceSpan) {
    ...
    static final class SpanInfo {
        ...
        public static /* synthetic */ int lambda$static$0(SpanInfo spanInfo, SpanInfo spanInfo2) {
            int iM = KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(spanInfo2.end, spanInfo.end);
            if (iM != 0) {
                return iM;
            }
        ...
        public static /* synthetic */ int lambda$static$1(SpanInfo spanInfo, SpanInfo spanInfo2) {
            int iM = KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(spanInfo2.start, spanInfo.start);
            if (iM != 0) {
                return iM;
            }
