...
final class TtmlRenderUtil {
    ...
    public static void applyStylesToSpan(Spannable spannable, int i, int i2, TtmlStyle ttmlStyle, TtmlNode ttmlNode, Map<String, TtmlStyle> map) {
        ...
        if (rubyType == 2) {
            ...
            if (ttmlNodeFindRubyContainerNode != null && (ttmlNodeFindRubyTextNode = findRubyTextNode(ttmlNodeFindRubyContainerNode, map)) != null) {
                if (ttmlNodeFindRubyTextNode.getChildCount() == 1 && ttmlNodeFindRubyTextNode.getChild(0).text != null) {
                    ...
                    spannable.setSpan(new RubySpan(str, ttmlStyle2 != null ? ttmlStyle2.getRubyPosition() : -1), i, i2, 33);
                } else {
