...
public final class WebvttCueParser {
    ...
    private static final class StyleMatch implements Comparable<StyleMatch> {
        ...
        public int compareTo(StyleMatch styleMatch) {
            return KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(this.score, styleMatch.score);
        }
    }
    ...
    private static final class StartTag {
        ...
        public static StartTag buildWholeCueVirtualTag() {
            return new StartTag(BuildConfig.FLAVOR, 0, BuildConfig.FLAVOR, Collections.emptySet());
        }
    }
    ...
    static class Element {
        ...
        public static /* synthetic */ int lambda$static$0(Element element, Element element2) {
            return KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(element.startTag.position, element2.startTag.position);
        }
