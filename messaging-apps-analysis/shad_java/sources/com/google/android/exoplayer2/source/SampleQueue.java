...
public class SampleQueue implements TrackOutput {
    ...
    public int read(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z, boolean z2) {
        int sampleMetadata = readSampleMetadata(formatHolder, decoderInputBuffer, z, z2, this.extrasHolder);
    ...
    */
    ...
    private void onFormatResult(Format format, FormatHolder formatHolder) {
        ...
        if (z || !Util.areEqual(drmInitData, drmInitData2)) {
            DrmSession drmSession = this.currentDrmSession;
            DrmSession drmSessionAcquireSession = this.drmSessionManager.acquireSession(this.playbackLooper, this.drmEventDispatcher, format);
