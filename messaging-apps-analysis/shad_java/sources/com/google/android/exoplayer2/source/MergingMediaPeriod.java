...
final class MergingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public long selectTracks(TrackSelection[] trackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        while (i3 < this.periods.length) {
            ...
            long jSelectTracks = this.periods[i3].selectTracks(trackSelectionArr2, zArr, sampleStreamArr3, zArr2, j2);
            if (i5 == 0) {
                j2 = jSelectTracks;
    ...
    private static final class TimeOffsetMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
        ...
        public long selectTracks(TrackSelection[] trackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
            ...
            long jSelectTracks = this.mediaPeriod.selectTracks(trackSelectionArr, zArr, sampleStreamArr2, zArr2, j - this.timeOffsetUs);
    ...
    private static final class TimeOffsetSampleStream implements SampleStream {
        ...
        public int readData(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z) {
            int data = this.sampleStream.readData(formatHolder, decoderInputBuffer, z);
            if (data == -4) {
