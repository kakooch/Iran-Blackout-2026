        ...
        while (!this.populated) {
            ...
            if (iCalculatePacketSize2 > 0) {
                if (this.packetArray.capacity() < this.packetArray.limit() + iCalculatePacketSize2) {
                    ...
                    parsableByteArray.reset(Arrays.copyOf(parsableByteArray.getData(), this.packetArray.limit() + iCalculatePacketSize2), this.packetArray.limit());
                }
                extractorInput.readFully(this.packetArray.getData(), this.packetArray.limit(), iCalculatePacketSize2);
