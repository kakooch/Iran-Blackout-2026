...
public final class Mp3Extractor implements Extractor {
    ...
    private boolean synchronize(ExtractorInput extractorInput, boolean z) throws IOException {
        ...
        int peekPosition;
        int frameSize;
        int i2 = z ? 32768 : MessagesController.UPDATE_MASK_REORDER;
        extractorInput.resetPeekPosition();
        if (extractorInput.getPosition() == 0) {
            Metadata metadataPeekId3Data = this.id3Peeker.peekId3Data(extractorInput, (this.flags & 4) == 0 ? null : REQUIRED_ID3_FRAME_PREDICATE);
    ...
    private Seeker computeSeeker(ExtractorInput extractorInput) throws IOException {
        ...
        return (seekerMaybeReadSeekFrame == null || !(seekerMaybeReadSeekFrame.isSeekable() || (this.flags & 1) == 0)) ? getConstantBitrateSeeker(extractorInput) : seekerMaybeReadSeekFrame;
    }
