...
final class AudioTrackPositionTracker {
    ...
    public long getCurrentPositionUs(boolean z) {
        ...
        if (zHasAdvancingTimestamp) {
            jMax = framesToDurationUs(audioTimestampPoller.getTimestampPositionFrames()) + (jNanoTime - audioTimestampPoller.getTimestampSystemTimeUs());
        } else {
