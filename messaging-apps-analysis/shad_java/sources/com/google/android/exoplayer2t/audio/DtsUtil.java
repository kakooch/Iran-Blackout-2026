...
public final class DtsUtil {
    ...
    public static Format parseDtsFormat(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        ...
        int i3 = bits >= iArr.length ? -1 : (iArr[bits] * CloseCodes.NORMAL_CLOSURE) / 2;
    ...
    */
    public static int getDtsFrameSize(byte[] r7) {
        ...
        L63:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2t.audio.DtsUtil.getDtsFrameSize(byte[]):int");
    }
