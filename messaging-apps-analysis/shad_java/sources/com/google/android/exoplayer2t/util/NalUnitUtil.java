...
public final class NalUnitUtil {
    ...
    */
    public static com.google.android.exoplayer2t.util.NalUnitUtil.SpsData parseSpsNalUnit(byte[] r21, int r22, int r23) {
        /*
            Method dump skipped, instructions count: 372
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2t.util.NalUnitUtil.parseSpsNalUnit(byte[], int, int):com.google.android.exoplayer2t.util.NalUnitUtil$SpsData");
    }
    ...
    */
    public static int findNalUnit(byte[] r7, int r8, int r9, boolean[] r10) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2t.util.NalUnitUtil.findNalUnit(byte[], int, int, boolean[]):int");
    }
