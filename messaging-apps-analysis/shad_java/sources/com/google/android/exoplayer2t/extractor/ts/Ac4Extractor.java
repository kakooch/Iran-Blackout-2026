...
public final class Ac4Extractor implements Extractor {
    ...
    */
    public boolean sniff(com.google.android.exoplayer2t.extractor.ExtractorInput r9) throws java.lang.InterruptedException, java.io.IOException {
        ...
        L4f:
            byte[] r6 = r0.data
            int r5 = com.google.android.exoplayer2t.audio.Ac4Util.parseAc4SyncframeSize(r6, r5)
            r6 = -1
            if (r5 != r6) goto L59
            return r2
        L59:
        ...
        L5f:
            ...
            goto L9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2t.extractor.ts.Ac4Extractor.sniff(com.google.android.exoplayer2t.extractor.ExtractorInput):boolean");
    }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws InterruptedException, IOException {
        int i = extractorInput.read(this.sampleData.data, 0, LiteMode.FLAG_ANIMATED_EMOJI_KEYBOARD_NOT_PREMIUM);
        if (i == -1) {
            return -1;
        }
