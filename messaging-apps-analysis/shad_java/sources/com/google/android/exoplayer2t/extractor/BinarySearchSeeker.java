...
public abstract class BinarySearchSeeker {
    ...
    public interface TimestampSeeker {
        ...
        /* renamed from: com.google.android.exoplayer2t.extractor.BinarySearchSeeker$TimestampSeeker$-CC, reason: invalid class name */
        ...
        TimestampSearchResult searchForTimestamp(ExtractorInput extractorInput, long j) throws InterruptedException, IOException;
    }
    ...
    public int handlePendingSeek(ExtractorInput extractorInput, PositionHolder positionHolder) throws InterruptedException, IOException {
        ...
        while (true) {
            ...
            TimestampSearchResult timestampSearchResultSearchForTimestamp = timestampSeeker.searchForTimestamp(extractorInput, seekOperationParams.getTargetTimePosition());
