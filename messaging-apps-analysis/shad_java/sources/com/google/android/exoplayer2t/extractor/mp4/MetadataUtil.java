...
import com.google.android.exoplayer2t.metadata.id3.ApicFrame;
import com.google.android.exoplayer2t.metadata.id3.CommentFrame;
import com.google.android.exoplayer2t.metadata.id3.Id3Frame;
import com.google.android.exoplayer2t.metadata.id3.InternalFrame;
import com.google.android.exoplayer2t.metadata.id3.TextInformationFrame;
...
final class MetadataUtil {
    ...
    */
    private static com.google.android.exoplayer2t.metadata.id3.TextInformationFrame parseStandardGenreAttribute(com.google.android.exoplayer2t.util.ParsableByteArray r3) {
        /*
            int r3 = parseUint8AttributeValue(r3)
            r0 = 0
            if (r3 <= 0) goto L11
            java.lang.String[] r1 = com.google.android.exoplayer2t.extractor.mp4.MetadataUtil.STANDARD_GENRES
            int r2 = r1.length
            if (r3 > r2) goto L11
            int r3 = r3 + (-1)
            r3 = r1[r3]
        ...
        L12:
            if (r3 == 0) goto L1c
            com.google.android.exoplayer2t.metadata.id3.TextInformationFrame r1 = new com.google.android.exoplayer2t.metadata.id3.TextInformationFrame
        ...
        L1c:
            ...
            com.google.android.exoplayer2t.util.Log.w(r3, r1)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2t.extractor.mp4.MetadataUtil.parseStandardGenreAttribute(com.google.android.exoplayer2t.util.ParsableByteArray):com.google.android.exoplayer2t.metadata.id3.TextInformationFrame");
    }
