...
public final class DefaultExtractorInput implements ExtractorInput {
    ...
    private byte[] peekBuffer = new byte[MessagesController.UPDATE_MASK_CHECK];
    ...
    @Override // com.google.android.exoplayer2t.extractor.ExtractorInput
    ...
    private void ensureSpaceForPeek(int i) {
        ...
        if (i2 > bArr.length) {
            this.peekBuffer = Arrays.copyOf(this.peekBuffer, Util.constrainValue(bArr.length * 2, MessagesController.UPDATE_MASK_CHECK + i2, i2 + MessagesController.UPDATE_MASK_CHAT_SHOW_SPAM));
        }
    }
    ...
    private void updatePeekBuffer(int i) {
        ...
        this.peekBufferPosition = 0;
        byte[] bArr = this.peekBuffer;
        byte[] bArr2 = i2 < bArr.length - MessagesController.UPDATE_MASK_CHAT_SHOW_SPAM ? new byte[MessagesController.UPDATE_MASK_CHECK + i2] : bArr;
