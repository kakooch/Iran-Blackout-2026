package com.google.android.exoplayer2t.text.dvb;
...
final class DvbParser {
    ...
    public List<Cue> decode(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < sparseArray2.size(); i4++) {
            ...
            Bitmap bitmapCreateBitmap2 = Bitmap.createBitmap(this.bitmap, i5, i6, regionComposition.width, regionComposition.height);
            int i9 = displayDefinition.width;
            float f = i5 / i9;
            int i10 = displayDefinition.height;
            arrayList.add(new Cue(bitmapCreateBitmap2, f, 0, i6 / i10, 0, regionComposition.width / i9, regionComposition.height / i10));
    ...
    */
    private static int paint2BitPixelCodeString(com.google.android.exoplayer2t.util.ParsableBitArray r13, int[] r14, byte[] r15, int r16, int r17, android.graphics.Paint r18, android.graphics.Canvas r19) {
        /*
            r0 = r13
            r1 = r17
            r8 = r18
        ...
        L83:
            ...
            goto L9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2t.text.dvb.DvbParser.paint2BitPixelCodeString(com.google.android.exoplayer2t.util.ParsableBitArray, int[], byte[], int, int, android.graphics.Paint, android.graphics.Canvas):int");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static int paint4BitPixelCodeString(com.google.android.exoplayer2t.util.ParsableBitArray r13, int[] r14, byte[] r15, int r16, int r17, android.graphics.Paint r18, android.graphics.Canvas r19) {
        /*
            r0 = r13
            r1 = r17
            r8 = r18
        ...
        L8e:
            ...
            goto L9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2t.text.dvb.DvbParser.paint4BitPixelCodeString(com.google.android.exoplayer2t.util.ParsableBitArray, int[], byte[], int, int, android.graphics.Paint, android.graphics.Canvas):int");
    }
