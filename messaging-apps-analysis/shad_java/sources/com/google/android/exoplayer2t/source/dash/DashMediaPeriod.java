...
import com.google.android.exoplayer2t.source.chunk.ChunkSampleStream;
...
import com.google.android.exoplayer2t.source.dash.manifest.Descriptor;
...
final class DashMediaPeriod implements MediaPeriod, SequenceableLoader.Callback<ChunkSampleStream<DashChunkSource>>, ChunkSampleStream.ReleaseCallback<DashChunkSource> {
    ...
    @Override // com.google.android.exoplayer2t.source.chunk.ChunkSampleStream.ReleaseCallback
    ...
    private static int buildPrimaryAndEmbeddedTrackGroupInfos(DrmSessionManager<?> drmSessionManager, List<AdaptationSet> list, int[][] iArr, int i, boolean[] zArr, Format[][] formatArr, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr) {
        ...
        while (i4 < i) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                Format formatCopyWithExoMediaCryptoType = ((Representation) arrayList.get(i7)).format;
                ...
                formatArr2[i7] = formatCopyWithExoMediaCryptoType;
            }
