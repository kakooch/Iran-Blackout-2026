...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    private static class SmoothStreamingMediaParser extends ElementParser {
        ...
        @Override // com.google.android.exoplayer2t.source.smoothstreaming.manifest.SsManifestParser.ElementParser
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (iIntValue == 2) {
                this.format = Format.createVideoContainerFormat(attributeValue, str, "video/mp4", strFourCCToMimeType, null, null, requiredInt, parseRequiredInt(xmlPullParser, "MaxWidth"), parseRequiredInt(xmlPullParser, "MaxHeight"), -1.0f, buildCodecSpecificData(xmlPullParser.getAttributeValue(null, "CodecPrivateData")), 0, 0);
                return;
            }
            if (iIntValue != 1) {
                if (iIntValue == 3) {
                    ...
                    str2.hashCode();
                    this.format = Format.createTextContainerFormat(attributeValue, str, "application/mp4", strFourCCToMimeType, null, requiredInt, 0, !str2.equals("CAPT") ? !str2.equals("DESC") ? 0 : 1024 : 64, (String) getNormalizedAttribute("Language"));
                    return;
                }
            ...
            List<byte[]> listBuildCodecSpecificData = buildCodecSpecificData(xmlPullParser.getAttributeValue(null, "CodecPrivateData"));
