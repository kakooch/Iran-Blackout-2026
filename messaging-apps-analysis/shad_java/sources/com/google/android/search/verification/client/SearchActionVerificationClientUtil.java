    ...
    public static boolean isPackageGoogleSigned(Context context, String pkg) {
        try {
            ...
            if (signatureArr != null && signatureArr.length == 1) {
                ...
                Log.d("SAVerificationClientU", String.format("Package %s GSA signed status %s AssistantGo signed status %s", pkg, Boolean.valueOf(zEquals), Boolean.valueOf(zEquals2)));
