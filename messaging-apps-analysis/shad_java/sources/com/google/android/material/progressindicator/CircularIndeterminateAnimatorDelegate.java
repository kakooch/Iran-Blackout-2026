...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DELAY_TO_FADE_IN_MS = {CloseCodes.NORMAL_CLOSURE, 2350, 3700, 5050};
    ...
    private void maybeUpdateSegmentColors(int i) {
        for (int i2 = 0; i2 < 4; i2++) {
            float fractionInRange = getFractionInRange(i, DELAY_TO_FADE_IN_MS[i2], MessageObject.TYPE_BANNED_MESSAGE);
