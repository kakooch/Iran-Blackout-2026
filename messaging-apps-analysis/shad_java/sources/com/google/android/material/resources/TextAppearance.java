...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int i) throws Resources.NotFoundException {
        ...
        MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, R$styleable.TextAppearance_android_textColorHint);
        MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, R$styleable.TextAppearance_android_textColorLink);
