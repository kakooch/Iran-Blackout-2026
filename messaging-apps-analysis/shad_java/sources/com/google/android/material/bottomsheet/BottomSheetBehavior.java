...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.4
            ...
            public void onViewReleased(View view, float f, float f2) {
                ...
                if (f2 < 0.0f) {
                    if (BottomSheetBehavior.this.fitToContents) {
                        ...
                        if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                            if (BottomSheetBehavior.this.shouldExpandOnUpwardDrag(jCurrentTimeMillis, (top * 100.0f) / r11.parentHeight)) {
                ...
                bottomSheetBehavior4.startSettlingAnimation(view, i, expandedOffset, bottomSheetBehavior4.shouldSkipSmoothAnimation());
            }
    ...
    */
    ...
    private float getYVelocity() {
        ...
        velocityTracker.computeCurrentVelocity(CloseCodes.NORMAL_CLOSURE, this.maximumVelocity);
    ...
    private void updateAccessibilityActions() {
        ...
        ViewCompat.removeAccessibilityAction(v, MessagesController.UPDATE_MASK_CHAT_SHOW_SPAM);
        ViewCompat.removeAccessibilityAction(v, MessagesController.UPDATE_MASK_CHAT_MUTE);
