        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.of("proto"))) {
                    ...
                    builderProtoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName(Utf8Charset.NAME)));
                } else {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.d("CctTransportBackend", "Content-Type: %s", httpURLConnection.getHeaderField(HttpHeaders.CONTENT_TYPE));
            ...
            return new HttpResponse(HttpStatus.HTTP_INTERNAL_SERVER_ERROR, null, 0L);
