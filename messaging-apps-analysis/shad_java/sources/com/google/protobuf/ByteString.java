        ...
        new Comparator<ByteString>() { // from class: com.google.protobuf.ByteString.2
            ...
            public int compare(ByteString byteString, ByteString byteString2) {
                ...
                while (Iterator2.hasNext() && Iterator22.hasNext()) {
                    int iM = KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(ByteString.toInt(Iterator2.nextByte()), ByteString.toInt(Iterator22.nextByte()));
                    if (iM != 0) {
                        return iM;
                    }
                }
                return KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(byteString.size(), byteString2.size());
            }
        };
    }
