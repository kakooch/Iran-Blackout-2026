...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{HttpStatus.HTTP_INTERNAL_SERVER_ERROR, 509}, "GB");
            add(new int[]{520}, "GR");
            add(new int[]{528}, "LB");
            add(new int[]{529}, "CY");
            add(new int[]{531}, "MK");
            ...
            add(new int[]{MediaController.MAX_WIDTH_HEIGHT_SIZE, 839}, "IT");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{DBHelper.GET_STICKER_LIMIT, 919}, "AT");
