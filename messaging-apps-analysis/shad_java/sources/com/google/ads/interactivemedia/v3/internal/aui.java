...
public final class aui {
    ...
    public final aui a(Object obj, Object obj2) {
        c(obj, obj2);
        return this;
    }
        ...
        if (this.a == 0 && obj != obj2) {
            ...
            if (obj instanceof int[]) {
                ...
                while (i < iArr.length && this.a == 0) {
                    this.a = KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(iArr[i], iArr2[i]);
                    i++;
                }
                return;
            }
            if (obj instanceof short[]) {
                ...
                while (i < sArr.length && this.a == 0) {
                    this.a = aui$$ExternalSyntheticBackport2.m(sArr[i], sArr2[i]);
                    i++;
                }
                return;
            }
            if (obj instanceof char[]) {
                ...
                while (i < cArr.length && this.a == 0) {
                    this.a = aui$$ExternalSyntheticBackport1.m(cArr[i], cArr2[i]);
                    i++;
                }
                return;
            }
            if (obj instanceof byte[]) {
                ...
                while (i < bArr.length && this.a == 0) {
                    this.a = aui$$ExternalSyntheticBackport0.m(bArr[i], bArr2[i]);
                    i++;
                }
                return;
            }
