...
public class CrashlyticsReportPersistence {
    ...
    public void persistReport(CrashlyticsReport crashlyticsReport) {
        ...
        try {
            ...
            writeTextFile(this.fileStore.getSessionFile(identifier, "start-time"), BuildConfig.FLAVOR, session.getStartedAt());
        } catch (IOException e) {
    ...
    private static String generateEventFilename(int i, boolean z) {
        return "event" + String.format(Locale.US, "%010d", Integer.valueOf(i)) + (z ? "_" : BuildConfig.FLAVOR);
    }
