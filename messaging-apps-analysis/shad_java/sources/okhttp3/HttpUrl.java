...
public final class HttpUrl {
    ...
    public String redact() {
        return newBuilder("/...").username(BuildConfig.FLAVOR).password(BuildConfig.FLAVOR).build().toString();
    }
    ...
    public static final class Builder {
        ...
        Builder parse(HttpUrl httpUrl, String str) throws NumberFormatException {
            ...
            if (iDelimiterOffset3 < iSkipTrailingAsciiWhitespace && str.charAt(iDelimiterOffset3) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, 1 + iDelimiterOffset3, iSkipTrailingAsciiWhitespace, BuildConfig.FLAVOR, true, false, false, false, null);
            }
            return this;
        }
        ...
        private static int parsePort(String str, int i, int i2) throws NumberFormatException {
            int i3;
            try {
                i3 = Integer.parseInt(HttpUrl.canonicalize(str, i, i2, BuildConfig.FLAVOR, false, false, false, true, null));
