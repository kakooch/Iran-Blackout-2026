...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(com.facebook.stetho.server.http.HttpHeaders.CONTENT_TYPE), response.body().contentLength(), Okio.buffer(new Source(this) { // from class: okhttp3.internal.cache.CacheInterceptor.1
    ...
    static boolean isContentSpecificHeader(String str) {
        return com.facebook.stetho.server.http.HttpHeaders.CONTENT_LENGTH.equalsIgnoreCase(str) || "Content-Encoding".equalsIgnoreCase(str) || com.facebook.stetho.server.http.HttpHeaders.CONTENT_TYPE.equalsIgnoreCase(str);
    }
}
