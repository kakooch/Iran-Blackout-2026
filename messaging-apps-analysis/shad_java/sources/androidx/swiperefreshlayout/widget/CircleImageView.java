...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        this.mBackgroundColor = typedArrayObtainStyledAttributes.getColor(R$styleable.SwipeRefreshLayout_swipeRefreshLayoutProgressSpinnerBackgroundColor, -328966);
