...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private boolean hasVoiceSearch() {
        ...
        return (intent == null || getContext().getPackageManager().resolveActivity(intent, MessagesController.UPDATE_MASK_CHECK) == null) ? false : true;
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = inputType | MessagesController.UPDATE_MASK_CHECK | MessagesController.UPDATE_MASK_CHAT_SHOW_SPAM;
            }
        }
