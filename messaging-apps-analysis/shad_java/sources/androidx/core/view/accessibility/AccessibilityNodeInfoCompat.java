...
public class AccessibilityNodeInfoCompat {
    ...
    private static String getActionSymbolicName(int i) {
        ...
        switch (i) {
            ...
            case MessagesController.UPDATE_MASK_CHAT_MUTE /* 262144 */:
                return "ACTION_EXPAND";
            case MessagesController.UPDATE_MASK_CHAT_SHOW_SPAM /* 524288 */:
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            new AccessibilityActionCompat(MessagesController.UPDATE_MASK_CHECK, null);
            new AccessibilityActionCompat(MessagesController.UPDATE_MASK_REORDER, (CharSequence) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) AccessibilityViewCommand.SetSelectionArguments.class);
            ACTION_EXPAND = new AccessibilityActionCompat(MessagesController.UPDATE_MASK_CHAT_MUTE, null);
            ACTION_COLLAPSE = new AccessibilityActionCompat(MessagesController.UPDATE_MASK_CHAT_SHOW_SPAM, null);
