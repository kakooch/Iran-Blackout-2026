...
public final class BidiFormatter {
    ...
    private String markAfter(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        ...
        if (this.mIsRtlContext || !(zIsRtl || getExitDir(charSequence) == 1)) {
            return this.mIsRtlContext ? (!zIsRtl || getExitDir(charSequence) == -1) ? RLM_STRING : BuildConfig.FLAVOR : BuildConfig.FLAVOR;
        }
        return LRM_STRING;
    }
    ...
    private String markBefore(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        ...
        if (this.mIsRtlContext || !(zIsRtl || getEntryDir(charSequence) == 1)) {
            return this.mIsRtlContext ? (!zIsRtl || getEntryDir(charSequence) == -1) ? RLM_STRING : BuildConfig.FLAVOR : BuildConfig.FLAVOR;
        }
        return LRM_STRING;
    }
