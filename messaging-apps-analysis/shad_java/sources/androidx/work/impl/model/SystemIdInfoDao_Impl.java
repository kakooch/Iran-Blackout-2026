...
public final class SystemIdInfoDao_Impl implements SystemIdInfoDao {
    ...
    public SystemIdInfoDao_Impl(RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfSystemIdInfo = new EntityInsertionAdapter<SystemIdInfo>(this, __db) { // from class: androidx.work.impl.model.SystemIdInfoDao_Impl.1
        ...
        this.__preparedStmtOfRemoveSystemIdInfo = new SharedSQLiteStatement(this, __db) { // from class: androidx.work.impl.model.SystemIdInfoDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
