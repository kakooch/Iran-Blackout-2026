...
public class ConstraintLayout extends ViewGroup {
    ...
    public ConstraintLayout(Context context) throws XmlPullParserException, IOException {
        ...
        this.mMinWidth = 0;
        this.mMinHeight = 0;
        this.mMaxWidth = ConnectionsManager.DEFAULT_DATACENTER_ID;
        this.mMaxHeight = ConnectionsManager.DEFAULT_DATACENTER_ID;
    ...
    */
    ...
    public void resolveMeasuredDimension(int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            if (z) {
                iMin |= ConnectionsManager.FileTypePhoto;
            }
            if (z2) {
                iMin2 |= ConnectionsManager.FileTypePhoto;
            }
