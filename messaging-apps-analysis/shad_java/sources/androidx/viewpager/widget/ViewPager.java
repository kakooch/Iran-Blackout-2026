...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
            ...
            if (i4 < i5) {
                ...
                while (true) {
                    ...
                    while (i4 < itemInfo4.position) {
                        pageWidth += this.mAdapter.getPageWidth(i4) + f;
                        i4++;
                    }
        ...
        int i8 = i7 - 1;
        this.mFirstOffset = i7 == 0 ? pageWidth3 : -3.4028235E38f;
        int i9 = count - 1;
        this.mLastOffset = i7 == i9 ? (itemInfo.widthFactor + pageWidth3) - 1.0f : Float.MAX_VALUE;
        int i10 = i - 1;
        while (i10 >= 0) {
        ...
        while (i12 < size2) {
            ...
            while (true) {
                ...
                pageWidth4 += this.mAdapter.getPageWidth(i11) + f;
                i11++;
            }
            if (i2 == i9) {
    ...
    */
    ...
    public void endFakeDrag() throws Resources.NotFoundException {
        ...
        if (this.mAdapter != null) {
            VelocityTracker velocityTracker = this.mVelocityTracker;
            velocityTracker.computeCurrentVelocity(CloseCodes.NORMAL_CLOSURE, this.mMaximumVelocity);
