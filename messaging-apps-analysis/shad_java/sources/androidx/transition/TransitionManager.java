...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo139clone = transition.mo139clone();
        transitionMo139clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo139clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo139clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo139clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo139clone = transition.mo139clone();
        sceneChangeSetup(viewGroup, transitionMo139clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo139clone);
    }
