...
public class ExifInterface {
    ...
    static {
        ...
        IFD_FORMAT_NAMES = new String[]{BuildConfig.FLAVOR, "BYTE", "STRING", "USHORT", "ULONG", "URATIONAL", "SBYTE", "UNDEFINED", "SSHORT", "SLONG", "SRATIONAL", "SINGLE", "DOUBLE", "IFD"};
    ...
    */
    ...
    private void handleThumbnailFromStrips(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap map) throws IOException {
        ...
        int i3 = 0;
        int i4 = 0;
        while (i2 < jArrConvertToLongArray.length) {
            int i5 = (int) jArrConvertToLongArray[i2];
            int i6 = (int) jArrConvertToLongArray2[i2];
            if (i2 < jArrConvertToLongArray.length - i && i5 + i6 != jArrConvertToLongArray[i2 + 1]) {
        ...
        if (this.mAreThumbnailStripsConsecutive) {
            long j4 = jArrConvertToLongArray[0];
        }
    }
