...
public final class HttpLoggingMessanger implements Interceptor {
    ...
    public interface Logger {
        public static final HttpLoggingInterceptor.Logger DEFAULT = new HttpLoggingInterceptor.Logger() { // from class: ir.resaneh1.iptv.apiMessanger.HttpLoggingMessanger.Logger.1
    ...
    public HttpLoggingMessanger(int i) {
        this(i, Logger.DEFAULT);
    }

    public HttpLoggingMessanger(int i, HttpLoggingInterceptor.Logger logger) {
                ...
                if (!z3 || !okhttp3.internal.http.HttpHeaders.hasBody(responseProceed)) {
                    ...
                    if (j != 0) {
                        ...
                        if (requestBodyBody != null) {
                            ...
                            requestBodyBody.writeTo(buffer3);
                            this.logger.log(buffer3.readString(charset2));
                        }
                    }
