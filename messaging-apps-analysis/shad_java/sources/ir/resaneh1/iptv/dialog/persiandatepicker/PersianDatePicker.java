...
import ir.resaneh1.iptv.dialog.persiandatepicker.util.PersianCalendar;
import ir.resaneh1.iptv.dialog.persiandatepicker.util.PersianCalendarConstants;
import ir.resaneh1.iptv.dialog.persiandatepicker.util.PersianCalendarUtils;
import ir.resaneh1.iptv.dialog.persiandatepicker.util.PersianHelper;
...
class PersianDatePicker extends LinearLayout {
    ...
    private void updateVariablesFromXml(Context context, AttributeSet attributeSet) {
        ...
        this.yearRange = typedArrayObtainStyledAttributes.getInteger(7, 10);
        this.minYear = typedArrayObtainStyledAttributes.getInt(3, this.pCalendar.getPersianYear() - this.yearRange);
        this.maxYear = typedArrayObtainStyledAttributes.getInt(2, this.pCalendar.getPersianYear() + this.yearRange);
        this.displayMonthNames = typedArrayObtainStyledAttributes.getBoolean(1, false);
        this.displayDescription = typedArrayObtainStyledAttributes.getBoolean(0, false);
        this.selectedDay = typedArrayObtainStyledAttributes.getInteger(4, this.pCalendar.getPersianDay());
        this.selectedYear = typedArrayObtainStyledAttributes.getInt(6, this.pCalendar.getPersianYear());
        this.selectedMonth = typedArrayObtainStyledAttributes.getInteger(5, this.pCalendar.getPersianMonth());
        int i = this.minYear;
    ...
    public PersianDatePicker(Context context, AttributeSet attributeSet, int i) throws IllegalAccessException, IllegalArgumentException {
        ...
        this.dateChangeListener = new NumberPicker.OnValueChangeListener() { // from class: ir.resaneh1.iptv.dialog.persiandatepicker.PersianDatePicker.4
        ...
        View viewInflate = LayoutInflater.from(context).inflate(ir.medu.shad.R.layout.persian__date_picker, this);
        this.yearNumberPicker = (PersianNumberPicker) viewInflate.findViewById(ir.medu.shad.R.id.yearNumberPicker);
        this.monthNumberPicker = (PersianNumberPicker) viewInflate.findViewById(ir.medu.shad.R.id.monthNumberPicker);
        this.dayNumberPicker = (PersianNumberPicker) viewInflate.findViewById(ir.medu.shad.R.id.dayNumberPicker);
        this.descriptionTextView = (TextView) viewInflate.findViewById(ir.medu.shad.R.id.descriptionTextView);
        this.yearNumberPicker.setFormatter(new NumberPicker.Formatter(this) { // from class: ir.resaneh1.iptv.dialog.persiandatepicker.PersianDatePicker.1
            @Override // android.widget.NumberPicker.Formatter
            public String format(int i2) {
                return PersianHelper.toPersianNumber(i2 + BuildConfig.FLAVOR);
            }
        });
        this.monthNumberPicker.setFormatter(new NumberPicker.Formatter(this) { // from class: ir.resaneh1.iptv.dialog.persiandatepicker.PersianDatePicker.2
            @Override // android.widget.NumberPicker.Formatter
            public String format(int i2) {
                return PersianHelper.toPersianNumber(i2 + BuildConfig.FLAVOR);
            }
        });
        this.dayNumberPicker.setFormatter(new NumberPicker.Formatter(this) { // from class: ir.resaneh1.iptv.dialog.persiandatepicker.PersianDatePicker.3
            @Override // android.widget.NumberPicker.Formatter
            public String format(int i2) {
                return PersianHelper.toPersianNumber(i2 + BuildConfig.FLAVOR);
            }
    ...
    static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: ir.resaneh1.iptv.dialog.persiandatepicker.PersianDatePicker.SavedState.1
