...
import ir.appp.rghapp.video.Track;
...
public class Track {
    ...
    public void prepare() {
        ...
        Collections.sort(this.samplePresentationTimes, new Comparator() { // from class: ir.appp.rghapp.video.Track$$ExternalSyntheticLambda0
