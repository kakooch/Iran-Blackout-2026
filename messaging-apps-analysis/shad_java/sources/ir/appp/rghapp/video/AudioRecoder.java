...
public class AudioRecoder {
    ...
    public AudioRecoder(MediaFormat mediaFormat, MediaExtractor mediaExtractor, int i) throws IOException {
        ...
        MediaFormat mediaFormatCreateAudioFormat = MediaFormat.createAudioFormat(MediaController.AUIDO_MIME_TYPE, mediaFormat.getInteger("sample-rate"), mediaFormat.getInteger("channel-count"));
        this.format = mediaFormatCreateAudioFormat;
        mediaFormatCreateAudioFormat.setInteger("bitrate", MessagesController.UPDATE_MASK_CHECK);
    ...
    public boolean step(MP4Builder mP4Builder, int i) throws Exception {
        ...
        if (this.pendingAudioDecoderOutputBufferIndex != -1 && (iDequeueInputBuffer = this.encoder.dequeueInputBuffer(2500L)) != -1) {
            ...
            if (i2 >= 0) {
                ...
                byteBufferDuplicate.limit(this.decoderOutputBufferInfo.offset + i2);
                byteBuffer.position(0);
                byteBuffer.put(byteBufferDuplicate);
                this.encoder.queueInputBuffer(iDequeueInputBuffer, 0, i2, j2, this.decoderOutputBufferInfo.flags);
            }
            ...
            if (iDequeueOutputBuffer == -3) {
                ...
                if ((bufferInfo2.flags & 2) != 0) {
                    ...
                    if (bufferInfo2.size != 0) {
                        mP4Builder.writeSampleData(i, byteBuffer2, bufferInfo2, false);
                    }
