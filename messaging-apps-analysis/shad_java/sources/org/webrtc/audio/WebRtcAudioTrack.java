    ...
    private int initPlayout(int i, int i2, double d) {
        ...
        try {
            if (this.useLowLatency && Build.VERSION.SDK_INT >= 26) {
                this.audioTrack = createAudioTrackOnOreoOrHigher(i, iChannelCountToConfiguration, i3, this.audioAttributes);
            } else if (Build.VERSION.SDK_INT >= 21) {
                this.audioTrack = createAudioTrackOnLollipopOrHigher(i, iChannelCountToConfiguration, i3, this.audioAttributes);
            } else {
                this.audioTrack = createAudioTrackOnLowerThanLollipop(i, iChannelCountToConfiguration, i3);
            }
