...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    static class WifiManagerDelegate {
        ...
        String getWifiSSID() {
            ...
            return (intentRegisterReceiver == null || (wifiInfo = (WifiInfo) intentRegisterReceiver.getParcelableExtra("wifiInfo")) == null || (ssid = wifiInfo.getSSID()) == null) ? BuildConfig.FLAVOR : ssid;
        }
    }
    ...
    private String getWifiSSID(NetworkState networkState) {
        return getConnectionType(networkState) != NetworkChangeDetector.ConnectionType.CONNECTION_WIFI ? BuildConfig.FLAVOR : this.wifiManagerDelegate.getWifiSSID();
    }
