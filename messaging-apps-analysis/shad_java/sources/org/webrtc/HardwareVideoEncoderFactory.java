...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    public VideoEncoder createEncoder(VideoCodecInfo videoCodecInfo) {
        ...
        if (Build.VERSION.SDK_INT < 19 || (mediaCodecInfoFindCodecForType = findCodecForType((videoCodecMimeTypeValueOf = VideoCodecMimeType.valueOf(videoCodecInfo.name)))) == null) {
            return null;
        }
