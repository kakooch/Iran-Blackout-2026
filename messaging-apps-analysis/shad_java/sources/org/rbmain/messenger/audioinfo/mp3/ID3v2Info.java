    ...
    */
    public static boolean isID3v2StartPosition(java.io.InputStream r2) throws java.io.IOException {
        ...
        L23:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.messenger.audioinfo.mp3.ID3v2Info.isID3v2StartPosition(java.io.InputStream):boolean");
    }

    public ID3v2Info(InputStream inputStream, Level level) throws ID3v2Exception, IOException {
        ID3v2DataInput data;
    ...
    void parseFrame(ID3v2FrameBody iD3v2FrameBody) throws ID3v2Exception, IOException {
        String str;
        byte b;
        int i;
        Logger logger = LOGGER;
        ...
        switch (frameId) {
            ...
            case "COMM":
                ...
                if (this.comment == null || (str = commentOrUnsynchronizedLyricsFrame.description) == null || BuildConfig.FLAVOR.equals(str)) {
    ...
    String parseTextFrame(ID3v2FrameBody iD3v2FrameBody) throws ID3v2Exception, IOException {
        return iD3v2FrameBody.readFixedLengthString((int) iD3v2FrameBody.getRemainingLength(), iD3v2FrameBody.readEncoding());
    }

    CommentOrUnsynchronizedLyrics parseCommentOrUnsynchronizedLyricsFrame(ID3v2FrameBody iD3v2FrameBody) throws ID3v2Exception, IOException {
    ...
    AttachedPicture parseAttachedPictureFrame(ID3v2FrameBody iD3v2FrameBody) throws ID3v2Exception, IOException {
