...
public class ID3v2FrameBody {
    static final ThreadLocal<Buffer> textBuffer = new ThreadLocal<Buffer>() { // from class: org.rbmain.messenger.audioinfo.mp3.ID3v2FrameBody.1
    ...
    public String readZeroTerminatedString(int i, ID3v2Encoding iD3v2Encoding) throws ID3v2Exception, IOException {
    ...
    public String readFixedLengthString(int i, ID3v2Encoding iD3v2Encoding) throws ID3v2Exception, IOException {
