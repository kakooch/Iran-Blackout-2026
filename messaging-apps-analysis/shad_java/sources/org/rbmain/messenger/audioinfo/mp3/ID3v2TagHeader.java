...
public class ID3v2TagHeader {
    ...
    public ID3v2TagHeader(InputStream inputStream) throws ID3v2Exception, IOException {
        this(new PositionInputStream(inputStream));
    }

    ID3v2TagHeader(PositionInputStream positionInputStream) throws ID3v2Exception, IOException {
        this.version = 0;
        this.revision = 0;
        this.headerSize = 0;
        this.totalTagSize = 0;
    ...
    public ID3v2TagBody tagBody(InputStream inputStream) throws ID3v2Exception, IOException {
        if (this.compression) {
