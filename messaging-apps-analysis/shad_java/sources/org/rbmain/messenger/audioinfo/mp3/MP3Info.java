...
import org.rbmain.messenger.audioinfo.mp3.MP3Frame;
...
public class MP3Info extends AudioInfo {
    ...
    public MP3Info(InputStream inputStream, long j) throws ID3v2Exception, IOException, MP3Exception {
        this(inputStream, j, Level.FINEST);
    }

    public MP3Info(InputStream inputStream, long j, Level level) throws ID3v2Exception, IOException, MP3Exception {
        this.brand = "MP3";
        ...
        if (j2 <= 0 || j2 >= 3600000) {
            try {
                this.duration = calculateDuration(mP3Input, j, new StopReadCondition(this, j) { // from class: org.rbmain.messenger.audioinfo.mp3.MP3Info.1
                    ...
                    @Override // org.rbmain.messenger.audioinfo.mp3.MP3Info.StopReadCondition
