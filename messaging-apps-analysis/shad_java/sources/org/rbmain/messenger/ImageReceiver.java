...
import org.rbmain.ui.Components.AttachableDrawable;
import org.rbmain.ui.Components.AvatarDrawable;
import org.rbmain.ui.Components.ClipRoundedDrawable;
import org.rbmain.ui.Components.RLottieDrawable;
import org.rbmain.ui.Components.RecyclableDrawable;
import org.rbmain.ui.Components.VectorAvatarThumbDrawable;
...
public class ImageReceiver implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface ImageReceiverDelegate {
        ...
        /* renamed from: org.rbmain.messenger.ImageReceiver$ImageReceiverDelegate$-CC, reason: invalid class name */
    ...
    public void setImage(PhotoViewerObject photoViewerObject, String str, Drawable drawable, String str2, int i) {
        setImage(ImageLocation.getForPhotoViewerObject(photoViewerObject), str, drawable, i, str2, (Object) null, 1);
    }
    ...
    /* JADX WARN: Type inference failed for: r12v3, types: [org.rbmain.tgnet.TLRPC$VideoSize] */
    /* JADX WARN: Type inference failed for: r5v18 */
    /* JADX WARN: Type inference failed for: r5v19 */
    /* JADX WARN: Type inference failed for: r5v4, types: [org.rbmain.tgnet.TLRPC$VideoSize] */
    ...
    public void setForUserOrChat(TLObject tLObject, Drawable drawable, Object obj, boolean z, int i) {
        ...
        if (tLObject instanceof TLRPC$User) {
            ...
            if (tLRPC$UserProfilePhoto != null) {
                ...
                if (i == 3) {
                    MessagesController.getInstance(this.currentAccount).getUserFull(tLRPC$User.id);
                }
                if (z && MessagesController.getInstance(this.currentAccount).isPremiumUser(tLRPC$User) && tLRPC$User.photo.has_video && LiteMode.isEnabled(1024)) {
                    ...
                    if (userFull == null) {
                        ...
                        if (tLRPC$Photo != null && (arrayList = tLRPC$Photo.video_sizes) != null && !arrayList.isEmpty()) {
                            ...
                            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                                TLRPC$VideoSize tLRPC$VideoSize = arrayList.get(i2);
                                if ("p".equals(tLRPC$VideoSize.type)) {
                                    closestVideoSizeWithSize = tLRPC$VideoSize;
                                }
                            ...
                            forPhoto = ImageLocation.getForPhoto(closestVideoSizeWithSize, tLRPC$Photo);
            ...
            imageLocation3 = forPhoto;
            z2 = z4;
            drawable2 = imageLocation4;
            r5 = imageLocation;
        } else {
            if (!(tLObject instanceof TLRPC$Chat) || (tLRPC$ChatPhoto = ((TLRPC$Chat) tLObject).photo) == null) {
                ...
                BitmapDrawable bitmapDrawable = tLRPC$ChatPhoto.strippedBitmap;
        ...
        if (r5 != 0 && i != 0) {
            setImageBitmap(new VectorAvatarThumbDrawable(r5, z3, i));
            return;
        }
        ImageLocation forUserOrChat = ImageLocation.getForUserOrChat(tLObject, 1);
        if (imageLocation3 != null) {
            setImage(imageLocation3, "avatar", forUserOrChat, "50_50", null, null, drawable2, 0L, null, obj3, 0);
            this.animatedFileDrawableRepeatMaxCount = 3;
        } else if (drawable2 != null) {
            setImage(forUserOrChat, "50_50", drawable2, null, obj3, 0);
        } else if (z2) {
            setImage(forUserOrChat, "50_50", ImageLocation.getForUserOrChat(tLObject, 2), "50_50_b", drawable, obj3, 0);
        } else {
            setImage(forUserOrChat, "50_50", drawable, null, obj3, 0);
        }
    }
    ...
    protected void drawDrawable(Canvas canvas, Drawable drawable, int i, BitmapShader bitmapShader, int i2, int i3, int i4, BackgroundThreadDrawHolder backgroundThreadDrawHolder) {
        ...
        if (drawable instanceof BitmapDrawable) {
            ...
            if (bitmapShader != null && backgroundThreadDrawHolder == null) {
                if (this.isAspectFit) {
                    ...
                    float fMin = 1.0f / Math.min(f9, f5);
                    ...
                    if (this.isVisible) {
                        ...
                        if (this.composeShader != null) {
                            ...
                            float fMin2 = 1.0f / Math.min(f14 == 0.0f ? 1.0f : width / f7, f3 == 0.0f ? 1.0f : height / f8);
                            this.shaderMatrix.reset();
                ...
                float f28 = f4;
                if (this.isAspectFit) {
                    float fMax2 = Math.max(f9, f5);
                    canvas.save();
                    int i15 = (int) (intrinsicHeight / fMax2);
                    int i16 = (int) (i14 / fMax2);
                    if (backgroundThreadDrawHolder == null) {
                        float f29 = i15;
                        float f30 = i16;
        ...
        if (backgroundThreadDrawHolder == null) {
            if (this.isAspectFit) {
                ...
                float fMax3 = Math.max(f34 != 0.0f ? intrinsicWidth2 / (f34 - (f35 * 2.0f)) : 1.0f, f3 == 0.0f ? 1.0f : intrinsicHeight2 / (f3 - (f35 * 2.0f)));
                float f36 = (int) (intrinsicWidth2 / fMax3);
                float f37 = (int) (intrinsicHeight2 / fMax3);
    ...
    private void checkAlphaAnimation(boolean z, BackgroundThreadDrawHolder backgroundThreadDrawHolder) {
        ...
        if (f != 1.0f) {
            ...
            if (backgroundThreadDrawHolder != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.ImageReceiver$$ExternalSyntheticLambda0
    ...
    */
    public boolean draw(android.graphics.Canvas r42, org.rbmain.messenger.ImageReceiver.BackgroundThreadDrawHolder r43) {
        /*
            Method dump skipped, instructions count: 1036
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.messenger.ImageReceiver.draw(android.graphics.Canvas, org.rbmain.messenger.ImageReceiver$BackgroundThreadDrawHolder):boolean");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public org.rbmain.messenger.ImageReceiver.BitmapHolder getBitmapSafe() {
        /*
            r5 = this;
            org.rbmain.ui.Components.AnimatedFileDrawable r0 = r5.getAnimation()
            org.rbmain.ui.Components.RLottieDrawable r1 = r5.getLottieAnimation()
            r2 = 0
            r3 = 0
            if (r1 == 0) goto L19
        ...
        L19:
            ...
            if (r3 == 0) goto L35
            org.rbmain.messenger.ImageReceiver$BitmapHolder r0 = new org.rbmain.messenger.ImageReceiver$BitmapHolder
        ...
        L37:
            ...
            if (r1 == 0) goto L4e
            boolean r1 = r0 instanceof org.rbmain.ui.Components.AnimatedFileDrawable
            if (r1 != 0) goto L4e
            boolean r1 = r0 instanceof org.rbmain.ui.Components.RLottieDrawable
            if (r1 != 0) goto L4e
        ...
        L4e:
            ...
            if (r4 == 0) goto L65
            boolean r4 = r1 instanceof org.rbmain.ui.Components.AnimatedFileDrawable
            if (r4 != 0) goto L65
            boolean r4 = r0 instanceof org.rbmain.ui.Components.RLottieDrawable
            if (r4 != 0) goto L65
        ...
        L65:
            ...
            boolean r4 = r1 instanceof org.rbmain.ui.Components.AnimatedFileDrawable
            if (r4 != 0) goto L7c
            boolean r0 = r0 instanceof org.rbmain.ui.Components.RLottieDrawable
            if (r0 != 0) goto L7c
            android.graphics.drawable.BitmapDrawable r1 = (android.graphics.drawable.BitmapDrawable) r1
            android.graphics.Bitmap r0 = r1.getBitmap()
        ...
        L8b:
            if (r0 == 0) goto L92
            org.rbmain.messenger.ImageReceiver$BitmapHolder r2 = new org.rbmain.messenger.ImageReceiver$BitmapHolder
            r2.<init>(r0, r1, r3)
        L92:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.messenger.ImageReceiver.getBitmapSafe():org.rbmain.messenger.ImageReceiver$BitmapHolder");
    }
    ...
    */
    protected boolean setImageBitmapByKey(android.graphics.drawable.Drawable r8, java.lang.String r9, int r10, boolean r11, int r12) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.messenger.ImageReceiver.setImageBitmapByKey(android.graphics.drawable.Drawable, java.lang.String, int, boolean, int):boolean");
    }
