...
public class DispatchQueuePoolBackground {
    ...
    private static final Runnable finishCollectUpdateRunnable = new Runnable() { // from class: org.rbmain.messenger.DispatchQueuePoolBackground.2
    ...
    private Runnable cleanupRunnable = new Runnable() { // from class: org.rbmain.messenger.DispatchQueuePoolBackground.1
        @Override // java.lang.Runnable
        public void run() {
    ...
    private void execute(ArrayList<Runnable> arrayList) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (runnable != null) {
                ...
                dispatchQueueRemove.postRunnable(new Runnable() { // from class: org.rbmain.messenger.DispatchQueuePoolBackground$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
    ...
    public /* synthetic */ void lambda$execute$1(Runnable runnable, final DispatchQueue dispatchQueue) {
        runnable.run();
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.messenger.DispatchQueuePoolBackground$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static void finishCollectUpdateRunnables() {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.messenger.DispatchQueuePoolBackground$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static /* synthetic */ void lambda$finishCollectUpdateRunnables$3(final ArrayList arrayList) {
        ...
        arrayList.clear();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.DispatchQueuePoolBackground$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
