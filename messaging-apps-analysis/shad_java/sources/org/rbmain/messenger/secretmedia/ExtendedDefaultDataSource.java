...
import com.google.android.exoplayer2t.upstream.ContentDataSource;
import com.google.android.exoplayer2t.upstream.DataSchemeDataSource;
import com.google.android.exoplayer2t.upstream.DataSource;
import com.google.android.exoplayer2t.upstream.DataSpec;
import com.google.android.exoplayer2t.upstream.DefaultHttpDataSource;
import com.google.android.exoplayer2t.upstream.FileDataSource;
import com.google.android.exoplayer2t.upstream.RawResourceDataSource;
...
import org.rbmain.messenger.FileStreamLoadOperation;
...
public final class ExtendedDefaultDataSource implements DataSource {
    ...
    private DataSource getRtmpDataSource() {
        if (this.rtmpDataSource == null) {
            try {
                DataSource dataSource = (DataSource) Class.forName("com.google.android.exoplayer2t.ext.rtmp.RtmpDataSource").getConstructor(new Class[0]).newInstance(new Object[0]);
