...
public class FastDateParser implements DateParser, Serializable {
    ...
    private static final Strategy ABBREVIATED_YEAR_STRATEGY = new NumberStrategy(1) { // from class: org.rbmain.messenger.time.FastDateParser.1
        @Override // org.rbmain.messenger.time.FastDateParser.NumberStrategy, org.rbmain.messenger.time.FastDateParser.Strategy
    ...
    private static final Strategy NUMBER_MONTH_STRATEGY = new NumberStrategy(2) { // from class: org.rbmain.messenger.time.FastDateParser.2
        @Override // org.rbmain.messenger.time.FastDateParser.NumberStrategy
        int modify(int i) {
            return i - 1;
        }
    };
    ...
    private static final Strategy MODULO_HOUR_OF_DAY_STRATEGY = new NumberStrategy(11) { // from class: org.rbmain.messenger.time.FastDateParser.3
        @Override // org.rbmain.messenger.time.FastDateParser.NumberStrategy
        int modify(int i) {
            return i % 24;
        }
    };
    private static final Strategy MODULO_HOUR_STRATEGY = new NumberStrategy(10) { // from class: org.rbmain.messenger.time.FastDateParser.4
        @Override // org.rbmain.messenger.time.FastDateParser.NumberStrategy
        int modify(int i) {
            return i % 12;
        }
    ...
    @Override // org.rbmain.messenger.time.DateParser, org.rbmain.messenger.time.DatePrinter
    ...
    @Override // org.rbmain.messenger.time.DateParser
    ...
    private static class CopyQuotedStrategy extends Strategy {
        ...
        @Override // org.rbmain.messenger.time.FastDateParser.Strategy
        boolean isNumber() {
