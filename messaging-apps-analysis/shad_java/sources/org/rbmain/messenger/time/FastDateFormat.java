...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    private static final FormatCache<FastDateFormat> cache = new FormatCache<FastDateFormat>() { // from class: org.rbmain.messenger.time.FastDateFormat.1
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // org.rbmain.messenger.time.FormatCache
    ...
    @Override // java.text.Format, org.rbmain.messenger.time.DatePrinter
    ...
    public String format(long j) {
        String str = this.printer.format(j);
        return getLocale() != null ? (getLocale().getLanguage().equals("fa") || getLocale().getLanguage().equals("ar")) ? NumberUtils.toPersian(str) : str : str;
    }
    ...
    @Override // java.text.Format, org.rbmain.messenger.time.DateParser
