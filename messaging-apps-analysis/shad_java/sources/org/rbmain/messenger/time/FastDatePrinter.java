...
public class FastDatePrinter implements DatePrinter, Serializable {
    ...
    @Override // org.rbmain.messenger.time.DatePrinter
    ...
    private GregorianCalendar newCalendar() {
        ...
        if (locale != null && locale.getLanguage().equals("fa")) {
            ...
            persianCalendar.setTimeZone(this.mTimeZone);
    ...
    private static class CharacterLiteral implements Rule {
        ...
        @Override // org.rbmain.messenger.time.FastDatePrinter.Rule
    ...
    private static class TextField implements Rule {
        ...
        @Override // org.rbmain.messenger.time.FastDatePrinter.Rule
        public void appendTo(StringBuffer stringBuffer, Calendar calendar) {
            if (calendar instanceof PersianCalendar) {
                int i = this.mField;
                if (i == 2) {
                    stringBuffer.append(this.mValues[((PersianCalendar) calendar).getPersianMonth() - 1]);
                    return;
                } else if (i == 1) {
                    stringBuffer.append(this.mValues[((PersianCalendar) calendar).getPersianYear()]);
                    return;
                } else if (i == 5) {
                    stringBuffer.append(this.mValues[((PersianCalendar) calendar).getPersianDay()]);
                    return;
                }
            }
    ...
    private static class UnpaddedNumberField implements NumberRule {
        ...
        public void appendTo(StringBuffer stringBuffer, Calendar calendar) {
            if (calendar instanceof PersianCalendar) {
                int i = this.mField;
                if (i == 5) {
                    appendTo(stringBuffer, ((PersianCalendar) calendar).getPersianDay());
                    return;
                } else if (i == 1) {
                    appendTo(stringBuffer, ((PersianCalendar) calendar).getPersianYear());
                    return;
                }
            }
        ...
        @Override // org.rbmain.messenger.time.FastDatePrinter.NumberRule
        ...
        public void appendTo(StringBuffer stringBuffer, Calendar calendar) {
            if (calendar instanceof PersianCalendar) {
                ...
                if (i == 1) {
                    ...
                    appendTo(stringBuffer, ((PersianCalendar) calendar).getPersianMonth());
                    return;
                } else if (i == 7) {
                    appendTo(stringBuffer, ((PersianCalendar) calendar).getPersianDay());
                    return;
    ...
    private static class TwoDigitNumberField implements NumberRule {
        ...
        public void appendTo(StringBuffer stringBuffer, Calendar calendar) {
            Object objValueOf;
            if ((calendar instanceof PersianCalendar) && this.mField == 5) {
                int persianDay = ((PersianCalendar) calendar).getPersianDay();
                if (persianDay >= 10) {
                    objValueOf = Integer.valueOf(persianDay);
                } else {
                    objValueOf = "0" + persianDay;
                }
                stringBuffer.append(objValueOf);
                return;
            }
            appendTo(stringBuffer, calendar.get(this.mField));
        }
    ...
    private static class TwoDigitYearField implements NumberRule {
        ...
        public void appendTo(StringBuffer stringBuffer, Calendar calendar) {
            if (calendar instanceof PersianCalendar) {
                appendTo(stringBuffer, ((PersianCalendar) calendar).getPersianYear() % 100);
            } else {
