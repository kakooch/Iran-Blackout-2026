    ...
    */
    private boolean checkBasic() {
        ...
        Le6:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.messenger.EmuDetector.checkBasic():boolean");
    }
    ...
    private boolean checkPackageName() {
        if (this.isCheckPackage && !this.mListPackageName.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (launchIntentForPackage != null && !packageManager.queryIntentActivities(launchIntentForPackage, MessagesController.UPDATE_MASK_CHECK).isEmpty()) {
                    return true;
                }
            }
        }
