...
public class ContactsWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i, boolean z) {
        ...
        int i2 = ir.medu.shad.R.layout.contacts_widget_layout_1;
        if (!z2) {
            ...
            if (cellsForSize != 1 && iCeil > 1) {
                i2 = (cellsForSize == 2 || iCeil <= 2) ? ir.medu.shad.R.layout.contacts_widget_layout_2 : (cellsForSize == 3 || iCeil <= 3) ? ir.medu.shad.R.layout.contacts_widget_layout_3 : ir.medu.shad.R.layout.contacts_widget_layout_4;
            }
        }
