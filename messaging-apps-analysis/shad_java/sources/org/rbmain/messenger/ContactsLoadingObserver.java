...
public final class ContactsLoadingObserver {
    ...
    private final NotificationCenter.NotificationCenterDelegate observer = new NotificationCenter.NotificationCenterDelegate() { // from class: org.rbmain.messenger.ContactsLoadingObserver.1
        @Override // org.rbmain.messenger.NotificationCenter.NotificationCenterDelegate
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            if (i == NotificationCenter.contactsDidLoad) {
                ContactsLoadingObserver.this.onContactsLoadingStateUpdated(i2, false);
            }
        }
    };
    ...
    private ContactsLoadingObserver(Callback callback) {
        ...
        this.releaseRunnable = new Runnable() { // from class: org.rbmain.messenger.ContactsLoadingObserver$$ExternalSyntheticLambda0
