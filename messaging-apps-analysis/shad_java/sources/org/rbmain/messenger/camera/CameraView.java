...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener {
    ...
    public void initCamera() {
        ...
        Size sizeChooseOptimalSize = CameraController.chooseOptimalSize(cameraInfo.getPictureSizes(), i2, i, size);
        if (sizeChooseOptimalSize.getWidth() >= 1280 && sizeChooseOptimalSize.getHeight() >= 1280) {
            if (Math.abs(fMin - 1.3333334f) < 0.1f) {
                size2 = new Size(3, 4);
            } else {
                size2 = new Size(9, 16);
            }
            Size sizeChooseOptimalSize2 = CameraController.chooseOptimalSize(cameraInfo.getPictureSizes(), i, i2, size2);
        ...
        CameraSession cameraSession = new CameraSession(cameraInfo, this.previewSize, sizeChooseOptimalSize, 256);
        this.cameraSession = cameraSession;
        boolean z2 = this.optimizeForBarcode;
        if (z2) {
            cameraSession.setOptimizeForBarcode(z2);
        }
        CameraController.getInstance().open(this.cameraSession, surfaceTexture, new Runnable() { // from class: org.rbmain.messenger.camera.CameraView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$initCamera$0();
            }
        }, new Runnable() { // from class: org.rbmain.messenger.camera.CameraView$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
