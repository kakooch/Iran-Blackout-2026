...
public class ImageLocation {
    ...
    public PhotoViewerObject photoViewerObject;
    ...
    public static ImageLocation getForDocument(TLRPC$Document tLRPC$Document) {
        ...
        imageLocation.cdnTag = tLRPC$Document.cdnTag;
        return imageLocation;
    }
    ...
    public static ImageLocation getForPhotoViewerObject(PhotoViewerObject photoViewerObject) {
        if (photoViewerObject == null) {
            return null;
        }
        ImageLocation imageLocation = new ImageLocation();
        imageLocation.filePath = photoViewerObject.getFileDownloadedName();
        imageLocation.photoViewerObject = photoViewerObject;
        return imageLocation;
    }
    ...
    public static ImageLocation getForUser(TLRPC$User tLRPC$User, int i) {
        ...
        return getForPhoto(tLRPC$FileLocation, 0, null, null, tLRPC$TL_inputPeerUser, i, i2, null, null);
    }
    ...
    public static ImageLocation getForChat(TLRPC$Chat tLRPC$Chat, int i) {
        ...
        return getForPhoto(tLRPC$FileLocation, 0, null, null, tLRPC$InputPeer, i, i2, null, null);
    }
    ...
    private static ImageLocation getForPhoto(TLRPC$FileLocation tLRPC$FileLocation, int i, TLRPC$Photo tLRPC$Photo, TLRPC$Document tLRPC$Document, TLRPC$InputPeer tLRPC$InputPeer, int i2, int i3, TLRPC$InputStickerSet tLRPC$InputStickerSet, String str) {
        if (tLRPC$FileLocation == null || (tLRPC$Photo == null && tLRPC$InputPeer == null && tLRPC$InputStickerSet == null && tLRPC$Document == null)) {
            return null;
        }
        ImageLocation imageLocation = new ImageLocation();
        ...
        imageLocation.cdnTag = tLRPC$Photo != null ? tLRPC$Photo.cdnTag : null;
        if (tLRPC$FileLocation instanceof TLRPC$TL_fileLocationToBeDeprecated) {
            ...
            if (tLRPC$Photo != null) {
                ...
                imageLocation.cdnTag = tLRPC$Photo.cdnTag;
    ...
    public String getKey(Object obj, Object obj2, boolean z) {
        ...
        if (tLRPC$Document != null) {
            if (z || !(tLRPC$Document instanceof DocumentObject.ThemeDocument)) {
                ...
                return IdStorage.getInstance().getDcId(this.document.dc_id) + "_" + this.document.id;
            }
