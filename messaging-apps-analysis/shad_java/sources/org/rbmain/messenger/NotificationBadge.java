...
public class NotificationBadge {
    ...
    public static class AdwHomeBadger implements Badger {
        ...
        @Override // org.rbmain.messenger.NotificationBadge.Badger
        public void executeBadge(int i) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.AdwHomeBadger.1
    ...
    public static class ApexHomeBadger implements Badger {
        ...
        public void executeBadge(int i) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.ApexHomeBadger.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ApplicationLoader.applicationContext.sendBroadcast(intent);
                    }
    ...
    public static class AsusHomeBadger implements Badger {
        ...
        public void executeBadge(int i) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.AsusHomeBadger.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ApplicationLoader.applicationContext.sendBroadcast(intent);
                    }
    ...
    public static class DefaultBadger implements Badger {
        ...
        public void executeBadge(int i) {
            ...
            intent.putExtra(INTENT_EXTRA_PACKAGENAME, NotificationBadge.componentName.getPackageName());
            intent.putExtra(INTENT_EXTRA_ACTIVITY_NAME, NotificationBadge.componentName.getClassName());
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.DefaultBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        ApplicationLoader.applicationContext.sendBroadcast(intent);
    ...
    public static class HuaweiHomeBadger implements Badger {
        ...
        public void executeBadge(int i) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.HuaweiHomeBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
    ...
    public static class NewHtcHomeBadger implements Badger {
        ...
        public void executeBadge(int i) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent) || NotificationBadge.canResolveBroadcast(intent2)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.NewHtcHomeBadger.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ApplicationLoader.applicationContext.sendBroadcast(intent);
    ...
    public static class SonyHomeBadger implements Badger {
        ...
        private static void executeBadgeByBroadcast(int i) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.SonyHomeBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    ApplicationLoader.applicationContext.sendBroadcast(intent);
                }
        ...
        private void executeBadgeByContentProvider(int i) {
            ...
            if (mQueryHandler == null) {
                mQueryHandler = new AsyncQueryHandler(ApplicationLoader.applicationContext.getApplicationContext().getContentResolver()) { // from class: org.rbmain.messenger.NotificationBadge.SonyHomeBadger.2
    ...
    public static class XiaomiHomeBadger implements Badger {
        ...
        public void executeBadge(int i) {
            ...
            try {
                ...
                declaredField.set(objNewInstance, String.valueOf(i == 0 ? io.github.inflationx.calligraphy3.BuildConfig.FLAVOR : Integer.valueOf(i)));
            } catch (Throwable unused) {
                final Intent intent = new Intent(INTENT_ACTION);
                ...
                intent.putExtra(EXTRA_UPDATE_APP_MSG_TEXT, String.valueOf(objValueOf));
                if (NotificationBadge.canResolveBroadcast(intent)) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.XiaomiHomeBadger.1
                        @Override // java.lang.Runnable
                        public void run() {
                            ApplicationLoader.applicationContext.sendBroadcast(intent);
                        }
    ...
    public static class ZukHomeBadger implements Badger {
        ...
        public void executeBadge(int i) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.NotificationBadge.ZukHomeBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
    ...
    private static boolean initBadger() throws IllegalAccessException, InstantiationException {
        ...
        ResolveInfo resolveInfoResolveActivity = context.getPackageManager().resolveActivity(intent, MessagesController.UPDATE_MASK_CHECK);
        ...
        List<ResolveInfo> listQueryIntentActivities = context.getPackageManager().queryIntentActivities(intent, MessagesController.UPDATE_MASK_CHECK);
