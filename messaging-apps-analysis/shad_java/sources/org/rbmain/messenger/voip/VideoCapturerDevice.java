...
public class VideoCapturerDevice {
    ...
    public VideoCapturerDevice(final boolean z) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda9
    ...
    public static void checkScreenCapturerSize() {
        ...
        videoCapturerDeviceArr[1].handler.post(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void init(final long j, final String str) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$init$5(long j, String str) {
        ...
        if ("screen".equals(str)) {
            if (Build.VERSION.SDK_INT >= 21 && this.videoCapturer == null) {
                ...
                this.handler.post(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$init$2(screenCaptureSize);
                    }
                });
                return;
            }
        ...
        if (this.videoCapturer == null) {
            ...
            this.handler.post(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
        ...
        this.handler.post(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* renamed from: org.rbmain.messenger.voip.VideoCapturerDevice$1, reason: invalid class name */
    class AnonymousClass1 extends MediaProjection.Callback {
        ...
        public void onStop() {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* renamed from: org.rbmain.messenger.voip.VideoCapturerDevice$2, reason: invalid class name */
    class AnonymousClass2 implements CameraVideoCapturer.CameraEventsHandler {
        ...
        public void onFirstFrameAvailable() {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* renamed from: org.rbmain.messenger.voip.VideoCapturerDevice$3, reason: invalid class name */
    class AnonymousClass3 implements CameraVideoCapturer.CameraSwitchHandler {
        ...
        public void onCameraSwitchDone(final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void onStateChanged(final long j, final int i) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$onStateChanged$7(long j, final int i) {
        ...
        this.handler.post(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onStateChanged$6(i);
            }
        });
    }
    ...
    private void onDestroy() {
        ...
        this.nativePtr = 0L;
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$onDestroy$9() {
        ...
        this.handler.post(new Runnable() { // from class: org.rbmain.messenger.voip.VideoCapturerDevice$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
