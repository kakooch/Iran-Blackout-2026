...
public class NativeInstance {
    ...
    private void onNetworkStateUpdated(final boolean z, final boolean z2) {
        if (this.onStateUpdatedListener != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.NativeInstance$$ExternalSyntheticLambda2
    ...
    private void onAudioLevelsUpdated(final int[] iArr, final float[] fArr, final boolean[] zArr) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.NativeInstance$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void onParticipantDescriptionsRequired(final long j, final int[] iArr) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.NativeInstance$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void onEmitJoinPayload(final String str, final int i) {
        try {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.messenger.voip.NativeInstance$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
