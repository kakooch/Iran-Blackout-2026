...
public final class VoIPPendingCall {
    ...
    private VoIPPendingCall(Activity activity, long j, boolean z, long j2, AccountInstance accountInstance) {
        NotificationCenter.NotificationCenterDelegate notificationCenterDelegate = new NotificationCenter.NotificationCenterDelegate() { // from class: org.rbmain.messenger.voip.VoIPPendingCall$$ExternalSyntheticLambda1
        ...
        Runnable runnable = new Runnable() { // from class: org.rbmain.messenger.voip.VoIPPendingCall$$ExternalSyntheticLambda0
