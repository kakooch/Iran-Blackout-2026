...
public class AudioTrackJNI {
    ...
    private void startThread() {
        ...
        this.running = true;
        Thread thread = new Thread(new Runnable() { // from class: org.rbmain.messenger.voip.AudioTrackJNI$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$startThread$0() throws IllegalStateException {
        try {
            this.audioTrack.play();
