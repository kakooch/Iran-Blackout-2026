...
import org.rbmain.messenger.video.Track;
...
public class Track {
    ...
    public void prepare() {
        ...
        Collections.sort(this.samplePresentationTimes, new Comparator() { // from class: org.rbmain.messenger.video.Track$$ExternalSyntheticLambda0
