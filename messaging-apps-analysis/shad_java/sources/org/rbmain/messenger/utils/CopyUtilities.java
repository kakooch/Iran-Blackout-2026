...
public class CopyUtilities {
    public static Spannable fromHTML(String str) {
        try {
            ...
            SpannableString spannableString = new SpannableString(spannedFromHtml.toString());
    ...
    private static class HTMLTagHandler implements HTMLTagAttributesHandler.TagHandler {
        ...
        @Override // org.rbmain.messenger.utils.CopyUtilities.HTMLTagAttributesHandler.TagHandler
