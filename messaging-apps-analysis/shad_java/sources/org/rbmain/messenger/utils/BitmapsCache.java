...
public class BitmapsCache {
    ...
    private Runnable cleanupSharedBuffers = new Runnable() { // from class: org.rbmain.messenger.utils.BitmapsCache.1
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:53:0x011c -> B:72:0x0134). Please report as a decompilation issue!!! */
    ...
    public static void decrementTaskCounter() {
        ...
        if (i <= 0) {
            taskCounter = 0;
            RLottieDrawable.lottieCacheGenerateQueue.postRunnable(new Runnable() { // from class: org.rbmain.messenger.utils.BitmapsCache$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
    ...
    /* JADX WARN: Code restructure failed: missing block: B:74:0x01c8, code lost:
        ...
        if (org.rbmain.messenger.BuildVars.DEBUG_VERSION == false) goto L76;
     */
    /* JADX WARN: Code restructure failed: missing block: B:75:0x01ca, code lost:
    
        org.rbmain.messenger.FileLog.d("cancelled cache generation");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:78:0x01d5, code lost:
        ...
        if (r10 >= org.rbmain.messenger.utils.BitmapsCache.N) goto L135;
     */
    /* JADX WARN: Code restructure failed: missing block: B:80:0x01d9, code lost:
    
        if (r20[r10] == null) goto L85;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:127:0x00e6 A[SYNTHETIC] */
    ...
    */
    public void createCache() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.messenger.utils.BitmapsCache.createCache():void");
    }
    ...
    static class CacheGeneratorSharedTools {
            ...
            for (int i4 = 0; i4 < BitmapsCache.N; i4++) {
                if (z || this.bitmap[i4] == null) {
                    ...
                    if (bitmapArr[i4] != null) {
                        ...
                        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.messenger.utils.BitmapsCache$CacheGeneratorSharedTools$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
        ...
        void release() {
            ...
            Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.messenger.utils.BitmapsCache$CacheGeneratorSharedTools$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
