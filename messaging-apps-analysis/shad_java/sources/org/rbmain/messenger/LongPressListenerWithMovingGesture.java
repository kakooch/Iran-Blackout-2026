...
public class LongPressListenerWithMovingGesture implements View.OnTouchListener {
    ...
    public LongPressListenerWithMovingGesture() {
        GestureDetector2 gestureDetector2 = new GestureDetector2(new GestureDetector2.OnGestureListener() { // from class: org.rbmain.messenger.LongPressListenerWithMovingGesture.1
