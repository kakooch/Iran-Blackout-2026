...
public class ChatPullingDownDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void updateDialog() {
        ...
        if (nextUnreadDialog != null) {
            ...
            MessagesController.getInstance(this.currentAccount).ensureMessagesLoaded(nextUnreadDialog.id, 0L, null);
    ...
    public void setWidth(int i) {
        ...
        if (i != this.lastWidth) {
            ...
            int iMeasureText3 = (int) this.textPaint2.measureText(str2);
    ...
    public void draw(Canvas canvas, View view, float f, float f2) {
        ...
        float f8 = fDp / 2.0f;
        float fMax = Math.max(0.0f, Math.min(this.circleRadius, (f8 - (AndroidUtilities.dp(16.0f) * f)) - AndroidUtilities.dp(4.0f)));
        float fMax2 = ((Math.max(0.0f, Math.min(this.circleRadius * f, f8 - (AndroidUtilities.dp(8.0f) * f))) * 2.0f) - AndroidUtilities.dp2(16.0f)) * (1.0f - this.swipeToReleaseProgress);
        float fDp2 = AndroidUtilities.dp(56.0f);
        float f9 = this.swipeToReleaseProgress;
        float f10 = fMax2 + (fDp2 * f9);
        if (f9 < 1.0f || this.emptyStub) {
            float f11 = -fDp;
            i2 = alpha3;
            i3 = alpha2;
            float fDp3 = ((-AndroidUtilities.dp(8.0f)) * (1.0f - this.swipeToReleaseProgress)) + ((AndroidUtilities.dp(56.0f) + f11) * this.swipeToReleaseProgress);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(f6 - fMax, f11, fMax + f6, fDp3);
            ...
            float fDp5 = ((AndroidUtilities.dp(24.0f) + f11) + (AndroidUtilities.dp(8.0f) * (1.0f - f))) - (AndroidUtilities.dp(36.0f) * this.swipeToReleaseProgress);
            canvas.save();
            f3 = fDp;
            ...
            drawArrow(canvas, f6, fDp5, AndroidUtilities.dp(24.0f) * f);
            if (this.emptyStub) {
                float fDp22 = ((((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f)) - f10) * (1.0f - this.swipeToReleaseProgress)) + ((f11 - AndroidUtilities.dp(2.0f)) * this.swipeToReleaseProgress) + f7;
                this.arrowPaint.setAlpha(alpha4);
                canvas.save();
                canvas.scale(f, f, f6, AndroidUtilities.dp(28.0f) + fDp22);
                drawCheck(canvas, f6, fDp22 + AndroidUtilities.dp(28.0f));
                canvas.restore();
            }
            canvas.restore();
        } else {
        ...
        if (this.chatNameLayout != null && this.swipeToReleaseProgress > 0.0f) {
            getThemedPaint("paintChatActionBackground").setAlpha(i5);
            this.textPaint.setAlpha(i6);
            float fDp6 = ((AndroidUtilities.dp(20.0f) * (1.0f - this.swipeToReleaseProgress)) - (AndroidUtilities.dp(36.0f) * this.swipeToReleaseProgress)) + f7;
            RectF rectF2 = AndroidUtilities.rectTmp;
            int i7 = this.lastWidth;
            int i8 = this.chatNameWidth;
            rectF2.set((i7 - i8) / 2.0f, fDp6, i7 - ((i7 - i8) / 2.0f), this.chatNameLayout.getHeight() + fDp6);
        ...
        if (this.emptyStub || f10 <= 0.0f) {
            ...
            float fDp23 = ((((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f)) - f10) * (1.0f - this.swipeToReleaseProgress)) + (((-f3) + AndroidUtilities.dp(4.0f)) * this.swipeToReleaseProgress) + f7;
            float f13 = f10 / 2.0f;
            this.imageReceiver.setRoundRadius((int) f13);
            this.imageReceiver.setImageCoords(f6 - f13, fDp23, f10, f10);
            if (this.swipeToReleaseProgress > 0.0f) {
                ...
                canvas.scale(f14, f14, AndroidUtilities.dp(12.0f) + f6 + this.counterDrawable.getCenterX(), (fDp23 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas.translate(AndroidUtilities.dp(12.0f) + f6, fDp23 - AndroidUtilities.dp(6.0f));
                ...
                canvas.scale(f15, f15, AndroidUtilities.dp(12.0f) + f6 + this.counterDrawable.getCenterX(), (fDp23 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas.translate(f6 + AndroidUtilities.dp(12.0f), fDp23 - AndroidUtilities.dp(6.0f));
    ...
    private void drawBackground(Canvas canvas, RectF rectF) {
        if (this.drawFolderBackground) {
            ...
            float f4 = f * 2.0f;
            this.path.rLineTo((((-(rectF.width() - f3)) / 2.0f) + f4) - fWidth3, 0.0f);
            float f5 = -f;
            float f6 = f5 / 2.0f;
            float f7 = f5 * 2.0f;
    ...
    private void showReleaseState(boolean z, final View view) {
        ...
        if (z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ChatPullingDownDrawable$$ExternalSyntheticLambda4
            ...
            valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ChatPullingDownDrawable$$ExternalSyntheticLambda3
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ChatPullingDownDrawable$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            valueAnimatorOfFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ChatPullingDownDrawable$$ExternalSyntheticLambda6
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ChatPullingDownDrawable.1
        ...
        valueAnimatorOfFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ChatPullingDownDrawable$$ExternalSyntheticLambda5
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    */
    public void drawBottomPanel(android.graphics.Canvas r17, int r18, int r19, int r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ChatPullingDownDrawable.drawBottomPanel(android.graphics.Canvas, int, int, int):void");
    }
    ...
    public void runOnAnimationFinish(Runnable runnable) {
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.swipeToReleaseProgress, 1.0f);
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ChatPullingDownDrawable$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ChatPullingDownDrawable$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$runOnAnimationFinish$6(valueAnimator);
            }
        });
        this.showReleaseAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ChatPullingDownDrawable.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                ChatPullingDownDrawable chatPullingDownDrawable = ChatPullingDownDrawable.this;
                chatPullingDownDrawable.bounceProgress = 0.0f;
