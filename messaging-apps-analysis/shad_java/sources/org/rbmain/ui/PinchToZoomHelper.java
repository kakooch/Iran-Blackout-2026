...
public class PinchToZoomHelper {
    ...
    public interface Callback {
        ...
        /* renamed from: org.rbmain.ui.PinchToZoomHelper$Callback$-CC, reason: invalid class name */
    ...
    public void finishZoom() {
        if (this.finishTransition == null && this.inOverlayMode) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.PinchToZoomHelper$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.lambda$finishZoom$0(valueAnimator);
                }
            });
            this.finishTransition.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.PinchToZoomHelper.1
    ...
    private class ZoomOverlayView extends FrameLayout {
        ...
        public ZoomOverlayView(Context context) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                frameLayout.setOutlineProvider(new ViewOutlineProvider(this, PinchToZoomHelper.this) { // from class: org.rbmain.ui.PinchToZoomHelper.ZoomOverlayView.1
                ...
                this.videoPlayerContainer = new FrameLayout(context, PinchToZoomHelper.this) { // from class: org.rbmain.ui.PinchToZoomHelper.ZoomOverlayView.2
