...
public class WebviewActivity extends BaseFragment {
    ...
    private int type;
    public Runnable typingRunnable = new Runnable() { // from class: org.rbmain.ui.WebviewActivity.1
    ...
    class RubikaWebviewProxy {
        ...
        public void postEvent(final String str, String str2) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.WebviewActivity$RubikaWebviewProxy$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.WebviewActivity.2
        ...
        if (i == 0) {
            ...
            this.actionBar.setBackgroundColor(getThemedColor(Theme.key_dialogBackground));
        ...
        this.webView.setWebViewClient(new WebViewClient() { // from class: org.rbmain.ui.WebviewActivity.3
            private boolean isInternalUrl(String str2) {
            ...
            public boolean shouldOverrideUrlLoading(WebView webView2, String str2) {
                return isInternalUrl(str2) || super.shouldOverrideUrlLoading(webView2, str2);
            }
            ...
            public void onPageFinished(WebView webView2, String str2) {
                ...
                animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.WebviewActivity.3.1
    ...
    public boolean onBackPressed() {
        WebView webView;
        if (this.type == 2 && this.backEnabled && (webView = this.webView) != null && webView.canGoBack()) {
            this.webView.goBack();
            return false;
        }
    ...
    public static void openGameInBrowser(String str, MessageObject messageObject, Activity activity, String str2, String str3) {
        ...
        try {
            ...
            String string = sharedPreferences.getString(BuildConfig.FLAVOR + messageObject.getId(), null);
            StringBuilder sb = new StringBuilder(string != null ? string : BuildConfig.FLAVOR);
            StringBuilder sb2 = new StringBuilder("tgShareScoreUrl=" + URLEncoder.encode("tgb://share_game_score?hash=", Utf8Charset.NAME));
            if (string == null) {
