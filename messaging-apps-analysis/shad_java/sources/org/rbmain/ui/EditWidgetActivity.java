...
import org.rbmain.messenger.ChatsWidgetProvider;
import org.rbmain.messenger.ContactsWidgetProvider;
...
import org.rbmain.ui.Components.InviteMembersBottomSheet;
...
public class EditWidgetActivity extends BaseFragment {
    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        /* JADX WARN: Type inference failed for: r0v80, types: [org.rbmain.tgnet.TLRPC$User] */
        /* JADX WARN: Type inference failed for: r14v16, types: [org.rbmain.tgnet.TLRPC$Dialog] */
        /* JADX WARN: Type inference failed for: r14v17 */
        /* JADX WARN: Type inference failed for: r14v5 */
        /* JADX WARN: Type inference failed for: r15v0 */
        /* JADX WARN: Type inference failed for: r15v1, types: [org.rbmain.tgnet.TLRPC$FileLocation] */
        /* JADX WARN: Type inference failed for: r15v19 */
        /* JADX WARN: Type inference failed for: r15v2, types: [org.rbmain.tgnet.TLObject] */
        /* JADX WARN: Type inference failed for: r15v26, types: [org.rbmain.tgnet.TLRPC$FileLocation] */
        /* JADX WARN: Type inference failed for: r3v65 */
        /* JADX WARN: Type inference failed for: r3v66, types: [org.rbmain.tgnet.TLRPC$Chat] */
        /* JADX WARN: Type inference failed for: r3v80 */
        /* JADX WARN: Type inference failed for: r3v82 */
        /* JADX WARN: Type inference failed for: r3v83 */
        /* JADX WARN: Type inference failed for: r9v30 */
        /* JADX WARN: Type inference failed for: r9v31, types: [org.rbmain.tgnet.TLRPC$User] */
        ...
        */
        public void updateDialogs() throws android.content.res.Resources.NotFoundException {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.EditWidgetActivity.WidgetPreviewCell.updateDialogs():void");
        }
    ...
    public EditWidgetActivity(int i, int i2, boolean z) throws InterruptedException {
        this.widgetType = i;
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.EditWidgetActivity.1
            ...
            public void onItemClick(int i) {
                ...
                sharedPreferences.edit().putInt("account" + EditWidgetActivity.this.currentWidgetId, ((BaseFragment) EditWidgetActivity.this).currentAccount).apply();
                sharedPreferences.edit().putInt("type" + EditWidgetActivity.this.currentWidgetId, EditWidgetActivity.this.widgetType).apply();
                AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(EditWidgetActivity.this.getParentActivity());
                if (EditWidgetActivity.this.widgetType == 0) {
                    ChatsWidgetProvider.updateWidget(EditWidgetActivity.this.getParentActivity(), appWidgetManager, EditWidgetActivity.this.currentWidgetId, EditWidgetActivity.this.isEdit);
                } else {
                    ContactsWidgetProvider.updateWidget(EditWidgetActivity.this.getParentActivity(), appWidgetManager, EditWidgetActivity.this.currentWidgetId, EditWidgetActivity.this.isEdit);
                }
                if (EditWidgetActivity.this.delegate != null) {
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.EditWidgetActivity$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ void lambda$createView$1(Context context, View view, int i) {
        if (i == this.selectChatsRow) {
            ...
            inviteMembersBottomSheet.setDelegate(new InviteMembersBottomSheet.InviteMembersBottomSheetDelegate() { // from class: org.rbmain.ui.EditWidgetActivity$$ExternalSyntheticLambda1
                @Override // org.rbmain.ui.Components.InviteMembersBottomSheet.InviteMembersBottomSheetDelegate
    ...
    /* renamed from: org.rbmain.ui.EditWidgetActivity$2, reason: invalid class name */
        ...
        public boolean onItemClick(View view, final int i, float f, float f2) {
            if (EditWidgetActivity.this.getParentActivity() != null && (view instanceof GroupCreateUserCell)) {
                ...
                if (!this.rect.contains((int) f, (int) f2)) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString("Delete", R.string.Delete)}, new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.EditWidgetActivity$2$$ExternalSyntheticLambda0
    ...
    public void finishActivity() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.EditWidgetActivity$$ExternalSyntheticLambda0
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                imageView.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.EditWidgetActivity$ListAdapter$$ExternalSyntheticLambda0
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) throws Resources.NotFoundException {
            ...
            if (itemViewType != 1) {
                ...
                int iLongValue = (int) ((Long) EditWidgetActivity.this.selectedDialogs.get(i - EditWidgetActivity.this.chatsStartRow)).longValue();
                if (iLongValue > 0) {
                    groupCreateUserCell.setObject(EditWidgetActivity.this.getMessagesController().getUser(Integer.valueOf(iLongValue)), null, null, i != EditWidgetActivity.this.chatsEndRow - 1);
                    return;
                } else {
                    groupCreateUserCell.setObject(EditWidgetActivity.this.getMessagesController().getChat(Integer.valueOf(-iLongValue)), null, null, i != EditWidgetActivity.this.chatsEndRow - 1);
                    return;
                }
            }
