...
public class TextMessageEnterTransition implements MessageEnterTransitionContainer.Transition {
    ...
    public TextMessageEnterTransition(final ChatMessageCell chatMessageCell, final ChatActivity chatActivity, RecyclerListView recyclerListView, final MessageEnterTransitionContainer messageEnterTransitionContainer, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (chatMessageCell.getMessageObject().getEmojiOnlyCount() != 0) {
            ...
            if (textPaint != null) {
                iDp = (int) (textPaint.getTextSize() + AndroidUtilities.dp(4.0f));
            }
        }
        ...
        if (editText.length() != charSequenceReplaceEmoji.length() || z2) {
            ...
            charSequenceReplaceEmoji = Emoji.replaceEmoji(editText, textPaint.getFontMetricsInt(), iDp, false);
        } else {
            lineTop = 0;
        }
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.TextMessageEnterTransition$$ExternalSyntheticLambda0
        ...
        this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.TextMessageEnterTransition.1
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                AnimatedEmojiSpan.release(null, TextMessageEnterTransition.this.animatedEmojiStack);
            }
        });
    ...
    */
    public void onDraw(android.graphics.Canvas r42) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.TextMessageEnterTransition.onDraw(android.graphics.Canvas):void");
    }
