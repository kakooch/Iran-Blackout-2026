...
public class ExternalActionActivity extends Activity implements ActionBarLayout.ActionBarLayoutDelegate {
    ...
    protected void onCreate(Bundle bundle) throws Resources.NotFoundException {
        ...
        if (AndroidUtilities.isTablet()) {
            ...
            frameLayout.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda4
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return this.f$0.lambda$onCreate$0(view, motionEvent);
                }
            });
            frameLayout.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda3
    ...
    public void showPasscodeActivity() {
        ...
        this.passcodeView.setDelegate(new PasscodeView.PasscodeViewDelegate() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda10
    ...
    protected boolean handleIntent(final Intent intent, final boolean z, final boolean z2, final boolean z3, final int i, int i2) {
        ...
        if ("org.rbmain.passport.AUTHORIZE".equals(intent.getAction())) {
            if (i2 == 0) {
                ...
                if (activatedAccountsCount == 0) {
                    ...
                    this.passcodeSaveIntentAccount = i;
                    this.passcodeSaveIntentState = i2;
                    LoginActivityAppp loginActivityAppp = new LoginActivityAppp();
                    if (AndroidUtilities.isTablet()) {
                        this.layersActionBarLayout.addFragmentToStack(loginActivityAppp);
                    } else {
                        this.actionBarLayout.addFragmentToStack(loginActivityAppp);
                    }
                    if (!AndroidUtilities.isTablet()) {
                ...
                if (activatedAccountsCount >= 2) {
                    AlertDialog alertDialogCreateAccountSelectDialog = AlertsCreator.createAccountSelectDialog(this, new AlertsCreator.AccountSelectDelegate() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda9
                        @Override // org.rbmain.ui.Components.AlertsCreator.AccountSelectDelegate
                    ...
                    alertDialogCreateAccountSelectDialog.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda1
            ...
            alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda0
            ...
            alertDialog.show();
            iArr[0] = ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_account_getAuthorizationForm, new RequestDelegate() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda8
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    this.f$0.lambda$handleIntent$10(iArr, i, alertDialog, tLRPC$TL_account_getAuthorizationForm, stringExtra2, stringExtra, tLObject, tLRPC$TL_error);
                }
            }, 10);
        } else {
            if (AndroidUtilities.isTablet()) {
    ...
    public /* synthetic */ void lambda$handleIntent$10(int[] iArr, final int i, final AlertDialog alertDialog, final TLRPC$TL_account_getAuthorizationForm tLRPC$TL_account_getAuthorizationForm, final String str, final String str2, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (tLRPC$TL_account_authorizationForm != null) {
            iArr[0] = ConnectionsManager.getInstance(i).sendRequest(new TLRPC$TL_account_getPassword(), new RequestDelegate() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda7
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) {
                    this.f$0.lambda$handleIntent$7(alertDialog, i, tLRPC$TL_account_authorizationForm, tLRPC$TL_account_getAuthorizationForm, str, str2, tLObject2, tLRPC$TL_error2);
                }
            });
        } else {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$handleIntent$9(alertDialog, tLRPC$TL_error);
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$handleIntent$7(final AlertDialog alertDialog, final int i, final TLRPC$TL_account_authorizationForm tLRPC$TL_account_authorizationForm, final TLRPC$TL_account_getAuthorizationForm tLRPC$TL_account_getAuthorizationForm, final String str, final String str2, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$handleIntent$6(alertDialog, tLObject, i, tLRPC$TL_account_authorizationForm, tLRPC$TL_account_getAuthorizationForm, str, str2);
            }
        });
    }
        ...
        try {
            ...
            if ("APP_VERSION_OUTDATED".equals(tLRPC$TL_error.text)) {
                ...
                if (alertDialogShowUpdateAppAlert != null) {
                    alertDialogShowUpdateAppAlert.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.rbmain.ui.ExternalActionActivity$$ExternalSyntheticLambda2
                        @Override // android.content.DialogInterface.OnDismissListener
                        public final void onDismiss(DialogInterface dialogInterface) {
                            this.f$0.lambda$handleIntent$8(tLRPC$TL_error, dialogInterface);
                        }
                    });
                } else {
    ...
    public void fixLayout() {
        ...
        if (AndroidUtilities.isTablet() && (actionBarLayout = this.actionBarLayout) != null) {
            actionBarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.rbmain.ui.ExternalActionActivity.1
    ...
    private void onPasscodePause() {
        ...
        if (SharedConfig.passcodeHash.length() != 0) {
            SharedConfig.lastPauseTime = (int) (SystemClock.elapsedRealtime() / 1000);
            Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.ExternalActionActivity.2
                @Override // java.lang.Runnable
                public void run() {
