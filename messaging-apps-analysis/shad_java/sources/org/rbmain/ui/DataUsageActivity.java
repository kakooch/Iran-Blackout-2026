...
public class DataUsageActivity extends BaseFragment {
    private static final Interpolator interpolator = new Interpolator() { // from class: org.rbmain.ui.DataUsageActivity$$ExternalSyntheticLambda1
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.DataUsageActivity.1
        ...
        this.scrollSlidingTextTabStrip.setDelegate(new ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate() { // from class: org.rbmain.ui.DataUsageActivity.2
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.rbmain.ui.DataUsageActivity.3
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                measureChildWithMargins(((BaseFragment) DataUsageActivity.this).actionBar, i2, 0, i3, 0);
                int measuredHeight = ((BaseFragment) DataUsageActivity.this).actionBar.getMeasuredHeight();
                this.globalIgnoreLayout = true;
                for (int i4 = 0; i4 < DataUsageActivity.this.viewPages.length; i4++) {
            ...
            */
            public boolean checkTabsAnimationInProgress() {
                /*
                    r7 = this;
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    boolean r0 = org.rbmain.ui.DataUsageActivity.access$1500(r0)
                    r1 = 0
                    if (r0 == 0) goto Lc3
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    boolean r0 = org.rbmain.ui.DataUsageActivity.access$1600(r0)
                    r2 = -1
                    r3 = 0
                    ...
                    if (r0 == 0) goto L59
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    org.rbmain.ui.DataUsageActivity$ViewPage[] r0 = org.rbmain.ui.DataUsageActivity.access$000(r0)
                    r0 = r0[r1]
                    ...
                    org.rbmain.ui.DataUsageActivity$ViewPage[] r0 = org.rbmain.ui.DataUsageActivity.access$000(r0)
                    r0 = r0[r5]
                    org.rbmain.ui.DataUsageActivity r3 = org.rbmain.ui.DataUsageActivity.this
                    org.rbmain.ui.DataUsageActivity$ViewPage[] r3 = org.rbmain.ui.DataUsageActivity.access$000(r3)
                    r3 = r3[r1]
                    int r3 = r3.getMeasuredWidth()
                    org.rbmain.ui.DataUsageActivity r4 = org.rbmain.ui.DataUsageActivity.this
                    boolean r4 = org.rbmain.ui.DataUsageActivity.access$500(r4)
                    if (r4 == 0) goto L52
                    r2 = 1
                L52:
                    int r3 = r3 * r2
                ...
                L59:
                    ...
                    r0 = r0[r1]
                    org.rbmain.ui.DataUsageActivity r4 = org.rbmain.ui.DataUsageActivity.this
                    org.rbmain.ui.DataUsageActivity$ViewPage[] r4 = org.rbmain.ui.DataUsageActivity.access$000(r4)
                    r4 = r4[r1]
                    int r4 = r4.getMeasuredWidth()
                    org.rbmain.ui.DataUsageActivity r6 = org.rbmain.ui.DataUsageActivity.this
                    boolean r6 = org.rbmain.ui.DataUsageActivity.access$500(r6)
                    if (r6 == 0) goto L8a
                    goto L8b
                L8a:
                    r2 = 1
                ...
                L9e:
                    if (r5 == 0) goto Lbc
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    android.animation.AnimatorSet r0 = org.rbmain.ui.DataUsageActivity.access$1700(r0)
                    if (r0 == 0) goto Lb7
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    android.animation.AnimatorSet r0 = org.rbmain.ui.DataUsageActivity.access$1700(r0)
                    r0.cancel()
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    r2 = 0
                    org.rbmain.ui.DataUsageActivity.access$1702(r0, r2)
                Lb7:
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    org.rbmain.ui.DataUsageActivity.access$1502(r0, r1)
                Lbc:
                    org.rbmain.ui.DataUsageActivity r0 = org.rbmain.ui.DataUsageActivity.this
                    boolean r0 = org.rbmain.ui.DataUsageActivity.access$1500(r0)
                    return r0
                Lc3:
                    return r1
                */
                throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.DataUsageActivity.AnonymousClass3.checkTabsAnimationInProgress():boolean");
            }
            ...
            public boolean onTouchEvent(MotionEvent motionEvent) {
                ...
                if (motionEvent != null && motionEvent.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                    ...
                    this.velocityTracker.computeCurrentVelocity(CloseCodes.NORMAL_CLOSURE, DataUsageActivity.this.maximumVelocity);
                    ...
                    if (this.startedTracking) {
                        ...
                        DataUsageActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.DataUsageActivity.3.1
        ...
        while (true) {
            ...
            ViewPage viewPage = new ViewPage(context) { // from class: org.rbmain.ui.DataUsageActivity.4
                @Override // android.view.View
            ...
            LinearLayoutManager linearLayoutManager = viewPageArr2[i2].layoutManager = new LinearLayoutManager(this, context, i, z) { // from class: org.rbmain.ui.DataUsageActivity.5
            ...
            this.viewPages[i2].listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.DataUsageActivity$$ExternalSyntheticLambda2
                @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
                public final void onItemClick(View view, int i3) {
                    this.f$0.lambda$createView$2(recyclerListView, view, i3);
                }
            });
            this.viewPages[i2].listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.DataUsageActivity.6
    ...
    public /* synthetic */ void lambda$createView$2(RecyclerListView recyclerListView, View view, int i) {
        ...
        if (i == listAdapter.resetRow) {
            ...
            builder.setPositiveButton(LocaleController.getString("Reset", R.string.Reset), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.DataUsageActivity$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    this.f$0.lambda$createView$1(listAdapter, dialogInterface, i2);
                }
            });
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                shadowSectionCell = i != 3 ? null : new TextInfoPrivacyCell(this.mContext);
            }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        for (int i = 0; i < this.viewPages.length; i++) {
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{TextSettingsCell.class, HeaderCell.class}, null, null, null, Theme.key_windowBackgroundWhite));
            ...
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{ShadowSectionCell.class}, null, null, null, i2));
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, 0, new Class[]{HeaderCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteBlueHeader));
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{TextInfoPrivacyCell.class}, null, null, null, i2));
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, 0, new Class[]{TextInfoPrivacyCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteGrayText4));
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, ThemeDescription.FLAG_CHECKTAG, new Class[]{TextSettingsCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteBlackText));
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, 0, new Class[]{TextSettingsCell.class}, new String[]{"valueTextView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_windowBackgroundWhiteValueText));
            arrayList.add(new ThemeDescription(this.viewPages[i].listView, ThemeDescription.FLAG_CHECKTAG, new Class[]{TextSettingsCell.class}, new String[]{"textView"}, (Paint[]) null, (Drawable[]) null, (ThemeDescription.ThemeDescriptionDelegate) null, Theme.key_text_RedRegular));
        }
        return arrayList;
    }
}
