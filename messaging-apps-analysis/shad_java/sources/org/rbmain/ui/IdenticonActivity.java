...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.IdenticonActivity.1
        ...
        this.fragmentView.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.IdenticonActivity$$ExternalSyntheticLambda0
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.rbmain.ui.IdenticonActivity.2
        ...
        if (encryptedChat != null) {
            ...
            if (bArr.length > 16) {
                ...
                for (int i4 = 0; i4 < 5; i4++) {
                    ...
                    int i5 = (i4 * 4) + 16;
                    int i6 = (bArr2[i5 + 3] & 255) | ((bArr2[i5] & 127) << 24) | ((bArr2[i5 + 1] & 255) << 16) | ((bArr2[i5 + 2] & 255) << 8);
                    if (i4 != 0) {
                        sb.append(" ");
                    }
            ...
            int iIndexOf = spannableStringBuilder.toString().indexOf("rubika.ir");
            if (iIndexOf != -1) {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        TextView textView;
        if (i != NotificationCenter.emojiDidLoad || (textView = this.emojiTextView) == null) {
            return;
        }
        textView.invalidate();
    }
    ...
    private void updateEmojiButton(boolean z) {
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.IdenticonActivity.3
    ...
    private void fixLayout() {
        this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.rbmain.ui.IdenticonActivity.4
