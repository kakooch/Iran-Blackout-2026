...
public class GroupCallTabletGridAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new RecyclerListView.Holder(new GroupCallGridCell(viewGroup.getContext(), true) { // from class: org.rbmain.ui.GroupCallTabletGridAdapter.1
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        groupCallGridCell.setData(AccountInstance.getInstance(this.currentAccount), videoParticipant, this.groupCall, MessageObject.getPeerId(r3.selfPeer));
    ...
    public void update(boolean z, RecyclerListView recyclerListView) {
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.rbmain.ui.GroupCallTabletGridAdapter.2
