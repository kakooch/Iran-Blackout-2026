...
import org.rbmain.ui.Components.BatteryDrawable;
...
public class LiteModeSettingsActivity extends BaseFragment {
    ...
    private Utilities.Callback16<Boolean> onPowerAppliedChange = new Utilities.Callback16() { // from class: org.rbmain.ui.LiteModeSettingsActivity$$ExternalSyntheticLambda0
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.LiteModeSettingsActivity.1
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.rbmain.ui.LiteModeSettingsActivity$$ExternalSyntheticLambda1
    ...
    private void updateItems() {
        ...
        this.items.add(Item.asInfo(BuildConfig.FLAVOR));
    ...
    private class Adapter extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                switchCell = new TextInfoPrivacyCell(this, context) { // from class: org.rbmain.ui.LiteModeSettingsActivity.Adapter.1
                    @Override // org.rbmain.ui.Cells.TextInfoPrivacyCell, android.view.View
    ...
    private class SwitchCell extends FrameLayout {
        ...
        public SwitchCell(Context context) {
            ...
            TextView textView = new TextView(this, context, LiteModeSettingsActivity.this) { // from class: org.rbmain.ui.LiteModeSettingsActivity.SwitchCell.1
        ...
        /* JADX WARN: Removed duplicated region for block: B:21:0x0031 A[PHI: r1
          0x0031: PHI (r1v5 int) = (r1v2 int), (r1v10 int) binds: [B:20:0x002f, B:11:0x001e] A[DONT_GENERATE, DONT_INLINE]] */
        /*
        ...
        */
        private int preprocessFlagsCount(int r4) {
            /*
                r3 = this;
                org.rbmain.ui.LiteModeSettingsActivity r0 = org.rbmain.ui.LiteModeSettingsActivity.this
                org.rbmain.messenger.UserConfig r0 = r0.getUserConfig()
            ...
            L31:
                int r1 = r1 + (-1)
            L33:
                int r0 = org.rbmain.messenger.SharedConfig.getDevicePerformanceClass()
                r2 = 1
                if (r0 >= r2) goto L40
            ...
            L40:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.LiteModeSettingsActivity.SwitchCell.preprocessFlagsCount(int):int");
        }
    ...
    class PowerSaverSlider extends FrameLayout {
        ...
        public PowerSaverSlider(Context context) {
            ...
            AnimatedTextView animatedTextView = new AnimatedTextView(this, context, true, false, false, LiteModeSettingsActivity.this) { // from class: org.rbmain.ui.LiteModeSettingsActivity.PowerSaverSlider.1
                ...
                @Override // org.rbmain.ui.Components.AnimatedTextView, android.view.View
                protected void onDraw(Canvas canvas) {
            ...
            this.seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate(LiteModeSettingsActivity.this) { // from class: org.rbmain.ui.LiteModeSettingsActivity.PowerSaverSlider.2
            ...
            AnimatedTextView animatedTextView2 = new AnimatedTextView(context, false, true, true, LiteModeSettingsActivity.this) { // from class: org.rbmain.ui.LiteModeSettingsActivity.PowerSaverSlider.3
                @Override // org.rbmain.ui.Components.AnimatedTextView, android.view.View
            ...
            this.seekBarAccessibilityDelegate = new IntSeekBarAccessibilityDelegate(LiteModeSettingsActivity.this) { // from class: org.rbmain.ui.LiteModeSettingsActivity.PowerSaverSlider.4
        ...
        private void updateOnActive(boolean z) {
            ...
            if (this.onActiveT != f) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.LiteModeSettingsActivity$PowerSaverSlider$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        this.f$0.lambda$updateOnActive$0(valueAnimator2);
                    }
                });
                this.onActiveAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.LiteModeSettingsActivity.PowerSaverSlider.5
        ...
        private void updateOffActive(boolean z) {
            ...
            if (this.offActiveT != f) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.LiteModeSettingsActivity$PowerSaverSlider$$ExternalSyntheticLambda1
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        this.f$0.lambda$updateOffActive$1(valueAnimator2);
                    }
                });
                this.offActiveAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.LiteModeSettingsActivity.PowerSaverSlider.6
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
