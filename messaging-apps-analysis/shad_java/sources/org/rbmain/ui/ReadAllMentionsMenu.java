...
public class ReadAllMentionsMenu {
    public static ActionBarPopupWindow show(int i, Activity activity, ActionBarLayout actionBarLayout, FrameLayout frameLayout, View view, Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
        int i2;
        String str;
        ...
        actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ReadAllMentionsMenu$$ExternalSyntheticLambda0
        ...
        if (AndroidUtilities.isTablet()) {
            ViewGroup view2 = actionBarLayout.getView();
