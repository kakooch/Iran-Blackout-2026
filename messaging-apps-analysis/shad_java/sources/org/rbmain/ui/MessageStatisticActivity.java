...
import org.rbmain.tgnet.TLRPC$TL_stats_getMessagePublicForwards;
import org.rbmain.tgnet.TLRPC$TL_stats_getMessageStats;
import org.rbmain.tgnet.TLRPC$TL_stats_loadAsyncGraph;
import org.rbmain.tgnet.TLRPC$TL_stats_messageStats;
...
import org.rbmain.ui.StatisticActivity;
...
public class MessageStatisticActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final Runnable showProgressbar = new Runnable() { // from class: org.rbmain.ui.MessageStatisticActivity.1
    ...
    private void updateRows() {
        ...
        if (this.firstLoaded && this.statsLoaded) {
            ...
            if (this.listContainer.getVisibility() == 8) {
                this.progressLayout.animate().alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.MessageStatisticActivity.2
    ...
    */
    public android.view.View createView(android.content.Context r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.MessageStatisticActivity.createView(android.content.Context):android.view.View");
    }
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i) {
        ...
        bundle.putLong("message_id", tLRPC$Message.id);
    ...
    public void loadChats(int i) {
        ...
        getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_stats_getMessagePublicForwards, new RequestDelegate() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda5
    ...
    public /* synthetic */ void lambda$loadChats$3(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadChats$2(tLRPC$TL_error, tLObject);
            }
        });
    }
    ...
    private void loadStat() {
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_stats_getMessageStats, new RequestDelegate() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda6
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadStat$8(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadStat$7(tLRPC$TL_error, tLObject);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$loadStat$7(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (chartViewDataCreateViewData != null && chartViewDataCreateViewData.chartData.x.length <= 5) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_stats_loadAsyncGraph, new RequestDelegate() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda7
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) throws JSONException {
                    this.f$0.lambda$loadStat$6(str, tLRPC$TL_stats_loadAsyncGraph, tLObject2, tLRPC$TL_error2);
                }
            }, null, null, 0, this.chat.stats_dc, 1, true), this.classGuid);
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadStat$6(final String str, final TLRPC$TL_stats_loadAsyncGraph tLRPC$TL_stats_loadAsyncGraph, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) throws JSONException {
        ...
        if (tLObject instanceof TLRPC$TL_statsGraph) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$loadStat$4(tLObject);
                }
            });
        }
        final ChartData chartData = chartDataCreateChartData;
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadStat$5(tLRPC$TL_error, chartData, str, tLRPC$TL_stats_loadAsyncGraph);
            }
        });
    }
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* renamed from: org.rbmain.ui.MessageStatisticActivity$ListAdapter$1, reason: invalid class name */
        class AnonymousClass1 extends StatisticActivity.BaseChartCell {
            ...
            public void onZoomed() {
                ...
                if (baseChartView.legendSignatureView.canGoZoom) {
                    ...
                    ConnectionsManager.getInstance(((BaseFragment) MessageStatisticActivity.this).currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(((BaseFragment) MessageStatisticActivity.this).currentAccount).sendRequest(tLRPC$TL_stats_loadAsyncGraph, new RequestDelegate() { // from class: org.rbmain.ui.MessageStatisticActivity$ListAdapter$1$$ExternalSyntheticLambda1
                        @Override // org.rbmain.tgnet.RequestDelegate
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onZoomed$1(final String str, final StatisticActivity.ZoomCancelable zoomCancelable, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) throws JSONException {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.MessageStatisticActivity$ListAdapter$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (dialogId > 0) {
                user = MessageStatisticActivity.this.getMessagesController().getUser(Integer.valueOf(dialogId));
                str = null;
            } else {
                TLRPC$Chat chat = MessageStatisticActivity.this.getMessagesController().getChat(Integer.valueOf(-dialogId));
                if (chat.participants_count != 0) {
                    if (ChatObject.isChannel(chat) && !chat.megagroup) {
                        pluralString = LocaleController.formatPluralString("Subscribers", chat.participants_count);
                    } else {
                        pluralString = LocaleController.formatPluralString("Members", chat.participants_count);
                    }
                    str = String.format("%1$s, %2$s", pluralString, LocaleController.formatPluralString("Views", item.views));
                } else {
                    str = null;
                }
                user = chat;
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.rbmain.ui.MessageStatisticActivity$$ExternalSyntheticLambda8
