...
import org.rbmain.messenger.SecureDocumentKey;
...
import org.rbmain.tgnet.TLRPC$InputSecureFile;
import org.rbmain.tgnet.TLRPC$PasswordKdfAlgo;
import org.rbmain.tgnet.TLRPC$PhotoSize;
import org.rbmain.tgnet.TLRPC$SecureFile;
import org.rbmain.tgnet.TLRPC$SecurePasswordKdfAlgo;
import org.rbmain.tgnet.TLRPC$SecurePlainData;
import org.rbmain.tgnet.TLRPC$SecureRequiredType;
import org.rbmain.tgnet.TLRPC$SecureValueType;
import org.rbmain.tgnet.TLRPC$TL_account_acceptAuthorization;
import org.rbmain.tgnet.TLRPC$TL_account_authorizationForm;
import org.rbmain.tgnet.TLRPC$TL_account_deleteSecureValue;
...
import org.rbmain.tgnet.TLRPC$TL_account_passwordSettings;
import org.rbmain.tgnet.TLRPC$TL_account_saveSecureValue;
import org.rbmain.tgnet.TLRPC$TL_account_sendVerifyEmailCode;
import org.rbmain.tgnet.TLRPC$TL_account_sendVerifyPhoneCode;
import org.rbmain.tgnet.TLRPC$TL_account_sentEmailCode;
import org.rbmain.tgnet.TLRPC$TL_account_updatePasswordSettings;
import org.rbmain.tgnet.TLRPC$TL_account_verifyEmail;
import org.rbmain.tgnet.TLRPC$TL_account_verifyPhone;
...
import org.rbmain.tgnet.TLRPC$TL_help_getPassportConfig;
import org.rbmain.tgnet.TLRPC$TL_help_passportConfig;
import org.rbmain.tgnet.TLRPC$TL_inputFile;
import org.rbmain.tgnet.TLRPC$TL_inputSecureFile;
import org.rbmain.tgnet.TLRPC$TL_inputSecureFileUploaded;
import org.rbmain.tgnet.TLRPC$TL_inputSecureValue;
import org.rbmain.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow;
import org.rbmain.tgnet.TLRPC$TL_secureCredentialsEncrypted;
import org.rbmain.tgnet.TLRPC$TL_secureData;
...
import org.rbmain.tgnet.TLRPC$TL_securePasswordKdfAlgoSHA512;
import org.rbmain.tgnet.TLRPC$TL_securePasswordKdfAlgoUnknown;
import org.rbmain.tgnet.TLRPC$TL_securePlainEmail;
import org.rbmain.tgnet.TLRPC$TL_securePlainPhone;
import org.rbmain.tgnet.TLRPC$TL_secureRequiredType;
import org.rbmain.tgnet.TLRPC$TL_secureRequiredTypeOneOf;
import org.rbmain.tgnet.TLRPC$TL_secureSecretSettings;
import org.rbmain.tgnet.TLRPC$TL_secureValue;
import org.rbmain.tgnet.TLRPC$TL_secureValueHash;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeAddress;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeBankStatement;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeDriverLicense;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeEmail;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeIdentityCard;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeInternalPassport;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypePassport;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypePassportRegistration;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypePersonalDetails;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypePhone;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeRentalAgreement;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeTemporaryRegistration;
import org.rbmain.tgnet.TLRPC$TL_secureValueTypeUtilityBill;
...
import org.rbmain.ui.Components.RadialProgress;
...
public class PassportActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:51:0x0149 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:52:0x015b  */
    /* JADX WARN: Removed duplicated region for block: B:55:0x0160 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:56:0x0165  */
    /* JADX WARN: Removed duplicated region for block: B:59:0x0170  */
    /* JADX WARN: Removed duplicated region for block: B:60:0x0171 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:63:0x017b A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:66:0x0185 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:69:0x018f A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:72:0x0199 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:75:0x01a3 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:78:0x01ac A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:81:0x01b6  */
    /* JADX WARN: Removed duplicated region for block: B:83:0x01ba  */
    /* JADX WARN: Removed duplicated region for block: B:84:0x01bc A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:85:0x01c1 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    /* JADX WARN: Removed duplicated region for block: B:86:0x01d4 A[Catch: Exception -> 0x023f, TryCatch #0 {Exception -> 0x023f, blocks: (B:6:0x0037, B:8:0x004a, B:11:0x0066, B:49:0x013f, B:51:0x0149, B:55:0x0160, B:57:0x0167, B:58:0x016d, B:82:0x01b7, B:84:0x01bc, B:85:0x01c1, B:86:0x01d4, B:88:0x01e9, B:89:0x01fc, B:90:0x0203, B:92:0x0218, B:93:0x022b, B:95:0x0233, B:60:0x0171, B:63:0x017b, B:66:0x0185, B:69:0x018f, B:72:0x0199, B:75:0x01a3, B:78:0x01ac, B:13:0x007b, B:15:0x007f, B:16:0x008e, B:18:0x0092, B:19:0x00a1, B:21:0x00a5, B:22:0x00b4, B:24:0x00b8, B:25:0x00c7, B:27:0x00cb, B:28:0x00da, B:30:0x00de, B:31:0x00ec, B:33:0x00f0, B:34:0x0100, B:36:0x0104, B:37:0x0107, B:39:0x010f, B:41:0x011b, B:48:0x012f, B:44:0x0127), top: B:101:0x0037 }] */
    ...
    */
    public PassportActivity(int r20, int r21, java.lang.String r22, java.lang.String r23, java.lang.String r24, java.lang.String r25, java.lang.String r26, org.rbmain.tgnet.TLRPC$TL_account_authorizationForm r27, org.rbmain.tgnet.TLRPC$TL_account_password r28) {
        /*
            Method dump skipped, instructions count: 624
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.<init>(int, int, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, org.rbmain.tgnet.TLRPC$TL_account_authorizationForm, org.rbmain.tgnet.TLRPC$TL_account_password):void");
    }

    public PassportActivity(int i, TLRPC$TL_account_authorizationForm tLRPC$TL_account_authorizationForm, TLRPC$TL_account_password tLRPC$TL_account_password, TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, TLRPC$TL_secureValue tLRPC$TL_secureValue, TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType2, TLRPC$TL_secureValue tLRPC$TL_secureValue2, HashMap<String, String> map, HashMap<String, String> map2) {
        this.currentCitizeship = BuildConfig.FLAVOR;
        this.currentResidence = BuildConfig.FLAVOR;
        ...
        this.provider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: org.rbmain.ui.PassportActivity.1
        ...
        if (i == 5) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_help_getPassportConfig, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda67
    ...
    public static /* synthetic */ void lambda$new$1(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda45
    ...
    public void onResume() {
        ...
        if (this.currentActivityType == 5 && (viewGroupArr = this.inputFieldContainers) != null && viewGroupArr[0] != null && viewGroupArr[0].getVisibility() == 0) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda47
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public View createView(Context context) throws NoSuchFieldException, NoSuchAlgorithmException, IOException {
        ...
        if (this.currentActivityType == 7) {
            ScrollView scrollView = new ScrollView(context) { // from class: org.rbmain.ui.PassportActivity.4
            ...
            ScrollView scrollView2 = new ScrollView(this, context) { // from class: org.rbmain.ui.PassportActivity.5
                @Override // android.widget.ScrollView, android.view.ViewGroup
                protected boolean onRequestFocusInDescendants(int i, Rect rect) {
                    return false;
                }
    ...
    /* renamed from: org.rbmain.ui.PassportActivity$3, reason: invalid class name */
    class AnonymousClass3 extends ActionBar.ActionBarMenuOnItemClick {
        ...
        private boolean onIdentityDone(final Runnable runnable, final ErrorRunnable errorRunnable) throws JSONException {
                    ...
                    if (PassportActivity.this.nonLatinNames[i]) {
                        ...
                        if (!z) {
                            ...
                            if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3)) {
                                ...
                                builder.setPositiveButton(LocaleController.getString("Done", R.string.Done), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$3$$ExternalSyntheticLambda1
                                    @Override // android.content.DialogInterface.OnClickListener
                                    public final void onClick(DialogInterface dialogInterface, int i2) throws JSONException {
                                        this.f$0.lambda$onIdentityDone$0(str, str2, str3, runnable, errorRunnable, dialogInterface, i2);
                                    }
                                });
                                builder.setNegativeButton(LocaleController.getString("Edit", R.string.Edit), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$3$$ExternalSyntheticLambda0
                                    @Override // android.content.DialogInterface.OnClickListener
                                    public final void onClick(DialogInterface dialogInterface, int i2) {
                                        this.f$0.lambda$onIdentityDone$1(i, dialogInterface, i2);
                                    }
                                });
            ...
            if (!PassportActivity.this.isHasNotAnyChanges()) {
                ...
                try {
                    if (PassportActivity.this.documentOnly) {
                        ...
                        try {
                            ...
                            Collections.sort(arrayList, new Comparator() { // from class: org.rbmain.ui.PassportActivity$3$$ExternalSyntheticLambda4
                    ...
                    if (PassportActivity.this.currentDocumentsType != null) {
                        ...
                        if (PassportActivity.this.currentExpireDate[0] != 0) {
                            ...
                            map2.put("expiry_date", BuildConfig.FLAVOR);
                        }
                        jSONObject2 = new JSONObject();
                        try {
                            ArrayList arrayList2 = new ArrayList(map2.keySet());
                            Collections.sort(arrayList2, new Comparator() { // from class: org.rbmain.ui.PassportActivity$3$$ExternalSyntheticLambda5
                                @Override // java.util.Comparator
                                public final int compare(Object obj, Object obj2) {
                ...
                passportActivityDelegate.saveValue(tLRPC$TL_secureRequiredType, null, string4, tLRPC$TL_secureRequiredType2, string5, null, secureDocument2, arrayList3, secureDocument3, secureDocument, runnable, errorRunnable);
                return true;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onIdentityDone$0(String str, String str2, String str3, Runnable runnable, ErrorRunnable errorRunnable, DialogInterface dialogInterface, int i) throws JSONException {
        ...
        public void onItemClick(int i) throws JSONException {
            ...
            if (i == 1) {
                ...
                if (iIndexOf != -1 && iLastIndexOf != -1) {
                    ...
                    spannableStringBuilder.setSpan(new URLSpanNoUnderline(LocaleController.getString("PassportInfoUrl", R.string.PassportInfoUrl)) { // from class: org.rbmain.ui.PassportActivity.3.1
            ...
            if (i == 2) {
                ...
                final Runnable runnable = new Runnable() { // from class: org.rbmain.ui.PassportActivity$3$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onItemClick$4();
                    }
                };
                final ErrorRunnable errorRunnable = new ErrorRunnable() { // from class: org.rbmain.ui.PassportActivity.3.2
                    @Override // org.rbmain.ui.PassportActivity.ErrorRunnable
                ...
                if (PassportActivity.this.currentActivityType == 4) {
                    ...
                    if (PassportActivity.this.currentActivityType == 6) {
                        ...
                        ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(tLRPC$TL_account_verifyEmail, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$3$$ExternalSyntheticLambda6
                            @Override // org.rbmain.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                                this.f$0.lambda$onItemClick$6(runnable, errorRunnable, tLRPC$TL_account_verifyEmail, tLObject, tLRPC$TL_error);
                            }
        ...
        public /* synthetic */ void lambda$onItemClick$6(final Runnable runnable, final ErrorRunnable errorRunnable, final TLRPC$TL_account_verifyEmail tLRPC$TL_account_verifyEmail, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$3$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$5(tLRPC$TL_error, runnable, errorRunnable, tLRPC$TL_account_verifyEmail);
                }
            });
        }
    ...
    private void loadPasswordInfo() {
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda63
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadPasswordInfo$4(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda55
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void createEmailVerificationInterface(Context context) {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            this.inputFields[i].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda40
                @Override // android.widget.TextView.OnEditorActionListener
                public final boolean onEditorAction(TextView textView, int i4, KeyEvent keyEvent) {
                    return this.f$0.lambda$createEmailVerificationInterface$5(textView, i4, keyEvent);
                }
            });
            this.inputFields[i].addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.PassportActivity.6
    ...
    private void createPasswordInterface(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("RubikaPassport", R.string.RubikaPassport));
        ...
        this.noPasswordTextView.setText(LocaleController.getString("RubikaPassportCreatePasswordInfo", R.string.RubikaPassportCreatePasswordInfo));
        ...
        this.noPasswordSetTextView.setText(LocaleController.getString("RubikaPassportCreatePassword", R.string.RubikaPassportCreatePassword));
        ...
        this.noPasswordSetTextView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda13
        ...
        for (int i2 = 0; i2 < 1; i2++) {
            ...
            this.inputFields[i2].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda42
                @Override // android.widget.TextView.OnEditorActionListener
                public final boolean onEditorAction(TextView textView3, int i4, KeyEvent keyEvent) {
                    return this.f$0.lambda$createPasswordInterface$7(textView3, i4, keyEvent);
                }
            });
            this.inputFields[i2].setCustomSelectionActionModeCallback(new ActionMode.Callback(this) { // from class: org.rbmain.ui.PassportActivity.7
        ...
        this.passwordForgotButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda15
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$createPasswordInterface$11(view);
            }
        });
        updatePasswordInterface();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createPasswordInterface$11(View view) {
        if (this.currentPassword.has_recovery) {
            needShowProgress();
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_auth_requestPasswordRecovery(), new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda61
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$createPasswordInterface$10(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda58
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createPasswordInterface$9(tLRPC$TL_error, tLObject);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$createPasswordInterface$9(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda6
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$createPasswordInterface$8(tLRPC$TL_auth_passwordRecovery, dialogInterface, i);
                }
            });
    ...
    public void onPasswordDone(final boolean z) {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda60
            @Override // java.lang.Runnable
            public final void run() throws NoSuchAlgorithmException {
                this.f$0.lambda$onPasswordDone$12(z, string);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$onPasswordDone$12(boolean r11, java.lang.String r12) throws java.security.NoSuchAlgorithmException {
        /*
            r10 = this;
            org.rbmain.tgnet.TLRPC$TL_account_getPasswordSettings r6 = new org.rbmain.tgnet.TLRPC$TL_account_getPasswordSettings
            r6.<init>()
            r7 = 0
            if (r11 == 0) goto Lc
        ...
        La:
            ...
            goto L24
        Lc:
            org.rbmain.tgnet.TLRPC$TL_account_password r0 = r10.currentPassword
            org.rbmain.tgnet.TLRPC$PasswordKdfAlgo r0 = r0.current_algo
            boolean r0 = r0 instanceof org.rbmain.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow
            if (r0 == 0) goto L23
            byte[] r0 = org.rbmain.messenger.AndroidUtilities.getStringBytes(r12)
            org.rbmain.tgnet.TLRPC$TL_account_password r1 = r10.currentPassword
            org.rbmain.tgnet.TLRPC$PasswordKdfAlgo r1 = r1.current_algo
            org.rbmain.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow r1 = (org.rbmain.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) r1
            byte[] r0 = org.rbmain.messenger.SRPHelper.getX(r0, r1)
            goto La
        L23:
            r8 = r7
        L24:
            org.rbmain.ui.PassportActivity$8 r9 = new org.rbmain.ui.PassportActivity$8
            r0 = r9
            r1 = r10
            r2 = r11
            r3 = r8
            ...
            r5 = r12
            r0.<init>(r2, r3, r4, r5)
            org.rbmain.tgnet.TLRPC$TL_account_password r11 = r10.currentPassword
            org.rbmain.tgnet.TLRPC$PasswordKdfAlgo r12 = r11.current_algo
            boolean r0 = r12 instanceof org.rbmain.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow
            if (r0 == 0) goto L6a
            org.rbmain.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow r12 = (org.rbmain.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) r12
            long r0 = r11.srp_id
            byte[] r11 = r11.srp_B
            org.rbmain.tgnet.TLRPC$TL_inputCheckPasswordSRP r11 = org.rbmain.messenger.SRPHelper.startCheck(r8, r0, r11, r12)
            r6.password = r11
            if (r11 != 0) goto L52
            org.rbmain.tgnet.TLRPC$TL_error r11 = new org.rbmain.tgnet.TLRPC$TL_error
            r11.<init>()
        ...
        L52:
            ...
            org.rbmain.tgnet.ConnectionsManager r11 = org.rbmain.tgnet.ConnectionsManager.getInstance(r11)
            r12 = 10
            int r11 = r11.sendRequest(r6, r9, r12)
            int r12 = r10.currentAccount
            org.rbmain.tgnet.ConnectionsManager r12 = org.rbmain.tgnet.ConnectionsManager.getInstance(r12)
        ...
        L76:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.lambda$onPasswordDone$12(boolean, java.lang.String):void");
    }

    /* renamed from: org.rbmain.ui.PassportActivity$8, reason: invalid class name */
    class AnonymousClass8 implements RequestDelegate {
        ...
        private void resetSecret() {
            ...
            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(this.val$req, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda12
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        public /* synthetic */ void lambda$resetSecret$3(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$resetSecret$2(tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$resetSecret$2(TLRPC$TL_error tLRPC$TL_error) {
            if (tLRPC$TL_error != null && "SRP_ID_INVALID".equals(tLRPC$TL_error.text)) {
                ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda15
                    @Override // org.rbmain.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error2) {
                        this.f$0.lambda$resetSecret$1(tLObject, tLRPC$TL_error2);
                    }
                }, 8);
            } else {
                generateNewSecret();
        ...
        public /* synthetic */ void lambda$resetSecret$1(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$resetSecret$0(tLRPC$TL_error, tLObject);
                }
            });
        }
        ...
        private void generateNewSecret() {
            ...
            dispatchQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda10
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$generateNewSecret$8(byte[] bArr, String str) {
            ...
            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(tLRPC$TL_account_updatePasswordSettings, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda11
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        public /* synthetic */ void lambda$generateNewSecret$7(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$generateNewSecret$6(tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$generateNewSecret$6(TLRPC$TL_error tLRPC$TL_error) {
            ...
            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda13
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error2) {
                    this.f$0.lambda$generateNewSecret$5(tLObject, tLRPC$TL_error2);
                }
            }, 8);
        }
        ...
        public /* synthetic */ void lambda$generateNewSecret$5(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$generateNewSecret$4(tLRPC$TL_error, tLObject);
                }
            });
        }
        ...
        public void run(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            if (tLRPC$TL_error != null && "SRP_ID_INVALID".equals(tLRPC$TL_error.text)) {
                ...
                connectionsManager.sendRequest(tLRPC$TL_account_getPassword, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda16
                    @Override // org.rbmain.tgnet.RequestDelegate
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) {
                        this.f$0.lambda$run$10(z, tLObject2, tLRPC$TL_error2);
                    }
                }, 8);
                return;
            }
            if (tLRPC$TL_error == null) {
                ...
                dispatchQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$16(z3, tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$run$10(final boolean z, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$9(tLRPC$TL_error, tLObject, z);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$run$15(TLObject tLObject, String str, final boolean z) {
            ...
            if (tLRPC$TL_secureSecretSettings == null) {
                ...
                if (tLRPC$SecurePasswordKdfAlgo instanceof TLRPC$TL_securePasswordKdfAlgoSHA512) {
                    ...
                    if (tLRPC$SecurePasswordKdfAlgo instanceof TLRPC$TL_securePasswordKdfAlgoUnknown) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$14(tLRPC$TL_account_passwordSettings, z, bArr);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$run$14(TLRPC$TL_account_passwordSettings tLRPC$TL_account_passwordSettings, boolean z, byte[] bArr) {
            ...
            if (PassportActivity.checkSecret(passportActivity2.decryptSecret(passportActivity2.secureSecret, PassportActivity.this.saltedPassword), Long.valueOf(PassportActivity.this.secureSecretId)) && bArr.length != 0 && PassportActivity.this.secureSecretId != 0) {
                if (PassportActivity.this.currentBotId == 0) {
                    ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(new TLObject() { // from class: org.rbmain.tgnet.TLRPC$TL_account_getAllSecureValues
                        ...
                        public TLObject deserializeResponse(AbstractSerializedData abstractSerializedData, int i, boolean z2) {
                            ...
                            for (int i2 = 0; i2 < int32; i2++) {
                                TLRPC$TL_secureValue tLRPC$TL_secureValueTLdeserialize = TLRPC$TL_secureValue.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z2), z2);
                    ...
                    }, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda14
                        @Override // org.rbmain.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            this.f$0.lambda$run$13(tLObject, tLRPC$TL_error);
                        }
                    });
                    return;
                } else {
        ...
        public /* synthetic */ void lambda$run$13(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$8$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$12(tLObject, tLRPC$TL_error);
                }
            });
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:33:0x0154 A[PHI: r1 r2 r3 r8
      0x0154: PHI (r1v60 boolean) = 
      (r1v36 boolean)
      (r1v36 boolean)
      (r1v36 boolean)
      (r1v36 boolean)
      ...
      (r1v61 boolean)
      (r1v36 boolean)
     binds: [B:35:0x015a, B:37:0x0164, B:40:0x0171, B:53:0x01aa, B:51:0x01a1, B:31:0x0151, B:32:0x0153, B:29:0x014d, B:26:0x0141] A[DONT_GENERATE, DONT_INLINE]
      0x0154: PHI (r2v44 int) = (r2v23 int), (r2v23 int), (r2v23 int), (r2v23 int), (r2v45 int), (r2v23 int), (r2v23 int), (r2v23 int), (r2v23 int) binds: [B:35:0x015a, B:37:0x0164, B:40:0x0171, B:53:0x01aa, B:51:0x01a1, B:31:0x0151, B:32:0x0153, B:29:0x014d, B:26:0x0141] A[DONT_GENERATE, DONT_INLINE]
      0x0154: PHI (r3v25 boolean) = 
      (r3v15 boolean)
      (r3v15 boolean)
      (r3v15 boolean)
      (r3v15 boolean)
      ...
      (r3v15 boolean)
     binds: [B:35:0x015a, B:37:0x0164, B:40:0x0171, B:53:0x01aa, B:51:0x01a1, B:31:0x0151, B:32:0x0153, B:29:0x014d, B:26:0x0141] A[DONT_GENERATE, DONT_INLINE]
      0x0154: PHI (r8v7 int) = (r8v1 int), (r8v1 int), (r8v1 int), (r8v1 int), (r8v1 int), (r8v1 int), (r8v1 int), (r8v1 int), (r8v8 int) binds: [B:35:0x015a, B:37:0x0164, B:40:0x0171, B:53:0x01aa, B:51:0x01a1, B:31:0x0151, B:32:0x0153, B:29:0x014d, B:26:0x0141] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:86:0x0213  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private void createRequestInterface(android.content.Context r23) throws java.security.NoSuchAlgorithmException {
        /*
            Method dump skipped, instructions count: 1153
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.createRequestInterface(android.content.Context):void");
    }

    /* renamed from: org.rbmain.ui.PassportActivity$1ValueToSend, reason: invalid class name */
    class C1ValueToSend {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createRequestInterface$15(View view) throws JSONException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        ArrayList arrayList;
        int i;
        ...
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_account_acceptAuthorization, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda62
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$createRequestInterface$14(tLObject, tLRPC$TL_error);
            }
        }), this.classGuid);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createRequestInterface$14(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda56
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createRequestInterface$13(tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createRequestInterface$13(TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error == null) {
    ...
    */
    private void createManageInterface(android.content.Context r20) throws java.security.NoSuchAlgorithmException {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.createManageInterface(android.content.Context):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createManageInterface$16(View view) {
        openAddDocumentAlert();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createManageInterface$20(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setTitle(LocaleController.getString("RubikaPassportDeleteTitle", R.string.RubikaPassportDeleteTitle));
        builder.setMessage(LocaleController.getString("RubikaPassportDeleteAlert", R.string.RubikaPassportDeleteAlert));
        builder.setPositiveButton(LocaleController.getString("Delete", R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$createManageInterface$19(dialogInterface, i);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createManageInterface$19(DialogInterface dialogInterface, int i) {
        ...
        needShowProgress();
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_account_deleteSecureValue, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda64
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$createManageInterface$18(tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createManageInterface$18(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda51
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createManageInterface$17();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createManageInterface$17() {
        int i = 0;
    ...
    private void openAddDocumentAlert() {
        ...
        builder.setItems((CharSequence[]) arrayList.toArray(new CharSequence[0]), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$openAddDocumentAlert$22(arrayList2, dialogInterface, i);
            }
        });
        showDialog(builder.create());
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$openAddDocumentAlert$22(java.util.ArrayList r2, android.content.DialogInterface r3, int r4) {
        /*
            r1 = this;
            r3 = 0
            org.rbmain.tgnet.TLRPC$TL_secureRequiredType r0 = new org.rbmain.tgnet.TLRPC$TL_secureRequiredType     // Catch: java.lang.Exception -> L17
            ...
            org.rbmain.tgnet.TLRPC$SecureValueType r2 = (org.rbmain.tgnet.TLRPC$SecureValueType) r2     // Catch: java.lang.Exception -> L15
        ...
        L17:
            r0 = r3
        L18:
            org.rbmain.tgnet.TLRPC$SecureValueType r2 = r0.type
            boolean r2 = r1.isPersonalDocument(r2)
            r4 = 1
            if (r2 == 0) goto L34
            r0.selfie_required = r4
            r0.translation_required = r4
            org.rbmain.tgnet.TLRPC$TL_secureRequiredType r2 = new org.rbmain.tgnet.TLRPC$TL_secureRequiredType
            r2.<init>()
            org.rbmain.tgnet.TLRPC$TL_secureValueTypePersonalDetails r3 = new org.rbmain.tgnet.TLRPC$TL_secureValueTypePersonalDetails
            r3.<init>()
            r2.type = r3
        L31:
            r3 = r0
        ...
        L34:
            ...
            org.rbmain.tgnet.TLRPC$TL_secureRequiredType r2 = new org.rbmain.tgnet.TLRPC$TL_secureRequiredType
            r2.<init>()
            org.rbmain.tgnet.TLRPC$TL_secureValueTypeAddress r3 = new org.rbmain.tgnet.TLRPC$TL_secureValueTypeAddress
            r3.<init>()
            r2.type = r3
            goto L31
        L49:
        ...
        L52:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.lambda$openAddDocumentAlert$22(java.util.ArrayList, android.content.DialogInterface, int):void");
    }
    ...
    private void createEmailInterface(Context context) {
        ...
        if (!TextUtils.isEmpty(this.currentEmail)) {
            ...
            textSettingsCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda26
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$createEmailInterface$23(view);
                }
            });
            TextInfoPrivacyCell textInfoPrivacyCell = new TextInfoPrivacyCell(context);
            this.bottomCell = textInfoPrivacyCell;
        ...
        for (int i = 0; i < 1; i++) {
            ...
            frameLayout.addView(this.inputFields[i], LayoutHelper.createFrame(-1, -2.0f, 51, 21.0f, 12.0f, 21.0f, 6.0f));
            this.inputFields[i].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda44
                @Override // android.widget.TextView.OnEditorActionListener
                public final boolean onEditorAction(TextView textView, int i3, KeyEvent keyEvent) {
                    return this.f$0.lambda$createEmailInterface$24(textView, i3, keyEvent);
                }
            });
        }
        TextInfoPrivacyCell textInfoPrivacyCell2 = new TextInfoPrivacyCell(context);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createEmailInterface$23(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createEmailInterface$24(TextView textView, int i, KeyEvent keyEvent) {
        if (i != 6 && i != 5) {
            return false;
        }
        this.doneItem.callOnClick();
    ...
    /* JADX WARN: Type inference failed for: r13v5, types: [android.view.View, android.view.ViewGroup, android.widget.LinearLayout] */
    ...
    private void createPhoneInterface(Context context) throws IOException {
        ...
        this.linearLayout2.addView(textSettingsCell, LayoutHelper.createLinear(-1, -2));
        textSettingsCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda19
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$createPhoneInterface$25(view);
            }
        });
        TextInfoPrivacyCell textInfoPrivacyCell = new TextInfoPrivacyCell(context);
        this.bottomCell = textInfoPrivacyCell;
        ...
        while (true) {
            ...
            if (i < 3) {
                ...
                this.inputFields[i].setCursorWidth(1.5f);
                if (i == 0) {
                    this.inputFields[i].setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda33
                        @Override // android.view.View.OnTouchListener
                        public final boolean onTouch(View view, MotionEvent motionEvent) {
                            return this.f$0.lambda$createPhoneInterface$28(view, motionEvent);
                        }
                    });
                ...
                if (i == 1) {
                    ...
                    this.inputFields[i].addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.PassportActivity.9
                        @Override // android.text.TextWatcher
                    ...
                    this.inputFields[i].addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.PassportActivity.10
                ...
                this.inputFields[i].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda43
                    @Override // android.widget.TextView.OnEditorActionListener
                    public final boolean onEditorAction(TextView textView2, int i3, KeyEvent keyEvent) {
                        return this.f$0.lambda$createPhoneInterface$29(textView2, i3, keyEvent);
                    }
                });
                if (i == 2) {
                    this.inputFields[i].setOnKeyListener(new View.OnKeyListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda31
                        @Override // android.view.View.OnKeyListener
                        public final boolean onKey(View view, int i3, KeyEvent keyEvent) {
                            return this.f$0.lambda$createPhoneInterface$30(view, i3, keyEvent);
                        }
                    });
                }
                if (i == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createPhoneInterface$25(View view) {
        this.useCurrentValue = true;
        this.doneItem.callOnClick();
        this.useCurrentValue = false;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createPhoneInterface$28(View view, MotionEvent motionEvent) {
        if (getParentActivity() == null) {
            return false;
        }
        if (motionEvent.getAction() == 1) {
            CountrySelectActivity countrySelectActivity = new CountrySelectActivity(false);
            countrySelectActivity.setCountrySelectActivityDelegate(new CountrySelectActivity.CountrySelectActivityDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda69
                ...
                public final void didSelectCountry(String str, String str2) {
                    this.f$0.lambda$createPhoneInterface$27(str, str2);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createPhoneInterface$27(String str, String str2) {
        ...
        if (this.countriesArray.indexOf(str) != -1) {
            ...
            this.inputFields[2].setHintText(str4 != null ? str4.replace('X', (char) 8211) : null);
            this.ignoreOnTextChange = false;
        }
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda49
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createPhoneInterface$26();
            }
        }, 300L);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createPhoneInterface$26() {
        AndroidUtilities.showKeyboard(this.inputFields[2]);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createPhoneInterface$29(TextView textView, int i, KeyEvent keyEvent) {
        if (i == 5) {
            this.inputFields[2].requestFocus();
            return true;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createPhoneInterface$30(View view, int i, KeyEvent keyEvent) {
    ...
    private void createAddressInterface(Context context) throws IOException {
        ...
        textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider_top, i));
        ...
        if (tLRPC$TL_secureRequiredType != null) {
            ...
            headerCell2.setBackgroundColor(Theme.getColor(i2));
            this.linearLayout2.addView(this.headerCell, LayoutHelper.createLinear(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            ...
            this.uploadDocumentCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda17
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$createAddressInterface$31(view);
                }
            });
            TextInfoPrivacyCell textInfoPrivacyCell2 = new TextInfoPrivacyCell(context);
            this.bottomCell = textInfoPrivacyCell2;
            textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider, i));
            if (this.currentBotId != 0) {
                ...
                if (tLRPC$SecureValueType2 instanceof TLRPC$TL_secureValueTypeRentalAgreement) {
                    ...
                    this.noAllDocumentsErrorText = BuildConfig.FLAVOR;
                }
            }
            ...
            if (map != null) {
                ...
                if (str2 != null) {
                    ...
                    this.errorsValues.put("files_all", BuildConfig.FLAVOR);
            ...
            if (this.currentDocumentsType.translation_required) {
                ...
                this.headerCell.setBackgroundColor(Theme.getColor(i2));
                this.linearLayout2.addView(this.headerCell, LayoutHelper.createLinear(-1, -2));
                ...
                this.uploadTranslationCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda14
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                ...
                textInfoPrivacyCell3.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider, i));
                if (this.currentBotId != 0) {
                    ...
                    if (tLRPC$SecureValueType3 instanceof TLRPC$TL_secureValueTypeRentalAgreement) {
                        ...
                        this.noAllTranslationErrorText = BuildConfig.FLAVOR;
                    }
                }
                ...
                if (map2 != null) {
                    ...
                    if (str3 != null) {
                        ...
                        this.errorsValues.put("translation_all", BuildConfig.FLAVOR);
        ...
        for (int i3 = 0; i3 < 6; i3++) {
            ...
            FrameLayout frameLayout = new FrameLayout(this, context) { // from class: org.rbmain.ui.PassportActivity.11
            ...
            this.inputFields[i3].setCursorColor(Theme.getColor(i5));
            ...
            if (i3 == 5) {
                this.inputFields[i3].setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda34
                    @Override // android.view.View.OnTouchListener
                    public final boolean onTouch(View view3, MotionEvent motionEvent) {
                        return this.f$0.lambda$createAddressInterface$34(view3, motionEvent);
                    }
                });
            ...
            if (i3 == 2) {
                this.inputFields[i3].addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.PassportActivity.12
                    private boolean ignore;

                    @Override // android.text.TextWatcher
                    public void beforeTextChanged(CharSequence charSequence5, int i6, int i7, int i8) {
                    }

                    @Override // android.text.TextWatcher
                    public void onTextChanged(CharSequence charSequence5, int i6, int i7, int i8) {
                    }
                ...
                this.inputFields[i3].addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.PassportActivity.13
                    @Override // android.text.TextWatcher
                    public void beforeTextChanged(CharSequence charSequence5, int i6, int i7, int i8) {
                    }
            ...
            this.inputFields[i3].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda39
                @Override // android.widget.TextView.OnEditorActionListener
                public final boolean onEditorAction(TextView textView, int i6, KeyEvent keyEvent) {
                    return this.f$0.lambda$createAddressInterface$35(textView, i6, keyEvent);
                }
            });
        }
        ...
        if (((this.currentBotId != 0 || this.currentDocumentsType == null) && this.currentTypeValue != null && !this.documentOnly) || this.currentDocumentsTypeValue != null) {
            ...
            shadowSectionCell2.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider, i6));
            ...
            textSettingsCell3.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda20
                @Override // android.view.View.OnClickListener
                public final void onClick(View view3) {
                    this.f$0.lambda$createAddressInterface$36(view3);
                }
            });
            ShadowSectionCell shadowSectionCell3 = new ShadowSectionCell(context);
            this.sectionCell = shadowSectionCell3;
            shadowSectionCell3.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider_bottom, i6));
            ...
            shadowSectionCell4.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider_bottom, i7));
            if (this.documentOnly && this.currentDocumentsType != null) {
                this.bottomCell.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider_bottom, i7));
            }
        }
        updateUploadText(0);
        updateUploadText(4);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createAddressInterface$31(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createAddressInterface$34(View view, MotionEvent motionEvent) {
        if (getParentActivity() == null) {
            return false;
        }
        if (motionEvent.getAction() == 1) {
            CountrySelectActivity countrySelectActivity = new CountrySelectActivity(false);
            countrySelectActivity.setCountrySelectActivityDelegate(new CountrySelectActivity.CountrySelectActivityDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda70
                @Override // org.rbmain.ui.CountrySelectActivity.CountrySelectActivityDelegate
                public final void didSelectCountry(String str, String str2) {
                    this.f$0.lambda$createAddressInterface$33(str, str2);
                }
            });
            presentFragment(countrySelectActivity);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createAddressInterface$33(String str, String str2) {
        this.inputFields[5].setText(str);
        this.currentCitizeship = str2;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createAddressInterface$35(TextView textView, int i, KeyEvent keyEvent) {
        if (i != 5) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createAddressInterface$36(View view) {
    ...
    private void createDocumentDeleteAlert() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda10
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$createDocumentDeleteAlert$37(zArr, dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
        builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
        ...
        if (!this.documentOnly && this.currentDocumentsType != null) {
            ...
            if (tLRPC$SecureValueType instanceof TLRPC$TL_secureValueTypeAddress) {
                checkBoxCell.setText(LocaleController.getString("PassportDeleteDocumentAddress", R.string.PassportDeleteDocumentAddress), BuildConfig.FLAVOR, true, false);
            } else if (tLRPC$SecureValueType instanceof TLRPC$TL_secureValueTypePersonalDetails) {
                checkBoxCell.setText(LocaleController.getString("PassportDeleteDocumentPersonal", R.string.PassportDeleteDocumentPersonal), BuildConfig.FLAVOR, true, false);
            }
            checkBoxCell.setPadding(LocaleController.isRTL ? AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(8.0f), 0, LocaleController.isRTL ? AndroidUtilities.dp(8.0f) : AndroidUtilities.dp(16.0f), 0);
            frameLayout.addView(checkBoxCell, LayoutHelper.createFrame(-1, 48, 51));
            checkBoxCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda30
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    PassportActivity.lambda$createDocumentDeleteAlert$38(zArr, view);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createDocumentDeleteAlert$37(boolean[] zArr, DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$createDocumentDeleteAlert$38(boolean[] zArr, View view) {
        if (view.isEnabled()) {
            zArr[0] = !zArr[0];
    ...
    /* JADX WARN: Removed duplicated region for block: B:197:0x02ba A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:215:0x02c1 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:219:0x02c7 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean checkFieldsForError() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.checkFieldsForError():boolean");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void createIdentityInterface(final android.content.Context r28) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 2274
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.createIdentityInterface(android.content.Context):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createIdentityInterface$39(View view) {
    ...
    public /* synthetic */ void lambda$createIdentityInterface$43(View view) {
        ...
        cameraScanActivity.setDelegate(new CameraScanActivity.CameraScanActivityDelegate() { // from class: org.rbmain.ui.PassportActivity.14
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createIdentityInterface$45(final View view, MotionEvent motionEvent) {
        if (getParentActivity() == null) {
            return false;
        }
        if (motionEvent.getAction() == 1) {
            CountrySelectActivity countrySelectActivity = new CountrySelectActivity(false);
            countrySelectActivity.setCountrySelectActivityDelegate(new CountrySelectActivity.CountrySelectActivityDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda71
                @Override // org.rbmain.ui.CountrySelectActivity.CountrySelectActivityDelegate
                public final void didSelectCountry(String str, String str2) {
                    this.f$0.lambda$createIdentityInterface$44(view, str, str2);
                }
            });
            presentFragment(countrySelectActivity);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createIdentityInterface$44(View view, String str, String str2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createIdentityInterface$48(Context context, View view, MotionEvent motionEvent) {
        String string;
        int i;
        int i2;
        int i3;
        ...
        if (motionEvent.getAction() == 1) {
            ...
            try {
                ...
                AlertDialog.Builder builderCreateDatePickerDialog = AlertsCreator.createDatePickerDialog(context, i, i2, i3, i4, i5, iIntValue, string, iIntValue2 == 8, new AlertsCreator.DatePickerDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda68
                    @Override // org.rbmain.ui.Components.AlertsCreator.DatePickerDelegate
                    public final void didSelectDate(int i6, int i7, int i8) {
                        this.f$0.lambda$createIdentityInterface$46(iIntValue2, editTextBoldCursor, i6, i7, i8);
                    }
                });
                if (iIntValue2 == 8) {
                    builderCreateDatePickerDialog.setNegativeButton(LocaleController.getString("PassportSelectNotExpire", R.string.PassportSelectNotExpire), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda9
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i6) {
                            this.f$0.lambda$createIdentityInterface$47(editTextBoldCursor, dialogInterface, i6);
                        }
                    });
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createIdentityInterface$46(int i, EditTextBoldCursor editTextBoldCursor, int i2, int i3, int i4) {
        if (i == 8) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createIdentityInterface$47(EditTextBoldCursor editTextBoldCursor, DialogInterface dialogInterface, int i) {
        int[] iArr = this.currentExpireDate;
        iArr[2] = 0;
        iArr[1] = 0;
        iArr[0] = 0;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createIdentityInterface$50(View view, MotionEvent motionEvent) {
        if (getParentActivity() == null) {
            return false;
        }
        if (motionEvent.getAction() == 1) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("PassportMale", R.string.PassportMale), LocaleController.getString("PassportFemale", R.string.PassportFemale)}, new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$createIdentityInterface$49(dialogInterface, i);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createIdentityInterface$49(DialogInterface dialogInterface, int i) {
        if (i == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createIdentityInterface$51(TextView textView, int i, KeyEvent keyEvent) {
        if (i != 5) {
            return false;
        }
        int iIntValue = ((Integer) textView.getTag()).intValue() + 1;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createIdentityInterface$53(View view) {
        createDocumentDeleteAlert();
    }
    ...
    */
    public void updateUploadText(int r9) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.updateUploadText(int):void");
    }
    ...
    private void checkTopErrorCell(boolean z) {
        ...
        if (this.fieldsErrors != null && ((z || this.errorsValues.containsKey("error_all")) && (str2 = this.fieldsErrors.get("error_all")) != null)) {
            ...
            if (z) {
                this.errorsValues.put("error_all", BuildConfig.FLAVOR);
            }
        }
        if (this.documentsErrors != null && ((z || this.errorsValues.containsKey("error_document_all")) && (str = this.documentsErrors.get("error_all")) != null)) {
            ...
            if (z) {
                this.errorsValues.put("error_document_all", BuildConfig.FLAVOR);
            }
        }
        if (spannableStringBuilder != null) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void setFieldValues(java.util.HashMap<java.lang.String, java.lang.String> r7, org.rbmain.ui.Components.EditTextBoldCursor r8, java.lang.String r9) {
        /*
            Method dump skipped, instructions count: 328
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.setFieldValues(java.util.HashMap, org.rbmain.ui.Components.EditTextBoldCursor, java.lang.String):void");
    }
    ...
    private void addDocumentView(final SecureDocument secureDocument, final int i) {
        ...
        if (str2 != null && (map = this.documentsErrors) != null && (dateForBan = map.get(str2)) != null) {
            ...
            this.errorsValues.put(str2, BuildConfig.FLAVOR);
        } else {
        ...
        secureDocumentCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda28
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$addDocumentView$54(i, view);
            }
        });
        secureDocumentCell.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda32
            @Override // android.view.View.OnLongClickListener
            public final boolean onLongClick(View view) {
                return this.f$0.lambda$addDocumentView$56(i, secureDocument, secureDocumentCell, str2, view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addDocumentView$54(int i, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$addDocumentView$56(final int i, final SecureDocument secureDocument, final SecureDocumentCell secureDocumentCell, final String str, View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        if (i == 1) {
        ...
        builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
        builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
        builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda5
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
                this.f$0.lambda$addDocumentView$55(secureDocument, i, secureDocumentCell, str, dialogInterface, i2);
            }
        });
        showDialog(builder.create());
        return true;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addDocumentView$55(SecureDocument secureDocument, int i, SecureDocumentCell secureDocumentCell, String str, DialogInterface dialogInterface, int i2) {
    ...
    private String getTextForType(TLRPC$SecureValueType tLRPC$SecureValueType) {
        ...
        return tLRPC$SecureValueType instanceof TLRPC$TL_secureValueTypeEmail ? LocaleController.getString("ActionBotDocumentEmail", R.string.ActionBotDocumentEmail) : BuildConfig.FLAVOR;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:111:0x0241  */
    /* JADX WARN: Removed duplicated region for block: B:134:0x0293 A[Catch: Exception -> 0x03e6, TryCatch #5 {Exception -> 0x03e6, blocks: (B:105:0x021b, B:130:0x028c, B:132:0x0290, B:134:0x0293, B:137:0x029d, B:109:0x0239), top: B:325:0x021b }] */
    /* JADX WARN: Removed duplicated region for block: B:180:0x0341 A[PHI: r1
      0x0341: PHI (r1v18 java.lang.Object) = (r1v16 java.lang.Object), (r1v19 java.lang.Object), (r1v22 java.lang.Object) binds: [B:178:0x033d, B:175:0x0333, B:170:0x0320] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:182:0x0344  */
    /* JADX WARN: Removed duplicated region for block: B:193:0x0378 A[Catch: Exception -> 0x0398, TryCatch #4 {Exception -> 0x0398, blocks: (B:140:0x02a9, B:142:0x02b1, B:144:0x02b7, B:146:0x02c1, B:148:0x02c9, B:151:0x02d3, B:153:0x02d9, B:155:0x02e1, B:157:0x02e9, B:159:0x02f1, B:162:0x02fa, B:163:0x0300, B:164:0x0305, B:186:0x034a, B:187:0x034e, B:189:0x0356, B:190:0x0363, B:192:0x036b, B:193:0x0378, B:195:0x0383, B:171:0x0323, B:174:0x032d, B:177:0x0337), top: B:323:0x02a9 }] */
    /* JADX WARN: Removed duplicated region for block: B:195:0x0383 A[Catch: Exception -> 0x0398, TRY_LEAVE, TryCatch #4 {Exception -> 0x0398, blocks: (B:140:0x02a9, B:142:0x02b1, B:144:0x02b7, B:146:0x02c1, B:148:0x02c9, B:151:0x02d3, B:153:0x02d9, B:155:0x02e1, B:157:0x02e9, B:159:0x02f1, B:162:0x02fa, B:163:0x0300, B:164:0x0305, B:186:0x034a, B:187:0x034e, B:189:0x0356, B:190:0x0363, B:192:0x036b, B:193:0x0378, B:195:0x0383, B:171:0x0323, B:174:0x032d, B:177:0x0337), top: B:323:0x02a9 }] */
    /* JADX WARN: Removed duplicated region for block: B:205:0x03bf  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void setTypeValue(org.rbmain.tgnet.TLRPC$TL_secureRequiredType r31, java.lang.String r32, java.lang.String r33, org.rbmain.tgnet.TLRPC$TL_secureRequiredType r34, java.lang.String r35, boolean r36, int r37) throws org.json.JSONException, java.security.NoSuchAlgorithmException, java.io.IOException {
        /*
            Method dump skipped, instructions count: 1445
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.setTypeValue(org.rbmain.tgnet.TLRPC$TL_secureRequiredType, java.lang.String, java.lang.String, org.rbmain.tgnet.TLRPC$TL_secureRequiredType, java.lang.String, boolean, int):void");
    }
    ...
    public void checkNativeFields(boolean z) {
        ...
        if (z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda48
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$checkNativeFields$57();
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkNativeFields$57() {
        EditTextBoldCursor[] editTextBoldCursorArr = this.inputExtraFields;
    ...
    private void openTypeActivity(TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType2, ArrayList<TLRPC$TL_secureRequiredType> arrayList, final boolean z) {
        ...
        if (i != -1) {
            HashMap<String, String> map2 = !z ? this.errorsMap.get(getNameForType(tLRPC$SecureValueType)) : null;
            ...
            TLRPC$TL_account_password tLRPC$TL_account_password2 = this.currentPassword;
            HashMap<String, String> map4 = this.typesValues.get(tLRPC$TL_secureRequiredType);
            if (tLRPC$TL_secureRequiredType2 != null) {
                tLRPC$TL_account_password = tLRPC$TL_account_password2;
                map = this.typesValues.get(tLRPC$TL_secureRequiredType2);
            } else {
                tLRPC$TL_account_password = tLRPC$TL_account_password2;
                map = null;
            }
            int i2 = i;
            PassportActivity passportActivity = new PassportActivity(i, tLRPC$TL_account_authorizationForm, tLRPC$TL_account_password, tLRPC$TL_secureRequiredType, valueByType, tLRPC$TL_secureRequiredType2, valueByType2, map4, map);
            passportActivity.delegate = new PassportActivityDelegate() { // from class: org.rbmain.ui.PassportActivity.20
                ...
                /* JADX WARN: Multi-variable type inference failed */
                @Override // org.rbmain.ui.PassportActivity.PassportActivityDelegate
                public void saveValue(TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType3, String str, String str2, TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType4, String str3, ArrayList<SecureDocument> arrayList2, SecureDocument secureDocument, ArrayList<SecureDocument> arrayList3, SecureDocument secureDocument2, SecureDocument secureDocument3, Runnable runnable, ErrorRunnable errorRunnable) throws NoSuchAlgorithmException {
                ...
                /* renamed from: org.rbmain.ui.PassportActivity$20$1, reason: invalid class name */
                class AnonymousClass1 implements RequestDelegate {
                    ...
                    public void lambda$run$4(final TLRPC$TL_error tLRPC$TL_error, final TLRPC$TL_secureValue tLRPC$TL_secureValue, final TLRPC$TL_secureValue tLRPC$TL_secureValue2) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$20$1$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() throws JSONException, NoSuchAlgorithmException, IOException {
                                this.f$0.lambda$onResult$0(tLRPC$TL_error, errorRunnable, str, tLRPC$TL_account_saveSecureValue, z, tLRPC$TL_secureRequiredType, tLRPC$TL_secureRequiredType2, tLRPC$TL_secureValue, tLRPC$TL_secureValue2, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, i, runnable);
                            }
                        });
                    }
                    ...
                    public void run(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                        if (tLRPC$TL_error != null) {
                            if (tLRPC$TL_error.text.equals("EMAIL_VERIFICATION_NEEDED")) {
                                ...
                                final ErrorRunnable errorRunnable = this.val$errorRunnable;
                                connectionsManager.sendRequest(tLRPC$TL_account_sendVerifyEmailCode, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$20$1$$ExternalSyntheticLambda3
                                    @Override // org.rbmain.tgnet.RequestDelegate
                                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) {
                                        this.f$0.lambda$run$2(str, tLRPC$TL_secureRequiredType, passportActivityDelegate, errorRunnable, tLObject2, tLRPC$TL_error2);
                                    }
                                });
                                return;
                            }
                            if (tLRPC$TL_error.text.equals("PHONE_VERIFICATION_NEEDED")) {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$20$1$$ExternalSyntheticLambda2
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        PassportActivity.AnonymousClass20.AnonymousClass1.lambda$run$3(errorRunnable2, tLRPC$TL_error, str2);
                                    }
                                });
                                return;
                            }
                        ...
                        if (tLRPC$TL_error == null && this.val$finalFileInputSecureValue != null) {
                            ...
                            tLRPC$TL_account_saveSecureValue.secure_secret_id = PassportActivity.this.secureSecretId;
                            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(tLRPC$TL_account_saveSecureValue, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$20$1$$ExternalSyntheticLambda4
                                @Override // org.rbmain.tgnet.RequestDelegate
                                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error2) {
                                    this.f$0.lambda$run$4(tLRPC$TL_secureValue, tLObject2, tLRPC$TL_error2);
                                }
                            });
                            return;
                        }
                    ...
                    public /* synthetic */ void lambda$run$2(final String str, final TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, final PassportActivityDelegate passportActivityDelegate, final ErrorRunnable errorRunnable, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$20$1$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$run$1(tLObject, str, tLRPC$TL_secureRequiredType, passportActivityDelegate, tLRPC$TL_error, errorRunnable);
                            }
                        });
                    }
                ...
                @Override // org.rbmain.ui.PassportActivity.PassportActivityDelegate
                public SecureDocument saveFile(TLRPC$TL_secureFile tLRPC$TL_secureFile) throws NoSuchAlgorithmException, IOException {
                    ...
                    return new SecureDocument(encryptionResultCreateSecureDocument.secureDocumentKey, tLRPC$TL_secureFile, str, encryptionResultCreateSecureDocument.fileHash, encryptionResultCreateSecureDocument.fileSecret);
                }
    ...
    public void deleteValueInternal(final TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, final TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType2, final ArrayList<TLRPC$TL_secureRequiredType> arrayList, final boolean z, final Runnable runnable, final ErrorRunnable errorRunnable, final boolean z2) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_account_deleteSecureValue, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda66
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$deleteValueInternal$59(errorRunnable, z2, tLRPC$TL_secureRequiredType2, tLRPC$TL_secureRequiredType, z, arrayList, runnable, tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$deleteValueInternal$59(final ErrorRunnable errorRunnable, final boolean z, final TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, final TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType2, final boolean z2, final ArrayList arrayList, final Runnable runnable, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda59
            @Override // java.lang.Runnable
            public final void run() throws JSONException, NoSuchAlgorithmException, IOException {
                this.f$0.lambda$deleteValueInternal$58(tLRPC$TL_error, errorRunnable, z, tLRPC$TL_secureRequiredType, tLRPC$TL_secureRequiredType2, z2, arrayList, runnable);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$deleteValueInternal$58(TLRPC$TL_error tLRPC$TL_error, ErrorRunnable errorRunnable, boolean z, TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType2, boolean z2, ArrayList arrayList, Runnable runnable) throws JSONException, NoSuchAlgorithmException, IOException {
        TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType3;
        String str;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private org.rbmain.ui.PassportActivity.TextDetailSecureCell addField(android.content.Context r17, final org.rbmain.tgnet.TLRPC$TL_secureRequiredType r18, final java.util.ArrayList<org.rbmain.tgnet.TLRPC$TL_secureRequiredType> r19, final boolean r20, boolean r21) throws java.security.NoSuchAlgorithmException {
        /*
            Method dump skipped, instructions count: 498
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.addField(android.content.Context, org.rbmain.tgnet.TLRPC$TL_secureRequiredType, java.util.ArrayList, boolean, boolean):org.rbmain.ui.PassportActivity$TextDetailSecureCell");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addField$63(final ArrayList arrayList, final TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, final boolean z, View view) {
        TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType2;
        int i;
        String str;
        if (arrayList != null) {
        ...
        if ((tLRPC$SecureValueType instanceof TLRPC$TL_secureValueTypePersonalDetails) || (tLRPC$SecureValueType instanceof TLRPC$TL_secureValueTypeAddress)) {
            if (tLRPC$TL_secureRequiredType2 == null && arrayList != null && !arrayList.isEmpty()) {
                ...
                builder.setItems((CharSequence[]) arrayList2.toArray(new CharSequence[0]), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda7
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i4) {
                        this.f$0.lambda$addField$60(tLRPC$TL_secureRequiredType, arrayList, z, dialogInterface, i4);
                    }
                });
                showDialog(builder.create());
                return;
            ...
            if ((z2 || (tLRPC$SecureValueType instanceof TLRPC$TL_secureValueTypeEmail)) && getValueByType(tLRPC$TL_secureRequiredType, false) != null) {
                ...
                builder2.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda8
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i4) {
                        this.f$0.lambda$addField$62(tLRPC$TL_secureRequiredType, z, dialogInterface, i4);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addField$60(TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, ArrayList arrayList, boolean z, DialogInterface dialogInterface, int i) {
        openTypeActivity(tLRPC$TL_secureRequiredType, (TLRPC$TL_secureRequiredType) arrayList.get(i), arrayList, z);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addField$62(TLRPC$TL_secureRequiredType tLRPC$TL_secureRequiredType, boolean z, DialogInterface dialogInterface, int i) {
        needShowProgress();
        deleteValueInternal(tLRPC$TL_secureRequiredType, null, null, true, new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda46
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.needHideProgress();
            }
        }, new ErrorRunnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda72
            @Override // org.rbmain.ui.PassportActivity.ErrorRunnable
            public final void onError(String str, String str2) {
                this.f$0.lambda$addField$61(str, str2);
            }
        }, z);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addField$61(String str, String str2) {
        needHideProgress();
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public org.rbmain.ui.PassportActivity.EncryptionResult createSecureDocument(java.lang.String r5) throws java.security.NoSuchAlgorithmException, java.io.IOException {
        /*
            r4 = this;
        ...
        L19:
            r2 = r1
        L1a:
            org.rbmain.ui.PassportActivity$EncryptionResult r5 = r4.encryptData(r0)
            r0 = 0
        ...
        L2b:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PassportActivity.createSecureDocument(java.lang.String):org.rbmain.ui.PassportActivity$EncryptionResult");
    }
    ...
    public void startPhoneVerification(boolean z, final String str, Runnable runnable, ErrorRunnable errorRunnable, final PassportActivityDelegate passportActivityDelegate) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_account_sendVerifyPhoneCode, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda65
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$startPhoneVerification$65(str, passportActivityDelegate, tLRPC$TL_account_sendVerifyPhoneCode, tLObject, tLRPC$TL_error);
            }
        }, 2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startPhoneVerification$65(final String str, final PassportActivityDelegate passportActivityDelegate, final TLRPC$TL_account_sendVerifyPhoneCode tLRPC$TL_account_sendVerifyPhoneCode, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda57
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$startPhoneVerification$64(tLRPC$TL_error, str, passportActivityDelegate, tLObject, tLRPC$TL_account_sendVerifyPhoneCode);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startPhoneVerification$64(TLRPC$TL_error tLRPC$TL_error, String str, PassportActivityDelegate passportActivityDelegate, TLObject tLObject, TLRPC$TL_account_sendVerifyPhoneCode tLRPC$TL_account_sendVerifyPhoneCode) {
        if (tLRPC$TL_error == null) {
            HashMap map = new HashMap();
            map.put("phone", str);
    ...
    public void showEditDoneProgress(boolean z, final boolean z2) {
        ...
        if (z && this.doneItem != null) {
            ...
            this.doneItemAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.PassportActivity.21
        ...
        if (this.acceptTextView != null) {
            ...
            this.doneItemAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.PassportActivity.22
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    if (PassportActivity.this.doneItemAnimation == null || !PassportActivity.this.doneItemAnimation.equals(animator)) {
                        return;
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        if (this.presentAfterAnimation != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda50
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onTransitionAnimationEnd$66();
                }
            });
        }
        int i = this.currentActivityType;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onTransitionAnimationEnd$66() {
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 21) {
            ...
            builder.setNegativeButton(LocaleController.getString("PermissionOpenSettings", R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda3
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    this.f$0.lambda$onRequestPermissionsResultFragment$67(dialogInterface, i3);
                }
            });
            builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), null);
            builder.show();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onRequestPermissionsResultFragment$67(DialogInterface dialogInterface, int i) {
        try {
    ...
    public void setPage(int i, boolean z, Bundle bundle) {
        ...
        if (z) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter(this) { // from class: org.rbmain.ui.PassportActivity.23
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    private void createChatAttachView() {
        if (getParentActivity() != null && this.chatAttachAlert == null) {
            ...
            chatAttachAlert.setDelegate(new ChatAttachAlert.ChatAttachViewDelegate() { // from class: org.rbmain.ui.PassportActivity.24
        ...
        if (i == 0) {
            ...
            try {
                ...
                if (fileGeneratePicturePath != null) {
                    if (i2 >= 24) {
                        intent.putExtra("output", FileProvider.getUriForFile(getParentActivity(), "ir.medu.shad.provider", fileGeneratePicturePath));
                        intent.addFlags(2);
                        intent.addFlags(1);
                    } else {
    ...
    public boolean checkDiscard() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setPositiveButton(LocaleController.getString("PassportDiscard", R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$checkDiscard$68(dialogInterface, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkDiscard$68(DialogInterface dialogInterface, int i) {
        finishFragment();
    }
    ...
    public void processSelectedFiles(final ArrayList<SendMessagesHelper.SendingMediaInfo> arrayList) {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda52
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processSelectedFiles$71(arrayList, i3, z2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processSelectedFiles$71(ArrayList arrayList, final int i, boolean z) {
        ...
        for (int i3 = 0; i3 < iMin; i3++) {
            ...
            if (bitmapLoadBitmap != null && (tLRPC$PhotoSizeScaleAndSaveImage = ImageLoader.scaleAndSaveImage(bitmapLoadBitmap, 2048.0f, 2048.0f, 89, false, 320, 320)) != null) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda54
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$processSelectedFiles$69(secureDocumentSaveFile, i);
                    }
                });
                if (z && !z2) {
                    try {
                        ...
                        if (resultRecognize != null) {
                            try {
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$$ExternalSyntheticLambda53
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        this.f$0.lambda$processSelectedFiles$70(resultRecognize);
                                    }
                                });
                                z2 = true;
                            } catch (Throwable th) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processSelectedFiles$69(SecureDocument secureDocument, int i) {
        int i2 = this.uploadingFileType;
        if (i2 == 1) {
        ...
        FileLoader.getInstance(this.currentAccount).uploadFile(secureDocument.path, false, true, ConnectionsManager.FileTypePhoto, null);
        addDocumentView(secureDocument, i);
        updateUploadText(i);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processSelectedFiles$70(MrzRecognizer.Result result) {
        int i;
        int i2;
        int i3 = result.type;
        if (i3 == 2) {
    ...
    public class PhoneConfirmationView extends SlideView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public PhoneConfirmationView(Context context, int i) {
            ...
            TextView textView3 = new TextView(this, context, PassportActivity.this) { // from class: org.rbmain.ui.PassportActivity.PhoneConfirmationView.1
            ...
            TextView textView4 = new TextView(this, context, PassportActivity.this) { // from class: org.rbmain.ui.PassportActivity.PhoneConfirmationView.2
                @Override // android.widget.TextView, android.view.View
                protected void onMeasure(int i4, int i5) {
                    super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(100.0f), Integer.MIN_VALUE));
                }
            ...
            this.problemText.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
        ...
        public void resendCode() {
            ...
            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(tLRPC$TL_auth_resendCode, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda8
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        public /* synthetic */ void lambda$resendCode$3(final Bundle bundle, final TLRPC$TL_auth_resendCode tLRPC$TL_auth_resendCode, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$resendCode$2(TLRPC$TL_error tLRPC$TL_error, Bundle bundle, TLObject tLObject, TLRPC$TL_auth_resendCode tLRPC$TL_auth_resendCode) {
            ...
            if (tLRPC$TL_error == null) {
                ...
                if (alertDialog != null && tLRPC$TL_error.text.contains("PHONE_CODE_EXPIRED")) {
                    alertDialog.setPositiveButtonListener(new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda1
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        public void setParams(Bundle bundle, boolean z) {
            ...
            if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.length) {
                ...
                while (i7 < this.length) {
                    ...
                    this.codeField[i7].addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.PassportActivity.PhoneConfirmationView.3
                        @Override // android.text.TextWatcher
                    ...
                    this.codeField[i7].setOnKeyListener(new View.OnKeyListener() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda3
                        @Override // android.view.View.OnKeyListener
                        public final boolean onKey(View view, int i9, KeyEvent keyEvent) {
                            return this.f$0.lambda$setParams$4(i7, view, i9, keyEvent);
                        }
                    });
                    this.codeField[i7].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda4
                        @Override // android.widget.TextView.OnEditorActionListener
        ...
        /* renamed from: org.rbmain.ui.PassportActivity$PhoneConfirmationView$4, reason: invalid class name */
        class AnonymousClass4 extends TimerTask {
            ...
            public void run() {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$4$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        /* renamed from: org.rbmain.ui.PassportActivity$PhoneConfirmationView$5, reason: invalid class name */
        class AnonymousClass5 extends TimerTask {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$5$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            public /* synthetic */ void lambda$run$2() {
                if (PhoneConfirmationView.this.time >= 1000) {
                    int i = (PhoneConfirmationView.this.time / CloseCodes.NORMAL_CLOSURE) / 60;
                    int i2 = (PhoneConfirmationView.this.time / CloseCodes.NORMAL_CLOSURE) - (i * 60);
                ...
                if (PhoneConfirmationView.this.verificationType != 3) {
                    if (PhoneConfirmationView.this.verificationType == 2 || PhoneConfirmationView.this.verificationType == 4) {
                        if (PhoneConfirmationView.this.nextType == 4 || PhoneConfirmationView.this.nextType == 2) {
                            ...
                            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(tLRPC$TL_auth_resendCode, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$5$$ExternalSyntheticLambda2
                                @Override // org.rbmain.tgnet.RequestDelegate
                                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            public /* synthetic */ void lambda$run$1(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$5$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void onNextPressed() {
            ...
            destroyTimer();
            PassportActivity.this.needShowProgress();
            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(tLRPC$TL_account_verifyPhone, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda9
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    this.f$0.lambda$onNextPressed$7(tLRPC$TL_account_verifyPhone, tLObject, tLRPC$TL_error);
                }
            }, 2);
        }
        ...
        public /* synthetic */ void lambda$onNextPressed$7(final TLRPC$TL_account_verifyPhone tLRPC$TL_account_verifyPhone, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onNextPressed$6(tLRPC$TL_error, tLRPC$TL_account_verifyPhone);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onNextPressed$6(TLRPC$TL_error tLRPC$TL_error, TLRPC$TL_account_verifyPhone tLRPC$TL_account_verifyPhone) {
            ...
            if (tLRPC$TL_error == null) {
                ...
                passportActivityDelegate.saveValue(tLRPC$TL_secureRequiredType, str, null, null, null, null, null, null, null, null, new Runnable() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public boolean onBackPressed(boolean z) {
            if (!z) {
                ...
                builder.setNegativeButton(LocaleController.getString("Stop", R.string.Stop), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            ConnectionsManager.getInstance(((BaseFragment) PassportActivity.this).currentAccount).sendRequest(tLRPC$TL_auth_cancelCode, new RequestDelegate() { // from class: org.rbmain.ui.PassportActivity$PhoneConfirmationView$$ExternalSyntheticLambda10
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
