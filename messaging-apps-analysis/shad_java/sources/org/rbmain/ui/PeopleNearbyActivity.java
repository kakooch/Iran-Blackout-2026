...
import org.rbmain.tgnet.TLRPC$PeerLocated;
import org.rbmain.tgnet.TLRPC$TL_channels_getAdminedPublicChannels;
import org.rbmain.tgnet.TLRPC$TL_contacts_getLocated;
...
import org.rbmain.tgnet.TLRPC$TL_peerSelfLocated;
import org.rbmain.tgnet.TLRPC$TL_peerUser;
import org.rbmain.tgnet.TLRPC$TL_updatePeerLocated;
...
public class PeopleNearbyActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, LocationController.LocationFetchCallback {
    ...
    private Runnable shortPollRunnable = new Runnable() { // from class: org.rbmain.ui.PeopleNearbyActivity.1
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.PeopleNearbyActivity.2
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.rbmain.ui.PeopleNearbyActivity.3
        ...
        this.itemAnimator = new DefaultItemAnimator(this) { // from class: org.rbmain.ui.PeopleNearbyActivity.4
            @Override // androidx.recyclerview.widget.DefaultItemAnimator
            protected long getAddAnimationDelay(long j, long j2, long j3) {
                return j;
            }
        };
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda10
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i3) {
                this.f$0.lambda$createView$2(view, i3);
            }
        });
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.PeopleNearbyActivity.5
            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrolled(RecyclerView recyclerView, int i3, int i4) {
                PeopleNearbyActivity.this.checkScroll(true);
            }
        });
        View view = new View(context) { // from class: org.rbmain.ui.PeopleNearbyActivity.6
    ...
    public /* synthetic */ void lambda$createView$2(View view, int i) {
        ...
        if (i >= i3 && i < this.usersEndRow) {
            if (view instanceof ManageChatUserCell) {
                ...
                bundle.putInt("user_id", tLRPC$TL_peerLocated.peer.user_id);
                if (((ManageChatUserCell) view).hasAvatarSet()) {
                    bundle.putBoolean("expandPhoto", true);
                }
                bundle.putInt("nearby_distance", tLRPC$TL_peerLocated.distance);
                MessagesController.getInstance(this.currentAccount).ensureMessagesLoaded(tLRPC$TL_peerLocated.peer.user_id, 0L, null);
        ...
        if (i >= i4 && i < this.chatsEndRow) {
            TLRPC$TL_peerLocated tLRPC$TL_peerLocated2 = this.chats.get(i - i4);
        ...
        if (i == this.chatsCreateRow) {
            if (this.checkingCanCreate || this.currentGroupCreateAddress == null) {
                ...
                alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda0
        ...
        if (i == this.showMeRow) {
            ...
            if (this.showingMe) {
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i5) {
                        this.f$0.lambda$createView$1(userConfig, dialogInterface, i5);
                    }
                });
    ...
    */
    public void checkScroll(boolean r11) {
        ...
        La:
            ...
            goto L39
        Lc:
            org.rbmain.ui.Components.RecyclerListView r3 = r10.listView
            androidx.recyclerview.widget.RecyclerView$ViewHolder r0 = r3.findViewHolderForAdapterPosition(r0)
            if (r0 != 0) goto L15
            goto La
        L15:
            android.view.View r0 = r0.itemView
            org.rbmain.ui.PeopleNearbyActivity$HintInnerCell r0 = (org.rbmain.ui.PeopleNearbyActivity.HintInnerCell) r0
            android.widget.TextView r3 = org.rbmain.ui.PeopleNearbyActivity.HintInnerCell.access$600(r0)
            int[] r4 = r10.location
            r3.getLocationOnScreen(r4)
            int[] r3 = r10.location
            r3 = r3[r2]
            android.widget.TextView r0 = org.rbmain.ui.PeopleNearbyActivity.HintInnerCell.access$600(r0)
            int r0 = r0.getMeasuredHeight()
            int r3 = r3 + r0
            org.rbmain.ui.ActionBar.ActionBar r0 = r10.actionBar
            int r0 = r0.getBottom()
            if (r3 >= r0) goto L38
            goto La
        L38:
        ...
        L78:
            ...
            r5[r1] = r6
            org.rbmain.ui.ActionBar.ActionBar r6 = r10.actionBar
            org.rbmain.ui.ActionBar.SimpleTextView r6 = r6.getTitleTextView()
            android.util.Property r7 = android.view.View.ALPHA
            float[] r8 = new float[r2]
            if (r0 == 0) goto L8d
            goto L8e
        ...
        L8e:
            ...
            r11.setDuration(r0)
            android.animation.AnimatorSet r11 = r10.actionBarAnimator
            org.rbmain.ui.PeopleNearbyActivity$7 r0 = new org.rbmain.ui.PeopleNearbyActivity$7
            r0.<init>()
            r11.addListener(r0)
            android.animation.AnimatorSet r11 = r10.actionBarAnimator
            r11.start()
        ...
        Lb8:
            r11.setAlpha(r1)
            org.rbmain.ui.ActionBar.ActionBar r11 = r10.actionBar
            org.rbmain.ui.ActionBar.SimpleTextView r11 = r11.getTitleTextView()
            if (r0 == 0) goto Lc4
            goto Lc5
        Lc4:
            r3 = 0
        ...
        Lc8:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.PeopleNearbyActivity.checkScroll(boolean):void");
    }
    ...
    private void checkCanCreateGroup() {
        ...
        getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tLRPC$TL_channels_getAdminedPublicChannels, new RequestDelegate() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda7
    ...
    public /* synthetic */ void lambda$checkCanCreateGroup$4(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$checkCanCreateGroup$3(tLRPC$TL_error);
            }
        });
    }
    ...
    private void showLoadingProgress(boolean z) {
        ...
        this.showProgressAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.PeopleNearbyActivity.8
    ...
    public void sendRequest(boolean z, final int i) {
        Location location;
        if (!this.firstLoaded) {
            Runnable runnable = new Runnable() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
        ...
        this.reqId = getConnectionsManager().sendRequest(tLRPC$TL_contacts_getLocated, new RequestDelegate() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda8
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$sendRequest$7(i, tLObject, tLRPC$TL_error);
            }
        });
    ...
    public /* synthetic */ void lambda$sendRequest$7(final int i, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$sendRequest$6(i, tLRPC$TL_error, tLObject);
            }
        });
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        final long jLongValue = ((Long) objArr[0]).longValue();
        final TLRPC$Chat tLRPC$Chat = (TLRPC$Chat) objArr[2];
        final boolean zBooleanValue = ((Boolean) objArr[3]).booleanValue();
        Runnable runnable = new Runnable() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$didReceivedNotification$8(tLRPC$Chat, jLongValue, zBooleanValue);
            }
        };
        UndoView undoView = this.undoView;
        if (undoView != null) {
            undoView.showWithAction(jLongValue, 1, runnable);
        } else {
            runnable.run();
        }
    }
    ...
    private void checkForExpiredLocations(boolean z) {
        ...
        if (iMin != Integer.MAX_VALUE) {
            Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$checkForExpiredLocations$9();
                }
            };
            this.checkExpiredRunnable = runnable2;
            AndroidUtilities.runOnUIThread(runnable2, (iMin - currentTime) * CloseCodes.NORMAL_CLOSURE);
        }
    }
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(PeopleNearbyActivity peopleNearbyActivity, Context context) {
            ...
            addView(this.titleTextView, LayoutHelper.createFrame(-1, -2.0f, 51, 52.0f, currentActionBarHeight + 120, 52.0f, 27.0f));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                TextView textView = new TextView(this, this.mContext) { // from class: org.rbmain.ui.PeopleNearbyActivity.ListAdapter.1
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i < PeopleNearbyActivity.this.usersStartRow || i >= PeopleNearbyActivity.this.usersEndRow) {
                    ...
                    int i3 = i - PeopleNearbyActivity.this.chatsStartRow;
                    TLRPC$TL_peerLocated tLRPC$TL_peerLocated = (TLRPC$TL_peerLocated) PeopleNearbyActivity.this.chats.get(i3);
                    ...
                    if (chat != null) {
                        ...
                        if (i4 != 0) {
                            distance = String.format("%1$s, %2$s", distance, LocaleController.formatPluralString("Members", i4));
                        }
                        manageChatUserCell.setData(chat, null, distance, i3 != PeopleNearbyActivity.this.chats.size() - 1);
                        return;
                    }
                    return;
                }
                ...
                TLRPC$User user = PeopleNearbyActivity.this.getMessagesController().getUser(Integer.valueOf(tLRPC$TL_peerLocated2.peer.user_id));
                if (user != null) {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.rbmain.ui.PeopleNearbyActivity$$ExternalSyntheticLambda9
