...
import org.rbmain.ui.Cells.InviteTextCell;
import org.rbmain.ui.Cells.InviteUserCell;
...
public class InviteContactsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    private class SpansContainer extends ViewGroup {
        ...
        public void addSpan(GroupCreateSpan groupCreateSpan) {
            ...
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.InviteContactsActivity.SpansContainer.1
        ...
        public void removeSpan(final GroupCreateSpan groupCreateSpan) {
            ...
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.currentAnimation = animatorSet2;
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.InviteContactsActivity.SpansContainer.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    public View createView(Context context) throws NoSuchFieldException {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.InviteContactsActivity.1
        ...
        ViewGroup viewGroup = new ViewGroup(context) { // from class: org.rbmain.ui.InviteContactsActivity.2
            @Override // android.view.View
            protected void onMeasure(int i, int i2) {
                int iDp;
                int size = View.MeasureSpec.getSize(i);
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.rbmain.ui.InviteContactsActivity.3
        ...
        EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context) { // from class: org.rbmain.ui.InviteContactsActivity.4
        ...
        this.editText.setCustomSelectionActionModeCallback(new ActionMode.Callback(this) { // from class: org.rbmain.ui.InviteContactsActivity.5
        ...
        this.editText.setOnKeyListener(new View.OnKeyListener() { // from class: org.rbmain.ui.InviteContactsActivity.6
        ...
        this.editText.addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.InviteContactsActivity.7
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.InviteContactsActivity$$ExternalSyntheticLambda3
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i) {
                this.f$0.lambda$createView$0(view, i);
            }
        });
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.InviteContactsActivity.8
        ...
        this.counterView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.InviteContactsActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
        ...
        this.textView.setText(LocaleController.getString("InviteToRubika", R.string.InviteToRubika).toUpperCase());
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i) {
        ...
        if (i == 0 && !this.searching) {
            try {
                ...
                getParentActivity().startActivityForResult(Intent.createChooser(intent, inviteText), HttpStatus.HTTP_INTERNAL_SERVER_ERROR);
                return;
            } catch (Exception e) {
                FileLog.e(e);
                return;
    ...
    private void fetchContacts() {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.rbmain.ui.InviteContactsActivity$$ExternalSyntheticLambda1
    ...
    public class InviteAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                inviteTextCell.setTextAndIcon(LocaleController.getString("ShareRubika", R.string.ShareRubika), R.drawable.share);
        ...
        /* renamed from: org.rbmain.ui.InviteContactsActivity$InviteAdapter$1, reason: invalid class name */
        class AnonymousClass1 extends TimerTask {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.InviteContactsActivity$InviteAdapter$1$$ExternalSyntheticLambda1
            ...
            public /* synthetic */ void lambda$run$1(final String str) {
                Utilities.searchQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.InviteContactsActivity$InviteAdapter$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            */
            public /* synthetic */ void lambda$run$0(java.lang.String r17) {
                /*
                    ...
                    int r2 = r1.length()
                    if (r2 != 0) goto L20
                    org.rbmain.ui.InviteContactsActivity$InviteAdapter r1 = org.rbmain.ui.InviteContactsActivity.InviteAdapter.this
                    java.util.ArrayList r2 = new java.util.ArrayList
                    r2.<init>()
                    java.util.ArrayList r3 = new java.util.ArrayList
                    r3.<init>()
                    org.rbmain.ui.InviteContactsActivity.InviteAdapter.access$2600(r1, r2, r3)
                    return
                L20:
                    org.rbmain.messenger.LocaleController r2 = org.rbmain.messenger.LocaleController.getInstance()
                ...
                L46:
                    ...
                    r8 = 0
                L51:
                    org.rbmain.ui.InviteContactsActivity$InviteAdapter r9 = org.rbmain.ui.InviteContactsActivity.InviteAdapter.this
                    org.rbmain.ui.InviteContactsActivity r9 = org.rbmain.ui.InviteContactsActivity.this
                    java.util.ArrayList r9 = org.rbmain.ui.InviteContactsActivity.access$2400(r9)
                    int r9 = r9.size()
                    if (r8 >= r9) goto Le3
                    org.rbmain.ui.InviteContactsActivity$InviteAdapter r9 = org.rbmain.ui.InviteContactsActivity.InviteAdapter.this
                    org.rbmain.ui.InviteContactsActivity r9 = org.rbmain.ui.InviteContactsActivity.this
                    ...
                    org.rbmain.messenger.ContactsController$Contact r9 = (org.rbmain.messenger.ContactsController.Contact) r9
                    java.lang.String r10 = r9.first_name
                    java.lang.String r11 = r9.last_name
                    java.lang.String r10 = org.rbmain.messenger.ContactsController.formatName(r10, r11)
                    java.lang.String r10 = r10.toLowerCase()
                    org.rbmain.messenger.LocaleController r11 = org.rbmain.messenger.LocaleController.getInstance()
                ...
                Lc9:
                    ...
                    java.lang.CharSequence r3 = org.rbmain.messenger.AndroidUtilities.generateSearchName(r3, r10, r14)
                    r2.add(r3)
                    r1.add(r9)
                    goto Lde
                Lda:
                ...
                Lde:
                    ...
                    goto L51
                Le3:
                    org.rbmain.ui.InviteContactsActivity$InviteAdapter r3 = org.rbmain.ui.InviteContactsActivity.InviteAdapter.this
                    org.rbmain.ui.InviteContactsActivity.InviteAdapter.access$2600(r3, r1, r2)
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.InviteContactsActivity.InviteAdapter.AnonymousClass1.lambda$run$0(java.lang.String):void");
            }
        }
        ...
        public void updateSearchResults(final ArrayList<ContactsController.Contact> arrayList, final ArrayList<CharSequence> arrayList2) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.InviteContactsActivity$InviteAdapter$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.rbmain.ui.InviteContactsActivity$$ExternalSyntheticLambda2
