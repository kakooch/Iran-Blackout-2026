...
public class StickersSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    /* renamed from: org.rbmain.ui.Adapters.StickersSearchAdapter$1, reason: invalid class name */
    class AnonymousClass1 implements Runnable {
        ...
        */
        public void run() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Adapters.StickersSearchAdapter.AnonymousClass1.run():void");
        }
        ...
        public /* synthetic */ void lambda$run$2(final TLRPC$TL_messages_searchStickerSets tLRPC$TL_messages_searchStickerSets, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            if (tLObject instanceof TLRPC$TL_messages_foundStickerSets) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.StickersSearchAdapter$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$run$1(tLRPC$TL_messages_searchStickerSets, tLObject);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void lambda$run$4(final TLRPC$TL_messages_getStickers tLRPC$TL_messages_getStickers, final ArrayList arrayList, final LongSparseArray longSparseArray, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.StickersSearchAdapter$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$3(tLRPC$TL_messages_getStickers, tLObject, arrayList, longSparseArray);
                }
            });
        }
    ...
    public StickersSearchAdapter(Context context, Delegate delegate, TLRPC$StickerSetCovered[] tLRPC$StickerSetCoveredArr, LongSparseArray<TLRPC$StickerSetCovered> longSparseArray, LongSparseArray<TLRPC$StickerSetCovered> longSparseArray2) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        boolean z = false;
        if (i == 0) {
            StickerEmojiCell stickerEmojiCell = new StickerEmojiCell(this, this.context, z) { // from class: org.rbmain.ui.Adapters.StickersSearchAdapter.2
            ...
            if (i == 1) {
                ...
                stickerSetNameCell = new StickerSetNameCell(this.context, false, true);
            } else if (i == 3) {
                FeaturedStickerSetInfoCell featuredStickerSetInfoCell = new FeaturedStickerSetInfoCell(this.context, 17, true);
                featuredStickerSetInfoCell.setAddOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Adapters.StickersSearchAdapter$$ExternalSyntheticLambda0
                ...
                this.emptyTextView.setTextColor(Theme.getColor(i2));
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void installStickerSet(org.rbmain.tgnet.TLRPC$StickerSetCovered r8, org.rbmain.ui.Cells.FeaturedStickerSetInfoCell r9) {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        L2:
            org.rbmain.tgnet.TLRPC$StickerSetCovered[] r2 = r7.primaryInstallingStickerSets
            int r3 = r2.length
            if (r1 >= r3) goto L3f
            r2 = r2[r1]
            if (r2 == 0) goto L3c
            int r2 = r7.currentAccount
            org.rbmain.messenger.MediaDataController r2 = org.rbmain.messenger.MediaDataController.getInstance(r2)
            org.rbmain.tgnet.TLRPC$StickerSetCovered[] r3 = r7.primaryInstallingStickerSets
            r3 = r3[r1]
            org.rbmain.tgnet.TLRPC$StickerSet r3 = r3.set
            long r3 = r3.id
            org.rbmain.tgnet.TLRPC$TL_messages_stickerSet r2 = r2.getStickerSetById(r3)
            if (r2 == 0) goto L2b
            org.rbmain.tgnet.TLRPC$StickerSet r2 = r2.set
        ...
        L2b:
            ...
            org.rbmain.tgnet.TLRPC$StickerSet r2 = r2.set
            long r2 = r2.id
            org.rbmain.tgnet.TLRPC$StickerSet r4 = r8.set
            long r4 = r4.id
        ...
        L59:
            androidx.collection.LongSparseArray<org.rbmain.tgnet.TLRPC$StickerSetCovered> r2 = r7.installingStickerSets
            org.rbmain.tgnet.TLRPC$StickerSet r3 = r8.set
            long r3 = r3.id
            r2.put(r3, r8)
            if (r9 == 0) goto L6e
            org.rbmain.ui.Adapters.StickersSearchAdapter$Delegate r8 = r7.delegate
            org.rbmain.tgnet.TLRPC$StickerSetCovered r9 = r9.getStickerSet()
            r8.onStickerSetAdd(r9, r1)
            goto L98
        L6e:
            android.util.SparseArray<org.rbmain.tgnet.TLRPC$StickerSetCovered> r9 = r7.positionsToSets
            int r9 = r9.size()
            r1 = 0
        L75:
            if (r1 >= r9) goto L98
            android.util.SparseArray<org.rbmain.tgnet.TLRPC$StickerSetCovered> r2 = r7.positionsToSets
            java.lang.Object r2 = r2.get(r1)
            org.rbmain.tgnet.TLRPC$StickerSetCovered r2 = (org.rbmain.tgnet.TLRPC$StickerSetCovered) r2
            if (r2 == 0) goto L95
            org.rbmain.tgnet.TLRPC$StickerSet r2 = r2.set
            long r2 = r2.id
            org.rbmain.tgnet.TLRPC$StickerSet r4 = r8.set
        ...
        L98:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Adapters.StickersSearchAdapter.installStickerSet(org.rbmain.tgnet.TLRPC$StickerSetCovered, org.rbmain.ui.Cells.FeaturedStickerSetInfoCell):void");
    }
    ...
    private void bindFeaturedStickerSetInfoCell(FeaturedStickerSetInfoCell featuredStickerSetInfoCell, int i, boolean z) {
        ...
        if (iIndexOfIgnoreCase >= 0) {
            featuredStickerSetInfoCell.setStickerSet(tLRPC$StickerSetCovered, z5, z, iIndexOfIgnoreCase, this.searchQuery.length(), z2);
        } else {
