...
public class PaddedListAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public PaddedListAdapter(RecyclerListView.SelectionAdapter selectionAdapter) {
        RecyclerView.AdapterDataObserver adapterDataObserver = new RecyclerView.AdapterDataObserver() { // from class: org.rbmain.ui.Adapters.PaddedListAdapter.2
    ...
    public int getPadding(int i) {
        ...
        if (getPaddingRunnable != null) {
            int iRun = getPaddingRunnable.run(i);
            this.lastPadding = iRun;
            return iRun;
        }
        this.lastPadding = 0;
        return 0;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == -983904) {
            View view = new View(viewGroup.getContext()) { // from class: org.rbmain.ui.Adapters.PaddedListAdapter.1
