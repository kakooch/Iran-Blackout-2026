...
import org.rbmain.tgnet.TLRPC$TL_inlineBotSwitchPM;
import org.rbmain.tgnet.TLRPC$TL_inlineBotWebView;
...
import org.rbmain.ui.Cells.BotSwitchCell;
import org.rbmain.ui.Cells.ContextLinkCell;
import org.rbmain.ui.Cells.MentionCell;
...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    private String nextMentionsOffset;
    ...
    private String searchingContextMentions;
    ...
    private boolean isLoadingAllMembers = false;
    private int currentAccount = UserConfig.selectedAccount;
    private boolean needUsernames = true;
    private boolean needBotContext = true;
    private boolean inlineMediaEnabled = true;
    private ArrayList<String> stickersToLoad = new ArrayList<>();
    private SendMessagesHelper.LocationProvider locationProvider = new SendMessagesHelper.LocationProvider(new SendMessagesHelper.LocationProvider.LocationProviderDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter.1
        ...
        public void onLocationAcquired(Location location) {
            ...
            mentionsAdapter.searchForContextBotResults(true, mentionsAdapter.foundContextBot, MentionsAdapter.this.searchingContextQuery, BuildConfig.FLAVOR);
        }
    ...
    }) { // from class: org.rbmain.ui.Adapters.MentionsAdapter.2
        @Override // org.rbmain.messenger.SendMessagesHelper.LocationProvider
        public void stop() {
            super.stop();
    ...
    static /* synthetic */ int access$1904(MentionsAdapter mentionsAdapter) {
    ...
    public MentionsAdapter(Context context, boolean z, long j, long j2, MentionsAdapterDelegate mentionsAdapterDelegate, Theme.ResourcesProvider resourcesProvider) {
        ...
        searchAdapterHelper.setDelegate(new SearchAdapterHelper.SearchAdapterHelperDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter.3
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if ((i != NotificationCenter.fileDidLoad && i != NotificationCenter.fileDidFailToLoad) || (arrayList = this.stickers) == null || arrayList.isEmpty() || this.stickersToLoad.isEmpty() || !this.visibleByStickersSearch) {
            return;
        }
    ...
    private void addStickersToResult(ArrayList<TLRPC$Document> arrayList, Object obj) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String str = tLRPC$Document.dc_id + "_" + tLRPC$Document.id;
            HashMap<String, TLRPC$Document> map = this.stickersMap;
            if ((map == null || !map.containsKey(str)) && (UserConfig.getInstance(this.currentAccount).isPremium() || !MessageObject.isPremiumSticker(tLRPC$Document))) {
    ...
    private boolean checkStickerFilesExistAndDownload() {
        ...
        for (int i = 0; i < iMin; i++) {
            ...
            if ((closestPhotoSizeWithSize instanceof TLRPC$TL_photoSize) || (closestPhotoSizeWithSize instanceof TLRPC$TL_photoSizeProgressive)) {
                ...
                if (!FileLoader.getPathToAttach(closestPhotoSizeWithSize, "webp", true).exists()) {
    ...
    private void searchServerStickers(final String str, String str2) {
        ...
        tLRPC$TL_messages_getStickers.startId = this.startId;
        tLRPC$TL_messages_getStickers.hash = 0;
        AccountInstance.getInstance(this.currentAccount).getMessageProxy().searchServerStickers(tLRPC$TL_messages_getStickers, new RequestDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda8
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$searchServerStickers$1(str, tLObject, tLRPC$TL_error);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$searchServerStickers$1(final String str, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda3
    ...
    */
    public void notifyDataSetChanged() {
        /*
            ...
            r2 = -1
            if (r0 == r2) goto L59
            java.lang.Object[] r2 = r9.lastData
            if (r2 != 0) goto Lb
            goto L59
        Lb:
        ...
        L43:
            int r1 = r0 - r5
            r9.notifyItemRangeRemoved(r5, r1)
            int r1 = r2 - r5
            r9.notifyItemRangeInserted(r5, r1)
            if (r4 == 0) goto L56
            org.rbmain.ui.Adapters.MentionsAdapter$MentionsAdapterDelegate r1 = r9.delegate
            if (r1 == 0) goto L56
            r1.onItemCountUpdate(r0, r2)
        L56:
            r9.lastData = r6
            goto L7d
        L59:
            org.rbmain.ui.Adapters.MentionsAdapter$MentionsAdapterDelegate r0 = r9.delegate
            if (r0 == 0) goto L64
            int r2 = r9.getItemCount()
            r0.onItemCountUpdate(r1, r2)
        L64:
        ...
        L6f:
            ...
            int r2 = r0.length
            if (r1 >= r2) goto L7d
            java.lang.Object r2 = r9.getItem(r1)
            r0[r1] = r2
            int r1 = r1 + 1
            goto L6f
        L7d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Adapters.MentionsAdapter.notifyDataSetChanged():void");
    }
    ...
    public String getContextBotName() {
        TLRPC$User tLRPC$User = this.foundContextBot;
        return tLRPC$User != null ? tLRPC$User.username : BuildConfig.FLAVOR;
    }
    ...
    public void processFoundUser(TLRPC$User tLRPC$User) {
        ...
        if (tLRPC$User != null && tLRPC$User.bot && tLRPC$User.bot_inline_placeholder != null) {
            ...
            if (this.foundContextBot.bot_inline_geo) {
                if (!MessagesController.getNotificationsSettings(this.currentAccount).getBoolean("inlinegeo_" + this.foundContextBot.id, false) && (chatActivity = this.parentFragment) != null && chatActivity.getParentActivity() != null) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda1
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            this.f$0.lambda$processFoundUser$2(zArr, tLRPC$User2, dialogInterface, i);
                        }
                    });
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda0
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            this.f$0.lambda$processFoundUser$3(zArr, dialogInterface, i);
                        }
                    });
                    this.parentFragment.showDialog(builder.create(), new DialogInterface.OnDismissListener() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda2
        ...
        searchForContextBotResults(true, this.foundContextBot, this.searchingContextQuery, BuildConfig.FLAVOR);
    }
    ...
    /* renamed from: org.rbmain.ui.Adapters.MentionsAdapter$4, reason: invalid class name */
    class AnonymousClass4 implements Runnable {
        ...
        public void run() {
            ...
            if (MentionsAdapter.this.foundContextBot != null || MentionsAdapter.this.noUserName) {
                ...
                MentionsAdapter mentionsAdapter = MentionsAdapter.this;
                mentionsAdapter.searchForContextBotResults(true, mentionsAdapter.foundContextBot, this.val$query, BuildConfig.FLAVOR);
                return;
            }
            ...
            mentionsAdapter2.contextUsernameReqid = connectionsManager.sendRequest(tLRPC$TL_contacts_resolveUsername, new RequestDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$4$$ExternalSyntheticLambda1
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    this.f$0.lambda$run$1(str, messagesController, messagesStorage, tLObject, tLRPC$TL_error);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$run$1(final String str, final MessagesController messagesController, final MessagesStorage messagesStorage, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$0(str, tLRPC$TL_error, tLObject, messagesController, messagesStorage);
                }
            });
        }
    ...
    public void searchForContextBotResults(final boolean z, final TLRPC$User tLRPC$User, final String str, final String str2) {
        ...
        sb.append("_");
        sb.append((!tLRPC$User.bot_inline_geo || this.lastKnownLocation.getLatitude() == -1000.0d) ? BuildConfig.FLAVOR : Double.valueOf(this.lastKnownLocation.getLatitude() + this.lastKnownLocation.getLongitude()));
        final String string = sb.toString();
        final MessagesStorage messagesStorage = MessagesStorage.getInstance(this.currentAccount);
        RequestDelegate requestDelegate = new RequestDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda9
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$searchForContextBotResults$6(str, z, tLRPC$User, str2, messagesStorage, string, tLObject, tLRPC$TL_error);
            }
        };
        if (z) {
        ...
        if (DialogObject.isEncryptedDialog(this.dialog_id)) {
            ...
            tLRPC$TL_messages_getInlineBotResults.peer = MessagesController.getInstance(this.currentAccount).getInputPeer((int) this.dialog_id);
        }
    ...
    public /* synthetic */ void lambda$searchForContextBotResults$6(final String str, final boolean z, final TLRPC$User tLRPC$User, final String str2, final MessagesStorage messagesStorage, final String str3, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$searchForContextBotResults$5(str, z, tLObject, tLRPC$User, str2, messagesStorage, str3);
            }
        });
    }
            ...
            if (tLObject instanceof TLRPC$TL_messages_botResults) {
                ...
                if (this.searchResultBotContext == null || str2.length() == 0) {
                    ...
                    if (tLRPC$TL_messages_botResults.results.isEmpty()) {
                        this.nextQueryOffset = BuildConfig.FLAVOR;
                    }
                    z2 = true;
                }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void searchUsernameOrHashtag(java.lang.CharSequence r24, int r25, java.util.ArrayList<org.rbmain.messenger.MessageObject> r26, boolean r27, boolean r28) {
        /*
            Method dump skipped, instructions count: 1974
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Adapters.MentionsAdapter.searchUsernameOrHashtag(java.lang.CharSequence, int, java.util.ArrayList, boolean, boolean):void");
    }
    ...
    /* renamed from: org.rbmain.ui.Adapters.MentionsAdapter$8, reason: invalid class name */
    class AnonymousClass8 implements Runnable {
        ...
        AnonymousClass8(TLRPC$Chat tLRPC$Chat, String str, long j, ArrayList arrayList, SparseArray sparseArray, MessagesController messagesController) {
        ...
        public void run() {
            ...
            tLRPC$TL_channelParticipantsMentions.flags |= 1;
            tLRPC$TL_channelParticipantsMentions.q = MentionsAdapter.this.searchingContextMentions = this.val$usernameString;
            long j = this.val$threadId;
            if (j != 0) {
                tLRPC$TL_channelParticipantsMentions.flags |= 2;
                tLRPC$TL_channelParticipantsMentions.top_msg_id = j;
            }
            tLRPC$TL_channels_getParticipants.filter = tLRPC$TL_channelParticipantsMentions;
            tLRPC$TL_channels_getParticipants.nextStartId = MentionsAdapter.this.nextMentionsOffset;
            final int iAccess$1904 = MentionsAdapter.access$1904(MentionsAdapter.this);
            MentionsAdapter mentionsAdapter = MentionsAdapter.this;
            DialogsProxy dialogsProxy = DialogsProxy.getInstance(mentionsAdapter.currentAccount);
            final ArrayList arrayList = this.val$newResult;
            final SparseArray sparseArray = this.val$newMap;
            final MessagesController messagesController = this.val$messagesController;
            mentionsAdapter.channelReqId = dialogsProxy.getMembersByType(tLRPC$TL_channels_getParticipants, new RequestDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$8$$ExternalSyntheticLambda1
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    this.f$0.lambda$run$1(iAccess$1904, arrayList, sparseArray, messagesController, tLObject, tLRPC$TL_error);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$run$1(final int i, final ArrayList arrayList, final SparseArray sparseArray, final MessagesController messagesController, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$8$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$0(i, arrayList, sparseArray, tLRPC$TL_error, tLObject, messagesController);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$run$0(int i, ArrayList arrayList, SparseArray sparseArray, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, MessagesController messagesController) {
            if (MentionsAdapter.this.channelReqId != 0 && i == MentionsAdapter.this.channelLastReqId && MentionsAdapter.this.searchResultUsernamesMap != null && MentionsAdapter.this.searchResultUsernames != null) {
                MentionsAdapter.this.showUsersResult(arrayList, sparseArray, false);
                if (tLRPC$TL_error == null) {
                    ...
                    MentionsAdapter.this.nextMentionsOffset = tLRPC$TL_channels_channelParticipants.nextStartId;
                    if (!tLRPC$TL_channels_channelParticipants.participants.isEmpty()) {
                        ...
                        for (int i2 = 0; i2 < tLRPC$TL_channels_channelParticipants.participants.size(); i2++) {
                            int peerId = MessageObject.getPeerId(tLRPC$TL_channels_channelParticipants.participants.get(i2).peer);
                            if (MentionsAdapter.this.searchResultUsernamesMap.indexOfKey(peerId) < 0 && ((peerId != 0 || MentionsAdapter.this.searchResultUsernamesMap.indexOfKey(clientUserId) < 0) && (MentionsAdapter.this.isSearchingMentions || (peerId != clientUserId && peerId != 0)))) {
                                if (peerId >= 0) {
                                    TLRPC$User user = messagesController.getUser(Integer.valueOf(peerId));
                                    if (user == null) {
                                        return;
                                    } else {
                                    ...
                                    TLRPC$Chat chat = messagesController.getChat(Integer.valueOf(-peerId));
                                    if (chat == null) {
                                        return;
                                    } else {
    ...
    public Object getItem(int i) {
        ...
        if (arrayList7 != null && (this.botsCount != 1 || (this.info instanceof TLRPC$TL_channelFull))) {
            ...
            objArr[1] = this.searchResultCommandsUsers.get(i) != null ? this.searchResultCommandsUsers.get(i).username : BuildConfig.FLAVOR;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            contextLinkCell.setDelegate(new ContextLinkCell.ContextLinkCellDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda11
                @Override // org.rbmain.ui.Cells.ContextLinkCell.ContextLinkCellDelegate
                public final void didPressedImage(ContextLinkCell contextLinkCell2) {
                    this.f$0.lambda$onCreateViewHolder$9(contextLinkCell2);
                }
            });
        ...
        if (this.searchResultBotContext != null) {
            ...
            if (viewHolder.getItemViewType() != 2) {
                ...
                if (z) {
                    ...
                    TLRPC$TL_inlineBotSwitchPM tLRPC$TL_inlineBotSwitchPM = this.searchResultBotContextSwitch;
                    tLRPC$TL_inlineBotSwitchPM.getClass();
                    botSwitchCell.setText(tLRPC$TL_inlineBotSwitchPM.text);
                    return;
                }
                return;
            }
    ...
    public void doSomeStickersAction() {
        if (isStickers()) {
            if (this.mentionsStickersActionTracker == null) {
                EmojiView.ChooseStickerActionTracker chooseStickerActionTracker = new EmojiView.ChooseStickerActionTracker(this.currentAccount, this.dialog_id, this.threadMessageId) { // from class: org.rbmain.ui.Adapters.MentionsAdapter.9
                    @Override // org.rbmain.ui.Components.EmojiView.ChooseStickerActionTracker
    ...
    private void getAllMembers() {
        ...
        if (tLRPC$ChatFull == null || this.isLoadingAllMembers || tLRPC$ChatFull.participants != null) {
            return;
        }
        final MessagesController messagesController = MessagesController.getInstance(this.currentAccount);
        this.isLoadingAllMembers = true;
        TLRPC$TL_channels_getParticipants tLRPC$TL_channels_getParticipants = new TLRPC$TL_channels_getParticipants();
        tLRPC$TL_channels_getParticipants.channel = MessagesController.getInputChannel(MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(this.info.id)));
        tLRPC$TL_channels_getParticipants.limit = 20;
        tLRPC$TL_channels_getParticipants.offset = 0;
        TLRPC$TL_channelParticipantsMentions tLRPC$TL_channelParticipantsMentions = new TLRPC$TL_channelParticipantsMentions();
        tLRPC$TL_channelParticipantsMentions.flags = 1 | tLRPC$TL_channelParticipantsMentions.flags;
        tLRPC$TL_channelParticipantsMentions.q = null;
        tLRPC$TL_channels_getParticipants.filter = tLRPC$TL_channelParticipantsMentions;
        this.channelReqId = DialogsProxy.getInstance(this.currentAccount).getMembersByType(tLRPC$TL_channels_getParticipants, new RequestDelegate() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda10
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$getAllMembers$11(messagesController, tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getAllMembers$11(final MessagesController messagesController, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$getAllMembers$10(tLRPC$TL_error, tLObject, messagesController);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getAllMembers$10(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, MessagesController messagesController) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            if (!tLRPC$TL_channels_channelParticipants.participants.isEmpty()) {
                ...
                for (int i = 0; i < tLRPC$TL_channels_channelParticipants.participants.size(); i++) {
                    ...
                    this.info.participants.participants.add(tLRPC$TL_chatChannelParticipant);
                }
            }
            String str = this.lastText;
            ...
            searchUsernameOrHashtag(str, i2, arrayList, this.lastUsernameOnly, this.lastForSearch);
        }
    }
