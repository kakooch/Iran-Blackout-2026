...
public class SearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public SearchAdapter(Context context, SparseArray<TLRPC$User> sparseArray, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, int i) {
        ...
        searchAdapterHelper.setDelegate(new SearchAdapterHelper.SearchAdapterHelperDelegate() { // from class: org.rbmain.ui.Adapters.SearchAdapter.1
    ...
    public void searchDialogs(final String str) {
        ...
        timer2.schedule(new TimerTask() { // from class: org.rbmain.ui.Adapters.SearchAdapter.2
    ...
    public void processSearch(final String str) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.SearchAdapter$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$processSearch$1(final String str) {
        ...
        this.searchReqId = i2;
        Utilities.searchQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Adapters.SearchAdapter$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void updateSearchResults(final int i, final ArrayList<Object> arrayList, final ArrayList<CharSequence> arrayList2) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Adapters.SearchAdapter$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Adapters.SearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
