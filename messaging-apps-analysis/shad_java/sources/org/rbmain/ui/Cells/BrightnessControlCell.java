...
public class BrightnessControlCell extends FrameLayout {
    ...
    public BrightnessControlCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        SeekBarView seekBarView = new SeekBarView(this, context, true, resourcesProvider) { // from class: org.rbmain.ui.Cells.BrightnessControlCell.1
        ...
        seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.rbmain.ui.Cells.BrightnessControlCell.2
