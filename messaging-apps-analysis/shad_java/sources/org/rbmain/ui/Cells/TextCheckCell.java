...
public class TextCheckCell extends FrameLayout {
    public static final Property<TextCheckCell, Float> ANIMATION_PROGRESS = new AnimationProperties.FloatProperty<TextCheckCell>("animationProgress") { // from class: org.rbmain.ui.Cells.TextCheckCell.1
    ...
    public void setBackgroundColorAnimated(boolean z, int i) {
        ...
        objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.TextCheckCell.2
    ...
    public void setBackgroundColorAnimatedReverse(final int i) {
        ...
        duration.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.TextCheckCell.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
