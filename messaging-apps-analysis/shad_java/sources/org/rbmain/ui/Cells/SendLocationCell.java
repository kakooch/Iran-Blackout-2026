...
public class SendLocationCell extends FrameLayout {
    ...
    public SendLocationCell(Context context, boolean z) throws Resources.NotFoundException {
        int i;
        int i2;
        super(context);
        this.currentAccount = UserConfig.selectedAccount;
        this.invalidateRunnable = new Runnable() { // from class: org.rbmain.ui.Cells.SendLocationCell.1
        ...
        Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.dp(42.0f), Theme.getColor(z ? Theme.key_location_sendLiveLocationBackground : Theme.key_location_sendLocationBackground), Theme.getColor(z ? Theme.key_location_sendLiveLocationBackground : Theme.key_location_sendLocationBackground));
        if (z) {
            this.rect = new RectF();
        ...
        this.titleTextView.setTextColor(Theme.getColor(z ? Theme.key_location_sendLiveLocationText : Theme.key_location_sendLocationText));
