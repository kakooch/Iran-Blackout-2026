...
public class TextInfoPrivacyCell extends FrameLayout {
    ...
    public TextInfoPrivacyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        LinkSpanDrawable.LinksTextView linksTextView = new LinkSpanDrawable.LinksTextView(context, linkCollector, resourcesProvider) { // from class: org.rbmain.ui.Cells.TextInfoPrivacyCell.1
            @Override // org.rbmain.ui.Components.LinkSpanDrawable.LinksTextView, android.widget.TextView, android.view.View
