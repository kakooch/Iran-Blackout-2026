...
public class PhotoEditToolCell extends FrameLayout {
    ...
    public PhotoEditToolCell(Context context) {
        super(context);
        this.hideValueRunnable = new Runnable() { // from class: org.rbmain.ui.Cells.PhotoEditToolCell.1
            ...
            public void run() {
                ...
                PhotoEditToolCell.this.valueAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.PhotoEditToolCell.1.1
    ...
    public void setSeekBarDelegate(final PhotoEditorSeekBar.PhotoEditorSeekBarDelegate photoEditorSeekBarDelegate) {
        this.seekBar.setDelegate(new PhotoEditorSeekBar.PhotoEditorSeekBarDelegate() { // from class: org.rbmain.ui.Cells.PhotoEditToolCell$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$setSeekBarDelegate$0(PhotoEditorSeekBar.PhotoEditorSeekBarDelegate photoEditorSeekBarDelegate, int i, int i2) {
        ...
        if (i2 > 0) {
            ...
            this.valueTextView.setText(BuildConfig.FLAVOR + i2);
        }
        if (this.valueTextView.getTag() == null) {
            ...
            this.valueAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.PhotoEditToolCell.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    public void setIconAndTextAndValue(String str, float f, int i, int i2) {
        ...
        if (f > 0.0f) {
            ...
            this.valueTextView.setText(BuildConfig.FLAVOR + ((int) f));
        }
