...
public class AvailableReactionCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void bind(TLRPC$TL_availableReaction tLRPC$TL_availableReaction, boolean z, int i) {
        ...
        this.imageView.setImage(ImageLocation.getForDocument(tLRPC$TL_availableReaction.activate_animation), "30_30_pcache", "tgs", Emoji.getEmojiDrawable(tLRPC$TL_availableReaction.reaction), tLRPC$TL_availableReaction);
