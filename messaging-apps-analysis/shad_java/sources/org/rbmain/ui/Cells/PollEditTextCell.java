...
public class PollEditTextCell extends FrameLayout {
    ...
    public PollEditTextCell(Context context, boolean z, View.OnClickListener onClickListener) {
        ...
        if (z) {
            EditTextCaption editTextCaption = new EditTextCaption(context, resourcesProvider) { // from class: org.rbmain.ui.Cells.PollEditTextCell.1
                ...
                @Override // org.rbmain.ui.Components.EditTextCaption, org.rbmain.ui.Components.EditTextBoldCursor, org.rbmain.ui.Components.EditTextEffects, android.widget.TextView, android.view.View
                ...
                @Override // org.rbmain.ui.Components.EditTextCaption, org.rbmain.ui.Components.EditTextBoldCursor, android.view.View
            ...
            this.textView = new EditTextBoldCursor(context) { // from class: org.rbmain.ui.Cells.PollEditTextCell.2
                @Override // android.widget.TextView, android.view.View
                public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
                    InputConnection inputConnectionOnCreateInputConnection = super.onCreateInputConnection(editorInfo);
                    if (PollEditTextCell.this.showNextButton) {
        ...
        if (onClickListener != null) {
            ...
            this.checkBox.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Cells.PollEditTextCell$$ExternalSyntheticLambda0
