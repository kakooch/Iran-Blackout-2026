...
public class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public WallpaperView(Context context) {
            ...
            BackupImageView backupImageView = new BackupImageView(context, WallpaperCell.this) { // from class: org.rbmain.ui.Cells.WallpaperCell.WallpaperView.1
        ...
        public void setChecked(final boolean z, boolean z2) {
            ...
            if (z2) {
                ...
                this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.WallpaperCell.WallpaperView.2
    ...
    public WallpaperCell(Context context, int i) {
        ...
        while (true) {
            ...
            if (i2 < wallpaperViewArr.length) {
                ...
                wallpaperView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Cells.WallpaperCell$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f$0.lambda$new$0(wallpaperView, i2, view);
                    }
                });
                wallpaperView.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.rbmain.ui.Cells.WallpaperCell$$ExternalSyntheticLambda1
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iDp2 = this.currentType == 0 ? AndroidUtilities.dp(180.0f) : i4;
        ...
        while (true) {
            ...
            this.wallpaperViews[i3].measure(View.MeasureSpec.makeMeasureSpec(i3 == i5 + (-1) ? iDp : i4, 1073741824), View.MeasureSpec.makeMeasureSpec(iDp2, 1073741824));
            iDp -= i4;
            i3++;
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < this.spanCount; i5++) {
            ...
            WallpaperView[] wallpaperViewArr = this.wallpaperViews;
            wallpaperViewArr[i5].layout(iDp, iDp2, iDp + measuredWidth, wallpaperViewArr[i5].getMeasuredHeight() + iDp2);
