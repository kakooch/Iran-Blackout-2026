...
public class SharedPhotoVideoCell extends FrameLayout {
    ...
    private class PhotoVideoView extends FrameLayout {
        ...
        public PhotoVideoView(Context context) {
            ...
            FrameLayout frameLayout2 = new FrameLayout(this, context, SharedPhotoVideoCell.this) { // from class: org.rbmain.ui.Cells.SharedPhotoVideoCell.PhotoVideoView.1
        ...
        public void setChecked(boolean z, boolean z2) {
            ...
            if (z2) {
                ...
                this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.SharedPhotoVideoCell.PhotoVideoView.2
    ...
    public SharedPhotoVideoCell(Context context, int i) {
        ...
        for (int i2 = 0; i2 < 6; i2++) {
            ...
            this.photoVideoViews[i2].setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Cells.SharedPhotoVideoCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$new$0(view);
                }
            });
            this.photoVideoViews[i2].setOnLongClickListener(new View.OnLongClickListener() { // from class: org.rbmain.ui.Cells.SharedPhotoVideoCell$$ExternalSyntheticLambda1
