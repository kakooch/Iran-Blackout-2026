...
public class GroupCallUserCell extends FrameLayout {
    ...
    public GroupCallUserCell(Context context) throws Resources.NotFoundException {
        ...
        this.shakeHandCallback = new Runnable() { // from class: org.rbmain.ui.Cells.GroupCallUserCell$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$0();
            }
        };
        this.raiseHandCallback = new Runnable() { // from class: org.rbmain.ui.Cells.GroupCallUserCell$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.checkRaiseRunnable = new Runnable() { // from class: org.rbmain.ui.Cells.GroupCallUserCell$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$2();
            }
        };
        this.updateRunnable = new Runnable() { // from class: org.rbmain.ui.Cells.GroupCallUserCell$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$3();
            }
        };
        this.updateVoiceRunnable = new Runnable() { // from class: org.rbmain.ui.Cells.GroupCallUserCell$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$4();
            }
        };
        this.speakLevelTime = 4000L;
        ...
        RadialProgressView radialProgressView = new RadialProgressView(context) { // from class: org.rbmain.ui.Cells.GroupCallUserCell.1
            private Paint paint;
        ...
        while (true) {
            ...
            simpleTextViewArr[i] = new SimpleTextView(context) { // from class: org.rbmain.ui.Cells.GroupCallUserCell.2
                float originalAlpha;
        ...
        this.muteDrawable = new RLottieDrawable(R.raw.voice_outlined2, "2131820686", AndroidUtilities.dp(34.0f), AndroidUtilities.dp(32.0f), true, null);
        this.shakeHandDrawable = new RLottieDrawable(R.raw.hand_1, "2131820591", AndroidUtilities.dp(34.0f), AndroidUtilities.dp(32.0f), true, null);
        ...
        this.muteButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Cells.GroupCallUserCell$$ExternalSyntheticLambda1
    ...
    public boolean isSelfUser() {
        ...
        if (j > 0) {
            ...
            return tLRPC$User != null && ((long) tLRPC$User.id) == j;
        }
        TLRPC$Chat tLRPC$Chat = this.currentChat;
        return tLRPC$Chat != null && ((long) tLRPC$Chat.id) == (-j);
    }
    ...
    */
    public void setData(org.rbmain.messenger.AccountInstance r7, org.rbmain.tgnet.TLRPC$TL_groupCallParticipant r8, org.rbmain.messenger.ChatObject.Call r9, long r10, org.rbmain.tgnet.TLRPC$FileLocation r12, boolean r13) {
        /*
            Method dump skipped, instructions count: 418
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Cells.GroupCallUserCell.setData(org.rbmain.messenger.AccountInstance, org.rbmain.tgnet.TLRPC$TL_groupCallParticipant, org.rbmain.messenger.ChatObject$Call, long, org.rbmain.tgnet.TLRPC$FileLocation, boolean):void");
    }
    ...
    public void setAmplitude(double d) {
        if (d > 1.5d) {
            ...
            AndroidUtilities.runOnUIThread(this.updateRunnable, this.speakLevelTime);
    ...
    */
    private void applyParticipantChanges(boolean r18, boolean r19) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Cells.GroupCallUserCell.applyParticipantChanges(boolean, boolean):void");
    }
        ...
        */
        public void draw(android.graphics.Canvas r8, float r9, float r10, android.view.View r11) {
            /*
                ...
                boolean r0 = org.rbmain.messenger.LiteMode.isEnabled(r0)
                if (r0 != 0) goto L9
                return
            L9:
            ...
            L1f:
                r8.save()
                org.rbmain.ui.Components.CubicBezierInterpolator r0 = org.rbmain.ui.Components.CubicBezierInterpolator.DEFAULT
            ...
            L62:
                ...
                r4 = 2
                if (r3 != r4) goto L74
                int r3 = org.rbmain.ui.ActionBar.Theme.key_voipgroup_mutedByAdminIcon
                goto L76
            L74:
                int r3 = org.rbmain.ui.ActionBar.Theme.key_voipgroup_listeningText
            L76:
                ...
                org.rbmain.ui.Components.BlobDrawable r3 = r7.blobDrawable
                android.graphics.Paint r3 = r3.paint
                r4 = 38
                int r0 = androidx.core.graphics.ColorUtils.setAlphaComponent(r0, r4)
                r3.setColor(r0)
            L8d:
                org.rbmain.ui.Components.BlobDrawable r0 = r7.blobDrawable
                float r3 = r7.amplitude
                r0.update(r3, r2)
                org.rbmain.ui.Components.BlobDrawable r0 = r7.blobDrawable
                android.graphics.Paint r3 = r0.paint
                r0.draw(r9, r10, r8, r3)
                org.rbmain.ui.Components.BlobDrawable r0 = r7.blobDrawable2
                float r3 = r7.amplitude
                r0.update(r3, r2)
                org.rbmain.ui.Components.BlobDrawable r0 = r7.blobDrawable2
                org.rbmain.ui.Components.BlobDrawable r2 = r7.blobDrawable
            ...
            Lb7:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Cells.GroupCallUserCell.AvatarWavesDrawable.draw(android.graphics.Canvas, float, float, android.view.View):void");
        }
    ...
    public long getPeerId() {
        ...
        return MessageObject.getPeerId(r0.peer);
    }
}
