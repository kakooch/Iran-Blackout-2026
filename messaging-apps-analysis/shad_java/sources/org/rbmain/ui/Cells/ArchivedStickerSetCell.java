...
public class ArchivedStickerSetCell extends FrameLayout implements Checkable {
    ...
    public ArchivedStickerSetCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() { // from class: org.rbmain.ui.Cells.ArchivedStickerSetCell$$ExternalSyntheticLambda0
    ...
    private void syncButtons(boolean z) {
        if (this.checkable) {
            ...
            if (z) {
                ...
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.ArchivedStickerSetCell.1
