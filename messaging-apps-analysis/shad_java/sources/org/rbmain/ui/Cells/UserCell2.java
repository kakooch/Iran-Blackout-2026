...
public class UserCell2 extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [org.rbmain.tgnet.TLRPC$FileLocation] */
    /*
    ...
    */
    public void update(int r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Cells.UserCell2.update(int):void");
    }
}
