...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    public PhotoAttachPhotoCell(Context context) {
        ...
        FrameLayout frameLayout2 = new FrameLayout(this, context) { // from class: org.rbmain.ui.Cells.PhotoAttachPhotoCell.1
    ...
    public void setChecked(int i, final boolean z, boolean z2) {
        ...
        if (this.itemSizeChanged) {
            ...
            if (z2) {
                ...
                this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.PhotoAttachPhotoCell.2
    ...
    public void showCheck(boolean z) {
        ...
        if (z || this.checkBox.getAlpha() != 0.0f) {
            ...
            this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.PhotoAttachPhotoCell.3
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        /*
            ...
            android.graphics.Rect r1 = org.rbmain.ui.Cells.PhotoAttachPhotoCell.rect
            r0.getHitRect(r1)
            int r0 = r6.getAction()
            r1 = 1
            r2 = 0
            if (r0 != 0) goto L27
            android.graphics.Rect r0 = org.rbmain.ui.Cells.PhotoAttachPhotoCell.rect
            float r3 = r6.getX()
            int r3 = (int) r3
            float r4 = r6.getY()
            int r4 = (int) r4
        ...
        L27:
            ...
            org.rbmain.ui.Cells.PhotoAttachPhotoCell$PhotoAttachPhotoCellDelegate r0 = r5.delegate
            r0.onCheckClick(r5)
            r5.invalidate()
            goto L74
        L49:
        ...
        L7b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Cells.PhotoAttachPhotoCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
