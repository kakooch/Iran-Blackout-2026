...
public class ManageChatUserCell extends FrameLayout {
    ...
    public ManageChatUserCell(Context context, int i, int i2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z) {
            ...
            this.optionsButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Cells.ManageChatUserCell$$ExternalSyntheticLambda0
    ...
    */
    public void update(int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Cells.ManageChatUserCell.update(int):void");
    }
