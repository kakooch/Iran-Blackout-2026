...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    public FeaturedStickerSetCell(Context context) {
        ...
        addView(textView4, LayoutHelper.createFrame(-2, -2.0f, z2 ? 5 : 3, z2 ? 100.0f : 71.0f, 35.0f, z2 ? 71.0f : 100.0f, 0.0f));
        ...
        addView(backupImageView2, LayoutHelper.createFrame(48, 48.0f, (z3 ? 5 : 3) | 48, z3 ? 0.0f : 12.0f, 8.0f, z3 ? 12.0f : 0.0f, 0.0f));
    ...
    public void setStickersSet(TLRPC$StickerSetCovered tLRPC$StickerSetCovered, boolean z, boolean z2) {
        ...
        if (z2) {
            Drawable drawable = new Drawable(this) { // from class: org.rbmain.ui.Cells.FeaturedStickerSetCell.1
        ...
        if (z3) {
            ...
            boolean zIsStickerPackInstalled = MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(tLRPC$StickerSetCovered.set.id);
            ...
            if (zIsStickerPackInstalled) {
                ...
                this.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.FeaturedStickerSetCell.2
            ...
            if (z6) {
                ...
                this.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.FeaturedStickerSetCell.3
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        if (FeaturedStickerSetCell.this.currentAnimation == null || !FeaturedStickerSetCell.this.currentAnimation.equals(animator)) {
                            return;
        ...
        boolean zIsStickerPackInstalled2 = MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(tLRPC$StickerSetCovered.set.id);
