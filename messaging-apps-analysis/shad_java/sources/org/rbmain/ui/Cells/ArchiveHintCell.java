...
public class ArchiveHintCell extends FrameLayout {
    ...
    public ArchiveHintCell(Context context) throws NoSuchFieldException, Resources.NotFoundException {
        super(context);
        ViewPager viewPager = new ViewPager(this, context) { // from class: org.rbmain.ui.Cells.ArchiveHintCell.1
        ...
        this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: org.rbmain.ui.Cells.ArchiveHintCell.2
