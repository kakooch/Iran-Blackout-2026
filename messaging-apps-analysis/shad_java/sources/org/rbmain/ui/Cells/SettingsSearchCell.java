        ...
        if (strArr != null) {
            ...
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (i2 != 0) {
                    ...
                    spannableStringBuilder.setSpan(new VerticalImageSpan(this, drawableMutate), spannableStringBuilder.length() - 2, spannableStringBuilder.length() - 1, 33);
                }
            ...
            if (strArr != null) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (i2 != 0) {
                        ...
                        spannableStringBuilder2.setSpan(new VerticalImageSpan(this, drawableMutate2), spannableStringBuilder2.length() - 2, spannableStringBuilder2.length() - 1, 33);
                    }
