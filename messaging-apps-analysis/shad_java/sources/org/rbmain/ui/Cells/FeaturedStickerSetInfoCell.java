...
public class FeaturedStickerSetInfoCell extends FrameLayout {
    ...
    public FeaturedStickerSetInfoCell(Context context, int i, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.delButton.setTextColor(Theme.getColor(Theme.key_featuredStickers_removeButtonText));
    ...
    public void setStickerSet(TLRPC$StickerSetCovered tLRPC$StickerSetCovered, boolean z, boolean z2, int i, int i2, boolean z3) {
        ...
        if (this.canAddRemove) {
            if (this.hasOnClick) {
                ...
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Cells.FeaturedStickerSetInfoCell.1
    ...
    private void updateStickerSetNameSearchSpan() {
        if (this.stickerSetNameSearchLength != 0) {
            ...
            try {
                ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(Theme.getColor(Theme.key_windowBackgroundWhiteBlueText4));
    ...
    private void updateUrlSearchSpan() {
        if (this.url != null) {
            ...
            try {
                spannableStringBuilder.setSpan(new ColorSpanUnderline(Theme.getColor(Theme.key_windowBackgroundWhiteBlueText4)), 0, this.urlSearchLength, 33);
                spannableStringBuilder.setSpan(new ColorSpanUnderline(Theme.getColor(Theme.key_chat_emojiPanelTrendingDescription)), this.urlSearchLength, this.url.length(), 33);
            } catch (Exception unused) {
            }
    ...
    */
    protected void onDraw(android.graphics.Canvas r8) {
        ...
        L3b:
            ...
            int r1 = org.rbmain.ui.ActionBar.Theme.key_featuredStickers_unread
        ...
        L6b:
            ...
            float r4 = (float) r0
            r5 = 0
            android.graphics.Paint r6 = org.rbmain.ui.ActionBar.Theme.dividerPaint
            r1 = r8
            r1.drawLine(r2, r3, r4, r5, r6)
        L7d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Cells.FeaturedStickerSetInfoCell.onDraw(android.graphics.Canvas):void");
    }
