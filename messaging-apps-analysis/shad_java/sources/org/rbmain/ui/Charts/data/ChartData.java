    ...
    public ChartData(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONArray2.getString(0).equals("x")) {
                ...
                while (i2 < length) {
                    int i3 = i2 + 1;
                    this.x[i2] = jSONArray2.getLong(i3) * 1000;
                    i2 = i3;
                }
            } else {
        ...
        for (int i6 = 0; i6 < this.lines.size(); i6++) {
            ...
            if (jSONObjectOptJSONObject != null) {
                String string = jSONObjectOptJSONObject.getString(line2.id);
                Matcher matcher = patternCompile.matcher(string.contains("#") ? string : string + "#ff000000");
                if (matcher.matches()) {
