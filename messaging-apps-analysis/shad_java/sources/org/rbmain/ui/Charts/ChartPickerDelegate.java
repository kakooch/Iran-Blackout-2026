...
public class ChartPickerDelegate {
    ...
    class CapturesData {
        ...
        public void captured() {
            ...
            this.a.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.ChartPickerDelegate$CapturesData$$ExternalSyntheticLambda0
        ...
        if (i == 0) {
            if (this.tryMoveTo) {
                ...
                if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.startTapTime < 300 && Math.sqrt((x * x) + (y * y)) < AndroidUtilities.dp(10.0f)) {
                    ...
                    this.moveToAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.ChartPickerDelegate$$ExternalSyntheticLambda0
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
