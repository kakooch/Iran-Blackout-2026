...
import org.rbmain.ui.Charts.view_data.StackBarViewData;
        ...
        if (BaseChartView.ANIMATE_PICKER_SIZES) {
            ...
            if (i > 0) {
                ...
                if (f != this.animatedToPickerMaxHeight) {
                    ...
                    ValueAnimator valueAnimatorCreateAnimator = createAnimator(this.pickerMaxHeight, this.animatedToPickerMaxHeight, new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.StackBarChartView.1
