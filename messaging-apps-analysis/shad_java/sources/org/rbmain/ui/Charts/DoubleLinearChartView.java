...
public class DoubleLinearChartView extends BaseChartView<DoubleLinearChartData, LineViewData> {
    ...
    */
    protected void drawPickerChart(android.graphics.Canvas r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Charts.DoubleLinearChartView.drawPickerChart(android.graphics.Canvas):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected void drawSignaturesToHorizontalLines(android.graphics.Canvas r18, org.rbmain.ui.Charts.view_data.ChartHorizontalLinesData r19) {
        /*
            Method dump skipped, instructions count: 337
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Charts.DoubleLinearChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.rbmain.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    public int findMaxValue(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int iRMaxQ = ((LineViewData) this.lines.get(i4)).enabled ? (int) (((DoubleLinearChartData) this.chartData).lines.get(i4).segmentTree.rMaxQ(i, i2) * ((DoubleLinearChartData) this.chartData).linesK[i4]) : 0;
            if (iRMaxQ > i3) {
                i3 = iRMaxQ;
            }
        }
    ...
    public int findMinValue(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int iRMinQ = ((LineViewData) this.lines.get(i4)).enabled ? (int) (((DoubleLinearChartData) this.chartData).lines.get(i4).segmentTree.rMinQ(i, i2) * ((DoubleLinearChartData) this.chartData).linesK[i4]) : ConnectionsManager.DEFAULT_DATACENTER_ID;
            if (iRMinQ < i3) {
                i3 = iRMinQ;
            }
        }
        ...
        if (BaseChartView.ANIMATE_PICKER_SIZES) {
            ...
            if (i2 > 0) {
                ...
                if (f != this.animatedToPickerMaxHeight) {
                    ...
                    ValueAnimator valueAnimatorCreateAnimator = createAnimator(this.pickerMaxHeight, this.animatedToPickerMaxHeight, new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.DoubleLinearChartView.1
