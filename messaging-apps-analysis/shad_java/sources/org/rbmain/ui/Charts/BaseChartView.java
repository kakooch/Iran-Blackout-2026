...
import org.rbmain.ui.Charts.view_data.ChartBottomSignatureData;
...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    public BaseChartView(Context context) {
        ...
        this.pickerHeightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView.1
        ...
        this.pickerMinHeightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView.2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        this.heightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$new$0(valueAnimator);
            }
        };
        this.minHeightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$new$1(valueAnimator);
            }
        };
        this.selectionAnimatorListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView.3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        this.selectorAnimatorEndListener = new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Charts.BaseChartView.4
    ...
    */
    void drawBottomSignature(android.graphics.Canvas r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Charts.BaseChartView.drawBottomSignature(android.graphics.Canvas):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected void drawHorizontalLines(android.graphics.Canvas r12, org.rbmain.ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            int[] r0 = r13.values
            int r1 = r0.length
        ...
        L27:
            ...
            if (r5 != r2) goto L31
            org.rbmain.ui.Charts.view_data.TransitionParams r2 = r11.transitionParams
        ...
        L3f:
            ...
            int r0 = r0 - r2
            int r2 = org.rbmain.ui.Charts.BaseChartView.SIGNATURE_TEXT_HEIGHT
            int r0 = r0 - r2
        ...
        L9d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Charts.BaseChartView.drawHorizontalLines(android.graphics.Canvas, org.rbmain.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected void drawSignaturesToHorizontalLines(android.graphics.Canvas r11, org.rbmain.ui.Charts.view_data.ChartHorizontalLinesData r12) {
        /*
            r10 = this;
            int[] r0 = r12.values
            int r1 = r0.length
        ...
        L27:
            ...
            if (r5 != r2) goto L31
            org.rbmain.ui.Charts.view_data.TransitionParams r2 = r10.transitionParams
            float r2 = r2.progress
            float r3 = r3 - r2
            goto L3f
        L31:
        ...
        L7b:
            ...
            r5 = r5[r3]
            float r6 = org.rbmain.ui.Charts.BaseChartView.HORIZONTAL_PADDING
            int r4 = r4 - r2
            float r4 = (float) r4
        ...
        La6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Charts.BaseChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.rbmain.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    */
    void drawPicker(android.graphics.Canvas r29) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Charts.BaseChartView.drawPicker(android.graphics.Canvas):void");
    }
    ...
    protected void setMaxMinValue(int i, int i2, boolean z, boolean z2, boolean z3) {
        if ((Math.abs(((float) ChartHorizontalLinesData.lookupHeight(i)) - this.animateToMaxHeight) >= this.thresholdMaxHeight && i != 0) || i != this.animateToMinHeight) {
            final ChartHorizontalLinesData chartHorizontalLinesDataCreateHorizontalLinesData = createHorizontalLinesData(i, i2);
            ...
            if (jCurrentTimeMillis - this.lastTime >= 320 || z2) {
                ...
                ValueAnimator valueAnimatorCreateAnimator = createAnimator(0.0f, 255.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView$$ExternalSyntheticLambda3
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                ...
                valueAnimatorCreateAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Charts.BaseChartView.5
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    public int findMaxValue(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (this.lines.get(i4).enabled && (iRMaxQ = this.lines.get(i4).line.segmentTree.rMaxQ(i, i2)) > i3) {
                i3 = iRMaxQ;
            }
        }
        return i3;
    ...
    public int findMinValue(int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (this.lines.get(i4).enabled && (iRMinQ = this.lines.get(i4).line.segmentTree.rMinQ(i, i2)) < i3) {
                i3 = iRMinQ;
            }
        }
        return i3;
    ...
    @Override // org.rbmain.ui.Charts.ChartPickerDelegate.Listener
    ...
    private void updateDates(int i) {
        ...
        if (chartBottomSignatureData == null || i >= chartBottomSignatureData.stepMax || i <= chartBottomSignatureData.stepMin) {
            ...
            if (chartBottomSignatureData2 == null || chartBottomSignatureData2.step != iHighestOneBit) {
                ...
                ValueAnimator duration = createAnimator(0.0f, 1.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView$$ExternalSyntheticLambda2
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Charts.BaseChartView.6
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        super.onAnimationEnd(animator);
        ...
        while (true) {
            ...
            if (l.enabled && l.alpha != 1.0f) {
                ...
                if (valueAnimator4 == null || !valueAnimator4.isRunning()) {
                    ValueAnimator valueAnimatorCreateAnimator = createAnimator(l.alpha, 1.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView$$ExternalSyntheticLambda5
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                ...
                ValueAnimator valueAnimatorCreateAnimator2 = createAnimator(l.alpha, 0.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Charts.BaseChartView$$ExternalSyntheticLambda4
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator5) {
