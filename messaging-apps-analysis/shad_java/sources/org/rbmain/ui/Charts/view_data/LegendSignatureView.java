...
public class LegendSignatureView extends FrameLayout {
    ...
    public LegendSignatureView(Context context) {
        ...
        this.canGoZoom = true;
        this.showProgressRunnable = new Runnable() { // from class: org.rbmain.ui.Charts.view_data.LegendSignatureView.1
    ...
    public void setData(int i, long j, ArrayList<LineViewData> arrayList, boolean z) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            ...
            if (!arrayList.get(i4).enabled) {
                ...
                if (i5 >= 0 && Theme.hasDefaultThemeKey(i5)) {
    ...
    public void showProgress(boolean z, boolean z2) {
        ...
        if (this.progressView.getVisibility() == 0) {
            this.progressView.animate().setDuration(80L).alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Charts.view_data.LegendSignatureView.2
