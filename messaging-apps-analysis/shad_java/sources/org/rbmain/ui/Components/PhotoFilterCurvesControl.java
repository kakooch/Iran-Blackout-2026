    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L2b:
            ...
            float r2 = r8.getY()
            r7.lastY = r2
            org.rbmain.ui.Components.Rect r4 = r7.actualArea
            float r5 = r4.x
        ...
        L76:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.PhotoFilterCurvesControl.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i3 < 5) {
            if (i3 == 0) {
                ...
                str = i3 != 4 ? BuildConfig.FLAVOR : String.format(Locale.US, "%.2f", Float.valueOf(curvesValue.whitesLevel / 100.0f));
            }
