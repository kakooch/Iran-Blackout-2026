...
public class WebPlayerView extends ViewGroup implements VideoPlayer.VideoPlayerDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    private static class JSExtractor {
                ...
                if (i3 < strArr.length) {
                    ...
                    if (matcher2.find()) {
                        ...
                        if (!TextUtils.isEmpty(strGroup)) {
                            ...
                            map.put(matcher2.group(1), BuildConfig.FLAVOR);
                            return;
                        }
                    }
                    i3++;
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (matcher4.find()) {
                                ...
                                strGroup3.replace("\"", BuildConfig.FLAVOR);
        ...
        private void buildFunction(String[] strArr, String str) throws Exception {
            ...
            for (String str2 : strArr) {
                map.put(str2, BuildConfig.FLAVOR);
            }
        ...
        public String extractFunction(String str) {
            ...
            return TextUtils.join(BuildConfig.FLAVOR, this.codeLines);
        }
    }
    ...
    */
    protected java.lang.String downloadUrlContent(android.os.AsyncTask r19, java.lang.String r20, java.util.HashMap<java.lang.String, java.lang.String> r21, boolean r22) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 412
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.WebPlayerView.downloadUrlContent(android.os.AsyncTask, java.lang.String, java.util.HashMap, boolean):java.lang.String");
    }
        ...
        */
        public java.lang.String[] doInBackground(java.lang.Void... r24) throws org.json.JSONException, java.lang.InterruptedException, java.io.UnsupportedEncodingException {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.WebPlayerView.YoutubeVideoTask.doInBackground(java.lang.Void[]):java.lang.String[]");
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$doInBackground$1(String str) {
            if (Build.VERSION.SDK_INT >= 21) {
                WebPlayerView.this.webView.evaluateJavascript(str, new ValueCallback() { // from class: org.rbmain.ui.Components.WebPlayerView$YoutubeVideoTask$$ExternalSyntheticLambda0
    ...
    private class TwitchStreamVideoTask extends AsyncTask<Void, Void, String> {
        ...
        public String doInBackground(Void... voidArr) throws JSONException, IOException {
            ...
            try {
                ...
                String strEncode = URLEncoder.encode(jSONObject.getString("sig"), Utf8Charset.NAME);
                String strEncode2 = URLEncoder.encode(jSONObject.getString("token"), Utf8Charset.NAME);
                URLEncoder.encode("https://youtube.googleapis.com/v/" + this.videoId, Utf8Charset.NAME);
    ...
    class ControlsView extends FrameLayout {
        ...
        public ControlsView(Context context) {
            super(context);
            this.isVisible = true;
            this.hideRunnable = new Runnable() { // from class: org.rbmain.ui.Components.WebPlayerView$ControlsView$$ExternalSyntheticLambda0
        ...
        public void show(boolean z, boolean z2) {
            ...
            if (this.isVisible) {
                if (z2) {
                    ...
                    this.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.WebPlayerView.ControlsView.1
                ...
                this.currentAnimation.setDuration(150L);
                this.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.WebPlayerView.ControlsView.2
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        ControlsView.this.currentAnimation = null;
                    }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                setProgress((int) (this.duration * CloseCodes.NORMAL_CLOSURE * ((this.currentProgressX - iDp) / (measuredWidth - iDp))));
                invalidate();
            }
        ...
        */
        protected void onDraw(android.graphics.Canvas r16) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.WebPlayerView.ControlsView.onDraw(android.graphics.Canvas):void");
        }
    }
    ...
    public WebPlayerView(Context context, boolean z, boolean z2, WebPlayerViewDelegate webPlayerViewDelegate) {
        ...
        this.progressRunnable = new Runnable() { // from class: org.rbmain.ui.Components.WebPlayerView.1
            @Override // java.lang.Runnable
            public void run() {
        ...
        this.surfaceTextureListener = new TextureView.SurfaceTextureListener() { // from class: org.rbmain.ui.Components.WebPlayerView.2
            ...
            /* renamed from: org.rbmain.ui.Components.WebPlayerView$2$1, reason: invalid class name */
            class AnonymousClass1 implements ViewTreeObserver.OnPreDrawListener {
                ...
                public boolean onPreDraw() {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.WebPlayerView$2$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        this.switchToInlineRunnable = new Runnable() { // from class: org.rbmain.ui.Components.WebPlayerView.3
            @Override // java.lang.Runnable
            public void run() {
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(context) { // from class: org.rbmain.ui.Components.WebPlayerView.4
        ...
        webView.addJavascriptInterface(new JavaScriptInterface(new CallJavaResultInterface() { // from class: org.rbmain.ui.Components.WebPlayerView$$ExternalSyntheticLambda5
            @Override // org.rbmain.ui.Components.WebPlayerView.CallJavaResultInterface
        ...
        this.fullscreenButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.WebPlayerView$$ExternalSyntheticLambda0
        ...
        this.playButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.WebPlayerView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (z) {
            ...
            this.inlineButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.WebPlayerView$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        if (z2) {
            ...
            this.shareButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.WebPlayerView$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public void onAudioFocusChange(final int i) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.WebPlayerView$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void preparePlayer() {
        ...
        if (this.seekToTime != -1) {
            this.videoPlayer.seekTo(r0 * CloseCodes.NORMAL_CLOSURE);
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean loadVideo(java.lang.String r27, org.rbmain.tgnet.TLRPC$Photo r28, java.lang.Object r29, java.lang.String r30, boolean r31) {
        /*
            Method dump skipped, instructions count: 617
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.WebPlayerView.loadVideo(java.lang.String, org.rbmain.tgnet.TLRPC$Photo, java.lang.Object, java.lang.String, boolean):boolean");
    }
    ...
    public void showProgress(boolean z, boolean z2) {
        if (z2) {
            ...
            this.progressAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.WebPlayerView.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
