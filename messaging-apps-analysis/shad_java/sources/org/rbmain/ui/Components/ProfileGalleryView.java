...
import org.rbmain.ui.Components.CircularViewPager;
...
public class ProfileGalleryView extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileGalleryView(Context context, ActionBar actionBar, RecyclerListView recyclerListView, Callback callback) throws Resources.NotFoundException {
        ...
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: org.rbmain.ui.Components.ProfileGalleryView.1
    ...
    public ProfileGalleryView(Context context, long j, ActionBar actionBar, RecyclerListView recyclerListView, ProfileActivity.AvatarImageView avatarImageView, int i, Callback callback) throws Resources.NotFoundException {
        ...
        this.touchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        this.callback = callback;
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: org.rbmain.ui.Components.ProfileGalleryView.2
            @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
    ...
    public void setChatInfo(TLRPC$ChatFull tLRPC$ChatFull) {
        ...
        if (this.photos.isEmpty() || this.photos.get(0) != null || this.chatInfo == null || this.imagesLocations.size() <= 0 || this.imagesLocations.get(0) == null || !FileLoader.isSamePhoto(this.imagesLocations.get(0).location, this.chatInfo.chat_photo)) {
            return;
        }
        this.photos.set(0, this.chatInfo.chat_photo);
        if (!this.chatInfo.chat_photo.video_sizes.isEmpty()) {
            TLRPC$VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(this.chatInfo.chat_photo.video_sizes, CloseCodes.NORMAL_CLOSURE);
    ...
    public void addImage(ImageLocation imageLocation, ImageLocation imageLocation2) {
        this.prevImageLocation = imageLocation;
        this.thumbsFileNames.add(0, null);
        this.videoFileNames.add(0, null);
        this.imagesLocations.add(0, imageLocation);
        ...
        this.vectorAvatars.add(0, null);
        this.photos.add(0, null);
        this.imagesLocationsSizes.add(0, 0);
        this.imagesUploadProgress.add(0, null);
        this.adapter.notifyDataSetChanged();
        resetCurrentItem();
    }
    ...
    public void replaceFirstPhoto(TLRPC$Photo tLRPC$Photo, TLRPC$Photo tLRPC$Photo2) {
        int iIndexOf;
        if (!this.photos.isEmpty() && (iIndexOf = this.photos.indexOf(tLRPC$Photo)) >= 0) {
            this.photos.set(iIndexOf, tLRPC$Photo2);
        }
    }
    ...
    */
    public void didReceivedNotification(int r16, int r17, java.lang.Object... r18) {
        /*
            Method dump skipped, instructions count: 813
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.ProfileGalleryView.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public class ViewPagerAdapter extends CircularViewPager.Adapter {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public org.rbmain.ui.Components.ProfileGalleryView.Item instantiateItem(android.view.ViewGroup r27, int r28) {
            /*
                Method dump skipped, instructions count: 946
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.ProfileGalleryView.ViewPagerAdapter.instantiateItem(android.view.ViewGroup, int):org.rbmain.ui.Components.ProfileGalleryView$Item");
        }
        ...
        @Override // org.rbmain.ui.Components.CircularViewPager.Adapter
            ...
            if (pinchToZoomHelper == null || !pinchToZoomHelper.isInOverlayMode()) {
                if (this.radialProgress != null) {
                    ...
                    if (!(realPosition >= ProfileGalleryView.this.imagesUploadProgress.size() || ProfileGalleryView.this.imagesUploadProgress.get(realPosition) == null ? !(drawable == null || (this.isVideo && (!(drawable instanceof AnimatedFileDrawable) || ((AnimatedFileDrawable) drawable).getDurationMs() <= 0))) : ((Float) ProfileGalleryView.this.imagesUploadProgress.get(realPosition)).floatValue() >= 1.0f)) {
                        ...
                        this.radialProgressHideAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.ProfileGalleryView$AvatarImageView$$ExternalSyntheticLambda0
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                this.f$0.lambda$onDraw$0(valueAnimator);
                            }
                        });
                        this.radialProgressHideAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.ProfileGalleryView.AvatarImageView.1
