...
public class HintView extends FrameLayout {
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, Object obj, int i, int i2, boolean z) {
        ...
        if (i6 == 0) {
            ...
            iDp = (int) (i5 + photoImage.getImageY());
            int imageHeight = (int) photoImage.getImageHeight();
            int i7 = iDp + imageHeight;
            int measuredHeight = view.getMeasuredHeight();
            if (iDp <= getMeasuredHeight() + AndroidUtilities.dp(10.0f) || i7 > measuredHeight + (imageHeight / 4)) {
                return false;
            }
            ...
            measure(View.MeasureSpec.makeMeasureSpec(CloseCodes.NORMAL_CLOSURE, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(CloseCodes.NORMAL_CLOSURE, Integer.MIN_VALUE));
            ...
            if (currentUser != null && currentUser.id == 0) {
                iDp = i5 + ((chatMessageCell.getMeasuredHeight() - Math.max(0, chatMessageCell.getBottom() - view.getMeasuredHeight())) - AndroidUtilities.dp(50.0f));
            } else {
                iDp = i5 + AndroidUtilities.dp(22.0f);
                ...
                if (!messageObject.shouldDrawWithoutBackground() && chatMessageCell.isDrawTopic()) {
                    iDp = (int) (iDp + AndroidUtilities.dp(5.0f) + chatMessageCell.getDrawTopicHeight());
                }
            }
            if (!this.isTopArrow && iDp <= getMeasuredHeight() + AndroidUtilities.dp(10.0f)) {
                return false;
            }
        ...
        if (this.isTopArrow) {
            ...
            float measuredHeight2 = iDp - getMeasuredHeight();
        ...
        float left2 = ((chatMessageCell.getLeft() + forwardNameCenterX) - iDp2) - (this.arrowImageView.getMeasuredWidth() / 2);
    ...
    /* renamed from: org.rbmain.ui.Components.HintView$1, reason: invalid class name */
    class AnonymousClass1 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(HintView.this.hideRunnable = new Runnable() { // from class: org.rbmain.ui.Components.HintView$1$$ExternalSyntheticLambda0
    ...
    /* renamed from: org.rbmain.ui.Components.HintView$2, reason: invalid class name */
    class AnonymousClass2 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            HintView.this.animatorSet = null;
            AndroidUtilities.runOnUIThread(HintView.this.hideRunnable = new Runnable() { // from class: org.rbmain.ui.Components.HintView$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onAnimationEnd$0();
                }
    ...
    */
    private void updatePosition(android.view.View r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.HintView.updatePosition(android.view.View):void");
    }
    ...
    public void hide(boolean z) {
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.HintView.3
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
