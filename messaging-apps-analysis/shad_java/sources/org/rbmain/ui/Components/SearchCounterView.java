...
public class SearchCounterView extends View {
    ...
    public void setCount(String str, int i, boolean z) {
        ...
        if (str2 == null || !str2.equals(strReplaceAll)) {
            ValueAnimator valueAnimator = this.countAnimator;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            boolean z2 = (this.currentCount == 0 || i <= 0 || strReplaceAll == null || LocaleController.isRTL || TextUtils.isEmpty(str)) ? false : z;
            if (z2 && strReplaceAll != null && !strReplaceAll.contains("**")) {
                z2 = false;
            }
            if (!z2) {
                if (strReplaceAll != null) {
                    strReplaceAll = strReplaceAll.replaceAll("\\*\\*", BuildConfig.FLAVOR);
                }
                this.currentCount = i;
                if (strReplaceAll == null) {
                    this.countWidth = 0;
            ...
            if (z2) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.SearchCounterView$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        this.f$0.lambda$setCount$0(valueAnimator3);
                    }
                });
                this.countAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.SearchCounterView.1
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.countChangeProgress != 1.0f) {
            ...
            if (this.countAnimationInLayout != null) {
                ...
                float fDp = AndroidUtilities.dp(4.0f) + measuredHeight;
                ...
                float fDp2 = AndroidUtilities.dp(4.0f) + measuredHeight;
            ...
            if (this.countOldLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft, AndroidUtilities.dp(4.0f) + measuredHeight + ((z ? -AndroidUtilities.dp(13.0f) : AndroidUtilities.dp(13.0f)) * this.countChangeProgress));
            ...
            if (this.countAnimationStableLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft + (this.dx * (1.0f - this.countChangeProgress)), AndroidUtilities.dp(4.0f) + measuredHeight);
