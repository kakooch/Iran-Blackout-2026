...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat tLRPC$Chat, boolean z) throws NoSuchFieldException, Resources.NotFoundException {
        super(context, false);
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.rbmain.ui.Components.GroupCallRecordAlert.1
        ...
        this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: org.rbmain.ui.Components.GroupCallRecordAlert.2
        ...
        TextView textView3 = new TextView(getContext()) { // from class: org.rbmain.ui.Components.GroupCallRecordAlert.3
            ...
            */
            protected void onSizeChanged(int r26, int r27, int r28, int r29) {
                ...
                L77:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.GroupCallRecordAlert.AnonymousClass3.onSizeChanged(int, int, int, int):void");
            }
        ...
        this.positiveButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.GroupCallRecordAlert$$ExternalSyntheticLambda0
        ...
        while (true) {
            ...
            this.titles[i3].setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.GroupCallRecordAlert$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
    ...
    class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) throws SAXException, IOException {
            ImageView imageView = new ImageView(GroupCallRecordAlert.this.getContext()) { // from class: org.rbmain.ui.Components.GroupCallRecordAlert.Adapter.1
                @Override // android.view.View
            ...
            imageView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.GroupCallRecordAlert$Adapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
