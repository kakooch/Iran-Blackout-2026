...
import org.rbmain.ui.Components.SharingLocationsAlert;
...
public class FragmentContextView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public FragmentContextView(Context context, BaseFragment baseFragment, View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.rect = new RectF();
        this.updateScheduleTimeRunnable = new Runnable() { // from class: org.rbmain.ui.Components.FragmentContextView.1
            ...
            public void run() {
                ...
                if (i2 >= 86400) {
                    fullDuration = LocaleController.formatPluralString("Days", Math.round(i2 / 86400.0f));
                } else {
        ...
        this.checkLocationRunnable = new Runnable() { // from class: org.rbmain.ui.Components.FragmentContextView.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void checkCreateView() {
        ...
        BlurredFrameLayout blurredFrameLayout = new BlurredFrameLayout(context, this.fragment.getFragmentView() instanceof SizeNotifierFrameLayout ? (SizeNotifierFrameLayout) this.fragment.getFragmentView() : null) { // from class: org.rbmain.ui.Components.FragmentContextView.3
            ...
            @Override // org.rbmain.ui.Components.BlurredFrameLayout, android.view.ViewGroup, android.view.View
            protected void dispatchDraw(Canvas canvas) {
                ...
                FragmentContextView.this.rect.set(0.0f, 0.0f, iCeil, AndroidUtilities.dp(28.0f));
                canvas.save();
        ...
        this.playButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda2
        ...
        AudioPlayerAlert.ClippingTextViewSwitcher clippingTextViewSwitcher = new AudioPlayerAlert.ClippingTextViewSwitcher(context) { // from class: org.rbmain.ui.Components.FragmentContextView.4
        ...
        AudioPlayerAlert.ClippingTextViewSwitcher clippingTextViewSwitcher2 = new AudioPlayerAlert.ClippingTextViewSwitcher(context) { // from class: org.rbmain.ui.Components.FragmentContextView.5
            @Override // org.rbmain.ui.Components.AudioPlayerAlert.ClippingTextViewSwitcher
            protected TextView createTextView() {
                TextView textView = new TextView(context);
                textView.setMaxLines(1);
        ...
        TextView textView = new TextView(context) { // from class: org.rbmain.ui.Components.FragmentContextView.6
            @Override // android.view.View
        ...
        this.joinButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        this.silentButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        this.avatars.setDelegate(new Runnable() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
        ...
        this.muteDrawable = new RLottieDrawable(R.raw.voice_muted, "2131820684", AndroidUtilities.dp(16.0f), AndroidUtilities.dp(20.0f), true, null);
        ...
        this.muteButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        this.closeButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                this.f$0.lambda$checkCreateView$6(view3);
            }
        });
        setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
    ...
    /* renamed from: org.rbmain.ui.Components.FragmentContextView$7, reason: invalid class name */
    class AnonymousClass7 extends RLottieImageView {
        ...
        AnonymousClass7(Context context) {
            super(context);
            this.toggleMicRunnable = new Runnable() { // from class: org.rbmain.ui.Components.FragmentContextView$7$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$$0();
                }
            };
            this.pressRunnable = new Runnable() { // from class: org.rbmain.ui.Components.FragmentContextView$7$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$$1();
                }
    ...
    public /* synthetic */ void lambda$checkCreateView$6(View view) {
        if (this.currentStyle == 2) {
            ...
            builder.setPositiveButton(LocaleController.getString("Stop", R.string.Stop), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$checkCreateView$5(dialogInterface, i);
                }
            });
    ...
    public /* synthetic */ void lambda$checkCreateView$8(View view) {
        ...
        if (i == 0) {
            ...
            if (playingMessageObject.getDialogId() == (chatActivityInterface != null ? chatActivityInterface.getDialogId() : 0L)) {
                this.chatActivity.scrollToMessageId(playingMessageObject.getId(), 0L, false, 0, true, 0L);
                return;
            }
            ...
            if (DialogObject.isEncryptedDialog(dialogId2)) {
                ...
                bundle.putInt("user_id", (int) dialogId2);
            } else {
                bundle.putInt("chat_id", (int) (-dialogId2));
            }
            bundle.putLong("message_id", playingMessageObject.getId());
        ...
        if (i == 2) {
            ...
            if (dialogId != 0) {
                ...
                this.fragment.showDialog(new SharingLocationsAlert(getContext(), new SharingLocationsAlert.SharingLocationsAlertDelegate() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda15
                    @Override // org.rbmain.ui.Components.SharingLocationsAlert.SharingLocationsAlertDelegate
        ...
        if (i == 4) {
            ...
            TLRPC$Chat chat = this.fragment.getMessagesController().getChat(Integer.valueOf(groupCall.chatId));
            Activity parentActivity = this.fragment.getParentActivity();
            BaseFragment baseFragment = this.fragment;
            VoIPHelper.startCall(chat, null, null, false, parentActivity, baseFragment, baseFragment.getAccountInstance());
            return;
        }
        ...
        importingAlert.setOnHideListener(new DialogInterface.OnDismissListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda1
    ...
    private void createPlaybackSpeedButton() {
        ...
        this.playbackSpeedButton.setDelegate(new ActionBarMenuItem.ActionBarMenuItemDelegate() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda14
        ...
        this.speedSlider.setOnValueChange(new Utilities.Callback2() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda13
        ...
        this.playbackSpeedButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$createPlaybackSpeedButton$11(fArr, view);
            }
        });
        this.playbackSpeedButton.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda9
    ...
    public /* synthetic */ boolean lambda$createPlaybackSpeedButton$13(View view) {
        ...
        this.playbackSpeedButton.setOnMenuDismiss(new Utilities.Callback16() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda12
    ...
    private void showSpeedHint() {
        ...
        HintView hintView = new HintView(this, getContext(), 6, true) { // from class: org.rbmain.ui.Components.FragmentContextView.8
            @Override // android.view.View
    ...
    public void openSharingLocation(final LocationController.SharingLocationInfo sharingLocationInfo) {
        ...
        locationActivity.setDelegate(new LocationActivity.LocationActivityDelegate() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda16
            @Override // org.rbmain.ui.LocationActivity.LocationActivityDelegate
            public final void didSelectLocation(TLRPC$MessageMedia tLRPC$MessageMedia, int i, boolean z, int i2) {
                FragmentContextView.lambda$openSharingLocation$14(sharingLocationInfo, dialogId, tLRPC$MessageMedia, i, z, i2);
            }
        });
        launchActivity.lambda$runLinkRequest$40(locationActivity);
    }
    ...
    */
    private void checkVisibility() {
        /*
            r7 = this;
            boolean r0 = r7.isLocation
            r1 = 0
            r2 = 1
            if (r0 == 0) goto L28
            org.rbmain.ui.ActionBar.BaseFragment r0 = r7.fragment
            boolean r3 = r0 instanceof org.rbmain.ui.DialogsActivity
            if (r3 == 0) goto L14
            int r0 = org.rbmain.messenger.LocationController.getLocationsCount()
            if (r0 == 0) goto La0
            goto La1
        L14:
            int r0 = r0.getCurrentAccount()
            org.rbmain.messenger.LocationController r0 = org.rbmain.messenger.LocationController.getInstance(r0)
            org.rbmain.ui.Components.ChatActivityInterface r2 = r7.chatActivity
            long r2 = r2.getDialogId()
            boolean r2 = r0.isSharingLocation(r2)
            goto La1
        L28:
            org.rbmain.messenger.voip.VoIPService r0 = org.rbmain.messenger.voip.VoIPService.getSharedInstance()
            if (r0 == 0) goto L48
            org.rbmain.messenger.voip.VoIPService r0 = org.rbmain.messenger.voip.VoIPService.getSharedInstance()
            ...
            r3 = 15
            if (r0 == r3) goto L48
            r7.startJoinFlickerAnimation()
            goto La1
        L48:
            org.rbmain.ui.Components.ChatActivityInterface r0 = r7.chatActivity
            if (r0 == 0) goto L65
            org.rbmain.ui.ActionBar.BaseFragment r0 = r7.fragment
            org.rbmain.messenger.SendMessagesHelper r0 = r0.getSendMessagesHelper()
            org.rbmain.ui.Components.ChatActivityInterface r3 = r7.chatActivity
            long r3 = r3.getDialogId()
            org.rbmain.messenger.SendMessagesHelper$ImportingHistory r0 = r0.getImportingHistory(r3)
            if (r0 == 0) goto L65
            boolean r0 = r7.isPlayingVoice()
            if (r0 != 0) goto L65
            goto La1
        L65:
            org.rbmain.ui.Components.ChatActivityInterface r0 = r7.chatActivity
            if (r0 == 0) goto L8b
            org.rbmain.messenger.ChatObject$Call r0 = r0.getGroupCall()
            if (r0 == 0) goto L8b
            org.rbmain.ui.Components.ChatActivityInterface r0 = r7.chatActivity
            org.rbmain.messenger.ChatObject$Call r0 = r0.getGroupCall()
            boolean r0 = r0.shouldShowPanel()
            if (r0 == 0) goto L8b
            boolean r0 = org.rbmain.ui.Components.GroupCallPip.isShowing()
            if (r0 != 0) goto L8b
            boolean r0 = r7.isPlayingVoice()
            if (r0 != 0) goto L8b
            r7.startJoinFlickerAnimation()
        ...
        Lab:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.FragmentContextView.checkVisibility():void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:16:0x003f A[PHI: r11
      0x003f: PHI (r11v9 java.lang.String) = (r11v2 java.lang.String), (r11v14 java.lang.String) binds: [B:31:0x0093, B:14:0x003c] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private void playbackSpeedChanged(boolean r11, float r12, float r13) {
        /*
            r10 = this;
            boolean r0 = r10.equals(r12, r13)
            if (r0 == 0) goto L7
            return
        L7:
            ...
            return
        L23:
            r11 = 2131886798(0x7f1202ce, float:1.9408185E38)
            java.lang.String r0 = "AudioSpeedNormal"
            java.lang.String r11 = org.rbmain.messenger.LocaleController.getString(r0, r11)
            float r0 = r12 - r4
        ...
        L43:
            ...
            if (r11 == 0) goto L6a
            boolean r9 = r10.equals(r13, r8)
            if (r9 == 0) goto L6a
            boolean r9 = r10.equals(r12, r0)
            if (r9 == 0) goto L6a
            java.lang.Object[] r11 = new java.lang.Object[r5]
            java.lang.String r12 = org.rbmain.ui.Components.SpeedIconDrawable.formatNumber(r13)
            r11[r1] = r12
            java.lang.String r11 = org.rbmain.messenger.LocaleController.formatString(r7, r6, r11)
            r2 = 2131820649(0x7f110069, float:1.9274019E38)
            goto L95
        L6a:
            if (r11 == 0) goto L85
            boolean r11 = r10.equals(r13, r4)
            if (r11 == 0) goto L85
            boolean r11 = r10.equals(r12, r8)
            if (r11 == 0) goto L85
            r11 = 2131886796(0x7f1202cc, float:1.940818E38)
            java.lang.String r12 = "AudioSpeedFast"
            java.lang.String r11 = org.rbmain.messenger.LocaleController.getString(r12, r11)
        ...
        L85:
            ...
            if (r12 >= 0) goto L3f
        L95:
            org.rbmain.ui.ActionBar.BaseFragment r12 = r10.fragment
            org.rbmain.ui.Components.BulletinFactory r12 = org.rbmain.ui.Components.BulletinFactory.of(r12)
            org.rbmain.ui.Components.Bulletin r11 = r12.createSimpleBulletin(r2, r11)
            r11.show()
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.FragmentContextView.playbackSpeedChanged(boolean, float, float):void");
    }
    ...
    private void checkLiveLocation(boolean z) {
        ...
        if (!zIsSharingLocation) {
            ...
            if (this.visible) {
                ...
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.FragmentContextView.9
        ...
        if (!this.visible) {
            if (!z) {
                ...
                this.animatorSet.setDuration(200L);
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.FragmentContextView.10
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        if (FragmentContextView.this.animatorSet == null || !FragmentContextView.this.animatorSet.equals(animator)) {
                            return;
        ...
        if (this.fragment instanceof DialogsActivity) {
            ...
            if (arrayList.size() == 1) {
                ...
                if (DialogObject.isUserDialog(dialogId)) {
                    ...
                    pluralString = chat != null ? chat.title : BuildConfig.FLAVOR;
            ...
            spannableStringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM), 0, getThemedColor(Theme.key_inappPlayerPerformer)), iIndexOf, string2.length() + iIndexOf, 18);
    ...
    public void checkLocationString() {
        ...
        if (iIndexOf >= 0) {
            spannableStringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM), 0, getThemedColor(Theme.key_inappPlayerPerformer)), iIndexOf, string.length() + iIndexOf, 18);
        }
        this.titleTextView.setText(spannableStringBuilder, false);
    }
    ...
    public void checkPlayer(boolean z) {
        ...
        if (playingMessageObject == null || playingMessageObject.getId() == 0 || playingMessageObject.isVideo()) {
            ...
            if (this.visible) {
                ...
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.FragmentContextView.11
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
        ...
        if (!this.visible) {
            if (!z) {
                ...
                this.animatorSet.setDuration(200L);
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.FragmentContextView.12
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        FragmentContextView.this.notificationsLocker.unlock();
                        if (FragmentContextView.this.animatorSet == null || !FragmentContextView.this.animatorSet.equals(animator)) {
        ...
        if (this.chatActivity != null) {
            ...
            if (importingHistory == null) {
                if (this.visible && ((z && this.currentStyle == -1) || this.currentStyle == 5)) {
                    ...
                    this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.FragmentContextView.13
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                            FragmentContextView.this.notificationsLocker.unlock();
                            if (FragmentContextView.this.animatorSet == null || !FragmentContextView.this.animatorSet.equals(animator)) {
            ...
            if (!this.visible) {
                if (!z) {
                    ...
                    this.animatorSet.playTogether(ObjectAnimator.ofFloat(this, "topPadding", AndroidUtilities.dp2(getStyleHeight())));
                    this.animatorSet.setDuration(200L);
                    this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.FragmentContextView.14
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                            FragmentContextView.this.notificationsLocker.unlock();
                            if (FragmentContextView.this.animatorSet == null || !FragmentContextView.this.animatorSet.equals(animator)) {
    ...
    */
    public void checkCall(boolean r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.FragmentContextView.checkCall(boolean):void");
    }
    ...
    public void startJoinFlickerAnimation() {
        ...
        if (cellFlickerDrawable != null && cellFlickerDrawable.getProgress() >= 1.0f) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.FragmentContextView$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void updateAvatars(boolean z) {
        ...
        if (avatarsImageView.avatarsDrawable.transitionProgressAnimator == null) {
            ...
            int i4 = iMin != 0 ? 10 + ((iMin - 1) * 24) + 10 + 32 : 10;
            if (z) {
                int i5 = ((FrameLayout.LayoutParams) this.titleTextView.getLayoutParams()).leftMargin;
                if (AndroidUtilities.dp(i4) != i5) {
                    float translationX = (this.titleTextView.getTranslationX() + i5) - AndroidUtilities.dp(r3);
            ...
            if (i == 1 || i == 3) {
                ...
                if (sharedInstance.getChat() != null) {
                    ...
                    if (chatActivityInterface != null && chatActivityInterface.getCurrentChat() != null && this.chatActivity.getCurrentChat().id == sharedInstance.getChat().id) {
                        if (ChatObject.isChannelOrGiga(this.chatActivity.getCurrentChat())) {
