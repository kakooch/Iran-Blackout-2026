...
public class BlurBehindDrawable {
    ...
    */
    public void draw(android.graphics.Canvas r15) throws java.lang.InterruptedException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.BlurBehindDrawable.draw(android.graphics.Canvas):void");
    }
    ...
    public void clear() throws InterruptedException {
        ...
        if (dispatchQueue != null) {
            ...
            this.queue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.BlurBehindDrawable$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$clear$2() {
        ...
        this.skipDraw = false;
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.BlurBehindDrawable$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class BlurBackgroundTask implements Runnable {
        ...
        public void run() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.BlurBehindDrawable$BlurBackgroundTask$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
