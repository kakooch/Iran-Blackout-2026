...
public class ChecksHintView extends FrameLayout {
    ...
    public ChecksHintView(Context context) {
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(6.0f), Theme.getColor(Theme.key_chat_gifSaveHintBackground)));
        int i = 0;
        ...
        while (i < 2) {
            ...
            this.textView[i].setTextColor(Theme.getColor(Theme.key_chat_gifSaveHintText));
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, boolean z) {
        ...
        if (z) {
            ...
            while (i3 < 2) {
                this.textView[i3].animate().scaleX(1.04f).scaleY(1.04f).setInterpolator(CubicBezierInterpolator.EASE_IN).setStartDelay((i3 == 0 ? 132 : HttpStatus.HTTP_INTERNAL_SERVER_ERROR) + 140).setDuration(100L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.ChecksHintView.2
    ...
    /* renamed from: org.rbmain.ui.Components.ChecksHintView$1, reason: invalid class name */
    class AnonymousClass1 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(ChecksHintView.this.hideRunnable = new Runnable() { // from class: org.rbmain.ui.Components.ChecksHintView$1$$ExternalSyntheticLambda0
    ...
    public void hide() {
        ...
        this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.ChecksHintView.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
