...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        public GroupCallUserCell(Context context) {
            ...
            RLottieImageView rLottieImageView = new RLottieImageView(context, GroupCallFullscreenAdapter.this) { // from class: org.rbmain.ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.1
        ...
        public void setParticipant(ChatObject.VideoParticipant videoParticipant, TLRPC$TL_groupCallParticipant tLRPC$TL_groupCallParticipant) {
            ...
            if (videoParticipant == null) {
                this.selected = GroupCallFullscreenAdapter.this.renderersContainer.fullscreenPeerId == ((long) MessageObject.getPeerId(tLRPC$TL_groupCallParticipant.peer));
        ...
        */
        private void drawSelection(android.graphics.Canvas r7) {
            ...
            L34:
                ...
                float r3 = r3 - r2
                float r0 = r0 * r3
                android.graphics.RectF r2 = org.rbmain.messenger.AndroidUtilities.rectTmp
            ...
            L7a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.drawSelection(android.graphics.Canvas):void");
        }
        ...
        */
        public void updateState(boolean r10) {
            ...
            L18:
                ...
                goto L16
            L27:
                int r0 = org.rbmain.ui.ActionBar.Theme.key_voipgroup_nameText
                int r0 = org.rbmain.ui.ActionBar.Theme.getColor(r0)
                int r1 = org.rbmain.ui.ActionBar.Theme.key_voipgroup_listeningText
            ...
            L41:
                ...
                org.rbmain.ui.Components.RLottieImageView r10 = r9.muteButton
                ...
                r10.setColor(r1)
                org.rbmain.ui.Cells.GroupCallUserCell$AvatarWavesDrawable r10 = r9.avatarWavesDrawable
                r0 = 38
            ...
            L6c:
                ...
                org.rbmain.ui.Components.GroupCallFullscreenAdapter$GroupCallUserCell$$ExternalSyntheticLambda0 r8 = new org.rbmain.ui.Components.GroupCallFullscreenAdapter$GroupCallUserCell$$ExternalSyntheticLambda0
                r2 = r8
                r3 = r9
                r5 = r0
                r7 = r1
                ...
                android.animation.ValueAnimator r10 = r9.colorAnimator
                org.rbmain.ui.Components.GroupCallFullscreenAdapter$GroupCallUserCell$2 r2 = new org.rbmain.ui.Components.GroupCallFullscreenAdapter$GroupCallUserCell$2
                r2.<init>()
                r10.addListener(r2)
                android.animation.ValueAnimator r10 = r9.colorAnimator
                r10.start()
            L97:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.updateState(boolean):void");
        }
    ...
    public void update(boolean z, RecyclerListView recyclerListView) {
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.rbmain.ui.Components.GroupCallFullscreenAdapter.1
