...
public class AnimatedEmojiDrawable extends Drawable {
    ...
    public static AnimatedEmojiDrawable make(int i, int i2, long j, String str) {
        ...
        int iHashCode = Arrays.hashCode(new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
        LongSparseArray<AnimatedEmojiDrawable> longSparseArray = globalEmojiCache.get(iHashCode);
        if (longSparseArray == null) {
            ...
            sparseArray.put(iHashCode, longSparseArray2);
    ...
    public static class EmojiDocumentFetcher {
        ...
        public void fetchDocument(long j, ReceivedDocument receivedDocument) {
            ...
            synchronized (this) {
                ...
                if (map != null && (tLRPC$Document = map.get(Long.valueOf(j))) != null) {
                ...
                if (checkThread()) {
                    ...
                    Runnable runnable = new Runnable() { // from class: org.rbmain.ui.Components.AnimatedEmojiDrawable$EmojiDocumentFetcher$$ExternalSyntheticLambda0
    ...
    public AnimatedEmojiDrawable(int i, int i2, long j) {
        ...
        updateSize();
        this.documentId = j;
        getDocumentFetcher(i2).fetchDocument(j, new ReceivedDocument() { // from class: org.rbmain.ui.Components.AnimatedEmojiDrawable$$ExternalSyntheticLambda1
    ...
    public AnimatedEmojiDrawable(int i, int i2, long j, String str) {
        ...
        getDocumentFetcher(i2).fetchDocument(j, new ReceivedDocument() { // from class: org.rbmain.ui.Components.AnimatedEmojiDrawable$$ExternalSyntheticLambda0
            @Override // org.rbmain.ui.Components.AnimatedEmojiDrawable.ReceivedDocument
            public final void run(TLRPC$Document tLRPC$Document) {
                this.f$0.lambda$new$1(tLRPC$Document);
            }
        });
    }
    ...
    /* JADX WARN: Type inference failed for: r1v17, types: [org.rbmain.messenger.ImageReceiver] */
    /* JADX WARN: Type inference failed for: r1v18, types: [org.rbmain.messenger.ImageReceiver] */
    /* JADX WARN: Type inference failed for: r1v19, types: [org.rbmain.messenger.ImageReceiver] */
    /* JADX WARN: Type inference failed for: r1v21, types: [org.rbmain.messenger.ImageReceiver] */
    /* JADX WARN: Type inference failed for: r1v22, types: [org.rbmain.messenger.ImageReceiver] */
    ...
    /* JADX WARN: Type inference failed for: r3v11, types: [org.rbmain.messenger.SvgHelper$SvgDrawable] */
    /* JADX WARN: Type inference failed for: r4v2, types: [org.rbmain.messenger.SvgHelper$SvgDrawable] */
    private void initDocument(boolean z) {
        ...
        if (this.document != null) {
            ...
            if (imageReceiver == null || z) {
                if (imageReceiver == null) {
                    ImageReceiver imageReceiver2 = new ImageReceiver() { // from class: org.rbmain.ui.Components.AnimatedEmojiDrawable.1
                ...
                if ("video/webm".equals(this.document.mime_type)) {
                    ...
                    if (SharedConfig.getDevicePerformanceClass() != 0 || this.cacheType == 2 || !ImageLoader.getInstance().hasLottieMemCache(string)) {
                        ?? svgThumb2 = DocumentObject.getSvgThumb(this.document.thumbs, Theme.key_windowBackgroundWhiteGrayIcon, 0.2f);
                        if (svgThumb2 != 0 && MessageObject.isAnimatedStickerDocument(this.document, true)) {
                            svgThumb2.overrideWidthAndHeight(512, 512);
                        }
                        forDocument = svgThumb2;
                    }
                    svgThumb = forDocument;
                    forDocument = ImageLocation.getForDocument(this.document);
                } else {
                    ?? svgThumb3 = DocumentObject.getSvgThumb(this.document.thumbs, Theme.key_windowBackgroundWhiteGrayIcon, 0.2f);
                    svgThumb = svgThumb3;
                    if (svgThumb3 != 0) {
                        svgThumb = svgThumb3;
                        if (MessageObject.isAnimatedStickerDocument(this.document, true)) {
                            svgThumb3.overrideWidthAndHeight(512, 512);
                            svgThumb = svgThumb3;
                        }
                    }
                }
                if (this.absolutePath != null) {
                    ...
                    if (i5 == 8) {
                        this.imageReceiver.setImage(null, null, forDocument, str2, null, null, svgThumb, r3.size, null, this.document, 1);
                    } else if (z2 || (!liteModeKeyboard && i5 != 14)) {
                        if ("video/webm".equals(this.document.mime_type)) {
                            this.imageReceiver.setImage(null, null, ImageLocation.getForDocument(closestPhotoSizeWithSize, this.document), this.sizedp + "_" + this.sizedp, null, null, svgThumb, r3.size, null, this.document, 1);
                        } else if (MessageObject.isAnimatedStickerDocument(this.document, true)) {
                            this.imageReceiver.setImage(forDocument, str2 + "_firstframe", null, null, svgThumb, r3.size, null, this.document, 1);
                        } else {
                            this.imageReceiver.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize, this.document), this.sizedp + "_" + this.sizedp, null, null, svgThumb, r3.size, null, this.document, 1);
                        }
                    } else {
                        this.imageReceiver.setImage(forDocument, str2, ImageLocation.getForDocument(closestPhotoSizeWithSize, this.document), this.sizedp + "_" + this.sizedp, null, null, svgThumb, r3.size, null, this.document, 1);
                    }
                }
    ...
    public boolean canOverrideColor() {
        ...
        Boolean boolValueOf = Boolean.valueOf(isDefaultStatusEmoji() || MessageObject.isTextColorEmoji(this.document));
        this.canOverrideColorCached = boolValueOf;
    ...
    */
    public boolean isDefaultStatusEmoji() {
        /*
            ...
            return r0
        L9:
            org.rbmain.tgnet.TLRPC$Document r0 = r6.document
            r1 = 0
            if (r0 == 0) goto L3a
            org.rbmain.tgnet.TLRPC$InputStickerSet r0 = org.rbmain.messenger.MessageObject.getInputStickerSet(r0)
            boolean r2 = r0 instanceof org.rbmain.tgnet.TLRPC$TL_inputStickerSetEmojiDefaultStatuses
            if (r2 != 0) goto L2e
            boolean r2 = r0 instanceof org.rbmain.tgnet.TLRPC$TL_inputStickerSetID
            if (r2 == 0) goto L2f
            long r2 = r0.id
        ...
        L3a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.AnimatedEmojiDrawable.isDefaultStatusEmoji():boolean");
    }
