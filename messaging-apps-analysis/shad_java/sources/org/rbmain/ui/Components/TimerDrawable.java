...
public class TimerDrawable extends Drawable {
    ...
    public TimerDrawable(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.timePaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.isDialog) {
            ...
            double d = i;
            Double.isNaN(d);
            canvas.translate((float) ((dWidth - dCeil) + d), (getBounds().height() - this.timeHeight) / 2.0f);
            this.timeLayout.draw(canvas);
            return;
        }
        double dCeil2 = Math.ceil(this.timeWidth / 2.0f);
        Double.isNaN(intrinsicWidth / 2);
        canvas.translate(((int) (r5 - dCeil2)) + i, (intrinsicHeight - this.timeHeight) / 2.0f);
        this.timeLayout.draw(canvas);
    }
