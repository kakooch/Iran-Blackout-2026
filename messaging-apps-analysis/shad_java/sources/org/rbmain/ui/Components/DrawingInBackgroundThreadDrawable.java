...
public class DrawingInBackgroundThreadDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final Runnable bitmapCreateTask = new Runnable() { // from class: org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable.1
        /* JADX WARN: Removed duplicated region for block: B:8:0x001d A[Catch: Exception -> 0x0068, TryCatch #0 {Exception -> 0x0068, blocks: (B:2:0x0000, B:4:0x000b, B:6:0x0015, B:12:0x003f, B:8:0x001d, B:10:0x0023, B:11:0x0026), top: B:18:0x0000 }] */
        ...
        */
        public void run() {
            /*
                r4 = this;
                org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable r0 = org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable.this     // Catch: java.lang.Exception -> L68
                ...
                org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable r2 = org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable.this     // Catch: java.lang.Exception -> L68
            ...
            L68:
                ...
                org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable r0 = org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable.this
                r1 = 1
                r0.error = r1
            L71:
                org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable r0 = org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable.this
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable.AnonymousClass1.run():void");
        }
    };
    Runnable uiFrameRunnable = new Runnable() { // from class: org.rbmain.ui.Components.DrawingInBackgroundThreadDrawable.2
        @Override // java.lang.Runnable
        public void run() {
