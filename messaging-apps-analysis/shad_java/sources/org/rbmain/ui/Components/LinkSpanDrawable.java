...
public class LinkSpanDrawable<S extends CharacterStyle> {
    ...
    public LinkSpanDrawable(S s, Theme.ResourcesProvider resourcesProvider, float f, float f2, boolean z) {
        ...
        setColor(Theme.getColor(i, resourcesProvider));
        setColor(Theme.getColor(i));
        this.mTouchX = f;
        this.mTouchY = f2;
    ...
    public static class LinkCollector {
        ...
        public void removeLink(final LinkSpanDrawable linkSpanDrawable, boolean z) {
            ...
            if (linkSpanDrawable.mReleaseStart < 0) {
                ...
                invalidate(pair.second);
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.LinkSpanDrawable$LinkCollector$$ExternalSyntheticLambda0
        ...
        private void removeLink(int i, boolean z) {
            ...
            if (z) {
                ...
                if (linkSpanDrawable.mReleaseStart < 0) {
                    linkSpanDrawable.release();
                    invalidate(pair.second);
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.LinkSpanDrawable$LinkCollector$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            if (this.links != null) {
                ...
                if (clickableSpanHit != null && motionEvent.getAction() == 0) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.LinkSpanDrawable$LinksTextView$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
