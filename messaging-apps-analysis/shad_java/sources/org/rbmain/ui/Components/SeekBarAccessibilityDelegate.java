...
public abstract class SeekBarAccessibilityDelegate extends View.AccessibilityDelegate {
    ...
    private final View.OnAttachStateChangeListener onAttachStateChangeListener = new View.OnAttachStateChangeListener() { // from class: org.rbmain.ui.Components.SeekBarAccessibilityDelegate.1
    ...
    private void postAccessibilityEventRunnable(final View view) {
        if (ViewCompat.isAttachedToWindow(view)) {
            ...
            if (runnable == null) {
                ...
                Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.Components.SeekBarAccessibilityDelegate$$ExternalSyntheticLambda0
