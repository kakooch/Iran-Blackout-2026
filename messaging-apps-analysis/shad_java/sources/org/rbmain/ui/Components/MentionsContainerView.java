...
import org.rbmain.ui.Adapters.PaddedListAdapter;
...
public class MentionsContainerView extends BlurredFrameLayout {
    ...
    public MentionsContainerView(Context context, long j, long j2, final ChatActivity chatActivity, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.shown = false;
        this.updateVisibilityRunnable = new Runnable() { // from class: org.rbmain.ui.Components.MentionsContainerView$$ExternalSyntheticLambda3
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context) { // from class: org.rbmain.ui.Components.MentionsContainerView.1
        ...
        ExtendedGridLayoutManager extendedGridLayoutManager = new ExtendedGridLayoutManager(context, 100, false, false) { // from class: org.rbmain.ui.Components.MentionsContainerView.2
            ...
            protected Size getSizeForItem(int i) {
                ...
                if (i != 0) {
                    ...
                    if (MentionsContainerView.this.adapter.getBotContextSwitch() == null) {
                        MentionsContainerView.this.adapter.getBotWebViewSwitch();
                    } else {
                        i2++;
                    }
                    Size size = this.size;
        ...
        extendedGridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.rbmain.ui.Components.MentionsContainerView.3
        ...
        MentionsAdapter mentionsAdapter = new MentionsAdapter(context, false, j, j2, new MentionsAdapter.MentionsAdapterDelegate() { // from class: org.rbmain.ui.Components.MentionsContainerView.4
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if ((this.adapter.isStickers() || this.adapter.isBotContext()) && this.adapter.isMediaLayout() && this.adapter.getBotContextSwitch() == null) {
            this.adapter.getBotWebViewSwitch();
            z = true;
        } else {
            z = false;
        }
        ...
        if (zIsReversed) {
            float fMin2 = Math.min(Math.max(0.0f, (this.paddedAdapter.paddingViewAttached ? r4.paddingView.getTop() : getHeight()) + this.listView.getTranslationY()) + this.containerPadding, (1.0f - this.hideT) * getHeight());
            ...
            float fMax = Math.max(0.0f, (this.paddedAdapter.paddingViewAttached ? r4.paddingView.getBottom() : 0) + this.listView.getTranslationY()) - this.containerPadding;
    ...
    private void updateListViewTranslation(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            if (translationY == f2) {
                ...
                Integer numValueOf = Integer.valueOf(z ? 8 : 0);
                ...
                spring.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() { // from class: org.rbmain.ui.Components.MentionsContainerView$$ExternalSyntheticLambda2
                ...
                if (z) {
                    this.listViewTranslationAnimator.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: org.rbmain.ui.Components.MentionsContainerView$$ExternalSyntheticLambda0
                ...
                this.listViewTranslationAnimator.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: org.rbmain.ui.Components.MentionsContainerView$$ExternalSyntheticLambda1
                    @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationEndListener
                    public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z3, float f5, float f6) {
    ...
    public class MentionsListView extends RecyclerListView {
        ...
        public MentionsListView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setOnScrollListener(new RecyclerView.OnScrollListener(MentionsContainerView.this) { // from class: org.rbmain.ui.Components.MentionsContainerView.MentionsListView.1
            ...
            addItemDecoration(new RecyclerView.ItemDecoration(MentionsContainerView.this) { // from class: org.rbmain.ui.Components.MentionsContainerView.MentionsListView.2
