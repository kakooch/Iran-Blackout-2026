...
public class ChatAttachAlertAudioLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatAttachAlertAudioLayout(ChatAttachAlert chatAttachAlert, Context context) {
        ...
        SearchField searchField = new SearchField(context) { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.1
        ...
        this.emptyView.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda0
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.2
        ...
        FillLastLinearLayoutManager fillLastLinearLayoutManager = new FillLastLinearLayoutManager(getContext(), 1, false, AndroidUtilities.dp(9.0f), this.listView) { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.3
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i2) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.3.1
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda3
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i2) {
                this.f$0.lambda$new$1(view, i2);
            }
        });
        this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda4
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemLongClickListener
            public final boolean onItemClick(View view, int i2) {
                return this.f$0.lambda$new$2(view, i2);
            }
        });
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.4
    ...
    */
    void onPreMeasure(int r4, int r5) {
        ...
        L53:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.onPreMeasure(int, int):void");
    }
    ...
    private void runShadowAnimation(final boolean z) {
        ...
        this.shadowAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.5
    ...
    private void loadAudio() {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$loadAudio$4() {
        ...
        try {
            ...
            while (cursorQuery.moveToNext()) {
                try {
                    ...
                    int clientUserId = UserConfig.getInstance(this.parentAlert.currentAccount).getClientUserId();
                    ...
                    int i5 = audioEntry.duration;
                    tLRPC$TL_documentAttributeAudio.duration = i5;
                    if (i5 == 0 && (audioInfo = AudioInfo.getAudioInfo(new File(audioEntry.path))) != null) {
                        tLRPC$TL_documentAttributeAudio.duration = (int) Math.ceil(audioInfo.getDuration() / 1000.0f);
                    }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view;
            if (i == 0) {
                SharedAudioCell sharedAudioCell = new SharedAudioCell(this.mContext) { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.ListAdapter.1
    ...
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void search(final String str) {
            ...
            this.lastSearchId = i;
            Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$SearchAdapter$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$search$1(final String str, final int i) {
            ...
            Utilities.searchQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$SearchAdapter$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        private void updateSearchResults(final ArrayList<MediaController.AudioEntry> arrayList, final String str, final int i) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout$SearchAdapter$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view;
            if (i == 0) {
                SharedAudioCell sharedAudioCell = new SharedAudioCell(this.mContext) { // from class: org.rbmain.ui.Components.ChatAttachAlertAudioLayout.SearchAdapter.1
                    @Override // org.rbmain.ui.Cells.SharedAudioCell
                    public boolean needPlayMessage(MessageObject messageObject) {
                        ChatAttachAlertAudioLayout.this.playingAudio = messageObject;
                        ArrayList<MessageObject> arrayList = new ArrayList<>();
