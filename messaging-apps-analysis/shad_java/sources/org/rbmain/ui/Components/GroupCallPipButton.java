...
public class GroupCallPipButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public GroupCallPipButton(Context context, int i, boolean z) {
        ...
        this.bigMicDrawable = new RLottieDrawable(R.raw.voice_outlined, "2131820685", AndroidUtilities.dp(22.0f), AndroidUtilities.dp(30.0f), true, null);
    ...
    */
    protected void onDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.GroupCallPipButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setState(int i) {
        ...
        if (weavingState == null || weavingState.currentState != i) {
            ...
            String string = LocaleController.getString("VoipGroupVoiceChat", R.string.VoipGroupVoiceChat);
            if (i == 0) {
