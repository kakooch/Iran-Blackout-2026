...
public class SlotsDrawable extends RLottieDrawable {
    ...
    public SlotsDrawable(String str, int i, int i2) {
        ...
        this.loadFrameRunnable = new Runnable() { // from class: org.rbmain.ui.Components.SlotsDrawable$$ExternalSyntheticLambda6
    ...
    public boolean setBaseDice(final ChatMessageCell chatMessageCell, final TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        if (this.nativePtr == 0 && !this.loadingInBackground) {
            ...
            Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.SlotsDrawable$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$setBaseDice$5(tLRPC$TL_messages_stickerSet, i, messageObject, chatMessageCell);
                }
            });
        }
        return true;
    ...
    public /* synthetic */ void lambda$setBaseDice$5(final TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, final int i, final MessageObject messageObject, final ChatMessageCell chatMessageCell) {
        if (this.destroyAfterLoading) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.SlotsDrawable$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        while (true) {
            ...
            if (jArr[i2] == 0) {
                ...
                if (TextUtils.isEmpty(res)) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.SlotsDrawable$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        if (z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.SlotsDrawable$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.SlotsDrawable$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public boolean setDiceNumber(final ChatMessageCell chatMessageCell, int i, final TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, final boolean z) {
        if (this.secondNativePtr == 0 && !this.secondLoadingInBackground) {
            ...
            Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.SlotsDrawable$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$setDiceNumber$10(tLRPC$TL_messages_stickerSet, i2, messageObject, chatMessageCell, z);
                }
            });
        }
        return true;
    ...
    */
    public /* synthetic */ void lambda$setDiceNumber$10(final org.rbmain.tgnet.TLRPC$TL_messages_stickerSet r18, final int r19, final org.rbmain.messenger.MessageObject r20, final org.rbmain.ui.Cells.ChatMessageCell r21, final boolean r22) {
        /*
            Method dump skipped, instructions count: 295
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.SlotsDrawable.lambda$setDiceNumber$10(org.rbmain.tgnet.TLRPC$TL_messages_stickerSet, int, org.rbmain.messenger.MessageObject, org.rbmain.ui.Cells.ChatMessageCell, boolean):void");
    }
