...
public class GigagroupConvertAlert extends BottomSheet {
    ...
    public GigagroupConvertAlert(final Context context, final BaseFragment baseFragment) {
        ...
        while (true) {
            if (i < 3) {
                ...
                bottomSheetCell.background.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.GigagroupConvertAlert$$ExternalSyntheticLambda2
                ...
                textView3.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.GigagroupConvertAlert$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$new$1(Context context, BaseFragment baseFragment, View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("GigagroupConvertAlertConver", R.string.GigagroupConvertAlertConver), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Components.GigagroupConvertAlert$$ExternalSyntheticLambda0
