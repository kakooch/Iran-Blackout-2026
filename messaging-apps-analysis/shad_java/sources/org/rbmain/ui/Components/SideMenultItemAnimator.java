...
public class SideMenultItemAnimator extends SimpleItemAnimator {
    ...
    public SideMenultItemAnimator(RecyclerListView recyclerListView) {
        ...
        recyclerListView.setChildDrawingOrderCallback(new RecyclerView.ChildDrawingOrderCallback() { // from class: org.rbmain.ui.Components.SideMenultItemAnimator$$ExternalSyntheticLambda0
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder, int i) {
        final ViewPropertyAnimator viewPropertyAnimatorAnimate = viewHolder.itemView.animate();
        this.mRemoveAnimations.add(viewHolder);
        viewPropertyAnimatorAnimate.setDuration(220L).translationY(-i).setInterpolator(CubicBezierInterpolator.EASE_OUT).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.SideMenultItemAnimator.1
    ...
    void animateAddImpl(final RecyclerView.ViewHolder viewHolder, int i, int i2, int i3) {
        ...
        viewPropertyAnimatorAnimate.translationY(0.0f).setDuration(220L).setInterpolator(CubicBezierInterpolator.EASE_OUT).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.SideMenultItemAnimator.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        viewPropertyAnimatorAnimate.setDuration(220L).setInterpolator(CubicBezierInterpolator.EASE_OUT).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.SideMenultItemAnimator.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.SideMenultItemAnimator.4
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
        ...
        if (view2 != null) {
            ...
            viewPropertyAnimatorAnimate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.SideMenultItemAnimator.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
