...
public class VideoEditTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        FilterGLThread filterGLThread = new FilterGLThread(surfaceTexture, new FilterGLThread.FilterGLThreadVideoDelegate() { // from class: org.rbmain.ui.Components.VideoEditTextureView$$ExternalSyntheticLambda1
            @Override // org.rbmain.ui.Components.FilterGLThread.FilterGLThreadVideoDelegate
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        if (filterGLThread != null) {
            ...
            this.eglThread.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.VideoEditTextureView$$ExternalSyntheticLambda0
