...
public class ReactionTabHolderView extends FrameLayout {
    ...
    public void setCounter(int i, TLRPC$ReactionCount tLRPC$ReactionCount) {
        ...
        ReactionsLayoutInBubble.VisibleReaction visibleReactionFromTLReaction = ReactionsLayoutInBubble.VisibleReaction.fromTLReaction(tLRPC$ReactionCount.reaction);
        this.reaction = visibleReactionFromTLReaction;
        if (visibleReactionFromTLReaction.emojicon != null) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (visibleReaction != null) {
            ...
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", this.count));
        }
    }
}
