...
public class TableLayout extends View {
    ...
    static final Alignment UNDEFINED_ALIGNMENT = new Alignment() { // from class: org.rbmain.ui.Components.TableLayout.1
        @Override // org.rbmain.ui.Components.TableLayout.Alignment
        ...
        */
        public void measure(int r2, int r3, boolean r4) {
            /*
                ...
                r1.fixedHeight = r3
            L8:
                org.rbmain.tgnet.TLRPC$TL_pageTableCell r2 = r1.cell
                if (r2 == 0) goto Lb4
            ...
            L18:
                ...
                int r2 = r1.textHeight
                int r3 = r3 - r2
                org.rbmain.ui.Components.TableLayout r2 = org.rbmain.ui.Components.TableLayout.this
                int r2 = org.rbmain.ui.Components.TableLayout.access$100(r2)
                int r3 = r3 - r2
                r1.textY = r3
                goto L31
            L29:
                ...
                r1.textY = r2
            L31:
                org.rbmain.ui.ArticleViewer$DrawingText r2 = r1.textLayout
                if (r2 == 0) goto Lb4
            ...
            L4a:
                org.rbmain.ui.Components.TableLayout r2 = org.rbmain.ui.Components.TableLayout.this
                org.rbmain.ui.Components.TableLayout$TableLayoutDelegate r2 = org.rbmain.ui.Components.TableLayout.access$300(r2)
                org.rbmain.tgnet.TLRPC$TL_pageTableCell r3 = r1.cell
                int r4 = r1.measuredWidth
                org.rbmain.ui.Components.TableLayout r0 = org.rbmain.ui.Components.TableLayout.this
                int r0 = org.rbmain.ui.Components.TableLayout.access$200(r0)
                int r0 = r0 * 2
                int r4 = r4 - r0
                org.rbmain.ui.ArticleViewer$DrawingText r2 = r2.createTextLayout(r3, r4)
                r1.setTextLayout(r2)
                int r2 = r1.textHeight
                org.rbmain.ui.Components.TableLayout r3 = org.rbmain.ui.Components.TableLayout.this
                int r3 = org.rbmain.ui.Components.TableLayout.access$100(r3)
                int r3 = r3 * 2
                int r2 = r2 + r3
                r1.fixedHeight = r2
            L71:
                ...
                int r4 = r1.textWidth
                int r3 = r3 - r4
                org.rbmain.ui.Components.TableLayout r4 = org.rbmain.ui.Components.TableLayout.this
                int r4 = org.rbmain.ui.Components.TableLayout.access$200(r4)
                int r3 = r3 - r4
                int r2 = r2 + r3
                r1.textX = r2
                goto Lb4
            ...
            La2:
                org.rbmain.ui.Components.TableLayout r3 = org.rbmain.ui.Components.TableLayout.this
                int r3 = org.rbmain.ui.Components.TableLayout.access$200(r3)
                int r2 = r2 + r3
                r1.textX = r2
                goto Lb4
            Lac:
                org.rbmain.ui.Components.TableLayout r2 = org.rbmain.ui.Components.TableLayout.this
                int r2 = org.rbmain.ui.Components.TableLayout.access$200(r2)
                r1.textX = r2
            Lb4:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.TableLayout.Child.measure(int, int, boolean):void");
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i5 < childCount2) {
            ...
            Bounds value = this.mHorizontalAxis.getGroupBounds().getValue(i5);
            Bounds value2 = this.mVerticalAxis.getGroupBounds().getValue(i5);
            int gravityOffset = absoluteAlignment.getGravityOffset(childAt, i8 - value.size(z4));
            int gravityOffset2 = absoluteAlignment2.getGravityOffset(childAt, i9 - value2.size(z4));
            ...
            int i11 = iMax2;
            int offset = value.getOffset(this, childAt, absoluteAlignment, measurement + i10, true);
            ...
            int i13 = !this.isRtl ? margin + i12 : ((i4 - sizeInCell) - margin3) - i12;
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        ...
                        Point point = this.rowSpans.get(i15);
        ...
        while (i16 < size2) {
            ...
            if (!z) {
                ...
                while (true) {
                    ...
                    Child child3 = this.childrens.get(i19);
            ...
            if (!z) {
                ...
                for (int i22 = 0; i22 < size4; i22++) {
                    Child child4 = this.childrens.get(i22);
                    if (child != child4) {
    ...
    final class Axis {
        ...
        /* JADX WARN: Type inference failed for: r0v0, types: [org.rbmain.ui.Components.TableLayout$Axis$1] */
        private Arc[] topologicalSort(Arc[] arcArr) {
            return new Object(arcArr) { // from class: org.rbmain.ui.Components.TableLayout.Axis.1
                Arc[][] arcsByVertex;
                int cursor;
                Arc[] result;
    ...
    static {
        Alignment alignment = new Alignment() { // from class: org.rbmain.ui.Components.TableLayout.2
            @Override // org.rbmain.ui.Components.TableLayout.Alignment
            public int getAlignmentValue(Child child, int i) {
                return 0;
            }
        ...
        LEADING = alignment;
        Alignment alignment2 = new Alignment() { // from class: org.rbmain.ui.Components.TableLayout.3
            @Override // org.rbmain.ui.Components.TableLayout.Alignment
            public int getAlignmentValue(Child child, int i) {
                return i;
            }
        ...
        new Alignment() { // from class: org.rbmain.ui.Components.TableLayout.5
            @Override // org.rbmain.ui.Components.TableLayout.Alignment
            public int getAlignmentValue(Child child, int i) {
                return i >> 1;
            }
        ...
        BASELINE = new Alignment() { // from class: org.rbmain.ui.Components.TableLayout.6
            @Override // org.rbmain.ui.Components.TableLayout.Alignment
            public int getAlignmentValue(Child child, int i) {
                return Integer.MIN_VALUE;
            }
            ...
            public Bounds getBounds() {
                return new Bounds(this) { // from class: org.rbmain.ui.Components.TableLayout.6.1
                    private int size;

                    @Override // org.rbmain.ui.Components.TableLayout.Bounds
                    protected void reset() {
                        super.reset();
        ...
        FILL = new Alignment() { // from class: org.rbmain.ui.Components.TableLayout.7
            @Override // org.rbmain.ui.Components.TableLayout.Alignment
            public int getAlignmentValue(Child child, int i) {
                return Integer.MIN_VALUE;
            }
    ...
    private static Alignment createSwitchingAlignment(final Alignment alignment) {
        return new Alignment() { // from class: org.rbmain.ui.Components.TableLayout.4
            @Override // org.rbmain.ui.Components.TableLayout.Alignment
            int getGravityOffset(Child child, int i) {
