...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public class UserCell extends LinearLayout {
        public UserCell(PhonebookShareAlert phonebookShareAlert, Context context) {
            ...
            if (phonebookShareAlert.phones.size() != 1 || phonebookShareAlert.other.size() != 0) {
                userStatus = (phonebookShareAlert.currentUser.status == null || phonebookShareAlert.currentUser.status.expires == 0) ? null : LocaleController.formatUserStatus(((BottomSheet) phonebookShareAlert).currentAccount, phonebookShareAlert.currentUser);
                z = true;
            } else {
                userStatus = ((AndroidUtilities.VcardItem) phonebookShareAlert.phones.get(0)).getValue(true);
                z = false;
            }
    ...
    */
    public PhonebookShareAlert(org.rbmain.ui.ActionBar.BaseFragment r19, org.rbmain.messenger.ContactsController.Contact r20, org.rbmain.tgnet.TLRPC$User r21, android.net.Uri r22, java.io.File r23, java.lang.String r24, java.lang.String r25) {
        /*
            Method dump skipped, instructions count: 828
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.PhonebookShareAlert.<init>(org.rbmain.ui.ActionBar.BaseFragment, org.rbmain.messenger.ContactsController$Contact, org.rbmain.tgnet.TLRPC$User, android.net.Uri, java.io.File, java.lang.String, java.lang.String):void");
    }
    ...
    public /* synthetic */ void lambda$new$2(int i, View view, View view2) {
        ...
        if (this.isImport) {
            ...
            if (i4 == 0) {
                try {
                    ...
                    this.parentFragment.getParentActivity().startActivityForResult(intent, HttpStatus.HTTP_INTERNAL_SERVER_ERROR);
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Copy", R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Components.PhonebookShareAlert$$ExternalSyntheticLambda0
        ...
        if (i >= this.phoneStartRow && i < this.phoneEndRow) {
            ...
            if (!z) {
                color &= ConnectionsManager.DEFAULT_DATACENTER_ID;
            }
    ...
    public /* synthetic */ boolean lambda$new$3(int i, Context context, View view) {
        ...
        if (BulletinFactory.canShowBulletin(this.parentFragment)) {
            if (vcardItem.type == 3) {
                BulletinFactory.of((FrameLayout) this.containerView, null).createCopyLinkBulletin().show();
            } else {
                Bulletin.SimpleLayout simpleLayout = new Bulletin.SimpleLayout(context, null);
                int i4 = vcardItem.type;
                if (i4 == 0) {
    ...
    public /* synthetic */ void lambda$new$5(View view) {
        ...
        if (this.isImport) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Components.PhonebookShareAlert.5
        ...
        if (iLastIndexOf >= 0) {
            ...
            tLRPC$TL_restrictionReason.reason = BuildConfig.FLAVOR;
            tLRPC$TL_restrictionReason.platform = BuildConfig.FLAVOR;
        ...
        if ((baseFragment instanceof ChatActivity) && ((ChatActivity) baseFragment).isInScheduleMode()) {
            AlertsCreator.createScheduleDatePickerDialog(getContext(), ((ChatActivity) this.parentFragment).getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.rbmain.ui.Components.PhonebookShareAlert$$ExternalSyntheticLambda5
    ...
    protected void onStart() {
        super.onStart();
        Bulletin.addDelegate((FrameLayout) this.containerView, new Bulletin.Delegate(this) { // from class: org.rbmain.ui.Components.PhonebookShareAlert.6
    ...
    public void updateLayout(boolean z) {
        ...
        if ((z2 && this.actionBar.getTag() == null) || (!z2 && this.actionBar.getTag() != null)) {
            ...
            if (z) {
                ...
                this.actionBarAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.PhonebookShareAlert.7
        ...
        if (z) {
            ...
            this.shadowAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.PhonebookShareAlert.8
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
