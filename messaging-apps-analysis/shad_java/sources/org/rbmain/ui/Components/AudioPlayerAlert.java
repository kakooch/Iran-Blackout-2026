...
import org.rbmain.ui.ActionBar.ActionBarMenuSlider;
...
import org.rbmain.ui.Cells.AudioPlayerCell;
...
public class AudioPlayerAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public AudioPlayerAlert(final Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.forwardSeek = new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.1
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.2
            ...
            protected void onAttachedToWindow() {
                ...
                Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.2.1
        ...
        ActionBar actionBar = new ActionBar(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.3
            @Override // android.view.View
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.4
        ...
        searchField.setHintTextColor(getThemedColor(i3));
        searchField.setCursorColor(getThemedColor(i2));
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.5
        ...
        this.playerLayout = new FrameLayout(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.6
            @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        ...
        CoverContainer coverContainer = new CoverContainer(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.7
            ...
            @Override // org.rbmain.ui.Components.AudioPlayerAlert.CoverContainer
        ...
        ClippingTextViewSwitcher clippingTextViewSwitcher = new ClippingTextViewSwitcher(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.8
        ...
        SeekBarView seekBarView = new SeekBarView(context, resourcesProvider) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.10
            @Override // org.rbmain.ui.Components.SeekBarView
        ...
        this.seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.11
        ...
        this.seekBarBufferSpring = new SpringAnimation(new FloatValueHolder(0.0f)).setSpring(new SpringForce().setStiffness(750.0f).setDampingRatio(1.0f)).addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda6
        ...
        this.timeTextView.setTextColor(getThemedColor(i3));
        ...
        this.playbackSpeedButton.setDelegate(new ActionBarMenuItem.ActionBarMenuItemDelegate() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda11
            @Override // org.rbmain.ui.ActionBar.ActionBarMenuItem.ActionBarMenuItemDelegate
            public final void onItemClick(int i4) {
                this.f$0.lambda$new$1(i4);
            }
        });
        ...
        this.speedSlider.setOnValueChange(new Utilities.Callback2() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda8
            @Override // org.rbmain.messenger.Utilities.Callback2
        ...
        this.playbackSpeedButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                this.f$0.lambda$new$3(fArr, view3);
            }
        });
        this.playbackSpeedButton.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda4
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.12
            @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            protected void onLayout(boolean z, int i4, int i5, int i6, int i7) {
        ...
        this.repeatButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        this.repeatButton.setDelegate(new ActionBarMenuItem.ActionBarMenuItemDelegate() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda9
            @Override // org.rbmain.ui.ActionBar.ActionBarMenuItem.ActionBarMenuItemDelegate
            public final void onItemClick(int i5) {
                this.f$0.lambda$new$6(i5);
            }
        });
        ...
        this.playButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        this.optionsButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                this.f$0.lambda$new$8(view3);
            }
        });
        this.optionsButton.setDelegate(new ActionBarMenuItem.ActionBarMenuItemDelegate() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda10
            @Override // org.rbmain.ui.ActionBar.ActionBarMenuItem.ActionBarMenuItemDelegate
            public final void onItemClick(int i6) {
                this.f$0.onSubItemClick(i6);
            }
        });
        ...
        this.emptyView.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda5
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.15
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda13
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view3, int i7) {
                AudioPlayerAlert.lambda$new$10(view3, i7);
            }
        });
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.16
        ...
        FrameLayout frameLayout3 = new FrameLayout(context) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.17
            @Override // android.view.View
            public boolean onTouchEvent(MotionEvent motionEvent) {
                if (AudioPlayerAlert.this.blurredView.getTag() != null) {
                    AudioPlayerAlert.this.showAlbumCover(false, true);
    ...
    /* renamed from: org.rbmain.ui.Components.AudioPlayerAlert$9, reason: invalid class name */
    class AnonymousClass9 extends ClippingTextViewSwitcher {
        ...
        protected TextView createTextView() {
            ...
            textView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$9$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
    ...
    /* renamed from: org.rbmain.ui.Components.AudioPlayerAlert$13, reason: invalid class name */
    class AnonymousClass13 extends RLottieImageView {
        ...
        AnonymousClass13(Context context, float f) {
            ...
            this.pressedCount = 0;
            this.pressedRunnable = new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.13.1
                @Override // java.lang.Runnable
                public void run() {
            ...
            this.backSeek = new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.13.2
                @Override // java.lang.Runnable
                public void run() {
                    long duration = MediaController.getInstance().getDuration();
                    if (duration == 0 || duration == -9223372036854775807L) {
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r10) {
            /*
                r9 = this;
                org.rbmain.ui.Components.AudioPlayerAlert r0 = org.rbmain.ui.Components.AudioPlayerAlert.this
                org.rbmain.ui.Components.SeekBarView r0 = org.rbmain.ui.Components.AudioPlayerAlert.access$5500(r0)
            ...
            L30:
                ...
                if (r10 <= 0) goto Ldf
                org.rbmain.ui.Components.AudioPlayerAlert r10 = org.rbmain.ui.Components.AudioPlayerAlert.this
                int r10 = r10.rewindingState
                if (r10 != 0) goto Ldf
                java.lang.Runnable r10 = r9.pressedRunnable
                org.rbmain.messenger.AndroidUtilities.cancelRunOnUIThread(r10)
                r9.setPressed(r1)
                goto Ldf
            L53:
                ...
                if (r10 >= 0) goto L8e
                org.rbmain.messenger.MediaController r10 = org.rbmain.messenger.MediaController.getInstance()
                r10.playPreviousMessage()
                org.rbmain.ui.Components.AudioPlayerAlert r10 = org.rbmain.ui.Components.AudioPlayerAlert.this
                org.rbmain.ui.Components.RLottieImageView r10 = org.rbmain.ui.Components.AudioPlayerAlert.access$5600(r10)
                r0 = 0
                r10.setProgress(r0)
                org.rbmain.ui.Components.AudioPlayerAlert r10 = org.rbmain.ui.Components.AudioPlayerAlert.this
                org.rbmain.ui.Components.RLottieImageView r10 = org.rbmain.ui.Components.AudioPlayerAlert.access$5600(r10)
            ...
            Lb2:
                ...
                r10.rewindingState = r1
                java.lang.Runnable r10 = r9.pressedRunnable
                org.rbmain.messenger.AndroidUtilities.runOnUIThread(r10, r5)
            ...
            Le0:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.AudioPlayerAlert.AnonymousClass13.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    /* renamed from: org.rbmain.ui.Components.AudioPlayerAlert$14, reason: invalid class name */
    class AnonymousClass14 extends RLottieImageView {
        ...
        AnonymousClass14(Context context, float f) {
            super(context);
            this.val$touchSlop = f;
            this.pressedRunnable = new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.14.1
                @Override // java.lang.Runnable
                public void run() {
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r7) {
            ...
            L2f:
                ...
                org.rbmain.messenger.AndroidUtilities.cancelRunOnUIThread(r7)
                r6.setPressed(r1)
                goto Ldc
            L50:
                ...
                if (r7 == 0) goto L7a
                org.rbmain.messenger.MediaController r7 = org.rbmain.messenger.MediaController.getInstance()
                r7.playNextMessage()
                org.rbmain.ui.Components.AudioPlayerAlert r7 = org.rbmain.ui.Components.AudioPlayerAlert.this
                org.rbmain.ui.Components.RLottieImageView r7 = org.rbmain.ui.Components.AudioPlayerAlert.access$5800(r7)
                r0 = 0
                r7.setProgress(r0)
                org.rbmain.ui.Components.AudioPlayerAlert r7 = org.rbmain.ui.Components.AudioPlayerAlert.this
                org.rbmain.ui.Components.RLottieImageView r7 = org.rbmain.ui.Components.AudioPlayerAlert.access$5800(r7)
            ...
            L7a:
                ...
                java.lang.Runnable r7 = org.rbmain.ui.Components.AudioPlayerAlert.access$100(r7)
                r7.run()
            La5:
                org.rbmain.ui.Components.AudioPlayerAlert r7 = org.rbmain.ui.Components.AudioPlayerAlert.this
            ...
            Lb5:
                ...
                org.rbmain.messenger.AndroidUtilities.runOnUIThread(r7, r0)
            ...
            Ldd:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.AudioPlayerAlert.AnonymousClass14.onTouchEvent(android.view.MotionEvent):boolean");
        }
    ...
    */
    public boolean scrollToCurrentSong(boolean r7) {
        /*
            ...
            org.rbmain.messenger.MessageObject r0 = r0.getPlayingMessageObject()
            r1 = 0
            if (r0 == 0) goto L5d
            r2 = 1
            if (r7 == 0) goto L3b
            org.rbmain.ui.Components.RecyclerListView r7 = r6.listView
            int r7 = r7.getChildCount()
            r3 = 0
        L15:
            if (r3 >= r7) goto L3b
            org.rbmain.ui.Components.RecyclerListView r4 = r6.listView
            android.view.View r4 = r4.getChildAt(r3)
            boolean r5 = r4 instanceof org.rbmain.ui.Cells.AudioPlayerCell
            if (r5 == 0) goto L38
            r5 = r4
            org.rbmain.ui.Cells.AudioPlayerCell r5 = (org.rbmain.ui.Cells.AudioPlayerCell) r5
            org.rbmain.messenger.MessageObject r5 = r5.getMessageObject()
            if (r5 != r0) goto L38
            int r7 = r4.getBottom()
            org.rbmain.ui.Components.RecyclerListView r3 = r6.listView
        ...
        L3c:
            if (r7 != 0) goto L5d
            java.util.ArrayList<org.rbmain.messenger.MessageObject> r7 = r6.playlist
            int r7 = r7.indexOf(r0)
            if (r7 < 0) goto L5d
            boolean r0 = org.rbmain.messenger.SharedConfig.playOrderReversed
            if (r0 == 0) goto L50
        ...
        L50:
            androidx.recyclerview.widget.LinearLayoutManager r0 = r6.layoutManager
            java.util.ArrayList<org.rbmain.messenger.MessageObject> r1 = r6.playlist
            int r1 = r1.size()
            int r1 = r1 - r7
        ...
        L5d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.AudioPlayerAlert.scrollToCurrentSong(boolean):boolean");
    }
    ...
    private void showSpeedHint() {
        if (this.containerView != null) {
            HintView hintView = new HintView(this, getContext(), 5, false) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.18
                @Override // android.view.View
    ...
    */
    public void onSubItemClick(int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.AudioPlayerAlert.onSubItemClick(int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSubItemClick$11(ArrayList arrayList, DialogsActivity dialogsActivity, ArrayList arrayList2, CharSequence charSequence, boolean z) {
        if (arrayList2.size() > 1 || ((Long) arrayList2.get(0)).longValue() == UserConfig.getInstance(this.currentAccount).getClientUserId() || charSequence != null) {
            for (int i = 0; i < arrayList2.size(); i++) {
                ...
                if (charSequence != null) {
                    SendMessagesHelper.getInstance(this.currentAccount).sendMessage(charSequence.toString(), jLongValue, (MessageObject) null, (MessageObject) null, (TLRPC$WebPage) null, true, (ArrayList<TLRPC$MessageEntity>) null, (TLRPC$ReplyMarkup) null, (HashMap<String, String>) null, true, 0);
                }
                SendMessagesHelper.getInstance(this.currentAccount).sendMessage(arrayList, jLongValue, true, 0);
            }
    ...
    public void showAlbumCover(boolean z, boolean z2) {
        if (z) {
            ...
            this.blurredView.animate().alpha(1.0f).setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.19
        ...
        if (z2) {
            this.blurredAnimationInProgress = true;
            this.blurredView.animate().alpha(0.0f).setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.20
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    public void updateLayout() {
        ...
        if ((z2 && this.actionBar.getTag() == null) || (!z2 && this.actionBar.getTag() != null)) {
            ...
            this.actionBarAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.21
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                }
        ...
        int iDp3 = (this.scrollOffsetY - this.backgroundPaddingTop) - AndroidUtilities.dp(13.0f);
        if (this.currentSheetAnimationType == 1) {
            iDp3 = (int) (iDp3 + this.listView.getTranslationY());
        }
        if ((this.backgroundPaddingTop + iDp3 < ActionBar.getCurrentActionBarHeight() ? 1.0f - Math.min(1.0f, ((ActionBar.getCurrentActionBarHeight() - iDp3) - this.backgroundPaddingTop) / (r0 + AndroidUtilities.dp(4.0f))) : 1.0f) <= 0.5f && ColorUtils.calculateLuminance(getThemedColor(Theme.key_dialogBackground)) > 0.699999988079071d) {
            z = true;
        }
        if (z != this.wasLight) {
    ...
    private void updateTitle(boolean z) {
        ...
        long dialogId = playingMessageObject.getDialogId();
        if ((dialogId < 0 && MessagesController.getInstance(this.currentAccount).isChatNoForwards((int) (-dialogId))) || MessagesController.getInstance(this.currentAccount).isChatNoForwards(playingMessageObject.getChatId()) || playingMessageObject.messageOwner.noforwards) {
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void search(final String str) {
            ...
            if (str == null) {
                ...
                Runnable runnable = new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$ListAdapter$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
        ...
        private void processSearch(final String str) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$ListAdapter$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$processSearch$2(final String str) {
            ...
            Utilities.searchQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$ListAdapter$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        private void updateSearchResults(final ArrayList<MessageObject> arrayList, final String str) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$ListAdapter$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$$ExternalSyntheticLambda12
    ...
    static abstract class CoverContainer extends FrameLayout {
        ...
        public CoverContainer(Context context) {
            ...
            for (final int i = 0; i < 2; i++) {
                ...
                this.imageViews[i].getImageReceiver().setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$CoverContainer$$ExternalSyntheticLambda2
        ...
        public final void switchImageViews() {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$CoverContainer$$ExternalSyntheticLambda1
            ...
            if (zHasBitmapImage) {
                ...
                valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$CoverContainer$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        AudioPlayerAlert.CoverContainer.lambda$switchImageViews$2(backupImageView, backupImageView2, valueAnimator);
                    }
                });
                valueAnimatorOfFloat2.addListener(new AnimatorListenerAdapter(this) { // from class: org.rbmain.ui.Components.AudioPlayerAlert.CoverContainer.1
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        backupImageView.setVisibility(8);
                        backupImageView.setImageDrawable(null);
    ...
    public static abstract class ClippingTextViewSwitcher extends FrameLayout {
        ...
        public void setText(CharSequence charSequence, boolean z) {
            ...
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.AudioPlayerAlert.ClippingTextViewSwitcher.1
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$ClippingTextViewSwitcher$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.AudioPlayerAlert$ClippingTextViewSwitcher$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
