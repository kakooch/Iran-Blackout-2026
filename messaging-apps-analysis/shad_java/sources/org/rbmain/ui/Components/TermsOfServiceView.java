...
import org.rbmain.tgnet.TLRPC$TL_help_acceptTermsOfService;
...
public class TermsOfServiceView extends FrameLayout {
    ...
    public TermsOfServiceView(Context context) {
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda4
        ...
        textView4.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
    ...
    public /* synthetic */ void lambda$new$4(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("DeclineDeactivate", R.string.DeclineDeactivate), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$new$3(DialogInterface dialogInterface, int i) {
        ...
        builder.setPositiveButton(LocaleController.getString("Deactivate", R.string.Deactivate), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface2, int i2) {
                this.f$0.lambda$new$2(dialogInterface2, i2);
            }
        });
    ...
    public /* synthetic */ void lambda$new$2(DialogInterface dialogInterface, int i) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_account_deleteAccount, new RequestDelegate() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda6
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$new$1(alertDialog, tLObject, tLRPC$TL_error);
            }
        });
        alertDialog.show();
    }
    ...
    public /* synthetic */ void lambda$new$1(final AlertDialog alertDialog, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$0(alertDialog, tLObject, tLRPC$TL_error);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$new$6(View view) {
        if (this.currentTos.min_age_confirm != 0) {
            ...
            builder.setPositiveButton(LocaleController.getString("Agree", R.string.Agree), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void accept() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_help_acceptTermsOfService, new RequestDelegate() { // from class: org.rbmain.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda7
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
