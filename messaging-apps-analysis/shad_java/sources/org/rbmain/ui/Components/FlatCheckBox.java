...
public class FlatCheckBox extends View {
    ...
    public void setChecked(boolean z, boolean z2) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.FlatCheckBox$$ExternalSyntheticLambda0
