...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    public interface ScrollSlidingTabStripDelegate {
        ...
        /* renamed from: org.rbmain.ui.Components.ScrollSlidingTextTabStrip$ScrollSlidingTabStripDelegate$-CC, reason: invalid class name */
    ...
    public ScrollSlidingTextTabStrip(Context context) {
        ...
        this.animationRunnable = new Runnable() { // from class: org.rbmain.ui.Components.ScrollSlidingTextTabStrip.1
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.rbmain.ui.Components.ScrollSlidingTextTabStrip.2
    ...
    public void addTextTab(final int i, CharSequence charSequence, SparseArray<View> sparseArray) {
        ...
        if (textView == null) {
            textView = new TextView(getContext()) { // from class: org.rbmain.ui.Components.ScrollSlidingTextTabStrip.3
                @Override // android.view.View
            ...
            textView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.ScrollSlidingTextTabStrip$$ExternalSyntheticLambda1
        ...
        int iCeil = ((int) Math.ceil(textView.getPaint().measureText(charSequence, 0, charSequence.length()))) + textView.getPaddingLeft() + textView.getPaddingRight();
        ...
        if (this.prevLayoutWidth != i6) {
            ...
            if (textView != null) {
                ...
                if (i9 != i8 || i5 != i7) {
                    ...
                    valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.ScrollSlidingTextTabStrip$$ExternalSyntheticLambda0
