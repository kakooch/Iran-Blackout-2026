...
public class DialogsItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                new Runnable() { // from class: org.rbmain.ui.Components.DialogsItemAnimator$$ExternalSyntheticLambda1
            ...
            if (z3) {
                ...
                new Runnable() { // from class: org.rbmain.ui.Components.DialogsItemAnimator$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            if (z4) {
                ...
                new Runnable() { // from class: org.rbmain.ui.Components.DialogsItemAnimator$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        if (view instanceof DialogCell) {
            ...
            if (view == dialogCell2) {
                ...
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.DialogsItemAnimator.1
            ...
            duration2.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.DialogsItemAnimator.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
                    DialogsItemAnimator.this.dispatchRemoveStarting(viewHolder);
                }
        ...
        viewPropertyAnimatorAnimate.setDuration(180L).alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.DialogsItemAnimator.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
                DialogsItemAnimator.this.dispatchRemoveStarting(viewHolder);
            }
    ...
    void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        final ViewPropertyAnimator viewPropertyAnimatorAnimate = view.animate();
        viewPropertyAnimatorAnimate.alpha(1.0f).setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.DialogsItemAnimator.4
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo, int i, int i2, int i3, int i4) {
        ...
        viewPropertyAnimatorAnimate.setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.DialogsItemAnimator.5
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.DialogsItemAnimator.6
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
