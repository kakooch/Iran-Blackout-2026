...
import org.rbmain.ui.ActionBar.FloatingActionMode;
import org.rbmain.ui.ActionBar.FloatingToolbar;
...
public class EditTextBoldCursor extends EditTextEffects {
    ...
    public EditTextBoldCursor(Context context) {
        super(context);
        this.invalidateRunnable = new Runnable() { // from class: org.rbmain.ui.Components.EditTextBoldCursor.1
    ...
    public Drawable getTextCursorDrawable() {
        ...
        ShapeDrawable shapeDrawable = new ShapeDrawable(new RectShape()) { // from class: org.rbmain.ui.Components.EditTextBoldCursor.2
    ...
    private void init() {
        ...
        if (i >= 29) {
            ShapeDrawable shapeDrawable = new ShapeDrawable() { // from class: org.rbmain.ui.Components.EditTextBoldCursor.3
                @Override // android.graphics.drawable.ShapeDrawable, android.graphics.drawable.Drawable
                public void draw(Canvas canvas) {
    ...
    public void fixHandleView(boolean z) {
        ...
        try {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.EditTextBoldCursor$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
    ...
    @Override // org.rbmain.ui.Components.EditTextEffects, android.widget.EditText, android.widget.TextView
    ...
    */
    protected void onDraw(android.graphics.Canvas r16) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.EditTextBoldCursor.onDraw(android.graphics.Canvas):void");
    }
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        if (Build.VERSION.SDK_INT >= 23 && (this.windowView != null || this.attachedToWindow != null)) {
            ...
            this.floatingToolbarPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: org.rbmain.ui.Components.EditTextBoldCursor$$ExternalSyntheticLambda0
