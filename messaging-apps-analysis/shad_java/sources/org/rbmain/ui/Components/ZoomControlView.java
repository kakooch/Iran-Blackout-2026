...
public class ZoomControlView extends View {
    ...
    public ZoomControlView(Context context) {
        super(context);
        this.ZOOM_PROPERTY = new AnimationProperties.FloatProperty<ZoomControlView>("clipProgress") { // from class: org.rbmain.ui.Components.ZoomControlView.1
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.ZoomControlView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private boolean animateToZoom(float f) {
        ...
        this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.ZoomControlView.2
