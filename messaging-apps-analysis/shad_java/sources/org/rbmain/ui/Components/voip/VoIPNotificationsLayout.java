...
public class VoIPNotificationsLayout extends LinearLayout {
    ...
    public VoIPNotificationsLayout(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            transitionSet.addTransition(new Fade(2).setDuration(150L)).addTransition(new ChangeBounds().setDuration(200L)).addTransition(new Visibility(this) { // from class: org.rbmain.ui.Components.voip.VoIPNotificationsLayout.1
    ...
    private void lock() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.VoIPNotificationsLayout$$ExternalSyntheticLambda0
    ...
    static class NotificationView extends FrameLayout {
        ...
        public void startAnimation() {
            ...
            postDelayed(new Runnable() { // from class: org.rbmain.ui.Components.voip.VoIPNotificationsLayout$NotificationView$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
