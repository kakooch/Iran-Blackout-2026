...
import org.rbmain.ui.Components.CrossOutDrawable;
...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public GroupCallMiniTextureView(final GroupCallRenderersContainer groupCallRenderersContainer, ArrayList<GroupCallMiniTextureView> arrayList, final ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        this.noRtmpStreamCallback = new Runnable() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda5
        ...
        TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(call.chatId));
        ...
        boolean z = false;
        boolean z2 = true;
        VoIPTextureView voIPTextureView = new VoIPTextureView(groupCallRenderersContainer.getContext(), z, z, z2, z2) { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.1
            float overlayIconAlphaFrom;

            @Override // org.rbmain.ui.Components.voip.VoIPTextureView
            ...
            @Override // org.rbmain.ui.Components.voip.VoIPTextureView, android.view.ViewGroup, android.view.View
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (!this.renderer.isFirstFrameRendered() || ((this.renderer.getAlpha() != 1.0f && this.blurRenderer.getAlpha() != 1.0f) || GroupCallMiniTextureView.this.videoIsPaused)) {
                    ...
                    if (videoParticipant == call.videoNotAvailableParticipant) {
                        ...
                        int iDp2 = (int) ((measuredHeight - ((fDp3 + (fDp4 * ((groupCallMiniTextureView7.showingInFullscreen || groupCallMiniTextureView7.animateToFullscreen) ? groupCallRenderersContainer.progressToFullscreenMode : 0.0f))) * f5)) + (AndroidUtilities.dp(17.0f) * f2));
            ...
            @Override // org.rbmain.ui.Components.voip.VoIPTextureView, android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            ...
            @Override // org.rbmain.ui.Components.voip.VoIPTextureView, android.view.View, android.view.ViewParent
            ...
            protected void onFirstFrameRendered() {
                ...
                if (imageView != null && imageView.getParent() != null) {
                    if (GroupCallMiniTextureView.this.blurredFlippingStub.getAlpha() == 1.0f) {
                        GroupCallMiniTextureView.this.blurredFlippingStub.animate().alpha(0.0f).setDuration(300L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.1.1
        ...
        this.textureView.renderer.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new RendererCommon.RendererEvents() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.2
        ...
        TextView textView = new TextView(groupCallRenderersContainer.getContext()) { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.3
        ...
        this.stopSharingTextView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda3
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    */
    protected void onMeasure(int r14, int r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.onMeasure(int, int):void");
    }
    ...
    */
    public void updateAttachState(boolean r24) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.updateAttachState(boolean):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:48:0x00c6 A[PHI: r11
      0x00c6: PHI (r11v15 org.rbmain.ui.Components.voip.GroupCallGridCell) = (r11v12 org.rbmain.ui.Components.voip.GroupCallGridCell), (r11v16 org.rbmain.ui.Components.voip.GroupCallGridCell) binds: [B:51:0x00cb, B:47:0x00c4] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void updatePosition(android.view.ViewGroup r9, android.view.ViewGroup r10, org.rbmain.ui.Components.RecyclerListView r11, org.rbmain.ui.Components.voip.GroupCallRenderersContainer r12) {
        /*
            Method dump skipped, instructions count: 445
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.updatePosition(android.view.ViewGroup, android.view.ViewGroup, org.rbmain.ui.Components.RecyclerListView, org.rbmain.ui.Components.voip.GroupCallRenderersContainer):void");
    }
    ...
    public void saveThumb() {
        ...
        getRenderBufferBitmap(new GlGenericDrawer.TextureCallback() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda8
    ...
    public /* synthetic */ void lambda$saveThumb$5(final Bitmap bitmap, int i) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    @Override // org.rbmain.ui.Components.voip.GroupCallStatusIcon.Callback
    ...
    */
    private void updateIconColor(boolean r10) {
        /*
            r9 = this;
            org.rbmain.ui.Components.voip.GroupCallStatusIcon r0 = r9.statusIcon
            if (r0 != 0) goto L5
            return
        L5:
            boolean r0 = r0.isMutedByMe()
            if (r0 == 0) goto L13
            int r0 = org.rbmain.ui.ActionBar.Theme.key_voipgroup_mutedByAdminIcon
        ...
        L13:
            ...
            if (r0 == 0) goto L22
            int r0 = org.rbmain.ui.ActionBar.Theme.key_voipgroup_speakingText
            int r0 = org.rbmain.ui.ActionBar.Theme.getColor(r0)
            goto L11
        L22:
            int r0 = org.rbmain.ui.ActionBar.Theme.key_voipgroup_speakingText
        ...
        L46:
            ...
            org.rbmain.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda2 r8 = new org.rbmain.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda2
            r2 = r8
            r3 = r9
            r5 = r0
            r7 = r1
            ...
            org.rbmain.ui.Components.voip.GroupCallMiniTextureView$7 r2 = new org.rbmain.ui.Components.voip.GroupCallMiniTextureView$7
            r2.<init>()
            r10.addListener(r2)
            android.animation.ValueAnimator r10 = r9.colorAnimator
            r10.start()
        L73:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.updateIconColor(boolean):void");
    }
    ...
    public void startFlipAnimation() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$startFlipAnimation$7(valueAnimator);
            }
        });
        this.flipAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.GroupCallMiniTextureView.8
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
