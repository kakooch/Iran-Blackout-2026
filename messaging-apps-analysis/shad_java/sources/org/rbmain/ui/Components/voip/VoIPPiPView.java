...
public class VoIPPiPView implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public int xOffset;
    public int yOffset;
    ValueAnimator.AnimatorUpdateListener animatorToCameraMiniUpdater = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$$ExternalSyntheticLambda0
    ...
    Runnable collapseRunnable = new Runnable(this) { // from class: org.rbmain.ui.Components.voip.VoIPPiPView.1
    ...
    private ValueAnimator.AnimatorUpdateListener updateXlistener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView.2
        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    ...
    private ValueAnimator.AnimatorUpdateListener updateYlistener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView.3
        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            VoIPPiPView voIPPiPView = VoIPPiPView.this;
    ...
    public VoIPPiPView(final Context context, int i, int i2, boolean z) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.rbmain.ui.Components.voip.VoIPPiPView.4
        ...
        if (z) {
            ...
            this.closeIcon.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    VoIPPiPView.lambda$new$1(view2);
                }
            });
            this.enlargeIcon.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
    ...
    public void onStateChanged(int i) {
        if (i == 11 || i == 17 || i == 4 || i == 10) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
    ...
    class FloatingView extends FrameLayout {
        ...
        public FloatingView(Context context) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                setOutlineProvider(new ViewOutlineProvider(this, VoIPPiPView.this) { // from class: org.rbmain.ui.Components.voip.VoIPPiPView.FloatingView.1
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.VoIPPiPView.FloatingView.onTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        public void expand(boolean z) {
            ...
            if (z) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        public /* synthetic */ void lambda$expand$1(final float f, final VoIPPiPView voIPPiPView) {
            ...
            showUi(true);
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    VoIPPiPView.FloatingView.lambda$expand$0(f, f2, voIPPiPView, valueAnimator);
                }
            });
            valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView.FloatingView.2
        ...
        /* renamed from: org.rbmain.ui.Components.voip.VoIPPiPView$FloatingView$3, reason: invalid class name */
        class AnonymousClass3 extends AnimatorListenerAdapter {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.VoIPPiPView$FloatingView$3$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
