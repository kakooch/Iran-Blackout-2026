...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public void setText(String str, boolean z, boolean z2) {
        ...
        if (this.timerShowing) {
            ...
            replaceViews(textViewArr[0], textViewArr[1], new Runnable() { // from class: org.rbmain.ui.Components.voip.VoIPStatusTextView$$ExternalSyntheticLambda1
    ...
    public void replaceViews(final View view, final View view2, Runnable runnable) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPStatusTextView$$ExternalSyntheticLambda0
    ...
    /* renamed from: org.rbmain.ui.Components.voip.VoIPStatusTextView$1, reason: invalid class name */
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (charSequence != null) {
                if (charSequence.equals("timer")) {
                    ...
                    voIPStatusTextView3.replaceViews(textViewArr[0], textViewArr[1], new Runnable() { // from class: org.rbmain.ui.Components.voip.VoIPStatusTextView$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public void showReconnect(boolean z, boolean z2) {
        if (!z2) {
            ...
            this.reconnectTextView.animate().alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.VoIPStatusTextView.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
