...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        this.active = true;
        this.progressUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPFloatingLayout.1
        ...
        this.mutedUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.VoIPFloatingLayout$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            setOutlineProvider(new ViewOutlineProvider() { // from class: org.rbmain.ui.Components.voip.VoIPFloatingLayout.2
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setFloatingMode(boolean z, boolean z2) {
        ...
        if (z && !this.floatingMode) {
            ...
            duration.setInterpolator(cubicBezierInterpolator).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.VoIPFloatingLayout.3
        ...
        if (!z && this.floatingMode) {
            ...
            requestLayout();
            animate().setListener(null).cancel();
            getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.rbmain.ui.Components.voip.VoIPFloatingLayout.4
                ...
                public boolean onPreDraw() {
                    ...
                    if (voIPFloatingLayout.measuredAsFloatingMode) {
                        ...
                        VoIPFloatingLayout.this.animate().setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.VoIPFloatingLayout.4.1
                            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                            public void onAnimationEnd(Animator animator) {
                                VoIPFloatingLayout.this.switchingToFloatingMode = false;
                                VoIPFloatingLayout.this.requestLayout();
