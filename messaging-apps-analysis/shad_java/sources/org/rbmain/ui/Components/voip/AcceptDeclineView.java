...
public class AcceptDeclineView extends View {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.voip.AcceptDeclineView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public AccessibilityNodeProvider getAccessibilityNodeProvider() {
        if (this.accessibilityNodeProvider == null) {
            this.accessibilityNodeProvider = new AcceptDeclineAccessibilityNodeProvider(this, 2) { // from class: org.rbmain.ui.Components.voip.AcceptDeclineView.1
                private final int[] coords = {0, 0};

                @Override // org.rbmain.ui.Components.voip.AcceptDeclineView.AcceptDeclineAccessibilityNodeProvider
