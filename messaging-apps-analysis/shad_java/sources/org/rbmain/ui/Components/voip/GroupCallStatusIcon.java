...
public class GroupCallStatusIcon {
    ...
    private Runnable shakeHandCallback = new Runnable() { // from class: org.rbmain.ui.Components.voip.GroupCallStatusIcon$$ExternalSyntheticLambda2
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.lambda$new$0();
        }
    };
    private Runnable raiseHandCallback = new Runnable() { // from class: org.rbmain.ui.Components.voip.GroupCallStatusIcon$$ExternalSyntheticLambda3
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.lambda$new$1();
        }
    };
    private Runnable updateRunnable = new Runnable() { // from class: org.rbmain.ui.Components.voip.GroupCallStatusIcon$$ExternalSyntheticLambda1
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.lambda$new$2();
        }
    };
    private Runnable checkRaiseRunnable = new Runnable() { // from class: org.rbmain.ui.Components.voip.GroupCallStatusIcon$$ExternalSyntheticLambda0
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.lambda$new$3();
        }
    };
    RLottieDrawable micDrawable = new RLottieDrawable(R.raw.voice_mini, "2131820683", AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
    RLottieDrawable shakeHandDrawable = new RLottieDrawable(R.raw.hand_2, "2131820592", AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), true, null);
