...
import org.rbmain.ui.Components.SimpleFloatPropertyCompat;
...
public class RTMPStreamPipOverlay implements NotificationCenter.NotificationCenterDelegate {
    private static final FloatPropertyCompat<RTMPStreamPipOverlay> PIP_X_PROPERTY = new SimpleFloatPropertyCompat("pipX", new SimpleFloatPropertyCompat.Getter() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda6
        @Override // org.rbmain.ui.Components.SimpleFloatPropertyCompat.Getter
        public final float get(Object obj) {
            return ((RTMPStreamPipOverlay) obj).pipX;
        }
    }, new SimpleFloatPropertyCompat.Setter() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda7
        @Override // org.rbmain.ui.Components.SimpleFloatPropertyCompat.Setter
        public final void set(Object obj, float f) {
            RTMPStreamPipOverlay.lambda$static$1((RTMPStreamPipOverlay) obj, f);
        }
    });
    private static final FloatPropertyCompat<RTMPStreamPipOverlay> PIP_Y_PROPERTY = new SimpleFloatPropertyCompat("pipY", new SimpleFloatPropertyCompat.Getter() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda5
        @Override // org.rbmain.ui.Components.SimpleFloatPropertyCompat.Getter
        public final float get(Object obj) {
            return ((RTMPStreamPipOverlay) obj).pipY;
        }
    }, new SimpleFloatPropertyCompat.Setter() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda8
        @Override // org.rbmain.ui.Components.SimpleFloatPropertyCompat.Setter
        public final void set(Object obj, float f) {
    ...
    private Runnable dismissControlsCallback = new Runnable() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda3
    ...
    public void toggleControls(boolean z) {
        ...
        this.scaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$toggleControls$5(valueAnimator);
            }
        });
        this.scaleAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.1
    ...
    private void dismissInternal() {
        if (this.isVisible) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    private void showInternal() {
        ...
        this.gestureDetector = new GestureDetectorCompat(context, new GestureDetector.SimpleOnGestureListener() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.4
        ...
        this.contentFrameLayout = new FrameLayout(context) { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.5
        ...
        ViewGroup viewGroup = new ViewGroup(context) { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.6
            @Override // android.view.ViewGroup, android.view.View
        ...
        if (i >= 21) {
            this.contentFrameLayout.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.7
        ...
        View view = new View(context) { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.9
            @Override // android.view.View
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda2
        ...
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        WindowManager.LayoutParams layoutParamsCreateWindowLayoutParams = createWindowLayoutParams();
    ...
    /* renamed from: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$3, reason: invalid class name */
    class AnonymousClass3 implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
            if (RTMPStreamPipOverlay.this.pipXSpring.isRunning() || RTMPStreamPipOverlay.this.pipYSpring.isRunning()) {
                ...
                DynamicAnimation.OnAnimationEndListener onAnimationEndListener = new DynamicAnimation.OnAnimationEndListener() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay.3.1
    ...
    /* renamed from: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$8, reason: invalid class name */
    class AnonymousClass8 implements RendererCommon.RendererEvents {
        ...
        public void onFirstFrameRendered() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$8$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onFrameResolutionChanged(int i, int i2, int i3) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.voip.RTMPStreamPipOverlay$8$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
