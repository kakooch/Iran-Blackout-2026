...
public class SpoilerEffect extends Drawable {
    ...
    public SpoilerEffect() {
        ...
        this.mAlpha = 255;
        this.rippleInterpolator = new TimeInterpolator() { // from class: org.rbmain.ui.Components.spoilers.SpoilerEffect$$ExternalSyntheticLambda0
    ...
    public void startRipple(float f, float f2, float f3, boolean z) {
        ...
        this.rippleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.spoilers.SpoilerEffect$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.lambda$startRipple$1(alpha, valueAnimator2);
            }
        });
        this.rippleAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.spoilers.SpoilerEffect.1
        ...
        if (this.drawPoints) {
            ...
            if (size < i9) {
                ...
                while (i10 < size2) {
                    ...
                    int i11 = i10 % 14;
                    float fNextFloat = fArr[i11];
                    if (fNextFloat == f4) {
                        fNextFloat = Utilities.fastRandom.nextFloat();
                        fArr[i11] = fNextFloat;
                    }
                    float f5 = fNextFloat;
                    Particle particlePop = !this.particlesPool.isEmpty() ? this.particlesPool.pop() : new Particle();
                    int i12 = 0;
                    while (true) {
                        generateRandomLocation(particlePop, i10);
                        int i13 = i12 + 1;
                        particle = particlePop;
                        i = size2;
                        f = f5;
                        if (!isOutOfBounds(i2, i3, i4, i5, particlePop.x, particlePop.y) || i13 >= 4) {
                            break;
                        }
                        f5 = f;
                        particlePop = particle;
                        i12 = i13;
                        size2 = i;
                    }
                    double d = f;
    ...
    private static void addSpoilerRangesInternal(final View view, final Layout layout, final int i, final int i2, int i3, int i4, final Stack<SpoilerEffect> stack, final List<SpoilerEffect> list) {
        layout.getSelectionPath(i3, i4, new Path() { // from class: org.rbmain.ui.Components.spoilers.SpoilerEffect.2
    ...
    public static void renderWithRipple(View view, boolean z, int i, int i2, AtomicReference<Layout> atomicReference, Layout layout, List<SpoilerEffect> list, Canvas canvas, boolean z2) {
        ...
        Layout staticLayout = atomicReference.get();
                ...
                while (i4 < length) {
                    ...
                    if (textStyleSpan.isSpoiler()) {
                        ...
                        while (i5 < length2) {
                            ...
                            spannableStringBuilder.setSpan(new ReplacementSpan() { // from class: org.rbmain.ui.Components.spoilers.SpoilerEffect.3
