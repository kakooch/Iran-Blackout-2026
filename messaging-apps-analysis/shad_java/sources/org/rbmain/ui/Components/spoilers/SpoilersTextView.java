...
public class SpoilersTextView extends TextView {
    ...
    public SpoilersTextView(Context context, final boolean z) {
        ...
        this.path = new Path();
        this.clickDetector = new SpoilersClickDetector(this, this.spoilers, new SpoilersClickDetector.OnSpoilerClickedListener() { // from class: org.rbmain.ui.Components.spoilers.SpoilersTextView$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ void lambda$new$2(boolean z, SpoilerEffect spoilerEffect, float f, float f2) {
        ...
        spoilerEffect.setOnRippleEndCallback(new Runnable() { // from class: org.rbmain.ui.Components.spoilers.SpoilersTextView$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$new$1() {
        post(new Runnable() { // from class: org.rbmain.ui.Components.spoilers.SpoilersTextView$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
