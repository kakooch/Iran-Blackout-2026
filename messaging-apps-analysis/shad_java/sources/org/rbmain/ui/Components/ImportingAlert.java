...
public class ImportingAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context) {
            ...
            view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iDp, Theme.getColor(i), Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
            ...
            rLottieImageView.setBackground(Theme.createCircleDrawable(iDp2, Theme.getColor(i2)));
    ...
    public ImportingAlert(Context context, ChatActivity chatActivity) {
        super(context, false);
        this.importCountTextView = new TextView[2];
        this.infoTextView = new TextView[2];
        Runnable runnable = new Runnable() { // from class: org.rbmain.ui.Components.ImportingAlert$$ExternalSyntheticLambda1
        ...
        this.percentTextView.setTextColor(Theme.getColor(i));
        ...
        this.cell.background.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.ImportingAlert$$ExternalSyntheticLambda0
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            ...
            this.importCountTextView[i2].setTextColor(Theme.getColor(Theme.key_dialogTextBlack));
            ...
            this.infoTextView[i2].setTextColor(Theme.getColor(Theme.key_dialogTextGray3));
            ...
            if (i2 == 0) {
                ...
                this.importCountTextView[i2].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            } else {
                this.infoTextView[i2].setText(LocaleController.getString("ImportDoneInfo", R.string.ImportDoneInfo));
                this.importCountTextView[i2].setText(LocaleController.getString("ImportDoneTitle", R.string.ImportDoneTitle));
