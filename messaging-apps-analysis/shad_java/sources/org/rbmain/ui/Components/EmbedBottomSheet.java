...
public class EmbedBottomSheet extends BottomSheet {
    ...
    class YoutubeProxy {
        ...
        public void postEvent(String str, String str2) {
            if ("loaded".equals(str)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$YoutubeProxy$$ExternalSyntheticLambda0
    ...
    private EmbedBottomSheet(Context context, String str, String str2, String str3, String str4, int i, int i2, int i3) {
        ...
        this.onShowListener = new DialogInterface.OnShowListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.1
            @Override // android.content.DialogInterface.OnShowListener
            public void onShow(DialogInterface dialogInterface) {
                if (EmbedBottomSheet.this.pipVideoView == null || !EmbedBottomSheet.this.videoView.isInline()) {
                    return;
                }
                EmbedBottomSheet.this.videoView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.1.1
        ...
        this.fullscreenVideoContainer.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda5
        ...
        this.fullscreenVideoContainer.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda6
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return EmbedBottomSheet.lambda$new$1(view, motionEvent);
            }
        });
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.rbmain.ui.Components.EmbedBottomSheet.2
        ...
        frameLayout2.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda4
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        WebView webView = new WebView(context) { // from class: org.rbmain.ui.Components.EmbedBottomSheet.3
        ...
        this.webView.setWebChromeClient(new WebChromeClient() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.4
        ...
        this.webView.setWebViewClient(new WebViewClient() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.5
        ...
        WebPlayerView webPlayerView = new WebPlayerView(context, true, false, new WebPlayerView.WebPlayerViewDelegate() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.6
            ...
            public void onInitFailed() {
                ...
                map.put("Referer", "messenger.rubika.ir");
                try {
            ...
            public void prepareToSwitchInlineMode(boolean z, final Runnable runnable, float f, boolean z2) {
                if (z) {
                    ...
                    if (z2) {
                        ...
                        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.6.1
            ...
            @Override // org.rbmain.ui.Components.WebPlayerView.WebPlayerViewDelegate
            public TextureView onSwitchInlineMode(View view, boolean z, float f, int i5, boolean z2) {
                if (z) {
                    view.setTranslationY(0.0f);
                    EmbedBottomSheet.this.pipVideoView = new PipVideoView(false);
                    return EmbedBottomSheet.this.pipVideoView.show(EmbedBottomSheet.this.parentActivity, EmbedBottomSheet.this, view, f, i5, null);
                }
                if (z2) {
                    ...
                    animatorSet.setInterpolator(new DecelerateInterpolator());
                    animatorSet.setDuration(250L);
                    animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.6.2
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda1
        ...
        this.pipButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                this.f$0.lambda$new$4(view3);
            }
        });
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        textView5.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
        ...
        setDelegate(new BottomSheet.BottomSheetDelegate() { // from class: org.rbmain.ui.Components.EmbedBottomSheet.8
            /* JADX WARN: Multi-variable type inference failed */
            /* JADX WARN: Removed duplicated region for block: B:37:0x016e  */
            @Override // org.rbmain.ui.ActionBar.BottomSheet.BottomSheetDelegate, org.rbmain.ui.ActionBar.BottomSheet.BottomSheetDelegateInterface
            /*
            ...
            */
            public void onOpenAnimationEnd() {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.EmbedBottomSheet.AnonymousClass8.onOpenAnimationEnd():void");
            }
        ...
        this.orientationEventListener = new OrientationEventListener(ApplicationLoader.applicationContext) { // from class: org.rbmain.ui.Components.EmbedBottomSheet.9
        ...
        String youTubeVideoId = this.videoView.getYouTubeVideoId(this.embedUrl);
    ...
    public /* synthetic */ void lambda$new$5(View view) {
        ...
        if (activity instanceof LaunchActivity) {
            ((LaunchActivity) activity).showBulletin(new Function() { // from class: org.rbmain.ui.Components.EmbedBottomSheet$$ExternalSyntheticLambda7
