...
public class OtherDocumentPlaceholderDrawable extends RecyclableDrawable implements DownloadController.FileDownloadProgressListener {
    ...
    public OtherDocumentPlaceholderDrawable(Context context, View view, MessageObject messageObject) {
        ...
        if (messageObject.getDocument() != null) {
            ...
            this.ext = iLastIndexOf == -1 ? BuildConfig.FLAVOR : this.fileName.substring(iLastIndexOf + 1).toUpperCase();
    ...
    @Override // org.rbmain.ui.Components.RecyclableDrawable
    public void recycle() {
    ...
    */
    public void checkFileExist() {
        /*
            r6 = this;
            org.rbmain.messenger.MessageObject r0 = r6.parentMessageObject
            r1 = 0
            r2 = 1
            r3 = 0
            if (r0 == 0) goto L8b
            org.rbmain.tgnet.TLRPC$Message r0 = r0.messageOwner
            org.rbmain.tgnet.TLRPC$MessageMedia r4 = r0.media
            if (r4 == 0) goto L8b
            r4 = 0
            ...
            org.rbmain.messenger.MessageObject r5 = r6.parentMessageObject
            org.rbmain.tgnet.TLRPC$Message r5 = r5.messageOwner
        ...
        L27:
            org.rbmain.messenger.MessageObject r0 = r6.parentMessageObject
            org.rbmain.tgnet.TLRPC$Message r0 = r0.messageOwner
            java.io.File r0 = org.rbmain.messenger.FileLoader.getPathToMessage(r0)
            boolean r0 = r0.exists()
            if (r0 != 0) goto L3f
            org.rbmain.messenger.MessageObject r0 = r6.parentMessageObject
            org.rbmain.tgnet.TLRPC$Document r0 = r0.getDocument()
            java.lang.String r4 = org.rbmain.messenger.FileLoader.getAttachFileName(r0)
        L3f:
            r6.loaded = r3
            if (r4 != 0) goto L55
            ...
            org.rbmain.messenger.DownloadController r0 = org.rbmain.messenger.DownloadController.getInstance(r0)
        ...
        L55:
            ...
            org.rbmain.messenger.MessageObject r0 = r6.parentMessageObject
            int r0 = r0.currentAccount
            org.rbmain.messenger.FileLoader r0 = org.rbmain.messenger.FileLoader.getInstance(r0)
            boolean r0 = r0.isLoadingFile(r4)
            r6.loading = r0
            if (r0 == 0) goto L88
            r6.progressVisible = r2
            org.rbmain.messenger.ImageLoader r0 = org.rbmain.messenger.ImageLoader.getInstance()
        ...
        L9f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.OtherDocumentPlaceholderDrawable.checkFileExist():void");
    }
