...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, 255, 0, 300), createEllipsizeAnimator(textAlphaSpanArr[1], 0, 255, ImageReceiver.DEFAULT_CROSSFADE_DURATION, 300), createEllipsizeAnimator(textAlphaSpanArr[2], 0, 255, 300, 300), createEllipsizeAnimator(textAlphaSpanArr[0], 255, 0, CloseCodes.NORMAL_CLOSURE, 400), createEllipsizeAnimator(textAlphaSpanArr[1], 255, 0, CloseCodes.NORMAL_CLOSURE, 400), createEllipsizeAnimator(textAlphaSpanArr[2], 255, 0, CloseCodes.NORMAL_CLOSURE, 400));
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.EllipsizeSpanAnimator.1
            private Runnable restarter = new Runnable() { // from class: org.rbmain.ui.Components.EllipsizeSpanAnimator.1.1
    ...
    private Animator createEllipsizeAnimator(final TextAlphaSpan textAlphaSpan, int i, int i2, int i3, int i4) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.EllipsizeSpanAnimator$$ExternalSyntheticLambda0
