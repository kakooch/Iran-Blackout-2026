...
public class FilterGLThread extends DispatchQueue {
    ...
    public FilterGLThread(SurfaceTexture surfaceTexture, Bitmap bitmap, int i, boolean z) {
        ...
        this.drawRunnable = new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread.1
    ...
    public void setFilterGLThreadDelegate(final FilterShaders.FilterShadersDelegate filterShadersDelegate) {
        postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setFilterGLThreadDelegate$0(filterShadersDelegate);
            }
        });
    }
        ...
        if (iArr[0] > 0) {
            ...
            if (surfaceTexture instanceof SurfaceTexture) {
                ...
                if (this.videoDelegate != null) {
                    ...
                    surfaceTexture2.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda0
                        @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
                        public final void onFrameAvailable(SurfaceTexture surfaceTexture3) {
                            this.f$0.lambda$initGL$1(surfaceTexture3);
                        }
                    });
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public void setVideoSize(final int i, final int i2) {
        postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setVideoSize$3(i, i2);
            }
        });
    }
    ...
    public Bitmap getTexture() throws InterruptedException {
        ...
        try {
            if (postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$getTexture$4(bitmapArr, countDownLatch);
                }
            })) {
    ...
    public void shutdown() {
        postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setSurfaceTextureSize(final int i, final int i2) {
        postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setSurfaceTextureSize$6(i, i2);
            }
        });
    }
    ...
    public void requestRender(final boolean z, final boolean z2, final boolean z3) {
        postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.FilterGLThread$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$requestRender$7(z, z3, z2);
            }
        });
    }
