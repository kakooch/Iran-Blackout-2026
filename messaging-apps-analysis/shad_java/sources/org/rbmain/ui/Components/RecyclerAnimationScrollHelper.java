...
public class RecyclerAnimationScrollHelper {
    ...
    /* renamed from: org.rbmain.ui.Components.RecyclerAnimationScrollHelper$1, reason: invalid class name */
    class AnonymousClass1 implements View.OnLayoutChangeListener {
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.RecyclerAnimationScrollHelper$1$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    this.f$0.lambda$onLayoutChange$0(arrayList2, z2, i13, arrayList, valueAnimator2);
                }
            });
            RecyclerAnimationScrollHelper.this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.RecyclerAnimationScrollHelper.1.1
            ...
            if (z) {
                ...
                long measuredHeight = (long) (((i13 / RecyclerAnimationScrollHelper.this.recyclerView.getMeasuredHeight()) + 1.0f) * 200.0f);
