...
public class UnreadCounterTextView extends View {
    ...
    public void setText(CharSequence charSequence, boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.UnreadCounterTextView$$ExternalSyntheticLambda0
