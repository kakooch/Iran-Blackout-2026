...
public class SeekBarWaveform {
        ...
        while (i3 < length) {
            if (i3 == i4) {
                ...
                if (i11 > 0) {
                    ...
                    if (i12 < bArr2.length) {
                        bMin = (byte) (((byte) (bMin << i11)) | (bArr2[i12] & ((2 << (i11 - 1)) - 1)));
                    }
                }
                int i13 = 0;
                while (i13 < i7) {
    ...
    public void draw(Canvas canvas, View view) {
        ...
        if (fArr2 != null && (fArr = this.toHeights) != null) {
            ...
            int iMax = Math.max(fArr2.length, fArr.length);
            ...
            for (int i6 = 0; i6 < iMax; i6++) {
                float f6 = i6;
                int iClamp = MathUtils.clamp((int) Math.floor((f6 / iMax) * iMin), 0, iMin - 1);
                if (i5 < iClamp) {
                    addBar(this.path, AndroidUtilities.lerp(iClamp, f6, f5) * AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(AndroidUtilities.lerp(fArr5[iClamp], fArr6[i6], f5)));
                    i5 = iClamp;
                } else {
                    addBar(this.alphaPath, AndroidUtilities.lerp(iClamp, f6, f5) * AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(AndroidUtilities.lerp(fArr5[iClamp], fArr6[i6], f5)));
                    f = f5;
                }
            }
        } else {
            if (this.heights != null) {
                while (true) {
                    float f7 = i2;
                    if (f7 >= fDpf2 || i2 >= this.heights.length) {
                        break;
                    }
                    float fDpf22 = AndroidUtilities.dpf2(3.0f) * f7;
                    float fClamp = MathUtils.clamp((f4 * fDpf2) - f7, 0.0f, 1.0f);
                    addBar(this.path, fDpf22, (AndroidUtilities.dpf2(this.heights[i2]) * fClamp) - (AndroidUtilities.dpf2(1.0f) * (1.0f - fClamp)));
                    i2++;
                }
            }
            f = 0.0f;
