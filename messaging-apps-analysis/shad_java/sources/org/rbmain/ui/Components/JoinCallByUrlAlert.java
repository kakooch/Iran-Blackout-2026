...
public class JoinCallByUrlAlert extends BottomSheet {
    ...
    public JoinCallByUrlAlert(Context context, TLRPC$Chat tLRPC$Chat) {
        ...
        bottomSheetCell.background.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.JoinCallByUrlAlert$$ExternalSyntheticLambda0
