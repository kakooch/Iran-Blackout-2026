...
import org.rbmain.ui.Components.Crop.CropRotationWheel;
import org.rbmain.ui.Components.Crop.CropTransform;
import org.rbmain.ui.Components.Crop.CropView;
...
public class PhotoCropView extends FrameLayout {
    ...
    public PhotoCropView(Context context) {
        ...
        this.ANIMATION_VALUE = new AnimationProperties.FloatProperty<PhotoCropView>("thumbAnimationProgress") { // from class: org.rbmain.ui.Components.PhotoCropView.1
        ...
        this.PROGRESS_VALUE = new AnimationProperties.FloatProperty<PhotoCropView>("thumbImageVisibleProgress") { // from class: org.rbmain.ui.Components.PhotoCropView.2
            @Override // org.rbmain.ui.Components.AnimationProperties.FloatProperty
            public void setValue(PhotoCropView photoCropView, float f) {
        ...
        cropView.setListener(new CropView.CropViewListener() { // from class: org.rbmain.ui.Components.PhotoCropView.3
            @Override // org.rbmain.ui.Components.Crop.CropView.CropViewListener
        ...
        cropRotationWheel.setListener(new CropRotationWheel.RotationWheelListener() { // from class: org.rbmain.ui.Components.PhotoCropView.4
            @Override // org.rbmain.ui.Components.Crop.CropRotationWheel.RotationWheelListener
            public void onStart() {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.thumbImageVisible && view == (cropView = this.cropView)) {
            ...
            this.circlePaint.setColor(Theme.getColor(Theme.key_dialogFloatingButton));
    ...
    public void setVideoThumb(Bitmap bitmap, int i) {
        ...
        this.thumbAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.PhotoCropView.5
    ...
    public void setVideoThumbVisible(boolean z) {
        ...
        this.thumbOverrideAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.PhotoCropView.6
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
