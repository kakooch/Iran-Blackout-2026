...
public class NumberPicker extends LinearLayout {
    ...
    private void init() {
        ...
        setAccessibilityDelegate(new SeekBarAccessibilityDelegate() { // from class: org.rbmain.ui.Components.NumberPicker.1
    ...
    */
    public boolean dispatchKeyEvent(android.view.KeyEvent r6) {
        ...
        L47:
            ...
            r5.mLastHandledDownDpadKeyCode = r0
            r5.removeAllCallbacks()
            org.rbmain.ui.Components.Scroller r6 = r5.mFlingScroller
        ...
        L60:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.NumberPicker.dispatchKeyEvent(android.view.KeyEvent):boolean");
    }
    ...
    private void setValueInternal(int i, boolean z) {
        ...
        this.mValue = iMin;
        updateInputTextView();
        if (Math.abs(i2 - iMin) > 0.9f && Build.VERSION.SDK_INT >= 27) {
            try {
    ...
    private boolean ensureScrollWheelAdjusted() {
        ...
        this.mAdjustScroller.startScroll(0, 0, 0, i, MediaController.MAX_WIDTH_HEIGHT_SIZE);
        invalidate();
        return true;
    }
