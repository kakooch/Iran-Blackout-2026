...
public class Switch extends View {
    ...
    public void setDrawRipple(boolean z) {
        ...
        if (this.rippleDrawable == null) {
            ...
            paint.setColor(-1);
            RippleDrawable rippleDrawable = new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{0}), null, i >= 23 ? null : new Drawable() { // from class: org.rbmain.ui.Components.Switch.1
    ...
    private void animateToCheckedState(boolean z) {
        ...
        objectAnimatorOfFloat.setDuration(this.semHaptics ? 150L : 250L);
        this.checkAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.Switch.2
    ...
    private void animateIcon(boolean z) {
        ...
        objectAnimatorOfFloat.setDuration(this.semHaptics ? 150L : 250L);
        this.iconAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.Switch.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
    ...
    */
    protected void onDraw(android.graphics.Canvas r32) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.Switch.onDraw(android.graphics.Canvas):void");
    }
    ...
    private void vibrateChecked(boolean z) {
        try {
            ...
            VibrationEffect vibrationEffectCreateWaveform = VibrationEffect.createWaveform(new long[]{75, 10, 5, 10}, new int[]{5, 20, 110, 20}, -1);
            vibrator.cancel();
