...
public class ShutterButton extends View {
    ...
    public ShutterButton(Context context) {
        ...
        this.longPressed = new Runnable() { // from class: org.rbmain.ui.Components.ShutterButton.1
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.state != State.RECORDING) {
            if (this.redProgress != 0.0f) {
                canvas.drawCircle(f, f2, AndroidUtilities.dp(26.0f) * scaleX, this.redPaint);
                return;
            }
            return;
        }
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.dp(26.0f) * scaleX * this.redProgress, this.redPaint);
    }
