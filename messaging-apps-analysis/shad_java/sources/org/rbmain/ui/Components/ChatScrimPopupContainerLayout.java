...
public class ChatScrimPopupContainerLayout extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (reactionsContainerLayout != null && this.popupWindowLayout != null) {
            ...
            if (this.reactionsLayout.showCustomEmojiReaction()) {
                ...
                int iDp2 = ((AndroidUtilities.dp(36.0f) * iDp) + AndroidUtilities.dp(16.0f)) - AndroidUtilities.dp(8.0f);
    ...
    public void setPopupWindowLayout(final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        ...
        actionBarPopupWindowLayout.setOnSizeChangedListener(new ActionBarPopupWindow.onSizeChangedListener() { // from class: org.rbmain.ui.Components.ChatScrimPopupContainerLayout$$ExternalSyntheticLambda0
            @Override // org.rbmain.ui.ActionBar.ActionBarPopupWindow.onSizeChangedListener
            public final void onSizeChanged() {
                this.f$0.lambda$setPopupWindowLayout$0(actionBarPopupWindowLayout);
            }
        });
        if (actionBarPopupWindowLayout.getSwipeBack() != null) {
            actionBarPopupWindowLayout.getSwipeBack().addOnSwipeBackProgressListener(new PopupSwipeBackLayout.OnSwipeBackProgressListener() { // from class: org.rbmain.ui.Components.ChatScrimPopupContainerLayout$$ExternalSyntheticLambda1
                @Override // org.rbmain.ui.Components.PopupSwipeBackLayout.OnSwipeBackProgressListener
