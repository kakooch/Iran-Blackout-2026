...
public class ReplaceableIconDrawable extends Drawable implements Animator.AnimatorListener {
    ...
    public void setIcon(Drawable drawable, boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.ReplaceableIconDrawable$$ExternalSyntheticLambda0
