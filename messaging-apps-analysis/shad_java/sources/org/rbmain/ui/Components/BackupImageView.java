...
public class BackupImageView extends View {
    ...
    public BackupImageView(Context context) {
        ...
        imageReceiverCreateImageReciever.setAllowLoadingOnAttachedOnly(true);
        this.imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.rbmain.ui.Components.BackupImageView$$ExternalSyntheticLambda0
    ...
    public void setImageResource(int i, int i2) throws Resources.NotFoundException {
