...
public class AnimatedTextView extends View {
    ...
    public static class AnimatedTextDrawable extends Drawable {
        ...
        */
        public void draw(android.graphics.Canvas r17) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.AnimatedTextView.AnimatedTextDrawable.draw(android.graphics.Canvas):void");
        }
        ...
        public void setText(CharSequence charSequence, boolean z, boolean z2) {
            ...
            if (z) {
                ...
                diff(this.splitByWords ? new WordSequence(this.oldText) : this.oldText, this.splitByWords ? new WordSequence(this.currentText) : this.currentText, new RegionCallback() { // from class: org.rbmain.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda3
                    @Override // org.rbmain.ui.Components.AnimatedTextView.AnimatedTextDrawable.RegionCallback
                ...
                }, new RegionCallback() { // from class: org.rbmain.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda2
                    @Override // org.rbmain.ui.Components.AnimatedTextView.AnimatedTextDrawable.RegionCallback
                    public final void run(CharSequence charSequence2, int i, int i2) {
                        this.f$0.lambda$setText$1(iWidth, arrayList, charSequence2, i, i2);
                    }
                }, new RegionCallback() { // from class: org.rbmain.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda1
                    @Override // org.rbmain.ui.Components.AnimatedTextView.AnimatedTextDrawable.RegionCallback
                    public final void run(CharSequence charSequence2, int i, int i2) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.AnimatedTextView$AnimatedTextDrawable$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        this.f$0.lambda$setText$3(valueAnimator3);
                    }
                });
                this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.AnimatedTextView.AnimatedTextDrawable.1
            ...
            this.t = 0.0f;
            if (!charSequence.equals(this.currentText)) {
                this.currentParts = new Part[]{new Part(this, makeLayout(charSequence, iWidth), 0.0f, -1)};
                this.currentText = charSequence;
        ...
        public /* synthetic */ void lambda$setText$0(int i, ArrayList arrayList, ArrayList arrayList2, CharSequence charSequence, int i2, int i3) {
            ...
            Part part = new Part(this, staticLayoutMakeLayout, this.currentWidth, arrayList.size());
            Part part2 = new Part(this, staticLayoutMakeLayout, this.oldWidth, arrayList.size());
            arrayList2.add(part);
            arrayList.add(part2);
            float f = part.width;
            this.currentWidth += f;
        ...
        public static boolean partEquals(CharSequence charSequence, CharSequence charSequence2, int i, int i2) {
            ...
            if (charSequenceWordAt == null && charSequenceWordAt2 == null) {
                return true;
            }
            return charSequenceWordAt != null && charSequenceWordAt.equals(charSequenceWordAt2);
        }
        ...
        private void diff(CharSequence charSequence, CharSequence charSequence2, RegionCallback regionCallback, RegionCallback regionCallback2, RegionCallback regionCallback3) {
            if (this.preserveIndex) {
                ...
                if (charSequence2.length() - iMin > 0) {
                    regionCallback2.run(charSequence2.subSequence(iMin, charSequence2.length()), iMin, charSequence2.length());
                }
                if (charSequence.length() - iMin > 0) {
                    regionCallback3.run(charSequence.subSequence(iMin, charSequence.length()), iMin, charSequence.length());
                    return;
                }
                return;
            }
                ...
                if (z6 != z7 || length5 == iMin2) {
                    ...
                    if (i12 > 0 || i13 > 0) {
                        if (i12 == i13 && z6) {
                            ...
                            if (i12 > 0) {
                                regionCallback2.run(charSequence2.subSequence(i10, length5), i10, length5);
                            }
                            if (i13 > 0) {
                                regionCallback3.run(charSequence.subSequence(i11, length6), i11, length6);
                            }
                        }
                    }
                    i10 = length5;
    ...
    public AnimatedTextView(Context context, boolean z, boolean z2, boolean z3) {
        ...
        this.drawable.setOnAnimationFinishListener(new Runnable() { // from class: org.rbmain.ui.Components.AnimatedTextView$$ExternalSyntheticLambda0
