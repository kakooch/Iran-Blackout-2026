...
public class RLottieImageView extends ImageView {
    ...
    public void setAnimation(TLRPC$Document tLRPC$Document, final int i, final int i2) {
        ...
        ImageReceiver imageReceiver2 = new ImageReceiver() { // from class: org.rbmain.ui.Components.RLottieImageView.1
        ...
        if (this.onlyLastFrame) {
            ...
            if ("video/webm".equals(tLRPC$Document.mime_type)) {
                ...
                sb.append("_");
                sb.append(i2);
                sb.append(this.cached ? "_pcache" : BuildConfig.FLAVOR);
                sb.append("_");
                ...
                sb2.append("_");
                sb2.append(i2);
                sb2.append(this.cached ? "_pcache" : BuildConfig.FLAVOR);
        ...
        setImageDrawable(new Drawable() { // from class: org.rbmain.ui.Components.RLottieImageView.2
