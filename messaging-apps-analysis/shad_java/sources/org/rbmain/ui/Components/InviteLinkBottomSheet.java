...
import org.rbmain.tgnet.TLRPC$TL_chatInviteImporter;
...
import org.rbmain.tgnet.TLRPC$TL_messages_chatInviteImporters;
...
import org.rbmain.tgnet.TLRPC$TL_messages_getChatInviteImporters;
...
public class InviteLinkBottomSheet extends BottomSheet {
    ...
    public InviteLinkBottomSheet(Context context, final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, TLRPC$ChatFull tLRPC$ChatFull, final HashMap<Integer, TLRPC$User> map, final BaseFragment baseFragment, int i, boolean z, boolean z2) {
        super(context, false);
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.1
            ...
            */
            protected void onDraw(android.graphics.Canvas r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.InviteLinkBottomSheet.AnonymousClass1.onDraw(android.graphics.Canvas):void");
            }
        };
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.2
            int lastH;
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.3
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.4
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
            public void onItemClick(View view2, int i2) {
                TLRPC$User tLRPC$User;
                InviteLinkBottomSheet inviteLinkBottomSheet = InviteLinkBottomSheet.this;
                if (i2 == inviteLinkBottomSheet.creatorRow && tLRPC$TL_chatInviteExported.admin_id == UserConfig.getInstance(((BottomSheet) inviteLinkBottomSheet).currentAccount).clientUserId) {
                    return;
                }
                InviteLinkBottomSheet inviteLinkBottomSheet2 = InviteLinkBottomSheet.this;
                int i3 = inviteLinkBottomSheet2.creatorRow;
                if (i2 == i3 || (i2 >= inviteLinkBottomSheet2.usersStartRow && i2 < inviteLinkBottomSheet2.usersEndRow)) {
                    if (i2 == i3) {
                        tLRPC$User = (TLRPC$User) map.get(Integer.valueOf(tLRPC$TL_chatInviteExported.admin_id));
                    } else {
                        tLRPC$User = (TLRPC$User) map.get(Integer.valueOf(inviteLinkBottomSheet2.invitedUsers.get(i2 - inviteLinkBottomSheet2.usersStartRow).user_id));
                    }
                    if (tLRPC$User != null) {
        ...
        updateRows();
        loadUsers();
        if (map == null || map.get(Integer.valueOf(tLRPC$TL_chatInviteExported.admin_id)) == null) {
            loadCreator();
        }
        updateColors();
    }
    ...
    private void loadCreator() {
        ...
        ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$TL_users_getUsers, new RequestDelegate() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ void lambda$loadCreator$0(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.5
            @Override // java.lang.Runnable
            public void run() {
                if (tLRPC$TL_error == null) {
                    TLRPC$User tLRPC$User = (TLRPC$User) ((TLRPC$Vector) tLObject).objects.get(0);
                    InviteLinkBottomSheet inviteLinkBottomSheet = InviteLinkBottomSheet.this;
                    inviteLinkBottomSheet.users.put(Integer.valueOf(inviteLinkBottomSheet.invite.admin_id), tLRPC$User);
    ...
    class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                case 1:
                    ...
                    break;
                case 2:
                    userCell = new ShadowSectionCell(context, 12, Theme.getColor(Theme.key_windowBackgroundGray));
                    break;
                case 3:
                    InviteLinkBottomSheet inviteLinkBottomSheet = InviteLinkBottomSheet.this;
                ...
                case 5:
                    ...
                    break;
                case 6:
                    userCell = new View(this, context) { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.Adapter.2
                        @Override // android.view.View
                        protected void onMeasure(int i2, int i3) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    userCell = new EmptyHintRow(InviteLinkBottomSheet.this, context);
                    break;
                default:
        ...
        /* renamed from: org.rbmain.ui.Components.InviteLinkBottomSheet$Adapter$1, reason: invalid class name */
        class AnonymousClass1 implements LinkActionView.Delegate {
            ...
            public void revokeLink() {
                ...
                if (baseFragment instanceof ManageLinksActivity) {
                    ...
                    ConnectionsManager.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).sendRequest(tLRPC$TL_messages_editExportedChatInvite, new RequestDelegate() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda3
                        @Override // org.rbmain.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            public /* synthetic */ void lambda$revokeLink$1(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$revokeLink$0(tLRPC$TL_error, tLObject);
                    }
                });
            }
            ...
            public void editLink() {
                ...
                if (baseFragment instanceof ManageLinksActivity) {
                    ...
                    linkEditActivity.setCallback(new LinkEditActivity.Callback() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.Adapter.1.1
            ...
            public void removeLink() {
                ...
                if (baseFragment instanceof ManageLinksActivity) {
                    ...
                    ConnectionsManager.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).sendRequest(tLRPC$TL_messages_deleteExportedChatInvite, new RequestDelegate() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda2
                        @Override // org.rbmain.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
            ...
            public /* synthetic */ void lambda$removeLink$3(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet$Adapter$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$removeLink$2(tLRPC$TL_error);
                    }
                });
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == inviteLinkBottomSheet.usersHeaderRow) {
                    int i4 = inviteLinkBottomSheet.invite.usage;
                    if (i4 > 0) {
                        headerCell.setText(LocaleController.formatPluralString("PeopleJoined", i4));
                    } else {
            ...
            if (itemViewType == 1) {
                ...
                if (i == inviteLinkBottomSheet2.creatorRow) {
                    TLRPC$User user = inviteLinkBottomSheet2.users.get(Integer.valueOf(inviteLinkBottomSheet2.invite.admin_id));
                    if (user == null) {
                        user = MessagesController.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).getUser(Integer.valueOf(InviteLinkBottomSheet.this.invite.admin_id));
                    }
                    ...
                    if (tLRPC$ChatFull != null && user != null && tLRPC$ChatFull.participants != null) {
                        while (true) {
                            if (i5 >= InviteLinkBottomSheet.this.info.participants.participants.size()) {
                                break;
                            }
                            if (InviteLinkBottomSheet.this.info.participants.participants.get(i5).user_id == user.id) {
                                TLRPC$ChatParticipant tLRPC$ChatParticipant = InviteLinkBottomSheet.this.info.participants.participants.get(i5);
                    ...
                    tLRPC$User = InviteLinkBottomSheet.this.users.get(Integer.valueOf(inviteLinkBottomSheet2.invitedUsers.get(i - inviteLinkBottomSheet2.usersStartRow).user_id));
                    str = null;
                }
            ...
            if (itemViewType != 4) {
                ...
                int i6 = InviteLinkBottomSheet.this.invite.usage_limit;
                if (i6 > 0) {
                    emptyHintRow.textView.setText(LocaleController.formatPluralString("PeopleCanJoinViaLinkCount", i6));
            ...
            if (tLRPC$TL_chatInviteExported2.expired) {
                int i7 = tLRPC$TL_chatInviteExported2.usage_limit;
                if (i7 > 0 && i7 == tLRPC$TL_chatInviteExported2.usage) {
            ...
            if (tLRPC$TL_chatInviteExported2.expire_date > 0) {
                ...
                long j = (i8 * 1000) - jCurrentTimeMillis;
                if (j < 0) {
                    j = 0;
                }
                if (j > 86400000) {
    ...
    private void runShadowAnimation(final boolean z) {
        ...
        this.shadowAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.6
    ...
    public void loadUsers() {
        ...
        ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$TL_messages_getChatInviteImporters, new RequestDelegate() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet$$ExternalSyntheticLambda1
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadUsers$2(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadUsers$1(tLRPC$TL_error, tLObject);
            }
        });
    }
    ...
    private class TimerPrivacyCell extends TextInfoPrivacyCell {
        ...
        public TimerPrivacyCell(Context context) {
            super(context);
            this.timerRunnable = new Runnable() { // from class: org.rbmain.ui.Components.InviteLinkBottomSheet.TimerPrivacyCell.1
                @Override // java.lang.Runnable
                public void run() {
