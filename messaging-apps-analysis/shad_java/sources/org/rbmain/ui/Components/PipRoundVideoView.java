...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void show(Activity activity, Runnable runnable) {
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: org.rbmain.ui.Components.PipRoundVideoView.1
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(activity) { // from class: org.rbmain.ui.Components.PipRoundVideoView.2
                @Override // android.view.ViewGroup
            ...
            aspectRatioFrameLayout.setOutlineProvider(new ViewOutlineProvider(this) { // from class: org.rbmain.ui.Components.PipRoundVideoView.3
            ...
            AspectRatioFrameLayout aspectRatioFrameLayout2 = new AspectRatioFrameLayout(activity) { // from class: org.rbmain.ui.Components.PipRoundVideoView.4
    ...
    public void showTemporary(boolean z) {
        ...
        this.hideShowAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.PipRoundVideoView.5
    ...
    private void runShowHideAnimation(final boolean z) {
        ...
        this.hideShowAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.PipRoundVideoView.6
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                if (animator.equals(PipRoundVideoView.this.hideShowAnimation)) {
                    if (!z) {
    ...
    */
    public void animateToBoundsMaybe() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }
