...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayoutPhoto.SizeNotifierFrameLayoutPhotoDelegate {
    ...
    public PhotoViewerCaptionEnterView(Context context, SizeNotifierFrameLayoutPhoto sizeNotifierFrameLayoutPhoto, View view) {
        ...
        this.emojiButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda5
        ...
        EditTextCaption editTextCaption = new EditTextCaption(context, null) { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView.1
        ...
        editTextCaption3.setFilters(InputFilterHelper.getFilter(this.captionMaxLength, 64, editTextCaption3));
        ...
        this.messageEditText.setOnKeyListener(new View.OnKeyListener() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda6
            @Override // android.view.View.OnKeyListener
            public final boolean onKey(View view2, int i, KeyEvent keyEvent) {
                return this.f$0.lambda$new$1(view2, i, keyEvent);
            }
        });
        this.messageEditText.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
        ...
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
    ...
    /* renamed from: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$2, reason: invalid class name */
    class AnonymousClass2 implements TextWatcher {
        ...
        */
        public void afterTextChanged(android.text.Editable r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.PhotoViewerCaptionEnterView.AnonymousClass2.afterTextChanged(android.text.Editable):void");
        }
        ...
        public /* synthetic */ void lambda$afterTextChanged$0(ValueAnimator valueAnimator) {
            ...
            Theme.setDrawableColor(PhotoViewerCaptionEnterView.this.checkDrawable, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_dialogFloatingIcon), (int) (Color.alpha(r5) * ((PhotoViewerCaptionEnterView.this.sendButtonEnabledProgress * 0.42f) + 0.58f))));
    ...
    protected void onDraw(Canvas canvas) {
        if (this.shouldAnimateEditTextWithBounds) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda0
        ...
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                this.f$0.lambda$onDraw$5(valueAnimator3);
            }
        });
    ...
    public void updateColors() {
        Theme.setDrawableColor(this.doneDrawable, Theme.getColor(Theme.key_dialogFloatingButton));
        Theme.setDrawableColor(this.checkDrawable, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_dialogFloatingIcon), (int) (Color.alpha(r0) * ((this.sendButtonEnabledProgress * 0.42f) + 0.58f))));
    ...
    private void createEmojiView() {
        ...
        EmojiView emojiView = new EmojiView(null, false, false, getContext(), false, null);
        this.emojiView = emojiView;
        emojiView.setDelegate(new EmojiView.EmojiViewDelegate() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView.3
            ...
            public void onEmojiSelected(String str) {
                ...
                try {
                    try {
                        ...
                        CharSequence charSequenceReplaceEmoji = Emoji.replaceEmoji(str, PhotoViewerCaptionEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.dp(20.0f), false);
    ...
    public void setFieldFocused(boolean z) {
        ...
        if (z) {
            ...
            this.messageEditText.postDelayed(new Runnable() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda7
    ...
    private void showPopup(int i, boolean z) {
        ...
        if (this.sizeNotifierLayout != null) {
            if (z && SharedConfig.smoothKeyboard && i == 0 && this.emojiView != null) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView$$ExternalSyntheticLambda2
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        this.f$0.lambda$showPopup$7(f, valueAnimator);
                    }
                });
                valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.PhotoViewerCaptionEnterView.4
    ...
    @Override // org.rbmain.ui.Components.SizeNotifierFrameLayoutPhoto.SizeNotifierFrameLayoutPhotoDelegate
