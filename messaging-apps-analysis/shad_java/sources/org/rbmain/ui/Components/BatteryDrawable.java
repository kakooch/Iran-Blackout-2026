...
public class BatteryDrawable extends Drawable {
    ...
    public void setFillValue(float f, boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.Components.BatteryDrawable$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.lambda$setFillValue$0(valueAnimator2);
            }
        });
        this.fillValueAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.BatteryDrawable.1
