...
public class VectorAvatarThumbDrawable extends Drawable implements AnimatedEmojiSpan.InvalidateHolder, AttachableDrawable, NotificationCenter.NotificationCenterDelegate {
    ...
    public VectorAvatarThumbDrawable(TLRPC$VideoSize tLRPC$VideoSize, boolean z, int i) {
        ...
        if (tLRPC$VideoSize instanceof TLRPC$TL_videoSizeStickerMarkup) {
            ...
            ImageReceiver imageReceiver = new ImageReceiver() { // from class: org.rbmain.ui.Components.VectorAvatarThumbDrawable.1
    ...
    */
    private void setImage() {
        /*
            ...
            org.rbmain.messenger.MediaDataController r0 = org.rbmain.messenger.MediaDataController.getInstance(r0)
            org.rbmain.tgnet.TLRPC$TL_videoSizeStickerMarkup r1 = r15.sizeStickerMarkup
            org.rbmain.tgnet.TLRPC$InputStickerSet r1 = r1.stickerset
            r2 = 0
            org.rbmain.tgnet.TLRPC$TL_messages_stickerSet r0 = r0.getStickerSet(r1, r2)
            if (r0 == 0) goto L8c
            r1 = 1
            r15.imageSeted = r1
        L14:
            java.util.ArrayList<org.rbmain.tgnet.TLRPC$Document> r3 = r0.documents
            int r3 = r3.size()
            if (r2 >= r3) goto L8c
            java.util.ArrayList<org.rbmain.tgnet.TLRPC$Document> r3 = r0.documents
            java.lang.Object r3 = r3.get(r2)
            org.rbmain.tgnet.TLRPC$Document r3 = (org.rbmain.tgnet.TLRPC$Document) r3
            long r3 = r3.id
            org.rbmain.tgnet.TLRPC$TL_videoSizeStickerMarkup r5 = r15.sizeStickerMarkup
            long r5 = r5.sticker_id
            int r7 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r7 != 0) goto L89
            java.util.ArrayList<org.rbmain.tgnet.TLRPC$Document> r0 = r0.documents
            java.lang.Object r0 = r0.get(r2)
            org.rbmain.tgnet.TLRPC$Document r0 = (org.rbmain.tgnet.TLRPC$Document) r0
        ...
        L4f:
            r6 = r3
        L50:
            int r1 = org.rbmain.ui.ActionBar.Theme.key_windowBackgroundWhiteGrayIcon
            r2 = 1045220557(0x3e4ccccd, float:0.2)
            org.rbmain.messenger.SvgHelper$SvgDrawable r9 = org.rbmain.messenger.DocumentObject.getSvgThumb(r0, r1, r2)
            org.rbmain.messenger.ImageReceiver r2 = r15.imageReceiver
            org.rbmain.messenger.ImageLocation r1 = org.rbmain.messenger.ImageLocation.getForDocument(r0)
            org.rbmain.messenger.ImageLocation r5 = org.rbmain.messenger.ImageLocation.getForDocument(r3)
            r7 = 0
            r8 = 0
            r10 = 0
            r14 = 0
            ...
            r2 = 3
            if (r1 != r2) goto L8c
            org.rbmain.messenger.ImageReceiver r2 = r15.stickerPreloadImageReceiver
            org.rbmain.messenger.ImageLocation r3 = org.rbmain.messenger.ImageLocation.getForDocument(r0)
            r5 = 0
            r6 = 0
            r7 = 0
            r8 = 0
        ...
        L8c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.VectorAvatarThumbDrawable.setImage():void");
    }
    ...
    @Override // org.rbmain.ui.Components.AttachableDrawable
