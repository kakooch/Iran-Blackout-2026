...
import org.rbmain.ui.Components.GestureDetectorFixDoubleTap;
...
public class RecyclerListView extends RecyclerView {
    ...
    public interface OnItemClickListenerExtended {
        ...
        /* renamed from: org.rbmain.ui.Components.RecyclerListView$OnItemClickListenerExtended$-CC, reason: invalid class name */
    ...
    public interface OnItemLongClickListenerExtended {
        ...
        /* renamed from: org.rbmain.ui.Components.RecyclerListView$OnItemLongClickListenerExtended$-CC, reason: invalid class name */
        public final /* synthetic */ class CC {
    ...
    public static abstract class SectionsAdapter extends FastScrollAdapter {
        ...
        public void update(boolean z) {
            ...
            if (z) {
                DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.rbmain.ui.Components.RecyclerListView.SectionsAdapter.1
                    ...
                    public boolean areItemsTheSame(int i3, int i4) {
                        return CallProxy$$ExternalSyntheticBackport0.m(arrayList.get(i3), SectionsAdapter.this.hashes.get(i4));
                    }
    ...
    public class FastScroll extends View {
        ...
        public FastScroll(Context context, int i) {
            ...
            this.hideFloatingDateRunnable = new Runnable() { // from class: org.rbmain.ui.Components.RecyclerListView.FastScroll.1
            ...
            if (i == 0) {
                ...
                drawableMutate.setColorFilter(new PorterDuffColorFilter(ColorUtils.blendARGB(Theme.getColor(i2), -1, 0.1f), PorterDuff.Mode.MULTIPLY));
            }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:79:0x015a, code lost:
            ...
            if (r0 <= (org.rbmain.messenger.AndroidUtilities.dp(30.0f) + r8)) goto L81;
         */
        @Override // android.view.View
        /*
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.RecyclerListView.FastScroll.onTouchEvent(android.view.MotionEvent):boolean");
        }
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (linearLayoutManager.getOrientation() == 1) {
                    ...
                    if (adapter instanceof FastScrollAdapter) {
                        ...
                        if (this.type == 0) {
                            this.letterLayout = new StaticLayout(letter, this.letterPaint, CloseCodes.NORMAL_CLOSURE, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                        } else {
                            this.outLetterLayout = this.letterLayout;
                            int iMeasureText = ((int) this.letterPaint.measureText(letter)) + 1;
                            this.letterLayout = new StaticLayout(letter, this.letterPaint, iMeasureText, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                            if (this.outLetterLayout != null) {
                                ...
                                if (strArrSplit != null && strArrSplit2 != null && strArrSplit.length == 2 && strArrSplit2.length == 2 && strArrSplit[1].equals(strArrSplit2[1])) {
                                    ...
                                    this.outLetterLayout = new StaticLayout(spannableStringBuilder, this.letterPaint, ((int) this.letterPaint.measureText(string)) + 1, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                                    ...
                                    this.inLetterLayout = new StaticLayout(spannableStringBuilder2, this.letterPaint, iMeasureText, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                                    ...
                                    this.stableLetterLayout = new StaticLayout(spannableStringBuilder3, this.letterPaint, iMeasureText, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                                } else {
        ...
        */
        protected void onDraw(android.graphics.Canvas r19) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.RecyclerListView.FastScroll.onDraw(android.graphics.Canvas):void");
        }
    ...
    class RecyclerListViewItemClickListener implements RecyclerView.OnItemTouchListener {
        ...
        public RecyclerListViewItemClickListener(Context context) {
            RecyclerListView.this.gestureDetector = new GestureDetectorFixDoubleTap(context, new GestureDetectorFixDoubleTap.OnGestureListener(RecyclerListView.this) { // from class: org.rbmain.ui.Components.RecyclerListView.RecyclerListViewItemClickListener.1
                ...
                private void onPressItem(final View view, MotionEvent motionEvent) {
                    if (view != null) {
                        ...
                        AndroidUtilities.runOnUIThread(RecyclerListView.this.clickRunnable = new Runnable() { // from class: org.rbmain.ui.Components.RecyclerListView.RecyclerListViewItemClickListener.1.1
                            @Override // java.lang.Runnable
                            public void run() {
                ...
                @Override // org.rbmain.ui.Components.GestureDetectorFixDoubleTap.OnGestureListener
        ...
        */
        public boolean onInterceptTouchEvent(androidx.recyclerview.widget.RecyclerView r19, android.view.MotionEvent r20) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.Components.RecyclerListView.RecyclerListViewItemClickListener.onInterceptTouchEvent(androidx.recyclerview.widget.RecyclerView, android.view.MotionEvent):boolean");
        }
    ...
    public RecyclerListView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.accessibilityDelegate = new View.AccessibilityDelegate(this) { // from class: org.rbmain.ui.Components.RecyclerListView.1
        ...
        this.observer = new RecyclerView.AdapterDataObserver() { // from class: org.rbmain.ui.Components.RecyclerListView.2
        ...
        this.scroller = new Runnable() { // from class: org.rbmain.ui.Components.RecyclerListView.6
            @Override // java.lang.Runnable
            public void run() {
                int iDp;
                RecyclerListView recyclerListView = RecyclerListView.this;
        ...
        super.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.Components.RecyclerListView.3
    ...
    private void highlightRowInternal(IntReturnCallback intReturnCallback, int i, boolean z) {
        ...
        if (i > 0) {
            Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.Components.RecyclerListView$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
        ...
        if (z) {
            if (this.emptyViewAnimateToVisibility != i) {
                ...
                if (i == 0) {
                    ...
                    viewPropertyAnimatorAlpha.setDuration(150L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.Components.RecyclerListView.4
    ...
    public void addOverlayView(View view, FrameLayout.LayoutParams layoutParams) {
        if (this.overlayContainer == null) {
            this.overlayContainer = new FrameLayout(getContext()) { // from class: org.rbmain.ui.Components.RecyclerListView.5
