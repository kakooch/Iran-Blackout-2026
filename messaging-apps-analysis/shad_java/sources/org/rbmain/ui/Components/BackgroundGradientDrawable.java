...
public class BackgroundGradientDrawable extends GradientDrawable {
    ...
    public static class ListenerAdapter implements Listener {
        @Override // org.rbmain.ui.Components.BackgroundGradientDrawable.Listener
    ...
    public Disposable drawExactBoundsSize(Canvas canvas, final View view, float f) {
        ...
        final Disposable disposableStartDitheringInternal = startDitheringInternal(new IntSize[]{intSize}, new ListenerAdapter() { // from class: org.rbmain.ui.Components.BackgroundGradientDrawable.1
        ...
        Disposable disposablePut = this.disposables.put(view, new Disposable() { // from class: org.rbmain.ui.Components.BackgroundGradientDrawable$$ExternalSyntheticLambda2
            @Override // org.rbmain.ui.Components.BackgroundGradientDrawable.Disposable
    ...
    private Disposable startDitheringInternal(final IntSize[] intSizeArr, Listener listener, long j) {
        ...
        for (int i = 0; i < intSizeArr.length; i++) {
            ...
            if (intSize.width != 0 && intSize.height != 0) {
                ...
                final int i2 = i;
                Runnable runnable = new Runnable() { // from class: org.rbmain.ui.Components.BackgroundGradientDrawable$$ExternalSyntheticLambda0
        ...
        return new Disposable() { // from class: org.rbmain.ui.Components.BackgroundGradientDrawable$$ExternalSyntheticLambda3
            @Override // org.rbmain.ui.Components.BackgroundGradientDrawable.Disposable
    ...
    public /* synthetic */ void lambda$startDitheringInternal$2(final IntSize intSize, final Runnable[] runnableArr, final int i, final Listener[] listenerArr) {
        try {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.BackgroundGradientDrawable$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startDitheringInternal$3(Listener[] listenerArr, Runnable[] runnableArr, IntSize[] intSizeArr) throws InterruptedException {
        listenerArr[0] = null;
        if (this.ditheringRunnables.contains(runnableArr)) {
    ...
    /* renamed from: org.rbmain.ui.Components.BackgroundGradientDrawable$2, reason: invalid class name */
