...
public class RenderView extends TextureView {
    ...
    public RenderView(Context context, Painting painting, Bitmap bitmap) {
        ...
        this.painting.setDelegate(new Painting.PaintingDelegate() { // from class: org.rbmain.ui.Components.Paint.RenderView.2
            @Override // org.rbmain.ui.Components.Paint.Painting.PaintingDelegate
    ...
    /* renamed from: org.rbmain.ui.Components.Paint.RenderView$1, reason: invalid class name */
    class AnonymousClass1 implements TextureView.SurfaceTextureListener {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
            ...
            RenderView.this.updateTransform();
            RenderView.this.internal.requestRender();
            RenderView.this.internal.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$1$$ExternalSyntheticLambda1
        ...
        public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
            if (RenderView.this.internal != null && !RenderView.this.shuttingDown) {
                RenderView.this.painting.onPause(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void shutdown() {
        ...
        if (this.internal != null) {
            performInContext(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    class CanvasInternal extends DispatchQueue {
        ...
        /* renamed from: org.rbmain.ui.Components.Paint.RenderView$CanvasInternal$1, reason: invalid class name */
        class AnonymousClass1 implements Runnable {
            ...
            public void run() {
                ...
                if (!RenderView.this.firstDrawSent) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$CanvasInternal$1$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                ...
                RenderView.this.queue.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$CanvasInternal$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void requestRender() {
            postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$CanvasInternal$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$requestRender$0();
                }
            });
        }
        ...
        public void scheduleRedraw() {
            ...
            Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$CanvasInternal$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void shutdown() {
            postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$CanvasInternal$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public Bitmap getTexture() throws InterruptedException {
            ...
            try {
                postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$CanvasInternal$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void performInContext(final Runnable runnable) {
        ...
        canvasInternal.postRunnable(new Runnable() { // from class: org.rbmain.ui.Components.Paint.RenderView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$performInContext$1(runnable);
            }
        });
    }
