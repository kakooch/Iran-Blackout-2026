...
public class Painting {
    ...
    public void paintStroke(final Path path, final boolean z, final Runnable runnable) {
        this.renderView.performInContext(new Runnable() { // from class: org.rbmain.ui.Components.Paint.Painting$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$paintStroke$0(path, z, runnable);
            }
        });
    }
    ...
    public void commitStroke(final int i) {
        this.renderView.performInContext(new Runnable() { // from class: org.rbmain.ui.Components.Paint.Painting$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$commitStroke$1(i);
            }
        });
    }
    ...
    public void clearStroke() {
        this.renderView.performInContext(new Runnable() { // from class: org.rbmain.ui.Components.Paint.Painting$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void registerUndo(RectF rectF) {
        if (rectF != null && rectF.setIntersect(rectF, getBounds())) {
            ...
            this.delegate.requestUndoStore().registerUndo(UUID.randomUUID(), new Runnable() { // from class: org.rbmain.ui.Components.Paint.Painting$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$registerUndo$3(slice);
                }
            });
        }
    }
    ...
    public void lambda$registerUndo$3(final Slice slice) {
        this.renderView.performInContext(new Runnable() { // from class: org.rbmain.ui.Components.Paint.Painting$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() throws DataFormatException, IOException {
                this.f$0.lambda$restoreSlice$4(slice);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$restoreSlice$4(Slice slice) throws DataFormatException, IOException {
        PaintingDelegate paintingDelegate;
    ...
    public void onPause(final Runnable runnable) {
        this.renderView.performInContext(new Runnable() { // from class: org.rbmain.ui.Components.Paint.Painting$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onPause$5(runnable);
            }
        });
    }
