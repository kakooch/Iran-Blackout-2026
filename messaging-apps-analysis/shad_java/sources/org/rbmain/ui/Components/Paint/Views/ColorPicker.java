...
public class ColorPicker extends FrameLayout {
    ...
    public ColorPicker(Context context) {
        ...
        this.settingsButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.Paint.Views.ColorPicker$$ExternalSyntheticLambda1
        ...
        this.undoButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.Components.Paint.Views.ColorPicker$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
