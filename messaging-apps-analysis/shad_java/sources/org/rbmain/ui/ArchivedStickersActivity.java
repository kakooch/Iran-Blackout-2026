...
import org.rbmain.ui.Cells.ArchivedStickerSetCell;
...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.ArchivedStickersActivity.1
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.ArchivedStickersActivity$$ExternalSyntheticLambda3
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i) {
                this.f$0.lambda$createView$0(view, i);
            }
        });
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.ArchivedStickersActivity.3
    ...
    public /* synthetic */ void lambda$createView$0(final View view, int i) {
        ...
        stickersAlert.setInstallDelegate(new StickersAlert.StickersAlertInstallDelegate() { // from class: org.rbmain.ui.ArchivedStickersActivity.2
    ...
    public void getStickers() {
        ...
        tLRPC$TL_messages_getArchivedStickers.startId = this.startId;
        getMessageProxy().loadArchivedStickers(tLRPC$TL_messages_getArchivedStickers, new RequestDelegate() { // from class: org.rbmain.ui.ArchivedStickersActivity$$ExternalSyntheticLambda2
    ...
    public /* synthetic */ void lambda$getStickers$2(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArchivedStickersActivity$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$getStickers$1(tLRPC$TL_error, tLObject);
            }
        });
    }
    ...
    public void lambda$processResponse$3(final TLRPC$TL_messages_archivedStickers tLRPC$TL_messages_archivedStickers) {
        if (!this.isInTransition) {
            ...
            this.endReached = !tLRPC$TL_messages_archivedStickers.hasContinue;
            this.startId = tLRPC$TL_messages_archivedStickers.nextStartId;
        ...
        this.doOnTransitionEnd = new Runnable() { // from class: org.rbmain.ui.ArchivedStickersActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processResponse$3(tLRPC$TL_messages_archivedStickers);
            }
        };
    }
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (getItemViewType(i) == 0) {
                ...
                archivedStickerSetCell.setOnCheckedChangeListener(new ArchivedStickerSetCell.OnCheckedChangeListener() { // from class: org.rbmain.ui.ArchivedStickersActivity$ListAdapter$$ExternalSyntheticLambda0
                    @Override // org.rbmain.ui.Cells.ArchivedStickerSetCell.OnCheckedChangeListener
                    public final void onCheckedChanged(ArchivedStickerSetCell archivedStickerSetCell2, boolean z) {
                        this.f$0.lambda$onBindViewHolder$0(tLRPC$StickerSetCovered, archivedStickerSetCell2, z);
                    }
                });
                return;
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                loadingCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            } else if (i != 2) {
                loadingCell = null;
            } else {
