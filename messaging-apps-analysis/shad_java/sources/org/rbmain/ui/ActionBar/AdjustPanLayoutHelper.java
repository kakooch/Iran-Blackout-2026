...
public class AdjustPanLayoutHelper {
    ...
    public void animateHeight(int i, int i2, boolean z) {
        ...
        if (this.enabled) {
            ...
            this.animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ActionBar.AdjustPanLayoutHelper$$ExternalSyntheticLambda0
            ...
            this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.AdjustPanLayoutHelper.3
    ...
    */
    public void startTransition(int r6, int r7, boolean r8) {
        ...
        L74:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.AdjustPanLayoutHelper.startTransition(int, int, boolean):void");
    }
    ...
    public AdjustPanLayoutHelper(View view, boolean z) {
        this.usingInsetAnimator = false;
        this.delayedAnimationRunnable = new Runnable() { // from class: org.rbmain.ui.ActionBar.AdjustPanLayoutHelper.1
        ...
        this.onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: org.rbmain.ui.ActionBar.AdjustPanLayoutHelper.2
        ...
        this.parent = view;
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ActionBar.AdjustPanLayoutHelper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
    ...
    private void setupNewCallback() {
        ...
        view.setWindowInsetsAnimationCallback(new WindowInsetsAnimation.Callback(1) { // from class: org.rbmain.ui.ActionBar.AdjustPanLayoutHelper.4
