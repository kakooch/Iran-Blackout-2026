...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBar parentActionBar;
    ...
    protected ActionBarMenuItem addItemAt(int i, int i2, int i3, CharSequence charSequence, int i4, Drawable drawable, int i5, CharSequence charSequence2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (charSequence != null) {
            ...
            if (isRTLLayout()) {
                addView(actionBarMenuItem, 0, layoutParams);
            } else {
            ...
            if (isRTLLayout()) {
                addView(actionBarMenuItem, 0, new LinearLayout.LayoutParams(i6, -1));
            } else {
                addView(actionBarMenuItem, new LinearLayout.LayoutParams(i6, -1));
            }
        }
        actionBarMenuItem.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ActionBar.ActionBarMenu$$ExternalSyntheticLambda0
            ...
            if (this.parent.ids != null) {
                ...
                for (int i2 = 0; i2 < this.parent.getChildCount(); i2++) {
                    ...
                    if (tag instanceof Integer) {
                        if (this.parent.ids.indexOf(Integer.valueOf(((Integer) tag).intValue())) > iIndexOf) {
                            i = i2;
                            break;
                        }
                    }
