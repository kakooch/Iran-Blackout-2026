...
import org.rbmain.ui.Components.EffectsTextView;
...
public class AlertDialog extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public AlertDialog(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.dismissRunnable = new Runnable() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.dismiss();
            }
        };
        this.showRunnable = new Runnable() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void show() {
        ...
        if (showWithDelay()) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
    ...
    protected void onCreate(Bundle bundle) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        this.containerView = new AnonymousClass1(getContext());
        if (showWithDelay()) {
        ...
        if (this.topResId != 0 || this.topAnimationId != 0 || this.topDrawable != null) {
            ...
            if (this.topAnimationIsNew) {
                ...
                this.topImageView.setBackground(new Drawable() { // from class: org.rbmain.ui.ActionBar.AlertDialog.2
                    int size;
        ...
        if (this.progressViewStyle == 0) {
            ...
            ScrollView scrollView = new ScrollView(getContext()) { // from class: org.rbmain.ui.ActionBar.AlertDialog.3
        ...
        if (this.items != null) {
            ...
            while (true) {
                ...
                if (charSequenceArr[i5] != null) {
                    ...
                    alertDialogCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            this.f$0.lambda$onCreate$2(view2);
                        }
                    });
                }
                i5++;
        ...
        if (z) {
            ...
            if (this.verticalButtons) {
                ...
                this.buttonsLayout = new FrameLayout(this, getContext()) { // from class: org.rbmain.ui.ActionBar.AlertDialog.4
                    ...
                    protected void onLayout(boolean z3, int i6, int i7, int i8, int i9) {
                        ...
                        for (int i11 = 0; i11 < childCount; i11++) {
                            ...
                            if (num != null) {
                                ...
                                if (view3 != null) {
                                    left = view3.getLeft() + ((view3.getMeasuredWidth() - measuredWidth) / 2);
                                    top = view3.getTop() + ((view3.getMeasuredHeight() - measuredHeight) / 2);
                                } else {
                                    left = 0;
                                    top = 0;
                                }
            ...
            if (this.positiveButtonText != null) {
                TextView textView5 = new TextView(this, getContext()) { // from class: org.rbmain.ui.ActionBar.AlertDialog.5
                ...
                textView5.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda4
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view3) {
                        this.f$0.lambda$onCreate$3(view3);
                    }
                });
            }
            if (this.negativeButtonText != null) {
                TextView textView6 = new TextView(this, getContext()) { // from class: org.rbmain.ui.ActionBar.AlertDialog.6
                    @Override // android.widget.TextView, android.view.View
                    public void setEnabled(boolean z3) {
                        super.setEnabled(z3);
                        setAlpha(z3 ? 1.0f : 0.5f);
                ...
                textView6.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda3
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view3) {
                        this.f$0.lambda$onCreate$4(view3);
                    }
                });
            }
            if (this.neutralButtonText != null) {
                TextView textView7 = new TextView(this, getContext()) { // from class: org.rbmain.ui.ActionBar.AlertDialog.7
                    @Override // android.widget.TextView, android.view.View
                    public void setEnabled(boolean z3) {
                        super.setEnabled(z3);
                        setAlpha(z3 ? 1.0f : 0.5f);
                ...
                textView7.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view3) {
                        this.f$0.lambda$onCreate$5(view3);
                    }
                });
            }
            if (this.verticalButtons) {
        ...
        if (this.blurredBackground) {
            if (supportsNativeBlur()) {
                ...
                AndroidUtilities.makeGlobalBlurBitmap(new Utilities.Callback16() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda9
                    @Override // org.rbmain.messenger.Utilities.Callback16
                    public final void run(Object obj) {
                        this.f$0.lambda$onCreate$6((Bitmap) obj);
                    }
                }, 8.0f);
            }
        }
    ...
    /* renamed from: org.rbmain.ui.ActionBar.AlertDialog$1, reason: invalid class name */
    class AnonymousClass1 extends LinearLayout {
        ...
        */
        protected void onMeasure(int r13, int r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.AlertDialog.AnonymousClass1.onMeasure(int, int):void");
        }
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (AlertDialog.this.progressViewStyle == 3) {
                ...
                if (AlertDialog.this.onScrollChangedListener == null) {
                    AlertDialog.this.onScrollChangedListener = new ViewTreeObserver.OnScrollChangedListener() { // from class: org.rbmain.ui.ActionBar.AlertDialog$1$$ExternalSyntheticLambda0
    ...
    public void showCancelAlert() {
        if (this.canCacnel && this.cancelDialog == null) {
            ...
            builder.setNegativeButton(LocaleController.getString("Stop", R.string.Stop), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$showCancelAlert$7(dialogInterface, i);
                }
            });
            builder.setIsCancelDialog(true);
            builder.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.rbmain.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    this.f$0.lambda$showCancelAlert$8(dialogInterface);
                }
            });
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showCancelAlert$7(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showCancelAlert$8(DialogInterface dialogInterface) {
    ...
    public void runShadowAnimation(final int i, boolean z) {
        ...
        this.shadowAnimation[i].addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.AlertDialog.8
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        TextView textView;
        if (i != NotificationCenter.emojiDidLoad || (textView = this.messageTextView) == null) {
            return;
        }
        textView.invalidate();
    }
    ...
    public static class Builder {
        ...
        public Builder setIsCancelDialog(boolean z) {
            this.alertDialog.isCancelDialog = z;
            return this;
        }
    }

    private boolean showWithDelay() {
        return !this.isCancelDialog && this.progressViewStyle == 3;
    }
}
