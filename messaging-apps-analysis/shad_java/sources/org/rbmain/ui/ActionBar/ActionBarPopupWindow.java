...
import org.rbmain.ui.Components.PopupSwipeBackLayout;
...
public class ActionBarPopupWindow extends PopupWindow {
    ...
    static {
        ...
        NOP = new ViewTreeObserver.OnScrollChangedListener() { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow$$ExternalSyntheticLambda2
    ...
    public static class ActionBarPopupWindowLayout extends FrameLayout {
        ...
        public ActionBarPopupWindowLayout(Context context, int i, Theme.ResourcesProvider resourcesProvider, int i2) {
            ...
            LinearLayout linearLayout = new LinearLayout(context) { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.1
                ...
                */
                protected void onMeasure(int r18, int r19) {
                    /*
                        r17 = this;
                        r6 = r17
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r0 = org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.this
                        boolean r0 = org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.access$100(r0)
                        if (r0 == 0) goto Lc0
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r0 = org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.this
                        r1 = -1000000(0xfffffffffff0bdc0, float:NaN)
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.access$202(r0, r1)
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r0 = org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.this
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.access$302(r0, r1)
                        r0 = 0
                    ...
                    L6d:
                        ...
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r1 = org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.this
                        int r2 = r13.getMeasuredHeight()
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.access$202(r1, r2)
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r1 = org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.this
                        int r2 = org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.access$200(r1)
                        r3 = 1086324736(0x40c00000, float:6.0)
                        int r3 = org.rbmain.messenger.AndroidUtilities.dp(r3)
                        int r2 = r2 + r3
                        org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.access$302(r1, r2)
                        r12 = r0
                    L97:
                        if (r9 != 0) goto L9e
                    ...
                    Lc0:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.AnonymousClass1.onMeasure(int, int):void");
                }
        ...
        private void startChildAnimation(final View view) {
            if (this.animationEnabled) {
                ...
                animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.2
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r20) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    public ActionBarPopupWindow() throws IllegalAccessException, IllegalArgumentException {
    ...
    private void init() throws IllegalAccessException, IllegalArgumentException {
        ...
        if (contentView instanceof ActionBarPopupWindowLayout) {
            ...
            if (actionBarPopupWindowLayout.getSwipeBack() != null) {
                actionBarPopupWindowLayout.getSwipeBack().setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow$$ExternalSyntheticLambda1
    ...
    public static AnimatorSet startAnimation(final ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow$$ExternalSyntheticLambda0
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
    ...
    public static /* synthetic */ void lambda$startAnimation$2(ActionBarPopupWindowLayout actionBarPopupWindowLayout, ValueAnimator valueAnimator) {
        ...
        for (int i = 0; i < itemsCount; i++) {
            ...
            if (!(itemAt instanceof GapView)) {
                itemAt.setTranslationY((1.0f - AndroidUtilities.cascade(fFloatValue, actionBarPopupWindowLayout.shownFromBottom ? (itemsCount - 1) - i : i, itemsCount, 4.0f)) * AndroidUtilities.dp(-6.0f));
            }
        }
    }
    ...
    public void startAnimation() {
        ...
        if (this.animationEnabled && this.windowAnimatorSet == null) {
            ...
            this.windowAnimatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    public void dismiss(boolean z) {
        ...
        if (this.animationEnabled && z) {
            ...
            this.windowAnimatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.ActionBarPopupWindow.3
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    ActionBarPopupWindow.this.windowAnimatorSet = null;
