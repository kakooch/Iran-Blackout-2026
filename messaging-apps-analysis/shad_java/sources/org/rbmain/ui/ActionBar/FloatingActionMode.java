...
public final class FloatingActionMode extends ActionMode {
    ...
    private final Runnable mMovingOff = new Runnable() { // from class: org.rbmain.ui.ActionBar.FloatingActionMode.1
    ...
    private final Runnable mHideOff = new Runnable() { // from class: org.rbmain.ui.ActionBar.FloatingActionMode.2
        @Override // java.lang.Runnable
        public void run() {
            if (FloatingActionMode.this.isViewStillActive()) {
    ...
    public FloatingActionMode(Context context, ActionMode.Callback2 callback2, View view, FloatingToolbar floatingToolbar) {
        ...
        setType(1);
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() { // from class: org.rbmain.ui.ActionBar.FloatingActionMode$$ExternalSyntheticLambda1
    ...
    private void setFloatingToolbar(FloatingToolbar floatingToolbar) {
        FloatingToolbar onMenuItemClickListener = floatingToolbar.setMenu(this.mMenu).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: org.rbmain.ui.ActionBar.FloatingActionMode$$ExternalSyntheticLambda0
