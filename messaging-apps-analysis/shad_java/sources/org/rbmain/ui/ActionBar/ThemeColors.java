...
public class ThemeColors {
    ...
    public static int[] createDefaultColors() {
        ...
        iArr[Theme.key_avatar_subtitleInProfileBlue] = -12434878;
        ...
        iArr[Theme.key_actionBarDefault] = -657931;
        iArr[Theme.key_actionBarDefaultIcon] = -14606047;
        iArr[Theme.key_actionBarActionModeDefault] = -1;
        iArr[Theme.key_actionBarActionModeDefaultTop] = -1728053248;
        iArr[Theme.key_actionBarActionModeDefaultIcon] = -9211021;
        iArr[Theme.key_actionBarDefaultTitle] = -14606047;
        iArr[Theme.key_actionBarDefaultSubtitle] = -10395295;
        iArr[Theme.key_actionBarDefaultSelector] = -12554860;
        iArr[Theme.key_actionBarWhiteSelector] = 788529152;
        iArr[Theme.key_actionBarDefaultSearch] = -14606047;
        iArr[Theme.key_actionBarDefaultSearchPlaceholder] = -2011094751;
        iArr[Theme.key_actionBarDefaultSubmenuItem] = -14606047;
        iArr[Theme.key_actionBarDefaultSubmenuItemIcon] = -9999504;
        iArr[Theme.key_actionBarDefaultSubmenuBackground] = -1;
        iArr[Theme.key_actionBarActionModeDefaultSelector] = -986896;
        iArr[Theme.key_actionBarTabActiveText] = -15755027;
        iArr[Theme.key_actionBarTabUnactiveText] = -7565679;
        iArr[Theme.key_actionBarTabLine] = -13655305;
        iArr[Theme.key_actionBarTabSelector] = 136982325;
        ...
        iArr[Theme.key_chat_status] = -16742931;
        ...
        iArr[Theme.key_profile_title] = -14606047;
        iArr[Theme.key_profile_status] = -15365445;
        ...
        iArr[Theme.key_avatar_backgroundGroupCreateSpanBlue] = -4204822;
        iArr[Theme.key_services_card_background] = -328966;
        iArr[Theme.key_services_title_color] = -14606047;
        iArr[Theme.key_services_sub_title_color] = -8026747;
        iArr[Theme.key_services_btn_txt_color] = -14606047;
        iArr[Theme.key_services_btn_back_color] = -986896;
        iArr[Theme.key_services_icon_title_color] = -12434878;
        iArr[Theme.key_services_timer_color] = -1;
        iArr[Theme.key_services_feed_text_color] = -1;
        iArr[Theme.key_services_predict_bg] = -8830073;
        iArr[Theme.key_switchThumb] = -1184275;
        iArr[Theme.key_switchThumbChecked] = -12211217;
        iArr[Theme.key_mainTabBackground] = -1;
        iArr[Theme.key_mainTabIcon] = -9079435;
        iArr[Theme.key_mainTabIconSelected] = -15288867;
        iArr[Theme.key_rubinoBlackColor] = -14277082;
        iArr[Theme.key_rubinoGrayColor] = -6710887;
        iArr[Theme.key_rubinoGrayColorC6] = -3750202;
        iArr[Theme.key_rubinoMentionColor] = -16763029;
        iArr[Theme.key_rubinoFollowingBorderColor] = -2368549;
        iArr[Theme.key_rubino_mentionViewBackground] = -16777216;
        iArr[Theme.key_rubino_explore_header_stroke_color] = -2368549;
        iArr[Theme.key_rubino_add_post_iconBackground] = Integer.MIN_VALUE;
        iArr[Theme.key_rubino_add_post_photoPlaceholder] = -1182729;
        iArr[Theme.key_rubino_add_post_CheckBoxCheck] = -1;
        iArr[Theme.key_rubino_add_postCheckBoxBackground] = -12995849;
        iArr[Theme.key_rubino_add_post_PhotoBackground] = 201326592;
        iArr[Theme.key_rubino_add_post_TabActiveText] = -14277082;
        iArr[Theme.key_rubino_add_post_TabUnactiveText] = -6710887;
        iArr[Theme.key_rubino_add_post_TabLine] = -14277082;
        iArr[Theme.key_rubino_add_post_TabSelector] = -3618616;
        iArr[Theme.key_rubino_add_post_CaptureButtonColor] = -2368549;
        iArr[Theme.key_rubino_add_post_CaptureButtonColorHighlight] = -3684409;
        iArr[Theme.key_walletGreen] = -13730510;
        iArr[Theme.key_walletRed] = -1092784;
        iArr[Theme.key_chats_nameIcon] = -14408668;
        iArr[Theme.key_windowBackgroundWhiteGrayLine] = -2368549;
        iArr[Theme.key_changephoneinfo_image] = -4669499;
        return iArr;
    }
    ...
    public static SparseArray<String> createColorKeysMap() {
        ...
        sparseArray.put(Theme.key_services_card_background, "services_card_background");
        sparseArray.put(Theme.key_services_title_color, "services_title_color");
        sparseArray.put(Theme.key_services_sub_title_color, "services_sub_title_color");
        sparseArray.put(Theme.key_services_btn_txt_color, "services_btn_txt_color");
        sparseArray.put(Theme.key_services_btn_back_color, "services_btn_back_color");
        sparseArray.put(Theme.key_services_icon_title_color, "services_icon_title_color");
        sparseArray.put(Theme.key_services_timer_color, "services_timer_color");
        sparseArray.put(Theme.key_services_feed_text_color, "services_Banner_text_color");
        sparseArray.put(Theme.key_services_predict_bg, "services_predict_bg");
        sparseArray.put(Theme.key_switchThumb, "switchThumb");
        sparseArray.put(Theme.key_switchThumbChecked, "switchThumbChecked");
        sparseArray.put(Theme.key_mainTabBackground, "mainTabBackground");
        sparseArray.put(Theme.key_mainTabIcon, "mainTabIcon");
        sparseArray.put(Theme.key_mainTabIconSelected, "mainTabIconSelected");
        sparseArray.put(Theme.key_rubinoBlackColor, "rubinoBlackColor");
        sparseArray.put(Theme.key_rubinoGrayColor, "rubinoGrayColor");
        sparseArray.put(Theme.key_rubinoGrayColorC6, "rubinoGrayColorC6");
        sparseArray.put(Theme.key_rubinoMentionColor, "rubinoMentionColor");
        sparseArray.put(Theme.key_rubinoFollowingBorderColor, "rubinoFollowingBorderColor");
        sparseArray.put(Theme.key_rubino_mentionViewBackground, "rubinoMediaIndexBackground");
        sparseArray.put(Theme.key_rubino_explore_header_stroke_color, "rubinoExploreHeaderStrokeColor");
        sparseArray.put(Theme.key_rubino_add_post_photoPlaceholder, "rubino_add_post_photoPlaceholder");
        sparseArray.put(Theme.key_rubino_add_post_CheckBoxCheck, "rubino_add_post_CheckBoxCheck");
        sparseArray.put(Theme.key_rubino_add_postCheckBoxBackground, "rubino_add_post_CheckBoxBackground");
        sparseArray.put(Theme.key_rubino_add_post_PhotoBackground, "rubino_add_post_PhotoBackground");
        sparseArray.put(Theme.key_rubino_add_post_iconBackground, "rubino_add_post_IconBackground");
        sparseArray.put(Theme.key_rubino_add_post_TabActiveText, "rubino_add_post_TabActiveText");
        sparseArray.put(Theme.key_rubino_add_post_TabUnactiveText, "rubino_add_post_actionBarTabUnactiveText");
        sparseArray.put(Theme.key_rubino_add_post_TabLine, "rubino_add_post_actionBarTabLine");
        sparseArray.put(Theme.key_rubino_add_post_TabSelector, "rubino_add_post_actionBarTabSelector");
        sparseArray.put(Theme.key_rubino_add_post_CaptureButtonColor, "rubino_add_post_CaptureButtonColor");
        sparseArray.put(Theme.key_rubino_add_post_CaptureButtonColorHighlight, "rubino_add_post_CaptureButtonColorHighlight");
        sparseArray.put(Theme.key_avatar_backgroundGroupCreateSpanBlue, "avatar_backgroundGroupCreateSpanBlue");
        sparseArray.put(Theme.key_walletGreen, "key_walletGreen");
        sparseArray.put(Theme.key_walletRed, "key_walletRed");
        sparseArray.put(Theme.key_chats_nameIcon, "chats_nameIcon");
        sparseArray.put(Theme.key_windowBackgroundWhiteGrayLine, "windowBackgroundWhiteGrayLine");
        sparseArray.put(Theme.key_changephoneinfo_image, "changephoneinfo_image");
        return sparseArray;
    }
