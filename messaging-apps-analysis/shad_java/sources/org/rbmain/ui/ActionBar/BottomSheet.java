...
public class BottomSheet extends Dialog {
    ...
    public class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        private void checkDismiss(float f, float f2) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ActionBar.BottomSheet$ContainerView$$ExternalSyntheticLambda1
            ...
            this.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.BottomSheet.ContainerView.1
        ...
        public boolean processTouchEvent(MotionEvent motionEvent, boolean z) {
            ...
            if (BottomSheet.this.canDismissWithTouchOutside() && motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.startedTracking && !this.maybeStartTracking && motionEvent.getPointerCount() == 1)) {
                ...
                boolean zOnScrollUp = BottomSheet.this.onScrollUp(this.y + y2);
        ...
        */
        protected void onMeasure(int r14, int r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.BottomSheet.ContainerView.onMeasure(int, int):void");
        }
        ...
        */
        protected void onLayout(boolean r17, int r18, int r19, int r20, int r21) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.BottomSheet.ContainerView.onLayout(boolean, int, int, int, int):void");
        }
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r12) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.BottomSheet.ContainerView.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        */
        protected void onDraw(android.graphics.Canvas r11) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ActionBar.BottomSheet.ContainerView.onDraw(android.graphics.Canvas):void");
        }
    ...
    public void setHideSystemVerticalInsets(boolean z) {
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public BottomSheet(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.backDrawable = new ColorDrawable(-16777216) { // from class: org.rbmain.ui.ActionBar.BottomSheet.1
        ...
        this.dismissRunnable = new Runnable() { // from class: org.rbmain.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda6
        ...
        ContainerView containerView = new ContainerView(getContext()) { // from class: org.rbmain.ui.ActionBar.BottomSheet.2
            @Override // org.rbmain.ui.ActionBar.BottomSheet.ContainerView, android.view.ViewGroup
            ...
            @Override // org.rbmain.ui.ActionBar.BottomSheet.ContainerView, android.view.ViewGroup, android.view.View
        ...
        if (i2 >= 21) {
            ...
            this.container.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: org.rbmain.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda3
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (this.containerView == null) {
            FrameLayout frameLayout = new FrameLayout(getContext()) { // from class: org.rbmain.ui.ActionBar.BottomSheet.3
                @Override // android.view.View
                public boolean hasOverlappingRendering() {
                    return false;
                }
        ...
        int i = 48;
        if (this.title != null) {
            TextView textView = new TextView(getContext()) { // from class: org.rbmain.ui.ActionBar.BottomSheet.4
            ...
            this.titleView.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda5
        ...
        if (view != null) {
            ...
            while (true) {
                ...
                if (charSequenceArr[i2] != null) {
                    ...
                    bottomSheetCell.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            this.f$0.lambda$onCreate$3(view2);
                        }
                    });
        ...
        if (this.focusable) {
            ...
            attributes.flags = i3 | MessagesController.UPDATE_MASK_REORDER;
        }
    ...
    public void setFocusable(boolean z) {
        ...
        if (this.focusable) {
            ...
            attributes.flags |= MessagesController.UPDATE_MASK_REORDER;
        }
        window.setAttributes(attributes);
    }
    ...
    public void show() {
        ...
        Runnable runnable = new Runnable() { // from class: org.rbmain.ui.ActionBar.BottomSheet.5
            @Override // java.lang.Runnable
            public void run() {
                BottomSheet bottomSheet = BottomSheet.this;
    ...
    public void startOpenAnimation() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.lambda$startOpenAnimation$4(valueAnimator2);
            }
        });
        ...
        this.currentSheetAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ActionBar.BottomSheet.6
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
    ...
    /* renamed from: org.rbmain.ui.ActionBar.BottomSheet$7, reason: invalid class name */
    class AnonymousClass7 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ActionBar.BottomSheet$7$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void dismiss() {
        ...
        if ((bottomSheetDelegateInterface == null || bottomSheetDelegateInterface.canDismiss()) && !this.dismissed) {
            ...
            if (this.allowCustomAnimation && onCustomCloseAnimation()) {
                ...
                this.navigationBarAnimation = valueAnimatorOfFloat;
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda1
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        this.f$0.lambda$dismiss$5(valueAnimator2);
                    }
                });
    ...
    /* renamed from: org.rbmain.ui.ActionBar.BottomSheet$8, reason: invalid class name */
    class AnonymousClass8 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                bottomSheet.currentSheetAnimation = null;
                bottomSheet.currentSheetAnimationType = 0;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ActionBar.BottomSheet$8$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onAnimationEnd$0();
                    }
