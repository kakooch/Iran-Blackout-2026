...
import org.rbmain.messenger.LruCache;
...
import org.rbmain.tgnet.TLRPC$TL_messageInteractionCounters;
...
import org.rbmain.tgnet.TLRPC$TL_statsGroupTopAdmin;
import org.rbmain.tgnet.TLRPC$TL_statsGroupTopInviter;
import org.rbmain.tgnet.TLRPC$TL_statsGroupTopPoster;
...
import org.rbmain.tgnet.TLRPC$TL_stats_getMegagroupStats;
import org.rbmain.tgnet.TLRPC$TL_stats_loadAsyncGraph;
import org.rbmain.tgnet.TLRPC$TL_stats_megagroupStats;
...
import org.rbmain.ui.Cells.StatisticPostInfoCell;
import org.rbmain.ui.Charts.BarChartView;
import org.rbmain.ui.Charts.BaseChartView;
import org.rbmain.ui.Charts.ChartPickerDelegate;
import org.rbmain.ui.Charts.DoubleLinearChartView;
import org.rbmain.ui.Charts.LinearChartView;
import org.rbmain.ui.Charts.PieChartView;
import org.rbmain.ui.Charts.StackBarChartView;
import org.rbmain.ui.Charts.StackLinearChartView;
import org.rbmain.ui.Charts.data.ChartData;
import org.rbmain.ui.Charts.data.DoubleLinearChartData;
import org.rbmain.ui.Charts.data.StackBarChartData;
import org.rbmain.ui.Charts.data.StackLinearChartData;
import org.rbmain.ui.Charts.view_data.ChartHeaderView;
...
public class StatisticActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final LongSparseArray<Integer> recentPostIdtoIndexMap;
    ...
    public StatisticActivity(Bundle bundle) {
        ...
        this.loadFromId = -1L;
        this.recentPostIdtoIndexMap = new LongSparseArray<>();
        this.recentPostsAll = new ArrayList<>();
        this.recentPostsLoaded = new ArrayList<>();
        this.initialLoading = true;
        this.showProgressbar = new Runnable() { // from class: org.rbmain.ui.StatisticActivity.1
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.chat == null) {
            ...
            TLRPC$ChatFull chatFullById = getDialogsProxy().getChatFullById(IdStorage.getInstance().getDialogId(-this.chatId));
            this.chat = chatFullById;
        ...
        AccountInstance.getInstance(this.currentAccount).getDialogsProxy().getAllChannelStatistics(tLRPC$TL_stats_getBroadcastStats, new RequestDelegate() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda4
    ...
    public /* synthetic */ void lambda$onFragmentCreate$2(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        String str;
        String str2 = "TopHoursChartTitle";
        if (tLObject instanceof TLRPC$TL_stats_broadcastStats) {
            ...
            int i = 0;
            while (i < tLRPC$TL_stats_broadcastStats.recent_message_interactions.size()) {
                ...
                this.recentPostIdtoIndexMap.put(recentPostInfo.counters.msg_id, Integer.valueOf(i));
                i++;
                str2 = str2;
            }
            str = str2;
            if (this.recentPostsAll.size() > 0) {
                getMessagesStorage().getMessages(-this.chat.id, 0L, false, this.recentPostsAll.size(), this.recentPostsAll.get(0).counters.msg_id, 0, 0, this.classGuid, 0, true, false, 0L, 0, true);
            }
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onFragmentCreate$0(chartViewDataArr);
                }
            });
        } else {
        ...
        if (tLObject instanceof TLRPC$TL_stats_megagroupStats) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onFragmentCreate$1(chartViewDataArr2);
                }
            });
        }
    }
    ...
    private void dataLoaded(ChartViewData[] chartViewDataArr) {
        ...
        this.progressLayout.animate().alpha(0.0f).setDuration(230L).setListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.StatisticActivity.2
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.messagesDidLoad && ((Integer) objArr[10]).intValue() == this.classGuid) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                int iIntValue = this.recentPostIdtoIndexMap.get(messageObject.getId(), -1).intValue();
                if (iIntValue >= 0 && this.recentPostsAll.get(iIntValue).counters.msg_id == messageObject.getId()) {
                    if (messageObject.deleted) {
                        arrayList2.add(this.recentPostsAll.get(iIntValue));
                    } else {
                        this.recentPostsAll.get(iIntValue).message = messageObject;
                    }
                }
            }
    ...
    public View createView(Context context) {
        ...
        this.recyclerListView = new RecyclerListView(context) { // from class: org.rbmain.ui.StatisticActivity.3
            int lastH;
        ...
        this.animator = new DefaultItemAnimator(this) { // from class: org.rbmain.ui.StatisticActivity.4
        ...
        this.recyclerListView.setItemAnimator(null);
        this.recyclerListView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.StatisticActivity.5
        ...
        this.recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda7
            @Override // org.rbmain.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i3) {
                this.f$0.lambda$createView$3(view, i3);
            }
        });
        this.recyclerListView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda8
        ...
        TLRPC$Chat chat = getMessagesController().getChat(Integer.valueOf(this.chat.id));
        this.avatarContainer.setChatAvatar(chat);
        this.avatarContainer.setTitle(chat.title);
        this.avatarContainer.setSubtitle(LocaleController.getString("Statistics", R.string.Statistics));
        this.actionBar.setBackButtonDrawable(new BackDrawable(false));
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.rbmain.ui.StatisticActivity.6
    ...
    public /* synthetic */ boolean lambda$createView$5(View view, int i) {
        ...
        if (i >= i2 && i <= adapter.recentPostsEndRow) {
            ...
            builder.setItems((CharSequence[]) arrayList.toArray(new CharSequence[arrayList2.size()]), AndroidUtilities.toIntArray(arrayList3), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    this.f$0.lambda$createView$4(messageObject, dialogInterface, i3);
                }
            });
    ...
    public static ChartViewData createViewData(TLRPC$StatsGraph tLRPC$StatsGraph, String str, int i, boolean z) {
        ...
        if (tLRPC$StatsGraph instanceof TLRPC$TL_statsGraph) {
            try {
                ChartData chartDataCreateChartData = createChartData(new JSONObject(((TLRPC$TL_statsGraph) tLRPC$StatsGraph).json.data), i, z);
    ...
    class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i >= 0 && i <= 4) {
                View view = new ChartCell(this, viewGroup.getContext(), i, StatisticActivity.this.sharedUi) { // from class: org.rbmain.ui.StatisticActivity.Adapter.1
                    {
                ...
                View view2 = new StatisticPostInfoCell(this, viewGroup.getContext(), StatisticActivity.this.chat) { // from class: org.rbmain.ui.StatisticActivity.Adapter.2
                    @Override // android.view.View
                    protected void onDraw(Canvas canvas) {
                        if (getTranslationY() != 0.0f) {
                            canvas.drawColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                ...
                ChartHeaderView chartHeaderView = new ChartHeaderView(this, viewGroup.getContext()) { // from class: org.rbmain.ui.StatisticActivity.Adapter.3
                    @Override // android.view.View
                    protected void onDraw(Canvas canvas) {
                        if (getTranslationY() != 0.0f) {
                            canvas.drawColor(Theme.getColor(Theme.key_windowBackgroundWhite));
    ...
    class ChartCell extends BaseChartCell {
        ...
        @Override // org.rbmain.ui.StatisticActivity.BaseChartCell
        ...
        public void onZoomed() {
            ...
            if (baseChartView.legendSignatureView.canGoZoom) {
                ...
                ConnectionsManager.getInstance(((BaseFragment) StatisticActivity.this).currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(((BaseFragment) StatisticActivity.this).currentAccount).sendRequest(tLRPC$TL_stats_loadAsyncGraph, new RequestDelegate() { // from class: org.rbmain.ui.StatisticActivity$ChartCell$$ExternalSyntheticLambda1
                    @Override // org.rbmain.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) throws JSONException {
                        this.f$0.lambda$onZoomed$1(str, zoomCancelable, tLObject, tLRPC$TL_error);
                    }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onZoomed$1(final String str, final ZoomCancelable zoomCancelable, TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) throws JSONException {
            boolean z = true;
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.StatisticActivity$ChartCell$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static abstract class BaseChartCell extends FrameLayout {
        ...
        public BaseChartCell(Context context, int i, BaseChartView.SharedUiComponents sharedUiComponents) {
            ...
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(1);
            this.checkboxContainer = new FrameLayout(this, context) { // from class: org.rbmain.ui.StatisticActivity.BaseChartCell.1
                ...
                protected void onMeasure(int i2, int i3) {
                    ...
                    for (int i4 = 0; i4 < childCount; i4++) {
                        if (getChildAt(i4).getMeasuredWidth() + measuredWidth > getMeasuredWidth()) {
            ...
            this.chartHeaderView.back.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$$ExternalSyntheticLambda3
            ...
            this.chartView.setDateSelectionListener(new BaseChartView.DateSelectionListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$$ExternalSyntheticLambda5
                @Override // org.rbmain.ui.Charts.BaseChartView.DateSelectionListener
            ...
            this.chartView.legendSignatureView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$new$2(view);
                }
            });
            this.zoomedChartView.legendSignatureView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        public void zoomChart(boolean z) {
            ...
            valueAnimatorCreateTransitionAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.StatisticActivity.BaseChartCell.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
        ...
        private void zoomOut(boolean z) {
            ...
            valueAnimatorCreateTransitionAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.StatisticActivity.BaseChartCell.3
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
        ...
        private ValueAnimator createTransitionAnimator(long j, boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$$ExternalSyntheticLambda1
        ...
        public void updateData(ChartViewData chartViewData, boolean z) {
            ...
            if (z) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$$ExternalSyntheticLambda0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        this.f$0.lambda$updateData$5(valueAnimator);
                    }
                });
                valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.StatisticActivity.BaseChartCell.4
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        BaseChartCell baseChartCell = BaseChartCell.this;
        ...
        public void recolor() {
            ...
            if (chartViewData != null && (chartData = chartViewData.chartData) != null && (arrayList = chartData.lines) != null && arrayList.size() > 1) {
                for (int i = 0; i < this.data.chartData.lines.size(); i++) {
                    if (this.data.chartData.lines.get(i).colorKey >= 0 && Theme.hasDefaultThemeKey(this.data.chartData.lines.get(i).colorKey)) {
        ...
        class CheckBoxHolder {
            ...
            public void setData(final LineViewData lineViewData) {
                ...
                this.checkBox.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$CheckBoxHolder$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f$0.lambda$setData$0(lineViewData, view);
                    }
                });
                this.checkBox.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.rbmain.ui.StatisticActivity$BaseChartCell$CheckBoxHolder$$ExternalSyntheticLambda1
    ...
    public static class ChartViewData {
        ...
        public void load(int i, int i2, int i3, final RecyclerListView recyclerListView, Adapter adapter, final DiffUtilsCallback diffUtilsCallback) {
            ...
            ConnectionsManager.getInstance(i).bindRequestToGuid(ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_stats_loadAsyncGraph, new RequestDelegate() { // from class: org.rbmain.ui.StatisticActivity$ChartViewData$$ExternalSyntheticLambda1
                @Override // org.rbmain.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    this.f$0.lambda$load$1(recyclerListView, diffUtilsCallback, tLObject, tLRPC$TL_error);
                }
        ...
        /* JADX WARN: Type inference failed for: r12v11, types: [org.rbmain.ui.Charts.data.ChartData] */
        /* JADX WARN: Type inference failed for: r3v0 */
        /* JADX WARN: Type inference failed for: r3v1, types: [org.rbmain.ui.Charts.data.ChartData] */
        /* JADX WARN: Type inference failed for: r3v2 */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public /* synthetic */ void lambda$load$1(final org.rbmain.ui.Components.RecyclerListView r9, final org.rbmain.ui.StatisticActivity.DiffUtilsCallback r10, org.rbmain.tgnet.TLObject r11, org.rbmain.tgnet.TLRPC$TL_error r12) {
            /*
                r8 = this;
                r0 = 0
                if (r12 != 0) goto L5c
                boolean r12 = r11 instanceof org.rbmain.tgnet.TLRPC$TL_statsGraph
                r1 = 1
                if (r12 == 0) goto L49
                r12 = r11
                org.rbmain.tgnet.TLRPC$TL_statsGraph r12 = (org.rbmain.tgnet.TLRPC$TL_statsGraph) r12
                org.rbmain.tgnet.TLRPC$TL_dataJSON r12 = r12.json
                ...
                org.rbmain.ui.Charts.data.ChartData r12 = org.rbmain.ui.StatisticActivity.createChartData(r2, r12, r3)     // Catch: org.json.JSONException -> L43
                r2 = r11
                org.rbmain.tgnet.TLRPC$TL_statsGraph r2 = (org.rbmain.tgnet.TLRPC$TL_statsGraph) r2     // Catch: org.json.JSONException -> L3e
                ...
                org.rbmain.ui.Charts.data.StackLinearChartData r2 = new org.rbmain.ui.Charts.data.StackLinearChartData     // Catch: org.json.JSONException -> L3e
            ...
            L49:
                r12 = r0
            L4a:
                boolean r2 = r11 instanceof org.rbmain.tgnet.TLRPC$TL_statsGraphError
                if (r2 == 0) goto L59
                r2 = 0
                r8.isEmpty = r2
                r8.isError = r1
                org.rbmain.tgnet.TLRPC$TL_statsGraphError r11 = (org.rbmain.tgnet.TLRPC$TL_statsGraphError) r11
            ...
            L5c:
                ...
                r4 = r3
            L5e:
                org.rbmain.ui.StatisticActivity$ChartViewData$$ExternalSyntheticLambda0 r11 = new org.rbmain.ui.StatisticActivity$ChartViewData$$ExternalSyntheticLambda0
                r1 = r11
                r2 = r8
                r5 = r9
                r6 = r10
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.StatisticActivity.ChartViewData.lambda$load$1(org.rbmain.ui.Components.RecyclerListView, org.rbmain.ui.StatisticActivity$DiffUtilsCallback, org.rbmain.tgnet.TLObject, org.rbmain.tgnet.TLRPC$TL_error):void");
        }
    ...
    public void loadMessages() {
        ...
        int i = 0;
        for (int iIntValue = this.recentPostIdtoIndexMap.get(this.loadFromId).intValue(); iIntValue < size; iIntValue++) {
            if (this.recentPostsAll.get(iIntValue).message == null) {
                tLRPC$TL_channels_getMessages.id.add(Long.valueOf(this.recentPostsAll.get(iIntValue).counters.msg_id));
                i++;
                if (i > 50) {
                    break;
                }
        ...
        getConnectionsManager().sendRequest(tLRPC$TL_channels_getMessages, new RequestDelegate() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda5
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadMessages$7(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadMessages$6(arrayList);
            }
        });
    }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.rbmain.ui.StatisticActivity$$ExternalSyntheticLambda6
    ...
    public static class OverviewChannelData {
        ...
        public OverviewChannelData(TLRPC$TL_stats_broadcastStats tLRPC$TL_stats_broadcastStats) {
            ...
            if (i == 0 || fAbs == 0.0f) {
                this.followersSecondary = BuildConfig.FLAVOR;
            } else {
                int i2 = (int) fAbs;
                if (fAbs == i2) {
            ...
            if (i3 == 0 || fAbs2 == 0.0f) {
                this.sharesSecondary = BuildConfig.FLAVOR;
            } else {
                int i4 = (int) fAbs2;
                if (fAbs2 == i4) {
                    ...
                    sb4.append(i3 > 0 ? "+" : BuildConfig.FLAVOR);
            ...
            if (i5 == 0 || fAbs3 == 0.0f) {
                this.viewsSecondary = BuildConfig.FLAVOR;
            } else {
                int i6 = (int) fAbs3;
                if (fAbs3 == i6) {
                    ...
                    sb5.append(i5 <= 0 ? BuildConfig.FLAVOR : "+");
                    ...
                    sb6.append(i5 <= 0 ? BuildConfig.FLAVOR : "+");
    ...
    public static class OverviewChatData {
        ...
        public OverviewChatData(TLRPC$TL_stats_megagroupStats tLRPC$TL_stats_megagroupStats) {
            ...
            if (i == 0 || fAbs == 0.0f) {
                this.membersSecondary = BuildConfig.FLAVOR;
            } else {
                int i2 = (int) fAbs;
                if (fAbs == i2) {
                    Locale locale = Locale.ENGLISH;
            ...
            if (i3 == 0 || fAbs2 == 0.0f) {
                this.viewingMembersSecondary = BuildConfig.FLAVOR;
            } else {
                Locale locale3 = Locale.ENGLISH;
            ...
            if (i4 == 0 || fAbs3 == 0.0f) {
                this.postingMembersSecondary = BuildConfig.FLAVOR;
            } else {
                Locale locale4 = Locale.ENGLISH;
            ...
            if (i5 == 0 || fAbs4 == 0.0f) {
                this.messagesSecondary = BuildConfig.FLAVOR;
            } else {
                Locale locale5 = Locale.ENGLISH;
    ...
    public static class OverviewCell extends LinearLayout {
        ...
        public void setData(OverviewChannelData overviewChannelData) {
            ...
            this.secondary[1].setText(BuildConfig.FLAVOR);
            this.secondary[1].setTag(Integer.valueOf(overviewChannelData.viewsUp ? Theme.key_windowBackgroundWhiteGreenText2 : Theme.key_text_RedRegular));
        ...
        public void updateColors() {
            for (int i = 0; i < 4; i++) {
                ...
                int iIntValue = ((Integer) this.secondary[i].getTag()).intValue();
                if (iIntValue >= 0) {
                    this.secondary[i].setTextColor(Theme.getColor(iIntValue));
                }
            }
        }
    }
    ...
    public static class MemberData {
        ...
        public static MemberData from(TLRPC$TL_statsGroupTopInviter tLRPC$TL_statsGroupTopInviter, ArrayList<TLRPC$User> arrayList) {
            ...
            if (i2 > 0) {
                ...
                memberData.description = BuildConfig.FLAVOR;
            }
            return memberData;
        }
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        private void onLongClick(final org.rbmain.tgnet.TLRPC$ChatFull r17, final org.rbmain.ui.StatisticActivity r18, final org.rbmain.ui.ActionBar.AlertDialog[] r19, boolean r20) {
            /*
                Method dump skipped, instructions count: 470
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.StatisticActivity.MemberData.onLongClick(org.rbmain.tgnet.TLRPC$ChatFull, org.rbmain.ui.StatisticActivity, org.rbmain.ui.ActionBar.AlertDialog[], boolean):void");
        }
        ...
        public /* synthetic */ void lambda$onLongClick$1(final StatisticActivity statisticActivity, final AlertDialog[] alertDialogArr, final TLRPC$ChatFull tLRPC$ChatFull, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.StatisticActivity$MemberData$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onLongClick$0(statisticActivity, alertDialogArr, tLRPC$TL_error, tLObject, tLRPC$ChatFull);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onLongClick$3(final StatisticActivity statisticActivity, final AlertDialog[] alertDialogArr, final TLRPC$ChatFull tLRPC$ChatFull, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.StatisticActivity$MemberData$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onLongClick$2(statisticActivity, alertDialogArr, tLRPC$TL_error, tLObject, tLRPC$ChatFull);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onLongClick$4(ArrayList arrayList, TLRPC$ChatFull tLRPC$ChatFull, final TLRPC$TL_chatChannelParticipant tLRPC$TL_chatChannelParticipant, final boolean z, final StatisticActivity statisticActivity, DialogInterface dialogInterface, int i) {
            if (((Integer) arrayList.get(i)).intValue() == 0) {
                ...
                ChatRightsEditActivity chatRightsEditActivity = new ChatRightsEditActivity(i2, i3, tLRPC$ChannelParticipant.admin_rights, null, tLRPC$ChannelParticipant.banned_rights, tLRPC$ChannelParticipant.rank, 0, true, z) { // from class: org.rbmain.ui.StatisticActivity.MemberData.1
                    @Override // org.rbmain.ui.ActionBar.BaseFragment
                ...
                chatRightsEditActivity.setDelegate(new ChatRightsEditActivity.ChatRightsEditActivityDelegate(this) { // from class: org.rbmain.ui.StatisticActivity.MemberData.2
                    ...
                    public void didSetRights(int i4, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights, String str) {
                        if (i4 == 0) {
                            ...
                            tLRPC$ChannelParticipant2.rank = BuildConfig.FLAVOR;
                        } else {
            ...
            Bundle bundle = new Bundle();
            bundle.putInt("chat_id", tLRPC$ChatFull.id);
