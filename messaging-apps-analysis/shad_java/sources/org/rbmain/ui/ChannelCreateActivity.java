...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public ChannelCreateActivity(Bundle bundle) {
        ...
        if (i == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_channels_checkUsername, new RequestDelegate() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda19
    ...
    public /* synthetic */ void lambda$new$1(TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda15
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            ...
            SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.rbmain.ui.ChannelCreateActivity.2
                ...
                */
                protected void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                    /*
                        ...
                        if (r1 != 0) goto L26
                        org.rbmain.ui.ChannelCreateActivity r1 = org.rbmain.ui.ChannelCreateActivity.this
                        org.rbmain.ui.Components.EditTextEmoji r1 = org.rbmain.ui.ChannelCreateActivity.access$200(r1)
                    ...
                    L97:
                        int r4 = r7 - r4
                    L99:
                        org.rbmain.ui.ChannelCreateActivity r7 = org.rbmain.ui.ChannelCreateActivity.this
                        org.rbmain.ui.Components.EditTextEmoji r7 = org.rbmain.ui.ChannelCreateActivity.access$200(r7)
                        if (r7 == 0) goto Lc6
                        org.rbmain.ui.ChannelCreateActivity r7 = org.rbmain.ui.ChannelCreateActivity.this
                        org.rbmain.ui.Components.EditTextEmoji r7 = org.rbmain.ui.ChannelCreateActivity.access$200(r7)
                    ...
                    Lcf:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ChannelCreateActivity.AnonymousClass2.onLayout(boolean, int, int, int, int):void");
                }
            ...
            sizeNotifierFrameLayout.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda6
            ...
            sizeNotifierFrameLayout.setTag(Integer.valueOf(i2));
            ...
            BackupImageView backupImageView = new BackupImageView(context) { // from class: org.rbmain.ui.ChannelCreateActivity.3
            ...
            View view = new View(context) { // from class: org.rbmain.ui.ChannelCreateActivity.4
                @Override // android.view.View
            ...
            this.avatarOverlay.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda5
            ...
            RLottieImageView rLottieImageView = new RLottieImageView(context) { // from class: org.rbmain.ui.ChannelCreateActivity.5
                @Override // android.view.View
                public void invalidate(int i3, int i4, int i5, int i6) {
                    super.invalidate(i3, i4, i5, i6);
                    ChannelCreateActivity.this.avatarOverlay.invalidate();
            ...
            this.nameTextView.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda8
            ...
            this.descriptionTextView.setCursorColor(Theme.getColor(i3));
            ...
            this.descriptionTextView.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda7
                @Override // android.widget.TextView.OnEditorActionListener
                public final boolean onEditorAction(TextView textView, int i4, KeyEvent keyEvent) {
                    return this.f$0.lambda$createView$7(textView, i4, keyEvent);
                }
            });
            this.descriptionTextView.addTextChangedListener(new TextWatcher(this) { // from class: org.rbmain.ui.ChannelCreateActivity.6
            ...
            headerCell2.setBackgroundColor(Theme.getColor(i5));
            ...
            this.linearLayout2.setBackgroundColor(Theme.getColor(i5));
            ...
            this.radioButtonCell1.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
            ...
            this.radioButtonCell2.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view3) {
            ...
            this.linkContainer.setBackgroundColor(Theme.getColor(i5));
            ...
            editTextBoldCursor4.setHintTextColor(Theme.getColor(i6));
            EditTextBoldCursor editTextBoldCursor5 = this.editText;
            int i7 = Theme.key_windowBackgroundWhiteBlackText;
            editTextBoldCursor5.setTextColor(Theme.getColor(i7));
            ...
            this.descriptionTextView.setHintTextColor(Theme.getColor(i6));
            this.descriptionTextView.setTextColor(Theme.getColor(i7));
            ...
            this.descriptionTextView.addTextChangedListener(new TextWatcher() { // from class: org.rbmain.ui.ChannelCreateActivity.7
                @Override // android.text.TextWatcher
                public void afterTextChanged(Editable editable) {
                }
            ...
            LinkActionView linkActionView = new LinkActionView(context, this, null, this.chatId, true, ChatObject.isChannel(getMessagesController().getChat(Integer.valueOf(this.chatId))));
            ...
            textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider_bottom, i8));
            ...
            linearLayout7.setBackgroundColor(Theme.getColor(i5));
            this.adminnedChannelsLayout.setOrientation(1);
            this.linearLayout.addView(this.adminnedChannelsLayout, LayoutHelper.createLinear(-1, -2));
            TextInfoPrivacyCell textInfoPrivacyCell2 = new TextInfoPrivacyCell(context);
            this.adminedInfoCell = textInfoPrivacyCell2;
            textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawable(context, R.drawable.greydivider_bottom, i8));
    ...
    /* renamed from: org.rbmain.ui.ChannelCreateActivity$1, reason: invalid class name */
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                if (ChannelCreateActivity.this.currentStep == 0) {
                    ...
                    if (ChannelCreateActivity.this.nameTextView.length() != 0) {
                        ...
                        if (ChannelCreateActivity.this.imageUpdater.isUploadingImage()) {
                            ...
                            ChannelCreateActivity.this.progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.rbmain.ui.ChannelCreateActivity$1$$ExternalSyntheticLambda0
                        ...
                        final int iCreateChat = MessagesController.getInstance(((BaseFragment) ChannelCreateActivity.this).currentAccount).createChat(ChannelCreateActivity.this.nameTextView.getText().toString(), new ArrayList<>(), ChannelCreateActivity.this.inputPhoto, ChannelCreateActivity.this.inputSmallPhoto, ChannelCreateActivity.this.descriptionTextView.getText().toString(), 2, false, null, null, ChannelCreateActivity.this);
                        ChannelCreateActivity.this.progressDialog = new AlertDialog(ChannelCreateActivity.this.getParentActivity(), 3);
                        ChannelCreateActivity.this.progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.rbmain.ui.ChannelCreateActivity$1$$ExternalSyntheticLambda1
                            @Override // android.content.DialogInterface.OnCancelListener
                            public final void onCancel(DialogInterface dialogInterface) {
                                this.f$0.lambda$onItemClick$1(iCreateChat, dialogInterface);
                            }
                        });
                        ChannelCreateActivity.this.progressDialog.show();
                        return;
                ...
                if (ChannelCreateActivity.this.currentStep == 1) {
                    ...
                    bundle.putString("title", ChannelCreateActivity.this.title);
                    bundle.putString("about", ChannelCreateActivity.this.about);
                    bundle.putBoolean("canCreatePublic", ChannelCreateActivity.this.canCreatePublic);
                    bundle.putLong("small_photo_id", ChannelCreateActivity.this.smallPhotoId);
                    bundle.putLong("photo_id", ChannelCreateActivity.this.photoId);
                    bundle.putInt("step", 2);
                    bundle.putInt("chatId", ChannelCreateActivity.this.chatId);
                    bundle.putInt("chatType", 2);
                    bundle.putBoolean("isPublic", !ChannelCreateActivity.this.isPrivate);
    ...
    public /* synthetic */ void lambda$createView$5(View view) {
        this.imageUpdater.openMenu(this.avatar != null, new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createView$3();
            }
        }, new DialogInterface.OnDismissListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
                this.f$0.lambda$createView$4(dialogInterface);
            }
        });
    ...
    private void generateLink() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_messages_getExportedChatInvites, new RequestDelegate() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda17
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$generateLink$11(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$generateLink$10(tLRPC$TL_error, tLObject);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$generateLink$10(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic) {
            ...
            this.typeInfoCell.setTextColor(Theme.getColor(i));
            ...
            this.permanentLinkView.setVisibility(8);
            this.checkTextView.setVisibility(8);
        }
    ...
    public void didUploadPhoto(final TLRPC$InputFile tLRPC$InputFile, final TLRPC$InputFile tLRPC$InputFile2, final TLRPC$InputFile tLRPC$InputFile3, final double d, final String str, final TLRPC$PhotoSize tLRPC$PhotoSize, final TLRPC$PhotoSize tLRPC$PhotoSize2) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$didUploadPhoto$12(tLRPC$InputFile, tLRPC$InputFile2, tLRPC$InputFile3, str, d, tLRPC$PhotoSize2, tLRPC$PhotoSize);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didUploadPhoto$12(TLRPC$InputFile tLRPC$InputFile, TLRPC$InputFile tLRPC$InputFile2, TLRPC$InputFile tLRPC$InputFile3, String str, double d, TLRPC$PhotoSize tLRPC$PhotoSize, TLRPC$PhotoSize tLRPC$PhotoSize2) {
    ...
    private void showAvatarProgress(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.avatarAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ChannelCreateActivity.8
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.chatDidCreated) {
            ...
            bundle.putInt("chat_id", iIntValue);
            bundle.putString("title", this.nameTextView.getText().toString());
            bundle.putString("about", this.descriptionTextView.getText().toString());
            bundle.putBoolean("canCreatePublic", this.canCreatePublic);
            if (this.inputPhoto != null && (tLRPC$InputFile = this.inputSmallPhoto) != null) {
                bundle.putLong("small_photo_id", tLRPC$InputFile.id);
                bundle.putLong("photo_id", this.inputPhoto.id);
            }
    ...
    private void loadAdminedChannels() {
        ...
        updatePrivatePublic();
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_channels_getAdminedPublicChannels(), new RequestDelegate() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda18
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$18(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadAdminedChannels$17(tLObject);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$17(TLObject tLObject) {
        ...
        for (int i2 = 0; i2 < tLRPC$TL_messages_chats.chats.size(); i2++) {
            AdminedChannelCell adminedChannelCell = new AdminedChannelCell(getParentActivity(), new View.OnClickListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadAdminedChannels$16(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$loadAdminedChannels$15(currentChannel, dialogInterface, i);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadAdminedChannels$15(TLRPC$Chat tLRPC$Chat, DialogInterface dialogInterface, int i) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_channels_updateUsername, new RequestDelegate() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda20
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$14(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject instanceof TLRPC$TL_boolTrue) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$loadAdminedChannels$13();
                }
            });
        }
    }
    ...
    public boolean checkUserName(final String str) {
        ...
        Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$checkUserName$21(str);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkUserName$21(final String str) {
        TLRPC$TL_channels_checkUsername tLRPC$TL_channels_checkUsername = new TLRPC$TL_channels_checkUsername();
        ...
        this.checkReqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_channels_checkUsername, new RequestDelegate() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda21
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$checkUserName$20(str, tLObject, tLRPC$TL_error);
            }
        }, 2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkUserName$20(final String str, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$checkUserName$19(str, tLRPC$TL_error, tLObject);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkUserName$19(String str, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        this.checkReqId = 0;
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.rbmain.ui.ChannelCreateActivity$$ExternalSyntheticLambda22
