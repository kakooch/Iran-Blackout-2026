...
import org.rbmain.tgnet.TLRPC$RichText;
...
import org.rbmain.tgnet.TLRPC$TL_page;
import org.rbmain.tgnet.TLRPC$TL_pageBlockAudio;
import org.rbmain.tgnet.TLRPC$TL_pageBlockAuthorDate;
import org.rbmain.tgnet.TLRPC$TL_pageBlockBlockquote;
import org.rbmain.tgnet.TLRPC$TL_pageBlockChannel;
import org.rbmain.tgnet.TLRPC$TL_pageBlockCollage;
import org.rbmain.tgnet.TLRPC$TL_pageBlockCover;
import org.rbmain.tgnet.TLRPC$TL_pageBlockDetails;
import org.rbmain.tgnet.TLRPC$TL_pageBlockDivider;
import org.rbmain.tgnet.TLRPC$TL_pageBlockEmbed;
import org.rbmain.tgnet.TLRPC$TL_pageBlockEmbedPost;
import org.rbmain.tgnet.TLRPC$TL_pageBlockFooter;
import org.rbmain.tgnet.TLRPC$TL_pageBlockHeader;
import org.rbmain.tgnet.TLRPC$TL_pageBlockKicker;
import org.rbmain.tgnet.TLRPC$TL_pageBlockList;
import org.rbmain.tgnet.TLRPC$TL_pageBlockMap;
import org.rbmain.tgnet.TLRPC$TL_pageBlockOrderedList;
import org.rbmain.tgnet.TLRPC$TL_pageBlockParagraph;
import org.rbmain.tgnet.TLRPC$TL_pageBlockPhoto;
import org.rbmain.tgnet.TLRPC$TL_pageBlockPreformatted;
import org.rbmain.tgnet.TLRPC$TL_pageBlockPullquote;
import org.rbmain.tgnet.TLRPC$TL_pageBlockRelatedArticles;
import org.rbmain.tgnet.TLRPC$TL_pageBlockSlideshow;
import org.rbmain.tgnet.TLRPC$TL_pageBlockSubheader;
import org.rbmain.tgnet.TLRPC$TL_pageBlockSubtitle;
import org.rbmain.tgnet.TLRPC$TL_pageBlockTable;
import org.rbmain.tgnet.TLRPC$TL_pageBlockTitle;
import org.rbmain.tgnet.TLRPC$TL_pageBlockVideo;
import org.rbmain.tgnet.TLRPC$TL_pageRelatedArticle;
import org.rbmain.tgnet.TLRPC$TL_pageTableCell;
import org.rbmain.tgnet.TLRPC$TL_pageTableRow;
import org.rbmain.tgnet.TLRPC$TL_photo;
import org.rbmain.tgnet.TLRPC$TL_textAnchor;
import org.rbmain.tgnet.TLRPC$TL_textBold;
import org.rbmain.tgnet.TLRPC$TL_textConcat;
import org.rbmain.tgnet.TLRPC$TL_textEmail;
import org.rbmain.tgnet.TLRPC$TL_textEmpty;
import org.rbmain.tgnet.TLRPC$TL_textFixed;
import org.rbmain.tgnet.TLRPC$TL_textImage;
import org.rbmain.tgnet.TLRPC$TL_textItalic;
import org.rbmain.tgnet.TLRPC$TL_textMarked;
import org.rbmain.tgnet.TLRPC$TL_textPhone;
import org.rbmain.tgnet.TLRPC$TL_textPlain;
import org.rbmain.tgnet.TLRPC$TL_textStrike;
import org.rbmain.tgnet.TLRPC$TL_textSubscript;
import org.rbmain.tgnet.TLRPC$TL_textSuperscript;
import org.rbmain.tgnet.TLRPC$TL_textUnderline;
import org.rbmain.tgnet.TLRPC$TL_textUrl;
...
import org.rbmain.tgnet.TLRPC$TL_webPageNotModified;
...
import org.rbmain.ui.Components.AnchorSpan;
...
import org.rbmain.ui.Components.TableLayout;
import org.rbmain.ui.Components.TextPaintImageReceiverSpan;
import org.rbmain.ui.Components.TextPaintMarkSpan;
import org.rbmain.ui.Components.TextPaintSpan;
import org.rbmain.ui.Components.TextPaintUrlSpan;
import org.rbmain.ui.Components.TextPaintWebpageUrlSpan;
import org.rbmain.ui.Components.TypefaceSpan;
import org.rbmain.ui.Components.WebPlayerView;
...
public class ArticleViewer implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final Property<WindowView, Float> ARTICLE_VIEWER_INNER_TRANSLATION_X = new AnimationProperties.FloatProperty<WindowView>("innerTranslationX") { // from class: org.rbmain.ui.ArticleViewer.1
    ...
    public class DrawingText implements TextSelectionHelper.TextLayoutBlock {
        ...
        @Override // org.rbmain.ui.Cells.TextSelectionHelper.TextLayoutBlock
    ...
    private class TextSizeCell extends FrameLayout {
        ...
        public TextSizeCell(Context context) {
            ...
            this.sizeBar.setDelegate(new SeekBarView.SeekBarViewDelegate(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.TextSizeCell.1
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText(BuildConfig.FLAVOR + SharedConfig.ivFontSize, getMeasuredWidth() - AndroidUtilities.dp(39.0f), AndroidUtilities.dp(28.0f), this.textPaint);
        }
    ...
    private class WindowView extends FrameLayout {
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (ArticleViewer.this.anchorsOffsetMeasuredWidth != i5) {
                for (int i7 = 0; i7 < ArticleViewer.this.listView.length; i7++) {
                    Iterator it = ArticleViewer.this.adapter[i7].anchorsOffset.entrySet().iterator();
                    while (it.hasNext()) {
                        ((Map.Entry) it.next()).setValue(-1);
                    }
                }
                ArticleViewer.this.anchorsOffsetMeasuredWidth = i5;
            }
        ...
        public boolean handleTouchEvent(MotionEvent motionEvent) {
            ...
            if (motionEvent != null && motionEvent.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                ...
                this.tracker.computeCurrentVelocity(CloseCodes.NORMAL_CLOSURE);
                ...
                if (this.startedTracking) {
                    ...
                    animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ArticleViewer.WindowView.1
                        ...
                        public void onAnimationEnd(Animator animator) {
                            if (WindowView.this.movingPage) {
                                ...
                                if (!z) {
                                    ...
                                    ArticleViewer.this.titleTextView.setText(ArticleViewer.this.adapter[0].currentPage.site_name == null ? BuildConfig.FLAVOR : ArticleViewer.this.adapter[0].currentPage.site_name);
    ...
    public void showCopyPopup(final String str) {
        ...
        builder.setItems(new CharSequence[]{LocaleController.getString("Open", R.string.Open), LocaleController.getString("Copy", R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showCopyPopup$0(String str, DialogInterface dialogInterface, int i) throws NoSuchFieldException, Resources.NotFoundException, UnsupportedEncodingException {
        String strDecode;
        if (this.parentActivity == null) {
            return;
        }
        ...
        if (iLastIndexOf != -1) {
            ...
            try {
                strDecode = URLDecoder.decode(str.substring(iLastIndexOf + 1), Utf8Charset.NAME);
    ...
    public void showPopup(View view, int i, int i2, int i3) {
        ...
        if (this.popupLayout == null) {
            ...
            this.popupLayout.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda12
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return this.f$0.lambda$showPopup$1(view2, motionEvent);
                }
            });
            this.popupLayout.setDispatchKeyEventListener(new ActionBarPopupWindow.OnDispatchKeyEventListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda38
                @Override // org.rbmain.ui.ActionBar.ActionBarPopupWindow.OnDispatchKeyEventListener
                public final void onDispatchKeyEvent(KeyEvent keyEvent) {
                    this.f$0.lambda$showPopup$2(keyEvent);
                }
            });
            ...
            this.deleteView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda9
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f$0.lambda$showPopup$3(view2);
                }
            });
            ...
            this.popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda14
                @Override // android.widget.PopupWindow.OnDismissListener
                public final void onDismiss() {
                    this.f$0.lambda$showPopup$4();
                }
            });
        }
    ...
    */
    private boolean openAllParentBlocks(org.rbmain.ui.ArticleViewer.TL_pageBlockDetailsChild r5) {
        /*
            r4 = this;
            org.rbmain.tgnet.TLRPC$PageBlock r5 = org.rbmain.ui.ArticleViewer.TL_pageBlockDetailsChild.access$6300(r5)
            org.rbmain.tgnet.TLRPC$PageBlock r5 = r4.getLastNonListPageBlock(r5)
            boolean r0 = r5 instanceof org.rbmain.tgnet.TLRPC$TL_pageBlockDetails
            r1 = 0
            r2 = 1
            if (r0 == 0) goto L18
            org.rbmain.tgnet.TLRPC$TL_pageBlockDetails r5 = (org.rbmain.tgnet.TLRPC$TL_pageBlockDetails) r5
            boolean r0 = r5.open
            if (r0 != 0) goto L17
            r5.open = r2
            return r2
        L17:
            return r1
        L18:
            boolean r0 = r5 instanceof org.rbmain.ui.ArticleViewer.TL_pageBlockDetailsChild
            if (r0 == 0) goto L3e
            org.rbmain.ui.ArticleViewer$TL_pageBlockDetailsChild r5 = (org.rbmain.ui.ArticleViewer.TL_pageBlockDetailsChild) r5
            org.rbmain.tgnet.TLRPC$PageBlock r0 = org.rbmain.ui.ArticleViewer.TL_pageBlockDetailsChild.access$6400(r5)
            org.rbmain.tgnet.TLRPC$PageBlock r0 = r4.getLastNonListPageBlock(r0)
            boolean r3 = r0 instanceof org.rbmain.tgnet.TLRPC$TL_pageBlockDetails
            if (r3 == 0) goto L34
            org.rbmain.tgnet.TLRPC$TL_pageBlockDetails r0 = (org.rbmain.tgnet.TLRPC$TL_pageBlockDetails) r0
            boolean r3 = r0.open
            if (r3 != 0) goto L34
            r0.open = r2
            r0 = 1
        ...
        L3e:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.openAllParentBlocks(org.rbmain.ui.ArticleViewer$TL_pageBlockDetailsChild):boolean");
    }
    ...
    public void updateInterfaceForCurrentPage(TLRPC$WebPage tLRPC$WebPage, boolean z, int i) {
        ...
        if (!z && i != 0) {
            ...
            this.pageSwitchAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ArticleViewer.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    ArticleViewer.this.listView[1].setVisibility(8);
                    ArticleViewer articleViewer = ArticleViewer.this;
    ...
    private boolean scrollToAnchor(String str) throws NoSuchFieldException, Resources.NotFoundException {
        Integer num = 0;
        ...
        if (numValueOf != null) {
            ...
            if (tLRPC$TL_textAnchor != null) {
                ...
                this.textSelectionHelperBottomSheet.setCallback(new TextSelectionHelper.Callback() { // from class: org.rbmain.ui.ArticleViewer.3
                    @Override // org.rbmain.ui.Cells.TextSelectionHelper.Callback
                ...
                TextView textView = new TextView(this, this.parentActivity) { // from class: org.rbmain.ui.ArticleViewer.4
                ...
                FrameLayout frameLayout = new FrameLayout(this.parentActivity) { // from class: org.rbmain.ui.ArticleViewer.5
                    @Override // android.view.ViewGroup, android.view.View
                    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
                ...
                builder.setDelegate(new BottomSheet.BottomSheetDelegate() { // from class: org.rbmain.ui.ArticleViewer.6
    ...
    public CharSequence getText(TLRPC$WebPage tLRPC$WebPage, View view, TLRPC$RichText tLRPC$RichText, TLRPC$RichText tLRPC$RichText2, TLRPC$PageBlock tLRPC$PageBlock, int i) {
        ...
        ?? spannableStringBuilder4 = BuildConfig.FLAVOR;
        if (z) {
        ...
        if (tLRPC$RichText2 instanceof TLRPC$TL_textConcat) {
            ...
            while (i4 < size) {
                ...
                if (z2 && spannableStringBuilder5.length() != 0 && spannableStringBuilder5.charAt(spannableStringBuilder5.length() - 1) != '\n') {
                ...
                if (textFlags != 0 && !(text instanceof SpannableStringBuilder)) {
                    if ((textFlags & 8) != 0 || (textFlags & 512) != 0) {
                        ...
                        spannableStringBuilder5.setSpan(new TextPaintSpan(getTextPaint(tLRPC$RichText, lastRichText, tLRPC$PageBlock)), length, spannableStringBuilder5.length(), 33);
                    }
                }
                if (z2 && i5 != i6 - 1) {
                    spannableStringBuilder5.append((CharSequence) " ");
        ...
        if (tLRPC$RichText2 instanceof TLRPC$TL_textMarked) {
            SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder(getText(tLRPC$WebPage, view, tLRPC$RichText, ((TLRPC$TL_textMarked) tLRPC$RichText2).text, tLRPC$PageBlock, i));
            ...
            if (spannableStringBuilder6.length() != 0) {
                spannableStringBuilder6.setSpan(new TextPaintMarkSpan((metricAffectingSpanArr3 == null || metricAffectingSpanArr3.length == 0) ? getTextPaint(tLRPC$RichText, tLRPC$RichText2, tLRPC$PageBlock) : null), 0, spannableStringBuilder6.length(), 33);
            }
            return spannableStringBuilder6;
        }
        if (tLRPC$RichText2 instanceof TLRPC$TL_textPhone) {
            SpannableStringBuilder spannableStringBuilder7 = new SpannableStringBuilder(getText(tLRPC$WebPage, view, tLRPC$RichText, ((TLRPC$TL_textPhone) tLRPC$RichText2).text, tLRPC$PageBlock, i));
            ...
            if (spannableStringBuilder7.length() != 0) {
                spannableStringBuilder7.setSpan(new TextPaintUrlSpan((metricAffectingSpanArr4 == null || metricAffectingSpanArr4.length == 0) ? getTextPaint(tLRPC$RichText, tLRPC$RichText2, tLRPC$PageBlock) : null, "tel:" + getUrl(tLRPC$RichText2)), 0, spannableStringBuilder7.length(), 33);
            }
        ...
        if (tLRPC$RichText2 instanceof TLRPC$TL_textImage) {
            ...
            if (documentWithId != null) {
                ...
                if (view != null) {
                    int color = Theme.getColor(Theme.key_windowBackgroundWhite);
                    spannableStringBuilder4.setSpan(new TextPaintImageReceiverSpan(view, documentWithId, tLRPC$WebPage, i3, i2, false, (((((float) Color.red(color)) * 0.2126f) + (((float) Color.green(color)) * 0.7152f)) + (((float) Color.blue(color)) * 0.0722f)) / 255.0f <= 0.705f), 0, spannableStringBuilder4.length(), 33);
                }
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private android.text.TextPaint getTextPaint(org.rbmain.tgnet.TLRPC$RichText r11, org.rbmain.tgnet.TLRPC$RichText r12, org.rbmain.tgnet.TLRPC$PageBlock r13) {
        /*
            Method dump skipped, instructions count: 946
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.getTextPaint(org.rbmain.tgnet.TLRPC$RichText, org.rbmain.tgnet.TLRPC$RichText, org.rbmain.tgnet.TLRPC$PageBlock):android.text.TextPaint");
    }
    ...
    /* JADX WARN: Type inference failed for: r12v8, types: [android.graphics.Path, org.rbmain.ui.Components.LinkPath] */
    /* JADX WARN: Type inference failed for: r1v34 */
    /* JADX WARN: Type inference failed for: r1v36, types: [android.text.Layout, android.text.StaticLayout] */
    /* JADX WARN: Type inference failed for: r1v45 */
    /* JADX WARN: Type inference failed for: r1v46 */
    /* JADX WARN: Type inference failed for: r1v47 */
    /* JADX WARN: Type inference failed for: r8v3, types: [android.graphics.Path, org.rbmain.ui.Components.LinkPath] */
    ...
    public void drawLayoutLink(Canvas canvas, DrawingText drawingText) {
        ...
        if (this.drawBlockSelection) {
            if (drawingText.getLineCount() == 1) {
                width = drawingText.getLineWidth(0);
                lineLeft = drawingText.getLineLeft(0);
            } else {
                width = drawingText.getWidth();
                lineLeft = 0.0f;
            }
            canvas.drawRect((-AndroidUtilities.dp(2.0f)) + lineLeft, 0.0f, lineLeft + width + AndroidUtilities.dp(2.0f), drawingText.getHeight(), urlPaint);
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean checkLayoutForLinks(org.rbmain.ui.ArticleViewer.WebpageAdapter r17, android.view.MotionEvent r18, android.view.View r19, org.rbmain.ui.ArticleViewer.DrawingText r20, int r21, int r22) throws java.lang.NoSuchFieldException, android.content.res.Resources.NotFoundException, java.io.UnsupportedEncodingException {
        /*
            Method dump skipped, instructions count: 480
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.checkLayoutForLinks(org.rbmain.ui.ArticleViewer$WebpageAdapter, android.view.MotionEvent, android.view.View, org.rbmain.ui.ArticleViewer$DrawingText, int, int):boolean");
    }
    ...
    public void openWebpageUrl(String str, final String str2) {
        ...
        this.openUrlReqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_messages_getWebPage, new RequestDelegate() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda33
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$openWebpageUrl$6(i, str2, tLRPC$TL_messages_getWebPage, tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$openWebpageUrl$6(final int i, final String str, final TLRPC$TL_messages_getWebPage tLRPC$TL_messages_getWebPage, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda24
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openWebpageUrl$5(i, tLObject, str, tLRPC$TL_messages_getWebPage);
            }
        });
    }
            ...
            while (true) {
                ...
                while (true) {
                    if (i8 < childCount3) {
                        ...
                        if ((childAt3 instanceof BlockAudioCell) && (messageObject = (blockAudioCell = (BlockAudioCell) childAt3).getMessageObject()) != null && messageObject.getId() == l.longValue()) {
    ...
    public void setParentActivity(Activity activity, BaseFragment baseFragment) {
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: org.rbmain.ui.ArticleViewer.7
            ...
            */
            protected boolean drawChild(android.graphics.Canvas r11, android.view.View r12, long r13) {
                /*
                    r10 = this;
                    org.rbmain.ui.ArticleViewer r2 = org.rbmain.ui.ArticleViewer.this
                    org.rbmain.ui.ArticleViewer$WindowView r2 = org.rbmain.ui.ArticleViewer.access$1800(r2)
                    boolean r2 = org.rbmain.ui.ArticleViewer.WindowView.access$4200(r2)
                    if (r2 == 0) goto Le0
                    int r2 = r10.getMeasuredWidth()
                    org.rbmain.ui.ArticleViewer r3 = org.rbmain.ui.ArticleViewer.this
                    org.rbmain.ui.Components.RecyclerListView[] r3 = org.rbmain.ui.ArticleViewer.access$2800(r3)
                    r4 = 0
                    r3 = r3[r4]
                    float r3 = r3.getTranslationX()
                    int r3 = (int) r3
                    org.rbmain.ui.ArticleViewer r5 = org.rbmain.ui.ArticleViewer.this
                    org.rbmain.ui.Components.RecyclerListView[] r5 = org.rbmain.ui.ArticleViewer.access$2800(r5)
                    r6 = 1
                    r5 = r5[r6]
                    if (r12 != r5) goto L2b
                    r7 = r3
                ...
                L39:
                    ...
                    if (r3 == 0) goto Ldf
                    org.rbmain.ui.ArticleViewer r8 = org.rbmain.ui.ArticleViewer.this
                    org.rbmain.ui.Components.RecyclerListView[] r8 = org.rbmain.ui.ArticleViewer.access$2800(r8)
                    r4 = r8[r4]
                    r8 = 0
                    if (r12 != r4) goto La1
                    int r2 = r2 - r3
                    ...
                    org.rbmain.ui.ArticleViewer r4 = org.rbmain.ui.ArticleViewer.this
                    android.graphics.drawable.Drawable r4 = org.rbmain.ui.ArticleViewer.access$3500(r4)
                    org.rbmain.ui.ArticleViewer r5 = org.rbmain.ui.ArticleViewer.this
                    android.graphics.drawable.Drawable r5 = org.rbmain.ui.ArticleViewer.access$3500(r5)
                    int r5 = r5.getIntrinsicWidth()
                    int r5 = r3 - r5
                    int r6 = r12.getTop()
                    int r1 = r12.getBottom()
                    r4.setBounds(r5, r6, r3, r1)
                    org.rbmain.ui.ArticleViewer r1 = org.rbmain.ui.ArticleViewer.this
                    android.graphics.drawable.Drawable r1 = org.rbmain.ui.ArticleViewer.access$3500(r1)
                ...
                La1:
                    org.rbmain.ui.ArticleViewer r4 = org.rbmain.ui.ArticleViewer.this
                    org.rbmain.ui.Components.RecyclerListView[] r4 = org.rbmain.ui.ArticleViewer.access$2800(r4)
                    r4 = r4[r6]
                    if (r12 != r4) goto Ldf
                ...
                Lbd:
                    org.rbmain.ui.ArticleViewer r1 = org.rbmain.ui.ArticleViewer.this
                    android.graphics.Paint r1 = org.rbmain.ui.ArticleViewer.access$3400(r1)
                    ...
                    float r4 = (float) r4
                    org.rbmain.ui.ArticleViewer r5 = org.rbmain.ui.ArticleViewer.this
                    android.graphics.Paint r5 = org.rbmain.ui.ArticleViewer.access$3400(r5)
                    r0 = r11
                ...
                Le0:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.AnonymousClass7.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
            }
        };
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            this.containerView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda3
        ...
        while (i2 < this.listView.length) {
            ...
            this.listView[i2] = new RecyclerListView(activity) { // from class: org.rbmain.ui.ArticleViewer.8
                ...
                public boolean onInterceptTouchEvent(MotionEvent motionEvent) throws NoSuchFieldException, Resources.NotFoundException, UnsupportedEncodingException {
            ...
            this.listView[i2].setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda40
                @Override // org.rbmain.ui.Components.RecyclerListView.OnItemLongClickListener
                public final boolean onItemClick(View view, int i3) {
                    return this.f$0.lambda$setParentActivity$8(view, i3);
                }
            });
            this.listView[i2].setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda39
                ...
                public final void onItemClick(View view, int i3, float f, float f2) {
                    this.f$0.lambda$setParentActivity$11(webpageAdapter, view, i3, f, f2);
                }
            });
            this.listView[i2].setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.rbmain.ui.ArticleViewer.9
        ...
        FrameLayout frameLayout3 = new FrameLayout(activity) { // from class: org.rbmain.ui.ArticleViewer.10
            @Override // android.view.View
            protected void onDraw(Canvas canvas) {
                float measuredWidth = getMeasuredWidth();
                float measuredHeight = getMeasuredHeight();
        ...
        this.headerView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
        ...
        this.lineProgressTickRunnable = new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
        ...
        EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(this, this.parentActivity) { // from class: org.rbmain.ui.ArticleViewer.11
        ...
        this.searchField.setInputType(this.searchField.getInputType() | MessagesController.UPDATE_MASK_CHAT_SHOW_SPAM);
        if (i3 < 23) {
            this.searchField.setCustomSelectionActionModeCallback(new ActionMode.Callback(this) { // from class: org.rbmain.ui.ArticleViewer.12
        ...
        this.searchField.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda15
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView, int i5, KeyEvent keyEvent) {
                return this.f$0.lambda$setParentActivity$14(textView, i5, keyEvent);
            }
        });
        ...
        ImageView imageView = new ImageView(this.parentActivity) { // from class: org.rbmain.ui.ArticleViewer.14
        ...
        this.clearButton.setColorFilter(new PorterDuffColorFilter(Theme.getColor(i4), PorterDuff.Mode.MULTIPLY));
        this.clearButton.setScaleType(ImageView.ScaleType.CENTER);
        this.clearButton.setAlpha(0.0f);
        this.clearButton.setRotation(45.0f);
        this.clearButton.setScaleX(0.0f);
        this.clearButton.setScaleY(0.0f);
        this.clearButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
        ...
        this.backButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                this.f$0.lambda$setParentActivity$16(view2);
            }
        });
        this.backButton.setContentDescription(LocaleController.getString("AccDescrGoBack", R.string.AccDescrGoBack));
        ActionBarMenuItem actionBarMenuItem = new ActionBarMenuItem(this.parentActivity, null, 1090519039, -5000269) { // from class: org.rbmain.ui.ArticleViewer.15
            @Override // org.rbmain.ui.ActionBar.ActionBarMenuItem
        ...
        this.menuButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                this.f$0.lambda$setParentActivity$17(view2);
            }
        });
        this.menuButton.setDelegate(new ActionBarMenuItem.ActionBarMenuItemDelegate() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda37
            @Override // org.rbmain.ui.ActionBar.ActionBarMenuItem.ActionBarMenuItemDelegate
            public final void onItemClick(int i5) {
                this.f$0.lambda$setParentActivity$19(i5);
            }
        });
        FrameLayout frameLayout6 = new FrameLayout(this, this.parentActivity) { // from class: org.rbmain.ui.ArticleViewer.16
            @Override // android.view.View
        ...
        frameLayout6.setOnTouchListener(new View.OnTouchListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda13
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view2, MotionEvent motionEvent) {
        ...
        this.searchUpButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
        ...
        this.searchDownButton.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) throws NoSuchFieldException, Resources.NotFoundException {
        ...
        articleTextSelectionHelper2.setCallback(new TextSelectionHelper.Callback() { // from class: org.rbmain.ui.ArticleViewer.17
            @Override // org.rbmain.ui.Cells.TextSelectionHelper.Callback
            public void onStateChanged(boolean z) {
                if (z) {
        ...
        PinchToZoomHelper pinchToZoomHelper = new PinchToZoomHelper(this.containerView, null);
        this.pinchToZoomHelper = pinchToZoomHelper;
        pinchToZoomHelper.setClipBoundsListener(new PinchToZoomHelper.ClipBoundsListener() { // from class: org.rbmain.ui.ArticleViewer.18
            @Override // org.rbmain.ui.PinchToZoomHelper.ClipBoundsListener
        ...
        this.pinchToZoomHelper.setCallback(new PinchToZoomHelper.Callback() { // from class: org.rbmain.ui.ArticleViewer.19
            ...
            if (this.previewsReqId == 0) {
                if (!reportCell.hasViews || f >= view.getMeasuredWidth() / 2) {
                    ...
                    if (!(userOrChat instanceof TLRPC$TL_user)) {
                        ...
                        this.previewsReqId = ConnectionsManager.getInstance(i2).sendRequest(tLRPC$TL_contacts_resolveUsername, new RequestDelegate() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda32
                            @Override // org.rbmain.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                                this.f$0.lambda$setParentActivity$10(i2, j, tLObject, tLRPC$TL_error);
                            }
                        });
                        return;
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setParentActivity$10(final int i, final long j, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda28
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setParentActivity$9(tLObject, i, j);
            }
        });
    }
    ...
    /* renamed from: org.rbmain.ui.ArticleViewer$13, reason: invalid class name */
    class AnonymousClass13 implements TextWatcher {
        ...
        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) throws NoSuchFieldException, Resources.NotFoundException {
                ...
                if (TextUtils.isEmpty(charSequence)) {
                    if (ArticleViewer.this.clearButton.getTag() != null) {
                        ...
                        if (ArticleViewer.this.animateClear) {
                            ArticleViewer.this.clearButton.animate().setInterpolator(new DecelerateInterpolator()).alpha(0.0f).setDuration(180L).scaleY(0.0f).scaleX(0.0f).rotation(45.0f).withEndAction(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$13$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
    ...
    public /* synthetic */ void lambda$setParentActivity$19(int i) {
        ...
        if (i == 4) {
            ...
            while (i2 < 2) {
                ...
                this.fontCells[i2].setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setParentActivity$21(View view) throws NoSuchFieldException, Resources.NotFoundException {
        scrollToSearchIndex(this.currentSearchIndex - 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setParentActivity$22(View view) throws NoSuchFieldException, Resources.NotFoundException {
        scrollToSearchIndex(this.currentSearchIndex + 1);
    }
        ...
        if (frameLayout != null) {
            ...
            if (this.attachedToWindow) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    animatorCreateCircularReveal.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ArticleViewer.20
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                            if (z) {
                                return;
                ...
                animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ArticleViewer.21
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        if (z) {
                        ...
                        ArticleViewer.this.searchField.setText(BuildConfig.FLAVOR);
                    }
                ...
                if (!z && !AndroidUtilities.usingHardwareInput && this.keyboardVisible) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda18
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    private void updateSearchButtons() {
        ...
        if (size < 0) {
            this.searchCountText.setText(BuildConfig.FLAVOR);
            return;
        }
        if (size == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void processSearch(final String str) throws NoSuchFieldException, Resources.NotFoundException {
        ...
        Runnable runnable2 = new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processSearch$26(str, i);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processSearch$26(final String str, final int i) {
        ...
        this.searchRunnable = null;
        Utilities.searchQueue.postRunnable(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda27
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processSearch$25(arrayList, map, str, i);
            }
        });
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x005b A[PHI: r11 r17
      ...
      0x005b: PHI (r17v1 org.rbmain.tgnet.TLRPC$PageBlock) = (r17v0 org.rbmain.tgnet.TLRPC$PageBlock), (r17v5 org.rbmain.tgnet.TLRPC$PageBlock) binds: [B:10:0x0051, B:7:0x0040] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$processSearch$25(java.util.ArrayList r19, java.util.HashMap r20, final java.lang.String r21, final int r22) {
        /*
            r18 = this;
            r7 = r18
            r8 = r21
        ...
        Lf:
            ...
            r6 = r0
            org.rbmain.tgnet.TLRPC$PageBlock r6 = (org.rbmain.tgnet.TLRPC$PageBlock) r6
            boolean r0 = r14 instanceof org.rbmain.tgnet.TLRPC$RichText
            r5 = 0
            if (r0 == 0) goto L4c
            r4 = r14
            org.rbmain.tgnet.TLRPC$RichText r4 = (org.rbmain.tgnet.TLRPC$RichText) r4
            org.rbmain.ui.ArticleViewer$WebpageAdapter[] r0 = r7.adapter
            r1 = r0[r11]
            r2 = 0
        ...
        L5f:
            ...
            boolean r2 = org.rbmain.messenger.AndroidUtilities.isPunctuationCharacter(r2)
            if (r2 == 0) goto L79
            goto L7c
        L79:
            r0 = r17
            goto L8f
        L7c:
            org.rbmain.ui.ArticleViewer$SearchResult r2 = new org.rbmain.ui.ArticleViewer$SearchResult
            r2.<init>()
            org.rbmain.ui.ArticleViewer.SearchResult.access$402(r2, r0)
            r0 = r17
            org.rbmain.ui.ArticleViewer.SearchResult.access$202(r2, r0)
            org.rbmain.ui.ArticleViewer.SearchResult.access$302(r2, r14)
            r9.add(r2)
        L8f:
            r17 = r0
            r0 = r1
        ...
        L93:
            ...
            goto Lf
        L98:
            org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda23 r0 = new org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda23
            r1 = r22
            r0.<init>()
            org.rbmain.messenger.AndroidUtilities.runOnUIThread(r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.lambda$processSearch$25(java.util.ArrayList, java.util.HashMap, java.lang.String, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processSearch$24(int i, ArrayList arrayList, String str) throws NoSuchFieldException, Resources.NotFoundException {
    ...
    */
    private void scrollToSearchIndex(int r12) throws java.lang.NoSuchFieldException, android.content.res.Resources.NotFoundException {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.scrollToSearchIndex(int):void");
    }
    ...
    public void checkScrollAnimated() {
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda0
    ...
    public void setCurrentHeaderHeight(int i) {
        ...
        this.lineProgressView.setScaleY((((i - iMax) / f) * 0.5f) + 0.5f);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean open(final org.rbmain.messenger.MessageObject r12, org.rbmain.tgnet.TLRPC$WebPage r13, java.lang.String r14, boolean r15) {
        /*
            Method dump skipped, instructions count: 518
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.open(org.rbmain.messenger.MessageObject, org.rbmain.tgnet.TLRPC$WebPage, java.lang.String, boolean):boolean");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$open$29(final TLRPC$WebPage tLRPC$WebPage, final MessageObject messageObject, final int i, final String str, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda29
            @Override // java.lang.Runnable
            public final void run() throws NoSuchFieldException, Resources.NotFoundException {
                this.f$0.lambda$open$28(tLObject, tLRPC$WebPage, messageObject, i, str);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$open$28(TLObject tLObject, TLRPC$WebPage tLRPC$WebPage, MessageObject messageObject, int i, String str) throws NoSuchFieldException, Resources.NotFoundException {
        ...
        if (tLObject instanceof TLRPC$TL_webPage) {
            ...
            if (!this.pagesStack.isEmpty() && this.pagesStack.get(0) == tLRPC$WebPage) {
                if (messageObject != null) {
                    ...
                    MessagesStorage.getInstance(i).putMessages((TLRPC$messages_Messages) tLRPC$TL_messages_messages, messageObject.getDialogId(), -2, 0L, false, messageObject.scheduled);
                }
                this.pagesStack.set(0, tLRPC$TL_webPage);
                if (this.pagesStack.size() == 1) {
                    ApplicationLoader.applicationContext.getSharedPreferences("articles", 0).edit().remove("article" + tLRPC$TL_webPage.id).apply();
        ...
        if (tLObject instanceof TLRPC$TL_webPageNotModified) {
            ...
            if (i3 != i4) {
                ...
                if (messageObject != null) {
                    ...
                    MessagesStorage.getInstance(i).putMessages((TLRPC$messages_Messages) tLRPC$TL_messages_messages2, messageObject.getDialogId(), -2, 0L, false, messageObject.scheduled);
                }
            }
        }
    }
    ...
    /* renamed from: org.rbmain.ui.ArticleViewer$22, reason: invalid class name */
    class AnonymousClass22 extends AnimatorListenerAdapter {
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$22$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void showProgressView(boolean z, final boolean z2) {
        ...
        this.progressViewAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ArticleViewer.23
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
    ...
    public void close(boolean z, boolean z2) {
        ...
        this.animationEndRunnable = new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda20
            @Override // java.lang.Runnable
            public final void run() {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.rbmain.ui.ArticleViewer.26
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                if (ArticleViewer.this.animationEndRunnable != null) {
                    ArticleViewer.this.animationEndRunnable.run();
    ...
    public void onClosed() {
        ...
        this.containerView.post(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onClosed$35();
            }
        });
    }
    ...
    public void loadChannel(final BlockChannelCell blockChannelCell, final WebpageAdapter webpageAdapter, TLRPC$Chat tLRPC$Chat) {
        ...
        ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_contacts_resolveUsername, new RequestDelegate() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda36
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$loadChannel$37(webpageAdapter, i, blockChannelCell, tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$loadChannel$37(final WebpageAdapter webpageAdapter, final int i, final BlockChannelCell blockChannelCell, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda31
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadChannel$36(webpageAdapter, tLRPC$TL_error, tLObject, i, blockChannelCell);
            }
        });
    }
    ...
    public void joinChannel(final BlockChannelCell blockChannelCell, final TLRPC$Chat tLRPC$Chat) {
        ...
        final int i = UserConfig.selectedAccount;
        ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_channels_joinChannel, new RequestDelegate() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda35
            @Override // org.rbmain.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                this.f$0.lambda$joinChannel$41(blockChannelCell, i, tLRPC$TL_channels_joinChannel, tLRPC$Chat, tLObject, tLRPC$TL_error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$joinChannel$41(final BlockChannelCell blockChannelCell, final int i, final TLRPC$TL_channels_joinChannel tLRPC$TL_channels_joinChannel, final TLRPC$Chat tLRPC$Chat, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        boolean z;
        if (tLRPC$TL_error != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda30
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$joinChannel$38(blockChannelCell, i, tLRPC$TL_error, tLRPC$TL_channels_joinChannel);
                }
            });
            return;
        }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                blockChannelCell.setState(2, false);
            }
        });
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
                ArticleViewer.lambda$joinChannel$40(i, tLRPC$Chat);
            }
        }, 1000L);
        MessagesStorage.getInstance(i).updateDialogsWithDeletedMessages(new ArrayList<>(), null, true, tLRPC$Chat.id);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$joinChannel$40(int i, TLRPC$Chat tLRPC$Chat) {
    ...
    public void showDialog(Dialog dialog) {
        ...
        try {
            ...
            this.visibleDialog.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.rbmain.ui.ArticleViewer$$ExternalSyntheticLambda2
    ...
    class WebpageAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Removed duplicated region for block: B:182:0x05a7 A[SYNTHETIC] */
        /* JADX WARN: Type inference failed for: r1v14, types: [org.rbmain.tgnet.TLRPC$PageBlock] */
        /* JADX WARN: Type inference failed for: r1v41, types: [org.rbmain.tgnet.TLRPC$PageBlock] */
        /* JADX WARN: Type inference failed for: r24v0, types: [org.rbmain.ui.ArticleViewer$WebpageAdapter] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public void addBlock(org.rbmain.ui.ArticleViewer.WebpageAdapter r25, org.rbmain.tgnet.TLRPC$PageBlock r26, int r27, int r28, int r29) {
            /*
                Method dump skipped, instructions count: 1461
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.WebpageAdapter.addBlock(org.rbmain.ui.ArticleViewer$WebpageAdapter, org.rbmain.tgnet.TLRPC$PageBlock, int, int, int):void");
        }
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) throws NoSuchFieldException, Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void bindBlockToHolder(int i, RecyclerView.ViewHolder viewHolder, TLRPC$PageBlock tLRPC$PageBlock, int i2, int i3) throws NoSuchFieldException, Resources.NotFoundException {
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r13) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockVideoCell.onTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        */
        protected void onMeasure(int r32, int r33) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockVideoCell.onMeasure(int, int):void");
        }
        ...
        @Override // org.rbmain.ui.Cells.TextSelectionHelper.ArticleSelectableView
    ...
    class BlockAudioCell extends View implements DownloadController.FileDownloadProgressListener, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockAudioCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            seekBar.setDelegate(new SeekBar.SeekBarDelegate() { // from class: org.rbmain.ui.ArticleViewer$BlockAudioCell$$ExternalSyntheticLambda0
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r13) {
            /*
                ...
                float r0 = r13.getX()
                float r1 = r13.getY()
                org.rbmain.ui.Components.SeekBar r2 = r12.seekBar
            ...
            L36:
                ...
                int r6 = org.rbmain.messenger.AndroidUtilities.dp(r5)
                int r2 = r2 + r6
                float r2 = (float) r2
                ...
                if (r2 < 0) goto L66
                int r2 = org.rbmain.messenger.AndroidUtilities.dp(r5)
                int r0 = r0 + r2
                float r0 = (float) r0
            ...
            L8f:
                ...
                if (r0 != 0) goto Lc3
                org.rbmain.ui.ArticleViewer r5 = org.rbmain.ui.ArticleViewer.this
                org.rbmain.ui.ArticleViewer$WebpageAdapter r6 = r12.parentAdapter
                org.rbmain.ui.ArticleViewer$DrawingText r9 = r12.captionLayout
                int r10 = r12.textX
                int r11 = r12.textY
                r7 = r13
                r8 = r12
                boolean r0 = org.rbmain.ui.ArticleViewer.access$8700(r5, r6, r7, r8, r9, r10, r11)
                if (r0 != 0) goto Lc3
                org.rbmain.ui.ArticleViewer r5 = org.rbmain.ui.ArticleViewer.this
                org.rbmain.ui.ArticleViewer$WebpageAdapter r6 = r12.parentAdapter
                org.rbmain.ui.ArticleViewer$DrawingText r9 = r12.creditLayout
                int r10 = r12.textX
                int r0 = r12.textY
            ...
            Lc3:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockAudioCell.onTouchEvent(android.view.MotionEvent):boolean");
        }
            ...
            if (tLRPC$TL_pageBlockEmbedPost != null) {
                if (tLRPC$TL_pageBlockEmbedPost instanceof TL_pageBlockEmbedPostCaption) {
                    ...
                    if (this.currentBlock.date != 0) {
                        ...
                        this.dateLayout = articleViewer3.createLayoutForText(this, LocaleController.chatFullDate.format(this.currentBlock.date * 1000), null, size - AndroidUtilities.dp((this.avatarVisible ? 54 : 0) + 50), AndroidUtilities.dp(29.0f), this.currentBlock, this.parentAdapter);
                    } else {
                    ...
                    if (this.currentBlock.blocks.isEmpty()) {
                        ...
                        DrawingText drawingTextCreateLayoutForText4 = articleViewer4.createLayoutForText(this, null, tLRPC$TL_pageBlockEmbedPost4.caption.text, iDp4, this.textY, tLRPC$TL_pageBlockEmbedPost4, this.parentAdapter);
                        ...
                        DrawingText drawingTextCreateLayoutForText5 = articleViewer5.createLayoutForText(this, null, tLRPC$TL_pageBlockEmbedPost5.caption.credit, iDp4, this.textY + this.creditOffset, tLRPC$TL_pageBlockEmbedPost5, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
    ...
    class BlockEmbedCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        class RubikaWebviewProxy {
            ...
            public void postEvent(final String str, final String str2) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$BlockEmbedCell$RubikaWebviewProxy$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public BlockEmbedCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            this.parentAdapter = webpageAdapter;
            setWillNotDraw(false);
            WebPlayerView webPlayerView = new WebPlayerView(context, false, false, new WebPlayerView.WebPlayerViewDelegate(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockEmbedCell.1
                @Override // org.rbmain.ui.Components.WebPlayerView.WebPlayerViewDelegate
            ...
            if (i >= 17) {
                ...
                this.webView.addJavascriptInterface(new RubikaWebviewProxy(), "RubikaWebviewProxy");
            }
            if (i >= 21) {
            ...
            this.webView.setWebViewClient(new WebViewClient(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockEmbedCell.3
        ...
        /* renamed from: org.rbmain.ui.ArticleViewer$BlockEmbedCell$2, reason: invalid class name */
        class AnonymousClass2 extends WebChromeClient {
            ...
            public void onShowCustomView(View view, WebChromeClient.CustomViewCallback customViewCallback) {
                if (ArticleViewer.this.customView == null) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.rbmain.ui.ArticleViewer$BlockEmbedCell$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        public void setBlock(TLRPC$TL_pageBlockEmbed tLRPC$TL_pageBlockEmbed) {
            ...
            if (tLRPC$TL_pageBlockEmbed2 != tLRPC$TL_pageBlockEmbed3) {
                ...
                try {
                    ...
                    if (str != null) {
                        this.webView.loadDataWithBaseURL("https://rubika.ir/embed", str, "text/html", Utf8Charset.NAME, null);
        ...
        */
        protected void onMeasure(int r13, int r14) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockEmbedCell.onMeasure(int, int):void");
        }
    ...
    public class BlockTableCell extends FrameLayout implements TableLayout.TableLayoutDelegate, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockTableCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.parentAdapter = webpageAdapter;
            HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context, ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockTableCell.1
        ...
        @Override // org.rbmain.ui.Components.TableLayout.TableLayoutDelegate
        ...
        public void setBlock(TLRPC$TL_pageBlockTable tLRPC$TL_pageBlockTable) throws NoSuchFieldException {
            int i;
    ...
    private class BlockCollageCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public class GroupedMessages {
            ...
            private int maxSizeWidth = CloseCodes.NORMAL_CLOSURE;
            ...
            */
            public void calculate() {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockCollageCell.GroupedMessages.calculate():void");
            }
        }
        ...
        public BlockCollageCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            this.parentAdapter = webpageAdapter;
            RecyclerListView recyclerListView = new RecyclerListView(context, ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockCollageCell.1
            ...
            recyclerListView.addItemDecoration(new RecyclerView.ItemDecoration(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockCollageCell.2
            ...
            GridLayoutManagerFixed gridLayoutManagerFixed = new GridLayoutManagerFixed(context, CloseCodes.NORMAL_CLOSURE, 1, true, ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockCollageCell.3
            ...
            gridLayoutManagerFixed.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockCollageCell.4
            ...
            RecyclerView.Adapter adapter = new RecyclerView.Adapter(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockCollageCell.5
                @Override // androidx.recyclerview.widget.RecyclerView.Adapter
                public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                    View blockPhotoCell;
                    if (i == 0) {
    ...
    private class BlockSlideshowCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockSlideshowCell(Context context, WebpageAdapter webpageAdapter) throws NoSuchFieldException, Resources.NotFoundException {
            super(context);
            this.textX = AndroidUtilities.dp(18.0f);
            this.parentAdapter = webpageAdapter;
            ...
            ViewPager viewPager = new ViewPager(context, ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockSlideshowCell.1
            ...
            viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockSlideshowCell.2
            ...
            PagerAdapter pagerAdapter = new PagerAdapter(ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockSlideshowCell.3

                /* renamed from: org.rbmain.ui.ArticleViewer$BlockSlideshowCell$3$ObjectContainer */
            ...
            View view = new View(context, ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockSlideshowCell.4
                @Override // android.view.View
                protected void onDraw(Canvas canvas) {
                    int measuredWidth;
                    int i;
        ...
        public void setBlock(TLRPC$TL_pageBlockSlideshow tLRPC$TL_pageBlockSlideshow) throws Resources.NotFoundException {
    ...
    private class BlockListItemCell extends ViewGroup implements TextSelectionHelper.ArticleSelectableView {
        ...
        public void setBlock(TL_pageBlockListItem tL_pageBlockListItem) throws NoSuchFieldException {
        ...
        */
        protected void onMeasure(int r17, int r18) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockListItemCell.onMeasure(int, int):void");
        }
    ...
    private class BlockOrderedListItemCell extends ViewGroup implements TextSelectionHelper.ArticleSelectableView {
        ...
        public void setBlock(TL_pageBlockOrderedListItem tL_pageBlockOrderedListItem) throws NoSuchFieldException {
        ...
        */
        protected void onMeasure(int r17, int r18) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockOrderedListItemCell.onMeasure(int, int):void");
        }
    ...
    private class BlockRelatedArticlesCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageRelatedArticle.published_date != 0 && !TextUtils.isEmpty(tLRPC$TL_pageRelatedArticle.author)) {
                LocaleController.getInstance();
                string = LocaleController.formatString("ArticleDateByAuthor", R.string.ArticleDateByAuthor, LocaleController.chatFullDate.format(tLRPC$TL_pageRelatedArticle.published_date * 1000), tLRPC$TL_pageRelatedArticle.author);
                ...
                LocaleController.getInstance();
                string = LocaleController.chatFullDate.format(tLRPC$TL_pageRelatedArticle.published_date * 1000);
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r13) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockPhotoCell.onTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        */
        protected void onMeasure(int r29, int r30) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockPhotoCell.onMeasure(int, int):void");
        }
        ...
        */
        protected void onMeasure(int r32, int r33) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.BlockMapCell.onMeasure(int, int):void");
        }
    ...
    class BlockChannelCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockChannelCell(Context context, WebpageAdapter webpageAdapter, int i) {
            ...
            this.textView.setOnClickListener(new View.OnClickListener() { // from class: org.rbmain.ui.ArticleViewer$BlockChannelCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private class BlockAuthorDateCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        /* JADX WARN: Type inference failed for: r15v9, types: [android.text.Spannable] */
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockAuthorDate != null) {
                ...
                if (this.currentBlock.published_date != 0 && !TextUtils.isEmpty(text)) {
                    LocaleController.getInstance();
                    charSequenceNewSpannable = LocaleController.formatString("ArticleDateByAuthor", R.string.ArticleDateByAuthor, LocaleController.chatFullDate.format(this.currentBlock.published_date * 1000), text);
                } else if (!TextUtils.isEmpty(text)) {
                    charSequenceNewSpannable = LocaleController.formatString("ArticleByAuthor", R.string.ArticleByAuthor, text);
                } else {
                    LocaleController.getInstance();
                    charSequenceNewSpannable = LocaleController.chatFullDate.format(this.currentBlock.published_date * 1000);
                }
    ...
    class BlockPreformattedCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockPreformattedCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.parentAdapter = webpageAdapter;
            HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context, ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockPreformattedCell.1
                @Override // android.widget.HorizontalScrollView, android.view.ViewGroup
                public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
            ...
            addView(this.scrollView, LayoutHelper.createFrame(-1, -2.0f));
            this.textContainer = new View(context, ArticleViewer.this) { // from class: org.rbmain.ui.ArticleViewer.BlockPreformattedCell.2
                @Override // android.view.View
                protected void onMeasure(int i, int i2) {
                    int i3 = 0;
                    int iMax = 1;
                    ...
                    setMeasuredDimension(iMax + AndroidUtilities.dp(32.0f), i3);
                }
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                this.scrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: org.rbmain.ui.ArticleViewer$BlockPreformattedCell$$ExternalSyntheticLambda0
    ...
    public boolean openPhoto(TLRPC$PageBlock tLRPC$PageBlock, WebpageAdapter webpageAdapter) {
        ...
        if (!(tLRPC$PageBlock instanceof TLRPC$TL_pageBlockVideo) || WebPageUtils.isVideo(webpageAdapter.currentPage, tLRPC$PageBlock)) {
            ...
            iIndexOf = webpageAdapter.photoBlocks.indexOf(tLRPC$PageBlock);
            listSingletonList = arrayList;
        } else {
            listSingletonList = Collections.singletonList(tLRPC$PageBlock);
            iIndexOf = 0;
        }
        PhotoViewer photoViewer = PhotoViewer.getInstance();
        photoViewer.setParentActivity(this.parentActivity);
        return photoViewer.openPhoto(iIndexOf, new RealPageBlocksAdapter(webpageAdapter.currentPage, listSingletonList), new PageBlocksPhotoViewerProvider(listSingletonList));
    }
    ...
    private class RealPageBlocksAdapter implements PhotoViewer.PageBlocksAdapter {
        ...
        @Override // org.rbmain.ui.PhotoViewer.PageBlocksAdapter
        ...
        */
        public java.lang.CharSequence getCaption(int r9) {
            /*
                r8 = this;
                org.rbmain.tgnet.TLRPC$PageBlock r5 = r8.get(r9)
                boolean r9 = r5 instanceof org.rbmain.tgnet.TLRPC$TL_pageBlockPhoto
                r7 = 0
                if (r9 == 0) goto L28
                r9 = r5
                org.rbmain.tgnet.TLRPC$TL_pageBlockPhoto r9 = (org.rbmain.tgnet.TLRPC$TL_pageBlockPhoto) r9
                java.lang.String r9 = r9.url
                boolean r0 = android.text.TextUtils.isEmpty(r9)
                if (r0 != 0) goto L28
                android.text.SpannableStringBuilder r0 = new android.text.SpannableStringBuilder
                r0.<init>(r9)
                org.rbmain.ui.ArticleViewer$RealPageBlocksAdapter$1 r1 = new org.rbmain.ui.ArticleViewer$RealPageBlocksAdapter$1
                r1.<init>(r9)
                int r9 = r9.length()
                r2 = 34
            ...
            L29:
                if (r0 != 0) goto L87
                org.rbmain.ui.ArticleViewer r9 = org.rbmain.ui.ArticleViewer.this
                r0 = 2
                org.rbmain.tgnet.TLRPC$RichText r4 = org.rbmain.ui.ArticleViewer.access$21100(r9, r5, r0)
                org.rbmain.ui.ArticleViewer r0 = org.rbmain.ui.ArticleViewer.this
                org.rbmain.tgnet.TLRPC$WebPage r1 = r8.page
                r2 = 0
                r9 = 1120403456(0x42c80000, float:100.0)
                int r9 = org.rbmain.messenger.AndroidUtilities.dp(r9)
                int r6 = -r9
                r3 = r4
                java.lang.CharSequence r0 = org.rbmain.ui.ArticleViewer.access$21200(r0, r1, r2, r3, r4, r5, r6)
                boolean r9 = r0 instanceof android.text.Spannable
                if (r9 == 0) goto L87
                r9 = r0
                android.text.Spannable r9 = (android.text.Spannable) r9
                int r1 = r0.length()
                java.lang.Class<org.rbmain.ui.Components.TextPaintUrlSpan> r2 = org.rbmain.ui.Components.TextPaintUrlSpan.class
                java.lang.Object[] r1 = r9.getSpans(r7, r1, r2)
                org.rbmain.ui.Components.TextPaintUrlSpan[] r1 = (org.rbmain.ui.Components.TextPaintUrlSpan[]) r1
            ...
            L64:
                int r0 = r1.length
                if (r7 >= r0) goto L86
                org.rbmain.ui.ArticleViewer$RealPageBlocksAdapter$2 r0 = new org.rbmain.ui.ArticleViewer$RealPageBlocksAdapter$2
                r3 = r1[r7]
            ...
            L87:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: org.rbmain.ui.ArticleViewer.RealPageBlocksAdapter.getCaption(int):java.lang.CharSequence");
        }
        ...
        @Override // org.rbmain.ui.PhotoViewer.PageBlocksAdapter
        public void updateSlideshowCell(TLRPC$PageBlock tLRPC$PageBlock) throws Resources.NotFoundException {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt instanceof BlockSlideshowCell) {
                    ...
                    int iIndexOf = blockSlideshowCell.currentBlock.items.indexOf(tLRPC$PageBlock);
                    if (iIndexOf != -1) {
