    ...
    public static TLRPC$GeoPoint TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1297942941:
                ...
                break;
            case 43446532:
                tLRPC$TL_geoPoint = new TLRPC$TL_geoPoint() { // from class: org.rbmain.tgnet.TLRPC$TL_geoPoint_layer119
                    public static int constructor = 43446532;

                    @Override // org.rbmain.tgnet.TLRPC$TL_geoPoint, org.rbmain.tgnet.TLObject
                ...
                break;
            case 286776671:
                tLRPC$TL_geoPoint = new TLRPC$GeoPoint() { // from class: org.rbmain.tgnet.TLRPC$TL_geoPointEmpty
                ...
                break;
            case 541710092:
                tLRPC$TL_geoPoint = new TLRPC$TL_geoPoint() { // from class: org.rbmain.tgnet.TLRPC$TL_geoPoint_layer81
