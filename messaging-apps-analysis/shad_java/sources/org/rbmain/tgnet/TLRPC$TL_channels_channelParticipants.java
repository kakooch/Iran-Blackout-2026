...
public class TLRPC$TL_channels_channelParticipants extends TLRPC$channels_ChannelParticipants {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        for (int i = 0; i < int322; i++) {
            TLRPC$ChannelParticipant tLRPC$ChannelParticipantTLdeserialize = TLRPC$ChannelParticipant.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
