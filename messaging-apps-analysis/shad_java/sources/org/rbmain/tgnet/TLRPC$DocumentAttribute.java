    ...
    public static TLRPC$DocumentAttribute TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -1739392570:
                ...
                break;
            case -1723033470:
                tLRPC$TL_documentAttributeHasStickers = new TLRPC$TL_documentAttributeSticker() { // from class: org.rbmain.tgnet.TLRPC$TL_documentAttributeSticker_old2
                ...
                break;
            case -556656416:
                tLRPC$TL_documentAttributeHasStickers = new TLRPC$TL_documentAttributeAudio() { // from class: org.rbmain.tgnet.TLRPC$TL_documentAttributeAudio_layer45
                    public static int constructor = -556656416;

                    @Override // org.rbmain.tgnet.TLRPC$TL_documentAttributeAudio, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                ...
                break;
            case -83208409:
                tLRPC$TL_documentAttributeHasStickers = new TLRPC$TL_documentAttributeSticker() { // from class: org.rbmain.tgnet.TLRPC$TL_documentAttributeSticker_old
            ...
            case -48981863:
                ...
                break;
            case 85215461:
                tLRPC$TL_documentAttributeHasStickers = new TLRPC$TL_documentAttributeAudio() { // from class: org.rbmain.tgnet.TLRPC$TL_documentAttributeAudio_old
            ...
            case 978674434:
                ...
                break;
            case 1494273227:
                tLRPC$TL_documentAttributeHasStickers = new TLRPC$TL_documentAttributeVideo_layer65();
                break;
            case 1662637586:
