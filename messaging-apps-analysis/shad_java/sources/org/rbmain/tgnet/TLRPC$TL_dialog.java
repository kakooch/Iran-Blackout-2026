...
public class TLRPC$TL_dialog extends TLRPC$Dialog {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        abstractSerializedData.writeInt32((int) this.top_message);
        abstractSerializedData.writeInt32((int) this.read_inbox_max_id);
        abstractSerializedData.writeInt32((int) this.read_outbox_max_id);
