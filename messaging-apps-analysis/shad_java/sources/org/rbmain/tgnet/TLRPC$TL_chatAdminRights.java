...
public class TLRPC$TL_chatAdminRights extends TLObject {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.add_admins = (int32 & 512) != 0;
        this.anonymous = (int32 & 1024) != 0;
        this.manage_call = (int32 & 2048) != 0;
        this.other = (int32 & 4096) != 0;
    }
    ...
    public void setFlags() {
        ...
        int i10 = this.manage_call ? i9 | 2048 : i9 & (-2049);
        this.flags = i10;
        this.flags = this.other ? i10 | 4096 : i10 & (-4097);
    }
}
