    ...
    public static TLRPC$User TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1820043071:
                ...
                break;
            case -1298475060:
                tLRPC$TL_user = new TLRPC$TL_userDeleted_old2() { // from class: org.rbmain.tgnet.TLRPC$TL_userDeleted_old
                    public static int constructor = -1298475060;

                    @Override // org.rbmain.tgnet.TLRPC$TL_userDeleted_old2, org.rbmain.tgnet.TLObject
            ...
            case -894214632:
                ...
                break;
            case -787638374:
                tLRPC$TL_user = new TLRPC$TL_user() { // from class: org.rbmain.tgnet.TLRPC$TL_user_layer65
                    public static int constructor = -787638374;

                    @Override // org.rbmain.tgnet.TLRPC$TL_user, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        this.flags = i7;
                        int i8 = this.bot_nochats ? i7 | MessagesController.UPDATE_MASK_CHECK : i7 & (-65537);
                        this.flags = i8;
                        int i9 = this.verified ? i8 | MessagesController.UPDATE_MASK_REORDER : i8 & (-131073);
                        this.flags = i9;
                        int i10 = this.restricted ? i9 | MessagesController.UPDATE_MASK_CHAT_MUTE : i9 & (-262145);
                        this.flags = i10;
            ...
            case -640891665:
                ...
                break;
            case -218397927:
                tLRPC$TL_user = new TLRPC$TL_userContact_old2() { // from class: org.rbmain.tgnet.TLRPC$TL_userContact_old
                    public static int constructor = -218397927;

                    @Override // org.rbmain.tgnet.TLRPC$TL_userContact_old2, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.id = abstractSerializedData2.readInt32(z2);
                        this.first_name = abstractSerializedData2.readString(z2);
                        this.last_name = abstractSerializedData2.readString(z2);
            ...
            case 537022650:
                ...
                break;
            case 585404530:
                tLRPC$TL_user = new TLRPC$TL_user() { // from class: org.rbmain.tgnet.TLRPC$TL_user_old
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.bot_nochats = (65536 & int32) != 0;
                        this.verified = (131072 & int32) != 0;
                        this.explicit_content = (int32 & MessagesController.UPDATE_MASK_CHAT_MUTE) != 0;
                        this.id = abstractSerializedData2.readInt32(z2);
                        if ((this.flags & 1) != 0) {
                            this.access_hash = abstractSerializedData2.readInt64(z2);
                        }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        int i9 = this.verified ? i8 | MessagesController.UPDATE_MASK_REORDER : i8 & (-131073);
                        this.flags = i9;
                        int i10 = this.explicit_content ? i9 | MessagesController.UPDATE_MASK_CHAT_MUTE : i9 & (-262145);
                        this.flags = i10;
                ...
                break;
            case 585682608:
                tLRPC$TL_user = new TLRPC$TL_userRequest_old2() { // from class: org.rbmain.tgnet.TLRPC$TL_userRequest_old
                    public static int constructor = 585682608;

                    @Override // org.rbmain.tgnet.TLRPC$TL_userRequest_old2, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.id = abstractSerializedData2.readInt32(z2);
                        this.first_name = abstractSerializedData2.readString(z2);
                        this.last_name = abstractSerializedData2.readString(z2);
                ...
                break;
            case 773059779:
                tLRPC$TL_user = new TLRPC$TL_user() { // from class: org.rbmain.tgnet.TLRPC$TL_user_layer104
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.scam = (int32 & ConnectionsManager.FileTypePhoto) != 0;
                        this.id = abstractSerializedData2.readInt32(z2);
                        if ((this.flags & 1) != 0) {
                            this.access_hash = abstractSerializedData2.readInt64(z2);
                        }
                ...
                break;
            case 1377093789:
                tLRPC$TL_user = new TLRPC$TL_userForeign_old2() { // from class: org.rbmain.tgnet.TLRPC$TL_userForeign_old
                    public static int constructor = 1377093789;

                    @Override // org.rbmain.tgnet.TLRPC$TL_userForeign_old2, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.id = abstractSerializedData2.readInt32(z2);
                        this.first_name = abstractSerializedData2.readString(z2);
                        this.last_name = abstractSerializedData2.readString(z2);
                ...
                break;
            case 1879553105:
                tLRPC$TL_user = new TLRPC$TL_userSelf_old3() { // from class: org.rbmain.tgnet.TLRPC$TL_userSelf_old2
                    public static int constructor = 1879553105;

                    @Override // org.rbmain.tgnet.TLRPC$TL_userSelf_old3, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.id = abstractSerializedData2.readInt32(z2);
                        this.first_name = abstractSerializedData2.readString(z2);
                        this.last_name = abstractSerializedData2.readString(z2);
                ...
                break;
            case 1912944108:
                tLRPC$TL_user = new TLRPC$TL_userSelf_old3() { // from class: org.rbmain.tgnet.TLRPC$TL_userSelf_old
