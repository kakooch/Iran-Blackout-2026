...
public abstract class TLRPC$MessageFwdHeader extends TLObject {
    public long channel_post;
    public int date;
    public int flags;
    public Message.ForwardFromObject forwardFromObj;
    public TLRPC$Peer from_id;
    public String from_name;
    public boolean imported;
    public String post_author;
    public String psa_type;
    public long saved_from_msg_id;
    ...
    public static TLRPC$MessageFwdHeader TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -947462709:
                tLRPC$TL_messageFwdHeader = new TLRPC$TL_messageFwdHeader() { // from class: org.rbmain.tgnet.TLRPC$TL_messageFwdHeader_layer68
                    public static int constructor = -947462709;

                    @Override // org.rbmain.tgnet.TLRPC$TL_messageFwdHeader, org.rbmain.tgnet.TLObject
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        if ((this.flags & 2) != 0) {
                            abstractSerializedData2.writeInt32(this.from_id.channel_id);
                        }
                        if ((this.flags & 4) != 0) {
                            abstractSerializedData2.writeInt32((int) this.channel_post);
                        }
                    }
                };
                break;
            case -332168592:
                tLRPC$TL_messageFwdHeader = new TLRPC$TL_messageFwdHeader() { // from class: org.rbmain.tgnet.TLRPC$TL_messageFwdHeader_layer112
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        if ((this.flags & 16) != 0) {
                            abstractSerializedData2.writeInt32((int) this.saved_from_msg_id);
                        }
                    }
                };
                break;
            case -85986132:
                tLRPC$TL_messageFwdHeader = new TLRPC$TL_messageFwdHeader() { // from class: org.rbmain.tgnet.TLRPC$TL_messageFwdHeader_layer72
                ...
                break;
            case 893020267:
                tLRPC$TL_messageFwdHeader = new TLRPC$TL_messageFwdHeader() { // from class: org.rbmain.tgnet.TLRPC$TL_messageFwdHeader_layer118
                ...
                break;
            case 1436466797:
                tLRPC$TL_messageFwdHeader = new TLRPC$TL_messageFwdHeader() { // from class: org.rbmain.tgnet.TLRPC$TL_messageFwdHeader_layer96
