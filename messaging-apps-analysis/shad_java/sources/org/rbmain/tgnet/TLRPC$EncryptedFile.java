...
public abstract class TLRPC$EncryptedFile extends TLObject {
    ...
    public static TLRPC$EncryptedFile TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != -1038136962) {
            tLRPC$EncryptedFile = i != 1248893260 ? null : new TLRPC$EncryptedFile() { // from class: org.rbmain.tgnet.TLRPC$TL_encryptedFile
            ...
            tLRPC$EncryptedFile = new TLRPC$EncryptedFile() { // from class: org.rbmain.tgnet.TLRPC$TL_encryptedFileEmpty
