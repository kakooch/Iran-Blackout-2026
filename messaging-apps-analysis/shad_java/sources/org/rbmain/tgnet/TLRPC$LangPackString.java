...
public abstract class TLRPC$LangPackString extends TLObject {
    ...
    public static TLRPC$LangPackString TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -892239370) {
            tLRPC$LangPackString = new TLRPC$LangPackString() { // from class: org.rbmain.tgnet.TLRPC$TL_langPackString
            ...
            tLRPC$LangPackString = i != 1816636575 ? null : new TLRPC$LangPackString() { // from class: org.rbmain.tgnet.TLRPC$TL_langPackStringPluralized
            ...
            tLRPC$LangPackString = new TLRPC$LangPackString() { // from class: org.rbmain.tgnet.TLRPC$TL_langPackStringDeleted
