...
public abstract class TLRPC$BotInlineResult extends TLObject {
    ...
    public static TLRPC$BotInlineResult TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == 295067450) {
            tLRPC$BotInlineResult = new TLRPC$BotInlineResult() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineResult
            ...
            tLRPC$BotInlineResult = i != 400266251 ? null : new TLRPC$BotInlineResult() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineMediaResult
