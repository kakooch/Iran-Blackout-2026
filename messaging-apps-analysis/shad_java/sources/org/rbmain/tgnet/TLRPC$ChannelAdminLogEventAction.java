    ...
    public static TLRPC$ChannelAdminLogEventAction TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -714643696:
                ...
                break;
            case -610299584:
                tLRPC$TL_channelAdminLogEventActionStopPoll = new TLRPC$ChannelAdminLogEventAction() { // from class: org.rbmain.tgnet.TLRPC$TL_channelAdminLogEventActionDiscardGroupCall
            ...
            case -370660328:
                ...
                break;
            case -124291086:
                tLRPC$TL_channelAdminLogEventActionStopPoll = new TLRPC$ChannelAdminLogEventAction() { // from class: org.rbmain.tgnet.TLRPC$TL_channelAdminLogEventActionParticipantLeave
            ...
            case 241923758:
                ...
                break;
            case 405815507:
                tLRPC$TL_channelAdminLogEventActionStopPoll = new TLRPC$ChannelAdminLogEventAction() { // from class: org.rbmain.tgnet.TLRPC$TL_channelAdminLogEventActionParticipantJoin
            ...
            case 460916654:
                ...
                break;
            case 589338437:
                tLRPC$TL_channelAdminLogEventActionStopPoll = new TLRPC$ChannelAdminLogEventAction() { // from class: org.rbmain.tgnet.TLRPC$TL_channelAdminLogEventActionStartGroupCall
            ...
            case 1515256996:
                ...
                break;
            case 1557846647:
                tLRPC$TL_channelAdminLogEventActionStopPoll = new TLRPC$ChannelAdminLogEventAction() { // from class: org.rbmain.tgnet.TLRPC$TL_channelAdminLogEventActionParticipantJoinByInvite
                    public static int constructor = 1557846647;
                    public TLRPC$TL_chatInviteExported invite;

                    @Override // org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.invite = (TLRPC$TL_chatInviteExported) TLRPC$ExportedChatInvite.TLdeserialize(abstractSerializedData2, abstractSerializedData2.readInt32(z2), z2);
                    }
