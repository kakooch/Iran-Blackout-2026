    ...
    public static TLRPC$BotInlineMessage TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1970903652:
                ...
                break;
            case -1937807902:
                tLRPC$TL_botInlineMessageMediaVenue = new TLRPC$BotInlineMessage() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineMessageText
                ...
                break;
            case -1222451611:
                tLRPC$TL_botInlineMessageMediaVenue = new TLRPC$TL_botInlineMessageMediaGeo() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaGeo_layer119
                    public static int constructor = -1222451611;

                    @Override // org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaGeo, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            case 85477117:
                ...
                break;
            case 175419739:
                tLRPC$TL_botInlineMessageMediaVenue = new TLRPC$TL_botInlineMessageMediaAuto() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaAuto_layer74
                    public static int constructor = 175419739;

                    @Override // org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaAuto, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.flags = abstractSerializedData2.readInt32(z2);
                        this.message = abstractSerializedData2.readString(z2);
                        if ((this.flags & 4) != 0) {
            ...
            case 894081801:
                ...
                break;
            case 904770772:
                tLRPC$TL_botInlineMessageMediaVenue = new TLRPC$TL_botInlineMessageMediaContact() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaContact_layer81
                    public static int constructor = 904770772;

                    @Override // org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaContact, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.flags = abstractSerializedData2.readInt32(z2);
                ...
                break;
            case 982505656:
                tLRPC$TL_botInlineMessageMediaVenue = new TLRPC$TL_botInlineMessageMediaGeo() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaGeo_layer71
                ...
                break;
            case 1130767150:
                tLRPC$TL_botInlineMessageMediaVenue = new TLRPC$TL_botInlineMessageMediaVenue() { // from class: org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaVenue_layer77
                    public static int constructor = 1130767150;

                    @Override // org.rbmain.tgnet.TLRPC$TL_botInlineMessageMediaVenue, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.flags = abstractSerializedData2.readInt32(z2);
                        this.geo = TLRPC$GeoPoint.TLdeserialize(abstractSerializedData2, abstractSerializedData2.readInt32(z2), z2);
