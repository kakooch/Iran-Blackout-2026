...
public abstract class TLRPC$ContactLink_layer101 extends TLObject {
    public static TLRPC$ContactLink_layer101 TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -721239344) {
            tLRPC$ContactLink_layer101 = new TLRPC$ContactLink_layer101() { // from class: org.rbmain.tgnet.TLRPC$TL_contactLinkContact
            ...
            tLRPC$ContactLink_layer101 = new TLRPC$ContactLink_layer101() { // from class: org.rbmain.tgnet.TLRPC$TL_contactLinkNone
            ...
            tLRPC$ContactLink_layer101 = i != 1599050311 ? null : new TLRPC$ContactLink_layer101() { // from class: org.rbmain.tgnet.TLRPC$TL_contactLinkUnknown
