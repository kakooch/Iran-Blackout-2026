    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        if ((this.flags & 64) != 0) {
            ...
            for (int i = 0; i < int322; i++) {
                TLRPC$SecureFile tLRPC$SecureFileTLdeserialize = TLRPC$SecureFile.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
        ...
        if ((this.flags & 16) != 0) {
            ...
            for (int i2 = 0; i2 < int324; i2++) {
                TLRPC$SecureFile tLRPC$SecureFileTLdeserialize2 = TLRPC$SecureFile.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
