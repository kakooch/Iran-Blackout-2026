    ...
    public static TLRPC$MessageMedia TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -1618676578:
                ...
                break;
            case -1563278704:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaVideo_layer45() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaVideo_old
                    public static int constructor = -1563278704;

                    @Override // org.rbmain.tgnet.TLRPC$TL_messageMediaVideo_layer45, org.rbmain.tgnet.TLObject
            ...
            case -1557277184:
                ...
                break;
            case -1256047857:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaPhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaPhoto_layer74
                    public static int constructor = -1256047857;

                    @Override // org.rbmain.tgnet.TLRPC$TL_messageMediaPhoto, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            case -1186937242:
                ...
                break;
            case -961117440:
                tLRPC$TL_messageMediaInvoice = new TLRPC$MessageMedia() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaAudio_layer45
                ...
                break;
            case -926655958:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaPhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaPhoto_old
            ...
            case -873313984:
                ...
                break;
            case -203411800:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaDocument() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaDocument_layer68
                    public static int constructor = -203411800;

                    @Override // org.rbmain.tgnet.TLRPC$TL_messageMediaDocument, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            case 784356159:
                ...
                break;
            case 802824708:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaDocument() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaDocument_old
                ...
                break;
            case 1032643901:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaPhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaPhoto_layer68
            ...
            case 1540298357:
                ...
                break;
            case 1585262393:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaContact() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaContact_layer81
                    public static int constructor = 1585262393;

                    @Override // org.rbmain.tgnet.TLRPC$TL_messageMediaContact, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                ...
                break;
            case 1670374507:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaDice() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaDice_layer111
                    public static int constructor = 1670374507;

                    @Override // org.rbmain.tgnet.TLRPC$TL_messageMediaDice, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            case 1766936791:
                ...
                break;
            case 2031269663:
                tLRPC$TL_messageMediaInvoice = new TLRPC$MessageMedia() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaVenue_layer71
                ...
                break;
            case 2084316681:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaGeoLive() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaGeoLive_layer119
                    public static int constructor = 2084316681;

                    @Override // org.rbmain.tgnet.TLRPC$TL_messageMediaGeoLive, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.geo = TLRPC$GeoPoint.TLdeserialize(abstractSerializedData2, abstractSerializedData2.readInt32(z2), z2);
                ...
                break;
            case 2084836563:
                tLRPC$TL_messageMediaInvoice = new TLRPC$TL_messageMediaDocument() { // from class: org.rbmain.tgnet.TLRPC$TL_messageMediaDocument_layer74
        ...
        if (tLRPC$TL_messageMediaInvoice.video_unused != null) {
            ...
            if (tLRPC$TL_messageMediaDocument.captionLegacy == null) {
                tLRPC$TL_messageMediaDocument.captionLegacy = BuildConfig.FLAVOR;
            }
        } else {
