...
public abstract class TLRPC$RecentMeUrl extends TLObject {
    ...
    public static TLRPC$RecentMeUrl TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1917045962:
                tLRPC$RecentMeUrl = new TLRPC$RecentMeUrl() { // from class: org.rbmain.tgnet.TLRPC$TL_recentMeUrlUser
                ...
                break;
            case -1608834311:
                tLRPC$RecentMeUrl = new TLRPC$RecentMeUrl() { // from class: org.rbmain.tgnet.TLRPC$TL_recentMeUrlChat
                ...
                break;
            case -1140172836:
                tLRPC$RecentMeUrl = new TLRPC$RecentMeUrl() { // from class: org.rbmain.tgnet.TLRPC$TL_recentMeUrlStickerSet
                ...
                break;
            case -347535331:
                tLRPC$RecentMeUrl = new TLRPC$RecentMeUrl() { // from class: org.rbmain.tgnet.TLRPC$TL_recentMeUrlChatInvite
                ...
                break;
            case 1189204285:
                tLRPC$RecentMeUrl = new TLRPC$RecentMeUrl() { // from class: org.rbmain.tgnet.TLRPC$TL_recentMeUrlUnknown
