...
public class TLRPC$RequestPeerType extends TLObject {
    ...
    public static TLRPC$RequestPeerType TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -906990053) {
            ...
            tLRPC$TL_requestPeerTypeChat = i != 1597737472 ? null : new TLRPC$RequestPeerType() { // from class: org.rbmain.tgnet.TLRPC$TL_requestPeerTypeUser
                public Boolean bot;
                ...
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    ...
                    this.flags = int32;
                    if ((int32 & 1) != 0) {
                        this.bot = Boolean.valueOf(abstractSerializedData2.readBool(z2));
                    }
                    if ((this.flags & 2) != 0) {
                        this.premium = Boolean.valueOf(abstractSerializedData2.readBool(z2));
                    }
                }

                @Override // org.rbmain.tgnet.TLObject
                public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                    abstractSerializedData2.writeInt32(1597737472);
                    int i2 = this.bot != null ? this.flags | 1 : this.flags & (-2);
                    this.flags = i2;
                    int i3 = this.premium != null ? i2 | 2 : i2 & (-3);
                    this.flags = i3;
                    abstractSerializedData2.writeInt32(i3);
                    Boolean bool = this.bot;
                    if (bool != null) {
                        abstractSerializedData2.writeBool(bool.booleanValue());
                    }
            ...
            tLRPC$TL_requestPeerTypeChat = new TLRPC$RequestPeerType() { // from class: org.rbmain.tgnet.TLRPC$TL_requestPeerTypeBroadcast
                @Override // org.rbmain.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    int int32 = abstractSerializedData2.readInt32(z2);
                    this.flags = int32;
                    this.creator = Boolean.valueOf((int32 & 1) != 0);
                    if ((this.flags & 8) != 0) {
