    ...
    public static TLRPC$MessageEntity TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -2106619040:
                ...
                break;
            case -1687559349:
                tLRPC$TL_messageEntityItalic = new TLRPC$MessageEntity() { // from class: org.rbmain.tgnet.TLRPC$TL_messageEntityPhone
            ...
            case -1672577397:
                ...
                break;
            case -1148011883:
                tLRPC$TL_messageEntityItalic = new TLRPC$TL_messageEntityUnknown();
                break;
            case -1117713463:
            ...
            case -1090087980:
                ...
                break;
            case -100378723:
                tLRPC$TL_messageEntityItalic = new TLRPC$MessageEntity() { // from class: org.rbmain.tgnet.TLRPC$TL_messageEntityMention
            ...
            case 892193368:
                ...
                break;
            case 1280209983:
                tLRPC$TL_messageEntityItalic = new TLRPC$MessageEntity() { // from class: org.rbmain.tgnet.TLRPC$TL_messageEntityCashtag
                ...
                break;
            case 1692693954:
                tLRPC$TL_messageEntityItalic = new TLRPC$MessageEntity() { // from class: org.rbmain.tgnet.TLRPC$TL_messageEntityEmail
                ...
                break;
            case 1827637959:
                tLRPC$TL_messageEntityItalic = new TLRPC$MessageEntity() { // from class: org.rbmain.tgnet.TLRPC$TL_messageEntityBotCommand
            ...
            case 1859134776:
                ...
                break;
            case 1868782349:
                tLRPC$TL_messageEntityItalic = new TLRPC$MessageEntity() { // from class: org.rbmain.tgnet.TLRPC$TL_messageEntityHashtag
            ...
            case 1938967520:
                ...
                break;
            case 1981704948:
                tLRPC$TL_messageEntityItalic = new TLRPC$MessageEntity() { // from class: org.rbmain.tgnet.TLRPC$TL_messageEntityBankCard
