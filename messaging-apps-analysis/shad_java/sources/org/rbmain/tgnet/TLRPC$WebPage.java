...
public abstract class TLRPC$WebPage extends TLObject {
    ...
    public static TLRPC$WebPage TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -2054908813:
                tLRPC$TL_webPagePending = new TLRPC$TL_webPageNotModified() { // from class: org.rbmain.tgnet.TLRPC$TL_webPageNotModified_layer110
                    public static int constructor = -2054908813;

                    @Override // org.rbmain.tgnet.TLRPC$TL_webPageNotModified, org.rbmain.tgnet.TLObject
                ...
                break;
            case -1558273867:
                tLRPC$TL_webPagePending = new TLRPC$TL_webPage() { // from class: org.rbmain.tgnet.TLRPC$TL_webPage_old
                    public static int constructor = -1558273867;

                    @Override // org.rbmain.tgnet.TLRPC$TL_webPage, org.rbmain.tgnet.TLObject
            ...
            case -981018084:
                ...
                break;
            case -897446185:
                tLRPC$TL_webPagePending = new TLRPC$TL_webPage() { // from class: org.rbmain.tgnet.TLRPC$TL_webPage_layer58
            ...
            case -350980120:
                ...
                break;
            case -94051982:
                tLRPC$TL_webPagePending = new TLRPC$TL_webPage() { // from class: org.rbmain.tgnet.TLRPC$TL_webPage_layer107
                ...
                break;
            case 1594340540:
                tLRPC$TL_webPagePending = new TLRPC$TL_webPage() { // from class: org.rbmain.tgnet.TLRPC$TL_webPage_layer104
