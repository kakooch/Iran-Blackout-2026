    ...
    public static TLRPC$MessagePeerReaction TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1938180548:
                ...
                break;
            case -1826077446:
                tLRPC$TL_messagePeerReaction = new TLRPC$MessagePeerReaction() { // from class: org.rbmain.tgnet.TLRPC$TL_messagePeerReaction_layer137
                ...
                break;
            case -1319698788:
                tLRPC$TL_messagePeerReaction = new TLRPC$MessagePeerReaction() { // from class: org.rbmain.tgnet.TLRPC$TL_messagePeerReaction_layer154
                ...
                break;
            case 1370914559:
                tLRPC$TL_messagePeerReaction = new TLRPC$MessagePeerReaction() { // from class: org.rbmain.tgnet.TLRPC$TL_messagePeerReaction_layer144
