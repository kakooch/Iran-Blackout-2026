    ...
    public static TLRPC$DecryptedMessageMedia TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -1760785394:
                ...
                break;
            case -1332395189:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaDocument() { // from class: org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaDocument_layer8
                    public static int constructor = -1332395189;
                    public byte[] thumb;

                    @Override // org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaDocument, org.rbmain.tgnet.TLObject
            ...
            case 144661578:
                ...
                break;
            case 846826124:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaPhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaPhoto_layer8
                    public static int constructor = 846826124;
                    public byte[] thumb;

                    @Override // org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaPhoto, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.thumb = abstractSerializedData2.readByteArray(z2);
                        this.thumb_w = abstractSerializedData2.readInt32(z2);
                        this.thumb_h = abstractSerializedData2.readInt32(z2);
            ...
            case 893913689:
                ...
                break;
            case 1290694387:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaVideo() { // from class: org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaVideo_layer8
                    public static int constructor = 1290694387;
                    public byte[] thumb;

                    @Override // org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaVideo, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.thumb = abstractSerializedData2.readByteArray(z2);
                        this.thumb_w = abstractSerializedData2.readInt32(z2);
                        this.thumb_h = abstractSerializedData2.readInt32(z2);
                ...
                break;
            case 1380598109:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaVideo() { // from class: org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaVideo_layer17
            ...
            case 1485441687:
                ...
                break;
            case 1619031439:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaAudio() { // from class: org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaAudio_layer8
                    public static int constructor = 1619031439;

                    @Override // org.rbmain.tgnet.TLRPC$TL_decryptedMessageMediaAudio, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.duration = abstractSerializedData2.readInt32(z2);
                        this.size = abstractSerializedData2.readInt32(z2);
                        this.key = abstractSerializedData2.readByteArray(z2);
