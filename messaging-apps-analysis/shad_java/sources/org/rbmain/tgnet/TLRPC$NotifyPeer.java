    ...
    public static TLRPC$NotifyPeer TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1613493288:
                ...
                break;
            case -1261946036:
                tLRPC$TL_notifyPeer = new TLRPC$NotifyPeer() { // from class: org.rbmain.tgnet.TLRPC$TL_notifyUsers
                ...
                break;
            case -1073230141:
                tLRPC$TL_notifyPeer = new TLRPC$NotifyPeer() { // from class: org.rbmain.tgnet.TLRPC$TL_notifyChats
                ...
                break;
            case -703403793:
                tLRPC$TL_notifyPeer = new TLRPC$NotifyPeer() { // from class: org.rbmain.tgnet.TLRPC$TL_notifyBroadcasts
