...
public abstract class TLRPC$MessageReplies extends TLObject {
    ...
    public static TLRPC$MessageReplies TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != -2083123262) {
            tLRPC$TL_messageReplies = i != 1093204652 ? null : new TLRPC$TL_messageReplies() { // from class: org.rbmain.tgnet.TLRPC$TL_messageReplies_layer131
                public static int constructor = 1093204652;

                @Override // org.rbmain.tgnet.TLRPC$TL_messageReplies, org.rbmain.tgnet.TLObject
                ...
                public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                    ...
                    if ((this.flags & 4) != 0) {
                        abstractSerializedData2.writeInt64(this.max_id);
                    }
                    if ((this.flags & 8) != 0) {
                        abstractSerializedData2.writeInt64(this.read_max_id);
                    }
                }
            };
        } else {
