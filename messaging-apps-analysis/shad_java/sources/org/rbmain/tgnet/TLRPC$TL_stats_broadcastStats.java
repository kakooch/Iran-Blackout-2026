...
public class TLRPC$TL_stats_broadcastStats extends TLObject {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        for (int i = 0; i < int322; i++) {
            TLRPC$TL_messageInteractionCounters tLRPC$TL_messageInteractionCountersTLdeserialize = TLRPC$TL_messageInteractionCounters.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
