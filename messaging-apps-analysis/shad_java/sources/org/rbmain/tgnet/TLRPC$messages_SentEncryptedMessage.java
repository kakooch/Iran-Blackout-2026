...
public abstract class TLRPC$messages_SentEncryptedMessage extends TLObject {
    ...
    public static TLRPC$messages_SentEncryptedMessage TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != -1802240206) {
            tLRPC$messages_SentEncryptedMessage = i != 1443858741 ? null : new TLRPC$messages_SentEncryptedMessage() { // from class: org.rbmain.tgnet.TLRPC$TL_messages_sentEncryptedMessage
            ...
            tLRPC$messages_SentEncryptedMessage = new TLRPC$messages_SentEncryptedMessage() { // from class: org.rbmain.tgnet.TLRPC$TL_messages_sentEncryptedFile
