...
public abstract class TLRPC$UserProfilePhoto extends TLObject {
    ...
    public static TLRPC$UserProfilePhoto TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1727196013:
                tLRPC$TL_userProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_userProfilePhoto_old
                    public static int constructor = -1727196013;

                    @Override // org.rbmain.tgnet.TLRPC$TL_userProfilePhoto, org.rbmain.tgnet.TLObject
            ...
            case -865771401:
                ...
                break;
            case -715532088:
                tLRPC$TL_userProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_userProfilePhoto_layer97
                ...
                break;
            case -321430132:
                tLRPC$TL_userProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_userProfilePhoto_layer115
            ...
            case 1326562017:
                ...
                break;
            case 1775479590:
                tLRPC$TL_userProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_userProfilePhoto_layer126
