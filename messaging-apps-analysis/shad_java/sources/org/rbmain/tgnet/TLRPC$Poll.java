...
public abstract class TLRPC$Poll extends TLObject {
    ...
    public static TLRPC$Poll TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -2032041631) {
            ...
            tLRPC$TL_poll = new TLRPC$TL_poll() { // from class: org.rbmain.tgnet.TLRPC$TL_poll_toDelete
                public static int constructor = -1351325818;

                @Override // org.rbmain.tgnet.TLRPC$TL_poll, org.rbmain.tgnet.TLObject
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    ...
                    for (int i2 = 0; i2 < int323; i2++) {
                        TLRPC$TL_pollAnswer tLRPC$TL_pollAnswerTLdeserialize = TLRPC$TL_pollAnswer.TLdeserialize(abstractSerializedData2, abstractSerializedData2.readInt32(z2), z2);
            ...
            tLRPC$TL_poll = i != -716006138 ? null : new TLRPC$TL_poll() { // from class: org.rbmain.tgnet.TLRPC$TL_poll_layer111
