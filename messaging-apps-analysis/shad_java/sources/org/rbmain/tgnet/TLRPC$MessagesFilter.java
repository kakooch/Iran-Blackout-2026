    ...
    public static TLRPC$MessagesFilter TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -2134272152:
                ...
                break;
            case -1777752804:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterPhotos
            ...
            case -1629621880:
                ...
                break;
            case -1614803355:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterVideo
                ...
                break;
            case -1253451181:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterRoundVideo
                ...
                break;
            case -1040652646:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterMyMentions
                ...
                break;
            case -648121413:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterPhotoVideoDocuments
                ...
                break;
            case -530392189:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterContacts
                ...
                break;
            case -419271411:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterGeo
            ...
            case -3644025:
                ...
                break;
            case 464520273:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterPinned
            ...
            case 975236280:
                ...
                break;
            case 1358283666:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMessagesFilterVoice
