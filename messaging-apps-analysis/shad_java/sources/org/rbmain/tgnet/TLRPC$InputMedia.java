...
public abstract class TLRPC$InputMedia extends TLObject {
    ...
    public static TLRPC$InputMedia TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -1771768449:
                tLRPC$TL_inputMediaGeoLive = new TLRPC$InputMedia() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMediaEmpty
            ...
            case -750828557:
                ...
                break;
            case -440664550:
                tLRPC$TL_inputMediaGeoLive = new TLRPC$InputMedia() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMediaPhotoExternal
            ...
            case -104578748:
                ...
                break;
            case -78455655:
                tLRPC$TL_inputMediaGeoLive = new TLRPC$InputMedia() { // from class: org.rbmain.tgnet.TLRPC$TL_inputMediaDocumentExternal
        ...
        if (tLRPC$TL_inputMediaGeoLive == null && z) {
        ...
        if (tLRPC$TL_inputMediaGeoLive != null) {
            tLRPC$TL_inputMediaGeoLive.readParams(abstractSerializedData, z);
        }
