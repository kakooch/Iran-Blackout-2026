    ...
    public static TLRPC$PageBlock TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            ...
            case -1066346178:
                ...
                break;
            case -840826671:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockEmbed() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockEmbed_layer82
                    public static int constructor = -840826671;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockEmbed, org.rbmain.tgnet.TLObject
            ...
            case -837994576:
                ...
                break;
            case -650782469:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockEmbed() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockEmbed_layer60
                ...
                break;
            case -640214938:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockVideo() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockVideo_layer82
                    public static int constructor = -640214938;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockVideo, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int int32 = abstractSerializedData2.readInt32(z2);
                        this.flags = int32;
                ...
                break;
            case -618614392:
                tLRPC$TL_pageBlockAudio = new TLRPC$PageBlock() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockDivider
            ...
            case -454524911:
                ...
                break;
            case -372860542:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockPhoto() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockPhoto_layer82
                    public static int constructor = -372860542;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockPhoto, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            case 52401552:
                ...
                break;
            case 145955919:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockCollage() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockCollage_layer82
                    public static int constructor = 145955919;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockCollage, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int int32 = abstractSerializedData2.readInt32(z2);
                        if (int32 != 481674261) {
                            if (z2) {
                ...
                break;
            case 319588707:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockSlideshow() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockSlideshow_layer82
                    public static int constructor = 319588707;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockSlideshow, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        int int32 = abstractSerializedData2.readInt32(z2);
                        if (int32 != 481674261) {
                            if (z2) {
                ...
                break;
            case 324435594:
                tLRPC$TL_pageBlockAudio = new TLRPC$PageBlock() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockUnsupported
            ...
            case 641563686:
                ...
                break;
            case 690781161:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockEmbedPost() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockEmbedPost_layer82
                    public static int constructor = 690781161;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockEmbedPost, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.url = abstractSerializedData2.readString(z2);
                ...
                break;
            case 834148991:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockAudio() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockAudio_layer82
                    public static int constructor = 834148991;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockAudio, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            case 972174080:
                ...
                break;
            case 978896884:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockList() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockList_layer82
                    public static int constructor = 978896884;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockList, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        int int322 = abstractSerializedData2.readInt32(z2);
                        for (int i2 = 0; i2 < int322; i2++) {
                            TLRPC$RichText tLRPC$RichTextTLdeserialize = TLRPC$RichText.TLdeserialize(abstractSerializedData2, abstractSerializedData2.readInt32(z2), z2);
                ...
                break;
            case 1029399794:
                tLRPC$TL_pageBlockAudio = new TLRPC$TL_pageBlockAuthorDate() { // from class: org.rbmain.tgnet.TLRPC$TL_pageBlockAuthorDate_layer60
                    public static int constructor = 1029399794;

                    @Override // org.rbmain.tgnet.TLRPC$TL_pageBlockAuthorDate, org.rbmain.tgnet.TLObject
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        String string = abstractSerializedData2.readString(z2);
