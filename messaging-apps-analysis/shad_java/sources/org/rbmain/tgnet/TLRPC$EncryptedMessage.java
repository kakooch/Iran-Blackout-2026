...
public abstract class TLRPC$EncryptedMessage extends TLObject {
    ...
    public static TLRPC$EncryptedMessage TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i != -317144808) {
            tLRPC$EncryptedMessage = i != 594758406 ? null : new TLRPC$EncryptedMessage() { // from class: org.rbmain.tgnet.TLRPC$TL_encryptedMessageService
            ...
            tLRPC$EncryptedMessage = new TLRPC$EncryptedMessage() { // from class: org.rbmain.tgnet.TLRPC$TL_encryptedMessage
