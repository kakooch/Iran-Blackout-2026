...
public final class i implements j$.time.temporal.k, Comparable, Serializable {
    ...
    public int compareTo(i iVar) {
        int iC = j$.lang.d.c(this.a, iVar.a);
        if (iC != 0) {
            return iC;
        }
        int iC2 = j$.lang.d.c(this.b, iVar.b);
        if (iC2 != 0) {
            return iC2;
        }
        int iC3 = j$.lang.d.c(this.c, iVar.c);
        return iC3 == 0 ? j$.lang.d.c(this.d, iVar.d) : iC3;
    }
        ...
        if (b3 > 0 || i2 > 0) {
            ...
            if (i2 > 0) {
                ...
                if (i2 % MediaController.VIDEO_BITRATE_480 == 0) {
                    i = (i2 / MediaController.VIDEO_BITRATE_480) + CloseCodes.NORMAL_CLOSURE;
                } else {
