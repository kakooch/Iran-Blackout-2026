...
public final /* synthetic */ class P implements j$.util.function.l {
    ...
    public static /* synthetic */ j$.util.function.l a(IntConsumer intConsumer) {
        if (intConsumer == null) {
            return null;
        }
    ...
    @Override // j$.util.function.l
    public /* synthetic */ j$.util.function.l m(j$.util.function.l lVar) {
        return a(this.a.andThen(Q.a(lVar)));
    }
}
