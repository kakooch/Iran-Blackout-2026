    ...
    public static TLRPC$SendMessageAction TLdeserialize(AbstractSerializedData stream, int constructor, boolean exception) {
        ...
        switch (constructor) {
            case -1997373508:
                ...
                break;
            case -1884362354:
                tLRPC$TL_sendMessageRecordRoundAction = new TLRPC$TL_sendMessageUploadDocumentAction() { // from class: ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadDocumentAction_old
                    public static int constructor = -1884362354;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadDocumentAction, ir.eitaa.tgnet.TLObject
                ...
                break;
            case -1845219337:
                tLRPC$TL_sendMessageRecordRoundAction = new TLRPC$TL_sendMessageUploadVideoAction() { // from class: ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadVideoAction_old
                    public static int constructor = -1845219337;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadVideoAction, ir.eitaa.tgnet.TLObject
                    public void readParams(AbstractSerializedData stream2, boolean exception2) {
                    }
                ...
                break;
            case -1727382502:
                tLRPC$TL_sendMessageRecordRoundAction = new TLRPC$TL_sendMessageUploadPhotoAction() { // from class: ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadPhotoAction_old
                    public static int constructor = -1727382502;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadPhotoAction, ir.eitaa.tgnet.TLObject
                    public void readParams(AbstractSerializedData stream2, boolean exception2) {
                    }
                ...
                break;
            case -1584933265:
                tLRPC$TL_sendMessageRecordRoundAction = new TLRPC$SendMessageAction() { // from class: ir.eitaa.tgnet.TLRPC$TL_sendMessageRecordVideoAction
            ...
            case -580219064:
                ...
                break;
            case -424899985:
                tLRPC$TL_sendMessageRecordRoundAction = new TLRPC$TL_sendMessageUploadAudioAction() { // from class: ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadAudioAction_old
                    public static int constructor = -424899985;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_sendMessageUploadAudioAction, ir.eitaa.tgnet.TLObject
                    public void readParams(AbstractSerializedData stream2, boolean exception2) {
                    }
            ...
            case 381645902:
                ...
                break;
            case 393186209:
                tLRPC$TL_sendMessageRecordRoundAction = new TLRPC$SendMessageAction() { // from class: ir.eitaa.tgnet.TLRPC$TL_sendMessageGeoLocationAction
            ...
            case 630664139:
                ...
                break;
            case 1653390447:
                tLRPC$TL_sendMessageRecordRoundAction = new TLRPC$SendMessageAction() { // from class: ir.eitaa.tgnet.TLRPC$TL_sendMessageChooseContactAction
        ...
        if (tLRPC$TL_sendMessageRecordRoundAction == null && exception) {
            throw new RuntimeException(String.format("can't parse magic %x in SendMessageAction", Integer.valueOf(constructor)));
        }
        if (tLRPC$TL_sendMessageRecordRoundAction != null) {
            tLRPC$TL_sendMessageRecordRoundAction.readParams(stream, exception);
        }
