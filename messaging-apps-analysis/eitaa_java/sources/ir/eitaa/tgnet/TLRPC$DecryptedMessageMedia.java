    ...
    public static TLRPC$DecryptedMessageMedia TLdeserialize(AbstractSerializedData stream, int constructor, boolean exception) {
        ...
        switch (constructor) {
            ...
            case -1760785394:
                ...
                break;
            case -1332395189:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaDocument() { // from class: ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaDocument_layer8
                    public static int constructor = -1332395189;
                    public byte[] thumb;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaDocument, ir.eitaa.tgnet.TLObject
                    public void readParams(AbstractSerializedData stream2, boolean exception2) {
                        this.thumb = stream2.readByteArray(exception2);
                        this.thumb_w = stream2.readInt32(exception2);
                        this.thumb_h = stream2.readInt32(exception2);
                    ...
                    public void serializeToStream(AbstractSerializedData stream2) {
                        ...
                        stream2.writeByteArray(this.thumb);
                        stream2.writeInt32(this.thumb_w);
                        stream2.writeInt32(this.thumb_h);
            ...
            case 144661578:
                ...
                break;
            case 846826124:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaPhoto() { // from class: ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaPhoto_layer8
                    public static int constructor = 846826124;
                    public byte[] thumb;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaPhoto, ir.eitaa.tgnet.TLObject
                    public void readParams(AbstractSerializedData stream2, boolean exception2) {
                        this.thumb = stream2.readByteArray(exception2);
                        this.thumb_w = stream2.readInt32(exception2);
                        this.thumb_h = stream2.readInt32(exception2);
            ...
            case 893913689:
                ...
                break;
            case 1290694387:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaVideo() { // from class: ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaVideo_layer8
                    public static int constructor = 1290694387;
                    public byte[] thumb;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaVideo, ir.eitaa.tgnet.TLObject
                    public void readParams(AbstractSerializedData stream2, boolean exception2) {
                        this.thumb = stream2.readByteArray(exception2);
                        this.thumb_w = stream2.readInt32(exception2);
                        this.thumb_h = stream2.readInt32(exception2);
                ...
                break;
            case 1380598109:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaVideo() { // from class: ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaVideo_layer17
            ...
            case 1485441687:
                ...
                break;
            case 1619031439:
                tLRPC$TL_decryptedMessageMediaVenue = new TLRPC$TL_decryptedMessageMediaAudio() { // from class: ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaAudio_layer8
                    public static int constructor = 1619031439;

                    @Override // ir.eitaa.tgnet.TLRPC$TL_decryptedMessageMediaAudio, ir.eitaa.tgnet.TLObject
                    public void readParams(AbstractSerializedData stream2, boolean exception2) {
                        this.duration = stream2.readInt32(exception2);
                        this.size = stream2.readInt32(exception2);
                        this.key = stream2.readByteArray(exception2);
        ...
        if (tLRPC$TL_decryptedMessageMediaVenue == null && exception) {
            throw new RuntimeException(String.format("can't parse magic %x in DecryptedMessageMedia", Integer.valueOf(constructor)));
        }
        if (tLRPC$TL_decryptedMessageMediaVenue != null) {
            tLRPC$TL_decryptedMessageMediaVenue.readParams(stream, exception);
        }
