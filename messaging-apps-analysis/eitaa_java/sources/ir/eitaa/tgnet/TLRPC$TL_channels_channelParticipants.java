...
public class TLRPC$TL_channels_channelParticipants extends TLRPC$channels_ChannelParticipants {
    ...
    public void readParams(AbstractSerializedData stream, boolean exception) {
        ...
        for (int i = 0; i < int322; i++) {
            TLRPC$ChannelParticipant tLRPC$ChannelParticipantTLdeserialize = TLRPC$ChannelParticipant.TLdeserialize(stream, stream.readInt32(exception), exception);
            if (tLRPC$ChannelParticipantTLdeserialize == null) {
                return;
            }
            this.participants.add(tLRPC$ChannelParticipantTLdeserialize);
        }
