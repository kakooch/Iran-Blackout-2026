    ...
    public static TLRPC$MessagesFilter TLdeserialize(AbstractSerializedData stream, int constructor, boolean exception) {
        ...
        switch (constructor) {
            case -2134272152:
                ...
                break;
            case -1777752804:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterPhotos
            ...
            case -1629621880:
                ...
                break;
            case -1614803355:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterVideo
                ...
                break;
            case -1253451181:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterRoundVideo
                ...
                break;
            case -1040652646:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterMyMentions
                ...
                break;
            case -648121413:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterPhotoVideoDocuments
                ...
                break;
            case -530392189:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterContacts
                ...
                break;
            case -419271411:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterGeo
            ...
            case 975236280:
                ...
                break;
            case 1358283666:
                tLRPC$TL_inputMessagesFilterPhoneCalls = new TLRPC$MessagesFilter() { // from class: ir.eitaa.tgnet.TLRPC$TL_inputMessagesFilterVoice
        ...
        if (tLRPC$TL_inputMessagesFilterPhoneCalls == null && exception) {
            throw new RuntimeException(String.format("can't parse magic %x in MessagesFilter", Integer.valueOf(constructor)));
        }
        if (tLRPC$TL_inputMessagesFilterPhoneCalls != null) {
            tLRPC$TL_inputMessagesFilterPhoneCalls.readParams(stream, exception);
        }
