...
public class TLRPC$TL_messages_discussionMessage extends TLObject {
    ...
    public static TLRPC$TL_messages_discussionMessage TLdeserialize(AbstractSerializedData stream, int constructor2, boolean exception) {
        if (constructor != constructor2) {
            if (exception) {
                throw new RuntimeException(String.format("can't parse magic %x in TL_messages_discussionMessage", Integer.valueOf(constructor2)));
            }
            return null;
        }
        TLRPC$TL_messages_discussionMessage tLRPC$TL_messages_discussionMessage = new TLRPC$TL_messages_discussionMessage();
        tLRPC$TL_messages_discussionMessage.readParams(stream, exception);
