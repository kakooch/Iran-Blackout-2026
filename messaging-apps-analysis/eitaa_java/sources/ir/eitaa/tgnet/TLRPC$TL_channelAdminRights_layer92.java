...
public class TLRPC$TL_channelAdminRights_layer92 extends TLObject {
    ...
    public static TLRPC$TL_channelAdminRights_layer92 TLdeserialize(AbstractSerializedData stream, int constructor2, boolean exception) {
        if (constructor != constructor2) {
            if (exception) {
                throw new RuntimeException(String.format("can't parse magic %x in TL_channelAdminRights_layer92", Integer.valueOf(constructor2)));
            }
            return null;
        }
        TLRPC$TL_channelAdminRights_layer92 tLRPC$TL_channelAdminRights_layer92 = new TLRPC$TL_channelAdminRights_layer92();
        tLRPC$TL_channelAdminRights_layer92.readParams(stream, exception);
    ...
    public void readParams(AbstractSerializedData stream, boolean exception) {
        ...
        this.manage_call = (int32 & Factory.DEVICE_MCH264ENC_NO_PIX_FMT_CONV) != 0;
    ...
    public void serializeToStream(AbstractSerializedData stream) {
        ...
        this.flags = i8;
        int i9 = this.manage_call ? i8 | Factory.DEVICE_MCH264ENC_NO_PIX_FMT_CONV : i8 & (-1025);
        this.flags = i9;
        int i10 = this.post_live ? i9 | 1048576 : i9 & (-1048577);
        this.flags = i10;
