...
public class TLRPC$TL_channelAdminLogEventsFilter extends TLObject {
    ...
    public void readParams(AbstractSerializedData stream, boolean exception) {
        ...
        this.demote = (int32 & Factory.DEVICE_HAS_CRAPPY_OPENSLES) != 0;
        this.info = (int32 & Factory.DEVICE_USE_ANDROID_CAMCORDER) != 0;
        this.settings = (int32 & Factory.DEVICE_MCH264ENC_NO_PIX_FMT_CONV) != 0;
        this.pinned = (int32 & Factory.DEVICE_MCH265_LIMIT_DEQUEUE_OF_OUTPUT_BUFFERS) != 0;
        this.edit = (int32 & Factory.DEVICE_HAS_CRAPPY_AAUDIO) != 0;
        this.delete = (int32 & 8192) != 0;
        this.group_call = (int32 & 16384) != 0;
    ...
    public void serializeToStream(AbstractSerializedData stream) {
        ...
        this.flags = i8;
        int i9 = this.demote ? i8 | Factory.DEVICE_HAS_CRAPPY_OPENSLES : i8 & (-257);
        this.flags = i9;
        int i10 = this.info ? i9 | Factory.DEVICE_USE_ANDROID_CAMCORDER : i9 & (-513);
        this.flags = i10;
        int i11 = this.settings ? i10 | Factory.DEVICE_MCH264ENC_NO_PIX_FMT_CONV : i10 & (-1025);
        this.flags = i11;
        int i12 = this.pinned ? i11 | Factory.DEVICE_MCH265_LIMIT_DEQUEUE_OF_OUTPUT_BUFFERS : i11 & (-2049);
        this.flags = i12;
        int i13 = this.edit ? i12 | Factory.DEVICE_HAS_CRAPPY_AAUDIO : i12 & (-4097);
        this.flags = i13;
