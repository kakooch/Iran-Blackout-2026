...
public class CertSettingView extends FrameLayout {
    ...
    public CertSettingView(Context context, OnCertSelectListener onCertSelectListener) {
        ...
        NumberPicker numberPicker = new NumberPicker(context, 13) { // from class: ir.eitaa.features.CallOut.test.CertSettingView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawLine(AndroidUtilities.dp(2.0f), fDp, getMeasuredWidth() - AndroidUtilities.dp(2.0f), fDp, CertSettingView.this.pickerDividersPaint);
        ...
        this.fontPicker.setFormatter(new NumberPicker.Formatter() { // from class: ir.eitaa.features.CallOut.test.-$$Lambda$CertSettingView$lqDX0X3R1ecgu2DR2Lnck5YqmoY
            @Override // ir.eitaa.ui.Components.NumberPicker.Formatter
            public final String format(int i) {
                return this.f$0.lambda$new$0$CertSettingView(i);
            }
        });
        this.fontPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() { // from class: ir.eitaa.features.CallOut.test.-$$Lambda$CertSettingView$HoKYpWOw31yb-zmeohI9MtAbJBU
            @Override // ir.eitaa.ui.Components.NumberPicker.OnValueChangeListener
            public final void onValueChange(NumberPicker numberPicker2, int i, int i2) {
                this.f$0.lambda$new$1$CertSettingView(numberPicker2, i, i2);
            }
        });
    ...
    public /* synthetic */ String lambda$new$0$CertSettingView(int i) {
        return this.strings[i];
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$new$1, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$new$1$CertSettingView(NumberPicker numberPicker, int i, int i2) {
