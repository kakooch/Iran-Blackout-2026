...
public class ContactsWidgetConfigActivity extends ExternalActionActivity {
    ...
    protected boolean handleIntent(Intent intent, boolean isNew, boolean restore, boolean fromPassword, int intentAccount, int state) {
        ...
        if (this.creatingAppWidgetId != 0) {
            ...
            editWidgetActivity.setDelegate(new EditWidgetActivity.EditWidgetActivityDelegate() { // from class: ir.eitaa.ui.-$$Lambda$ContactsWidgetConfigActivity$HF4GIC3G1CgI1dpopXUKGCGT__Q
                @Override // ir.eitaa.ui.EditWidgetActivity.EditWidgetActivityDelegate
                public final void didSelectDialogs(ArrayList arrayList) {
                    this.f$0.lambda$handleIntent$0$ContactsWidgetConfigActivity(arrayList);
                }
            });
