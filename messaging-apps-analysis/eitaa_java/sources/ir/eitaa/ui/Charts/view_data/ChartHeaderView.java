...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.title.setTypeface(AndroidUtilities.getFontFamily(true));
        ...
        this.dates.setTypeface(AndroidUtilities.getFontFamily(true));
        ...
        this.datesTmp.setTypeface(AndroidUtilities.getFontFamily(true));
        ...
        this.datesTmp.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: ir.eitaa.ui.Charts.view_data.-$$Lambda$ChartHeaderView$yCrBT0BuwdthszOneCZCEmb-3yo
            @Override // android.view.View.OnLayoutChangeListener
            public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                this.f$0.lambda$new$0$ChartHeaderView(view, i, i2, i3, i4, i5, i6, i7, i8);
            }
        });
        recolor();
    }
    ...
    public void setDates(long start, long end) {
        ...
        if (end - start >= 86400000) {
            str = this.formatter.format(new Date(start)) + " — " + this.formatter.format(new Date(end));
        } else {
            str = this.formatter.format(new Date(start));
        }
