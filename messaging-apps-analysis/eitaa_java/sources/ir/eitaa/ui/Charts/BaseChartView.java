...
import ir.eitaa.ui.Charts.view_data.ChartBottomSignatureData;
...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    public BaseChartView(Context context) {
        ...
        this.pickerHeightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.BaseChartView.1
        ...
        this.pickerMinHeightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.BaseChartView.2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator animation) {
        ...
        this.heightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.-$$Lambda$BaseChartView$IUBYSr4z8YWSswR70Q5Y8_6riMM
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$new$0$BaseChartView(valueAnimator);
            }
        };
        this.minHeightUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.-$$Lambda$BaseChartView$vp5s_Tt8dNWxk9gx3ITAi4KpvEE
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$new$1$BaseChartView(valueAnimator);
            }
        };
        this.selectionAnimatorListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.BaseChartView.3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator animation) {
        ...
        this.selectorAnimatorEndListener = new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Charts.BaseChartView.4
    ...
    */
    void drawBottomSignature(android.graphics.Canvas r17) {
        /*
            Method dump skipped, instructions count: 300
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Charts.BaseChartView.drawBottomSignature(android.graphics.Canvas):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected void drawHorizontalLines(android.graphics.Canvas r12, ir.eitaa.ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            int[] r0 = r13.values
            int r1 = r0.length
        ...
        L27:
            ...
            if (r5 != r2) goto L31
            ir.eitaa.ui.Charts.view_data.TransitionParams r2 = r11.transitionParams
        ...
        L3f:
            ...
            int r0 = r0 - r2
            int r2 = ir.eitaa.ui.Charts.BaseChartView.SIGNATURE_TEXT_HEIGHT
            int r0 = r0 - r2
        ...
        L9d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Charts.BaseChartView.drawHorizontalLines(android.graphics.Canvas, ir.eitaa.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected void drawSignaturesToHorizontalLines(android.graphics.Canvas r11, ir.eitaa.ui.Charts.view_data.ChartHorizontalLinesData r12) {
        /*
            r10 = this;
            int[] r0 = r12.values
            int r1 = r0.length
        ...
        L27:
            ...
            if (r5 != r2) goto L31
            ir.eitaa.ui.Charts.view_data.TransitionParams r2 = r10.transitionParams
            float r2 = r2.progress
            float r3 = r3 - r2
            goto L3f
        L31:
        ...
        L7b:
            ...
            r5 = r5[r3]
            float r6 = ir.eitaa.ui.Charts.BaseChartView.HORIZONTAL_PADDING
            int r4 = r4 - r2
            float r4 = (float) r4
        ...
        La6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Charts.BaseChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, ir.eitaa.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    */
    void drawPicker(android.graphics.Canvas r29) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Charts.BaseChartView.drawPicker(android.graphics.Canvas):void");
    }
    ...
    protected void setMaxMinValue(int newMaxHeight, int newMinHeight, boolean animated, boolean force, boolean useAnimator) {
        if ((Math.abs(((float) ChartHorizontalLinesData.lookupHeight(newMaxHeight)) - this.animateToMaxHeight) >= this.thresholdMaxHeight && newMaxHeight != 0) || newMaxHeight != this.animateToMinHeight) {
            final ChartHorizontalLinesData chartHorizontalLinesDataCreateHorizontalLinesData = createHorizontalLinesData(newMaxHeight, newMinHeight);
            int[] iArr = chartHorizontalLinesDataCreateHorizontalLinesData.values;
            ...
            if (!useAnimator) {
                ...
                boolean z = ((float) i) != this.animateToMaxHeight;
                if (this.useMinHeight && i2 != this.animateToMinHeight) {
                    z = true;
                }
                if (z) {
            ...
            if (jCurrentTimeMillis - this.lastTime >= 320 || force) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ChartHorizontalLinesData chartHorizontalLinesData = this.horizontalLines.get(i3);
                ...
                ValueAnimator valueAnimatorCreateAnimator = createAnimator(0.0f, 255.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.-$$Lambda$BaseChartView$6BMcktE6prkZpz0ZaPlcjfje1s8
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        this.f$0.lambda$setMaxMinValue$2$BaseChartView(chartHorizontalLinesDataCreateHorizontalLinesData, valueAnimator2);
                    }
                });
                this.alphaAnimator = valueAnimatorCreateAnimator;
                valueAnimatorCreateAnimator.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Charts.BaseChartView.5
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animation) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$setMaxMinValue$2, reason: merged with bridge method [inline-methods] */
    ...
    ValueAnimator createAnimator(float f1, float f2, ValueAnimator.AnimatorUpdateListener l) {
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(f1, f2);
        valueAnimatorOfFloat.setDuration(400L);
        valueAnimatorOfFloat.setInterpolator(INTERPOLATOR);
        valueAnimatorOfFloat.addUpdateListener(l);
        ...
        if (actionMasked != 1) {
            if (actionMasked == 2) {
                ...
                if (this.pickerDelegate.captured()) {
                    boolean zMove = this.pickerDelegate.move(x, y, event.getActionIndex());
    ...
    public void moveLegend(float offset) {
        ...
        float f = (this.chartData.xPercentage[this.selectedIndex] * this.chartFullWidth) - offset;
        if (f > (this.chartStart + this.chartWidth) / 2.0f) {
            measuredWidth = f - (this.legendSignatureView.getWidth() + DP_5);
        } else {
            measuredWidth = f + DP_5;
        }
    ...
    public int findMaxValue(int startXIndex, int endXIndex) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            if (this.lines.get(i2).enabled && (iRMaxQ = this.lines.get(i2).line.segmentTree.rMaxQ(startXIndex, endXIndex)) > i) {
                i = iRMaxQ;
            }
        }
        return i;
    ...
    public int findMinValue(int startXIndex, int endXIndex) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            if (this.lines.get(i2).enabled && (iRMinQ = this.lines.get(i2).line.segmentTree.rMinQ(startXIndex, endXIndex)) < i) {
                i = iRMinQ;
            }
        }
        return i;
    ...
    @Override // ir.eitaa.ui.Charts.ChartPickerDelegate.Listener
    ...
    public void onPickerJumpTo(float start, float end, boolean force) {
        ...
        if (force) {
            int iFindStartIndex = t.findStartIndex(Math.max(start, 0.0f));
            int iFindEndIndex = this.chartData.findEndIndex(iFindStartIndex, Math.min(end, 1.0f));
    ...
    private void updateDates(int step) {
        ...
        if (chartBottomSignatureData == null || step >= chartBottomSignatureData.stepMax || step <= chartBottomSignatureData.stepMin) {
            int iHighestOneBit = Integer.highestOneBit(step) << 1;
            ...
            if (chartBottomSignatureData2 == null || chartBottomSignatureData2.step != iHighestOneBit) {
                ...
                for (int i = 0; i < this.tmpN; i++) {
                    ChartBottomSignatureData chartBottomSignatureData4 = this.bottomSignatureDate.get(i);
                ...
                ValueAnimator duration = createAnimator(0.0f, 1.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.-$$Lambda$BaseChartView$D_i6-j0TKksgjrdAVpuA3RWRAw0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        this.f$0.lambda$updateDates$3$BaseChartView(chartBottomSignatureData3, valueAnimator2);
                    }
                }).setDuration(200L);
                this.alphaBottomAnimator = duration;
                duration.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Charts.BaseChartView.6
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animation) {
                        super.onAnimationEnd(animation);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$updateDates$3, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$updateDates$3$BaseChartView(ChartBottomSignatureData chartBottomSignatureData, ValueAnimator valueAnimator) {
        ...
        while (it.hasNext()) {
            ...
            if (next == chartBottomSignatureData) {
                ...
                next.alpha = (int) ((1.0f - fFloatValue) * next.fixedAlpha);
            }
        }
        invalidate();
    }
        ...
        while (true) {
            ...
            if (l.enabled && l.alpha != 1.0f) {
                ...
                if (valueAnimator4 == null || !valueAnimator4.isRunning()) {
                    ValueAnimator valueAnimatorCreateAnimator = createAnimator(l.alpha, 1.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.-$$Lambda$BaseChartView$38VzKbzkLptGrgilahzbTTudCxg
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator5) {
                            this.f$0.lambda$onCheckChanged$4$BaseChartView(l, valueAnimator5);
                        }
                    });
                ...
                ValueAnimator valueAnimatorCreateAnimator2 = createAnimator(l.alpha, 0.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Charts.-$$Lambda$BaseChartView$W4-0kbROfAH6XxRsDNAYQSQdqSM
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator5) {
                        this.f$0.lambda$onCheckChanged$5$BaseChartView(l, valueAnimator5);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$onCheckChanged$4, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$onCheckChanged$5, reason: merged with bridge method [inline-methods] */
