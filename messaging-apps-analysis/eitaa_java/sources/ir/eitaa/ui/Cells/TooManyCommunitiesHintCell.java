...
public class TooManyCommunitiesHintCell extends FrameLayout {
    ...
    public TooManyCommunitiesHintCell(Context context) {
        ...
        this.headerTextView.setTypeface(AndroidUtilities.getFontFamily(true));
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: ir.eitaa.ui.Cells.TooManyCommunitiesHintCell.1
