...
public class ChatListCell extends LinearLayout {
    ...
    private class ListView extends FrameLayout {
        ...
        public ListView(Context context, boolean threeLines) {
            ...
            RadioButton radioButton = new RadioButton(context) { // from class: ir.eitaa.ui.Cells.ChatListCell.ListView.1
            ...
            boolean z2 = this.isThreeLines;
            if ((!z2 || !SharedConfig.useThreeLinesLayout) && (z2 || SharedConfig.useThreeLinesLayout)) {
                z = false;
            }
    ...
    public ChatListCell(Context context) {
        ...
        while (true) {
            ...
            this.listView[i].setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.Cells.-$$Lambda$ChatListCell$0qyudyIfyY6ZN15Ke1s8CUPtbAI
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$new$0$ChatListCell(z, view);
                }
            });
            i++;
        }
