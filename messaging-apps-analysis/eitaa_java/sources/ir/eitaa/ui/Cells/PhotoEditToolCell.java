...
public class PhotoEditToolCell extends FrameLayout {
    ...
    public PhotoEditToolCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.hideValueRunnable = new Runnable() { // from class: ir.eitaa.ui.Cells.PhotoEditToolCell.1
            ...
            public void run() {
                ...
                PhotoEditToolCell.this.valueAnimation.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Cells.PhotoEditToolCell.1.1
    ...
    public void setSeekBarDelegate(final PhotoEditorSeekBar.PhotoEditorSeekBarDelegate photoEditorSeekBarDelegate) {
        this.seekBar.setDelegate(new PhotoEditorSeekBar.PhotoEditorSeekBarDelegate() { // from class: ir.eitaa.ui.Cells.-$$Lambda$PhotoEditToolCell$6ILQ1ZSxOPYPY4G-c_Zx34RlXsg
            @Override // ir.eitaa.ui.Components.PhotoEditorSeekBar.PhotoEditorSeekBarDelegate
            public final void onProgressChanged(int i, int i2) {
                this.f$0.lambda$setSeekBarDelegate$0$PhotoEditToolCell(photoEditorSeekBarDelegate, i, i2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$setSeekBarDelegate$0, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$setSeekBarDelegate$0$PhotoEditToolCell(PhotoEditorSeekBar.PhotoEditorSeekBarDelegate photoEditorSeekBarDelegate, int i, int i2) {
        ...
        if (this.valueTextView.getTag() == null) {
            ...
            this.valueAnimation.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Cells.PhotoEditToolCell.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
