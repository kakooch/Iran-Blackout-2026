...
public class SharedLinkCell extends FrameLayout {
    ...
    public SharedLinkCell(Context context, int viewType) {
        ...
        textPaint2.setTypeface(AndroidUtilities.getFontFamily(false));
    ...
    */
    protected void onMeasure(int r29, int r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Cells.SharedLinkCell.onMeasure(int, int):void");
    }
