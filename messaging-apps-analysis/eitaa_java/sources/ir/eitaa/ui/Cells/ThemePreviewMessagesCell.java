...
public class ThemePreviewMessagesCell extends LinearLayout {
    ...
    public ThemePreviewMessagesCell(Context context, ActionBarLayout layout, int type) throws Resources.NotFoundException, NumberFormatException {
        super(context);
        this.invalidateRunnable = new Runnable() { // from class: ir.eitaa.ui.Cells.-$$Lambda$SZOJNuYakYXZLiENktmDJ0vEOJA
        ...
        if (type == 0) {
            tLRPC$TL_message.message = LocaleController.getString("FontSizePreviewReply", R.string.FontSizePreviewReply);
        } else {
            tLRPC$TL_message.message = LocaleController.getString("NewThemePreviewReply", R.string.NewThemePreviewReply);
        }
        ...
        if (type == 0) {
            tLRPC$TL_message2.message = LocaleController.getString("FontSizePreviewLine2", R.string.FontSizePreviewLine2);
        } else {
        ...
        if (type == 0) {
            tLRPC$TL_message3.message = LocaleController.getString("FontSizePreviewLine1", R.string.FontSizePreviewLine1);
        } else {
            tLRPC$TL_message3.message = LocaleController.getString("NewThemePreviewLine1", R.string.NewThemePreviewLine1);
        }
        ...
        while (true) {
            ...
            this.cells[i2].setDelegate(new ChatMessageCell.ChatMessageCellDelegate() { // from class: ir.eitaa.ui.Cells.ThemePreviewMessagesCell.1
                ...
                @Override // ir.eitaa.ui.Cells.ChatMessageCell.ChatMessageCellDelegate
                public /* synthetic */ void didPressedShareToMine(ChatMessageCell chatMessageCell) {
                    ChatMessageCell.ChatMessageCellDelegate.CC.$default$didPressedShareToMine(this, chatMessageCell);
                }
                ...
                @Override // ir.eitaa.ui.Cells.ChatMessageCell.ChatMessageCellDelegate
                public /* synthetic */ boolean needPlayMessage(MessageObject messageObject4) {
                    return ChatMessageCell.ChatMessageCellDelegate.CC.$default$needPlayMessage(this, messageObject4);
                }
