...
public class CropAreaView extends View {
    ...
    public void setGridType(GridType type, boolean animated) {
        ...
        this.gridAnimator.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.Crop.CropAreaView.1
    ...
    public void fill(final RectF targetRect, Animator scaleAnimator, boolean animated) {
        if (animated) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.Crop.CropAreaView.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
    ...
    */
    public void calculateRect(android.graphics.RectF r13, float r14) {
        /*
            ...
            if (r0 != 0) goto Ld
            int r0 = ir.eitaa.messenger.AndroidUtilities.statusBarHeight
            goto Le
        Ld:
            r0 = 0
        Le:
        ...
        L81:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.Crop.CropAreaView.calculateRect(android.graphics.RectF, float):void");
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (AnonymousClass3.$SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[this.activeControl.ordinal()]) {
            case 1:
    ...
    /* renamed from: ir.eitaa.ui.Components.Crop.CropAreaView$3, reason: invalid class name */
    static /* synthetic */ class AnonymousClass3 {
        static final /* synthetic */ int[] $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control;

        static {
            int[] iArr = new int[Control.values().length];
            $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control = iArr;
            try {
                iArr[Control.TOP_LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[Control.TOP_RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[Control.BOTTOM_LEFT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[Control.BOTTOM_RIGHT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[Control.TOP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[Control.LEFT.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[Control.RIGHT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$ir$eitaa$ui$Components$Crop$CropAreaView$Control[Control.BOTTOM.ordinal()] = 8;
    ...
    private void constrainRectByWidth(RectF rect, float aspectRatio) {
        ...
        rect.bottom = rect.top + (fWidth / aspectRatio);
    }

    private void constrainRectByHeight(RectF rect, float aspectRatio) {
        float fHeight = rect.height();
        rect.right = rect.left + (aspectRatio * fHeight);
