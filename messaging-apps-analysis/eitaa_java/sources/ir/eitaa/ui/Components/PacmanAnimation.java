...
public class PacmanAnimation {
    ...
    public void draw(Canvas canvas, int cy) {
        ...
        canvas.drawRect(0.0f, cy - i2, f, cy + i2 + 1, this.paint);
        this.paint.setColor(-69120);
        float f2 = measuredWidth + iDp;
        this.rect.set(measuredWidth, cy - i, f2, r12 + iDp);
        float f3 = this.progress;
        int i3 = (int) (f3 < 0.5f ? (1.0f - (f3 / 0.5f)) * 35.0f : ((f3 - 0.5f) * 35.0f) / 0.5f);
        float f4 = i3;
        float f5 = 360 - (i3 * 2);
        ...
        canvas.save();
        canvas.translate(f2 + AndroidUtilities.dp(20.0f), cy - AndroidUtilities.dp(25.0f));
