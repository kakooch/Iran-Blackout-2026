...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public class UserCell extends LinearLayout {
        public UserCell(Context context) {
            ...
            textView.setTextColor(PhonebookShareAlert.this.getThemedColor("dialogTextBlack"));
            ...
            if (userStatus != null) {
                ...
                textView2.setTextColor(PhonebookShareAlert.this.getThemedColor("dialogTextGray3"));
    ...
    public class TextCheckBoxCell extends FrameLayout {
        ...
        public TextCheckBoxCell(Context context) {
            ...
            textView.setTextColor(PhonebookShareAlert.this.getThemedColor("windowBackgroundWhiteBlackText"));
            ...
            textView3.setTextColor(PhonebookShareAlert.this.getThemedColor("windowBackgroundWhiteGrayText2"));
            ...
            this.imageView.setColorFilter(new PorterDuffColorFilter(PhonebookShareAlert.this.getThemedColor("windowBackgroundWhiteGrayIcon"), PorterDuff.Mode.MULTIPLY));
    ...
    */
    public PhonebookShareAlert(ir.eitaa.ui.ActionBar.BaseFragment r20, ir.eitaa.messenger.ContactsController.Contact r21, ir.eitaa.tgnet.TLRPC$User r22, android.net.Uri r23, java.io.File r24, java.lang.String r25, java.lang.String r26, final ir.eitaa.ui.ActionBar.Theme.ResourcesProvider r27) {
        /*
            Method dump skipped, instructions count: 844
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.PhonebookShareAlert.<init>(ir.eitaa.ui.ActionBar.BaseFragment, ir.eitaa.messenger.ContactsController$Contact, ir.eitaa.tgnet.TLRPC$User, android.net.Uri, java.io.File, java.lang.String, java.lang.String, ir.eitaa.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public /* synthetic */ void lambda$new$2$PhonebookShareAlert(int i, View view, View view2) {
        ...
        if (this.isImport) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Copy", R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PhonebookShareAlert$RTV-Xu71Wnsi_eE9MkR-7L1Gjnk
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i5) {
                    this.f$0.lambda$new$1$PhonebookShareAlert(vcardItem, dialogInterface, i5);
                }
            });
            builder.show();
            return;
    ...
    public /* synthetic */ boolean lambda$new$3$PhonebookShareAlert(int i, Theme.ResourcesProvider resourcesProvider, Context context, View view) {
    ...
    public /* synthetic */ void lambda$new$5$PhonebookShareAlert(Theme.ResourcesProvider resourcesProvider, View view) {
        StringBuilder sb;
        if (this.isImport) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
            builder.setTitle(LocaleController.getString("AddContactTitle", R.string.AddContactTitle));
            builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
            builder.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() { // from class: ir.eitaa.ui.Components.PhonebookShareAlert.5
                private void fillRowWithType(String type, ContentValues row) {
                    ...
                    if ("MOBILE".equalsIgnoreCase(type) || "CELL".equalsIgnoreCase(type)) {
                    ...
                    if ("RADIO".equalsIgnoreCase(type) || "VOICE".equalsIgnoreCase(type)) {
                ...
                private void fillUrlRowWithType(String type, ContentValues row) {
                    ...
                    if ("HOMEPAGE".equalsIgnoreCase(type)) {
                        row.put("data2", (Integer) 1);
                        return;
                    }
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    boolean z2 = false;
                    for (int i3 = 0; i3 < PhonebookShareAlert.this.phones.size(); i3++) {
                        AndroidUtilities.VcardItem vcardItem = (AndroidUtilities.VcardItem) PhonebookShareAlert.this.phones.get(i3);
                    ...
                    while (i4 < PhonebookShareAlert.this.other.size()) {
                        AndroidUtilities.VcardItem vcardItem2 = (AndroidUtilities.VcardItem) PhonebookShareAlert.this.other.get(i4);
                        int i5 = vcardItem2.type;
                        if (i5 == i2) {
                            ...
                            if (i5 == 2) {
                                ...
                                if (i5 == 20) {
                                    ...
                                    for (int i6 = i; i6 < PhonebookShareAlert.this.other.size(); i6++) {
                                        AndroidUtilities.VcardItem vcardItem3 = (AndroidUtilities.VcardItem) PhonebookShareAlert.this.other.get(i6);
        ...
        if ((baseFragment instanceof ChatActivity) && ((ChatActivity) baseFragment).isInScheduleMode()) {
            AlertsCreator.createScheduleDatePickerDialog(getContext(), ((ChatActivity) this.parentFragment).getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() { // from class: ir.eitaa.ui.Components.-$$Lambda$PhonebookShareAlert$A1n7Puk-3LwD-QqENd6iBjPoHPk
                @Override // ir.eitaa.ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                public final void didSelectDate(boolean z, int i2) {
                    this.f$0.lambda$new$4$PhonebookShareAlert(z, i2);
                }
            }, resourcesProvider);
        } else {
    ...
    protected void onStart() {
        super.onStart();
        Bulletin.addDelegate((FrameLayout) this.containerView, new Bulletin.Delegate() { // from class: ir.eitaa.ui.Components.PhonebookShareAlert.6
    ...
    public void updateLayout(boolean animated) {
        ...
        if ((z && this.actionBar.getTag() == null) || (!z && this.actionBar.getTag() != null)) {
            ...
            if (animated) {
                ...
                this.actionBarAnimation.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.PhonebookShareAlert.7
        ...
        boolean z2 = childAt.getBottom() - this.scrollView.getScrollY() > this.scrollView.getMeasuredHeight();
        if (!(z2 && this.shadow.getTag() == null) && (z2 || this.shadow.getTag() == null)) {
            return;
        }
        this.shadow.setTag(z2 ? 1 : null);
        ...
        if (animated) {
            ...
            this.shadowAnimation.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.PhonebookShareAlert.8
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
    ...
    private class ListAdapter {
        ...
        public void onBindViewHolder(View itemView, int position, int type) {
            AndroidUtilities.VcardItem vcardItem;
            if (type == 1) {
                TextCheckBoxCell textCheckBoxCell = (TextCheckBoxCell) itemView;
                int i = PhonebookShareAlert.this.phoneStartRow;
                int i2 = R.drawable.menu_info;
                if (position < i || position >= PhonebookShareAlert.this.phoneEndRow) {
                    vcardItem = (AndroidUtilities.VcardItem) PhonebookShareAlert.this.other.get(position - PhonebookShareAlert.this.vcardStartRow);
                    int i3 = vcardItem.type;
                    if (i3 == 1) {
                        i2 = R.drawable.menu_mail;
                    } else if (i3 == 2) {
                        i2 = R.drawable.menu_location;
                    } else if (i3 == 3) {
                        i2 = R.drawable.msg_link;
                    } else if (i3 == 4) {
                        i2 = R.drawable.profile_info;
                    } else if (i3 == 5) {
                        i2 = R.drawable.menu_date;
                    } else if (i3 == 6) {
                        i2 = "ORG".equalsIgnoreCase(vcardItem.getRawType(true)) ? R.drawable.menu_work : R.drawable.menu_jobtitle;
                    }
                } else {
                    vcardItem = (AndroidUtilities.VcardItem) PhonebookShareAlert.this.phones.get(position - PhonebookShareAlert.this.phoneStartRow);
                    i2 = R.drawable.menu_calls;
                }
                textCheckBoxCell.setVCardItem(vcardItem, i2, position != getItemCount() - 1);
            }
        }
        ...
        public View createView(Context context, int position) {
            ...
            onBindViewHolder(userCell, position, itemViewType);
            return userCell;
        }

        public int getItemViewType(int position) {
            return position == PhonebookShareAlert.this.userRow ? 0 : 1;
        }
    }
}
