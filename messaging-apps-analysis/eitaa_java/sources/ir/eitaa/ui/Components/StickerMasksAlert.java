...
public class StickerMasksAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    class SearchField extends FrameLayout {
        ...
        public SearchField(Context context, int type) {
            ...
            this.clearSearchImageView.setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$StickerMasksAlert$SearchField$kZzUC9g4frQMoJok-iUSsI1-efw
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
                    this.f$0.lambda$new$0$StickerMasksAlert$SearchField(view4);
                }
            });
            EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.SearchField.1
            ...
            this.searchEditText.addTextChangedListener(new TextWatcher() { // from class: ir.eitaa.ui.Components.StickerMasksAlert.SearchField.2
        ...
        public void showShadow(boolean show, boolean animated) {
            ...
            if (show || this.shadowView.getTag() == null) {
                ...
                if (animated) {
                    ...
                    this.shadowAnimator.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.StickerMasksAlert.SearchField.3
    ...
    public StickerMasksAlert(Context context, boolean isVideo, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.recentTabBum = -2;
        this.favTabBum = -2;
        this.contentPreviewViewerDelegate = new ContentPreviewViewer.ContentPreviewViewerDelegate() { // from class: ir.eitaa.ui.Components.StickerMasksAlert.1
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.2
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.3
            ...
            public boolean onInterceptTouchEvent(MotionEvent event) {
                return super.onInterceptTouchEvent(event) || ContentPreviewViewer.getInstance().onInterceptTouchEvent(event, StickerMasksAlert.this.gridView, ((BottomSheet) StickerMasksAlert.this).containerView.getMeasuredHeight(), StickerMasksAlert.this.contentPreviewViewerDelegate, this.resourcesProvider);
            }
        };
        this.gridView = recyclerListView;
        GridLayoutManager gridLayoutManager = new GridLayoutManager(context, 5) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.4
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.4.1
                    @Override // androidx.recyclerview.widget.LinearSmoothScroller
                    public int calculateDyToMakeVisible(View view, int snapPreference) {
                        return super.calculateDyToMakeVisible(view, snapPreference) - (StickerMasksAlert.this.gridView.getPaddingTop() - AndroidUtilities.dp(7.0f));
                    }
        ...
        this.stickersLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: ir.eitaa.ui.Components.StickerMasksAlert.5
            @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
            public int getSpanSize(int position) {
                if (StickerMasksAlert.this.gridView.getAdapter() != StickerMasksAlert.this.stickersGridAdapter) {
                    if (position == StickerMasksAlert.this.stickersSearchGridAdapter.totalItems || !(StickerMasksAlert.this.stickersSearchGridAdapter.cache.get(position) == null || (StickerMasksAlert.this.stickersSearchGridAdapter.cache.get(position) instanceof TLRPC$Document))) {
                ...
                if (position == StickerMasksAlert.this.stickersGridAdapter.totalItems || !(StickerMasksAlert.this.stickersGridAdapter.cache.get(position) == null || (StickerMasksAlert.this.stickersGridAdapter.cache.get(position) instanceof TLRPC$Document))) {
                    return StickerMasksAlert.this.stickersGridAdapter.stickersPerRow;
                }
                return 1;
            }
        ...
        this.gridView.setOnTouchListener(new View.OnTouchListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$StickerMasksAlert$gxPaxCMVC-iDVkTOIZE-yxjIjMs
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.lambda$new$0$StickerMasksAlert(resourcesProvider, view, motionEvent);
            }
        });
        RecyclerListView.OnItemClickListener onItemClickListener = new RecyclerListView.OnItemClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$StickerMasksAlert$n3WxM-8gBtpvL7Pm6RvmqvyQk6g
            @Override // ir.eitaa.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i2) {
                this.f$0.lambda$new$1$StickerMasksAlert(view, i2);
            }
        };
        ...
        this.stickersTab = new ScrollSlidingTabStrip(context, resourcesProvider) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.6
        ...
        this.stickersTab.setDelegate(new ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate() { // from class: ir.eitaa.ui.Components.-$$Lambda$StickerMasksAlert$rJ7JK5SrBzcjhc1OhNrchr9kjCA
            @Override // ir.eitaa.ui.Components.ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate
            public final void onPageSelected(int i2) {
                this.f$0.lambda$new$2$StickerMasksAlert(i2);
            }
        });
        this.gridView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: ir.eitaa.ui.Components.StickerMasksAlert.7
        ...
        if (!isVideo) {
            this.bottomTabContainer = new FrameLayout(context) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.8
                @Override // android.view.ViewGroup
                public boolean onInterceptTouchEvent(MotionEvent ev) {
                    if (getParent() != null) {
                        getParent().requestDisallowInterceptTouchEvent(true);
            ...
            ImageView imageView = new ImageView(context) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.9
                ...
                public void setSelected(boolean selected) {
                    ...
                    int i2 = selected ? -9520403 : 520093695;
            ...
            this.stickersButton.setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$StickerMasksAlert$XUsnQA9K5RFp5pL4mRvgRjRNHQM
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
                    this.f$0.lambda$new$3$StickerMasksAlert(view4);
                }
            });
            ImageView imageView2 = new ImageView(context) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.10
                @Override // android.widget.ImageView, android.view.View
                public void setSelected(boolean selected) {
                    super.setSelected(selected);
                    Drawable background = getBackground();
                    ...
                    int i3 = selected ? -9520403 : 520093695;
            ...
            this.masksButton.setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$StickerMasksAlert$co46NloifGag16xveq0xdTGqBlw
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
                    this.f$0.lambda$new$4$StickerMasksAlert(view4);
                }
            });
        }
        checkDocuments(true);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$new$0, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ boolean lambda$new$0$StickerMasksAlert(Theme.ResourcesProvider resourcesProvider, View view, MotionEvent motionEvent) {
    ...
    public void updateLayout(boolean animated) {
        ...
        if (holder3 == null) {
            ...
            this.stickersSearchField.showShadow(holder3.itemView.getTop() < this.gridView.getPaddingTop(), animated);
        }
    ...
    private void checkDocuments(boolean force) {
        ...
        if (force || size != this.recentStickers[this.currentType].size() || size2 != this.favouriteStickers.size()) {
            updateStickerTabs();
        }
        StickersGridAdapter stickersGridAdapter = this.stickersGridAdapter;
        if (stickersGridAdapter != null) {
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        ...
        if (id != NotificationCenter.emojiLoaded || (recyclerListView = this.gridView) == null) {
            return;
        }
    ...
    private class StickersGridAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            boolean z = false;
            if (i == 0) {
                stickerEmojiCell = new StickerEmojiCell(this.context, z) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.StickersGridAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (itemViewType == 0) {
                TLRPC$Document tLRPC$Document = (TLRPC$Document) this.cache.get(position);
                StickerEmojiCell stickerEmojiCell = (StickerEmojiCell) holder.itemView;
                stickerEmojiCell.setSticker(tLRPC$Document, this.cacheParents.get(position), false);
            ...
            if (position == this.totalItems) {
                int i = this.positionToRow.get(position - 1, Integer.MIN_VALUE);
                if (i == Integer.MIN_VALUE) {
        ...
        */
        public void notifyDataSetChanged() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.StickerMasksAlert.StickersGridAdapter.notifyDataSetChanged():void");
        }
    }
    ...
    class StickersSearchGridAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* renamed from: ir.eitaa.ui.Components.StickerMasksAlert$StickersSearchGridAdapter$1, reason: invalid class name */
            ...
            */
            public void run() {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.StickerMasksAlert.StickersSearchGridAdapter.AnonymousClass1.run():void");
            }

            /* JADX INFO: Access modifiers changed from: private */
            /* renamed from: lambda$run$0, reason: merged with bridge method [inline-methods] */
            public /* synthetic */ void lambda$run$0$StickerMasksAlert$StickersSearchGridAdapter$1(int i, HashMap map, ArrayList arrayList, String str) {
            ...
            public /* synthetic */ void lambda$run$2$StickerMasksAlert$StickersSearchGridAdapter$1(final TLRPC$TL_messages_getStickers tLRPC$TL_messages_getStickers, final ArrayList arrayList, final LongSparseArray longSparseArray, final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$StickerMasksAlert$StickersSearchGridAdapter$1$rvrwqBc8G6MUwKa6xzRd31-2YmM
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$run$1$StickerMasksAlert$StickersSearchGridAdapter$1(tLRPC$TL_messages_getStickers, tLObject, arrayList, longSparseArray);
                    }
                });
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            boolean z = false;
            if (i == 0) {
                stickerSetNameCell = new StickerEmojiCell(this.context, z) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.StickersSearchGridAdapter.2
                    @Override // android.widget.FrameLayout, android.view.View
                    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                        super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(82.0f), 1073741824));
                    }
                ...
                if (i == 1) {
                    ...
                    stickerSetNameCell = new StickerSetNameCell(this.context, false, ((BottomSheet) StickerMasksAlert.this).resourcesProvider);
                } else if (i == 4) {
                    ...
                    FrameLayout frameLayout = new FrameLayout(this.context) { // from class: ir.eitaa.ui.Components.StickerMasksAlert.StickersSearchGridAdapter.3
                        @Override // android.widget.FrameLayout, android.view.View
                        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                            super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(((StickerMasksAlert.this.gridView.getMeasuredHeight() - StickerMasksAlert.this.searchFieldHeight) - AndroidUtilities.dp(48.0f)) - AndroidUtilities.dp(48.0f), 1073741824));
                        }
                    };
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (itemViewType == 0) {
                TLRPC$Document tLRPC$Document = (TLRPC$Document) this.cache.get(position);
                StickerEmojiCell stickerEmojiCell = (StickerEmojiCell) holder.itemView;
                stickerEmojiCell.setSticker(tLRPC$Document, null, this.cacheParent.get(position), this.positionToEmoji.get(position), false);
