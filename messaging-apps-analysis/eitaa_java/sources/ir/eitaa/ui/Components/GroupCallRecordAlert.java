...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC$Chat chat, boolean hasVideo) throws NoSuchFieldException, Resources.NotFoundException {
        super(context, false);
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: ir.eitaa.ui.Components.GroupCallRecordAlert.1
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                int size = (View.MeasureSpec.getSize(widthMeasureSpec) - AndroidUtilities.dp(200.0f)) / 2;
                GroupCallRecordAlert.this.viewPager.setPadding(size, 0, size, 0);
                super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(370.0f), 1073741824));
        ...
        this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: ir.eitaa.ui.Components.GroupCallRecordAlert.2
        ...
        this.containerView.addView(view, LayoutHelper.createFrame(R.styleable.AppCompatTheme_windowNoTitle, -1.0f, 51, 0.0f, 100.0f, 0.0f, 130.0f));
        View view2 = new View(getContext());
        view2.setBackground(new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{0, color}));
        this.containerView.addView(view2, LayoutHelper.createFrame(R.styleable.AppCompatTheme_windowNoTitle, -1.0f, 53, 0.0f, 100.0f, 0.0f, 130.0f));
        TextView textView3 = new TextView(getContext()) { // from class: ir.eitaa.ui.Components.GroupCallRecordAlert.3
            ...
            */
            protected void onSizeChanged(int r26, int r27, int r28, int r29) {
                ...
                L77:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.GroupCallRecordAlert.AnonymousClass3.onSizeChanged(int, int, int, int):void");
            }
        ...
        this.positiveButton.setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$GroupCallRecordAlert$UJa7QFKBl2D5ZzXhAGmAZf_xs0o
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                this.f$0.lambda$new$0$GroupCallRecordAlert(view3);
            }
        });
        ...
        while (true) {
            ...
            this.titles[i2].setTypeface(AndroidUtilities.getFontFamily(true));
            ...
            this.titles[i2].setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$GroupCallRecordAlert$Q4bl01Ba1tFyTG2iYPe8P_QfL10
                @Override // android.view.View.OnClickListener
                public final void onClick(View view3) throws Resources.NotFoundException {
                    this.f$0.lambda$new$1$GroupCallRecordAlert(i2, view3);
                }
            });
            i2++;
        }
    ...
    public /* synthetic */ void lambda$new$0$GroupCallRecordAlert(View view) {
    ...
    public /* synthetic */ void lambda$new$1$GroupCallRecordAlert(int i, View view) throws Resources.NotFoundException {
    ...
    private class Adapter extends PagerAdapter {
        ...
        @Override // androidx.viewpager.widget.PagerAdapter
        public Object instantiateItem(ViewGroup container, int position) throws SAXException, IOException {
            ...
            SvgHelper.SvgDrawable drawable = SvgHelper.getDrawable(RLottieDrawable.readRes(null, position == 0 ? R.raw.record_audio : position == 1 ? R.raw.record_video_p : R.raw.record_video_l));
