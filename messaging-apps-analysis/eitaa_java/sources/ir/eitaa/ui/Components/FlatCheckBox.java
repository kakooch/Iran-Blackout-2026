...
public class FlatCheckBox extends View {
    ...
    public void setChecked(boolean enabled, boolean animate) {
        ...
        if (!this.attached || !animate) {
            this.progress = enabled ? 1.0f : 0.0f;
            return;
        }
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$FlatCheckBox$PWyWsjdYFSdbqC3hl2bLo7R-E5o
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.lambda$setChecked$0$FlatCheckBox(valueAnimator2);
            }
        });
