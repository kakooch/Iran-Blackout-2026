...
public class PullForegroundDrawable {
    ...
    public PullForegroundDrawable(String pullText, String releaseText) {
        ...
        this.textSwappingUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$74OpGQiDwtRLFZ63jX9sN9Pl33M
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$new$0$PullForegroundDrawable(valueAnimator);
            }
        };
        this.textInUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$jDPJs9c5PHufEicYd8CNGITRCo4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$new$1$PullForegroundDrawable(valueAnimator);
            }
        };
        this.textInRunnable = new Runnable() { // from class: ir.eitaa.ui.Components.PullForegroundDrawable.1
    ...
    private void updateTextProgress(float pullProgress) {
        ...
        if (z != this.arrowAnimateTo) {
            ...
            valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$SHej12JYA_2-UDUtmJPy5Qt3T8Q
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator4) {
                    this.f$0.lambda$updateTextProgress$2$PullForegroundDrawable(valueAnimator4);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$updateTextProgress$2, reason: merged with bridge method [inline-methods] */
    ...
    public void colorize(boolean colorize) {
        if (this.animateToColorize != colorize) {
            ...
            if (colorize) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$Fb4FToeqntIrZOxWEiOwRWzBWcc
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        this.f$0.lambda$colorize$3$PullForegroundDrawable(valueAnimator2);
                    }
                });
            ...
            valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$s4kEsQiBjJTz4R-0_0K6QMNEHcg
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                    this.f$0.lambda$colorize$4$PullForegroundDrawable(valueAnimator3);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$colorize$3, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$colorize$4, reason: merged with bridge method [inline-methods] */
    ...
    public void startOutAnimation() {
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$ycs1dke2xVhbzk2dQgG8suAsHcA
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$startOutAnimation$5$PullForegroundDrawable(valueAnimator);
            }
        });
        valueAnimatorOfFloat.setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT);
        valueAnimatorOfFloat.setDuration(250L);
        ValueAnimator valueAnimatorOfFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$0j83odC0S-hg0Sx4iNisZqjfoSA
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$startOutAnimation$6$PullForegroundDrawable(valueAnimator);
            }
        });
        ...
        valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PullForegroundDrawable$eoi_HDWxz5m-ux1u5K-58DO_0lk
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.PullForegroundDrawable.2
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$startOutAnimation$5, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$startOutAnimation$6, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$startOutAnimation$7, reason: merged with bridge method [inline-methods] */
