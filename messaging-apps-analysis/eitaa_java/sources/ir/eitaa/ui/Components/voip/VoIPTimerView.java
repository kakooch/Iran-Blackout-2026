...
public class VoIPTimerView extends View {
    ...
    public VoIPTimerView(Context context) {
        ...
        this.updater = new Runnable() { // from class: ir.eitaa.ui.Components.voip.-$$Lambda$VoIPTimerView$b7BAPfaF-xZBt8qkHIUjPNCh9Q8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$0$VoIPTimerView();
            }
        };
        ...
        this.inactivePaint.setColor(ColorUtils.setAlphaComponent(-1, R.styleable.AppCompatTheme_textAppearanceSearchResultTitle));
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (staticLayout != null) {
            setMeasuredDimension(View.MeasureSpec.getSize(widthMeasureSpec), staticLayout.getHeight());
        } else {
