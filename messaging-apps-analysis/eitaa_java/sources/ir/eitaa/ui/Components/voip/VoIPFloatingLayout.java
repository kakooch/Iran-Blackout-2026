...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        this.active = true;
        this.progressUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.voip.VoIPFloatingLayout.1
        ...
        this.mutedUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: ir.eitaa.ui.Components.voip.-$$Lambda$VoIPFloatingLayout$2OwhNfKfoU4vTZwPMqysHbVH4Ws
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$new$0$VoIPFloatingLayout(valueAnimator);
            }
        };
        this.touchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        if (Build.VERSION.SDK_INT >= 21) {
            setOutlineProvider(new ViewOutlineProvider() { // from class: ir.eitaa.ui.Components.voip.VoIPFloatingLayout.2
        ...
        this.mutedPaint.setColor(ColorUtils.setAlphaComponent(-16777216, R.styleable.AppCompatTheme_textAppearanceSearchResultTitle));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void setRelativePositionInternal(float xRelative, float yRelative, int width, int height, boolean animated) {
        ...
        float systemWindowInsetBottom = 0.0f;
        ...
        float measuredWidth = this.leftPadding + ((((view.getMeasuredWidth() - this.leftPadding) - this.rightPadding) - width) * xRelative);
        float measuredHeight = systemWindowInsetTop + ((((view.getMeasuredHeight() - systemWindowInsetBottom) - systemWindowInsetTop) - height) * yRelative);
        if (animated) {
            animate().setListener(null).cancel();
    ...
    public void setFloatingMode(boolean show, boolean animated) {
        ...
        if (!animated) {
            if (this.floatingMode != show) {
                ...
                this.toFloatingModeProgress = show ? 1.0f : 0.0f;
                requestLayout();
                if (Build.VERSION.SDK_INT >= 21) {
                    invalidateOutline();
                    return;
        ...
        if (show && !this.floatingMode) {
            ...
            duration.setInterpolator(cubicBezierInterpolator).setListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.voip.VoIPFloatingLayout.3
        ...
        if (!show && this.floatingMode) {
            ...
            requestLayout();
            animate().setListener(null).cancel();
            getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: ir.eitaa.ui.Components.voip.VoIPFloatingLayout.4
                ...
                public boolean onPreDraw() {
                    ...
                    if (voIPFloatingLayout.measuredAsFloatingMode) {
                        ...
                        VoIPFloatingLayout.this.animate().setListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.voip.VoIPFloatingLayout.4.1
                            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                            public void onAnimationEnd(Animator animation) {
                                VoIPFloatingLayout.this.switchingToFloatingMode = false;
                                VoIPFloatingLayout.this.requestLayout();
    ...
    public void setMuted(boolean muted, boolean animated) {
        if (!animated) {
            ...
            this.mutedProgress = muted ? 1.0f : 0.0f;
            invalidate();
            return;
        }
    ...
    public void setRelativePosition(VoIPFloatingLayout fromLayout) {
        ...
        float systemWindowInsetTop = (i < 20 || (windowInsets2 = this.lastInsets) == null) ? 0.0f : windowInsets2.getSystemWindowInsetTop() + this.topPadding;
        View view = (View) parent;
        setRelativePosition(Math.min(1.0f, Math.max(0.0f, (fromLayout.getTranslationX() - this.leftPadding) / (((view.getMeasuredWidth() - this.leftPadding) - this.rightPadding) - fromLayout.getMeasuredWidth()))), Math.min(1.0f, Math.max(0.0f, (fromLayout.getTranslationY() - systemWindowInsetTop) / (((view.getMeasuredHeight() - ((i < 20 || (windowInsets = this.lastInsets) == null) ? 0.0f : windowInsets.getSystemWindowInsetBottom() + this.bottomPadding)) - systemWindowInsetTop) - fromLayout.getMeasuredHeight()))));
    }
