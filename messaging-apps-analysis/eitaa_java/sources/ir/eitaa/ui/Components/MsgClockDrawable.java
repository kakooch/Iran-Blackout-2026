...
public class MsgClockDrawable extends Drawable {
    ...
    public void setColor(int color) {
        if (color != this.color) {
            ...
            this.paint.setColor(ColorUtils.setAlphaComponent(color, (int) (this.alpha * (iAlpha / 255.0f))));
        }
        this.color = color;
    }
    ...
    public Drawable.ConstantState getConstantState() {
        if (this.constantState == null) {
            this.constantState = new Drawable.ConstantState() { // from class: ir.eitaa.ui.Components.MsgClockDrawable.1
