...
public class FireworksOverlay extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.started = false;
        if (Build.VERSION.SDK_INT >= 18) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FireworksOverlay$sDe7La9i0rj1qRwWARICGGMZr5Y
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onDraw$0$FireworksOverlay();
                }
            });
        }
    }
