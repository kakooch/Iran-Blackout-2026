...
public class CheckBoxBase {
    ...
    private void animateToCheckedState(boolean newCheckedState) {
        ...
        objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.CheckBoxBase.1
    ...
    */
    public void draw(android.graphics.Canvas r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.CheckBoxBase.draw(android.graphics.Canvas):void");
    }
