...
public class ChecksHintView extends FrameLayout {
    ...
    public boolean showForMessageCell(ChatMessageCell cell, boolean animated) {
        ...
        int checksY = i2 + cell.getChecksY() + AndroidUtilities.dp(6.0f);
        int checksX = cell.getChecksX() + AndroidUtilities.dp(5.0f);
        int measuredWidth = view.getMeasuredWidth();
        float measuredHeight = checksY - getMeasuredHeight();
        this.translationY = measuredHeight;
        setTranslationY(measuredHeight);
        int left = cell.getLeft() + checksX;
        ...
        float left2 = ((cell.getLeft() + checksX) - iDp) - (this.arrowImageView.getMeasuredWidth() / 2);
        ...
        if (animated) {
            ...
            while (i3 < 2) {
                this.textView[i3].animate().scaleX(1.04f).scaleY(1.04f).setInterpolator(CubicBezierInterpolator.EASE_IN).setStartDelay((i3 == 0 ? 132 : 500) + 140).setDuration(100L).setListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.ChecksHintView.2
    ...
    /* renamed from: ir.eitaa.ui.Components.ChecksHintView$1, reason: invalid class name */
    class AnonymousClass1 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            AndroidUtilities.runOnUIThread(ChecksHintView.this.hideRunnable = new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$ChecksHintView$1$E41gyxq3vHMov8bm1qzFcFB8cAU
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onAnimationEnd$0$ChecksHintView$1();
                }
            }, 3000L);
        }
    ...
    public void hide() {
        ...
        this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.Components.ChecksHintView.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
