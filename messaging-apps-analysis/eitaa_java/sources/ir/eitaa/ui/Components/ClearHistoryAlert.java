...
public class ClearHistoryAlert extends BottomSheet {
    ...
    public interface ClearHistoryAlertDelegate {
        ...
        /* renamed from: ir.eitaa.ui.Components.ClearHistoryAlert$ClearHistoryAlertDelegate$-CC, reason: invalid class name */
        public final /* synthetic */ class CC {
            public static void $default$onClearHistory(ClearHistoryAlertDelegate clearHistoryAlertDelegate, boolean z) {
            }
        }

        void onAutoDeleteHistory(int ttl, int action);

        void onClearHistory(boolean revoke);
    }
    ...
    */
    public ClearHistoryAlert(final android.content.Context r27, ir.eitaa.tgnet.TLRPC$User r28, ir.eitaa.tgnet.TLRPC$Chat r29, boolean r30, ir.eitaa.ui.ActionBar.Theme.ResourcesProvider r31) {
        /*
            Method dump skipped, instructions count: 979
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.ClearHistoryAlert.<init>(android.content.Context, ir.eitaa.tgnet.TLRPC$User, ir.eitaa.tgnet.TLRPC$Chat, boolean, ir.eitaa.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public /* synthetic */ void lambda$new$2$ClearHistoryAlert(View view) {
        ...
        if (this.dismissedDelayed) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$p7XyAn19KY5JmBa7y2c1jDfM72s
