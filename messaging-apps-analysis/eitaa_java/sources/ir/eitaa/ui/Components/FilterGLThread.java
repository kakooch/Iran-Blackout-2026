...
public class FilterGLThread extends DispatchQueue {
    ...
    public FilterGLThread(SurfaceTexture surface, Bitmap bitmap, int bitmapOrientation, boolean mirror) {
        ...
        this.drawRunnable = new Runnable() { // from class: ir.eitaa.ui.Components.FilterGLThread.1
    ...
    /* renamed from: lambda$setFilterGLThreadDelegate$0, reason: merged with bridge method [inline-methods] */
    ...
    public void setFilterGLThreadDelegate(final FilterShaders.FilterShadersDelegate filterShadersDelegate) {
        postRunnable(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$ZUWr6ymvpjI588ftp6acMmUb-p0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setFilterGLThreadDelegate$0$FilterGLThread(filterShadersDelegate);
            }
        });
    }
        ...
        if (iArr[0] > 0) {
            ...
            if (surfaceTexture instanceof SurfaceTexture) {
                ...
                if (this.videoDelegate != null) {
                    ...
                    surfaceTexture2.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$aHNJvY86VAeTrlDpeqP79_KwQw8
                        @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
                        public final void onFrameAvailable(SurfaceTexture surfaceTexture3) {
                            this.f$0.lambda$initGL$1$FilterGLThread(surfaceTexture3);
                        }
                    });
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$mxvRtuAEGCOn4MVuyWiSvOAa4a4
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$initGL$2$FilterGLThread();
                        }
                    });
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$initGL$1, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$initGL$1$FilterGLThread(SurfaceTexture surfaceTexture) {
        requestRender(false, true, true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$initGL$2, reason: merged with bridge method [inline-methods] */
    ...
    public void setVideoSize(final int width, final int height) {
        postRunnable(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$wxrspKPY4cNu5EhxtWdkosZHX0I
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setVideoSize$3$FilterGLThread(width, height);
            }
        });
    }
    ...
    public Bitmap getTexture() throws InterruptedException {
        ...
        try {
            if (postRunnable(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$gR8f9OPBySKWaRwiGZXnRzkRH24
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$getTexture$4$FilterGLThread(bitmapArr, countDownLatch);
                }
            })) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$getTexture$4, reason: merged with bridge method [inline-methods] */
    ...
    public void shutdown() {
        postRunnable(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$BRgk8vz78q-JuTbVhkZJ_PkvCSA
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$shutdown$5$FilterGLThread();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$shutdown$5, reason: merged with bridge method [inline-methods] */
    ...
    public void setSurfaceTextureSize(final int width, final int height) {
        postRunnable(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$XLSxEg7yZpZHS_QE4XbgeAJSuRM
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setSurfaceTextureSize$6$FilterGLThread(width, height);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$setSurfaceTextureSize$6, reason: merged with bridge method [inline-methods] */
    ...
    public void requestRender(final boolean updateBlur, final boolean force, final boolean surface) {
        postRunnable(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$FilterGLThread$lF5uYi7ExqDw2vMNKkc2Z_35Ao8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$requestRender$7$FilterGLThread(updateBlur, surface, force);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$requestRender$7, reason: merged with bridge method [inline-methods] */
