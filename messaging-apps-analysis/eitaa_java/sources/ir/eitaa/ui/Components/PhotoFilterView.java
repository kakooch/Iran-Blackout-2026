...
import ir.eitaa.ui.Cells.PhotoEditRadioCell;
import ir.eitaa.ui.Cells.PhotoEditToolCell;
import ir.eitaa.ui.Components.FilterShaders;
import ir.eitaa.ui.Components.PhotoEditorSeekBar;
...
public class PhotoFilterView extends FrameLayout implements FilterShaders.FilterShadersDelegate {
    ...
    */
    public PhotoFilterView(android.content.Context r24, ir.eitaa.ui.Components.VideoEditTextureView r25, android.graphics.Bitmap r26, int r27, ir.eitaa.messenger.MediaController.SavedFilterState r28, ir.eitaa.ui.Components.PaintingOverlay r29, int r30, boolean r31, ir.eitaa.ui.ActionBar.Theme.ResourcesProvider r32) {
        /*
            Method dump skipped, instructions count: 1639
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.PhotoFilterView.<init>(android.content.Context, ir.eitaa.ui.Components.VideoEditTextureView, android.graphics.Bitmap, int, ir.eitaa.messenger.MediaController$SavedFilterState, ir.eitaa.ui.Components.PaintingOverlay, int, boolean, ir.eitaa.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    /* renamed from: ir.eitaa.ui.Components.PhotoFilterView$1, reason: invalid class name */
    class AnonymousClass1 implements TextureView.SurfaceTextureListener {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, final int width, final int height) {
            if (PhotoFilterView.this.eglThread != null) {
                ...
                PhotoFilterView.this.eglThread.postRunnable(new Runnable() { // from class: ir.eitaa.ui.Components.-$$Lambda$PhotoFilterView$1$vEvOJsptjaFeJYUtjtOwL7bNXRk
    ...
    private void updateSelectedBlurType() {
        ...
        if (i == 0) {
            ...
            drawableMutate.setColorFilter(new PorterDuffColorFilter(getThemedColor("dialogFloatingButton"), PorterDuff.Mode.MULTIPLY));
        ...
        if (i == 1) {
            ...
            drawableMutate2.setColorFilter(new PorterDuffColorFilter(getThemedColor("dialogFloatingButton"), PorterDuff.Mode.MULTIPLY));
        ...
        if (i == 2) {
            ...
            drawableMutate3.setColorFilter(new PorterDuffColorFilter(getThemedColor("dialogFloatingButton"), PorterDuff.Mode.MULTIPLY));
    ...
    public void onTouch(MotionEvent event) {
        if (event.getActionMasked() == 0 || event.getActionMasked() == 5) {
            ...
            if (textureView instanceof VideoEditTextureView) {
                ...
                if (event.getX() < this.textureView.getX() || event.getY() < this.textureView.getY() || event.getX() > this.textureView.getX() + this.textureView.getWidth() || event.getY() > this.textureView.getY() + this.textureView.getHeight()) {
                    return;
                }
                setShowOriginal(true);
                return;
    ...
    private void fixLayout(int viewWidth, int viewHeight) {
        ...
        float fCeil;
        float fCeil2;
        int iDp = viewWidth - AndroidUtilities.dp(28.0f);
        int iDp2 = AndroidUtilities.dp(214.0f);
        int i = Build.VERSION.SDK_INT;
        int i2 = viewHeight - (iDp2 + ((i < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight));
        ...
        int iCeil2 = (int) Math.ceil(((f2 - fCeil) / 2.0f) + AndroidUtilities.dp(14.0f) + ((i < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight));
        int i4 = (int) fCeil2;
        int i5 = (int) fCeil;
        if (this.ownsTextureView) {
        ...
        float f3 = i4;
        float f4 = i5;
        this.curvesControl.setActualArea(iCeil, iCeil2 - ((i < 21 || this.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight), f3, f4);
        this.blurControl.setActualAreaSize(f3, f4);
        ((FrameLayout.LayoutParams) this.blurControl.getLayoutParams()).height = AndroidUtilities.dp(38.0f) + i2;
        ((FrameLayout.LayoutParams) this.curvesControl.getLayoutParams()).height = i2 + AndroidUtilities.dp(28.0f);
    ...
    public class ToolsAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                photoEditToolCell.setSeekBarDelegate(new PhotoEditorSeekBar.PhotoEditorSeekBarDelegate() { // from class: ir.eitaa.ui.Components.-$$Lambda$PhotoFilterView$ToolsAdapter$Wc2wwdMujOR8Z-G__ZJdq9bkcys
                    @Override // ir.eitaa.ui.Components.PhotoEditorSeekBar.PhotoEditorSeekBarDelegate
                ...
                photoEditRadioCell2.setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$PhotoFilterView$ToolsAdapter$im6GjU2lAAEeb2sF2vNqO3go2fc
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f$0.lambda$onCreateViewHolder$1$PhotoFilterView$ToolsAdapter(view);
                    }
                });
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                PhotoEditRadioCell photoEditRadioCell = (PhotoEditRadioCell) holder.itemView;
        ...
        public int getItemViewType(int position) {
            return (position == PhotoFilterView.this.tintShadowsTool || position == PhotoFilterView.this.tintHighlightsTool) ? 1 : 0;
        }
    }
}
