...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean fromTheme) {
        ...
        builder.setItems(charSequenceArr, iArr, new DialogInterface.OnClickListener() { // from class: ir.eitaa.ui.Components.-$$Lambda$WallpaperUpdater$5tomG9Aqanc3Snhre3Agx2r19xk
            ...
            try {
                ...
                if (fileGeneratePicturePath != null) {
                    if (Build.VERSION.SDK_INT >= 24) {
                        intent.putExtra("output", FileProvider.getUriForFile(this.parentActivity, "ir.eitaa.messenger.provider", fileGeneratePicturePath));
                        intent.addFlags(2);
                        intent.addFlags(1);
                    } else {
    ...
    public void openGallery() {
        ...
        if (baseFragment != null) {
            ...
            photoAlbumPickerActivity.setDelegate(new PhotoAlbumPickerActivity.PhotoAlbumPickerActivityDelegate() { // from class: ir.eitaa.ui.Components.WallpaperUpdater.1
    ...
    /* JADX WARN: Type inference failed for: r10v12, types: [ir.eitaa.ui.Components.WallpaperUpdater$WallpaperUpdaterDelegate] */
    ...
    */
    public void onActivityResult(int r8, int r9, android.content.Intent r10) {
        /*
            ...
            ir.eitaa.messenger.AndroidUtilities.addMediaToGallery(r8)
            java.io.File r8 = new java.io.File     // Catch: java.lang.Throwable -> L5d java.lang.Exception -> L5f
            java.io.File r9 = ir.eitaa.messenger.FileLoader.getDirectory(r4)     // Catch: java.lang.Throwable -> L5d java.lang.Exception -> L5f
            ...
            java.security.SecureRandom r4 = ir.eitaa.messenger.Utilities.random     // Catch: java.lang.Throwable -> L5d java.lang.Exception -> L5f
            ...
            android.graphics.Point r8 = ir.eitaa.messenger.AndroidUtilities.getRealScreenSize()     // Catch: java.lang.Throwable -> L5d java.lang.Exception -> L5f
            ...
            android.graphics.Bitmap r8 = ir.eitaa.messenger.ImageLoader.loadBitmap(r9, r5, r10, r8, r2)     // Catch: java.lang.Throwable -> L5d java.lang.Exception -> L5f
            ...
            ir.eitaa.ui.Components.WallpaperUpdater$WallpaperUpdaterDelegate r10 = r7.delegate     // Catch: java.lang.Exception -> L5b java.lang.Throwable -> L71
        ...
        L5f:
            ...
            r9 = r5
        L61:
            ir.eitaa.messenger.FileLog.e(r8)     // Catch: java.lang.Throwable -> L71
            if (r9 == 0) goto L6e
            r9.close()     // Catch: java.lang.Exception -> L6a
            goto L6e
        L6a:
        ...
        L79:
            r9 = move-exception
            ir.eitaa.messenger.FileLog.e(r9)
        L7d:
            throw r8
        L7e:
            r9 = 11
        ...
        L8b:
            ...
            java.io.File r9 = ir.eitaa.messenger.FileLoader.getDirectory(r4)     // Catch: java.lang.Exception -> Ld1
            ...
            java.security.SecureRandom r6 = ir.eitaa.messenger.Utilities.random     // Catch: java.lang.Exception -> Ld1
            ...
            android.graphics.Point r8 = ir.eitaa.messenger.AndroidUtilities.getRealScreenSize()     // Catch: java.lang.Exception -> Ld1
            ...
            android.graphics.Bitmap r8 = ir.eitaa.messenger.ImageLoader.loadBitmap(r5, r9, r10, r8, r2)     // Catch: java.lang.Exception -> Ld1
            ...
            ir.eitaa.ui.Components.WallpaperUpdater$WallpaperUpdaterDelegate r9 = r7.delegate     // Catch: java.lang.Exception -> Ld1
            java.io.File r10 = r7.currentWallpaperPath     // Catch: java.lang.Exception -> Ld1
        ...
        Ld6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.WallpaperUpdater.onActivityResult(int, int, android.content.Intent):void");
    }
}
