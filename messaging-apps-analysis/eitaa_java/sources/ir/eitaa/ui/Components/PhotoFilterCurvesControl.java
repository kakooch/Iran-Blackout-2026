    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L2b:
            ...
            r7.lastX = r0
            r7.lastY = r2
            ir.eitaa.ui.Components.Rect r4 = r7.actualArea
            float r5 = r4.x
        ...
        L78:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.Components.PhotoFilterCurvesControl.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void handlePan(int state, MotionEvent event) {
        ...
        int i = curvesToolValue.activeType;
        if (i == 0) {
    ...
    private void selectSegmentWithPoint(float pointx) {
        ...
        Rect rect = this.actualArea;
        this.activeSegment = (int) Math.floor(((pointx - rect.x) / (rect.width / 5.0f)) + 1.0f);
    }
