...
import ir.eitaa.ui.Cells.InviteTextCell;
...
public class InviteContactsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    private class SpansContainer extends ViewGroup {
        ...
        public void addSpan(final GroupCreateSpan span) {
            ...
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.InviteContactsActivity.SpansContainer.1
        ...
        public void removeSpan(final GroupCreateSpan span) {
            ...
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.currentAnimation = animatorSet2;
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: ir.eitaa.ui.InviteContactsActivity.SpansContainer.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    public View createView(Context context) throws NoSuchFieldException {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: ir.eitaa.ui.InviteContactsActivity.1
        ...
        ViewGroup viewGroup = new ViewGroup(context) { // from class: ir.eitaa.ui.InviteContactsActivity.2
            @Override // android.view.View
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                int iDp;
                int size = View.MeasureSpec.getSize(widthMeasureSpec);
            ...
            protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
                ...
                int i = bottom - top;
                int measuredHeight = i - InviteContactsActivity.this.infoTextView.getMeasuredHeight();
                ...
                int measuredHeight2 = i - InviteContactsActivity.this.counterView.getMeasuredHeight();
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: ir.eitaa.ui.InviteContactsActivity.3
        ...
        EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context) { // from class: ir.eitaa.ui.InviteContactsActivity.4
        ...
        this.editText.setCustomSelectionActionModeCallback(new ActionMode.Callback() { // from class: ir.eitaa.ui.InviteContactsActivity.5
        ...
        this.editText.setOnKeyListener(new View.OnKeyListener() { // from class: ir.eitaa.ui.InviteContactsActivity.6
        ...
        this.editText.addTextChangedListener(new TextWatcher() { // from class: ir.eitaa.ui.InviteContactsActivity.7
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: ir.eitaa.ui.-$$Lambda$InviteContactsActivity$itCch8mNwFq4lDSpZAgb7rpRKxQ
            @Override // ir.eitaa.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i) {
                this.f$0.lambda$createView$0$InviteContactsActivity(view, i);
            }
        });
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: ir.eitaa.ui.InviteContactsActivity.8
        ...
        this.infoTextView.setTypeface(AndroidUtilities.getFontFamily(true));
        ...
        this.counterView.setOnClickListener(new View.OnClickListener() { // from class: ir.eitaa.ui.-$$Lambda$InviteContactsActivity$_9jtTcdOYU2TorzWCNm0r_sU9ZQ
            @Override // android.view.View.OnClickListener
        ...
        this.textView.setText(LocaleController.getString("InviteToEitaa ", R.string.InviteToEitaa).toUpperCase());
    ...
    private void fetchContacts() {
        ...
        Collections.sort(arrayList, $$Lambda$InviteContactsActivity$HlcR2C6ebMxp7rseVySPeif4FdA.INSTANCE);
    ...
    public class InviteAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                inviteTextCell.setTextAndIcon(LocaleController.getString("ShareEitaa ", R.string.ShareEitaa), R.drawable.share);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (!this.searching) {
                ...
                charSequence = this.searchResultNames.get(position);
            }
            inviteUserCell.setUser(contact, charSequence, true);
            inviteUserCell.setChecked(InviteContactsActivity.this.selectedContacts.containsKey(contact.key), false);
            inviteUserCell.setMxbDelegate(new MxbHelper.MxbDelegate() { // from class: ir.eitaa.ui.InviteContactsActivity.InviteAdapter.1
                @Override // ir.eitaa.helper.MxbHelper.MxbDelegate
                public void onMxbPressed(String phone) {
                    MxbHelper.showMxbMessengersDialog(InviteContactsActivity.this, phone);
                }
            });
        }
        ...
        public int getItemViewType(int position) {
            return (this.searching || position != 0) ? 0 : 1;
        }
        ...
        public void searchDialogs(final String query) {
            ...
            if (query == null) {
                ...
                timer2.schedule(new AnonymousClass2(query), 200L, 300L);
            }
        }

        /* renamed from: ir.eitaa.ui.InviteContactsActivity$InviteAdapter$2, reason: invalid class name */
        class AnonymousClass2 extends TimerTask {
            final /* synthetic */ String val$query;

            AnonymousClass2(final String val$query) {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.ui.-$$Lambda$InviteContactsActivity$InviteAdapter$2$oeyCqgC0f6_dvZ9Oep2-AmwOL44
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$run$1$InviteContactsActivity$InviteAdapter$2(str);
                    }
                });
            }
            ...
            public /* synthetic */ void lambda$run$1$InviteContactsActivity$InviteAdapter$2(final String str) {
                Utilities.searchQueue.postRunnable(new Runnable() { // from class: ir.eitaa.ui.-$$Lambda$InviteContactsActivity$InviteAdapter$2$7yl3c3qpRhtKvgxVB8fxm8z-Oso
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$run$0$InviteContactsActivity$InviteAdapter$2(str);
                    }
                });
            }
            ...
            */
            public /* synthetic */ void lambda$run$0$InviteContactsActivity$InviteAdapter$2(java.lang.String r17) {
                /*
                    r16 = this;
                    r0 = r16
                    ...
                    int r2 = r1.length()
                    if (r2 != 0) goto L20
                    ir.eitaa.ui.InviteContactsActivity$InviteAdapter r1 = ir.eitaa.ui.InviteContactsActivity.InviteAdapter.this
                    java.util.ArrayList r2 = new java.util.ArrayList
                    r2.<init>()
                    java.util.ArrayList r3 = new java.util.ArrayList
                    r3.<init>()
                    ir.eitaa.ui.InviteContactsActivity.InviteAdapter.access$2600(r1, r2, r3)
                    return
                L20:
                    ir.eitaa.messenger.LocaleController r2 = ir.eitaa.messenger.LocaleController.getInstance()
                ...
                L46:
                    ...
                    r8 = 0
                L51:
                    ir.eitaa.ui.InviteContactsActivity$InviteAdapter r9 = ir.eitaa.ui.InviteContactsActivity.InviteAdapter.this
                    ir.eitaa.ui.InviteContactsActivity r9 = ir.eitaa.ui.InviteContactsActivity.this
                    java.util.ArrayList r9 = ir.eitaa.ui.InviteContactsActivity.access$2400(r9)
                    int r9 = r9.size()
                    if (r8 >= r9) goto Le3
                    ir.eitaa.ui.InviteContactsActivity$InviteAdapter r9 = ir.eitaa.ui.InviteContactsActivity.InviteAdapter.this
                    ir.eitaa.ui.InviteContactsActivity r9 = ir.eitaa.ui.InviteContactsActivity.this
                    ...
                    ir.eitaa.messenger.ContactsController$Contact r9 = (ir.eitaa.messenger.ContactsController.Contact) r9
                    java.lang.String r10 = r9.first_name
                    java.lang.String r11 = r9.last_name
                    java.lang.String r10 = ir.eitaa.messenger.ContactsController.formatName(r10, r11)
                    java.lang.String r10 = r10.toLowerCase()
                    ir.eitaa.messenger.LocaleController r11 = ir.eitaa.messenger.LocaleController.getInstance()
                ...
                Lc9:
                    ...
                    java.lang.CharSequence r3 = ir.eitaa.messenger.AndroidUtilities.generateSearchName(r3, r10, r14)
                    r2.add(r3)
                    r1.add(r9)
                    goto Lde
                Lda:
                ...
                Lde:
                    ...
                    goto L51
                Le3:
                    ir.eitaa.ui.InviteContactsActivity$InviteAdapter r3 = ir.eitaa.ui.InviteContactsActivity.InviteAdapter.this
                    ir.eitaa.ui.InviteContactsActivity.InviteAdapter.access$2600(r3, r1, r2)
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.ui.InviteContactsActivity.InviteAdapter.AnonymousClass2.lambda$run$0$InviteContactsActivity$InviteAdapter$2(java.lang.String):void");
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void updateSearchResults(final ArrayList<ContactsController.Contact> users, final ArrayList<CharSequence> names) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.ui.-$$Lambda$InviteContactsActivity$InviteAdapter$qZEyYlr-kv3wKNP6a2RlRU7oJ3k
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: ir.eitaa.ui.-$$Lambda$InviteContactsActivity$mVai-FGH5SM8LUL9nykt5791Otk
