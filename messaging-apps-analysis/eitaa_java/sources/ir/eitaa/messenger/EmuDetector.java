    ...
    */
    private boolean checkBasic() {
        ...
        Le6:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.messenger.EmuDetector.checkBasic():boolean");
    }
    ...
    private boolean checkFiles(String[] targets, EmulatorTypes type) {
        ...
        for (String str : targets) {
            if (ContextCompat.checkSelfPermission(this.mContext, "android.permission.READ_EXTERNAL_STORAGE") == 0) {
                if ((str.contains("/") && type == EmulatorTypes.NOX) || type == EmulatorTypes.BLUE) {
    ...
    private String getProp(Context context, String property) throws ClassNotFoundException {
        try {
            Class<?> clsLoadClass = context.getClassLoader().loadClass("android.os.SystemProperties");
            return (String) clsLoadClass.getMethod("get", String.class).invoke(clsLoadClass, property);
        } catch (Exception unused) {
            return null;
        }
    }
