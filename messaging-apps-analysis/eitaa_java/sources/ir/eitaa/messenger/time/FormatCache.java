...
abstract class FormatCache<F extends Format> {
    ...
    static String getPatternForStyle(final Integer dateStyle, final Integer timeStyle, final Locale locale) {
        ...
        try {
            if (dateStyle == null) {
                dateTimeInstance = DateFormat.getTimeInstance(timeStyle.intValue(), locale);
            } else if (timeStyle == null) {
                dateTimeInstance = DateFormat.getDateInstance(dateStyle.intValue(), locale);
            } else {
                dateTimeInstance = DateFormat.getDateTimeInstance(dateStyle.intValue(), timeStyle.intValue(), locale);
            }
