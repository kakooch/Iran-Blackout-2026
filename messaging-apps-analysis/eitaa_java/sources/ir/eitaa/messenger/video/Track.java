...
public class Track {
    ...
    public Track(int id, MediaFormat format, boolean audio) {
            ...
            if (string.equals(MediaController.VIDEO_MIME_TYPE)) {
                ...
                if (format.containsKey("profile")) {
                    ...
                    if (integer2 == 1) {
                        ...
                        avcConfigurationBox.setAvcProfileIndication(R.styleable.AppCompatTheme_viewInflaterClass);
                    } else if (integer2 == 32) {
        ...
        String string2 = format.containsKey("mime") ? format.getString("mime") : "audio/mp4-latm";
        DecoderConfigDescriptor decoderConfigDescriptor = new DecoderConfigDescriptor();
        if ("audio/mpeg".equals(string2)) {
            decoderConfigDescriptor.setObjectTypeIndication(R.styleable.AppCompatTheme_textColorSearchUrl);
        } else {
    ...
    public void prepare() {
        ...
        Collections.sort(this.samplePresentationTimes, $$Lambda$Track$r6dc4ytSL1Hpxg6Wy_zBtAd2GQ0.INSTANCE);
        ...
        while (true) {
            ...
            jMin = (j2 <= 0 || j2 >= 2147483647L) ? j3 : Math.min(j3, j2);
