...
public final class FingerprintManagerCompatApi23 {
    ...
    public static abstract class AuthenticationCallback {
        ...
        public abstract void onAuthenticationSucceeded(AuthenticationResultInternal result);
    }
    ...
    private static FingerprintManager.AuthenticationCallback wrapCallback(final AuthenticationCallback callback) {
        return new FingerprintManager.AuthenticationCallback() { // from class: ir.eitaa.messenger.support.fingerprint.FingerprintManagerCompatApi23.1
