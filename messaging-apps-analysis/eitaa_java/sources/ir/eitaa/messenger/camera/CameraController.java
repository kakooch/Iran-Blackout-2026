...
public class CameraController implements MediaRecorder.OnInfoListener {
    ...
    private void initCamera(final Runnable onInitRunnable, final boolean withDelay) {
        ...
        this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$rk93cPm0bHQzPp-N3qiRNJQt5k4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$initCamera$4$CameraController(withDelay, onInitRunnable);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$initCamera$4, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$initCamera$4$CameraController(final boolean z, final Runnable runnable) {
        ...
        try {
            if (cameraController.cameraInfos == null) {
                ...
                $$Lambda$CameraController$JtMEHEyouIU42phtH_4JRQVBMc __lambda_cameracontroller_jtmeheyouiu42phth_4jrqvbmc = $$Lambda$CameraController$JtMEHEyouIU42phtH_4JRQVBMc.INSTANCE;
                ...
                if (string != null) {
                    ...
                    for (int i2 = 0; i2 < int32; i2++) {
                        ...
                        Collections.sort(cameraInfo2.previewSizes, __lambda_cameracontroller_jtmeheyouiu42phth_4jrqvbmc);
                        Collections.sort(cameraInfo2.pictureSizes, __lambda_cameracontroller_jtmeheyouiu42phth_4jrqvbmc);
                    }
                    ...
                    while (i5 < numberOfCameras) {
                        try {
                            ...
                            Collections.sort(cameraInfo4.previewSizes, __lambda_cameracontroller_jtmeheyouiu42phth_4jrqvbmc);
                            Collections.sort(cameraInfo4.pictureSizes, __lambda_cameracontroller_jtmeheyouiu42phth_4jrqvbmc);
                            ...
                            FileLog.e(e);
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$TZI0WlHoGwb6GjTJFNKdt7r9peo
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$initCamera$3$CameraController(z, e, runnable);
                                }
                            });
                            return;
                        }
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$TXH4JHhPHLCBKh3Xe1c866CttJY
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$initCamera$1$CameraController();
                }
            });
        } catch (Exception e2) {
            e = e2;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$initCamera$3, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$initCamera$3$CameraController(boolean z, Exception exc, final Runnable runnable) {
        this.onFinishCameraInitRunnables.clear();
        this.loadingCameras = false;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$2pDiFgxWIx7Qd2C4rrtrgEaEZA4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$initCamera$2$CameraController(runnable);
            }
        }, 1000L);
    }
    ...
    public void close(final CameraSession session, final CountDownLatch countDownLatch, final Runnable beforeDestroyRunnable) {
        session.destroy();
        this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$ghV2X3lAU9HBmffh0PXFPFejExs
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    private static int getOrientation(byte[] r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.messenger.camera.CameraController.getOrientation(byte[]):int");
    }
    ...
    public boolean takePicture(final File path, final CameraSession session, final Runnable callback) {
        ...
        final CameraInfo cameraInfo = session.cameraInfo;
        final boolean zIsFlipFront = session.isFlipFront();
        try {
            cameraInfo.camera.takePicture(null, null, new Camera.PictureCallback() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$fL02EdeEThxCd7C-XqNEew2i2Po
                @Override // android.hardware.Camera.PictureCallback
                public final void onPictureTaken(byte[] bArr, Camera camera) throws IOException {
                    CameraController.lambda$takePicture$6(path, cameraInfo, zIsFlipFront, callback, bArr, camera);
                }
            });
            return true;
        } catch (Exception e) {
    ...
    static /* synthetic */ void lambda$takePicture$6(File file, CameraInfo cameraInfo, boolean z, Runnable runnable, byte[] bArr, Camera camera) throws IOException {
    ...
    public void startPreview(final CameraSession session) {
        ...
        this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$qiZDHjbxIpMvPhDgF4BOrGxqNnc
            @Override // java.lang.Runnable
            public final void run() {
                CameraController.lambda$startPreview$7(session);
            }
        });
    }
    ...
    public void stopPreview(final CameraSession session) {
        ...
        this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$knHSf9FxXubCmWRFZkCAipvevlE
            @Override // java.lang.Runnable
            public final void run() {
                CameraController.lambda$stopPreview$8(session);
            }
        });
    }
    ...
    public void openRound(final CameraSession session, final SurfaceTexture texture, final Runnable callback, final Runnable configureCallback) {
        ...
        this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$eNfw9Xe9Gi0Ow4lrFVV2bgZO0KQ
            @Override // java.lang.Runnable
            public final void run() throws IOException {
                CameraController.lambda$openRound$9(session, configureCallback, texture, callback);
            }
        });
    }

    static /* synthetic */ void lambda$openRound$9(CameraSession cameraSession, Runnable runnable, SurfaceTexture surfaceTexture, Runnable runnable2) throws IOException {
        Camera camera = cameraSession.cameraInfo.camera;
        try {
            if (BuildVars.LOGS_ENABLED) {
    ...
    public void open(final CameraSession session, final SurfaceTexture texture, final Runnable callback, final Runnable prestartCallback) {
        ...
        this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$lWl_cs2IZoSNYOsjm6sV1xCLaFE
            @Override // java.lang.Runnable
            public final void run() throws IOException {
                this.f$0.lambda$open$10$CameraController(session, prestartCallback, texture, callback);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$open$10, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$open$10$CameraController(CameraSession cameraSession, Runnable runnable, SurfaceTexture surfaceTexture, Runnable runnable2) throws IOException {
        CameraInfo cameraInfo = cameraSession.cameraInfo;
        Camera camera = cameraInfo.camera;
        if (camera == null) {
            try {
    ...
    public void recordVideo(final CameraSession session, final File path, final boolean mirror, final VideoTakeCallback callback, final Runnable onVideoStartRecord, final CameraView cameraView) {
        ...
        if (cameraView != null) {
            ...
            this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$5b0SmEQj6fOY59B2RzI5FU1cCgM
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$recordVideo$12$CameraController(camera, session, cameraView, path, onVideoStartRecord);
                }
            });
            return;
        }
        this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$AARHBDFcOCy5p5JR4TCocczskyc
            @Override // java.lang.Runnable
            public final void run() throws IllegalStateException, IOException, IllegalArgumentException {
                this.f$0.lambda$recordVideo$13$CameraController(camera, session, mirror, path, cameraInfo, callback, onVideoStartRecord);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$recordVideo$12, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$recordVideo$12$CameraController(Camera camera, CameraSession cameraSession, final CameraView cameraView, final File file, final Runnable runnable) {
        try {
            if (camera != null) {
                try {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$lAABD-Xqt2ZyIiq_7xp9VFp5X-Q
                    @Override // java.lang.Runnable
                    public final void run() throws InterruptedException {
                        this.f$0.lambda$recordVideo$11$CameraController(cameraView, file, runnable);
                    }
                });
            }
        } catch (Exception e2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$recordVideo$11, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$recordVideo$11$CameraController(CameraView cameraView, File file, Runnable runnable) throws InterruptedException {
        cameraView.startRecording(file, new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$6aqtWVUpyQdrkJr_tKcfvo97RsU
            @Override // java.lang.Runnable
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$recordVideo$13, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$recordVideo$13$CameraController(Camera camera, CameraSession cameraSession, boolean z, File file, CameraInfo cameraInfo, VideoTakeCallback videoTakeCallback, Runnable runnable) throws IllegalStateException, IOException, IllegalArgumentException {
        if (camera != null) {
            try {
                try {
                    Camera.Parameters parameters = camera.getParameters();
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void finishRecordingVideo() throws java.lang.Throwable {
        /*
            r10 = this;
            r0 = 0
            r1 = 0
        ...
        L31:
            ...
            r3 = r0
        L33:
            ir.eitaa.messenger.FileLog.e(r4)     // Catch: java.lang.Throwable -> Lc1
            if (r3 == 0) goto L40
        ...
        L40:
            ...
            r2 = 1
            android.graphics.Bitmap r1 = ir.eitaa.messenger.SendMessagesHelper.createVideoThumbnail(r1, r2)
        ...
        L7e:
            ...
            r0.append(r1)
            int r1 = ir.eitaa.messenger.SharedConfig.getLastLocalId()
            r0.append(r1)
            ...
            r1 = 4
            java.io.File r1 = ir.eitaa.messenger.FileLoader.getDirectory(r1)
            r6.<init>(r1, r0)
        ...
        Lb3:
            ir.eitaa.messenger.SharedConfig.saveConfig()
            ir.eitaa.messenger.camera.-$$Lambda$CameraController$rAGpxhOcSEmnr673raDrCu2B7po r0 = new ir.eitaa.messenger.camera.-$$Lambda$CameraController$rAGpxhOcSEmnr673raDrCu2B7po
            r4 = r0
            r5 = r10
            r4.<init>()
        ...
        Lcc:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.messenger.camera.CameraController.finishRecordingVideo():void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$finishRecordingVideo$14, reason: merged with bridge method [inline-methods] */
    ...
    public void onInfo(MediaRecorder mediaRecorder, int what, int extra) throws Throwable {
    ...
    public void stopVideoRecording(final CameraSession session, final boolean abandon) throws InterruptedException {
        CameraView cameraView = this.recordingCurrentCameraView;
        if (cameraView != null) {
            cameraView.stopRecording();
            this.recordingCurrentCameraView = null;
        } else {
            this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$X4azMHJV7yd5mnkJx-Z0ha4TrFs
                @Override // java.lang.Runnable
                public final void run() throws Throwable {
                    this.f$0.lambda$stopVideoRecording$16$CameraController(session, abandon);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$stopVideoRecording$16, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$stopVideoRecording$16$CameraController(final CameraSession cameraSession, boolean z) throws Throwable {
        ...
        try {
            ...
            this.threadPool.execute(new Runnable() { // from class: ir.eitaa.messenger.camera.-$$Lambda$CameraController$5zYvEWHkD-YWEU5scGrimd-Nz6U
                @Override // java.lang.Runnable
                public final void run() {
