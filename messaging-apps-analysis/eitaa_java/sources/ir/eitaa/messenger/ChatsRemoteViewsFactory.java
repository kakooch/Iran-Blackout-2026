...
class ChatsRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    */
    public android.widget.RemoteViews getViewAt(int r20) throws android.content.res.Resources.NotFoundException {
        /*
            Method dump skipped, instructions count: 1550
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.eitaa.messenger.ChatsRemoteViewsFactory.getViewAt(int):android.widget.RemoteViews");
    }
