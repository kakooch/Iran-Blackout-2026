...
public class MP3Frame {
    ...
    static final class CRC16 {
        ...
        public void update(int value, int length) {
            ...
            do {
                short s = this.crc;
                if (((Short.MIN_VALUE & s) == 0) ^ ((value & i) == 0)) {
                    short s2 = (short) (s << 1);
                    this.crc = s2;
    ...
    public static class Header {
        ...
        public Header(int b1, int b2, int b3) throws MP3Exception {
            ...
            int i5 = b1 & 1;
            this.protection = i5;
            int sideInfoSize = i5 != 0 ? 4 : 6;
            sideInfoSize = i2 == 1 ? sideInfoSize + getSideInfoSize() : sideInfoSize;
        ...
        public long getTotalDuration(long totalSize) {
            long sampleCount = ((getSampleCount() * totalSize) * 1000) / (getFrameSize() * getFrequency());
