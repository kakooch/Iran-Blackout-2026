...
class H264Utils {
    ...
    private static native boolean nativeIsSameH264Profile(Map<String, String> params1, Map<String, String> params2);
    ...
    public static Map<String, String> getDefaultH264Params(boolean isHighProfile) {
        ...
        map.put("profile-level-id", isHighProfile ? "640c1f" : "42e01f");
        return map;
    }
