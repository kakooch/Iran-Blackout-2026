...
public class EglRenderer implements VideoSink {
    ...
    private class EglSurfaceCreation implements Runnable {
        ...
        /* JADX WARN: Removed duplicated region for block: B:16:0x0030 A[Catch: all -> 0x00b2, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0005, B:7:0x000d, B:9:0x0011, B:14:0x002a, B:16:0x0030, B:23:0x0061, B:25:0x0068, B:26:0x0075, B:28:0x008d, B:17:0x003e, B:19:0x0042, B:21:0x0046, B:22:0x0054, B:29:0x0097, B:30:0x00af, B:12:0x001e), top: B:36:0x0001 }] */
        /* JADX WARN: Removed duplicated region for block: B:17:0x003e A[Catch: all -> 0x00b2, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0005, B:7:0x000d, B:9:0x0011, B:14:0x002a, B:16:0x0030, B:23:0x0061, B:25:0x0068, B:26:0x0075, B:28:0x008d, B:17:0x003e, B:19:0x0042, B:21:0x0046, B:22:0x0054, B:29:0x0097, B:30:0x00af, B:12:0x001e), top: B:36:0x0001 }] */
        /* JADX WARN: Removed duplicated region for block: B:25:0x0068 A[Catch: all -> 0x00b2, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0005, B:7:0x000d, B:9:0x0011, B:14:0x002a, B:16:0x0030, B:23:0x0061, B:25:0x0068, B:26:0x0075, B:28:0x008d, B:17:0x003e, B:19:0x0042, B:21:0x0046, B:22:0x0054, B:29:0x0097, B:30:0x00af, B:12:0x001e), top: B:36:0x0001 }] */
        /* JADX WARN: Removed duplicated region for block: B:26:0x0075 A[Catch: all -> 0x00b2, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0005, B:7:0x000d, B:9:0x0011, B:14:0x002a, B:16:0x0030, B:23:0x0061, B:25:0x0068, B:26:0x0075, B:28:0x008d, B:17:0x003e, B:19:0x0042, B:21:0x0046, B:22:0x0054, B:29:0x0097, B:30:0x00af, B:12:0x001e), top: B:36:0x0001 }] */
    ...
    private static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message msg) throws Exception {
            try {
    ...
    public void init(final EglBase.Context sharedContext, final int[] configAttributes, RendererCommon.GlDrawer drawer, boolean usePresentationTimeStamp) {
        synchronized (this.handlerLock) {
            ...
            handlerWithExceptionCallback.post(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$miQc1-F9Qqw0EkFhtMh5sNQ-7uU
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$init$0$EglRenderer(sharedContext, configAttributes);
                }
            });
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            ...
            handler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$dbZIvF-jDfWfAxWS6_OKLODul18
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$release$1$EglRenderer(countDownLatch);
                }
            });
            final Looper looper = this.renderThreadHandler.getLooper();
            this.renderThreadHandler.post(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$pvyzzKSwJYfQ10Yf4Pez7unf1S4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$release$2$EglRenderer(looper);
                }
            });
    ...
    public void addFrameListener(final FrameListener listener, final float scale, final RendererCommon.GlDrawer drawerParam, final boolean applyFpsReduction) {
        postToRenderThread(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$tlO7hICOsFJNVxM1OoLci4j1Lnc
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$addFrameListener$3$EglRenderer(drawerParam, listener, scale, applyFpsReduction);
            }
        });
    }
    ...
    public void removeFrameListener(final FrameListener listener) {
        ...
        synchronized (this.handlerLock) {
            ...
            postToRenderThread(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$aWqqEBvqd4fvIvDBk5V3V8xkOJw
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$removeFrameListener$4$EglRenderer(countDownLatch, listener);
                }
            });
            ThreadUtils.awaitUninterruptibly(countDownLatch);
        }
    ...
    public void onFrame(VideoFrame frame) {
        synchronized (this.handlerLock) {
            ...
            synchronized (this.frameLock) {
                ...
                frame.retain();
                this.renderThreadHandler.post(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$im8Sa54i366ODPy-soB9Bg4O-w4
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void releaseEglSurface(final Runnable completionCallback, final boolean background) {
        ...
        synchronized (this.handlerLock) {
            ...
            if (handler != null) {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$QVOzCVAVmXRPog88Qz_fF-zgKvY
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$releaseEglSurface$5$EglRenderer(background, completionCallback);
                    }
                });
    ...
    public void lambda$clearImage$6$EglRenderer(float r, float g, float b, float a) {
        EglBase eglBase = this.eglBase;
    ...
    public void clearImage(final float r, final float g, final float b, final float a) {
        synchronized (this.handlerLock) {
            ...
            handler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$YLaZEDK0BTvdaMEDE4KOForeEwY
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$clearImage$6$EglRenderer(r, g, b, a);
                }
            });
        }
    }
    ...
    public void getTexture(final GlGenericDrawer.TextureCallback callback) {
        ...
        synchronized (this.handlerLock) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$TpvYYrwQxD2WYODeErcR6kyRc6o
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$getTexture$7$EglRenderer(callback);
                    }
                });
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: lambda$getTexture$7, reason: merged with bridge method [inline-methods] */
        ...
        while (it.hasNext()) {
            ...
            if (wasRendered || !next.applyFpsReduction) {
                ...
                if (rotatedWidth == 0 || rotatedHeight == 0) {
                    ...
                    GLES20.glClear(16384);
                    this.frameDrawer.drawFrame(frame, next.drawer, this.drawMatrix, 0, 0, rotatedWidth, rotatedHeight, false, false);
