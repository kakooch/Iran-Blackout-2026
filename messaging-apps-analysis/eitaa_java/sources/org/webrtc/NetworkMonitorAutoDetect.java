    ...
    static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        WifiDirectManagerDelegate(NetworkChangeDetector.Observer observer, Context context) {
            ...
            if (Build.VERSION.SDK_INT > 28) {
                ...
                wifiP2pManager.requestGroupInfo(wifiP2pManager.initialize(context, context.getMainLooper(), null), new WifiP2pManager.GroupInfoListener() { // from class: org.webrtc.-$$Lambda$NetworkMonitorAutoDetect$WifiDirectManagerDelegate$wciCufxXu_MFCqXYngZBDItBMAU
                    @Override // android.net.wifi.p2p.WifiP2pManager.GroupInfoListener
                    public final void onGroupInfoAvailable(WifiP2pGroup wifiP2pGroup) {
                        this.f$0.lambda$new$0$NetworkMonitorAutoDetect$WifiDirectManagerDelegate(wifiP2pGroup);
                    }
                });
            }
        }
