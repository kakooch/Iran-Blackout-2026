...
class Camera2Session implements CameraSession {
    ...
    private class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        @Override // android.hardware.camera2.CameraDevice.StateCallback
        public void onOpened(CameraDevice camera) throws CameraAccessException {
            Camera2Session.this.checkIsOnCameraThread();
    ...
    class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        @Override // android.hardware.camera2.CameraCaptureSession.StateCallback
        public void onConfigured(CameraCaptureSession session) throws CameraAccessException {
            Camera2Session.this.checkIsOnCameraThread();
            ...
            try {
                ...
                session.setRepeatingRequest(builderCreateCaptureRequest.build(), new CameraCaptureCallback(), Camera2Session.this.cameraThreadHandler);
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.-$$Lambda$Camera2Session$CaptureSessionCallback$_XbqUL6ihfYRgME_EfDLZtLmkGA
                    @Override // org.webrtc.VideoSink
                    public final void onFrame(VideoFrame videoFrame) {
                        this.f$0.lambda$onConfigured$0$Camera2Session$CaptureSessionCallback(videoFrame);
                    }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: lambda$onConfigured$0, reason: merged with bridge method [inline-methods] */
    ...
    private Camera2Session(CameraSession.CreateSessionCallback callback, CameraSession.Events events, Context applicationContext, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String cameraId, int width, int height, int framerate) throws CameraAccessException {
