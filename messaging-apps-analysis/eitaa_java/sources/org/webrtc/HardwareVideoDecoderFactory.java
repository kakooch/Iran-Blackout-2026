...
public class HardwareVideoDecoderFactory extends MediaCodecVideoDecoderFactory {
        ...
        */
        public boolean test(android.media.MediaCodecInfo r8) {
            ...
            L8:
                ...
                goto L85
            L13:
                ir.eitaa.messenger.voip.Instance$ServerConfig r0 = ir.eitaa.messenger.voip.Instance.getGlobalServerConfig()
                r2 = 0
            L18:
                int r3 = r8.length
                r4 = 1
            ...
            L5a:
                ...
                return r8
            L5d:
                ir.eitaa.messenger.voip.VoIPService r8 = ir.eitaa.messenger.voip.VoIPService.getSharedInstance()
                if (r8 == 0) goto L6c
                ir.eitaa.messenger.voip.VoIPService r8 = ir.eitaa.messenger.voip.VoIPService.getSharedInstance()
                ir.eitaa.messenger.ChatObject$Call r8 = r8.groupCall
                if (r8 == 0) goto L6c
                return r1
            L6c:
    ...
    public /* bridge */ /* synthetic */ VideoDecoder createDecoder(VideoCodecInfo codecType) {
        return super.createDecoder(codecType);
    }
    ...
    public HardwareVideoDecoderFactory(EglBase.Context sharedContext, Predicate<MediaCodecInfo> codecAllowedPredicate) {
        ...
        if (codecAllowedPredicate == null) {
            ...
            predicateAnd = codecAllowedPredicate.and(defaultAllowedPredicate);
        }
        super(sharedContext, predicateAnd);
    }
}
