...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    private static int resolveGravity(int i) {
        ...
        return (i & R.styleable.AppCompatTheme_windowActionBarOverlay) == 0 ? i | 48 : i;
    }
    ...
    */
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int i5 = absoluteGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
        int i6 = absoluteGravity2 & 7;
        int i7 = absoluteGravity2 & R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (i6 == 1) {
    ...
    private void layoutChildWithKeyline(View view, int i, int i2) {
        ...
        int i4 = absoluteGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
        int width = getWidth();
        int height = getHeight();
        int measuredWidth = view.getMeasuredWidth();
        int measuredHeight = view.getMeasuredHeight();
    ...
    */
    ...
    static class ViewElevationComparator implements Comparator<View>, j$.util.Comparator {
