...
public final class SavedStateRegistry {
    ...
    public final void performAttach$savedstate_release(Lifecycle lifecycle) {
        ...
        lifecycle.addObserver(new LifecycleEventObserver() { // from class: androidx.savedstate.-$$Lambda$SavedStateRegistry$fqOml4yVknvVr08QjHEXC_isf3A
            ...
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                SavedStateRegistry.m8performAttach$lambda4(this.f$0, lifecycleOwner, event);
            }
        });
        this.attached = true;
    }
    ...
    public static final void m8performAttach$lambda4(SavedStateRegistry this$0, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
