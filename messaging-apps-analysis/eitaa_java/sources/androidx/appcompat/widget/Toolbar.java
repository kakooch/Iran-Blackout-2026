...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            layoutParamsGenerateDefaultLayoutParams.gravity = 8388613 | (this.mButtonGravity & R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams layoutParamsGenerateDefaultLayoutParams = generateDefaultLayoutParams();
            layoutParamsGenerateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    */
    ...
    private int getChildVerticalGravity(int i) {
        ...
        return (i2 == 16 || i2 == 48 || i2 == 80) ? i2 : this.mGravity & R.styleable.AppCompatTheme_windowActionBarOverlay;
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                layoutParamsGenerateDefaultLayoutParams.gravity = 8388611 | (toolbar4.mButtonGravity & R.styleable.AppCompatTheme_windowActionBarOverlay);
                layoutParamsGenerateDefaultLayoutParams.mViewType = 2;
