...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public void onWindowSystemUiVisibilityChanged(int i) {
        ...
        boolean z = (i & 4) == 0;
        boolean z2 = (i & Factory.DEVICE_HAS_CRAPPY_OPENSLES) != 0;
        ...
        if ((i2 & Factory.DEVICE_HAS_CRAPPY_OPENSLES) == 0 || this.mActionBarVisibilityCallback == null) {
            return;
        }
        ViewCompat.requestApplyInsets(this);
    }
    ...
    */
    ...
    protected boolean fitSystemWindows(Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        pullChildren();
        int windowSystemUiVisibility = ViewCompat.getWindowSystemUiVisibility(this) & Factory.DEVICE_HAS_CRAPPY_OPENSLES;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        boolean z = (ViewCompat.getWindowSystemUiVisibility(this) & Factory.DEVICE_HAS_CRAPPY_OPENSLES) != 0;
        if (z) {
    ...
    private boolean shouldHideActionBarOnFling(float f, float f2) {
        this.mFlingEstimator.fling(0, 0, 0, (int) f2, 0, 0, Integer.MIN_VALUE, ConnectionsManager.DEFAULT_DATACENTER_ID);
