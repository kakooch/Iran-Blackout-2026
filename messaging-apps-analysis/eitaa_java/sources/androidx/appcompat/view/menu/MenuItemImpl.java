...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    private int mShortcutNumericModifiers = Factory.DEVICE_HAS_CRAPPY_AAUDIO;
    private int mShortcutAlphabeticModifiers = Factory.DEVICE_HAS_CRAPPY_AAUDIO;
    ...
    String getShortcutLabel() {
        ...
        appendModifier(sb, i, Factory.DEVICE_HAS_CRAPPY_AAUDIO, resources.getString(R$string.abc_menu_ctrl_shortcut_label));
