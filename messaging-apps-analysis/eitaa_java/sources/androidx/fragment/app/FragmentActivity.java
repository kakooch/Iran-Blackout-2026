...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider("android:support:lifecycle", new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.-$$Lambda$FragmentActivity$t3WwJ1XbNlapyNW0l552nMkkXdo
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return this.f$0.lambda$init$0$FragmentActivity();
            }
        });
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.-$$Lambda$FragmentActivity$euPNEtWNfVdMY89Jt5kWt_WEHqw
            ...
            public final void onContextAvailable(Context context) {
                this.f$0.lambda$init$3$FragmentActivity(context);
            }
        });
    }
