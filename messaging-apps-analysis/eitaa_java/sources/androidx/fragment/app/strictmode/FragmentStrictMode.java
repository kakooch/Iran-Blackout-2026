...
public final class FragmentStrictMode {
    ...
    private final void handlePolicyViolation(final Policy policy, final Violation violation) {
        ...
        if (policy.getListener$fragment_release() != null) {
            runOnHostThread(fragment, new Runnable() { // from class: androidx.fragment.app.strictmode.-$$Lambda$FragmentStrictMode$3GEKar9k4mm28McDHO-XTHzF5lU
                ...
                public final void run() {
                    FragmentStrictMode.m4handlePolicyViolation$lambda0(policy, violation);
                }
            });
        }
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new Runnable() { // from class: androidx.fragment.app.strictmode.-$$Lambda$FragmentStrictMode$ujbeN2H_kHMJp2XfgBvtZfltiz0
                @Override // java.lang.Runnable
                public final void run() {
                    FragmentStrictMode.m5handlePolicyViolation$lambda1(name, violation);
                }
            });
        }
    }
    ...
    public static final void m4handlePolicyViolation$lambda0(Policy policy, Violation violation) {
    ...
    public static final void m5handlePolicyViolation$lambda1(String str, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
