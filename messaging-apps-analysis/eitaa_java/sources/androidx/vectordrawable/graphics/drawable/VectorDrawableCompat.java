...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        int iMin = Math.min(Factory.DEVICE_MCH265_LIMIT_DEQUEUE_OF_OUTPUT_BUFFERS, (int) (this.mTmpBounds.width() * fAbs));
        int iMin2 = Math.min(Factory.DEVICE_MCH265_LIMIT_DEQUEUE_OF_OUTPUT_BUFFERS, (int) (this.mTmpBounds.height() * fAbs2));
        if (iMin <= 0 || iMin2 <= 0) {
            return;
        }
