...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    protected void animateMoveImpl(final RecyclerView.ViewHolder holder, MoveInfo moveInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            viewPropertyAnimatorAnimate.setUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.-$$Lambda$DefaultItemAnimator$oLQxi4htIq91Jei3xGDc0d13x_4
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.lambda$animateMoveImpl$0$DefaultItemAnimator(holder, valueAnimator);
                }
            });
        }
    ...
    /* renamed from: lambda$animateMoveImpl$0, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void lambda$animateMoveImpl$0$DefaultItemAnimator(RecyclerView.ViewHolder viewHolder, ValueAnimator valueAnimator) {
