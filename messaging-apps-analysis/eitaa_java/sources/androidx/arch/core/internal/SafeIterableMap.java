...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>>, Iterable {
    ...
    private static abstract class ListIterator<K, V> implements Iterator<Map.Entry<K, V>>, SupportRemove<K, V>, j$.util.Iterator {
    ...
    public class IteratorWithAdditions implements java.util.Iterator<Map.Entry<K, V>>, SupportRemove<K, V>, j$.util.Iterator {
