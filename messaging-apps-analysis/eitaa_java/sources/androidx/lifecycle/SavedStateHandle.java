...
public final class SavedStateHandle {
    ...
    private final Map<String, ?> liveDatas = new LinkedHashMap();
    private final Map<String, MutableStateFlow<Object>> flows = new LinkedHashMap();
    private final SavedStateRegistry.SavedStateProvider savedStateProvider = new SavedStateRegistry.SavedStateProvider() { // from class: androidx.lifecycle.-$$Lambda$SavedStateHandle$85q68529u9GpNelrug3JBSyWf4c
