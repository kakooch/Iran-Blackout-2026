...
public final class CacheControl {
    ...
    public static final CacheControl FORCE_CACHE = new Builder().onlyIfCached().maxStale(ConnectionsManager.DEFAULT_DATACENTER_ID, TimeUnit.SECONDS).build();
    ...
    */
    ...
    public static final class Builder {
        ...
        public Builder maxStale(int i, TimeUnit timeUnit) {
            ...
            this.maxStaleSeconds = seconds > 2147483647L ? ConnectionsManager.DEFAULT_DATACENTER_ID : (int) seconds;
            return this;
        }
