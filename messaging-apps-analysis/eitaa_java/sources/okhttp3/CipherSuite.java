...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new AnonymousClass1();
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu);
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_toolbarNavigationButtonStyle);
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_toolbarStyle);
    public static final CipherSuite TLS_DH_anon_WITH_AES_128_CBC_SHA256 = init("TLS_DH_anon_WITH_AES_128_CBC_SHA256", R.styleable.AppCompatTheme_tooltipForegroundColor);
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA256 = init("TLS_DH_anon_WITH_AES_256_CBC_SHA256", R.styleable.AppCompatTheme_tooltipFrameBackground);
    ...
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = init("TLS_RSA_WITH_SEED_CBC_SHA", ImageReceiver.DEFAULT_CROSSFADE_DURATION);
