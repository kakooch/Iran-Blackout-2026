...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new AnonymousClass1();
    ...
    /* renamed from: okhttp3.internal.Util$1, reason: invalid class name */
    ...
    public static String[] intersect(java.util.Comparator<? super String> comparator, String[] strArr, String[] strArr2) {
    ...
    public static boolean nonEmptyIntersection(java.util.Comparator<String> comparator, String[] strArr, String[] strArr2) {
    ...
    public static int indexOf(java.util.Comparator<String> comparator, String[] strArr, String str) {
