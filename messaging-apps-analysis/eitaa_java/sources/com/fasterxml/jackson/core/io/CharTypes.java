...
public final class CharTypes {
    ...
    static {
        ...
        int[] iArr = new int[Factory.DEVICE_HAS_CRAPPY_OPENSLES];
        ...
        int[] iArr3 = new int[Factory.DEVICE_HAS_CRAPPY_OPENSLES];
        Arrays.fill(iArr3, -1);
        ...
        int[] iArr4 = new int[Factory.DEVICE_HAS_CRAPPY_OPENSLES];
        System.arraycopy(iArr3, 0, iArr4, 0, Factory.DEVICE_HAS_CRAPPY_OPENSLES);
        Arrays.fill(iArr4, 128, 128, 0);
        sInputCodesUtf8JsNames = iArr4;
        int[] iArr5 = new int[Factory.DEVICE_HAS_CRAPPY_OPENSLES];
        ...
        int[] iArr7 = new int[Factory.DEVICE_HAS_CRAPPY_OPENSLES];
        ...
        int[] iArr9 = new int[Factory.DEVICE_HAS_CRAPPY_OPENSLES];
        sHexValues = iArr9;
        Arrays.fill(iArr9, -1);
