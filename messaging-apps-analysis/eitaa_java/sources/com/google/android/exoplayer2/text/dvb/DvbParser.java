...
final class DvbParser {
    ...
    public List<Cue> decode(byte[] data, int limit) {
        ...
        for (int i3 = 0; i3 < sparseArray2.size(); i3++) {
            ...
            Bitmap bitmapCreateBitmap2 = Bitmap.createBitmap(this.bitmap, i4, i5, regionComposition.width, regionComposition.height);
            int i8 = displayDefinition.width;
            float f = i4 / i8;
            int i9 = displayDefinition.height;
            arrayList.add(new Cue(bitmapCreateBitmap2, f, 0, i5 / i9, 0, regionComposition.width / i8, regionComposition.height / i9));
        ...
        if (bits2 == 1) {
            ...
            if (bits2 == 0) {
                ...
                if (bits3 > 0) {
                    ...
                    data.readBytes(bArr2, 0, bits3);
                }
                if (bits4 > 0) {
                    bArr = new byte[bits4];
                    data.readBytes(bArr, 0, bits4);
                }
            }
