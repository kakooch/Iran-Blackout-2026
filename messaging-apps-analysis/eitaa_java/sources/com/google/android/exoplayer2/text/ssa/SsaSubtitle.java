...
final class SsaSubtitle implements Subtitle {
    ...
    public int getNextEventTimeIndex(long timeUs) {
        int iBinarySearchCeil = Util.binarySearchCeil((List<? extends Comparable<? super Long>>) this.cueTimesUs, Long.valueOf(timeUs), false, false);
    ...
    public List<Cue> getCues(long timeUs) {
        int iBinarySearchFloor = Util.binarySearchFloor((List<? extends Comparable<? super Long>>) this.cueTimesUs, Long.valueOf(timeUs), true, false);
