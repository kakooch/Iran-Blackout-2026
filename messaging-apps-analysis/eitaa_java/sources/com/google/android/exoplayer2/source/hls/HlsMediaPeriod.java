...
public final class HlsMediaPeriod implements MediaPeriod, HlsSampleStreamWrapper.Callback, HlsPlaylistTracker.PlaylistEventListener {
    ...
    */
    ...
    public boolean onPlaylistError(Uri url, long blacklistDurationMs) {
        ...
        for (HlsSampleStreamWrapper hlsSampleStreamWrapper : this.sampleStreamWrappers) {
            zOnPlaylistError &= hlsSampleStreamWrapper.onPlaylistError(url, blacklistDurationMs);
        }
        this.callback.onContinueLoadingRequested(this);
    ...
    */
    ...
    private void buildAndPrepareAudioSampleStreamWrappers(long positionUs, List<HlsMasterPlaylist.Rendition> audioRenditions, List<HlsSampleStreamWrapper> sampleStreamWrappers, List<int[]> manifestUrlsIndicesPerWrapper, Map<String, DrmInitData> overridingDrmInitData) {
        ...
        for (int i = 0; i < audioRenditions.size(); i++) {
            ...
            if (hashSet.add(str)) {
                ...
                manifestUrlsIndicesPerWrapper.add(Util.toArray(arrayList3));
    ...
    private static Format deriveVideoFormat(Format variantFormat) {
        ...
        return Format.createVideoContainerFormat(variantFormat.id, variantFormat.label, variantFormat.containerMimeType, MimeTypes.getMediaMimeType(codecsOfType), codecsOfType, variantFormat.metadata, variantFormat.bitrate, variantFormat.width, variantFormat.height, variantFormat.frameRate, null, variantFormat.selectionFlags, variantFormat.roleFlags);
    }
    ...
    private static Format deriveAudioFormat(Format variantFormat, Format mediaTagFormat, boolean isPrimaryTrackInVariant) {
        ...
        if (mediaTagFormat != null) {
            String str4 = mediaTagFormat.codecs;
            Metadata metadata2 = mediaTagFormat.metadata;
            int i4 = mediaTagFormat.channelCount;
            int i5 = mediaTagFormat.selectionFlags;
            int i6 = mediaTagFormat.roleFlags;
            String str5 = mediaTagFormat.language;
            ...
            String codecsOfType = Util.getCodecsOfType(variantFormat.codecs, 1);
            Metadata metadata3 = variantFormat.metadata;
            if (isPrimaryTrackInVariant) {
                int i7 = variantFormat.channelCount;
                str = codecsOfType;
                i = i7;
                i2 = variantFormat.selectionFlags;
                metadata = metadata3;
                i3 = variantFormat.roleFlags;
                str3 = variantFormat.language;
        ...
        return Format.createAudioContainerFormat(variantFormat.id, str2, variantFormat.containerMimeType, MimeTypes.getMediaMimeType(str), str, metadata, isPrimaryTrackInVariant ? variantFormat.bitrate : -1, i, -1, null, i2, i3, str3);
    }
}
