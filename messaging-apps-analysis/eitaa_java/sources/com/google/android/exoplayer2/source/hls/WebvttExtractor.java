...
public final class WebvttExtractor implements Extractor {
    ...
    private byte[] sampleData = new byte[Factory.DEVICE_MCH264ENC_NO_PIX_FMT_CONV];
    ...
    private TrackOutput buildTrackOutput(long subsampleOffsetUs) {
        ...
        trackOutputTrack.format(Format.createTextSampleFormat(null, "text/vtt", null, -1, 0, this.language, null, subsampleOffsetUs));
