...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        private static int[] getCountryGroupIndices(String countryCode) {
            int[] iArr = DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_COUNTRY_GROUPS.get(countryCode);
    ...
    private void maybeNotifyBandwidthSample(final int elapsedMs, final long bytesTransferred, final long bitrateEstimate) {
        ...
        this.eventDispatcher.dispatch(new EventDispatcher.Event() { // from class: com.google.android.exoplayer2.upstream.-$$Lambda$DefaultBandwidthMeter$pN4ezwwGidOf1Vrod007JMI61es
    ...
    private long getInitialBitrateEstimateForNetworkType(int networkType) {
        Long l = this.initialBitrateEstimates.get(networkType);
        if (l == null) {
    ...
    static class ConnectivityActionReceiver extends BroadcastReceiver {
        ...
        public synchronized void register(final DefaultBandwidthMeter bandwidthMeter) {
            ...
            this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.upstream.-$$Lambda$DefaultBandwidthMeter$ConnectivityActionReceiver$mti4nZG5medJd4VCi4eWnkFCrdE
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$register$0$DefaultBandwidthMeter$ConnectivityActionReceiver(bandwidthMeter);
                }
            });
        }
        ...
        public void lambda$register$0$DefaultBandwidthMeter$ConnectivityActionReceiver(DefaultBandwidthMeter bandwidthMeter) {
