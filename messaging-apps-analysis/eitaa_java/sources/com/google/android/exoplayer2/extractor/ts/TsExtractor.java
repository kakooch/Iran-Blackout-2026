...
public final class TsExtractor implements Extractor {
    ...
    public void seek(long position, long timeUs) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((timestampAdjuster.getTimestampOffsetUs() == -9223372036854775807L) || (timestampAdjuster.getTimestampOffsetUs() != 0 && timestampAdjuster.getFirstSampleTimestampUs() != timeUs)) {
    ...
    private boolean fillBufferWithAtLeastOnePacket(ExtractorInput input) throws InterruptedException, IOException {
        ...
        while (this.tsPacketBuffer.bytesLeft() < 188) {
            int iLimit = this.tsPacketBuffer.limit();
            int i = input.read(bArr, iLimit, 9400 - iLimit);
            if (i == -1) {
                return false;
            }
