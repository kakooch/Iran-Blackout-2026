...
public final class AdtsExtractor implements Extractor {
    ...
    public AdtsExtractor(int flags) {
        ...
        this.packetBuffer = new ParsableByteArray(Factory.DEVICE_MCH265_LIMIT_DEQUEUE_OF_OUTPUT_BUFFERS);
    ...
    */
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws InterruptedException, IOException {
        ...
        int i = input.read(this.packetBuffer.data, 0, Factory.DEVICE_MCH265_LIMIT_DEQUEUE_OF_OUTPUT_BUFFERS);
        boolean z2 = i == -1;
    ...
    private void maybeOutputSeekMap(long inputLength, boolean canUseConstantBitrateSeeking, boolean readEndOfStream) {
        ...
        if (z && this.reader.getSampleDurationUs() == -9223372036854775807L && !readEndOfStream) {
            return;
        }
        ExtractorOutput extractorOutput = (ExtractorOutput) Assertions.checkNotNull(this.extractorOutput);
        if (z && this.reader.getSampleDurationUs() != -9223372036854775807L) {
