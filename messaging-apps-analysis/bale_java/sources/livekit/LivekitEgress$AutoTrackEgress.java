...
public final class LivekitEgress$AutoTrackEgress extends GeneratedMessageLite implements U64 {
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        ...
        private a() {
            super(LivekitEgress$AutoTrackEgress.DEFAULT_INSTANCE);
        }
    }
    ...
    static {
        ...
        GeneratedMessageLite.registerDefaultInstance(LivekitEgress$AutoTrackEgress.class, livekitEgress$AutoTrackEgress);
    }
    ...
    public static LivekitEgress$AutoTrackEgress parseDelimitedFrom(InputStream inputStream) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(ByteBuffer byteBuffer) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public static a newBuilder(LivekitEgress$AutoTrackEgress livekitEgress$AutoTrackEgress) {
        return (a) DEFAULT_INSTANCE.createBuilder(livekitEgress$AutoTrackEgress);
    }

    public static LivekitEgress$AutoTrackEgress parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(byte[] bArr) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(InputStream inputStream) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitEgress$AutoTrackEgress parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitEgress$AutoTrackEgress) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
