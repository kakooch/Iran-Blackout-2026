...
public final class LivekitIngress$CreateIngressRequest extends GeneratedMessageLite implements U64 {
    ...
    public static LivekitIngress$CreateIngressRequest parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitIngress$CreateIngressRequest parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitIngress$CreateIngressRequest parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static LivekitIngress$CreateIngressRequest parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static LivekitIngress$CreateIngressRequest parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static LivekitIngress$CreateIngressRequest parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitIngress$CreateIngressRequest parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitIngress$CreateIngressRequest parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitIngress$CreateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
