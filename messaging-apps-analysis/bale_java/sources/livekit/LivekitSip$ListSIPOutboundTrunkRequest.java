...
public final class LivekitSip$ListSIPOutboundTrunkRequest extends GeneratedMessageLite implements U64 {
    ...
    public static a newBuilder(LivekitSip$ListSIPOutboundTrunkRequest livekitSip$ListSIPOutboundTrunkRequest) {
        return (a) DEFAULT_INSTANCE.createBuilder(livekitSip$ListSIPOutboundTrunkRequest);
    }

    public static LivekitSip$ListSIPOutboundTrunkRequest parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitSip$ListSIPOutboundTrunkRequest parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitSip$ListSIPOutboundTrunkRequest parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static LivekitSip$ListSIPOutboundTrunkRequest parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static LivekitSip$ListSIPOutboundTrunkRequest parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static LivekitSip$ListSIPOutboundTrunkRequest parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitSip$ListSIPOutboundTrunkRequest parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitSip$ListSIPOutboundTrunkRequest parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitSip$ListSIPOutboundTrunkRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
