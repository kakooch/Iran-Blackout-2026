...
public final class LivekitSip$GetSIPInboundTrunkResponse extends GeneratedMessageLite implements U64 {
    ...
    public static LivekitSip$GetSIPInboundTrunkResponse parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitSip$GetSIPInboundTrunkResponse parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitSip$GetSIPInboundTrunkResponse parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static LivekitSip$GetSIPInboundTrunkResponse parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static LivekitSip$GetSIPInboundTrunkResponse parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static LivekitSip$GetSIPInboundTrunkResponse parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitSip$GetSIPInboundTrunkResponse parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitSip$GetSIPInboundTrunkResponse parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitSip$GetSIPInboundTrunkResponse) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
