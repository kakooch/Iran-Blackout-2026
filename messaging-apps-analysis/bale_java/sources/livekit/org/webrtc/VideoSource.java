...
public class VideoSource extends MediaSource {
    ...
    public /* synthetic */ void lambda$setVideoProcessor$1(final VideoFrame videoFrame) {
        runWithReference(new Runnable() { // from class: ir.nasim.fV7
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$setVideoProcessor$0(videoFrame);
            }
        });
    }
        ...
        synchronized (this.videoProcessorLock) {
            try {
                ...
                if (videoProcessor != null) {
                    videoProcessor.setSink(new VideoSink() { // from class: ir.nasim.gV7
