...
import ir.nasim.ChoreographerFrameCallbackC20662sO5;
...
public final class RenderSynchronizer {
    ...
    public RenderSynchronizer(float f) {
        ...
        handler.post(new Runnable() { // from class: ir.nasim.uO5
    ...
    public /* synthetic */ void lambda$registerListener$1() {
        this.choreographer.postFrameCallback(new ChoreographerFrameCallbackC20662sO5(this));
    }
        ...
        synchronized (this.lock) {
            try {
                if (!this.isListening) {
                    ...
                    this.mainThreadHandler.post(new Runnable() { // from class: ir.nasim.tO5
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.a.lambda$registerListener$1();
                        }
                    });
                }
            } catch (Throwable th) {
