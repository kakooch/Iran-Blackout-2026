...
public class SurfaceTextureHelper {
    ...
    public void returnTextureFrame() {
        this.handler.post(new Runnable() { // from class: ir.nasim.d37
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$returnTextureFrame$5();
            }
        });
    }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: ir.nasim.g37
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$dispose$6();
            }
        });
    }

    public void forceFrame() {
        this.handler.post(new Runnable() { // from class: ir.nasim.i37
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$forceFrame$3();
            }
        });
    }
    ...
    public void setFrameRotation(final int i) {
        this.handler.post(new Runnable() { // from class: ir.nasim.e37
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$setFrameRotation$4(i);
            }
        });
    }
    ...
    public void setTextureSize(final int i, final int i2) {
        ...
        if (i2 > 0) {
            ...
            this.handler.post(new Runnable() { // from class: ir.nasim.f37
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: ir.nasim.h37
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$stopListening$1();
            }
        });
    }
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        try {
            ...
            surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: ir.nasim.j37
