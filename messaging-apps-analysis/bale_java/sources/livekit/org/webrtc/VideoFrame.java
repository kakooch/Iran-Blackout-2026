...
public class VideoFrame implements RefCounted {
    ...
    public int getRotatedHeight() {
        return this.rotation % SetRpcStruct$ComposedRpc.JOIN_GROUP_FIELD_NUMBER == 0 ? this.buffer.getHeight() : this.buffer.getWidth();
    }

    public int getRotatedWidth() {
        return this.rotation % SetRpcStruct$ComposedRpc.JOIN_GROUP_FIELD_NUMBER == 0 ? this.buffer.getWidth() : this.buffer.getHeight();
    }
