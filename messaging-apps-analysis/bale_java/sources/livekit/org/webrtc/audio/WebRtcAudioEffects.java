...
class WebRtcAudioEffects {
    ...
    public void enable(int i) throws IllegalStateException {
        Logging.d(TAG, "enable(audioSession=" + i + Separators.RPAREN);
        boolean z = false;
    ...
    public boolean setAEC(boolean z) {
        Logging.d(TAG, "setAEC(" + z + Separators.RPAREN);
        if (!isAcousticEchoCancelerSupported()) {
    ...
    public boolean setNS(boolean z) {
        Logging.d(TAG, "setNS(" + z + Separators.RPAREN);
        if (!isNoiseSuppressorSupported()) {
    ...
    public boolean toggleNS(boolean z) {
        ...
        Logging.d(TAG, "toggleNS(" + z + Separators.RPAREN);
