...
class Camera2Session implements CameraSession {
    ...
    private static final Histogram camera2StartTimeMsHistogram = Histogram.createCounts("WebRTC.Android.Camera2.StartTimeMs", 1, AppMetricaDefaultValues.DEFAULT_MAX_REPORTS_COUNT_UPPER_BOUND, 50);
    private static final Histogram camera2StopTimeMsHistogram = Histogram.createCounts("WebRTC.Android.Camera2.StopTimeMs", 1, AppMetricaDefaultValues.DEFAULT_MAX_REPORTS_COUNT_UPPER_BOUND, 50);
    ...
    private class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onOpened(CameraDevice cameraDevice) throws CameraAccessException {
            ...
            try {
                ...
                Camera2Session.this.reportError("Failed to create capture session. " + String.valueOf(e));
            }
        }
    ...
    class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) throws CameraAccessException {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: livekit.org.webrtc.d
                ...
                Camera2Session.this.reportError("Failed to start capture request. " + String.valueOf(e));
            }
        }
    ...
    private void openCamera() throws CameraAccessException {
        ...
        try {
            ...
            reportError("Failed to open camera: " + String.valueOf(e));
        }
    }
