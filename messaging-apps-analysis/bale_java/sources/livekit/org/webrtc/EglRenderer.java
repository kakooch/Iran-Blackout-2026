...
public class EglRenderer implements VideoSink {
    ...
    private void swapBuffersOnRenderThread(final VideoFrame videoFrame, final long j) {
        synchronized (this.threadLock) {
            try {
                ...
                EglThread.RenderUpdate renderUpdate = new EglThread.RenderUpdate() { // from class: ir.nasim.r52
        ...
        synchronized (this.threadLock) {
            try {
                ...
                synchronized (this.frameLock) {
                    ...
                    videoFrame.retain();
                    this.eglThread.getHandler().post(new Runnable() { // from class: ir.nasim.q52
                        @Override // java.lang.Runnable
    ...
    public void release() {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: ir.nasim.k52
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.a.lambda$release$0(countDownLatch);
                    }
                });
        ...
        synchronized (this.threadLock) {
            try {
                ...
                if (eglThread == null) {
                    ...
                    this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: ir.nasim.l52
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.a.lambda$releaseEglSurface$4(runnable);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: ir.nasim.m52
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void removeRenderListener(final RenderListener renderListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: ir.nasim.o52
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.a.lambda$removeRenderListener$3(countDownLatch, renderListener);
                    }
                });
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.threadLock) {
            try {
                ...
                eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: ir.nasim.p52
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.a.lambda$clearImage$5(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: ir.nasim.n52
            @Override // java.lang.Runnable
            public final void run() {
