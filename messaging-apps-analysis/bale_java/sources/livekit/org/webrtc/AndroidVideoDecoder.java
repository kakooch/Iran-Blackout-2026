...
class AndroidVideoDecoder implements VideoDecoder, VideoSink {
    ...
    AndroidVideoDecoder(MediaCodecWrapperFactory mediaCodecWrapperFactory, String str, VideoCodecMimeType videoCodecMimeType, int i, EglBase.Context context) {
        ...
        Logging.d(TAG, "ctor name: " + str + " type: " + String.valueOf(videoCodecMimeType) + " color format: " + i + " context: " + String.valueOf(context));
    ...
    private VideoCodecStatus initDecodeInternal(int i, int i2) {
        ...
        Logging.d(TAG, "initDecodeInternal name: " + this.codecName + " type: " + String.valueOf(this.codecType) + " width: " + i + " height: " + i2 + " color format: " + this.colorFormat);
        ...
        synchronized (this.dimensionLock) {
            try {
                ...
                if (integer != i || integer2 != this.height) {
                    ...
                    Logging.w(TAG, "Unexpected format dimensions. Configured " + i + Separators.STAR + this.height + ". New " + integer + Separators.STAR + integer2 + ". Skip it");
                    return;
                }
