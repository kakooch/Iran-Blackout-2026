...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    public void switchCameraInternal(CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        ...
        synchronized (this.stateLock) {
            try {
                ...
                this.cameraThreadHandler.post(new Runnable(this) { // from class: livekit.org.webrtc.CameraCapturer.9
    ...
    public void changeCaptureFormat(int i, int i2, int i3) {
        Logging.d(TAG, "changeCaptureFormat: " + i + "x" + i2 + Separators.AT + i3);
        synchronized (this.stateLock) {
            stopCapture();
    ...
    public void startCapture(int i, int i2, int i3) {
        Logging.d(TAG, "startCapture: " + i + "x" + i2 + Separators.AT + i3);
    ...
    public void stopCapture() {
        ...
        synchronized (this.stateLock) {
            ...
            if (this.currentSession != null) {
                ...
                this.cameraStatistics = null;
                final CameraSession cameraSession = this.currentSession;
                this.cameraThreadHandler.post(new Runnable(this) { // from class: livekit.org.webrtc.CameraCapturer.6
                    final /* synthetic */ CameraCapturer this$0;
    ...
    public void switchCamera(final CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler) {
        ...
        this.cameraThreadHandler.post(new Runnable(this) { // from class: livekit.org.webrtc.CameraCapturer.7
            final /* synthetic */ CameraCapturer this$0;
    ...
    public void switchCamera(final CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, final String str) {
        Logging.d(TAG, "switchCamera");
        this.cameraThreadHandler.post(new Runnable(this) { // from class: livekit.org.webrtc.CameraCapturer.8
            final /* synthetic */ CameraCapturer this$0;
