...
public final class LivekitEgress$EncodedFileOutput extends GeneratedMessageLite implements h {
    ...
    public static final class a extends GeneratedMessageLite.b implements h {
        ...
        private a() {
            super(LivekitEgress$EncodedFileOutput.DEFAULT_INSTANCE);
        }
    }
    ...
    static {
        ...
        GeneratedMessageLite.registerDefaultInstance(LivekitEgress$EncodedFileOutput.class, livekitEgress$EncodedFileOutput);
    }
    ...
    public static LivekitEgress$EncodedFileOutput parseDelimitedFrom(InputStream inputStream) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(ByteBuffer byteBuffer) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setFileType(EnumC18779pE3 enumC18779pE3) {
        this.fileType_ = enumC18779pE3.getNumber();
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        ...
        switch (f.a[gVar.ordinal()]) {
            ...
            case 2:
                return new a(fVar);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0007\u0001\u0000\u0001\u0007\u0007\u0000\u0000\u0000\u0001\f\u0002Ȉ\u0003<\u0000\u0004<\u0000\u0005<\u0000\u0006\u0007\u0007<\u0000", new Object[]{"output_", "outputCase_", "fileType_", "filepath_", LivekitEgress$S3Upload.class, LivekitEgress$GCPUpload.class, LivekitEgress$AzureBlobUpload.class, "disableManifest_", LivekitEgress$AliOSSUpload.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
    ...
    public EnumC18779pE3 getFileType() {
        EnumC18779pE3 enumC18779pE3J = EnumC18779pE3.j(this.fileType_);
        return enumC18779pE3J == null ? EnumC18779pE3.UNRECOGNIZED : enumC18779pE3J;
    }
    ...
    public static a newBuilder(LivekitEgress$EncodedFileOutput livekitEgress$EncodedFileOutput) {
        return (a) DEFAULT_INSTANCE.createBuilder(livekitEgress$EncodedFileOutput);
    }

    public static LivekitEgress$EncodedFileOutput parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(byte[] bArr) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(InputStream inputStream) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitEgress$EncodedFileOutput parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitEgress$EncodedFileOutput) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
