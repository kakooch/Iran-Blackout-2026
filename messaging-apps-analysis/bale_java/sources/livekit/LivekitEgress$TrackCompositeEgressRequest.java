...
public final class LivekitEgress$TrackCompositeEgressRequest extends GeneratedMessageLite implements U64 {
    ...
    public static final int WEBHOOKS_FIELD_NUMBER = 15;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setAudioTrackIdBytes(AbstractC2383g abstractC2383g) {
        AbstractC2377a.checkByteStringIsUtf8(abstractC2383g);
        this.audioTrackId_ = abstractC2383g.f0();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setVideoTrackIdBytes(AbstractC2383g abstractC2383g) {
        AbstractC2377a.checkByteStringIsUtf8(abstractC2383g);
        this.videoTrackId_ = abstractC2383g.f0();
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        ...
        switch (f.a[gVar.ordinal()]) {
            ...
            case 2:
                return new a(fVar);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\r\u0002\u0000\u0001\u000f\r\u0000\u0005\u0000\u0001Ȉ\u0002Ȉ\u0003Ȉ\u0004<\u0000\u0005<\u0000\u0006?\u0001\u0007<\u0001\b<\u0000\u000b\u001b\f\u001b\r\u001b\u000e\u001b\u000f\u001b", new Object[]{"output_", "outputCase_", "options_", "optionsCase_", "roomName_", "audioTrackId_", "videoTrackId_", LivekitEgress$EncodedFileOutput.class, LivekitEgress$StreamOutput.class, LivekitEgress$EncodingOptions.class, LivekitEgress$SegmentedFileOutput.class, "fileOutputs_", LivekitEgress$EncodedFileOutput.class, "streamOutputs_", LivekitEgress$StreamOutput.class, "segmentOutputs_", LivekitEgress$SegmentedFileOutput.class, "imageOutputs_", LivekitEgress$ImageOutput.class, "webhooks_", LivekitModels$WebhookConfig.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
    ...
    public AbstractC2383g getAudioTrackIdBytes() {
        return AbstractC2383g.N(this.audioTrackId_);
    }
    ...
    public AbstractC2383g getVideoTrackIdBytes() {
        return AbstractC2383g.N(this.videoTrackId_);
    }
    ...
    public static a newBuilder(LivekitEgress$TrackCompositeEgressRequest livekitEgress$TrackCompositeEgressRequest) {
        return (a) DEFAULT_INSTANCE.createBuilder(livekitEgress$TrackCompositeEgressRequest);
    }

    public static LivekitEgress$TrackCompositeEgressRequest parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitEgress$TrackCompositeEgressRequest parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitEgress$TrackCompositeEgressRequest parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static LivekitEgress$TrackCompositeEgressRequest parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static LivekitEgress$TrackCompositeEgressRequest parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static LivekitEgress$TrackCompositeEgressRequest parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitEgress$TrackCompositeEgressRequest parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitEgress$TrackCompositeEgressRequest parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitEgress$TrackCompositeEgressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
