...
public final class LivekitCloudAgent$UpdateAgentRequest extends GeneratedMessageLite implements U64 {
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        ...
        private a() {
            super(LivekitCloudAgent$UpdateAgentRequest.DEFAULT_INSTANCE);
        }
    }
    ...
    static {
        ...
        GeneratedMessageLite.registerDefaultInstance(LivekitCloudAgent$UpdateAgentRequest.class, livekitCloudAgent$UpdateAgentRequest);
    }
    ...
    public static LivekitCloudAgent$UpdateAgentRequest parseDelimitedFrom(InputStream inputStream) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(ByteBuffer byteBuffer) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        ...
        switch (e.a[gVar.ordinal()]) {
            ...
            case 2:
                return new a(eVar);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0007\u0000\u0000\u0001\u0007\u0007\u0000\u0002\u0000\u0001Ȉ\u0002Ȉ\u0003\u0004\u0004\u0004\u0005Ȉ\u0006Ț\u0007\u001b", new Object[]{"agentId_", "agentName_", "replicas_", "maxReplicas_", "cpuReq_", "regions_", "secrets_", LivekitCloudAgent$AgentSecret.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
    ...
    public static a newBuilder(LivekitCloudAgent$UpdateAgentRequest livekitCloudAgent$UpdateAgentRequest) {
        return (a) DEFAULT_INSTANCE.createBuilder(livekitCloudAgent$UpdateAgentRequest);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(byte[] bArr) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(InputStream inputStream) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitCloudAgent$UpdateAgentRequest parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitCloudAgent$UpdateAgentRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
