...
public final class LivekitIngress$UpdateIngressRequest extends GeneratedMessageLite implements U64 {
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        ...
        private a() {
            super(LivekitIngress$UpdateIngressRequest.DEFAULT_INSTANCE);
        }
    }
    ...
    static {
        ...
        GeneratedMessageLite.registerDefaultInstance(LivekitIngress$UpdateIngressRequest.class, livekitIngress$UpdateIngressRequest);
    }
    ...
    public static LivekitIngress$UpdateIngressRequest parseDelimitedFrom(InputStream inputStream) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(ByteBuffer byteBuffer) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public static a newBuilder(LivekitIngress$UpdateIngressRequest livekitIngress$UpdateIngressRequest) {
        return (a) DEFAULT_INSTANCE.createBuilder(livekitIngress$UpdateIngressRequest);
    }

    public static LivekitIngress$UpdateIngressRequest parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(AbstractC2383g abstractC2383g) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(byte[] bArr) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(byte[] bArr, C2394s c2394s) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(InputStream inputStream) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(InputStream inputStream, C2394s c2394s) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(AbstractC2384h abstractC2384h) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static LivekitIngress$UpdateIngressRequest parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (LivekitIngress$UpdateIngressRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
