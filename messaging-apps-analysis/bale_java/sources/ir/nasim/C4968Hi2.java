...
/* renamed from: ir.nasim.Hi2, reason: case insensitive filesystem */
/* loaded from: classes6.dex */
public final class C4968Hi2 implements InterfaceC9764aW7 {
    ...
    private C4968Hi2(ConstraintLayout constraintLayout, FrameLayout frameLayout, ImageViewCrossFade imageViewCrossFade, CircleProgressBar circleProgressBar, LottieAnimationView lottieAnimationView, FrameLayout frameLayout2, ImageView imageView) {
    ...
    public static C4968Hi2 a(View view) {
                ...
                if (circleProgressBar != null) {
                    ...
                    if (lottieAnimationView != null) {
                        ...
                        if (frameLayout2 != null) {
                            ...
                            if (imageView != null) {
                                return new C4968Hi2((ConstraintLayout) view, frameLayout, imageViewCrossFade, circleProgressBar, lottieAnimationView, frameLayout2, imageView);
                            }
                        }
                    }
                }
