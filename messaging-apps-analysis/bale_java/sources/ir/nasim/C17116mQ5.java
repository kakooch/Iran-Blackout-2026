...
/* renamed from: ir.nasim.mQ5, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public class C17116mQ5 extends TP5 {
    private String a;
    private String b;
    private long c;
    ...
    public static C17116mQ5 r(byte[] bArr) {
        return (C17116mQ5) AbstractC16720ll0.b(new C17116mQ5(), bArr);
    }
    ...
    public int q() {
        return SetRpcStruct$ComposedRpc.BUY_CHARGE_FIELD_NUMBER;
    }
    ...
    public void serialize(C19675ql0 c19675ql0) throws IOException {
        ...
        Integer num2 = this.h;
        if (num2 != null) {
            c19675ql0.f(8, num2.intValue());
        }
    }

    public String toString() {
        return "rpc BuyCharge{}";
    }
}
