...
public final class C6876Pj extends AbstractC2358u implements T64 {
    private static final C6876Pj DEFAULT_INSTANCE;
    ...
    public static final class b extends AbstractC2358u.a implements T64 {
        ...
        public b p(AbstractC2345g abstractC2345g) {
            i();
            ((C6876Pj) this.b).Y(abstractC2345g);
            return this;
        }
        ...
        private b() {
            super(C6876Pj.DEFAULT_INSTANCE);
        }
    }

    static {
        C6876Pj c6876Pj = new C6876Pj();
        DEFAULT_INSTANCE = c6876Pj;
        AbstractC2358u.N(C6876Pj.class, c6876Pj);
    }
    ...
    public static C6876Pj X(AbstractC2345g abstractC2345g, C2352n c2352n) {
        return (C6876Pj) AbstractC2358u.H(DEFAULT_INSTANCE, abstractC2345g, c2352n);
    }
