...
/* renamed from: ir.nasim.Oi, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C6633Oi extends AbstractC2358u implements T64 {
    private static final C6633Oi DEFAULT_INSTANCE;
    private static volatile JW4 PARSER = null;
    public static final int TAG_SIZE_FIELD_NUMBER = 1;
    private int tagSize_;

    /* renamed from: ir.nasim.Oi$a */
    ...
    public static final class b extends AbstractC2358u.a implements T64 {
        ...
        private b() {
            super(C6633Oi.DEFAULT_INSTANCE);
        }
    }

    static {
        C6633Oi c6633Oi = new C6633Oi();
        DEFAULT_INSTANCE = c6633Oi;
        AbstractC2358u.N(C6633Oi.class, c6633Oi);
    }

    private C6633Oi() {
    }

    public static C6633Oi T() {
    ...
    protected final Object q(AbstractC2358u.d dVar, Object obj, Object obj2) {
        ...
        switch (a.a[dVar.ordinal()]) {
            ...
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC2358u.F(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"tagSize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                JW4 bVar = PARSER;
                if (bVar == null) {
                    synchronized (C6633Oi.class) {
                        try {
                            bVar = PARSER;
                            if (bVar == null) {
