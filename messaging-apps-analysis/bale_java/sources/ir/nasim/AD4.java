...
public final class AD4 {
    ...
    private static class b implements e {
        ...
        @Override // ir.nasim.AD4.e
        public void a(TZ2 tz2) {
            tz2.u2(this.a, this.b, this.c, this.d);
        }
    ...
    private static class d implements Handler.Callback, ServiceConnection {
        ...
        private void j() {
            Set setF = AD4.f(this.a);
            if (setF.equals(this.e)) {
                return;
            }
            this.e = setF;
    ...
    private AD4(Context context) {
        this.a = context;
        this.b = (NotificationManager) context.getSystemService("notification");
    }

    public static AD4 e(Context context) {
    ...
    public void h(String str, int i, Notification notification) {
        if (!j(notification)) {
            ...
            i(new b(this.a.getPackageName(), i, str, notification));
            this.b.cancel(str, i);
        }
    }
}
