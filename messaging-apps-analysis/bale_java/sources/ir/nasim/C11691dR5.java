...
/* renamed from: ir.nasim.dR5, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public class C11691dR5 extends TP5 {
    private C25238zy a;
    private long b;
    private String c;
    private List d;

    public static C11691dR5 r(byte[] bArr) {
        return (C11691dR5) AbstractC16720ll0.b(new C11691dR5(), bArr);
    }
