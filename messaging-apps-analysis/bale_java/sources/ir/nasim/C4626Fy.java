...
/* renamed from: ir.nasim.Fy, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public class C4626Fy extends AbstractC17902nl0 {
    private C12056dy a;
    private int b;
    private int c;
    private int d;

    public C4626Fy(C12056dy c12056dy, int i, int i2, int i3) {
        this.a = c12056dy;
        this.b = i;
        this.c = i2;
        this.d = i3;
