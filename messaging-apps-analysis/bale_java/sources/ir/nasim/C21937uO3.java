...
public final class C21937uO3 extends RecyclerView.o {
    private final int a;
    private final int b;
    private int c;
    private int d;
    ...
    public /* synthetic */ C21937uO3(int i, int i2, int i3, int i4, int i5, int i6, ED1 ed1) {
    ...
    public void g(Rect rect, View view, RecyclerView recyclerView, RecyclerView.z zVar) {
        ...
        if (childAdapterPosition == 0) {
            rect.set(this.d, this.a, this.e, this.c);
            return;
        }
    ...
    public C21937uO3(int i, int i2, int i3, int i4, int i5) {
        this.a = i;
        this.b = i2;
        this.d = i4;
        this.e = i5;
