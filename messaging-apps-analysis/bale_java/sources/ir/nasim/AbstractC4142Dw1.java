...
public abstract class AbstractC4142Dw1 {
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder a(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, ir.nasim.InterfaceC11600dH4 r20, ir.nasim.C13774gn7 r21, ir.nasim.CK5 r22) {
        ...
        L8e:
            return r17
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.nasim.AbstractC4142Dw1.a(android.view.inputmethod.CursorAnchorInfo$Builder, int, int, ir.nasim.dH4, ir.nasim.gn7, ir.nasim.CK5):android.view.inputmethod.CursorAnchorInfo$Builder");
    }
    ...
    public static final CursorAnchorInfo b(CursorAnchorInfo.Builder builder, C23945xm7 c23945xm7, InterfaceC11600dH4 interfaceC11600dH4, C13774gn7 c13774gn7, Matrix matrix, CK5 ck5, CK5 ck52, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (i >= 33 && z3) {
            C24628yw1.a(builder, ck52);
        }
        if (i >= 34 && z4) {
            C3674Bw1.a(builder, c13774gn7, ck5);
        }
        return builder.build();
    }

    private static final boolean c(CK5 ck5, float f, float f2) {
        float fI = ck5.i();
        if (f <= ck5.j() && fI <= f) {
            float fL = ck5.l();
            if (f2 <= ck5.e() && fL <= f2) {
