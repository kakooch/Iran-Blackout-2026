...
public class YY5 extends AbstractC10365bX5 {
    private List b;
    private List c;

    public static YY5 s(byte[] bArr) {
        return (YY5) AbstractC16720ll0.b(new YY5(), bArr);
    }
    ...
    public String toString() {
        return "response GetReferencedEntitites{}";
    }
