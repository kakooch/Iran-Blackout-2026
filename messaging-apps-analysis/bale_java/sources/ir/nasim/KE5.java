...
public abstract class KE5 {
    ...
    public static int AudioWaveView_animateExpansion = 0;
    public static int AudioWaveView_chunkHeight = 1;
    public static int AudioWaveView_chunkRadius = 2;
    public static int AudioWaveView_chunkSpacing = 3;
    public static int AudioWaveView_chunkWidth = 4;
    public static int AudioWaveView_minChunkHeight = 5;
    public static int AudioWaveView_progress = 6;
    public static int AudioWaveView_touchable = 7;
    public static int AudioWaveView_waveColor = 8;
    public static int AvatarViewGlide_roundAsCircle = 0;
    public static int AvatarViewGlide_roundedCornerRadius = 1;
    ...
    public static int BaleButton_bale_button_type = 0;
    public static int BaleButton_bale_button_type_custom = 1;
    public static int BaleFullWidthButton_button_icon = 0;
    public static int BaleFullWidthButton_button_text = 1;
    public static int BaleImageButton_bale_image_button_icon_resource = 0;
    public static int BaleImageButton_bale_image_button_type = 1;
    public static int BaleImageButton_text = 2;
    public static int BaleTextInputLayout_android_imeOptions = 1;
    public static int BaleTextInputLayout_android_singleLine = 0;
    public static int BaleTextInputLayout_helper = 2;
    public static int BaleTextInputLayout_hide_helper = 3;
    public static int BaleTextInputLayout_hint = 4;
    public static int BaleTextInputLayout_inputTextDirection = 5;
    public static int BaleTextInputLayout_prefix = 6;
    public static int BaleTextInputLayout_prefixTextColor = 7;
    public static int BaleTextInputLayout_suffix = 8;
    public static int BaleTextInputLayout_title = 9;
    public static int BaleToolbar_android_layoutDirection = 0;
    ...
    public static int BoundedSizeTextView_maxTextSize = 0;
    public static int BoundedSizeTextView_minTextSize = 1;
    ...
    public static int CustomInputView_android_backgroundTint = 9;
    public static int CustomInputView_android_digits = 8;
    public static int CustomInputView_android_hint = 4;
    public static int CustomInputView_android_lines = 6;
    public static int CustomInputView_android_maxLength = 7;
    public static int CustomInputView_android_maxLines = 5;
    public static int CustomInputView_android_text = 3;
    public static int CustomInputView_android_textColor = 1;
    public static int CustomInputView_android_textColorHint = 2;
    public static int CustomInputView_android_textSize = 0;
    public static int CustomInputView_cardCornerRadius = 10;
    public static int CustomInputView_cardElevation = 11;
    public static int CustomInputView_cardHeight = 12;
    public static int CustomInputView_cardStrokeWidth = 13;
    public static int CustomInputView_cardWidth = 14;
    public static int CustomInputView_drawableEndFirst = 15;
    public static int CustomInputView_drawableEndFirstTint = 16;
    public static int CustomInputView_drawableEndSecond = 17;
    public static int CustomInputView_drawableEndSecondTint = 18;
    public static int CustomInputView_drawableStart = 19;
    public static int CustomInputView_drawableStartTint = 20;
    public static int CustomInputView_hintMarginBottom = 21;
    public static int CustomInputView_hintMarginLeft = 22;
    public static int CustomInputView_hintMarginRight = 23;
    public static int CustomInputView_hintMarginTop = 24;
    public static int CustomInputView_hintSize = 25;
    public static int CustomInputView_hintVisibility = 26;
    public static int CustomInputView_inputGravity = 27;
    public static int CustomInputView_inputHint = 28;
    public static int CustomInputView_inputHintColor = 29;
    public static int CustomInputView_inputMarginBottom = 30;
    public static int CustomInputView_inputMarginLeft = 31;
    public static int CustomInputView_inputMarginRight = 32;
    public static int CustomInputView_inputMarginTop = 33;
    public static int CustomInputView_isSourceInput = 34;
    public static int CustomInputView_postfix = 35;
    public static int CustomInputView_textInputType = 36;
    ...
    public static int DynamicFragmentNavigator_moduleName = 0;
    ...
    public static int EditTextWithPrefix_prefix = 0;
    ...
    public static int LoadingButton_state_loading = 0;
    ...
    public static int MultiProgressBar_progressColor = 0;
    public static int MultiProgressBar_progressIsNeedRestoreProgress = 1;
    public static int MultiProgressBar_progressLineColor = 2;
    public static int MultiProgressBar_progressOrientation = 3;
    public static int MultiProgressBar_progressPadding = 4;
    public static int MultiProgressBar_progressPercents = 5;
    public static int MultiProgressBar_progressSingleDisplayedTime = 6;
    public static int MultiProgressBar_progressSteps = 7;
    public static int MultiProgressBar_progressWidth = 8;
    ...
    public static int PhoneNumberEditText_formatterColor = 0;
    public static int PhoneNumberEditText_phoneNumberFormat = 1;
    ...
    public static int SentryUserFeedbackButton_android_background = 1;
    public static int SentryUserFeedbackButton_android_drawablePadding = 4;
    public static int SentryUserFeedbackButton_android_drawableStart = 6;
    public static int SentryUserFeedbackButton_android_padding = 2;
    public static int SentryUserFeedbackButton_android_text = 3;
    public static int SentryUserFeedbackButton_android_textAllCaps = 5;
    public static int SentryUserFeedbackButton_android_textColor = 0;
    ...
    public static int TintImageView_src = 0;
    public static int TintImageView_tintColor = 1;
    ...
    public static int[] AudioWaveView = {R.attr.animateExpansion, R.attr.chunkHeight, R.attr.chunkRadius, R.attr.chunkSpacing, R.attr.chunkWidth, R.attr.minChunkHeight, R.attr.progress, R.attr.touchable, R.attr.waveColor};
    public static int[] AvatarViewGlide = {R.attr.roundAsCircle, R.attr.roundedCornerRadius};
    ...
    public static int[] BaleButton = {R.attr.bale_button_type, R.attr.bale_button_type_custom};
    public static int[] BaleFullWidthButton = {R.attr.button_icon, R.attr.button_text};
    public static int[] BaleImageButton = {R.attr.bale_image_button_icon_resource, R.attr.bale_image_button_type, R.attr.text};
    public static int[] BaleTextInputLayout = {android.R.attr.singleLine, android.R.attr.imeOptions, R.attr.helper, R.attr.hide_helper, R.attr.hint, R.attr.inputTextDirection, R.attr.prefix, R.attr.prefixTextColor, R.attr.suffix, R.attr.title};
    public static int[] BaleToolbar = {android.R.attr.layoutDirection};
    ...
    public static int[] BoundedSizeTextView = {R.attr.maxTextSize, R.attr.minTextSize};
    ...
    public static int[] CustomInputView = {android.R.attr.textSize, android.R.attr.textColor, android.R.attr.textColorHint, android.R.attr.text, android.R.attr.hint, android.R.attr.maxLines, android.R.attr.lines, android.R.attr.maxLength, android.R.attr.digits, android.R.attr.backgroundTint, R.attr.cardCornerRadius, R.attr.cardElevation, R.attr.cardHeight, R.attr.cardStrokeWidth, R.attr.cardWidth, R.attr.drawableEndFirst, R.attr.drawableEndFirstTint, R.attr.drawableEndSecond, R.attr.drawableEndSecondTint, R.attr.drawableStart, R.attr.drawableStartTint, R.attr.hintMarginBottom, R.attr.hintMarginLeft, R.attr.hintMarginRight, R.attr.hintMarginTop, R.attr.hintSize, R.attr.hintVisibility, R.attr.inputGravity, R.attr.inputHint, R.attr.inputHintColor, R.attr.inputMarginBottom, R.attr.inputMarginLeft, R.attr.inputMarginRight, R.attr.inputMarginTop, R.attr.isSourceInput, R.attr.postfix, R.attr.textInputType};
    ...
    public static int[] DynamicFragmentNavigator = {R.attr.moduleName};
    ...
    public static int[] EditTextWithPrefix = {R.attr.prefix};
    ...
    public static int[] LoadingButton = {R.attr.state_loading};
    ...
    public static int[] MultiProgressBar = {R.attr.progressColor, R.attr.progressIsNeedRestoreProgress, R.attr.progressLineColor, R.attr.progressOrientation, R.attr.progressPadding, R.attr.progressPercents, R.attr.progressSingleDisplayedTime, R.attr.progressSteps, R.attr.progressWidth};
    ...
    public static int[] PersianDatePicker = {R.attr.displayDescription, R.attr.displayMonthNames, R.attr.maxYear, R.attr.minYear, R.attr.selectedDay, R.attr.selectedMonth, R.attr.selectedYear, R.attr.yearRange};
    public static int[] PhoneNumberEditText = {R.attr.formatterColor, R.attr.phoneNumberFormat};
    ...
    public static int[] SVGImageView = {R.attr.css, R.attr.svg};
    ...
    public static int[] TintImageView = {R.attr.src, R.attr.tintColor};
