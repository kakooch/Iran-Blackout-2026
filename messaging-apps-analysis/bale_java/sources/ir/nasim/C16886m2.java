...
/* renamed from: ir.nasim.m2, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public final class C16886m2 implements InterfaceC9262Ze2 {
    public static final InterfaceC12462ef2 d = new InterfaceC12462ef2() { // from class: ir.nasim.l2
        @Override // ir.nasim.InterfaceC12462ef2
        public final InterfaceC9262Ze2[] c() {
            return C16886m2.f();
        }
    };
    private final C17477n2 a = new C17477n2();
    private final EW4 b = new EW4(16384);
    private boolean c;

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ InterfaceC9262Ze2[] f() {
        return new InterfaceC9262Ze2[]{new C16886m2()};
    }
    ...
    public boolean d(InterfaceC9845af2 interfaceC9845af2) {
        ...
        while (true) {
            ...
            if (iL == 44096 || iL == 44097) {
                ...
                int iE2 = AbstractC18068o2.e(ew4.e(), iL);
                if (iE2 == -1) {
                    return false;
                }
                interfaceC9845af2.h(iE2 - 7);
            } else {
                interfaceC9845af2.e();
                i3++;
                if (i3 - i >= 8192) {
    ...
    public int e(InterfaceC9845af2 interfaceC9845af2, C8292Vi5 c8292Vi5) {
        int i = interfaceC9845af2.read(this.b.e(), 0, 16384);
        if (i == -1) {
            return -1;
        }
        this.b.S(0);
