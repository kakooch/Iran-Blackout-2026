...
public final class C4491Fj extends AbstractC2358u implements T64 {
    private static final C4491Fj DEFAULT_INSTANCE;
    ...
    public static final class b extends AbstractC2358u.a implements T64 {
        ...
        public b p(AbstractC2345g abstractC2345g) {
            i();
            ((C4491Fj) this.b).Y(abstractC2345g);
            return this;
        }
        ...
        private b() {
            super(C4491Fj.DEFAULT_INSTANCE);
        }
    }

    static {
        C4491Fj c4491Fj = new C4491Fj();
        DEFAULT_INSTANCE = c4491Fj;
        AbstractC2358u.N(C4491Fj.class, c4491Fj);
    }
    ...
    public static C4491Fj X(AbstractC2345g abstractC2345g, C2352n c2352n) {
        return (C4491Fj) AbstractC2358u.H(DEFAULT_INSTANCE, abstractC2345g, c2352n);
    }
