...
final class AD1 implements InterfaceC7391Rn0 {
    ...
    static final class a extends AbstractC19859r37 implements InterfaceC14603iB2 {
        ...
        /* renamed from: ir.nasim.AD1$a$a, reason: collision with other inner class name */
        static final class C0257a implements InterfaceC4806Gq2 {
            final /* synthetic */ C14063hH6 a;

            C0257a(C14063hH6 c14063hH6) {
                this.a = c14063hH6;
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.b = 1;
                if (interfaceC4557Fq2B.b(c0257a, this) == objE) {
                    return objE;
                }
            } else {
                if (i != 1) {
    ...
    static final class b extends AbstractC19859r37 implements InterfaceC14603iB2 {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(C15607js c15607js, float f, boolean z, AD1 ad1, InterfaceC22645vb3 interfaceC22645vb3, InterfaceC20295rm1 interfaceC20295rm1) {
            super(2, interfaceC20295rm1);
            this.c = c15607js;
            this.d = f;
            this.e = z;
            ...
            if (i == 0) {
                ...
                if (!C17784nZ1.s(((C17784nZ1) this.c.n()).v(), this.d)) {
                    if (this.e) {
                        ...
                        this.b = 2;
                        if (F52.d(c15607js, f, c23400wr2, interfaceC22645vb3, this) == objE) {
                            return objE;
                        }
                    } else {
    ...
    public /* synthetic */ AD1(float f, float f2, float f3, float f4, float f5, ED1 ed1) {
        this(f, f2, f3, f4, f5);
    }

    @Override // ir.nasim.InterfaceC7391Rn0
    public InterfaceC9664aL6 a(boolean z, InterfaceC23241wb3 interfaceC23241wb3, InterfaceC22053ub1 interfaceC22053ub1, int i) {
        interfaceC22053ub1.W(-1588756907);
        if (AbstractC5138Ib1.I()) {
            AbstractC5138Ib1.Q(-1588756907, i, -1, "androidx.compose.material.DefaultButtonElevation.elevation (Button.kt:503)");
        }
        ...
        float f = !z ? this.c : interfaceC22645vb3 instanceof InterfaceC6693Oo5.b ? this.b : interfaceC22645vb3 instanceof C12403eZ2 ? this.d : interfaceC22645vb3 instanceof C23400wr2 ? this.e : this.a;
    ...
    private AD1(float f, float f2, float f3, float f4, float f5) {
        this.a = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
