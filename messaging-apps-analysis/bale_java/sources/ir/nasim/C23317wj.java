...
public final class C23317wj extends AbstractC2358u implements T64 {
    private static final C23317wj DEFAULT_INSTANCE;
    ...
    public static final class b extends AbstractC2358u.a implements T64 {
        ...
        private b() {
            super(C23317wj.DEFAULT_INSTANCE);
        }
    }

    static {
        C23317wj c23317wj = new C23317wj();
        DEFAULT_INSTANCE = c23317wj;
        AbstractC2358u.N(C23317wj.class, c23317wj);
    }
    ...
    public static C23317wj W(AbstractC2345g abstractC2345g, C2352n c2352n) {
        return (C23317wj) AbstractC2358u.H(DEFAULT_INSTANCE, abstractC2345g, c2352n);
    }
    ...
    protected final Object q(AbstractC2358u.d dVar, Object obj, Object obj2) {
        ...
        switch (a.a[dVar.ordinal()]) {
            ...
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC2358u.F(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0002\u0003\u0002\u0000\u0000\u0000\u0002\u000b\u0003\u000b", new Object[]{"keySize_", "version_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                JW4 bVar = PARSER;
                if (bVar == null) {
                    synchronized (C23317wj.class) {
                        try {
                            bVar = PARSER;
                            if (bVar == null) {
