...
public final class C18472oj extends AbstractC2358u implements T64 {
    private static final C18472oj DEFAULT_INSTANCE;
    ...
    public static final class b extends AbstractC2358u.a implements T64 {
        ...
        private b() {
            super(C18472oj.DEFAULT_INSTANCE);
        }
    }

    static {
        C18472oj c18472oj = new C18472oj();
        DEFAULT_INSTANCE = c18472oj;
        AbstractC2358u.N(C18472oj.class, c18472oj);
    }

    private C18472oj() {
    }

    public static C18472oj T() {
