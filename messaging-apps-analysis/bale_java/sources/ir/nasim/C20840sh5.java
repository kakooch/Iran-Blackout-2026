...
/* renamed from: ir.nasim.sh5, reason: case insensitive filesystem */
/* loaded from: classes5.dex */
public final class C20840sh5 implements Z64 {
    private final Context a;
    private final GI7 b;
    private final int c;
    private final MessagingStruct$Message.b d;

    public C20840sh5(Context context, GI7 gi7, int i) {
        AbstractC13042fc3.i(context, "context");
        AbstractC13042fc3.i(gi7, "userNamePlaceHolderManager");
        this.a = context;
        this.b = gi7;
        this.c = i;
        this.d = MessagingStruct$Message.b.POLL_MESSAGE;
    }

    private final DialogLastMessage.Text f(final int i, final ExPeerType exPeerType, final MessageState messageState) {
        return (DialogLastMessage.Text) this.b.b(new UA2() { // from class: ir.nasim.rh5
            @Override // ir.nasim.UA2
            public final Object invoke(Object obj) {
                return C20840sh5.g(this.a, i, exPeerType, messageState, (GI7.a) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final DialogLastMessage.Text g(C20840sh5 c20840sh5, int i, ExPeerType exPeerType, MessageState messageState, GI7.a aVar) {
        AbstractC13042fc3.i(c20840sh5, "this$0");
        ...
        String string = c20840sh5.a.getString(FD5.last_message_poll);
        AbstractC13042fc3.h(string, "getString(...)");
        return new DialogLastMessage.Text(string, (List) null, (EnumC22968w74) null, aVar.c(i, exPeerType), i == c20840sh5.c, i, messageState, aVar.b(), (MessagingStruct$ServiceEx.b) null, 262, (ED1) null);
    }
