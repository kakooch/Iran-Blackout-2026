...
/* renamed from: ir.nasim.Hw6, reason: case insensitive filesystem */
/* loaded from: classes7.dex */
public abstract class AbstractC5098Hw6 {
    ...
    private static Map a() {
        ...
        map.put("compositeWithMask", Collections.unmodifiableMap(map5));
        ...
        map6.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "blured", "color"});
        map.put("blitWithMaskBlurer", Collections.unmodifiableMap(map6));
        ...
        map7.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "blured", "color"});
        map.put("compositeWithMaskBlurer", Collections.unmodifiableMap(map7));
        HashMap map8 = new HashMap();
        map8.put("vertex", "precision highp float;uniform mat4 mvpMatrix;attribute vec4 inPosition;attribute vec2 inTexcoord;attribute float alpha;varying vec2 varTexcoord;varying float varIntensity;void main (void) {   gl_Position = mvpMatrix * inPosition;   varTexcoord = inTexcoord;   varIntensity = alpha;}");
        map8.put("fragment", "precision highp float;varying vec2 varTexcoord;varying float varIntensity;uniform sampler2D texture;void main (void) {   vec4 f = texture2D(texture, varTexcoord.st, 0.0);   gl_FragColor = vec4(f.r * varIntensity, f.g, f.b, 0.0);}");
        map8.put("attributes", new String[]{"inPosition", "inTexcoord", "alpha"});
        map8.put("uniforms", new String[]{"mvpMatrix", "texture"});
        map.put("brushLight", Collections.unmodifiableMap(map8));
        ...
        map9.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "color"});
        map.put("blitWithMaskLight", Collections.unmodifiableMap(map9));
        ...
        map10.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "color"});
        map.put("compositeWithMaskLight", Collections.unmodifiableMap(map10));
        HashMap map11 = new HashMap();
        map11.put("vertex", "precision highp float;uniform mat4 mvpMatrix;attribute vec4 inPosition;attribute vec2 inTexcoord;varying vec2 varTexcoord;void main (void) {   gl_Position = mvpMatrix * inPosition;   varTexcoord = inTexcoord;}");
        map11.put("fragment", "precision highp float;varying vec2 varTexcoord;uniform sampler2D texture;uniform sampler2D mask;uniform vec4 color;void main (void) {   vec4 dst = texture2D(texture, varTexcoord.st, 0.0);   float srcAlpha = color.a * texture2D(mask, varTexcoord.st, 0.0).a;   float outAlpha = dst.a * (1. - srcAlpha);   gl_FragColor.rgb = dst.rgb;   gl_FragColor.a = outAlpha;   gl_FragColor.rgb *= gl_FragColor.a;}");
        map11.put("attributes", new String[]{"inPosition", "inTexcoord"});
        map11.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "color"});
        map.put("blitWithMaskEraser", Collections.unmodifiableMap(map11));
        ...
        map.put("compositeWithMaskEraser", Collections.unmodifiableMap(map12));
        ...
        map13.put("fragment", "precision highp float;varying vec2 varTexcoord;uniform sampler2D texture;void main (void) {   gl_FragColor = texture2D(texture, varTexcoord.st, 0.0);}");
        map13.put("attributes", new String[]{"inPosition", "inTexcoord"});
        map13.put("uniforms", new String[]{"mvpMatrix", "texture"});
        map.put("nonPremultipliedBlit", Collections.unmodifiableMap(map13));
        ...
        map14.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", SDPKeywords.CLEAR, "color", "type", "color", "resolution", "center", "radius", "thickness", "rounding", "fill", "rotation", "middle", "arrowTriangleLength", "composite"});
        map.put("shape", Collections.unmodifiableMap(map14));
    ...
    public static Map b() {
        ...
        for (Map.Entry entry : a.entrySet()) {
            ...
            map.put((String) entry.getKey(), new ir.nasim.tgwidgets.editor.ui.Components.Paint.p((String) map2.get("vertex"), (String) map2.get("fragment"), (String[]) map2.get("attributes"), (String[]) map2.get("uniforms")));
        }
        return Collections.unmodifiableMap(map);
    }
}
