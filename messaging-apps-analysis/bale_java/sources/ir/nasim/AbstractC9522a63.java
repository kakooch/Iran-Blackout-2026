...
/* renamed from: ir.nasim.a63, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public abstract class AbstractC9522a63 {

    /* renamed from: ir.nasim.a63$a */
    ...
    public static final float a(Layout layout, int i, Paint paint) {
        ...
        if (!AbstractC15565jn7.m(layout, i) || layout.getParagraphDirection(i) != 1 || lineLeft >= 0.0f) {
            return 0.0f;
        }
    ...
    public static final float c(Layout layout, int i, Paint paint) {
        float width;
        float width2;
        if (!AbstractC15565jn7.m(layout, i)) {
            return 0.0f;
        }
