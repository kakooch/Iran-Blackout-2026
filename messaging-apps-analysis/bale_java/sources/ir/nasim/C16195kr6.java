...
/* renamed from: ir.nasim.kr6, reason: case insensitive filesystem */
/* loaded from: classes5.dex */
public final class C16195kr6 extends AbstractC12586er6 {
    private String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C16195kr6(C11909dl1 c11909dl1) {
        ...
        AbstractC13042fc3.g(vbU, "null cannot be cast to non-null type ir.nasim.core.api.ApiServiceExChangedAbout");
        String strU = ((ZB) vbU).u();
        this.d = strU;
        if (strU == null) {
            this.d = "";
        }
    ...
    public String a(Context context, int i, String str, boolean z) {
        ...
        int i2 = AbstractC12217eE5.service_holder_group_about_changed;
