...
public abstract class MS implements View.OnTouchListener {
    ...
    private static class a {
        ...
        private float e(long j) {
            ...
            long j2 = this.i;
            if (j2 < 0 || j < j2) {
                return MS.e((j - r0) / this.a, 0.0f, 1.0f) * 0.5f;
            }
            float f = this.j;
            return (1.0f - f) + (f * MS.e((j - j2) / this.k, 0.0f, 1.0f));
        }
        ...
        public void i() {
            long jCurrentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.k = MS.f((int) (jCurrentAnimationTimeMillis - this.e), 0, this.b);
    ...
    private class b implements Runnable {
        ...
        public void run() {
            ...
            if (ms.o) {
                ...
                aVar.a();
                MS.this.j(aVar.b(), aVar.c());
                AbstractC12990fW7.h0(MS.this.c, this);
            }
        }
    }
    ...
    public MS(View view) {
        ...
        t(1.0f, 1.0f);
        k(r);
        r(SIPTransactionStack.BASE_TIMER_INTERVAL);
        q(SIPTransactionStack.BASE_TIMER_INTERVAL);
    }
    ...
    private void v() {
        ...
        if (this.l || (i = this.h) <= 0) {
            ...
            AbstractC12990fW7.i0(this.c, this.d, i);
        }
        this.l = true;
    }
    ...
    */
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L61:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.nasim.MS.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }

    public MS p(float f, float f2) {
        float[] fArr = this.j;
        fArr[0] = f / 1000.0f;
        fArr[1] = f2 / 1000.0f;
        return this;
