...
public final class DW4 {
    ...
    private void a() {
        int i;
        int i2 = this.b;
        AbstractC20011rK.g(i2 >= 0 && (i2 < (i = this.d) || (i2 == i && this.c == 0)));
    }
    ...
    public void f(int i, int i2) {
        ...
        int i3 = this.c;
        int i4 = (8 - i3) - iMin;
        int i5 = (ValidatingResolver.VALIDATION_REASON_QCLASS >> i3) | ((1 << i4) - 1);
        byte[] bArr = this.a;
        int i6 = this.b;
    ...
    public long j(int i) {
        return i <= 32 ? AbstractC9683aN7.Z0(h(i)) : AbstractC9683aN7.Y0(h(i - 32), h(32));
    }
    ...
    public DW4(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public DW4(byte[] bArr, int i) {
        this.a = bArr;
        this.d = i;
    }
}
