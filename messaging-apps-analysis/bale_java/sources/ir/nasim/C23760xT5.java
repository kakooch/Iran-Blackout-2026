...
/* renamed from: ir.nasim.xT5, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public class C23760xT5 extends TP5 {
    private List a;
    private List b;

    public static C23760xT5 r(byte[] bArr) {
        return (C23760xT5) AbstractC16720ll0.b(new C23760xT5(), bArr);
    }
