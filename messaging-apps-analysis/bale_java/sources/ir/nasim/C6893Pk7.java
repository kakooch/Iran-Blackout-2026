...
public final class C6893Pk7 extends Canvas {
    private Canvas a;
    ...
    public boolean clipOutPath(Path path) {
        C10814cF0 c10814cF0 = C10814cF0.a;
        Canvas canvas = this.a;
        if (canvas == null) {
            AbstractC13042fc3.y("nativeCanvas");
            canvas = null;
        }
        return c10814cF0.a(canvas, path);
    }
    ...
    public boolean clipOutRect(RectF rectF) {
        ...
        return c10814cF0.e(canvas, rectF);
    }
    ...
    public void disableZ() {
        C15239jF0 c15239jF0 = C15239jF0.a;
        Canvas canvas = this.a;
        if (canvas == null) {
            AbstractC13042fc3.y("nativeCanvas");
            canvas = null;
    ...
    public void drawDoubleRoundRect(RectF rectF, float f, float f2, RectF rectF2, float f3, float f4, Paint paint) {
        ...
        c15239jF0.e(canvas, rectF, f, f2, rectF2, f3, f4, paint);
    }

    @Override // android.graphics.Canvas
    public void drawGlyphs(int[] iArr, int i, float[] fArr, int i2, int i3, Font font, Paint paint) {
        C19967rF0 c19967rF0 = C19967rF0.a;
        Canvas canvas = this.a;
        if (canvas == null) {
            AbstractC13042fc3.y("nativeCanvas");
            canvas = null;
        }
        c19967rF0.a(canvas, iArr, i, fArr, i2, i3, font, paint);
    }
    ...
    public void drawPatch(NinePatch ninePatch, Rect rect, Paint paint) {
        ...
        c19967rF0.b(canvas, ninePatch, rect, paint);
    }
    ...
    public void drawTextRun(char[] cArr, int i, int i2, int i3, int i4, float f, float f2, boolean z, Paint paint) {
        ...
        we0.b(canvas, cArr, i, i2, i3, i4, f, f2, z, paint);
    }
    ...
    public boolean clipOutRect(Rect rect) {
        ...
        return c10814cF0.d(canvas, rect);
    }
    ...
    public void drawPatch(NinePatch ninePatch, RectF rectF, Paint paint) {
        ...
        c19967rF0.c(canvas, ninePatch, rectF, paint);
    }
    ...
    public boolean quickReject(RectF rectF) {
        C17603nF0 c17603nF0 = C17603nF0.a;
        Canvas canvas = this.a;
        if (canvas == null) {
            AbstractC13042fc3.y("nativeCanvas");
            canvas = null;
        }
        return c17603nF0.c(canvas, rectF);
    }
    ...
    public boolean clipOutRect(float f, float f2, float f3, float f4) {
        ...
        return c10814cF0.b(canvas, f, f2, f3, f4);
    }
    ...
    public boolean clipOutRect(int i, int i2, int i3, int i4) {
        ...
        return c10814cF0.c(canvas, i, i2, i3, i4);
    }
    ...
    public void drawColor(int i, BlendMode blendMode) {
        ...
        c15239jF0.b(canvas, i, blendMode);
    }
    ...
    public void drawDoubleRoundRect(RectF rectF, float[] fArr, RectF rectF2, float[] fArr2, Paint paint) {
        ...
        c15239jF0.f(canvas, rectF, fArr, rectF2, fArr2, paint);
    }
    ...
    public void drawTextRun(CharSequence charSequence, int i, int i2, int i3, int i4, float f, float f2, boolean z, Paint paint) {
        ...
        we0.a(canvas, charSequence, i, i2, i3, i4, f, f2, z, paint);
    }
    ...
    public boolean quickReject(Path path) {
        ...
        return c17603nF0.b(canvas, path);
    }
    ...
    public void drawColor(long j, BlendMode blendMode) {
        ...
        c15239jF0.d(canvas, j, blendMode);
    }
    ...
    public boolean quickReject(float f, float f2, float f3, float f4) {
        ...
        return c17603nF0.a(canvas, f, f2, f3, f4);
    }
    ...
    public void drawTextRun(MeasuredText measuredText, int i, int i2, int i3, int i4, float f, float f2, boolean z, Paint paint) {
        ...
        c15239jF0.h(canvas, measuredText, i, i2, i3, i4, f, f2, z, paint);
    }
}
