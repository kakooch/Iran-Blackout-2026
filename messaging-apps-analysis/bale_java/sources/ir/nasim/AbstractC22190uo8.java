...
/* renamed from: ir.nasim.uo8, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public abstract class AbstractC22190uo8 {
    public static String a(AbstractC10561bo8 abstractC10561bo8) throws SecurityException, IllegalArgumentException {
        if (abstractC10561bo8 == null) {
            return "";
        }
        StringBuffer stringBuffer = new StringBuffer();
        try {
            b(null, abstractC10561bo8, new StringBuffer(), stringBuffer);
    ...
    private static void b(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, SecurityException, IllegalArgumentException {
        if (obj != null) {
            int i = 0;
            if (!(obj instanceof AbstractC10561bo8)) {
                String strC = c(str);
