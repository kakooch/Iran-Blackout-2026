...
@Metadata(d1 = {"\u0000\\\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0007\u0018\u0000 )2\u00020\u0001:\u0001*B\t\b\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bJ-\u0010\u0010\u001a\u0004\u0018\u00010\u000f2\u0006\u0010\n\u001a\u00020\t2\b\u0010\f\u001a\u0004\u0018\u00010\u000b2\b\u0010\u000e\u001a\u0004\u0018\u00010\rH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u000f\u0010\u0013\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0013\u0010\u0003J\u000f\u0010\u0014\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0014\u0010\u0003R\u0018\u0010\u0018\u001a\u0004\u0018\u00010\u00158\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017R\u0018\u0010\u001a\u001a\u0004\u0018\u00010\u00158\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0019\u0010\u0017R\u0018\u0010\u001c\u001a\u0004\u0018\u00010\u00158\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u0017R\u0018\u0010 \u001a\u0004\u0018\u00010\u001d8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001e\u0010\u001fR\u0018\u0010$\u001a\u0004\u0018\u00010!8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\"\u0010#R\u0018\u0010(\u001a\u0004\u0018\u00010%8\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b&\u0010'¨\u0006+"}, d2 = {"Lir/nasim/Ht3;", "Lir/nasim/ua0;", "<init>", "()V", "Landroid/content/Context;", "context", "Landroid/widget/FrameLayout;", "T9", "(Landroid/content/Context;)Landroid/widget/FrameLayout;", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "Landroid/os/Bundle;", "savedInstanceState", "Landroid/view/View;", "Q6", "(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;", "Lir/nasim/rB7;", "h7", "T6", "Landroid/widget/RadioButton;", "h1", "Landroid/widget/RadioButton;", "everyBody", "i1", "justContacts", "j1", "nobody", "Landroid/widget/RadioGroup;", "k1", "Landroid/widget/RadioGroup;", "radioGroup", "Landroid/widget/LinearLayout;", "l1", "Landroid/widget/LinearLayout;", "rootLayout", "Lir/nasim/core/modules/settings/SettingsModule;", "m1", "Lir/nasim/core/modules/settings/SettingsModule;", "settingsModule", "n1", "a", "nasim_release"}, k = 1, mv = {2, 0, 0})
/* renamed from: ir.nasim.Ht3, reason: case insensitive filesystem */
/* loaded from: classes6.dex */
public final class C5068Ht3 extends VW2 {
    ...
    /* renamed from: ir.nasim.Ht3$a, reason: from kotlin metadata */
    public static final class Companion {
        private Companion() {
        }

        public final C5068Ht3 a() {
            return new C5068Ht3();
        }
    ...
    public static final void U9(C5068Ht3 c5068Ht3, RadioGroup radioGroup, int i) {
        SettingsModule settingsModule;
        AbstractC13042fc3.i(c5068Ht3, "this$0");
        RadioButton radioButton = c5068Ht3.everyBody;
        if (radioButton != null && i == radioButton.getId()) {
            SettingsModule settingsModule2 = c5068Ht3.settingsModule;
            if (settingsModule2 != null) {
                settingsModule2.c7("always");
                return;
            }
            return;
        }
        RadioButton radioButton2 = c5068Ht3.justContacts;
        if (radioButton2 != null && i == radioButton2.getId()) {
            SettingsModule settingsModule3 = c5068Ht3.settingsModule;
            if (settingsModule3 != null) {
                settingsModule3.c7(ContactEntity.TABLE_NAME);
                return;
            }
            return;
        }
        RadioButton radioButton3 = c5068Ht3.nobody;
        if (radioButton3 == null || i != radioButton3.getId() || (settingsModule = c5068Ht3.settingsModule) == null) {
            return;
        }
        settingsModule.c7("none");
    }
    ...
    public View Q6(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String strH6 = h6(AbstractC12217eE5.lastseen_header);
        ...
        textView.setText(AbstractC12217eE5.lastseen_description);
    ...
    public void h7() {
        ...
        if (this.radioGroup != null) {
            ...
            if (radioButton != null) {
                ...
                radioButton.setChecked(AbstractC13042fc3.d(settingsModule != null ? settingsModule.L2() : null, "always"));
            }
            RadioButton radioButton2 = this.justContacts;
            if (radioButton2 != null) {
                SettingsModule settingsModule2 = this.settingsModule;
                radioButton2.setChecked(AbstractC13042fc3.d(settingsModule2 != null ? settingsModule2.L2() : null, ContactEntity.TABLE_NAME));
            }
            RadioButton radioButton3 = this.nobody;
            if (radioButton3 != null) {
                SettingsModule settingsModule3 = this.settingsModule;
                radioButton3.setChecked(AbstractC13042fc3.d(settingsModule3 != null ? settingsModule3.L2() : null, "none"));
            }
            RadioGroup radioGroup = this.radioGroup;
            if (radioGroup != null) {
                radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: ir.nasim.Gt3
                    @Override // android.widget.RadioGroup.OnCheckedChangeListener
                    public final void onCheckedChanged(RadioGroup radioGroup2, int i) {
                        C5068Ht3.U9(this.a, radioGroup2, i);
                    }
                });
            }
        }
