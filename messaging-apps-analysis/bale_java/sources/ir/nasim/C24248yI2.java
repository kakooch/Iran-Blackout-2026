...
/* renamed from: ir.nasim.yI2, reason: case insensitive filesystem */
/* loaded from: classes5.dex */
public final class C24248yI2 implements Z64 {
    private final Context a;
    private final int b;
    private final MessagingStruct$Message.b c;

    public C24248yI2(Context context, int i) {
        AbstractC13042fc3.i(context, "context");
        this.a = context;
        this.b = i;
        this.c = MessagingStruct$Message.b.GIFT_PACKET_MESSAGE;
    }

    private final DialogLastMessage.Text e(int i, MessageState messageState) {
        String string = this.a.getString(FD5.last_message_gift_packet);
