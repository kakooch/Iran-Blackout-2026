...
public final class C20405rx2 implements InterfaceC9764aW7 {
    ...
    public static C20405rx2 a(View view) {
        View viewA;
        int i = BC5.appbar_layout;
                                ...
                                if (nestedScrollView != null && (viewA = AbstractC11738dW7.a(view, (i = BC5.ok_button_shadow))) != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (baleToolbar != null) {
                                                return new C20405rx2((ConstraintLayout) view, appBarLayout, materialCardView, recyclerView, baleButton, textView, customInputView, nestedScrollView, viewA, textView2, textView3, baleToolbar);
                                            }
                                        }
                                    }
                                }
    ...
    public static C20405rx2 c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(AbstractC12208eD5.fragment_arbaeen_last_viewer, viewGroup, false);
        if (z) {
