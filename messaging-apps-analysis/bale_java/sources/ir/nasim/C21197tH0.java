...
@Metadata(d1 = {"\u0000\\\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0007\u0018\u0000 +2\u00020\u0001:\u0001,B\t\b\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bJ-\u0010\u0010\u001a\u0004\u0018\u00010\u000f2\u0006\u0010\n\u001a\u00020\t2\b\u0010\f\u001a\u0004\u0018\u00010\u000b2\b\u0010\u000e\u001a\u0004\u0018\u00010\rH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u000f\u0010\u0013\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0013\u0010\u0003J\u000f\u0010\u0014\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0014\u0010\u0003R\"\u0010\u001c\u001a\u00020\u00158\u0006@\u0006X\u0087.¢\u0006\u0012\n\u0004\b\u0016\u0010\u0017\u001a\u0004\b\u0018\u0010\u0019\"\u0004\b\u001a\u0010\u001bR\u0018\u0010 \u001a\u0004\u0018\u00010\u001d8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001e\u0010\u001fR\u0018\u0010\"\u001a\u0004\u0018\u00010\u001d8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b!\u0010\u001fR\u0018\u0010&\u001a\u0004\u0018\u00010#8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b$\u0010%R\u0018\u0010*\u001a\u0004\u0018\u00010'8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b(\u0010)¨\u0006-"}, d2 = {"Lir/nasim/tH0;", "Lir/nasim/ua0;", "<init>", "()V", "Landroid/content/Context;", "context", "Landroid/widget/FrameLayout;", "T9", "(Landroid/content/Context;)Landroid/widget/FrameLayout;", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "Landroid/os/Bundle;", "savedInstanceState", "Landroid/view/View;", "Q6", "(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;", "Lir/nasim/rB7;", "h7", "T6", "Lir/nasim/core/modules/settings/SettingsModule;", "h1", "Lir/nasim/core/modules/settings/SettingsModule;", "U9", "()Lir/nasim/core/modules/settings/SettingsModule;", "setSettingsModule", "(Lir/nasim/core/modules/settings/SettingsModule;)V", "settingsModule", "Landroid/widget/RadioButton;", "i1", "Landroid/widget/RadioButton;", "everyBody", "j1", "justContacts", "Landroid/widget/RadioGroup;", "k1", "Landroid/widget/RadioGroup;", "radioGroup", "Landroid/widget/LinearLayout;", "l1", "Landroid/widget/LinearLayout;", "rootLayout", "m1", "a", "nasim_release"}, k = 1, mv = {2, 0, 0})
/* renamed from: ir.nasim.tH0, reason: case insensitive filesystem */
/* loaded from: classes6.dex */
public final class C21197tH0 extends ZV2 {
    ...
    /* renamed from: ir.nasim.tH0$a, reason: from kotlin metadata */
    public static final class Companion {
        private Companion() {
        }

        public final C21197tH0 a() {
            return new C21197tH0();
        }
    ...
    public static final void V9(C21197tH0 c21197tH0, RadioGroup radioGroup, int i) {
        AbstractC13042fc3.i(c21197tH0, "this$0");
        RadioButton radioButton = c21197tH0.everyBody;
        if (radioButton != null && i == radioButton.getId()) {
            c21197tH0.U9().w6("always");
            return;
        }
        RadioButton radioButton2 = c21197tH0.justContacts;
        if (radioButton2 == null || i != radioButton2.getId()) {
            return;
        }
        c21197tH0.U9().w6(ContactEntity.TABLE_NAME);
    }
    ...
    public View Q6(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String strH6 = h6(AbstractC12217eE5.cardToCardPolicy_toolbar);
        ...
        textView.setText(AbstractC12217eE5.cardToCardPolicy_description);
    ...
    public void h7() {
        ...
        if (this.radioGroup != null) {
            ...
            if (radioButton != null) {
                radioButton.setChecked(AbstractC13042fc3.d(strD1, "always"));
            }
            RadioButton radioButton2 = this.justContacts;
            if (radioButton2 != null) {
                radioButton2.setChecked(AbstractC13042fc3.d(strD1, ContactEntity.TABLE_NAME));
            }
            RadioGroup radioGroup = this.radioGroup;
            if (radioGroup != null) {
                radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: ir.nasim.sH0
                    @Override // android.widget.RadioGroup.OnCheckedChangeListener
                    public final void onCheckedChanged(RadioGroup radioGroup2, int i) {
                        C21197tH0.V9(this.a, radioGroup2, i);
                    }
                });
            }
        }
