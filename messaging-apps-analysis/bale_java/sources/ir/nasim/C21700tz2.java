...
public final class C21700tz2 implements InterfaceC9764aW7 {
    ...
    private C21700tz2(ConstraintLayout constraintLayout, CustomInputView customInputView, MaterialCardView materialCardView, RecyclerView recyclerView, FullWidthButtonPrimary fullWidthButtonPrimary, CustomInputView customInputView2, TextView textView, TextView textView2, TextView textView3, View view, MaterialButton materialButton, TextView textView4, Guideline guideline, ConstraintLayout constraintLayout2, CustomInputView customInputView3, NestedScrollView nestedScrollView, CustomInputView customInputView4, MaterialCardView materialCardView2, TextView textView5, TextView textView6, CustomInputView customInputView5) {
    ...
    public static C21700tz2 a(View view) {
        View viewA;
                                                                        ...
                                                                        if (textView5 != null) {
                                                                            ...
                                                                            if (textView6 != null) {
                                                                                ...
                                                                                if (customInputView5 != null) {
                                                                                    return new C21700tz2((ConstraintLayout) view, customInputView, materialCardView, recyclerView, fullWidthButtonPrimary, customInputView2, textView, textView2, textView3, viewA, materialButton, textView4, guideline, constraintLayout, customInputView3, nestedScrollView, customInputView4, materialCardView2, textView5, textView6, customInputView5);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
    ...
    public static C21700tz2 c(LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    public static C21700tz2 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(AbstractC12208eD5.fragment_statement, viewGroup, false);
        if (z) {
