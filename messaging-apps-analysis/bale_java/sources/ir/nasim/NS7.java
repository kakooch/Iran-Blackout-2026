...
public final class NS7 extends YC2 {
        ...
        public final Object invokeSuspend(Object obj) throws IOException {
            ...
            try {
                ...
                do {
                    ...
                    if (string == null) {
                        C19406qI3.j("VideoDataSource", "MediaStore.Bucket_Display_Name with id(" + j + ") was null", new Object[0]);
                    }
    ...
    static final class g extends AbstractC19859r37 implements InterfaceC14603iB2 {
        ...
        @Override // ir.nasim.E90
        public final InterfaceC20295rm1 create(Object obj, InterfaceC20295rm1 interfaceC20295rm1) {
            return NS7.this.new g(this.d, interfaceC20295rm1);
        }
        ...
        public final Object invokeSuspend(Object obj) throws IOException {
            ...
            NS7 ns7 = NS7.this;
            Cursor cursorH = ns7.H(ns7.k, this.d);
            if (cursorH != null) {
                ...
                try {
                    ...
                    int columnIndex3 = cursor2.getColumnIndex(ns72.B());
                    int columnIndex4 = cursor2.getColumnIndex("duration");
                    Integer numD = Build.VERSION.SDK_INT > 28 ? AbstractC6392Nk0.d(cursor2.getColumnIndex("orientation")) : null;
                    ...
                    while (cursor2.moveToNext()) {
                        ...
                        if (str != null) {
                            ...
                            arrayList.add(new C9588aD2(i, str, AbstractC6392Nk0.e(j), cursor2.getLong(columnIndex3), numD != null ? cursor2.getInt(numD.intValue()) : 0, cursor2.getLong(columnIndex5)));
                        }
                    }
    ...
    public NS7(Context context, AbstractC13778go1 abstractC13778go1) {
        AbstractC13042fc3.i(context, "context");
        AbstractC13042fc3.i(abstractC13778go1, "ioDispatcher");
        this.k = context;
        this.l = abstractC13778go1;
        this.m = AbstractC13269fw3.a(new SA2() { // from class: ir.nasim.JS7
            @Override // ir.nasim.SA2
            public final Object invoke() {
                return NS7.D();
            }
        });
        this.n = AbstractC13269fw3.a(new SA2() { // from class: ir.nasim.KS7
            @Override // ir.nasim.SA2
            public final Object invoke() {
                return NS7.y();
            }
        });
        this.o = AbstractC13269fw3.a(new SA2() { // from class: ir.nasim.LS7
            @Override // ir.nasim.SA2
            public final Object invoke() {
                return NS7.J();
            }
        });
        this.p = AbstractC13269fw3.a(new SA2() { // from class: ir.nasim.MS7
            @Override // ir.nasim.SA2
            public final Object invoke() {
                return NS7.K(this.a);
            }
    ...
    public static final Uri D() {
        return Build.VERSION.SDK_INT >= 29 ? MediaStore.Video.Media.getContentUri("internal") : MediaStore.Video.Media.INTERNAL_CONTENT_URI;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final String[] K(NS7 ns7) {
        AbstractC13042fc3.i(ns7, "this$0");
        return (String[]) AbstractC10242bK.Y(new String[]{"_id", "_data", ns7.B(), "duration", Build.VERSION.SDK_INT > 28 ? "orientation" : null, "bucket_id"}).toArray(new String[0]);
    }
    ...
    */
    protected java.lang.Object k(ir.nasim.InterfaceC20295rm1 r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof ir.nasim.NS7.e
            if (r0 == 0) goto L13
            r0 = r6
            ir.nasim.NS7$e r0 = (ir.nasim.NS7.e) r0
            int r1 = r0.c
            ...
            goto L18
        L13:
            ir.nasim.NS7$e r0 = new ir.nasim.NS7$e
            r0.<init>(r6)
        L18:
        ...
        L31:
            ...
            android.database.Cursor r6 = r5.G(r6, r2)
            if (r6 == 0) goto L51
            r0.c = r3
        ...
        L58:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.nasim.NS7.k(ir.nasim.rm1):java.lang.Object");
    }
    ...
    */
    protected java.lang.Object l(ir.nasim.InterfaceC20295rm1 r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof ir.nasim.NS7.f
            if (r0 == 0) goto L13
            r0 = r6
            ir.nasim.NS7$f r0 = (ir.nasim.NS7.f) r0
            int r1 = r0.c
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r3 = r1 & r2
            if (r3 == 0) goto L13
            ...
            goto L18
        L13:
            ir.nasim.NS7$f r0 = new ir.nasim.NS7$f
            r0.<init>(r6)
        L18:
            java.lang.Object r6 = r0.a
            java.lang.Object r1 = ir.nasim.AbstractC13660gc3.e()
        ...
        L58:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.nasim.NS7.l(ir.nasim.rm1):java.lang.Object");
    }
