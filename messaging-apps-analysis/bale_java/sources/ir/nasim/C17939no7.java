...
/* renamed from: ir.nasim.no7, reason: case insensitive filesystem */
/* loaded from: classes7.dex */
public class C17939no7 {
    private Bitmap a;
    private int b;

    public C17939no7(Bitmap bitmap) {
        this.a = bitmap;
    }
    ...
    public static int c(SD6 sd6) {
        return b((int) sd6.a, (int) sd6.b);
    }
    ...
    public int d() {
        ...
        if (!this.a.isRecycled() && Build.VERSION.SDK_INT <= 28) {
