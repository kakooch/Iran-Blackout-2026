...
public final class C10291bP3 extends AbstractC16640ld0 {
    public static final a G = new a(null);
    public static final int H = 8;
    private InterfaceC20315ro1 A;
    private InterfaceC7857Tm2 B;
    private C9724aS3 D;
    private final C5410Jf3 v;
    private final C23731xQ3.b w;
    private final C12950fS3.b x;
    private final UA2 y;
    private final UA2 z;

    /* renamed from: ir.nasim.bP3$a */
    public static final class a {
        private a() {
        }

        private final void b(C5410Jf3 c5410Jf3) {
            c5410Jf3.l.setTypeface(C6011Lu2.k());
            c5410Jf3.g.setTypeface(C6011Lu2.i());
            c5410Jf3.h.setTypeface(C6011Lu2.k());
            c5410Jf3.i.setTypeface(C6011Lu2.k());
            c5410Jf3.d.setTypeface(C6011Lu2.i());
            if (C5495Jo7.a.J2()) {
                c5410Jf3.b.setElevation(0.0f);
            }
        }

        public final C10291bP3 a(ViewGroup viewGroup, C23731xQ3.b bVar, C12950fS3.b bVar2, UA2 ua2, UA2 ua22) {
            AbstractC13042fc3.i(viewGroup, "parent");
            AbstractC13042fc3.i(bVar2, "onLongItemClick");
            AbstractC13042fc3.i(ua2, "bindItem");
            AbstractC13042fc3.i(ua22, "unbindItem");
            C5410Jf3 c5410Jf3C = C5410Jf3.c(LayoutInflater.from(viewGroup.getContext()), viewGroup, false);
            AbstractC13042fc3.h(c5410Jf3C, "inflate(...)");
            b(c5410Jf3C);
            return new C10291bP3(c5410Jf3C, bVar, bVar2, ua2, ua22, null);
        }
    ...
    public static final class b implements InterfaceC8091Um2 {
        ...
        public void d(InterfaceC3346Am2 interfaceC3346Am2) {
            ...
            QI2 qi2 = QI2.a;
            ImageView imageView = C10291bP3.this.v.e;
            AbstractC13042fc3.h(imageView, "img");
            qi2.m(imageView, interfaceC3346Am2.getDescriptor());
            C10291bP3.this.v.e.setVisibility(0);
            C10291bP3.this.v.k.getRoot().setVisibility(8);
        }
    ...
    public /* synthetic */ C10291bP3(C5410Jf3 c5410Jf3, C23731xQ3.b bVar, C12950fS3.b bVar2, UA2 ua2, UA2 ua22, ED1 ed1) {
        this(c5410Jf3, bVar, bVar2, ua2, ua22);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean L0(C10291bP3 c10291bP3, MarketProductItem marketProductItem, View view) {
        AbstractC13042fc3.i(c10291bP3, "this$0");
        AbstractC13042fc3.i(marketProductItem, "$item");
        c10291bP3.x.x2(marketProductItem);
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void M0(C10291bP3 c10291bP3, MarketProductItem marketProductItem, MarketSection marketSection, View view) {
        AbstractC13042fc3.i(c10291bP3, "this$0");
        AbstractC13042fc3.i(marketProductItem, "$item");
        AbstractC13042fc3.i(marketSection, "$row");
        C23731xQ3.b bVar = c10291bP3.w;
        if (bVar != null) {
    ...
    */
    public final void J0(final ir.nasim.core.modules.market.model.MarketProductItem r5, final ir.nasim.core.modules.market.model.MarketSection r6) {
        ...
        Lf4:
            ...
            ir.nasim.aP3 r1 = new ir.nasim.aP3     // Catch: java.lang.Exception -> L56
        ...
        L106:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.nasim.C10291bP3.J0(ir.nasim.core.modules.market.model.MarketProductItem, ir.nasim.core.modules.market.model.MarketSection):void");
    }
    ...
    private C10291bP3(C5410Jf3 c5410Jf3, C23731xQ3.b bVar, C12950fS3.b bVar2, UA2 ua2, UA2 ua22) {
        ConstraintLayout root = c5410Jf3.getRoot();
