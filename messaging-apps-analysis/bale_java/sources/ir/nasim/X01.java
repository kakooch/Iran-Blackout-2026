...
public final class X01 {
    ...
    X01(Object obj, c cVar) {
        this.a = obj;
        this.b = cVar;
    }

    public static X01 c(Context context, Class cls) {
        return new X01(context, new b(cls));
    }
    ...
    public List b() {
        ...
        for (final String str : this.b.a(this.a)) {
            arrayList.add(new InterfaceC7959Tx5() { // from class: ir.nasim.W01
