...
public final class FullWidthButtonError extends AbsButton {
    ...
    public FullWidthButtonError(Context context, AttributeSet attributeSet) {
    ...
    public void i() {
        ...
        getBinding().e.setTextColor(c5495Jo7.B0());
        h(c5495Jo7.a0());
    }
