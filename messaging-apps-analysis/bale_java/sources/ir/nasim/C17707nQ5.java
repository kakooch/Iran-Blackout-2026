...
public class C17707nQ5 extends TP5 {
    private long a;
    private String b;
    private EnumC23601xC c;
    private EnumC6993Pw d;

    public static C17707nQ5 r(byte[] bArr) {
        return (C17707nQ5) AbstractC16720ll0.b(new C17707nQ5(), bArr);
    }
    ...
    public int q() {
        return SetRpcStruct$ComposedRpc.BUY_FAST_CHARGE_FIELD_NUMBER;
    }
