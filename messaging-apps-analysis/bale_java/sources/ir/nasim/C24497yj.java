...
public final class C24497yj extends AbstractC4482Fi {
    private final int a;
    private final int b;
    private final int c;
    private final c d;
    ...
    public static final class b {
        ...
        public C24497yj a() throws GeneralSecurityException {
            Integer num = this.a;
            if (num == null) {
            ...
            if (this.c != null) {
                return new C24497yj(num.intValue(), this.b.intValue(), this.c.intValue(), this.d);
            }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof C24497yj)) {
            return false;
        }
        C24497yj c24497yj = (C24497yj) obj;
        return c24497yj.d() == d() && c24497yj.c() == c() && c24497yj.e() == e() && c24497yj.f() == f();
    }
    ...
    public int hashCode() {
        return Objects.hash(C24497yj.class, Integer.valueOf(this.a), Integer.valueOf(this.b), Integer.valueOf(this.c), this.d);
    }
    ...
    private C24497yj(int i, int i2, int i3, c cVar) {
        this.a = i;
        this.b = i2;
        this.c = i3;
        this.d = cVar;
