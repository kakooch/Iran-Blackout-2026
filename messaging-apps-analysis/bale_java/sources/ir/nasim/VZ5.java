...
public class VZ5 extends AbstractC10365bX5 {
    private List b;
    private List c;
    private List d;
    private List e;
    ...
    public static VZ5 s(byte[] bArr) {
        return (VZ5) AbstractC16720ll0.b(new VZ5(), bArr);
    }
    ...
    public void parse(C19084pl0 c19084pl0) {
        ...
        this.d = c19084pl0.p(4, arrayList3);
        ArrayList arrayList4 = new ArrayList();
        for (int i4 = 0; i4 < c19084pl0.m(5); i4++) {
            arrayList4.add(new C23464wy());
        }
