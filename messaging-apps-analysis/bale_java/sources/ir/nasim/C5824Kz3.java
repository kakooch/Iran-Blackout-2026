...
/* renamed from: ir.nasim.Kz3, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
public class C5824Kz3 extends AbstractC6522Nw1 {
    private double[] a;
    private double[][] b;
    private double c;
    ...
    public C5824Kz3(double[] dArr, double[][] dArr2) {
        this.c = Double.NaN;
    ...
    */
    public double f(double r8, int r10) {
        ...
        L35:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.nasim.C5824Kz3.f(double, int):double");
    }
    ...
    */
    public void g(double r13, double[] r15) {
        ...
        L41:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ir.nasim.C5824Kz3.g(double, double[]):void");
    }
