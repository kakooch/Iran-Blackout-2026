...
/* renamed from: ir.nasim.tA0, reason: case insensitive filesystem */
/* loaded from: classes2.dex */
abstract class AbstractC21134tA0 {
    ...
    static int a(float f) {
        ...
        float[] fArr = c;
        return QY0.b(f5 * fArr[0], f3 * fArr[1], f4 * fArr[2]);
    }
    ...
    static void f(int i, float[] fArr) {
        float fE = e(Color.red(i));
        float fE2 = e(Color.green(i));
        float fE3 = e(Color.blue(i));
        float[][] fArr2 = d;
        float[] fArr3 = fArr2[0];
