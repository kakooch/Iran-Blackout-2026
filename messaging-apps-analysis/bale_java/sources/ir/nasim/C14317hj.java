...
public final class C14317hj extends AbstractC2358u implements T64 {
    private static final C14317hj DEFAULT_INSTANCE;
    ...
    public static final class b extends AbstractC2358u.a implements T64 {
        ...
        private b() {
            super(C14317hj.DEFAULT_INSTANCE);
        }
    }

    static {
        C14317hj c14317hj = new C14317hj();
        DEFAULT_INSTANCE = c14317hj;
        AbstractC2358u.N(C14317hj.class, c14317hj);
    }

    private C14317hj() {
    }

    public static C14317hj T() {
    ...
    protected final Object q(AbstractC2358u.d dVar, Object obj, Object obj2) {
        ...
        switch (a.a[dVar.ordinal()]) {
            ...
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC2358u.F(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"ivSize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                JW4 bVar = PARSER;
                if (bVar == null) {
                    synchronized (C14317hj.class) {
                        try {
                            bVar = PARSER;
                            if (bVar == null) {
