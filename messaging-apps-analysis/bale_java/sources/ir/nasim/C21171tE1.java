...
/* renamed from: ir.nasim.tE1, reason: case insensitive filesystem */
/* loaded from: classes5.dex */
public final class C21171tE1 implements Z64 {
    private final Context a;
    private final GI7 b;
    private final int c;
    private final MessagingStruct$Message.b d;

    public C21171tE1(Context context, GI7 gi7, int i) {
        AbstractC13042fc3.i(context, "context");
        AbstractC13042fc3.i(gi7, "userNamePlaceHolderManager");
        this.a = context;
        this.b = gi7;
        this.c = i;
        this.d = MessagingStruct$Message.b.TRAIT_NOT_SET;
    }

    private final DialogLastMessage.Text f(final int i, final ExPeerType exPeerType, final MessageState messageState) {
        return (DialogLastMessage.Text) this.b.b(new UA2() { // from class: ir.nasim.sE1
            @Override // ir.nasim.UA2
            public final Object invoke(Object obj) {
                return C21171tE1.g(this.a, i, exPeerType, messageState, (GI7.a) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final DialogLastMessage.Text g(C21171tE1 c21171tE1, int i, ExPeerType exPeerType, MessageState messageState, GI7.a aVar) {
        AbstractC13042fc3.i(c21171tE1, "this$0");
        ...
        String string = c21171tE1.a.getString(FD5.message_holder_content_template);
        AbstractC13042fc3.h(string, "getString(...)");
        return new DialogLastMessage.Text(string, (List) null, (EnumC22968w74) null, aVar.c(i, exPeerType), i == c21171tE1.c, i, messageState, aVar.b(), (MessagingStruct$ServiceEx.b) null, 262, (ED1) null);
    }
    ...
    public DialogLastMessage b(MessagingStruct$Message messagingStruct$Message, int i, ExPeerType exPeerType, MessageState messageState) {
        ...
        AbstractC13042fc3.i(messageState, "state");
        UO1.b.b(UO1.b.a, "Used Default message for", messagingStruct$Message.getTraitCase().name(), null, 4, null);
    ...
    public DialogLastMessage c(AbstractC17457n0 abstractC17457n0, int i, ExPeerType exPeerType, MessageState messageState) {
        ...
        AbstractC13042fc3.i(exPeerType, DialogEntity.COLUMN_EX_PEER_TYPE);
        AbstractC13042fc3.i(messageState, "state");
        UO1.b.b(UO1.b.a, "Used Default message for", null, abstractC17457n0.getClass().getSimpleName(), 2, null);
        return f(i, exPeerType, messageState);
    }
