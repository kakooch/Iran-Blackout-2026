...
/* renamed from: ir.nasim.gE6, reason: case insensitive filesystem */
/* loaded from: classes7.dex */
public class C13445gE6 {
    private RectF a;
    private File b;

    public C13445gE6(ByteBuffer byteBuffer, RectF rectF, HU1 hu1) throws IOException {
        this.a = rectF;
        try {
            this.b = File.createTempFile("paint", ".bin", AbstractC14047hG.a.getCacheDir());
        } catch (Exception e) {
