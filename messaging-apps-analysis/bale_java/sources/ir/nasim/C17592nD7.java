...
public final class C17592nD7 implements InterfaceC14123hO3 {
    private final C8655Wx a;

    public C17592nD7(C8655Wx c8655Wx) {
    ...
    public C17001mD7 a(MessagingOuterClass$UpdateDialogsMarkedAsUnread messagingOuterClass$UpdateDialogsMarkedAsUnread) {
        AbstractC13042fc3.i(messagingOuterClass$UpdateDialogsMarkedAsUnread, "input");
        List<PeersStruct$ExPeer> peersList = messagingOuterClass$UpdateDialogsMarkedAsUnread.getPeersList();
        ...
        return new C17001mD7(arrayList);
    }
}
