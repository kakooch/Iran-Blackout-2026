...
public final class RD4 implements CD4 {
    private final C11909dl1 a;

    public RD4(C11909dl1 c11909dl1) {
    ...
    public DD4 a(Context context, C9057Yh4 c9057Yh4, long j, ZN2 zn2, boolean z, String str) {
        ...
        C19150pr6 c19150pr6 = new C19150pr6(this.a);
        DD4 dd4 = new DD4(null, null, null, 7, null);
        dd4.f(c19150pr6.a(context, (int) j, null, zn2 == ZN2.GROUP));
        return dd4;
    }
}
