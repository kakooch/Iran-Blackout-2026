...
public class MZ5 extends AbstractC10365bX5 {
    private List b;
    private List c;
    private List d;
    private List e;
    ...
    public static MZ5 s(byte[] bArr) {
        return (MZ5) AbstractC16720ll0.b(new MZ5(), bArr);
    }
    ...
    public void parse(C19084pl0 c19084pl0) {
        ...
        this.e = c19084pl0.p(5, arrayList4);
        ArrayList arrayList5 = new ArrayList();
        for (int i5 = 0; i5 < c19084pl0.m(6); i5++) {
            arrayList5.add(new C25238zy());
        }
        this.f = c19084pl0.p(6, arrayList5);
        this.g = c19084pl0.v(4);
    }
