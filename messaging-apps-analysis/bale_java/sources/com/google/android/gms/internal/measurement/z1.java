...
abstract class z1 {
    ...
    public static void d(Object obj, long j, byte b2) {
        long j2 = (-4) & j;
        y1 y1Var = d;
        int iJ = y1Var.j(obj, j2);
        int i = ((~((int) j)) & 3) << 3;
        y1Var.n(obj, j2, ((255 & b2) << i) | (iJ & (~(255 << i))));
    }
    ...
    public static void e(Object obj, long j, byte b2) {
        ...
        y1 y1Var = d;
        int i = (((int) j) & 3) << 3;
        y1Var.n(obj, j2, ((255 & b2) << i) | (y1Var.j(obj, j2) & (~(255 << i))));
    }
    ...
    static /* bridge */ /* synthetic */ void m(Throwable th) {
        Logger.getLogger(z1.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
