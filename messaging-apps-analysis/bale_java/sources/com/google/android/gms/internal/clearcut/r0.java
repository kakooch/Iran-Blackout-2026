...
abstract class r0 {
                    ...
                    if (i4 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(cCharAt3, cCharAt4)) {
                                ...
                                int i5 = iPosition + 1;
                                try {
                                    byteBuffer.put(iPosition, (byte) ((codePoint >>> 18) | SetRpcStruct$ComposedRpc.RESPONSE_STICKERS_REPONSE_FIELD_NUMBER));
                                    i = iPosition + 2;
    ...
    final boolean e(byte[] bArr, int i, int i2) {
