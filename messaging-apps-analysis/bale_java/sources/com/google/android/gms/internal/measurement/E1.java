...
abstract class E1 {
    ...
    static String d(byte[] bArr, int i, int i2) throws zzkp {
        ...
        while (i < i3) {
            ...
            if (A1.d(b2)) {
                ...
                int i7 = i + 2;
                i += 3;
                A1.b(b2, bArr[i6], bArr[i7], cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw zzkp.c();
                ...
                int i9 = i + 3;
                i += 4;
                A1.a(b2, bArr[i6], bArr[i8], bArr[i9], cArr, i5);
                i5 += 2;
            }
        }
