...
abstract class AbstractC2174h0 {
    private static final Logger a = Logger.getLogger(zzii.class.getName());
    private static String b = "com.google.protobuf.BlazeGeneratedExtensionRegistryLiteLoader";

    static C2162b0 a(Class cls) {
        String str;
        ClassLoader classLoader = AbstractC2174h0.class.getClassLoader();
        if (cls.equals(C2162b0.class)) {
            str = b;
        } else {
            if (!cls.getPackage().equals(AbstractC2174h0.class.getPackage())) {
        ...
        try {
            ...
            Iterator it = ServiceLoader.load(AbstractC2174h0.class, classLoader).iterator();
            ...
            if (arrayList.size() == 1) {
                return (C2162b0) arrayList.get(0);
            }
            if (arrayList.size() == 0) {
                return null;
            }
            try {
                return (C2162b0) cls.getMethod("combine", Collection.class).invoke(null, arrayList);
