...
public final class zzft extends zzbs {
    ...
    protected final void zzd() throws PackageManager.NameNotFoundException {
        ...
        zzbv zzbvVarZzt = zzt();
        zzew zzewVar = (zzew) new zzcs(zzbvVarZzt, new zzev(zzbvVarZzt)).zza(i);
        if (zzewVar != null) {
            ...
            if (str3 != null) {
                ...
                int i2 = "verbose".equals(lowerCase) ? 0 : ParameterNames.INFO.equals(lowerCase) ? 1 : "warning".equals(lowerCase) ? 2 : "error".equals(lowerCase) ? 3 : -1;
                if (i2 >= 0) {
