...
abstract class e0 {
        ...
        */
        int d(int r7, byte[] r8, int r9, int r10) {
            ...
            L1c:
                ...
                r9 = r8[r9]
                if (r7 < r10) goto L31
                int r7 = com.google.crypto.tink.shaded.protobuf.e0.a(r0, r9)
                return r7
            L31:
                r5 = r9
                r9 = r7
            ...
            L49:
                ...
                r1 = r8[r9]
                if (r7 < r10) goto L5a
                int r7 = com.google.crypto.tink.shaded.protobuf.e0.a(r0, r1)
                return r7
            L5a:
                r9 = 0
                goto L62
            ...
            L62:
                ...
                r7 = r8[r7]
                if (r9 < r10) goto L6f
                int r7 = com.google.crypto.tink.shaded.protobuf.e0.b(r0, r1, r7)
                return r7
            L6f:
                r5 = r9
                r9 = r7
            ...
            L86:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.e0.c.d(int, byte[], int, int):int");
        }
    }
    ...
    static final class e extends b {
        ...
        */
        private static int f(byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = com.google.crypto.tink.shaded.protobuf.d0.u(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = com.google.crypto.tink.shaded.protobuf.d0.u(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = com.google.crypto.tink.shaded.protobuf.d0.u(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = com.google.crypto.tink.shaded.protobuf.d0.u(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = com.google.crypto.tink.shaded.protobuf.d0.u(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.e0.e.f(byte[], long, int):int");
        }
        ...
        private static int g(byte[] bArr, long j, int i) {
            ...
            while (true) {
                int i4 = i2 + 8;
                if (i4 > i || (d0.A(bArr, d0.h + j) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j += 8;
                i2 = i4;
        ...
        private static int h(byte[] bArr, int i, long j, int i2) {
            ...
            if (i2 == 1) {
                return e0.j(i, d0.u(bArr, j));
            }
            if (i2 == 2) {
                return e0.k(i, d0.u(bArr, j), d0.u(bArr, j + 1));
            }
        ...
        @Override // com.google.crypto.tink.shaded.protobuf.e0.b
        String a(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            Charset charset = AbstractC2360w.b;
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 >= 128 || j4 >= j5) {
                    if (cCharAt2 >= 2048 || j4 > j5 - 2) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j4 > j5 - 3) {
                            ...
                            if (i5 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    j2 = 1;
                                    d0.K(bArr, j4, (byte) ((codePoint >>> 18) | SetRpcStruct$ComposedRpc.RESPONSE_STICKERS_REPONSE_FIELD_NUMBER));
                                    j3 = j5;
                                    d0.K(bArr, j4 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j6 = j4 + 3;
                                    d0.K(bArr, j4 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j4 += 4;
                                    d0.K(bArr, j6, (byte) ((codePoint & 63) | 128));
                                    i4 = i5;
                                } else {
                                    i4 = i5;
                                }
                        ...
                        d0.K(bArr, j4, (byte) ((cCharAt2 >>> '\f') | 480));
                        long j7 = j4 + 2;
                        d0.K(bArr, j4 + 1, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        j4 += 3;
                        d0.K(bArr, j7, (byte) ((cCharAt2 & '?') | 128));
                    } else {
                        str = str3;
                        str2 = str4;
                        long j8 = j4 + j;
                        d0.K(bArr, j4, (byte) ((cCharAt2 >>> 6) | 960));
                        j4 += 2;
                        d0.K(bArr, j8, (byte) ((cCharAt2 & '?') | 128));
                    }
                    j3 = j5;
                    j2 = 1;
                } else {
                    d0.K(bArr, j4, (byte) cCharAt2);
                    j3 = j5;
                    str2 = str4;
                    j2 = j;
                    j4 += j;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            ...
            if (com.google.crypto.tink.shaded.protobuf.d0.u(r12, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
        
            if (com.google.crypto.tink.shaded.protobuf.d0.u(r12, r0) > (-65)) goto L59;
         */
        @Override // com.google.crypto.tink.shaded.protobuf.e0.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int d(int r11, byte[] r12, int r13, int r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.e0.e.d(int, byte[], int, int):int");
        }
    }

    static {
        a = (!e.e() || AbstractC2342d.c()) ? new c() : new e();
    }
    ...
    static boolean n(byte[] bArr, int i, int i2) {
