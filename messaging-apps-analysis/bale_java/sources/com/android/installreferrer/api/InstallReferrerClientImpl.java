...
class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    private final class InstallReferrerServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            V93.a(InstallReferrerClientImpl.TAG, "Install Referrer service connected.");
            InstallReferrerClientImpl.this.service = MZ2.a.B2(iBinder);
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            V93.b(InstallReferrerClientImpl.TAG, "Install Referrer service disconnected.");
    ...
    public void endConnection() {
        ...
        if (this.serviceConnection != null) {
            V93.a(TAG, "Unbinding from service.");
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        ...
        try {
            return new ReferrerDetails(this.service.e0(bundle));
        } catch (RemoteException e) {
            V93.b(TAG, "RemoteException getting install referrer information");
            this.clientState = 0;
            throw e;
        }
    }
    ...
    public void startConnection(InstallReferrerStateListener installReferrerStateListener) {
        ...
        if (isReady()) {
            V93.a(TAG, "Service connection is valid. No need to re-initialize.");
            installReferrerStateListener.onInstallReferrerSetupFinished(0);
            return;
        }
        int i = this.clientState;
        if (i == 1) {
            V93.b(TAG, "Client is already in the process of connecting to the service.");
            installReferrerStateListener.onInstallReferrerSetupFinished(3);
            return;
        }
        if (i == 3) {
            V93.b(TAG, "Client was already closed and can't be reused. Please create another instance.");
            installReferrerStateListener.onInstallReferrerSetupFinished(3);
            return;
        }
        V93.a(TAG, "Starting install referrer service setup.");
        ...
        if (listQueryIntentServices == null || listQueryIntentServices.isEmpty() || (serviceInfo = listQueryIntentServices.get(0).serviceInfo) == null) {
            this.clientState = 0;
            V93.a(TAG, "Install Referrer service unavailable on device.");
        ...
        if (!SERVICE_PACKAGE_NAME.equals(str) || str2 == null || !isPlayStoreCompatible()) {
            V93.b(TAG, "Play Store missing or incompatible. Version 8.3.73 or later required.");
            this.clientState = 0;
            installReferrerStateListener.onInstallReferrerSetupFinished(2);
            return;
        }
        ...
        try {
            if (this.mApplicationContext.bindService(intent2, installReferrerServiceConnection, 1)) {
                V93.a(TAG, "Service was bonded successfully.");
                return;
            }
            V93.b(TAG, "Connection to service is blocked.");
            this.clientState = 0;
            installReferrerStateListener.onInstallReferrerSetupFinished(1);
        } catch (SecurityException unused) {
            V93.b(TAG, "No permission to connect to service.");
            this.clientState = 0;
