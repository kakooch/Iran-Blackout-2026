...
public final class Validate$Int64Rules extends GeneratedMessageLite implements U64 {
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        private a() {
            super(Validate$Int64Rules.DEFAULT_INSTANCE);
        }
    }
    ...
    public static Validate$Int64Rules parseDelimitedFrom(InputStream inputStream) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Validate$Int64Rules parseFrom(ByteBuffer byteBuffer) {
    ...
    public static a newBuilder(Validate$Int64Rules validate$Int64Rules) {
        return (a) DEFAULT_INSTANCE.createBuilder(validate$Int64Rules);
    }

    public static Validate$Int64Rules parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static Validate$Int64Rules parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static Validate$Int64Rules parseFrom(AbstractC2383g abstractC2383g) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static Validate$Int64Rules parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static Validate$Int64Rules parseFrom(byte[] bArr) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static Validate$Int64Rules parseFrom(byte[] bArr, C2394s c2394s) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static Validate$Int64Rules parseFrom(InputStream inputStream) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Validate$Int64Rules parseFrom(InputStream inputStream, C2394s c2394s) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static Validate$Int64Rules parseFrom(AbstractC2384h abstractC2384h) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static Validate$Int64Rules parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (Validate$Int64Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
