...
public final class Validate$Fixed32Rules extends GeneratedMessageLite implements U64 {
    ...
    public static Validate$Fixed32Rules parseDelimitedFrom(InputStream inputStream) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Validate$Fixed32Rules parseFrom(ByteBuffer byteBuffer) {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (io.envoyproxy.pgv.validate.a.a[gVar.ordinal()]) {
            ...
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0001\b\u0000\u0001\u0001\b\b\u0000\u0002\u0000\u0001ဆ\u0000\u0002ဆ\u0001\u0003ဆ\u0002\u0004ဆ\u0003\u0005ဆ\u0004\u0006\u0018\u0007\u0018\bဇ\u0005", new Object[]{"bitField0_", "const_", "lt_", "lte_", "gt_", "gte_", "in_", "notIn_", "ignoreEmpty_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
    ...
    public static a newBuilder(Validate$Fixed32Rules validate$Fixed32Rules) {
        return (a) DEFAULT_INSTANCE.createBuilder(validate$Fixed32Rules);
    }

    public static Validate$Fixed32Rules parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static Validate$Fixed32Rules parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static Validate$Fixed32Rules parseFrom(AbstractC2383g abstractC2383g) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static Validate$Fixed32Rules parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static Validate$Fixed32Rules parseFrom(byte[] bArr) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static Validate$Fixed32Rules parseFrom(byte[] bArr, C2394s c2394s) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static Validate$Fixed32Rules parseFrom(InputStream inputStream) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Validate$Fixed32Rules parseFrom(InputStream inputStream, C2394s c2394s) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static Validate$Fixed32Rules parseFrom(AbstractC2384h abstractC2384h) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static Validate$Fixed32Rules parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (Validate$Fixed32Rules) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
