...
public final class V8 extends MessageNano {
    ...
    public final V8 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) {
        while (true) {
    ...
    public static V8 b(CodedInputByteBufferNano codedInputByteBufferNano) {
        return new V8().mergeFrom(codedInputByteBufferNano);
    }

    public static V8 a(byte[] bArr) {
