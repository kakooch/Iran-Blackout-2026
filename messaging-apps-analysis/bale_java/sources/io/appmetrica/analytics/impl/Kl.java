...
public final class Kl extends Rl {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Ye("startup_state", iBinaryDataHelper, new C2894u8(c3003yl, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrA, bArrA2)), new C2573gl());
    }
