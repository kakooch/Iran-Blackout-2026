...
public final class AdvertisementStruct$UserAuthData extends GeneratedMessageLite implements InterfaceC5190Ih {
    public static final int ADDRESS_FIELD_NUMBER = 4;
    public static final int BIRTH_DATE_FIELD_NUMBER = 3;
    public static final int CHANNEL_NICK_FIELD_NUMBER = 12;
    private static final AdvertisementStruct$UserAuthData DEFAULT_INSTANCE;
    ...
    public static final class a extends GeneratedMessageLite.b implements InterfaceC5190Ih {
        private a() {
            super(AdvertisementStruct$UserAuthData.DEFAULT_INSTANCE);
        }
    }

    static {
        AdvertisementStruct$UserAuthData advertisementStruct$UserAuthData = new AdvertisementStruct$UserAuthData();
        DEFAULT_INSTANCE = advertisementStruct$UserAuthData;
        GeneratedMessageLite.registerDefaultInstance(AdvertisementStruct$UserAuthData.class, advertisementStruct$UserAuthData);
    }

    private AdvertisementStruct$UserAuthData() {
    }
    ...
    public static AdvertisementStruct$UserAuthData getDefaultInstance() {
    ...
    public static AdvertisementStruct$UserAuthData parseDelimitedFrom(InputStream inputStream) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(ByteBuffer byteBuffer) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (AbstractC1843c.a[gVar.ordinal()]) {
            case 1:
                return new AdvertisementStruct$UserAuthData();
            case 2:
                return new a();
            case 3:
            ...
            case 5:
                KW4 cVar = PARSER;
                if (cVar == null) {
                    synchronized (AdvertisementStruct$UserAuthData.class) {
                        try {
                            cVar = PARSER;
                            if (cVar == null) {
    ...
    public static a newBuilder(AdvertisementStruct$UserAuthData advertisementStruct$UserAuthData) {
        return (a) DEFAULT_INSTANCE.createBuilder(advertisementStruct$UserAuthData);
    }

    public static AdvertisementStruct$UserAuthData parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(AbstractC2383g abstractC2383g) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(byte[] bArr) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(byte[] bArr, C2394s c2394s) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(InputStream inputStream) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(InputStream inputStream, C2394s c2394s) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(AbstractC2384h abstractC2384h) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static AdvertisementStruct$UserAuthData parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (AdvertisementStruct$UserAuthData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
