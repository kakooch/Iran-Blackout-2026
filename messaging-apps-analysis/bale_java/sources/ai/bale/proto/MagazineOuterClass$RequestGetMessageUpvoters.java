...
public final class MagazineOuterClass$RequestGetMessageUpvoters extends GeneratedMessageLite implements U64 {
    ...
    public static MagazineOuterClass$RequestGetMessageUpvoters parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MagazineOuterClass$RequestGetMessageUpvoters parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static MagazineOuterClass$RequestGetMessageUpvoters parseFrom(AbstractC2383g abstractC2383g) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static MagazineOuterClass$RequestGetMessageUpvoters parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static MagazineOuterClass$RequestGetMessageUpvoters parseFrom(byte[] bArr, C2394s c2394s) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static MagazineOuterClass$RequestGetMessageUpvoters parseFrom(InputStream inputStream, C2394s c2394s) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MagazineOuterClass$RequestGetMessageUpvoters parseFrom(AbstractC2384h abstractC2384h) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static MagazineOuterClass$RequestGetMessageUpvoters parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (MagazineOuterClass$RequestGetMessageUpvoters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
