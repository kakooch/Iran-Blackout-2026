...
public final class DakeOuterClass$ResponseGetNewsCoverage extends GeneratedMessageLite implements U64 {
    ...
    public static a newBuilder(DakeOuterClass$ResponseGetNewsCoverage dakeOuterClass$ResponseGetNewsCoverage) {
        return (a) DEFAULT_INSTANCE.createBuilder(dakeOuterClass$ResponseGetNewsCoverage);
    }

    public static DakeOuterClass$ResponseGetNewsCoverage parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static DakeOuterClass$ResponseGetNewsCoverage parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static DakeOuterClass$ResponseGetNewsCoverage parseFrom(AbstractC2383g abstractC2383g) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static DakeOuterClass$ResponseGetNewsCoverage parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static DakeOuterClass$ResponseGetNewsCoverage parseFrom(byte[] bArr, C2394s c2394s) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static DakeOuterClass$ResponseGetNewsCoverage parseFrom(InputStream inputStream, C2394s c2394s) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static DakeOuterClass$ResponseGetNewsCoverage parseFrom(AbstractC2384h abstractC2384h) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static DakeOuterClass$ResponseGetNewsCoverage parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (DakeOuterClass$ResponseGetNewsCoverage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
