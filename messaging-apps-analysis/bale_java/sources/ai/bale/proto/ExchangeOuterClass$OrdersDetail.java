...
public final class ExchangeOuterClass$OrdersDetail extends GeneratedMessageLite implements InterfaceC17814nc2 {
    ...
    private static final ExchangeOuterClass$OrdersDetail DEFAULT_INSTANCE;
    ...
    public static final class a extends GeneratedMessageLite.b implements InterfaceC17814nc2 {
        private a() {
            super(ExchangeOuterClass$OrdersDetail.DEFAULT_INSTANCE);
        }
    }

    static {
        ExchangeOuterClass$OrdersDetail exchangeOuterClass$OrdersDetail = new ExchangeOuterClass$OrdersDetail();
        DEFAULT_INSTANCE = exchangeOuterClass$OrdersDetail;
        GeneratedMessageLite.registerDefaultInstance(ExchangeOuterClass$OrdersDetail.class, exchangeOuterClass$OrdersDetail);
    }

    private ExchangeOuterClass$OrdersDetail() {
    }
    ...
    public static ExchangeOuterClass$OrdersDetail getDefaultInstance() {
    ...
    public static ExchangeOuterClass$OrdersDetail parseDelimitedFrom(InputStream inputStream) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(ByteBuffer byteBuffer) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    private void setStatus(EnumC5148Ic2 enumC5148Ic2) {
        this.status_ = enumC5148Ic2.getNumber();
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (U.a[gVar.ordinal()]) {
            case 1:
                return new ExchangeOuterClass$OrdersDetail();
            case 2:
                return new a();
            case 3:
            ...
            case 5:
                KW4 cVar = PARSER;
                if (cVar == null) {
                    synchronized (ExchangeOuterClass$OrdersDetail.class) {
                        try {
                            cVar = PARSER;
                            if (cVar == null) {
    ...
    public EnumC5148Ic2 getStatus() {
        EnumC5148Ic2 enumC5148Ic2J = EnumC5148Ic2.j(this.status_);
        return enumC5148Ic2J == null ? EnumC5148Ic2.UNRECOGNIZED : enumC5148Ic2J;
    }
    ...
    public static a newBuilder(ExchangeOuterClass$OrdersDetail exchangeOuterClass$OrdersDetail) {
        return (a) DEFAULT_INSTANCE.createBuilder(exchangeOuterClass$OrdersDetail);
    }

    public static ExchangeOuterClass$OrdersDetail parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(AbstractC2383g abstractC2383g) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(byte[] bArr) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(byte[] bArr, C2394s c2394s) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(InputStream inputStream) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(InputStream inputStream, C2394s c2394s) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(AbstractC2384h abstractC2384h) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static ExchangeOuterClass$OrdersDetail parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (ExchangeOuterClass$OrdersDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
