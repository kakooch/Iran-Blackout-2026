...
public final class AuthOuterClass$ResponseSendChangePhoneVerificationCode extends GeneratedMessageLite implements U64 {
    ...
    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseFrom(AbstractC2383g abstractC2383g) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseFrom(byte[] bArr, C2394s c2394s) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseFrom(InputStream inputStream, C2394s c2394s) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseFrom(AbstractC2384h abstractC2384h) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static AuthOuterClass$ResponseSendChangePhoneVerificationCode parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (AuthOuterClass$ResponseSendChangePhoneVerificationCode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
