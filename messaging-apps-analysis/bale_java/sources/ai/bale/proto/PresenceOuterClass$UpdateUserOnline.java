...
public final class PresenceOuterClass$UpdateUserOnline extends GeneratedMessageLite implements U64 {
    ...
    public static a newBuilder(PresenceOuterClass$UpdateUserOnline presenceOuterClass$UpdateUserOnline) {
        return (a) DEFAULT_INSTANCE.createBuilder(presenceOuterClass$UpdateUserOnline);
    }

    public static PresenceOuterClass$UpdateUserOnline parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static PresenceOuterClass$UpdateUserOnline parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static PresenceOuterClass$UpdateUserOnline parseFrom(AbstractC2383g abstractC2383g) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static PresenceOuterClass$UpdateUserOnline parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static PresenceOuterClass$UpdateUserOnline parseFrom(byte[] bArr, C2394s c2394s) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static PresenceOuterClass$UpdateUserOnline parseFrom(InputStream inputStream, C2394s c2394s) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static PresenceOuterClass$UpdateUserOnline parseFrom(AbstractC2384h abstractC2384h) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static PresenceOuterClass$UpdateUserOnline parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (PresenceOuterClass$UpdateUserOnline) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
