...
public final class StoryStruct$ChannelStory extends GeneratedMessageLite implements InterfaceC16562lU6 {
    public static final int CREATED_AT_FIELD_NUMBER = 4;
    private static final StoryStruct$ChannelStory DEFAULT_INSTANCE;
    ...
    public static final class a extends GeneratedMessageLite.b implements InterfaceC16562lU6 {
        private a() {
            super(StoryStruct$ChannelStory.DEFAULT_INSTANCE);
        }
    }

    static {
        StoryStruct$ChannelStory storyStruct$ChannelStory = new StoryStruct$ChannelStory();
        DEFAULT_INSTANCE = storyStruct$ChannelStory;
        GeneratedMessageLite.registerDefaultInstance(StoryStruct$ChannelStory.class, storyStruct$ChannelStory);
    }

    private StoryStruct$ChannelStory() {
    }
    ...
    public static StoryStruct$ChannelStory getDefaultInstance() {
    ...
    public static StoryStruct$ChannelStory parseDelimitedFrom(InputStream inputStream) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static StoryStruct$ChannelStory parseFrom(ByteBuffer byteBuffer) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (d2.a[gVar.ordinal()]) {
            case 1:
                return new StoryStruct$ChannelStory();
            case 2:
                return new a();
            case 3:
            ...
            case 5:
                KW4 cVar = PARSER;
                if (cVar == null) {
                    synchronized (StoryStruct$ChannelStory.class) {
                        try {
                            cVar = PARSER;
                            if (cVar == null) {
    ...
    public static a newBuilder(StoryStruct$ChannelStory storyStruct$ChannelStory) {
        return (a) DEFAULT_INSTANCE.createBuilder(storyStruct$ChannelStory);
    }

    public static StoryStruct$ChannelStory parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static StoryStruct$ChannelStory parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static StoryStruct$ChannelStory parseFrom(AbstractC2383g abstractC2383g) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static StoryStruct$ChannelStory parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static StoryStruct$ChannelStory parseFrom(byte[] bArr) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static StoryStruct$ChannelStory parseFrom(byte[] bArr, C2394s c2394s) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static StoryStruct$ChannelStory parseFrom(InputStream inputStream) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static StoryStruct$ChannelStory parseFrom(InputStream inputStream, C2394s c2394s) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static StoryStruct$ChannelStory parseFrom(AbstractC2384h abstractC2384h) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static StoryStruct$ChannelStory parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (StoryStruct$ChannelStory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
