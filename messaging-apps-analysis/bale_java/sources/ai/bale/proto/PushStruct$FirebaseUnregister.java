...
public final class PushStruct$FirebaseUnregister extends GeneratedMessageLite implements U64 {
    ...
    public static PushStruct$FirebaseUnregister parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static PushStruct$FirebaseUnregister parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static PushStruct$FirebaseUnregister parseFrom(AbstractC2383g abstractC2383g) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static PushStruct$FirebaseUnregister parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static PushStruct$FirebaseUnregister parseFrom(byte[] bArr, C2394s c2394s) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static PushStruct$FirebaseUnregister parseFrom(InputStream inputStream, C2394s c2394s) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static PushStruct$FirebaseUnregister parseFrom(AbstractC2384h abstractC2384h) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static PushStruct$FirebaseUnregister parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (PushStruct$FirebaseUnregister) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
