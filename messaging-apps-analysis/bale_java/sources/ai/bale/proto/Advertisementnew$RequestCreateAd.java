...
public final class Advertisementnew$RequestCreateAd extends GeneratedMessageLite implements U64 {
    ...
    public static Advertisementnew$RequestCreateAd parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static Advertisementnew$RequestCreateAd parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static Advertisementnew$RequestCreateAd parseFrom(AbstractC2383g abstractC2383g) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static Advertisementnew$RequestCreateAd parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static Advertisementnew$RequestCreateAd parseFrom(byte[] bArr, C2394s c2394s) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static Advertisementnew$RequestCreateAd parseFrom(InputStream inputStream, C2394s c2394s) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static Advertisementnew$RequestCreateAd parseFrom(AbstractC2384h abstractC2384h) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static Advertisementnew$RequestCreateAd parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (Advertisementnew$RequestCreateAd) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
