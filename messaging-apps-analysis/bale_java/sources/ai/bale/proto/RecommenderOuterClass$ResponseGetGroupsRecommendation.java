...
public final class RecommenderOuterClass$ResponseGetGroupsRecommendation extends GeneratedMessageLite implements U64 {
    ...
    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseFrom(AbstractC2383g abstractC2383g) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseFrom(byte[] bArr, C2394s c2394s) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseFrom(InputStream inputStream, C2394s c2394s) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseFrom(AbstractC2384h abstractC2384h) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static RecommenderOuterClass$ResponseGetGroupsRecommendation parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (RecommenderOuterClass$ResponseGetGroupsRecommendation) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
