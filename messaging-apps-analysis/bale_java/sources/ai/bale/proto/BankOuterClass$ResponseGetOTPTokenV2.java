...
public final class BankOuterClass$ResponseGetOTPTokenV2 extends GeneratedMessageLite implements U64 {
    ...
    public static a newBuilder(BankOuterClass$ResponseGetOTPTokenV2 bankOuterClass$ResponseGetOTPTokenV2) {
        return (a) DEFAULT_INSTANCE.createBuilder(bankOuterClass$ResponseGetOTPTokenV2);
    }

    public static BankOuterClass$ResponseGetOTPTokenV2 parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static BankOuterClass$ResponseGetOTPTokenV2 parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static BankOuterClass$ResponseGetOTPTokenV2 parseFrom(AbstractC2383g abstractC2383g) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static BankOuterClass$ResponseGetOTPTokenV2 parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static BankOuterClass$ResponseGetOTPTokenV2 parseFrom(byte[] bArr, C2394s c2394s) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static BankOuterClass$ResponseGetOTPTokenV2 parseFrom(InputStream inputStream, C2394s c2394s) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static BankOuterClass$ResponseGetOTPTokenV2 parseFrom(AbstractC2384h abstractC2384h) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static BankOuterClass$ResponseGetOTPTokenV2 parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (BankOuterClass$ResponseGetOTPTokenV2) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
