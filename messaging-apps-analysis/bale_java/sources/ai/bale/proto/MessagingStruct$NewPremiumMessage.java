...
public final class MessagingStruct$NewPremiumMessage extends GeneratedMessageLite implements U64 {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (L0.a[gVar.ordinal()]) {
            ...
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0005\u0000\u0001\u0001\u0005\u0005\u0000\u0000\u0000\u0001\u0002\u0002Ȉ\u0003ဉ\u0000\u0004ဉ\u0001\u0005\u0004", new Object[]{"bitField0_", "amount_", "targetWalletId_", "originalMessage_", "preview_", "minimumRequiredDrmLevel_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
    ...
    public static a newBuilder(MessagingStruct$NewPremiumMessage messagingStruct$NewPremiumMessage) {
        return (a) DEFAULT_INSTANCE.createBuilder(messagingStruct$NewPremiumMessage);
    }

    public static MessagingStruct$NewPremiumMessage parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MessagingStruct$NewPremiumMessage parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static MessagingStruct$NewPremiumMessage parseFrom(AbstractC2383g abstractC2383g) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static MessagingStruct$NewPremiumMessage parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static MessagingStruct$NewPremiumMessage parseFrom(byte[] bArr, C2394s c2394s) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static MessagingStruct$NewPremiumMessage parseFrom(InputStream inputStream, C2394s c2394s) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MessagingStruct$NewPremiumMessage parseFrom(AbstractC2384h abstractC2384h) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static MessagingStruct$NewPremiumMessage parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (MessagingStruct$NewPremiumMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
