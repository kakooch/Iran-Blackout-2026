...
public final class ImagesOuterClass$RequestAddStickerCollection extends GeneratedMessageLite implements U64 {
    ...
    public static ImagesOuterClass$RequestAddStickerCollection parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ImagesOuterClass$RequestAddStickerCollection parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static ImagesOuterClass$RequestAddStickerCollection parseFrom(AbstractC2383g abstractC2383g) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static ImagesOuterClass$RequestAddStickerCollection parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static ImagesOuterClass$RequestAddStickerCollection parseFrom(byte[] bArr, C2394s c2394s) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static ImagesOuterClass$RequestAddStickerCollection parseFrom(InputStream inputStream, C2394s c2394s) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ImagesOuterClass$RequestAddStickerCollection parseFrom(AbstractC2384h abstractC2384h) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static ImagesOuterClass$RequestAddStickerCollection parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (ImagesOuterClass$RequestAddStickerCollection) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
