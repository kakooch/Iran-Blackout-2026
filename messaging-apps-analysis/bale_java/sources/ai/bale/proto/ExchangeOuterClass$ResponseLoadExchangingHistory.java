...
public final class ExchangeOuterClass$ResponseLoadExchangingHistory extends GeneratedMessageLite implements U64 {
    ...
    private void setOrders(int i, ExchangeStruct$ExchangeHistoryItem exchangeStruct$ExchangeHistoryItem) {
        exchangeStruct$ExchangeHistoryItem.getClass();
        ensureOrdersIsMutable();
        this.orders_.set(i, exchangeStruct$ExchangeHistoryItem);
    }
    ...
    public ExchangeStruct$ExchangeHistoryItem getOrders(int i) {
        return (ExchangeStruct$ExchangeHistoryItem) this.orders_.get(i);
    }
    ...
    public InterfaceC6577Oc2 getOrdersOrBuilder(int i) {
        return (InterfaceC6577Oc2) this.orders_.get(i);
    }

    public List<? extends InterfaceC6577Oc2> getOrdersOrBuilderList() {
        return this.orders_;
    }
    ...
    public static a newBuilder(ExchangeOuterClass$ResponseLoadExchangingHistory exchangeOuterClass$ResponseLoadExchangingHistory) {
        return (a) DEFAULT_INSTANCE.createBuilder(exchangeOuterClass$ResponseLoadExchangingHistory);
    }

    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseFrom(AbstractC2383g abstractC2383g) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    private void addOrders(int i, ExchangeStruct$ExchangeHistoryItem exchangeStruct$ExchangeHistoryItem) {
        exchangeStruct$ExchangeHistoryItem.getClass();
        ensureOrdersIsMutable();
        this.orders_.add(i, exchangeStruct$ExchangeHistoryItem);
    }

    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseFrom(byte[] bArr, C2394s c2394s) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseFrom(InputStream inputStream, C2394s c2394s) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseFrom(AbstractC2384h abstractC2384h) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static ExchangeOuterClass$ResponseLoadExchangingHistory parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (ExchangeOuterClass$ResponseLoadExchangingHistory) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
