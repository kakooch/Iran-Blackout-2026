...
public final class GroupsOuterClass$ResponseJoinGroup extends GeneratedMessageLite implements U64 {
    public static final int DATE_FIELD_NUMBER = 4;
    private static final GroupsOuterClass$ResponseJoinGroup DEFAULT_INSTANCE;
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        private a() {
            super(GroupsOuterClass$ResponseJoinGroup.DEFAULT_INSTANCE);
        }
    }

    static {
        GroupsOuterClass$ResponseJoinGroup groupsOuterClass$ResponseJoinGroup = new GroupsOuterClass$ResponseJoinGroup();
        DEFAULT_INSTANCE = groupsOuterClass$ResponseJoinGroup;
        GeneratedMessageLite.registerDefaultInstance(GroupsOuterClass$ResponseJoinGroup.class, groupsOuterClass$ResponseJoinGroup);
    }

    private GroupsOuterClass$ResponseJoinGroup() {
    }
    ...
    public static GroupsOuterClass$ResponseJoinGroup getDefaultInstance() {
    ...
    public static GroupsOuterClass$ResponseJoinGroup parseDelimitedFrom(InputStream inputStream) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(ByteBuffer byteBuffer) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (AbstractC1874m0.a[gVar.ordinal()]) {
            case 1:
                return new GroupsOuterClass$ResponseJoinGroup();
            case 2:
                return new a();
            case 3:
            ...
            case 5:
                KW4 cVar = PARSER;
                if (cVar == null) {
                    synchronized (GroupsOuterClass$ResponseJoinGroup.class) {
                        try {
                            cVar = PARSER;
                            if (cVar == null) {
    ...
    public static a newBuilder(GroupsOuterClass$ResponseJoinGroup groupsOuterClass$ResponseJoinGroup) {
        return (a) DEFAULT_INSTANCE.createBuilder(groupsOuterClass$ResponseJoinGroup);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(AbstractC2383g abstractC2383g) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static GroupsOuterClass$ResponseJoinGroup parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(byte[] bArr) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(byte[] bArr, C2394s c2394s) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(InputStream inputStream) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(InputStream inputStream, C2394s c2394s) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(AbstractC2384h abstractC2384h) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static GroupsOuterClass$ResponseJoinGroup parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (GroupsOuterClass$ResponseJoinGroup) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
