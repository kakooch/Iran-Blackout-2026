...
public final class SearchOuterClass$ResponseSearchMessages extends GeneratedMessageLite implements U64 {
    private static final SearchOuterClass$ResponseSearchMessages DEFAULT_INSTANCE;
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        private a() {
            super(SearchOuterClass$ResponseSearchMessages.DEFAULT_INSTANCE);
        }
    }

    static {
        SearchOuterClass$ResponseSearchMessages searchOuterClass$ResponseSearchMessages = new SearchOuterClass$ResponseSearchMessages();
        DEFAULT_INSTANCE = searchOuterClass$ResponseSearchMessages;
        GeneratedMessageLite.registerDefaultInstance(SearchOuterClass$ResponseSearchMessages.class, searchOuterClass$ResponseSearchMessages);
    }

    private SearchOuterClass$ResponseSearchMessages() {
    }
    ...
    public static SearchOuterClass$ResponseSearchMessages getDefaultInstance() {
    ...
    public static SearchOuterClass$ResponseSearchMessages parseDelimitedFrom(InputStream inputStream) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(ByteBuffer byteBuffer) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (L1.a[gVar.ordinal()]) {
            case 1:
                return new SearchOuterClass$ResponseSearchMessages();
            case 2:
                return new a();
            case 3:
            ...
            case 5:
                KW4 cVar = PARSER;
                if (cVar == null) {
                    synchronized (SearchOuterClass$ResponseSearchMessages.class) {
                        try {
                            cVar = PARSER;
                            if (cVar == null) {
    ...
    public static a newBuilder(SearchOuterClass$ResponseSearchMessages searchOuterClass$ResponseSearchMessages) {
        return (a) DEFAULT_INSTANCE.createBuilder(searchOuterClass$ResponseSearchMessages);
    }

    public static SearchOuterClass$ResponseSearchMessages parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(AbstractC2383g abstractC2383g) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static SearchOuterClass$ResponseSearchMessages parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(byte[] bArr) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(byte[] bArr, C2394s c2394s) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(InputStream inputStream) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(InputStream inputStream, C2394s c2394s) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(AbstractC2384h abstractC2384h) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static SearchOuterClass$ResponseSearchMessages parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (SearchOuterClass$ResponseSearchMessages) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
