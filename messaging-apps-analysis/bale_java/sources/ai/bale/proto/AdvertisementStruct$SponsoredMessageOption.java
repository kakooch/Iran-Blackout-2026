...
public final class AdvertisementStruct$SponsoredMessageOption extends GeneratedMessageLite implements U64 {
    ...
    public static AdvertisementStruct$SponsoredMessageOption parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static AdvertisementStruct$SponsoredMessageOption parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static AdvertisementStruct$SponsoredMessageOption parseFrom(AbstractC2383g abstractC2383g) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static AdvertisementStruct$SponsoredMessageOption parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static AdvertisementStruct$SponsoredMessageOption parseFrom(byte[] bArr, C2394s c2394s) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static AdvertisementStruct$SponsoredMessageOption parseFrom(InputStream inputStream, C2394s c2394s) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static AdvertisementStruct$SponsoredMessageOption parseFrom(AbstractC2384h abstractC2384h) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static AdvertisementStruct$SponsoredMessageOption parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (AdvertisementStruct$SponsoredMessageOption) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
