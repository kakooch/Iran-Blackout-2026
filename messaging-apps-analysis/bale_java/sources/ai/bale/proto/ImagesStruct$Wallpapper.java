...
public final class ImagesStruct$Wallpapper extends GeneratedMessageLite implements U64 {
    ...
    public static ImagesStruct$Wallpapper parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ImagesStruct$Wallpapper parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static ImagesStruct$Wallpapper parseFrom(AbstractC2383g abstractC2383g) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static ImagesStruct$Wallpapper parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static ImagesStruct$Wallpapper parseFrom(byte[] bArr, C2394s c2394s) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static ImagesStruct$Wallpapper parseFrom(InputStream inputStream, C2394s c2394s) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ImagesStruct$Wallpapper parseFrom(AbstractC2384h abstractC2384h) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static ImagesStruct$Wallpapper parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (ImagesStruct$Wallpapper) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
