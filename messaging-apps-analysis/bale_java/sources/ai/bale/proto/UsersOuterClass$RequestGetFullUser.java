...
public final class UsersOuterClass$RequestGetFullUser extends GeneratedMessageLite implements U64 {
    ...
    public static a newBuilder(UsersOuterClass$RequestGetFullUser usersOuterClass$RequestGetFullUser) {
        return (a) DEFAULT_INSTANCE.createBuilder(usersOuterClass$RequestGetFullUser);
    }

    public static UsersOuterClass$RequestGetFullUser parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static UsersOuterClass$RequestGetFullUser parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static UsersOuterClass$RequestGetFullUser parseFrom(AbstractC2383g abstractC2383g) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static UsersOuterClass$RequestGetFullUser parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static UsersOuterClass$RequestGetFullUser parseFrom(byte[] bArr, C2394s c2394s) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static UsersOuterClass$RequestGetFullUser parseFrom(InputStream inputStream, C2394s c2394s) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static UsersOuterClass$RequestGetFullUser parseFrom(AbstractC2384h abstractC2384h) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static UsersOuterClass$RequestGetFullUser parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (UsersOuterClass$RequestGetFullUser) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
