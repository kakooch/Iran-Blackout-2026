...
public final class ClubOuterClass$ResponseGetVouchers extends GeneratedMessageLite implements U64 {
    ...
    public static a newBuilder(ClubOuterClass$ResponseGetVouchers clubOuterClass$ResponseGetVouchers) {
        return (a) DEFAULT_INSTANCE.createBuilder(clubOuterClass$ResponseGetVouchers);
    }

    public static ClubOuterClass$ResponseGetVouchers parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ClubOuterClass$ResponseGetVouchers parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static ClubOuterClass$ResponseGetVouchers parseFrom(AbstractC2383g abstractC2383g) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static ClubOuterClass$ResponseGetVouchers parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static ClubOuterClass$ResponseGetVouchers parseFrom(byte[] bArr, C2394s c2394s) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static ClubOuterClass$ResponseGetVouchers parseFrom(InputStream inputStream, C2394s c2394s) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static ClubOuterClass$ResponseGetVouchers parseFrom(AbstractC2384h abstractC2384h) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static ClubOuterClass$ResponseGetVouchers parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (ClubOuterClass$ResponseGetVouchers) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
