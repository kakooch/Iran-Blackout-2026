...
public final class KifpoolOuterClass$RequestPurchaseMessage extends GeneratedMessageLite implements U64 {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (AbstractC1897u0.a[gVar.ordinal()]) {
            ...
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0001\u0002\u0004\u0003\u0000\u0000\u0000\u0002ဉ\u0000\u0003ဉ\u0001\u0004ဉ\u0002", new Object[]{"bitField0_", "historyId_", "amount_", "description_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
    ...
    public static a newBuilder(KifpoolOuterClass$RequestPurchaseMessage kifpoolOuterClass$RequestPurchaseMessage) {
        return (a) DEFAULT_INSTANCE.createBuilder(kifpoolOuterClass$RequestPurchaseMessage);
    }

    public static KifpoolOuterClass$RequestPurchaseMessage parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static KifpoolOuterClass$RequestPurchaseMessage parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static KifpoolOuterClass$RequestPurchaseMessage parseFrom(AbstractC2383g abstractC2383g) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static KifpoolOuterClass$RequestPurchaseMessage parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static KifpoolOuterClass$RequestPurchaseMessage parseFrom(byte[] bArr, C2394s c2394s) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static KifpoolOuterClass$RequestPurchaseMessage parseFrom(InputStream inputStream, C2394s c2394s) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static KifpoolOuterClass$RequestPurchaseMessage parseFrom(AbstractC2384h abstractC2384h) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static KifpoolOuterClass$RequestPurchaseMessage parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (KifpoolOuterClass$RequestPurchaseMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
