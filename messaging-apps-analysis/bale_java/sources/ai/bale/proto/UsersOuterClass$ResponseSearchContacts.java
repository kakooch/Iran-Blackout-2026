...
public final class UsersOuterClass$ResponseSearchContacts extends GeneratedMessageLite implements U64 {
    private static final UsersOuterClass$ResponseSearchContacts DEFAULT_INSTANCE;
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        private a() {
            super(UsersOuterClass$ResponseSearchContacts.DEFAULT_INSTANCE);
        }
    }

    static {
        UsersOuterClass$ResponseSearchContacts usersOuterClass$ResponseSearchContacts = new UsersOuterClass$ResponseSearchContacts();
        DEFAULT_INSTANCE = usersOuterClass$ResponseSearchContacts;
        GeneratedMessageLite.registerDefaultInstance(UsersOuterClass$ResponseSearchContacts.class, usersOuterClass$ResponseSearchContacts);
    }

    private UsersOuterClass$ResponseSearchContacts() {
    }
    ...
    public static UsersOuterClass$ResponseSearchContacts getDefaultInstance() {
    ...
    public static UsersOuterClass$ResponseSearchContacts parseDelimitedFrom(InputStream inputStream) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(ByteBuffer byteBuffer) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (p2.a[gVar.ordinal()]) {
            case 1:
                return new UsersOuterClass$ResponseSearchContacts();
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0004\u0000\u0000\u0001\u0005\u0004\u0000\u0004\u0000\u0001\u001b\u0002\u001b\u0004\u001b\u0005\u001b", new Object[]{"users_", UsersStruct$User.class, "userPeers_", PeersStruct$UserOutPeer.class, "groups_", GroupsStruct$Group.class, "groupPeers_", PeersStruct$GroupOutPeer.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
                if (cVar == null) {
                    synchronized (UsersOuterClass$ResponseSearchContacts.class) {
                        try {
                            cVar = PARSER;
                            if (cVar == null) {
    ...
    public static a newBuilder(UsersOuterClass$ResponseSearchContacts usersOuterClass$ResponseSearchContacts) {
        return (a) DEFAULT_INSTANCE.createBuilder(usersOuterClass$ResponseSearchContacts);
    }

    public static UsersOuterClass$ResponseSearchContacts parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(AbstractC2383g abstractC2383g) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static UsersOuterClass$ResponseSearchContacts parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(byte[] bArr) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(byte[] bArr, C2394s c2394s) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(InputStream inputStream) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(InputStream inputStream, C2394s c2394s) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(AbstractC2384h abstractC2384h) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static UsersOuterClass$ResponseSearchContacts parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (UsersOuterClass$ResponseSearchContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
