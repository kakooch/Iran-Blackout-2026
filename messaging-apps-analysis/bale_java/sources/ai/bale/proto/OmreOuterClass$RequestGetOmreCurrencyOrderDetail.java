...
public final class OmreOuterClass$RequestGetOmreCurrencyOrderDetail extends GeneratedMessageLite implements U64 {
    ...
    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseFrom(AbstractC2383g abstractC2383g) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseFrom(byte[] bArr, C2394s c2394s) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseFrom(InputStream inputStream, C2394s c2394s) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseFrom(AbstractC2384h abstractC2384h) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static OmreOuterClass$RequestGetOmreCurrencyOrderDetail parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (OmreOuterClass$RequestGetOmreCurrencyOrderDetail) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
