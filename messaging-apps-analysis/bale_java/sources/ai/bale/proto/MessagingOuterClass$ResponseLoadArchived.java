...
public final class MessagingOuterClass$ResponseLoadArchived extends GeneratedMessageLite implements U64 {
    private static final MessagingOuterClass$ResponseLoadArchived DEFAULT_INSTANCE;
    public static final int DIALOGS_FIELD_NUMBER = 3;
    public static final int GROUPS_FIELD_NUMBER = 1;
    public static final int GROUP_PEERS_FIELD_NUMBER = 6;
    ...
    public static final class a extends GeneratedMessageLite.b implements U64 {
        private a() {
            super(MessagingOuterClass$ResponseLoadArchived.DEFAULT_INSTANCE);
        }
    }

    static {
        MessagingOuterClass$ResponseLoadArchived messagingOuterClass$ResponseLoadArchived = new MessagingOuterClass$ResponseLoadArchived();
        DEFAULT_INSTANCE = messagingOuterClass$ResponseLoadArchived;
        GeneratedMessageLite.registerDefaultInstance(MessagingOuterClass$ResponseLoadArchived.class, messagingOuterClass$ResponseLoadArchived);
    }

    private MessagingOuterClass$ResponseLoadArchived() {
    }
    ...
    public static MessagingOuterClass$ResponseLoadArchived getDefaultInstance() {
    ...
    public static MessagingOuterClass$ResponseLoadArchived parseDelimitedFrom(InputStream inputStream) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(ByteBuffer byteBuffer) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (K0.a[gVar.ordinal()]) {
            case 1:
                return new MessagingOuterClass$ResponseLoadArchived();
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0006\u0000\u0001\u0001\u0006\u0006\u0000\u0005\u0000\u0001\u001b\u0002\u001b\u0003\u001b\u0004ဉ\u0000\u0005\u001b\u0006\u001b", new Object[]{"bitField0_", "groups_", GroupsStruct$Group.class, "users_", UsersStruct$User.class, "dialogs_", MessagingStruct$Dialog.class, "nextOffset_", "userPeers_", PeersStruct$UserOutPeer.class, "groupPeers_", PeersStruct$GroupOutPeer.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
                if (cVar == null) {
                    synchronized (MessagingOuterClass$ResponseLoadArchived.class) {
                        try {
                            cVar = PARSER;
                            if (cVar == null) {
    ...
    public static a newBuilder(MessagingOuterClass$ResponseLoadArchived messagingOuterClass$ResponseLoadArchived) {
        return (a) DEFAULT_INSTANCE.createBuilder(messagingOuterClass$ResponseLoadArchived);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(AbstractC2383g abstractC2383g) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static MessagingOuterClass$ResponseLoadArchived parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(byte[] bArr) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(byte[] bArr, C2394s c2394s) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(InputStream inputStream) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(InputStream inputStream, C2394s c2394s) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(AbstractC2384h abstractC2384h) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static MessagingOuterClass$ResponseLoadArchived parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (MessagingOuterClass$ResponseLoadArchived) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
