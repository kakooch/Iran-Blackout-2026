...
public final class MessagingStruct$AnimatedStickerMessage extends GeneratedMessageLite implements U64 {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        switch (L0.a[gVar.ordinal()]) {
            ...
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0005\u0000\u0001\u0001\u0006\u0005\u0000\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u0003ဉ\u0002\u0005ဉ\u0003\u0006ဉ\u0004", new Object[]{"bitField0_", "stickerId_", "fastPreview_", "fileLocation_", "stickerCollectionId_", "stickerCollectionAccessHash_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                KW4 cVar = PARSER;
    ...
    public static a newBuilder(MessagingStruct$AnimatedStickerMessage messagingStruct$AnimatedStickerMessage) {
        return (a) DEFAULT_INSTANCE.createBuilder(messagingStruct$AnimatedStickerMessage);
    }

    public static MessagingStruct$AnimatedStickerMessage parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MessagingStruct$AnimatedStickerMessage parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static MessagingStruct$AnimatedStickerMessage parseFrom(AbstractC2383g abstractC2383g) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }

    public static MessagingStruct$AnimatedStickerMessage parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static MessagingStruct$AnimatedStickerMessage parseFrom(byte[] bArr, C2394s c2394s) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static MessagingStruct$AnimatedStickerMessage parseFrom(InputStream inputStream, C2394s c2394s) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static MessagingStruct$AnimatedStickerMessage parseFrom(AbstractC2384h abstractC2384h) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static MessagingStruct$AnimatedStickerMessage parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (MessagingStruct$AnimatedStickerMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
