...
public final class UsersOuterClass$ResponseGetContacts extends GeneratedMessageLite implements U64 {
    ...
    public static UsersOuterClass$ResponseGetContacts parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static UsersOuterClass$ResponseGetContacts parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static UsersOuterClass$ResponseGetContacts parseFrom(AbstractC2383g abstractC2383g) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static UsersOuterClass$ResponseGetContacts parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static UsersOuterClass$ResponseGetContacts parseFrom(byte[] bArr, C2394s c2394s) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static UsersOuterClass$ResponseGetContacts parseFrom(InputStream inputStream, C2394s c2394s) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static UsersOuterClass$ResponseGetContacts parseFrom(AbstractC2384h abstractC2384h) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static UsersOuterClass$ResponseGetContacts parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (UsersOuterClass$ResponseGetContacts) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
