...
public final class StoryOuterClass$ResponseGetChannelStories extends GeneratedMessageLite implements U64 {
    ...
    public static StoryOuterClass$ResponseGetChannelStories parseDelimitedFrom(InputStream inputStream, C2394s c2394s) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static StoryOuterClass$ResponseGetChannelStories parseFrom(ByteBuffer byteBuffer, C2394s c2394s) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, c2394s);
    }

    public static StoryOuterClass$ResponseGetChannelStories parseFrom(AbstractC2383g abstractC2383g) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g);
    }
    ...
    public static StoryOuterClass$ResponseGetChannelStories parseFrom(AbstractC2383g abstractC2383g, C2394s c2394s) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2383g, c2394s);
    }
    ...
    public static StoryOuterClass$ResponseGetChannelStories parseFrom(byte[] bArr, C2394s c2394s) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c2394s);
    }
    ...
    public static StoryOuterClass$ResponseGetChannelStories parseFrom(InputStream inputStream, C2394s c2394s) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c2394s);
    }

    public static StoryOuterClass$ResponseGetChannelStories parseFrom(AbstractC2384h abstractC2384h) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h);
    }

    public static StoryOuterClass$ResponseGetChannelStories parseFrom(AbstractC2384h abstractC2384h, C2394s c2394s) {
        return (StoryOuterClass$ResponseGetChannelStories) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC2384h, c2394s);
    }
}
