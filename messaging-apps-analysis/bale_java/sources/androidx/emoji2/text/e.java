...
public class e {
    ...
    private final int l;
    private final int m;
    private final InterfaceC0085e n;
    ...
    private static final class a extends b {
        ...
        void f(l lVar) {
            ...
            l lVar2 = this.c;
            j jVar = this.a.g;
            InterfaceC0085e interfaceC0085e = this.a.n;
            e eVar = this.a;
            this.b = new androidx.emoji2.text.h(lVar2, jVar, interfaceC0085e, eVar.i, eVar.j, androidx.emoji2.text.g.a());
            this.a.q();
        }
    }
    ...
    public static abstract class c {
        ...
        int h = -16711936;
        int i = 0;
        InterfaceC0085e j = new androidx.emoji2.text.d();

        protected c(h hVar) {
            AbstractC4980Hj5.h(hVar, "metadataLoader cannot be null.");
            this.a = hVar;
        }
    ...
    public static class d implements j {
        ...
        public AbstractC22956w62 a(m mVar) {
            return new C16864lz7(mVar);
        }
    }
    ...
    private static class g implements Runnable {
        ...
        g(f fVar, int i) {
            this(Arrays.asList((f) AbstractC4980Hj5.h(fVar, "initCallback cannot be null")), i, null);
        }
        ...
        g(Collection collection, int i, Throwable th) {
            AbstractC4980Hj5.h(collection, "initCallbacks cannot be null");
    ...
    public void n() {
        AbstractC4980Hj5.j(this.m == 1, "Set metadataLoadStrategy to LOAD_STRATEGY_MANUAL to execute manual loading");
        if (m()) {
            return;
        }
        this.a.writeLock().lock();
    ...
    public CharSequence u(CharSequence charSequence, int i2, int i3, int i4, int i5) {
        boolean z;
        AbstractC4980Hj5.j(m(), "Not initialized yet");
        AbstractC4980Hj5.e(i2, "start cannot be negative");
        AbstractC4980Hj5.e(i3, "end cannot be negative");
        AbstractC4980Hj5.e(i4, "maxEmojiCount cannot be negative");
        AbstractC4980Hj5.b(i2 <= i3, "start should be <= than end");
        if (charSequence == null) {
            return null;
        }
        AbstractC4980Hj5.b(i2 <= charSequence.length(), "start should be < than charSequence length");
        AbstractC4980Hj5.b(i3 <= charSequence.length(), "end should be < than charSequence length");
    ...
    public void v(f fVar) {
        AbstractC4980Hj5.h(fVar, "initCallback cannot be null");
        this.a.writeLock().lock();
        try {
