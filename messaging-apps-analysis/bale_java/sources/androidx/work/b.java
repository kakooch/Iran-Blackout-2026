...
public final class b {
    private static final String b = HI3.f("Data");
    ...
    public static final class a {
        ...
        public a g(String str, long[] jArr) {
            this.a.put(str, b.f(jArr));
            return this;
        }
    ...
    */
    ...
    public static byte[] p(b bVar) throws Throwable {
    ...
    public boolean n(String str, Class cls) {
        Object obj = this.a.get(str);
