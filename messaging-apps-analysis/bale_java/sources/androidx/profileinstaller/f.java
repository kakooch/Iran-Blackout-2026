...
public abstract class f {
    ...
    static void g(Executor executor, final c cVar, final int i, final Object obj) {
        executor.execute(new Runnable() { // from class: ir.nasim.Gu5
    ...
    public static void i(Context context) throws PackageManager.NameNotFoundException {
        j(context, new ExecutorC4596Fu5(), a);
    }
    ...
    static void k(Context context, Executor executor, c cVar, boolean z) throws PackageManager.NameNotFoundException {
