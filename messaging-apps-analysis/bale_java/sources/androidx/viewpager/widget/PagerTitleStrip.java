...
public class PagerTitleStrip extends ViewGroup {
    ...
    void b(int i, androidx.viewpager.widget.a aVar) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((getWidth() - getPaddingLeft()) - getPaddingRight()) * 0.8f)), RecyclerView.UNDEFINED_DURATION);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(Math.max(0, (getHeight() - getPaddingTop()) - getPaddingBottom()), RecyclerView.UNDEFINED_DURATION);
    ...
    void c(int i, float f, boolean z) {
        ...
        int i14 = this.h & SetRpcStruct$ComposedRpc.SEARCH_CONTACTS_FIELD_NUMBER;
        if (i14 == 16) {
    ...
    public PagerTitleStrip(Context context, AttributeSet attributeSet) throws Resources.NotFoundException {
        ...
        if (resourceId != 0) {
            AbstractC15575jo7.p(this.b, resourceId);
            AbstractC15575jo7.p(this.c, resourceId);
            AbstractC15575jo7.p(this.d, resourceId);
        }
