...
public class ActionMenuItemView extends AppCompatTextView implements k.a, View.OnClickListener, ActionMenuView.a {
    ...
    private class a extends t {
        ...
        @Override // androidx.appcompat.widget.t
        protected boolean c() {
            InterfaceC13418gB6 interfaceC13418gB6B;
            ActionMenuItemView actionMenuItemView = ActionMenuItemView.this;
            e.b bVar = actionMenuItemView.k;
            return bVar != null && bVar.d(actionMenuItemView.h) && (interfaceC13418gB6B = b()) != null && interfaceC13418gB6B.b();
        }
    }

    public static abstract class b {
        public abstract InterfaceC13418gB6 a();
    }
    ...
    private void t() {
        ...
        if (TextUtils.isEmpty(tooltipText)) {
            AbstractC8375Vr7.a(this, z3 ? null : this.h.getTitle());
        } else {
            AbstractC8375Vr7.a(this, tooltipText);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        t tVar;
        if (this.h.hasSubMenu() && (tVar = this.l) != null && tVar.onTouch(this, motionEvent)) {
            return true;
        }
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.n = s();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, HE5.ActionMenuItemView, i, 0);
        this.p = typedArrayObtainStyledAttributes.getDimensionPixelSize(HE5.ActionMenuItemView_android_minWidth, 0);
