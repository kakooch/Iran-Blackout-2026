...
class x extends GW5 implements View.OnClickListener {
    ...
    private static final class a {
        ...
        public a(View view) {
            ...
            this.e = (ImageView) view.findViewById(AbstractC15808kC5.edit_query);
        }
    }
    ...
    private CharSequence l(CharSequence charSequence) {
        if (this.s == null) {
            ...
            this.n.getTheme().resolveAttribute(AbstractC15790kA5.textColorSearchUrl, typedValue, true);
    ...
    private Drawable s(String str) throws NumberFormatException, IOException {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.n.getPackageName() + Separators.SLASH + i;
            Drawable drawableK = k(str2);
            if (drawableK != null) {
                return drawableK;
            }
            Drawable drawableF = AbstractC4043Dl1.f(this.n, i);
            A(str2, drawableF);
            return drawableF;
        } catch (Resources.NotFoundException unused) {
    ...
    @Override // ir.nasim.AbstractC20985sw1, ir.nasim.C4859Gw1.a
    ...
    @Override // ir.nasim.AbstractC20985sw1, android.widget.BaseAdapter, android.widget.SpinnerAdapter
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            return super.getDropDownView(i, view, viewGroup);
        } catch (RuntimeException e) {
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e);
            View viewG = g(this.n, d(), viewGroup);
            if (viewG != null) {
    ...
    @Override // ir.nasim.AbstractC20985sw1, android.widget.Adapter
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            return super.getView(i, view, viewGroup);
        } catch (RuntimeException e) {
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e);
            View viewH = h(this.n, d(), viewGroup);
            if (viewH != null) {
    ...
    @Override // ir.nasim.GW5, ir.nasim.AbstractC20985sw1
    public View h(Context context, Cursor cursor, ViewGroup viewGroup) {
        View viewH = super.h(context, cursor, viewGroup);
        viewH.setTag(new a(viewH));
        ((ImageView) viewH.findViewById(AbstractC15808kC5.edit_query)).setImageResource(this.p);
        return viewH;
    }
