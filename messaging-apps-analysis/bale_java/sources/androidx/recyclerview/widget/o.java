...
public class o extends RecyclerView.y {
    ...
    protected void C(RecyclerView.y.a aVar) {
        ...
        aVar.d((int) (this.o * 1.2f), (int) (this.p * 1.2f), (int) (x(AppMetricaDefaultValues.DEFAULT_MAX_REPORTS_COUNT_UPPER_BOUND) * 1.2f), this.i);
    }
    ...
    public int t(View view, int i) {
        ...
        return s(pVarE.R(view) - ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, pVarE.U(view) + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, pVarE.f0(), pVarE.p0() - pVarE.g0(), i);
    }
    ...
    public int u(View view, int i) {
        ...
        RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view.getLayoutParams();
        return s(pVarE.V(view) - ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, pVarE.P(view) + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin, pVarE.h0(), pVarE.X() - pVarE.e0(), i);
    }
