...
class s {
    ...
    interface a {
        C1975a.b a(int i, int i2, int i3, Object obj);

        void b(C1975a.b bVar);
    }
    ...
    private void c(List list, int i, C1975a.b bVar, int i2, C1975a.b bVar2) {
        int i3 = bVar.d;
        int i4 = bVar2.b;
        int i5 = i3 < i4 ? -1 : 0;
        int i6 = bVar.b;
    ...
    private void d(List list, int i, int i2) {
        C1975a.b bVar = (C1975a.b) list.get(i);
        C1975a.b bVar2 = (C1975a.b) list.get(i2);
        int i3 = bVar2.a;
        if (i3 == 1) {
    ...
    void e(List list, int i, C1975a.b bVar, int i2, C1975a.b bVar2) {
        boolean z;
        int i3 = bVar.b;
        int i4 = bVar.d;
        boolean z2 = false;
        ...
        if (i7 <= i8) {
            ...
            int i9 = bVar2.d;
            if (i7 < i8 + i9) {
                bVarA = this.a.a(2, i7 + 1, (i8 + i9) - i7, null);
    ...
    */
    void f(java.util.List r9, int r10, androidx.recyclerview.widget.C1975a.b r11, int r12, androidx.recyclerview.widget.C1975a.b r13) {
        /*
            r8 = this;
            int r0 = r11.d
            int r1 = r13.b
        ...
        L2b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.s$a r4 = r8.a
            int r1 = r1 + r3
