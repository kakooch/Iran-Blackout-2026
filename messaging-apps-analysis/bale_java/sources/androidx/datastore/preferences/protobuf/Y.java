...
abstract class Y extends AbstractMap {
    ...
    static class a extends Y {
        ...
        public void s() {
            if (!q()) {
                if (l() > 0) {
                    AbstractC18350oW3.a(k(0).getKey());
                    throw null;
                }
    ...
    private class c extends g {
        ...
        @Override // androidx.datastore.preferences.protobuf.Y.g, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
    ...
    private class g extends AbstractSet {
        ...
        public boolean add(Map.Entry entry) {
            ...
            Y.this.u((Comparable) entry.getKey(), entry.getValue());
            return true;
        }
    ...
    */
    private int g(java.lang.Comparable r5) {
        /*
            ...
            androidx.datastore.preferences.protobuf.Y$e r2 = (androidx.datastore.preferences.protobuf.Y.e) r2
        ...
        L24:
            ...
            androidx.datastore.preferences.protobuf.Y$e r3 = (androidx.datastore.preferences.protobuf.Y.e) r3
        ...
        L47:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.Y.g(java.lang.Comparable):int");
    }
    ...
    private class b implements Iterator {
        ...
        public boolean hasNext() {
            int i = this.a;
            return (i > 0 && i <= Y.this.b.size()) || a().hasNext();
        }
    ...
    private class f implements Iterator {
        ...
        public Map.Entry next() {
            ...
            int i = this.a + 1;
            this.a = i;
            return i < Y.this.b.size() ? (Map.Entry) Y.this.b.get(this.a) : (Map.Entry) a().next();
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.a + 1 >= Y.this.b.size()) {
                return !Y.this.c.isEmpty() && a().hasNext();
            }
            return true;
        }
