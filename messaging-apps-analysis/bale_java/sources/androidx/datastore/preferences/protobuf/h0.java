...
interface h0 {
    ...
    void J(int i, List list, V v);

    void K(int i, AbstractC1937f abstractC1937f);

    void L(int i, Object obj, V v);

    void M(int i, B.a aVar, Map map);

    void N(int i, Object obj, V v);

    void O(int i, List list, V v);
