...
final /* synthetic */ class Okio__JvmOkioKt {
    ...
    public static final boolean isAndroidGetsocknameError(AssertionError assertionError) {
        AbstractC13042fc3.i(assertionError, "<this>");
        if (assertionError.getCause() == null) {
            return false;
        }
        String message = assertionError.getMessage();
        return message != null ? AbstractC20762sZ6.X(message, "getsockname failed", false, 2, null) : false;
    }
    ...
    public static final Sink sink(Socket socket) throws IOException {
        ...
        AbstractC13042fc3.h(outputStream, "getOutputStream(...)");
    ...
    public static final Source source(java.nio.file.Path path, OpenOption... openOptionArr) throws IOException {
        ...
        AbstractC13042fc3.i(openOptionArr, "options");
