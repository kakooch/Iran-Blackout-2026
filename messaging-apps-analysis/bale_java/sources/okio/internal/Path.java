...
public final class Path {
    ...
    static {
        ...
        SLASH = companion.encodeUtf8(Separators.SLASH);
        BACKSLASH = companion.encodeUtf8("\\");
        ANY_SLASH = companion.encodeUtf8("/\\");
        DOT = companion.encodeUtf8(Separators.DOT);
    ...
    public static final int commonCompareTo(okio.Path path, okio.Path path2) {
        ...
        AbstractC13042fc3.i(path2, "other");
        return path.getBytes().compareTo(path2.getBytes());
    }

    public static final boolean commonEquals(okio.Path path, Object obj) {
        AbstractC13042fc3.i(path, "<this>");
        return (obj instanceof okio.Path) && AbstractC13042fc3.d(((okio.Path) obj).getBytes(), path.getBytes());
    }
    ...
    public static final okio.Path commonParent(okio.Path path) {
        AbstractC13042fc3.i(path, "<this>");
        if (AbstractC13042fc3.d(path.getBytes(), DOT) || AbstractC13042fc3.d(path.getBytes(), SLASH) || AbstractC13042fc3.d(path.getBytes(), BACKSLASH) || lastSegmentIsDotDot(path)) {
            return null;
        }
        int indexOfLastSlash = getIndexOfLastSlash(path);
    ...
    public static final okio.Path commonRelativeTo(okio.Path path, okio.Path path2) {
        AbstractC13042fc3.i(path, "<this>");
        AbstractC13042fc3.i(path2, "other");
        if (!AbstractC13042fc3.d(path.getRoot(), path2.getRoot())) {
        ...
        if (i == iMin && path.getBytes().size() == path2.getBytes().size()) {
            return Path.Companion.get$default(okio.Path.INSTANCE, Separators.DOT, false, 1, (Object) null);
        }
    ...
    private static final boolean startsWithVolumeLetterAndColon(Buffer buffer, ByteString byteString) {
        if (!AbstractC13042fc3.d(byteString, BACKSLASH) || buffer.size() < 2 || buffer.getByte(1L) != 58) {
            return false;
        }
    ...
    public static final okio.Path toPath(Buffer buffer, boolean z) {
        ...
        boolean z2 = i >= 2 && AbstractC13042fc3.d(slash, byteString);
        if (z2) {
            AbstractC13042fc3.f(slash);
            buffer2.write(slash);
            buffer2.write(slash);
        } else if (i > 0) {
            AbstractC13042fc3.f(slash);
        ...
        while (!buffer.exhausted()) {
            ...
            if (AbstractC13042fc3.d(byteString2, byteString3)) {
                if (!z3 || !arrayList.isEmpty()) {
                    if (!z || (!z3 && (arrayList.isEmpty() || AbstractC13042fc3.d(AbstractC15401jX0.C0(arrayList), byteString3)))) {
                        arrayList.add(byteString2);
                    } else if (!z2 || arrayList.size() != 1) {
                        AbstractC13610gX0.O(arrayList);
                    }
                }
            } else if (!AbstractC13042fc3.d(byteString2, DOT) && !AbstractC13042fc3.d(byteString2, ByteString.EMPTY)) {
                arrayList.add(byteString2);
            }
        }
    ...
    public static final ByteString toSlash(String str) {
        if (AbstractC13042fc3.d(str, Separators.SLASH)) {
            return SLASH;
        }
    ...
    public static final okio.Path commonResolve(okio.Path path, ByteString byteString, boolean z) {
        AbstractC13042fc3.i(path, "<this>");
        AbstractC13042fc3.i(byteString, "child");
    ...
    public static final okio.Path commonResolve(okio.Path path, Buffer buffer, boolean z) {
        AbstractC13042fc3.i(path, "<this>");
        AbstractC13042fc3.i(buffer, "child");
    ...
    public static final okio.Path commonResolve(okio.Path path, okio.Path path2, boolean z) {
        AbstractC13042fc3.i(path, "<this>");
        AbstractC13042fc3.i(path2, "child");
