...
public final class Buffer {
    ...
    public static final void commonClose(Buffer.UnsafeCursor unsafeCursor) {
        AbstractC13042fc3.i(unsafeCursor, "<this>");
    ...
    public static final okio.Buffer commonCopyTo(okio.Buffer buffer, okio.Buffer buffer2, long j, long j2) {
        AbstractC13042fc3.i(buffer, "<this>");
        AbstractC13042fc3.i(buffer2, "out");
    ...
    */
    ...
    public static final int commonSeek(Buffer.UnsafeCursor unsafeCursor, long j) {
        ...
        if (unsafeCursor.getSegment() != null) {
            ...
            AbstractC13042fc3.f(unsafeCursor.getSegment());
            long j4 = j3 - (i - r9.pos);
            if (j4 > j) {
                segmentPush = segment;
        ...
        if (size - j > j - j2) {
            while (true) {
                AbstractC13042fc3.f(segmentPush);
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    if (cCharAt2 > 56319 || 56320 > cCharAt3 || cCharAt3 >= 57344) {
                        ...
                        bArr4[i11] = (byte) ((i10 >> 18) | SetRpcStruct$ComposedRpc.RESPONSE_STICKERS_REPONSE_FIELD_NUMBER);
    ...
    public static final okio.Buffer commonWriteUtf8CodePoint(okio.Buffer buffer, int i) {
        ...
        if (i < 128) {
            ...
            bArr3[i4] = (byte) ((i >> 18) | SetRpcStruct$ComposedRpc.RESPONSE_STICKERS_REPONSE_FIELD_NUMBER);
    ...
    public static final <T> T seek(okio.Buffer buffer, long j, InterfaceC14603iB2 interfaceC14603iB2) {
        AbstractC13042fc3.i(buffer, "<this>");
        AbstractC13042fc3.i(interfaceC14603iB2, "lambda");
        Segment segment = buffer.head;
        if (segment == null) {
            return (T) interfaceC14603iB2.invoke(null, -1L);
        }
        if (buffer.size() - j < j) {
            long size = buffer.size();
            while (size > j) {
            ...
            return (T) interfaceC14603iB2.invoke(segment, Long.valueOf(size));
        }
        long j2 = 0;
        while (true) {
            long j3 = (segment.limit - segment.pos) + j2;
            if (j3 > j) {
                return (T) interfaceC14603iB2.invoke(segment, Long.valueOf(j2));
            }
            segment = segment.next;
            AbstractC13042fc3.f(segment);
            j2 = j3;
    ...
    */
    ...
    public static final int commonRead(okio.Buffer buffer, byte[] bArr, int i, int i2) {
        ...
        byte[] bArr2 = segment.data;
        int i3 = segment.pos;
        AbstractC9648aK.g(bArr2, bArr, i, i3, i3 + iMin);
        segment.pos += iMin;
    ...
    public static final okio.Buffer commonWrite(okio.Buffer buffer, byte[] bArr, int i, int i2) {
        ...
        while (i < i3) {
            ...
            int i4 = i + iMin;
            AbstractC9648aK.g(bArr, segmentWritableSegment$okio.data, segmentWritableSegment$okio.limit, i, i4);
            segmentWritableSegment$okio.limit += iMin;
            i = i4;
        }
        buffer.setSize$okio(buffer.size() + j);
    ...
    public static final void commonReadFully(okio.Buffer buffer, okio.Buffer buffer2, long j) throws EOFException {
        AbstractC13042fc3.i(buffer, "<this>");
        AbstractC13042fc3.i(buffer2, "sink");
        if (buffer.size() >= j) {
    ...
    public static final void commonWrite(okio.Buffer buffer, okio.Buffer buffer2, long j) {
        Segment segment;
        AbstractC13042fc3.i(buffer, "<this>");
        AbstractC13042fc3.i(buffer2, "source");
        if (buffer2 != buffer) {
            ...
            while (j > 0) {
                ...
                AbstractC13042fc3.f(segment2);
                int i = segment2.limit;
                AbstractC13042fc3.f(buffer2.head);
                if (j < i - r1.pos) {
                ...
                if (segment7 == null) {
                    ...
                    AbstractC13042fc3.f(segment7);
                    Segment segment8 = segment7.prev;
                    AbstractC13042fc3.f(segment8);
