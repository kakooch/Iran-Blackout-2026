...
public final /* data */ class WebSocketExtensions {
    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers responseHeaders) {
            ...
            for (int i = 0; i < size; i++) {
                if (AbstractC20153rZ6.D(responseHeaders.name(i), WebSocketExtensions.HEADER_WEB_SOCKET_EXTENSION, true)) {
                    ...
                    while (i2 < strValue.length()) {
                        ...
                        if (AbstractC20153rZ6.D(strTrimSubstring, "permessage-deflate", true)) {
                            if (z) {
                                z4 = true;
                            }
                            i2 = i3;
                            while (i2 < iDelimiterOffset$default) {
                                ...
                                String strF0 = iDelimiterOffset3 < iDelimiterOffset2 ? AbstractC20762sZ6.F0(Util.trimSubstring(strValue, iDelimiterOffset3 + 1, iDelimiterOffset2), Separators.DOUBLE_QUOTE) : null;
                                i2 = iDelimiterOffset2 + 1;
                                if (AbstractC20153rZ6.D(strTrimSubstring2, "client_max_window_bits", true)) {
                                    if (numO != null) {
                                        z4 = true;
                                    }
                                    numO = strF0 != null ? AbstractC19562qZ6.o(strF0) : null;
                                    if (numO == null) {
                                        z4 = true;
                                    }
                                } else if (AbstractC20153rZ6.D(strTrimSubstring2, "client_no_context_takeover", true)) {
                                    if (z2) {
                                        z4 = true;
                                    }
                                    if (strF0 != null) {
                                    ...
                                    z2 = true;
                                } else if (AbstractC20153rZ6.D(strTrimSubstring2, "server_max_window_bits", true)) {
                                    if (numO2 != null) {
                                        z4 = true;
                                    }
                                    numO2 = strF0 != null ? AbstractC19562qZ6.o(strF0) : null;
                                    if (numO2 == null) {
                                        z4 = true;
                                    }
                                } else if (AbstractC20153rZ6.D(strTrimSubstring2, "server_no_context_takeover", true)) {
                                    if (z3) {
                                        z4 = true;
                                    }
                                    if (strF0 != null) {
            ...
            return new WebSocketExtensions(z, numO, z2, numO2, z3, z4);
        }
    ...
    public boolean equals(Object other) {
        ...
        return this.perMessageDeflate == webSocketExtensions.perMessageDeflate && AbstractC13042fc3.d(this.clientMaxWindowBits, webSocketExtensions.clientMaxWindowBits) && this.clientNoContextTakeover == webSocketExtensions.clientNoContextTakeover && AbstractC13042fc3.d(this.serverMaxWindowBits, webSocketExtensions.serverMaxWindowBits) && this.serverNoContextTakeover == webSocketExtensions.serverNoContextTakeover && this.unknownValues == webSocketExtensions.unknownValues;
    }
    ...
    public /* synthetic */ WebSocketExtensions(boolean z, Integer num, boolean z2, Integer num2, boolean z3, boolean z4, int i, ED1 ed1) {
