...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    private static final List<Protocol> ONLY_HTTP1 = AbstractC9766aX0.e(Protocol.HTTP_1_1);
    ...
    public static final class Message {
        ...
        public Message(int i, ByteString byteString) {
            AbstractC13042fc3.i(byteString, "data");
            this.formatOpcode = i;
    ...
    public RealWebSocket(TaskRunner taskRunner, Request request, WebSocketListener webSocketListener, Random random, long j, WebSocketExtensions webSocketExtensions, long j2) {
        ...
        AbstractC13042fc3.i(webSocketListener, "listener");
        ...
        if (!AbstractC13042fc3.d("GET", request.method())) {
    ...
    public final boolean isValid(WebSocketExtensions webSocketExtensions) {
        if (!webSocketExtensions.unknownValues && webSocketExtensions.clientMaxWindowBits == null) {
            return webSocketExtensions.serverMaxWindowBits == null || new C24411ya3(8, 15).B(webSocketExtensions.serverMaxWindowBits.intValue());
        }
        return false;
    }
    ...
    public final void checkUpgradeSuccess$okhttp(Response response, Exchange exchange) throws ProtocolException {
        ...
        if (!AbstractC20153rZ6.D("Upgrade", strHeader$default, true)) {
        ...
        if (!AbstractC20153rZ6.D("websocket", strHeader$default2, true)) {
        ...
        if (AbstractC13042fc3.d(strBase64, strHeader$default3)) {
            if (exchange == null) {
    ...
    public final void initReaderAndWriter(String name, Streams streams) {
        ...
        AbstractC13042fc3.i(streams, "streams");
        WebSocketExtensions webSocketExtensions = this.extensions;
        AbstractC13042fc3.f(webSocketExtensions);
        synchronized (this) {
            try {
                this.name = name;
    ...
    public final void loopReader() {
        while (this.receivedCloseCode == -1) {
            WebSocketReader webSocketReader = this.reader;
            AbstractC13042fc3.f(webSocketReader);
    ...
    public final boolean writeOneFrame$okhttp() throws IOException {
        ...
        synchronized (this) {
            try {
                ...
                try {
                    if (byteStringPoll != null) {
                        AbstractC13042fc3.f(webSocketWriter2);
