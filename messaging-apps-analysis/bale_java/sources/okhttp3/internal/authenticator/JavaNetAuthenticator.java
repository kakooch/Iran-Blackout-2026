...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    private final InetAddress connectToInetAddress(Proxy proxy, HttpUrl httpUrl, Dns dns) {
        ...
        if ((type == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) == 1) {
            return (InetAddress) AbstractC15401jX0.q0(dns.lookup(httpUrl.host()));
        }
        SocketAddress socketAddressAddress = proxy.address();
        AbstractC13042fc3.g(socketAddressAddress, "null cannot be cast to non-null type java.net.InetSocketAddress");
        InetAddress address = ((InetSocketAddress) socketAddressAddress).getAddress();
        AbstractC13042fc3.h(address, "address() as InetSocketAddress).address");
        return address;
    }
    ...
    public Request authenticate(Route route, Response response) {
        ...
        for (Challenge challenge : listChallenges) {
            if (AbstractC20153rZ6.D("Basic", challenge.scheme(), true)) {
                ...
                if (z) {
                    ...
                    AbstractC13042fc3.h(proxy, "proxy");
                ...
                if (passwordAuthenticationRequestPasswordAuthentication != null) {
                    String str = z ? SIPHeaderNames.PROXY_AUTHORIZATION : SIPHeaderNames.AUTHORIZATION;
                    String userName = passwordAuthenticationRequestPasswordAuthentication.getUserName();
                    AbstractC13042fc3.h(userName, "auth.userName");
                    char[] password = passwordAuthenticationRequestPasswordAuthentication.getPassword();
                    AbstractC13042fc3.h(password, "auth.password");
    ...
    public JavaNetAuthenticator(Dns dns) {
        AbstractC13042fc3.i(dns, "defaultDns");
        this.defaultDns = dns;
    }

    public /* synthetic */ JavaNetAuthenticator(Dns dns, int i, ED1 ed1) {
