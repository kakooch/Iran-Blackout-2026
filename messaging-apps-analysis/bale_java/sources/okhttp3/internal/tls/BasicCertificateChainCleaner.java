...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public BasicCertificateChainCleaner(TrustRootIndex trustRootIndex) {
        AbstractC13042fc3.i(trustRootIndex, "trustRootIndex");
    ...
    private final boolean verifySignature(X509Certificate toVerify, X509Certificate signingCert) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, NoSuchProviderException {
        if (!AbstractC13042fc3.d(toVerify.getIssuerDN(), signingCert.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public List<Certificate> clean(List<? extends Certificate> chain, String hostname) throws SSLPeerUnverifiedException {
        ...
        AbstractC13042fc3.h(objRemoveFirst, "queue.removeFirst()");
        arrayList.add(objRemoveFirst);
        boolean z = false;
        for (int i = 0; i < 9; i++) {
            Object obj = arrayList.get(arrayList.size() - 1);
            AbstractC13042fc3.g(obj, "null cannot be cast to non-null type java.security.cert.X509Certificate");
            ...
            if (x509CertificateFindByIssuerAndSignature == null) {
                ...
                AbstractC13042fc3.h(it, "queue.iterator()");
                while (it.hasNext()) {
                    Object next = it.next();
                    AbstractC13042fc3.g(next, "null cannot be cast to non-null type java.security.cert.X509Certificate");
            ...
            if (arrayList.size() > 1 || !AbstractC13042fc3.d(x509Certificate, x509CertificateFindByIssuerAndSignature)) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BasicCertificateChainCleaner) && AbstractC13042fc3.d(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex);
    }
