...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public BasicTrustRootIndex(X509Certificate... x509CertificateArr) {
        AbstractC13042fc3.i(x509CertificateArr, "caCerts");
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        for (X509Certificate x509Certificate : x509CertificateArr) {
            X500Principal subjectX500Principal = x509Certificate.getSubjectX500Principal();
            AbstractC13042fc3.h(subjectX500Principal, "caCert.subjectX500Principal");
    ...
    public boolean equals(Object other) {
        return other == this || ((other instanceof BasicTrustRootIndex) && AbstractC13042fc3.d(((BasicTrustRootIndex) other).subjectToCaCerts, this.subjectToCaCerts));
    }
