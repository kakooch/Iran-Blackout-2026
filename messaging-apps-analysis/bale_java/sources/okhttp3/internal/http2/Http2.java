...
public final class Http2 {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            AbstractC13042fc3.h(binaryString, "toBinaryString(it)");
            strArr[i] = AbstractC20153rZ6.L(Util.format("%8s", binaryString), ' ', '0', false, 4, null);
        }
        BINARY = strArr;
    ...
    public final String formatFlags(int type, int flags) {
        ...
        if (type != 2 && type != 3) {
            if (type == 4 || type == 6) {
                return flags == 1 ? TokenNames.ACK : BINARY[flags];
            }
            if (type != 7 && type != 8) {
                String[] strArr = FLAGS;
                ...
                String str2 = str;
                return (type != 5 || (flags & 4) == 0) ? (type != 0 || (flags & 32) == 0) ? str2 : AbstractC20153rZ6.M(str2, "PRIORITY", "COMPRESSED", false, 4, null) : AbstractC20153rZ6.M(str2, "HEADERS", "PUSH_PROMISE", false, 4, null);
            }
        }
        return BINARY[flags];
    }
