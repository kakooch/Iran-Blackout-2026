...
public final class HostnamesKt {
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (AbstractC13042fc3.k(cCharAt, 31) <= 0 || AbstractC13042fc3.k(cCharAt, 127) >= 0 || AbstractC20762sZ6.k0(" #%/:?@[\\]", cCharAt, 0, false, 6, null) != -1) {
                return true;
            }
        }
        return false;
    ...
    private static final boolean decodeIpv4Suffix(String str, int i, int i2, byte[] bArr, int i3) {
        ...
        while (i < i2) {
            ...
            while (i5 < i2) {
                ...
                if (AbstractC13042fc3.k(cCharAt, 48) < 0 || AbstractC13042fc3.k(cCharAt, 57) > 0) {
                    break;
                }
    ...
    */
    private static final java.net.InetAddress decodeIpv6(java.lang.String r18, int r19, int r20) {
        ...
        L15:
            ...
            r10 = r5
            r5 = r17
            boolean r0 = ir.nasim.AbstractC14836iZ6.R(r0, r1, r2, r3, r4, r5)
            if (r0 == 0) goto L38
            if (r14 == r11) goto L2e
            return r16
        L2e:
    ...
    public static final String toCanonicalHost(String str) {
        ...
        if (!AbstractC20762sZ6.X(str, ":", false, 2, null)) {
            try {
                ...
                AbstractC13042fc3.h(ascii, "toASCII(host)");
        ...
        InetAddress inetAddressDecodeIpv6 = (AbstractC20153rZ6.S(str, "[", false, 2, null) && AbstractC20153rZ6.C(str, "]", false, 2, null)) ? decodeIpv6(str, 1, str.length() - 1) : decodeIpv6(str, 0, str.length());
        if (inetAddressDecodeIpv6 == null) {
            return null;
        }
        byte[] address = inetAddressDecodeIpv6.getAddress();
        if (address.length == 16) {
            AbstractC13042fc3.h(address, "address");
