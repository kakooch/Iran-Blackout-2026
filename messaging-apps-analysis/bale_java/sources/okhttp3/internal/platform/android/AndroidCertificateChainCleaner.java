...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public AndroidCertificateChainCleaner(X509TrustManager x509TrustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
        ...
        AbstractC13042fc3.i(x509TrustManagerExtensions, "x509TrustManagerExtensions");
    ...
    public List<Certificate> clean(List<? extends Certificate> chain, String hostname) throws CertificateException, SSLPeerUnverifiedException {
        ...
        try {
            ...
            AbstractC13042fc3.h(listCheckServerTrusted, "x509TrustManagerExtensio…ficates, \"RSA\", hostname)");
