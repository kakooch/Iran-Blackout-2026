...
public class AndroidSocketAdapter implements SocketAdapter {
        ...
        public final DeferredSocketAdapter.Factory factory(final String packageName) {
            ...
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public boolean matchesSocket(SSLSocket sslSocket) {
                    ...
                    AbstractC13042fc3.h(name, "sslSocket.javaClass.name");
                    return AbstractC20153rZ6.S(name, packageName + '.', false, 2, null);
                }
            };
        }
    ...
    public AndroidSocketAdapter(Class<? super SSLSocket> cls) throws NoSuchMethodException, SecurityException {
        AbstractC13042fc3.i(cls, "sslSocketClass");
        this.sslSocketClass = cls;
        Method declaredMethod = cls.getDeclaredMethod("setUseSessionTickets", Boolean.TYPE);
        AbstractC13042fc3.h(declaredMethod, "sslSocketClass.getDeclar…:class.javaPrimitiveType)");
    ...
    public String getSelectedProtocol(SSLSocket sslSocket) {
        ...
        try {
            ...
            if ((cause instanceof NullPointerException) && AbstractC13042fc3.d(((NullPointerException) cause).getMessage(), "ssl == null")) {
                return null;
            }
            throw new AssertionError(e2);
        }
