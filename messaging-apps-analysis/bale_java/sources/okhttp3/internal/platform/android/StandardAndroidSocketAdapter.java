...
public final class StandardAndroidSocketAdapter extends AndroidSocketAdapter {
    ...
    public static final class Companion {
        ...
        public final SocketAdapter buildIfSupported(String packageName) throws ClassNotFoundException {
            ...
            try {
                ...
                AbstractC13042fc3.g(cls, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocket>");
                Class<?> cls2 = Class.forName(packageName + ".OpenSSLSocketFactoryImpl");
                AbstractC13042fc3.g(cls2, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocketFactory>");
                Class<?> cls3 = Class.forName(packageName + ".SSLParametersImpl");
                AbstractC13042fc3.h(cls3, "paramsClass");
    ...
    public StandardAndroidSocketAdapter(Class<? super SSLSocket> cls, Class<? super SSLSocketFactory> cls2, Class<?> cls3) {
        ...
        AbstractC13042fc3.i(cls2, "sslSocketFactoryClass");
        AbstractC13042fc3.i(cls3, "paramClass");
    ...
    public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
        ...
        AbstractC13042fc3.f(fieldOrNull);
