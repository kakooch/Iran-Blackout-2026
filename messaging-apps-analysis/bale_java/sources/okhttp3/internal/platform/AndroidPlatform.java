...
public final class AndroidPlatform extends Platform {
    ...
    public static final /* data */ class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(X509TrustManager x509TrustManager, Method method) {
            ...
            AbstractC13042fc3.i(method, "findByIssuerAndSignatureMethod");
        ...
        public final CustomTrustRootIndex copy(X509TrustManager trustManager, Method findByIssuerAndSignatureMethod) {
            ...
            AbstractC13042fc3.i(findByIssuerAndSignatureMethod, "findByIssuerAndSignatureMethod");
        ...
        public boolean equals(Object other) {
            ...
            return AbstractC13042fc3.d(this.trustManager, customTrustRootIndex.trustManager) && AbstractC13042fc3.d(this.findByIssuerAndSignatureMethod, customTrustRootIndex.findByIssuerAndSignatureMethod);
        }
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate cert) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                AbstractC13042fc3.g(objInvoke, "null cannot be cast to non-null type java.security.cert.TrustAnchor");
    ...
    public AndroidPlatform() {
        List listR = AbstractC10360bX0.r(StandardAndroidSocketAdapter.Companion.buildIfSupported$default(StandardAndroidSocketAdapter.INSTANCE, null, 1, null), new DeferredSocketAdapter(AndroidSocketAdapter.INSTANCE.getPlayProviderFactory()), new DeferredSocketAdapter(ConscryptSocketAdapter.INSTANCE.getFactory()), new DeferredSocketAdapter(BouncyCastleSocketAdapter.INSTANCE.getFactory()));
    ...
    public TrustRootIndex buildTrustRootIndex(X509TrustManager trustManager) throws NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            AbstractC13042fc3.h(declaredMethod, "method");
