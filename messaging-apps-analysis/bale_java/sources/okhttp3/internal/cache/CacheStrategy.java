            ...
            if (!cacheControl2.noCache()) {
                ...
                if (j < millis + jComputeFreshnessLifetime) {
                    ...
                    if (j >= jComputeFreshnessLifetime) {
                        builderNewBuilder.addHeader(SIPHeaderNames.WARNING, "110 HttpURLConnection \"Response is stale\"");
                    }
                    if (jCacheResponseAge > 86400000 && isFreshnessLifetimeHeuristic()) {
                        builderNewBuilder.addHeader(SIPHeaderNames.WARNING, "113 HttpURLConnection \"Heuristic expiration\"");
                    }
