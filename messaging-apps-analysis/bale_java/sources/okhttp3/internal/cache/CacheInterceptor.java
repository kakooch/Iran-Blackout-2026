...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u0000 \u000f2\u00020\u0001:\u0001\u000fB\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004J\u001a\u0010\u0007\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\n2\u0006\u0010\u000b\u001a\u00020\bH\u0002J\u0010\u0010\f\u001a\u00020\b2\u0006\u0010\r\u001a\u00020\u000eH\u0016R\u0016\u0010\u0002\u001a\u0004\u0018\u00010\u0003X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0010"}, d2 = {"Lokhttp3/internal/cache/CacheInterceptor;", "Lokhttp3/Interceptor;", "cache", "Lokhttp3/Cache;", "(Lokhttp3/Cache;)V", "getCache$okhttp", "()Lokhttp3/Cache;", "cacheWritingResponse", "Lokhttp3/Response;", "cacheRequest", "Lokhttp3/internal/cache/CacheRequest;", "response", "intercept", ReferencesHeader.CHAIN, "Lokhttp3/Interceptor$Chain;", "Companion", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((!AbstractC20153rZ6.D(SIPHeaderNames.WARNING, strName, true) || !AbstractC20153rZ6.S(strValue, "1", false, 2, null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isContentSpecificHeader(String fieldName) {
            return AbstractC20153rZ6.D(SIPHeaderNames.CONTENT_LENGTH, fieldName, true) || AbstractC20153rZ6.D(SIPHeaderNames.CONTENT_ENCODING, fieldName, true) || AbstractC20153rZ6.D(SIPHeaderNames.CONTENT_TYPE, fieldName, true);
        }

        private final boolean isEndToEnd(String fieldName) {
            return (AbstractC20153rZ6.D("Connection", fieldName, true) || AbstractC20153rZ6.D("Keep-Alive", fieldName, true) || AbstractC20153rZ6.D(SIPHeaderNames.PROXY_AUTHENTICATE, fieldName, true) || AbstractC20153rZ6.D(SIPHeaderNames.PROXY_AUTHORIZATION, fieldName, true) || AbstractC20153rZ6.D("TE", fieldName, true) || AbstractC20153rZ6.D("Trailers", fieldName, true) || AbstractC20153rZ6.D("Transfer-Encoding", fieldName, true) || AbstractC20153rZ6.D("Upgrade", fieldName, true)) ? false : true;
        }
    ...
    private final Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) {
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, SIPHeaderNames.CONTENT_TYPE, null, 2, null), response.body().getContentLength(), Okio.buffer(source))).build();
    }
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (networkRequest == null) {
            AbstractC13042fc3.f(cacheResponse);
        ...
        try {
            ...
            if (cacheResponse != null) {
                if (responseProceed != null && responseProceed.code() == 304) {
                    ...
                    AbstractC13042fc3.f(responseBodyBody3);
                    responseBodyBody3.close();
                    Cache cache3 = this.cache;
                    AbstractC13042fc3.f(cache3);
            ...
            AbstractC13042fc3.f(responseProceed);
