...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m102deprecated_get(String mediaType) {
        ...
        public final MediaType m103deprecated_parse(String mediaType) {
            AbstractC13042fc3.i(mediaType, "mediaType");
        ...
        public final MediaType get(String str) {
            ...
            while (iEnd < str.length()) {
                ...
                if (strGroup3 == null) {
                    ...
                    } else if (AbstractC20153rZ6.S(strGroup4, Separators.QUOTE, false, 2, null) && AbstractC20153rZ6.C(strGroup4, Separators.QUOTE, false, 2, null) && strGroup4.length() > 2) {
                        strGroup4 = strGroup4.substring(1, strGroup4.length() - 1);
                        AbstractC13042fc3.h(strGroup4, "this as java.lang.String…ing(startIndex, endIndex)");
                    }
    ...
    public /* synthetic */ MediaType(String str, String str2, String str3, String[] strArr, ED1 ed1) {
    ...
    public boolean equals(Object other) {
        return (other instanceof MediaType) && AbstractC13042fc3.d(((MediaType) other).mediaType, this.mediaType);
    }
    ...
    public final String parameter(String name) {
        ...
        int i = 0;
        int iC = AbstractC16234kv5.c(0, this.parameterNamesAndValues.length - 1, 2);
        if (iC < 0) {
            return null;
        }
        while (!AbstractC20153rZ6.D(this.parameterNamesAndValues[i], name, true)) {
            if (i == iC) {
                return null;
            }
            i += 2;
