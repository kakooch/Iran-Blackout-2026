...
public final class Address {
    ...
    public Address(String str, int i, Dns dns, SocketFactory socketFactory, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, CertificatePinner certificatePinner, Authenticator authenticator, Proxy proxy, List<? extends Protocol> list, List<ConnectionSpec> list2, ProxySelector proxySelector) {
        AbstractC13042fc3.i(str, "uriHost");
        AbstractC13042fc3.i(dns, "dns");
        AbstractC13042fc3.i(socketFactory, "socketFactory");
        AbstractC13042fc3.i(authenticator, "proxyAuthenticator");
        AbstractC13042fc3.i(list, "protocols");
        AbstractC13042fc3.i(list2, "connectionSpecs");
    ...
    public boolean equals(Object other) {
        if (other instanceof Address) {
            ...
            if (AbstractC13042fc3.d(this.url, address.url) && equalsNonHost$okhttp(address)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean equalsNonHost$okhttp(Address that) {
        AbstractC13042fc3.i(that, "that");
        return AbstractC13042fc3.d(this.dns, that.dns) && AbstractC13042fc3.d(this.proxyAuthenticator, that.proxyAuthenticator) && AbstractC13042fc3.d(this.protocols, that.protocols) && AbstractC13042fc3.d(this.connectionSpecs, that.connectionSpecs) && AbstractC13042fc3.d(this.proxySelector, that.proxySelector) && AbstractC13042fc3.d(this.proxy, that.proxy) && AbstractC13042fc3.d(this.sslSocketFactory, that.sslSocketFactory) && AbstractC13042fc3.d(this.hostnameVerifier, that.hostnameVerifier) && AbstractC13042fc3.d(this.certificatePinner, that.certificatePinner) && this.url.port() == that.url.port();
    }
