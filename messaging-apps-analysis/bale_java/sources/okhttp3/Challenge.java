...
public final class Challenge {
    ...
    public Challenge(String str, Map<String, String> map) {
        ...
        AbstractC13042fc3.i(map, "authParams");
        this.scheme = str;
        ...
        AbstractC13042fc3.h(mapUnmodifiableMap, "unmodifiableMap<String?, String>(newAuthParams)");
    ...
    public final Charset charset() {
        ...
        if (str != null) {
            try {
                ...
                AbstractC13042fc3.h(charsetForName, "forName(charset)");
    ...
    public boolean equals(Object other) {
        if (other instanceof Challenge) {
            ...
            if (AbstractC13042fc3.d(challenge.scheme, this.scheme) && AbstractC13042fc3.d(challenge.authParams, this.authParams)) {
                return true;
            }
        }
        return false;
    ...
    public final Challenge withCharset(Charset charset) {
        ...
        Map mapA = AbstractC20051rO3.A(this.authParams);
        String strName = charset.name();
        AbstractC13042fc3.h(strName, "charset.name()");
    ...
    public Challenge(String str, String str2) {
        AbstractC13042fc3.i(str, "scheme");
        AbstractC13042fc3.i(str2, "realm");
        Map mapSingletonMap = Collections.singletonMap("realm", str2);
        AbstractC13042fc3.h(mapSingletonMap, "singletonMap(\"realm\", realm)");
